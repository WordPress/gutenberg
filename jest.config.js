...
module.exports = {
	...
	moduleNameMapper: {
		'@wordpress\\/(blocks|data|element|deprecated|editor|redux-routine|block-library|components|keycodes|url|a11y|viewport|core-data)$': '<rootDir>/gutenberg/packages/$1/src/index',
