...
-   Build `.mts` and `.cts` source files, including route and widget entry points, and rewrite their local imports to the emitted `.mjs` or `.cjs` extension ([#83071](https://github.com/WordPress/gutenberg/pull/83071)).
-   Resolve extensionless local imports through `.mts` and `.cts`, which esbuild's default resolution omits ([#83071](https://github.com/WordPress/gutenberg/pull/83071)).
