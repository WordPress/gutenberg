...
-   Treat a route's `canvas` file as route content, so a route that ships only a canvas still gets a `content.js` bundle ([#83088](https://github.com/WordPress/gutenberg/pull/83088)).
