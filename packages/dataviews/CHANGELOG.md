...
- DataForm: Specialize `EditConfig` for `integer` and `number` fields, adding declarative `step`, `spinControls`, `prefix`, and `suffix` options. [#78349](https://github.com/WordPress/gutenberg/pull/78349)
