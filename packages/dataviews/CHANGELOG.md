...
-   List layout: restore keyboard focus to the row that replaces a deleted row instead of dropping focus to the page body when the focused row is removed ([#00000](https://github.com/WordPress/gutenberg/pull/00000)).
