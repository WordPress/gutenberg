...
- DataViews table layout: remove row click-to-select behavior and hover styles. Selection is now only possible via checkboxes. [#73873](https://github.com/WordPress/gutenberg/pull/73873)
