...
- Dataviews: Fix Table Column insert left and insert right, which inserts the column in opposite order for RTL languages site. [#74681](https://github.com/WordPress/gutenberg/pull/74681)
