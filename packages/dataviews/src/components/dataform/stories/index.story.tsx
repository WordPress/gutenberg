...
export function ResourceListAlternative() {
	...
	const dataRLA: WeeklyOpeningHours = {
		weeklyOpeningHours: [
			{ day: 'monday', openingHours: 4 },
			{ day: 'tuesday', openingHours: 8 },
			{ day: 'wednesday', openingHours: 7 },
		],
	};

	const [ formData, setFormData ] = useState( dataRLA );
	const fieldsRLA: Field< WeeklyOpeningHours >[] = [
		{
			id: 'weeklyOpeningHours',
			type: 'array' as const,
			children: [
				{
					id: 'day',
				...
				},
				{
					...
					label: 'How many hours does it open?',
				},
			],
		},
	];
