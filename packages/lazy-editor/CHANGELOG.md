...
-   Allow `useEditorSettings` to receive an unresolved global styles ID, and defer loading user styles until the ID resolves. ([#81863](https://github.com/WordPress/gutenberg/pull/81863))
