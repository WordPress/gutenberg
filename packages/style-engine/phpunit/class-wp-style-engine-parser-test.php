<?php
/**
 * Tests WP_Style_Engine_Parser's methods that parse block style objects.
 *
 * @package    Gutenberg
...
/**
 * Tests for parsing plugin block styles.
 */
class WP_Style_Engine_Parser_Test extends WP_UnitTestCase {
	/**
	 ...
	 */
	public function test_parse_block_styles( $block_styles, $options, $expected_output ) {
		$generated_styles = WP_Style_Engine_Parser::parse_block_styles( $block_styles, $options );
		...
		return array(
			...
			'valid_inline_css_and_classnames_as_default_context' => array(
				...
				'expected_output' => array(
					...
					'classnames'   => array( 'has-text-color', 'has-texas-flood-color', 'has-border-color', 'has-cool-caramel-border-color' ),
				),
			),
			...
			'valid_inline_css_and_classnames_with_context' => array(
				...
				'expected_output' => array(
					...
					'classnames'   => array( 'has-text-color', 'has-little-lamb-color' ),
				),
			),
			...
			'elements_with_css_var_value'                  => array(
				...
				'expected_output' => array(
					...
					'classnames'   => array( 'has-text-color', 'has-my-little-pony-color' ),
				),
			),
			...
			'elements_with_invalid_preset_style_property'  => array(
				...
				'expected_output' => array(
					'classnames' => array( 'has-text-color' ),
				),
			),
			...
			'valid_classnames_deduped'                     => array(
				...
				'expected_output' => array(
					'classnames' => array(
						'has-text-color',
						'has-copper-socks-color',
						'has-background',
						'has-splendid-carrot-background-color',
						'has-like-wow-dude-gradient-background',
						'has-fantastic-font-size',
						'has-totally-awesome-font-family',
					),
				),
			),
			...
			'valid_classnames_and_css_vars'                => array(
				...
				'expected_output' => array(
					...
					'classnames'   => array( 'has-text-color', 'has-teal-independents-color' ),
				),
			),
			...
			'invalid_classnames_preset_value'              => array(
				...
				'options'         => array( 'convert_vars_to_classnames' => true ),
				'expected_output' => array(
					'classnames' => array( 'has-text-color', 'has-background' ),
				),
			),
