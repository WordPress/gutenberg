...
/**
 * A style object, for example the value of a block's `attributes.style` object
 * or the top-level styles in `theme.json`. Passed to `compileCSS` and
 * `getCSSRules` to generate CSS.
 */
export type { Style } from './types';

/**
 * Options that adjust how styles are generated by `compileCSS` and
 * `getCSSRules`.
 */
