...
class WP_Style_Engine {
	...
	/**
	 * Get an instance of the WP_Style_Engine_Gutenberg_CSS_Rules object.
	 *
	 ...
	 * @return WP_Style_Engine_Gutenberg_CSS_Rules The CSS rules object.
	 */
	public function get_css_rules_object( $selector = null ) {
		if ( null === $selector ) {
			return new WP_Style_Engine_Gutenberg_CSS_Rules();
		}
		static $instances = array();
		if ( ! isset( $instances[ $selector ] ) ) {
			$instances[ $selector ] = new WP_Style_Engine_Gutenberg_CSS_Rules();
		}
