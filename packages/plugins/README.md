...
<a name="createFilteredComponent" href="#createFilteredComponent">#</a> **createFilteredComponent**
...
-   _name_ `string`: The name of the existing hook.

_Returns_

-   `WPComponent`: Filtered component to use with Plugins API.

<a name="FilteredComponent" href="#FilteredComponent">#</a> **FilteredComponent**
