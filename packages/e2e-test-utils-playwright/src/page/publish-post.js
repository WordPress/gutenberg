...
export async function publishPost() {
	...
	if ( isPublishingPost ) {
		...
		const publishButton = await this.page.locator(
			'[aria-disabled="false"].editor-post-publish-button'
		);
		await publishButton.click();

		// A success notice should show up.
		return this.page.waitForSelector( '.components-snackbar' );
	}
}
