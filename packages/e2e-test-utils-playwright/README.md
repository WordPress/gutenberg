...
<!-- START TOKEN(Autogenerated admin|src/admin) -->
...
-   _this_ `Admin`:
-   _query_ `SiteEditorQueryParams`: Query params to be serialized as query portion of URL.
-   _skipWelcomeGuide_ `boolean`: Whether to skip the welcome guide as part of the navigation.

<!-- END TOKEN(Autogenerated admin|src/admin) -->
