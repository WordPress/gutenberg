...
These scripts can be executed by using the structure `npm run [command]`
### Build Commands

These commands are used to build the code for development or production.

* [start](https://github.com/WordPress/gutenberg/tree/HEAD/packages/scripts/docs/build-commands.md#start)
* [build](https://github.com/WordPress/gutenberg/tree/HEAD/packages/scripts/docs/build-commands.md#build)
