...
-   _id_ `string|number`: Optional ID of the rest resource to check.
...
-   _recordId_ `string|number`: Record's id.
...
-   _state_ `any`: Data state.
-   _query_ `Object`: Optional object of query parameters to include with request.
...
-   `any[]|undefined`: An array of autosaves for the post, or undefined if there is none.
...
-   `any[]`: Block pattern category list.
...
-   `Object|undefined`: Current user object.
...
-   _kind_ `string`: Entity kind.
-   _name_ `string`: Entity name.
-   _recordId_ `string|number`: Record ID.

_Returns_

-   `Object|null|undefined`: The entity record, merged with its edits.
...
-   `Object`: Array of entities with config matching kind.
...
-   `Object[]|undefined`: The entity record's edits.
...
-   `Object|undefined`: The entity record's non transient edits.
...
-   `Object|undefined`: The entity record's save error.
...
-   `Object|null|undefined`: Object with the entity's raw attributes.
...
-   `Object|null|undefined`: The edit.
...
-   _state_ `any`: Editor state.

_Returns_

-   `Object`: A value whose reference will change only when an edit occurs.
...
-   _state_ `any`: Data state.
-   _string_ `string`: queryID Query ID.
