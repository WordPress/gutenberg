...
-   _postId_ `number | null`: - The ID of the post.
-   _postType_ `string | null`: - The type of the post.

_Returns_

-   `ActiveCollaborator[]`: The active collaborators.
...
-   `SelectionCursor`: The absolute position index.
...
-   `boolean`: Whether the current collaborator is disconnected.
