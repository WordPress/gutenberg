...
<!-- START TOKEN(Autogenerated entity|src/entity-provider.js) -->

#### EntityProvider

Context provider component for providing an entity for a specific entity.

_Parameters_

-   _props_ `Object`: The component's props.
-   _props.kind_ `string`: The entity kind.
-   _props.type_ `string`: The entity name.
-   _props.id_ `number`: The entity ID.
-   _props.children_ `*`: The children to wrap.

_Returns_

-   `Object`: The provided children, wrapped with the entity's context provider.
...
-   `[WPBlock[], Function, Function]`: The block array and setters.
...
<!-- END TOKEN(Autogenerated entity|src/entity-provider.js) -->
