...
-   `__experimentalFetchLinkSuggestions`: Add an `exclude` option, so a caller can leave a type out of an unscoped search rather than discarding its results afterwards ([#83084](https://github.com/WordPress/gutenberg/pull/83084)).
