...
-   `EntitiesSavedStates`: Describe an attachment group by the change it carries, so media a block proposes attaching to the post says what saving it does rather than showing bare filenames ([#66663](https://github.com/WordPress/gutenberg/issues/66663)).
