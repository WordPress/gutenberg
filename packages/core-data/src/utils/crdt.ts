 ...
 * @return {Partial<ObjectData>} The changes that should be applied to the local record.
 */
...
/**
 * Given a raw entity record, return the initial data that should be loaded
 * into the CRDT document.
 *
 * @param {ObjectData} record The raw entity record.
 * @return {ObjectData} The initial data to load into the CRDT document.
 */
export function defaultGetInitialObjectData( record: ObjectData ): ObjectData {
	return record;
}

/**
 * Given a raw post entity record, return the initial data that should be loaded
 * into the CRDT document.
 *
 * @param {Post}        record           The raw entity record.
 * @param {Type}        postType         The post type definition.
 * @param {Set<string>} syncedProperties The set of properties that should be synced for this post type.
 * @return {ObjectData} The initial data to load into the CRDT document.
 */
