...
-   Include `plugin-wpds/no-global-css-defense-custom-properties` from `@wordpress/ui` to catch direct use or overrides of `--_gcd-*` (global CSS defense) custom properties ([#80952](https://github.com/WordPress/gutenberg/pull/80952)).
