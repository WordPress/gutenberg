...
-   `MediaEditor`: widen the docked details panel to 350px and dock it above the `large` breakpoint; below that it takes the whole body ([#81840](https://github.com/WordPress/gutenberg/pull/81840)).
