 ...
 * it straight into block attributes. Keeping this decoupled from REST field
 * names also leaves room to reuse the modal outside a WordPress REST context
 * (e.g. native/Electron hosts).
 */
