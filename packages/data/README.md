...
-   `null`: Enhanced component with merged dispatcher props.
...
-   _OriginalComponent_ `null`: Original component.

_Returns_

-   `null`: Enhanced component.
...
-   `null`: Enhanced component with merged state data props.
