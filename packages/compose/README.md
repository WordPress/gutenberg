...
-   `null`: Component class with generated display name assigned.
...
-   _WrappedComponent_ `null`: The wrapped component.

_Returns_

-   `null`: Component with an instanceId prop.
...
-   _OriginalComponent_ `null`: Component requiring setTimeout

_Returns_

-   `null`: Wrapped component.
