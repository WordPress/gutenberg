 ...
 * @param {Array} updateConditions - Boolean conditions on when to apply updates
 *
...
function useModifiedStyles( baseStyles, modifiers ) {
...
export default useModifiedStyles;
