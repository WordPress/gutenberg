...
describe('useMergeRefs', () => {
	...
	function MergedRefs({
		...
		const mergedRefs = useMergeRefs([!disable1 && ref1, !disable2 && ref2]);
	...
	it('should simultaneously update node and dependencies', () => {
		...
		ReactDOM.render(<MergedRefs count={2} tagName="button" />, rootElement);
	...
	it('should work for dependency change after node change', () => {
		...
		ReactDOM.render(<MergedRefs tagName="button" count={1} />, rootElement);
