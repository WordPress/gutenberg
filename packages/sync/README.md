...
-   _userInfo1_ `UserInfo`: - The first user info.
-   _userInfo2_ `UserInfo`: - The second user info.

_Returns_

-   `boolean`: True if the user infos are equal, false otherwise.
...
-   _currentUser_ `WordPressUserInfo`: - The current user.
-   _existingColors_ `string[]`: - The existing colors.
