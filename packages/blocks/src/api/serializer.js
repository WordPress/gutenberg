...
/**
 * Serialize and clean blocks to handle empty posts and backward compatibility.
 *
 * @param {Block[]} blocks The blocks to process.
 *
 * @return {string} The serialized result of rendering the `blocks`.
 */
