...
Average time to first paint: ${success(round(average(firstPaint)) + 'ms')}
...
Average time to first block: ${success(round(average(firstBlock)) + 'ms')}`);
		}
...
Slowest time to type character: ${success(round(Math.max(...type)) + 'ms')}
Fastest time to type character: ${success(round(Math.min(...type)) + 'ms')}`);
		}
...
Slowest time to select a block: ${success(round(Math.max(...focus)) + 'ms')}
Fastest time to select a block: ${success(round(Math.min(...focus)) + 'ms')}`);
		}
...
Average time to open list view: ${success(round(average(listViewOpen)) + 'ms')}
