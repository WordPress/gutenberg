...
describe('Sidebar', () => {
	...
	it('should be possible to programmatically remove Document Settings panels', async () => {
		...
		expect(await page.$x(getPanelToggleSelector('Categories'))).toEqual([]);
		expect(await page.$x(getPanelToggleSelector('Tags'))).toEqual([]);
		expect(await page.$x(getPanelToggleSelector('Featured image'))).toEqual(
			[]
		);
		expect(await page.$x(getPanelToggleSelector('Excerpt'))).toEqual([]);
		expect(await page.$x(getPanelToggleSelector('Discussion'))).toEqual([]);
		expect(
