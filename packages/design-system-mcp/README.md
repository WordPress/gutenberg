...
-   How to compose those components into an interaction, following the design system patterns, like confirming a destructive action or wording an error message
