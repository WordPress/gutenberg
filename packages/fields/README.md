...
This package provides reusable field definitions for displaying post and entity data in DataViews.

**Fields:**
- `titleField` - Post title
- `slugField` - Post slug
- `statusField` - Publication status
- `authorField` - Post author
- `dateField` - Publication date
- `featuredImageField` - Featured image with media picker
...
const fields = [ titleField, featuredImageField, authorField ];
```
