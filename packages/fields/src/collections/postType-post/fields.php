 ...
 * collocated `extensions.ts`, exposed as the `@wordpress/fields/postType-post`
 * script module.
 *
 * This file is copied to `build/scripts/fields/collections/postType-post/fields.php`
...
gutenberg_register_field_collection(
	...
	'post',
	$fields,
	'@wordpress/fields/postType-post'
);
