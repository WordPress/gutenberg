<?php
/**
 * Serializable field definitions for the `core/template-part-fields` field collection.
 *
 * The non-serializable extensions (getValue, render, Edit…) live in the
 * collocated `extensions.ts`, exposed as the
 * `@wordpress/fields/postType-wp_template_part` script module.
 *
 * This file is copied to `build/scripts/fields/collections/postType-wp_template_part/fields.php`
...
gutenberg_register_field_collection(
	...
	'@wordpress/fields/postType-wp_template_part'
);
