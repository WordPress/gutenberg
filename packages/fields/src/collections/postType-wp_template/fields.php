 ...
 * `@wordpress/fields/postType-wp_template` script module.
 *
 * This file is copied to `build/scripts/fields/collections/postType-wp_template/fields.php`
...
gutenberg_register_field_collection(
	...
	'@wordpress/fields/postType-wp_template'
);
