...
type ReduxAction =
	| ReturnType< typeof import('./actions').registerEntityAction >
	| ReturnType< typeof import('./actions').unregisterEntityAction >
	| ReturnType< typeof import('./actions').setIsReady >;
