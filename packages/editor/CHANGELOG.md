...
-   Notes: Badge the "All notes" toolbar toggle with the number of unresolved note threads carrying activity you have not seen. Your own notes never count, opening the sidebar clears the badge, and counts above 9 display as "9+" while assistive technology is given the exact number ([#81940](https://github.com/WordPress/gutenberg/issues/81940)).
