...
-   Template actions panel: Only offer editing the template to users who can create templates, like the post template panel. ([#](https://github.com/WordPress/gutenberg/pull/))
