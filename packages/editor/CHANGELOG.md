...
-   Add a `blockStatesEnabled` editor setting, defaulting to `true`, which hides state controls for blocks in the block inspector and Global Styles when set to `false` ([#80850](https://github.com/WordPress/gutenberg/issues/80850)).
