...
-   RTC: Keep collaborator multi-block selection overlays visible for remaining blocks when a selection endpoint is deleted ([#79867](https://github.com/WordPress/gutenberg/issues/79867)).
