...
-   Visual Revisions: Fix autosave diff comparison when viewing an autosave with no older revisions so unchanged base blocks are not highlighted as additions ([#80455](https://github.com/WordPress/gutenberg/issues/80455)).
