...
-   Visual Revisions: Fix autosave diff comparison when viewing an autosave with no older revisions so unchanged base blocks are not highlighted as additions ([#83342](https://github.com/WordPress/gutenberg/pull/83342)).
