 ...
 * @property {string}        fontLibraryAssetInstall Whether font face assets can, should or shouldn't be copied to the server.
 *                                                   'required' = Font collection assets are always installed locally.  This is the default.
 *                                                   'allowed'  = Font collection assets are installed locally unless a collection is configured to allow hosting.
 *                                                   'denied'   = Font upload is not allowed, only font collections that are configured to allow hosting can be used.
