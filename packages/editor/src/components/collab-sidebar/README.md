...
├── floating-notes.tsx               FloatingNotes - canvas overlay + reserved canvas space (slot fill rendered by VisualEditor)
├── notes-display-mode-menu.tsx      NotesDisplayModeMenu - "Notes" submenu of the Options menu (Hide / Minimize / Expand)
│
