 ...
 *                              inserter items.
 *
 * @return {Array<import('@wordpress/block-editor').EditorInserterItem>} The inserter items for the specified
 *                                      parent.
 */
 ...
 *
 * @return {import('@wordpress/components').Completer} A blocks completer.
 */
