 ...
 * @return Comparison key, or null for non-string-like values.
 */
export function contentKey( value: any ): string | null {
	...
	const handleContentEdit = useCallback(
		( request: any ) => {
			...
			if (
				...
				! actions.every(
					( action: any ) =>
						action.newNote || action.type === 'grow-add'
				) ||
