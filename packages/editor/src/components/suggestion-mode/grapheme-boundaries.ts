 ...
 *
 * @param text   Plain text (UTF-16 code units).
 * @param offset Offset to step back from.
 * @return Boundary offset, clamped to `[0, text.length]`.
 */
export function previousGraphemeBoundary( text: any, offset: number ): number {
 ...
 *
 * @param text   Plain text (UTF-16 code units).
 * @param offset Offset to step forward from.
 * @return Boundary offset, clamped to `[0, text.length]`.
 */
export function nextGraphemeBoundary( text: any, offset: number ): number {
