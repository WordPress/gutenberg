...
function EditorHistoryRedo( props, ref ) {
	...
	const hasRedo = useSelect( ( select ) => {
		/*
		 * Redo rewrites the post, so the read-only Viewing intent refuses it
		 * the same way it refuses a keystroke. `redo` in the editor store
		...
		return select( editorStore ).hasEditorRedo();
	}, [] );
