...
-   Add `cornerRadius` prop to `ThemeProvider` for configuring the border-radius preset (`none`, `sm`, `md`, `lg`, `xl`, `2xl`) via prebuilt design token modes. [#78816](https://github.com/WordPress/gutenberg/pull/78816).
