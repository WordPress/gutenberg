...
-   Return contrast warnings for the final generated ramp and include active fill pairs in accessibility checks ([#81185](https://github.com/WordPress/gutenberg/pull/81185)).
