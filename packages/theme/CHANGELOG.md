...
-   Interpolate cached chroma capacity so intent background colors remain distinct near lightness boundaries. ([#82591](https://github.com/WordPress/gutenberg/pull/82591))
