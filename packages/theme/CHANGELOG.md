...
-   Export `@wordpress/theme/utils` with a generated `var()` Sass function for compile-time design token fallback injection ([#78698](https://github.com/WordPress/gutenberg/pull/78698)).
