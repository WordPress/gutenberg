...
-   Skip unused ramp outputs and redundant base foreground solves, and calculate status interaction colors only when contrast correction needs them. Preserve semantic colors and contrast checks. ([#82528](https://github.com/WordPress/gutenberg/pull/82528))
