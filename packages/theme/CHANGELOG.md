...
-   Expose default legacy `--wp-components-*` color aliases in the generated design token CSS, while preserving scoped runtime overrides for custom `ThemeProvider` colors ([#79772](https://github.com/WordPress/gutenberg/pull/79772)).
