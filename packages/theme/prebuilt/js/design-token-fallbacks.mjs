...
export default {
	...
	'--wpds-color-background-interactive-error-weak-active': '#f8e5e2',
	...
	'--wpds-color-background-surface-error': '#f8e5e2',
	...
	'--wpds-color-foreground-content-success-weak': '#2f7c43',
	'--wpds-color-foreground-content-warning': '#2e1900',
	'--wpds-color-foreground-content-warning-weak': '#886725',
