...
export default {
	...
	'--wpds-color-foreground-interactive-brand':
		'color-mix(in oklch, var(--wp-admin-theme-color, #3858e9) 98%, black)',
	...
	'--wpds-color-foreground-interactive-error': '#be1616',
	...
	'--wpds-color-foreground-interactive-neutral': '#646464',
