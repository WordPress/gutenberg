...
export default {
	...
	'--wpds-color-foreground-interactive-error-active': '#a30000',
	...
	'--wpds-color-foreground-interactive-neutral-active': '#4f4f4f',
	...
	'--wpds-color-foreground-interactive-neutral-weak-active': '#4f4f4f',
