...
export default {
	...
	'--wpds-color-background-interactive-brand-strong-disabled': '#e3e3e3',
	...
	'--wpds-color-background-interactive-error-strong-disabled': '#e3e3e3',
	'--wpds-color-background-interactive-error-weak': '#0000',
	'--wpds-color-background-interactive-error-weak-active': '#fce7e3',
	...
	'--wpds-color-background-interactive-neutral-strong-disabled': '#e3e3e3',
	'--wpds-color-background-interactive-neutral-weak': '#0000',
	'--wpds-color-background-interactive-neutral-weak-active': '#efefef',
	'--wpds-color-background-interactive-neutral-weak-disabled': '#0000',
	'--wpds-color-background-surface-brand':
		'color-mix(in oklch, var(--wp-admin-theme-color, #3858e9) 8%, white)',
	'--wpds-color-background-surface-caution': '#ffea96',
	'--wpds-color-background-surface-caution-weak': '#fff9ca',
	'--wpds-color-background-surface-error': '#fce7e3',
	'--wpds-color-background-surface-error-weak': '#fff6f5',
	'--wpds-color-background-surface-info': '#e0edfc',
	...
	'--wpds-color-background-surface-neutral-weak': '#f7f7f7',
	'--wpds-color-background-surface-success': '#c5fbcd',
	'--wpds-color-background-surface-success-weak': '#ebffed',
	'--wpds-color-background-surface-warning': '#ffe8c0',
	...
	'--wpds-color-foreground-content-caution': '#5c4f16',
	'--wpds-color-foreground-content-caution-weak': '#7c6c21',
	'--wpds-color-foreground-content-error': '#980f0f',
	'--wpds-color-foreground-content-error-weak': '#d81a1a',
	'--wpds-color-foreground-content-info': '#005092',
	'--wpds-color-foreground-content-info-weak': '#006fc7',
	'--wpds-color-foreground-content-neutral': '#505050',
	'--wpds-color-foreground-content-neutral-weak': '#717171',
	'--wpds-color-foreground-content-success': '#215b2f',
	'--wpds-color-foreground-content-success-weak': '#307e44',
	'--wpds-color-foreground-content-warning': '#654c19',
	'--wpds-color-foreground-content-warning-weak': '#886726',
	'--wpds-color-foreground-interactive-brand':
		'color-mix(in oklch, var(--wp-admin-theme-color, #3858e9) 88%, black)',
	'--wpds-color-foreground-interactive-brand-active':
		'color-mix(in oklch, var(--wp-admin-theme-color, #3858e9) 35%, black)',
	...
	'--wpds-color-foreground-interactive-error': '#980f0f',
	'--wpds-color-foreground-interactive-error-active': '#260101',
	'--wpds-color-foreground-interactive-error-disabled': '#8d8d8d',
	'--wpds-color-foreground-interactive-error-strong': '#eae6e5',
	'--wpds-color-foreground-interactive-error-strong-active': '#eae6e5',
	'--wpds-color-foreground-interactive-error-strong-disabled': '#8d8d8d',
	'--wpds-color-foreground-interactive-neutral': '#505050',
	'--wpds-color-foreground-interactive-neutral-active': '#141414',
	...
	'--wpds-color-foreground-interactive-neutral-weak': '#717171',
	'--wpds-color-foreground-interactive-neutral-weak-active': '#141414',
	...
	'--wpds-color-stroke-surface-brand-strong':
		'var(--wp-admin-theme-color, #3858e9)',
	'--wpds-color-stroke-surface-caution': '#d0c28b',
	'--wpds-color-stroke-surface-caution-strong': '#836a00',
	'--wpds-color-stroke-surface-error': '#e0afa7',
	'--wpds-color-stroke-surface-error-strong': '#cc1818',
	'--wpds-color-stroke-surface-info': '#adc6e2',
	...
	'--wpds-color-stroke-surface-success': '#92d39d',
	'--wpds-color-stroke-surface-success-strong': '#008030',
	'--wpds-color-stroke-surface-warning': '#e1bd7c',
	'--wpds-color-stroke-surface-warning-strong': '#936300',
