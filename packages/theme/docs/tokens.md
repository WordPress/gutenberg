...
| --------------------------- | ------------------------------- |
| `--wpds-border-radius-xs`   | Extra small radius for surfaces |
| `--wpds-border-radius-sm`   | Small radius for surfaces       |
| `--wpds-border-radius-md`   | Medium radius for surfaces      |
| `--wpds-border-radius-lg`   | Large radius for surfaces       |
| `--wpds-border-width-xs`    | Extra small width for surfaces  |
| `--wpds-border-width-sm`    | Small width for surfaces        |
| `--wpds-border-width-md`    | Medium width for surfaces       |
| `--wpds-border-width-lg`    | Large width for surfaces        |
