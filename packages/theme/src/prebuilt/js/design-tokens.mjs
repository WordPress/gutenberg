...
export const tokens = {
	...
	'--wpds-font-weight-medium': {
		$description:
			'Medium font weight for emphasis and headings. Uses 499 instead of 500 to work around a Chrome bug where 500 renders as 600 when the exact weight is unavailable. See: https://issues.chromium.org/issues/40552893',
		$type: 'fontWeight',
		group: 'typography',
		modes: {
			default: {
