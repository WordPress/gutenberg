...
export default {
	...
	'--wpds-dimension-width-2xl': '960px',
	'--wpds-dimension-width-lg': '560px',
	'--wpds-dimension-width-md': '400px',
	'--wpds-dimension-width-sm': '320px',
	'--wpds-dimension-width-xl': '720px',
	'--wpds-dimension-width-xs': '240px',
	'--wpds-elevation-lg':
