...
-   `Page`: Add a `navigation` prop (`{ items, currentHref, components }`) for link-based navigation between sections, rendered in the page header ([#79746](https://github.com/WordPress/gutenberg/pull/79746)).
