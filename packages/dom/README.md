...
-   _node_ `Node | null`: Node from which to start.
...
-   `element is HTMLInputElement`: True if the element is input and holds a number.
...
-   `HTMLElement is HTMLElement`: True if the element is a text input, textarea, or contenteditable.
