...
<a name="wpDataDispatch" href="#wpDataDispatch">#</a> **wpDataDispatch**

Dispatches from the WordPress data module.

_Parameters_

-   _store_ `string`: Store to dispatch from e.g: core/editor, core/blocks...
-   _action_ `string`: Action to dispatch e.g: selectBlock.
-   _parameters_ `[...*]`: Parameters to pass to dispatch action.
