...
export const data: ComponentData[] = [
	...
	},
	{
		...
		notes: 'Overall design review needed. This component is a fallback for themes that do not supply spacing presets. Most of the time `SpacingSizesControl` is used instead.',
	},
	{
		id: 'button',
		name: 'Button',
	...
	},
	{
		...
		notes: 'If possible, use `ToggleControl` instead. (May be absorbed by `ToggleControl` once it supports more customization.)',
	},
	{
		id: 'form-token-field',
		name: 'FormTokenField',
	...
	},
	{
		...
		notes: 'Values are not aligned with the current design system. Prefer using Sass variables from `@wordpress/base-styles` instead.',
	},
	{
		id: 'icon',
		name: 'Icon',
	...
	},
	{
		...
		notes: 'If possible, use this component instead of `DropdownMenu`. It may still be marked as private but is pretty much ready.',
	},
	{
		id: 'menu-group',
		name: 'MenuGroup',
	...
	},
	{
		...
		notes: 'A design update is in the works.',
	},
	{
		id: 'number-control',
		name: 'NumberControl',
	...
	},
	{
		...
		notes: 'This is an internal experiment and not meant for external use. An official theming solution is in the works.',
	},
	{
		id: 'time-picker',
		name: 'TimePicker',
