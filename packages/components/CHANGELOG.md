...
-   `FontSizePicker`: Remove the negative top margin on the header toggle so it stays centered on the label row ([#80649](https://github.com/WordPress/gutenberg/pull/80649)).
