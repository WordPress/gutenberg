...
-   `ColorPalette`: Add support for rendering custom content between the custom color picker and the color options via the new `children` prop ([#77279](https://github.com/WordPress/gutenberg/pull/77279)).
