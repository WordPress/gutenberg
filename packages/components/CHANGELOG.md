...
-   Update emphasized labels and controls from medium (`499`) to semibold (`600`) font weight, and align the default font-family stack with the `@wordpress/theme` body token ([#80093](https://github.com/WordPress/gutenberg/pull/80093)).
