...
-   `Modal`: Wrap modal content in `ThemeProvider` so portaled modals reapply inherited design tokens from ancestor providers.
-   `Popover`: Wrap popover content in `ThemeProvider` so portaled popovers reapply inherited design tokens from ancestor providers ([#81183](https://github.com/WordPress/gutenberg/pull/81183)).
