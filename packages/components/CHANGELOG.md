...
-   `Button`: Pair primary foreground and background colors by state when used with `ThemeProvider`, while preserving legacy color variable overrides ([#82506](https://github.com/WordPress/gutenberg/pull/82506)).
