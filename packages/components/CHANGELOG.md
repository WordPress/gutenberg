...
-   `Notice`: Add `disabled`, `target`, and `rel` props to action buttons. Also allow `onClick` to work alongside `url` ([#74094](https://github.com/WordPress/gutenberg/pull/74094)).
