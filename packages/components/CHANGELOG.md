...
-   `InputControl`: Hide the value-like placeholder Safari renders in empty date and time inputs (e.g. `12:30`), which was indistinguishable from a committed value ([#](https://github.com/WordPress/gutenberg/issues/)).
