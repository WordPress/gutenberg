...
-   `ExternalLink`: No longer adds `noopener` to the `rel` attribute. Consumers relying on the previous behavior should pass `rel="noopener"` explicitly ([#79743](https://github.com/WordPress/gutenberg/pull/79743)).
