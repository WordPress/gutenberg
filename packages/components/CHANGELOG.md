...
-   `FocalPointPicker`: Keep a surrounding scroll container from gaining a horizontal scrollbar when the focal point sits on an edge, without clipping the handle ([#83329](https://github.com/WordPress/gutenberg/pull/83329)).
