...
-   `Notice`: Add `disabled` and `openInNewTab` props to action buttons. Also allow `onClick` to work alongside `url` ([#74094](https://github.com/WordPress/gutenberg/pull/74094)).
