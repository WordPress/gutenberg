...
-   `CircularOptionPicker`: Updated to show outline via design system's mixin for focus ring instead of previous outline implementation ([#82521](https://github.com/WordPress/gutenberg/pull/82521)).
