...
UseCompositeStorePlaceholder.displayName = 'useStore';
UseCompositeStorePlaceholder.ariakitAliasName = 'useStore';
...
export function transform( code: string, context: StoryContext ) {
	...
	return [
		...
		// `Composite.useStore` to convert store options into
		// a composite store prop.
		`const store = Composite.useStore(${ state });`,
		'',
		'return (',
		'  ' +
			code
