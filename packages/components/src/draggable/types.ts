...
export type DraggableProps = {
	 ...
	 *
	 * Note: this prop has no effect when the `@wordpress/ui` compat overlay
	 * slot is in effect and lives in the same document as the dragged
	 * element. In that case the clone is placed in the slot regardless of
	 * this prop. Cross-document drags (e.g. dragging an element inside an
	 * iframe while the slot is in the parent document) fall back to this
	 * prop's regular semantics.
	 *
	 * @default false
	 */
