...
export const _default = () => {
	const itemGroupProps = {
		...
		size: select('ItemGroup: size', ['small', 'medium', 'large'], 'medium'),
	};
...
export const dropdown = () => (
	<Flyout style={{ width: '350px' }} trigger={<Button>Open Popover</Button>}>
		...
		<ItemGroup isBordered isSeparated style={{ width: '250px' }}>
			...
			<Item onClick={() => alert('Single typography setting')}>
				<HStack justify="flex-start">
					...
					<FlexItem as={Truncate}>Single typography setting</FlexItem>
				</HStack>
			</Item>
