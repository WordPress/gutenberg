...
describe('Text', () => {
	...
	test('should render variant', () => {
		const { container } = render(<Text variant="muted">Lorem ipsum.</Text>);
		expect(container.firstChild).toHaveStyle({
	...
	test('should render align', () => {
		const { container } = render(<Text align="center">Lorem ipsum.</Text>);
		expect(container.firstChild).toHaveStyle({ textAlign: 'center' });
	});

	test('should render color', () => {
		const { container } = render(<Text color="orange">Lorem ipsum.</Text>);
	...
	test('should render weight', () => {
		const { container } = render(<Text weight={700}>Lorem ipsum.</Text>);
