 ...
 * @param {boolean} props.isShiftStepEnabled Determines if jumping values with shift is enabled
 * @param {number} props.shiftStep Multiplier to jump by, when holding shift key.
 * @param {number} props.step Multiplier to jump by, when not-holding shift key.
