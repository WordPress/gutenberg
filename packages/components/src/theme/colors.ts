...
const defaultPaletteParams: PaletteParams = {
	...
	darkColorLightnessValues: [
		0.1, 0.11, 0.13, 0.19, 0.22, 0.25, 0.31, 0.39, 0.54, 0.67, 0.75, 0.8, 0.93,
	],
	darkGrayLightnessValues: [
		0.09, 0.1, 0.11, 0.16, 0.19, 0.22, 0.18, 0.29, 0.38, 0.43, 0.55, 0.69, 0.93,
	],
	saturationFinetune: [
		1, 0.95, 0.95, 0.95, 0.97, 0.97, 0.97, 0.97, 0.97, 1, 1, 0.7, 0.6,
	],
	fun: 0.15,
