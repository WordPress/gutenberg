...
const defaultPaletteParams: PaletteParams = {
	...
	colorLightnessValues: [
		1, 0.99, 0.98, 0.97, 0.95, 0.93, 0.89, 0.83, 0.74, 0.56, 0.52, 0.47, 0.25,
	],
	grayLightnessValues: [
		1, 0.99, 0.98, 0.95, 0.92, 0.89, 0.87, 0.83, 0.73, 0.55, 0.48, 0.39, 0.13,
	],
	darkColorLightnessValues: [
		0.1, 0.1, 0.13, 0.19, 0.22, 0.25, 0.31, 0.39, 0.54, 0.57, 0.64, 0.8, 0.93,
	],
	darkGrayLightnessValues: [
		0.09, 0.09, 0.11, 0.16, 0.19, 0.22, 0.18, 0.29, 0.38, 0.43, 0.55, 0.69, 0.93,
	],
	saturationFinetune: [
		1, 0.95, 0.95, 0.95, 0.97, 0.97, 0.97, 0.97, 0.97, 0.9, 0.8, 0.7, 0.6,
	],
	fun: 0.4,
