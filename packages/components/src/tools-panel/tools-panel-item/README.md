...
not trigger it, including an item becoming visible because it received a value
or because `defaultShown` was set, and an item hiding because its value was
removed or because `Reset all` ran.
