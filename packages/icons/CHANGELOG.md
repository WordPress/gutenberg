...
-   The build now generates an `icons.json` file at the package root, mapping each icon slug to its raw SVG markup so PHP and other non-JavaScript consumers can render icons. ([#73796](https://github.com/WordPress/gutenberg/issues/73796))
