...
-   `manifest.json`: New `admin` property, set on the icons the WordPress admin interface renders. It ships the icon to WordPress Core and registers it in the new `core-admin` collection, which is not public, so unregistering `core` cannot take the icon away from the admin interface. ([#83261](https://github.com/WordPress/gutenberg/pull/83261), [#79451](https://github.com/WordPress/gutenberg/pull/79451))
