...
-   Move the icon registry's `public` property from individual icons to collections and restore PHP manifest generation to include only icons with `public: true` ([#83277](https://github.com/WordPress/gutenberg/pull/83277)).
