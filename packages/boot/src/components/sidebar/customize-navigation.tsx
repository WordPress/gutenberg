...
export default function CustomizeNavigation() {
	...
	return (
		<div className={ styles.customize }>
			<div className={ styles[ 'customize-heading' ] }>
				{ __( 'Customize navigation' ) }
			</div>
			<div className={ styles[ 'customize-sections' ] }>
				{ layout.sections.map( ( section ) => {
					...
					return (
						<div
							key={ section.id }
							className={ clsx( styles[ 'customize-section' ], {
						...
						>
							<div
								className={
									styles[ 'customize-section-header' ]
								}
							>
								{ section.id !== DEFAULT_SECTION_ID && (
									<Button
								...
								{ section.isCustom ? (
									...
									<div
										className={
											styles[ 'customize-section-title' ]
										}
									>
										{ section.label }
									</div>
							...
							<div
								className={
									styles[ 'customize-section-items' ]
								}
								onDragOver={ ( event ) => {
									if (
							...
							>
								{ sectionItems.length === 0 && (
									<div
										className={
											styles[ 'customize-empty-section' ]
										}
									>
										{ __( 'Drop items here' ) }
									</div>
