...
ruleTester.run( 'use-recommended-components', rule, {
	valid: [
		...
		"import { Badge, Icon, Input, InputControl, InputLayout, Link, Stack, Tabs, Text, Tooltip } from '@wordpress/ui';",
	...
	invalid: [
		...
		{
			code: "import { InputControl } from '@wordpress/components';",
			errors: [
				{
					message: 'Use `InputControl` from `@wordpress/ui` instead.',
				},
			],
		},
		{
			code: "import { NumberControl } from '@wordpress/components';",
			errors: [
				{
					message:
