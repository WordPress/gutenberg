...
-   Update `use-recommended-components` rule to mark `Input`, `InputControl`, and `InputLayout` from `@wordpress/ui` as recommended, and to prefer them over legacy `@wordpress/components` input controls ([#81658](https://github.com/WordPress/gutenberg/pull/81658)).
