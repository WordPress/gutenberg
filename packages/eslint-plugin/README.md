...
| [jsdoc-valid-since](https://github.com/WordPress/gutenberg/tree/HEAD/packages/eslint-plugin/docs/rules/jsdoc-valid-since.md)                                         | Enforce semantic versions in `@since` tags while allowing optional descriptions.                | ✓           |
