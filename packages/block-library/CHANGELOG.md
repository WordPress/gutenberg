...
-   Icon: Preserve intrinsic SVG styles when applying block styles, and keep stroke widths scaling with the block's size for compatibility ([#78808](https://github.com/WordPress/gutenberg/pull/78808)).
