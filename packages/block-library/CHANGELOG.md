...
-   Math: Align the cells of `aligned`, `cases` and tagged equations in Chromium and Safari by shipping the two `text-align` rules temml's MathML relies on, in `common.scss` so inline math is covered too ([#83007](https://github.com/WordPress/gutenberg/pull/83007)).
