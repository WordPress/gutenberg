...
-   Tab Panel: Show the tab's title in the Document Overview instead of the generic block title, so tabs can be told apart ([#81412](https://github.com/WordPress/gutenberg/issues/81412)).
