...
-   Image: Show rich captions in the lightbox with a single dialog scroll area, keyboard access to caption links, and support for picture-wrapped images. Keep Enlarge controls visible on touch devices and avoid exposing caption text as a clickable control ([#83325](https://github.com/WordPress/gutenberg/pull/83325)).
