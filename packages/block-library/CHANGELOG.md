...
-   Query Pagination: Say in the "Show label text" help that a hidden label is still announced to screen reader users, so editors know the text stays available to assistive technology ([#83160](https://github.com/WordPress/gutenberg/pull/83160)).
