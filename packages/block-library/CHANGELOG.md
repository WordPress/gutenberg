...
-   List: Declare `reversed` with its `false` default, so both runtimes read the same value out of list markup ([#82013](https://github.com/WordPress/gutenberg/pull/82013)).
