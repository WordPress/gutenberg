...
-   Media & Text: Add caption and Enlarge on click (lightbox) options for the media side, matching the Image block ([#81026](https://github.com/WordPress/gutenberg/issues/81026)).
