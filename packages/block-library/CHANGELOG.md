...
-   Math: Align the cells of `aligned`, `cases` and tagged equations in Chromium and Safari, in the Math block and in inline math ([#81019](https://github.com/WordPress/gutenberg/pull/81019)).
