...
-   Navigation: Give the block appender an explicit width so it renders square, matching the appender in other container blocks ([#82703](https://github.com/WordPress/gutenberg/issues/82703)).
