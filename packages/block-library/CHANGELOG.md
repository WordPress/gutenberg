...
-   Image: Show visible, accessible rich captions in the lightbox, with a single dialog scroll area, keyboard access to caption links, and support for picture-wrapped images ([#83325](https://github.com/WordPress/gutenberg/pull/83325)).
