...
-   Math: Ship temml's stylesheet with the block and load it whenever a rendered block contains MathML, so `\overline`, `\boxed`, `\cancel`, aligned columns and equation numbers render in Chromium, in the block and in inline math ([#83096](https://github.com/WordPress/gutenberg/pull/83096)).
