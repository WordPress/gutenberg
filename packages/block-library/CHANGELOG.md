...
-   Tabs: Start new tabs with an empty label showing a "Tab title" placeholder instead of a generic "Tab", and add a `placeholder` attribute to Tab Panel so patterns and templates can customize the prompt ([#81009](https://github.com/WordPress/gutenberg/pull/81009)).
