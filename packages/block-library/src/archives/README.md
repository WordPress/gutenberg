...
- [block.json](https://github.com/WordPress/gutenberg/tree/trunk/packages/block-library/src/archives/block.json) ([reference](/block-editor/reference-guides/block-api/block-metadata/))
