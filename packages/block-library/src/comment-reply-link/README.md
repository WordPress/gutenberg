...
```html
<!-- wp:comment-reply-link { /* attributes */ } /-->
```

_See the [canonical markup fixture](https://github.com/WordPress/gutenberg/tree/trunk/test/integration/fixtures/blocks/core__comment-reply-link.html) for a tested real-world example._
