...
- [Source directory](https://github.com/WordPress/gutenberg/tree/trunk/packages/block-library/src/post-navigation-link/) — browse `edit.js`, `save.js`, `index.php`, and more.
