...
export default function PostNavigationLinkEdit( {
	...
	/*
	 * Border and spacing serialization is skipped for this block so the styles
	 * are not applied to the empty wrapper the front end renders when there is
	 * no adjacent post. The editor always renders the link, so they always
	 * apply here.
	 */
