...
- **color**: `.wp-block-navigation-item__content`
- **states**:
...
- [Source directory](https://github.com/WordPress/gutenberg/tree/trunk/packages/block-library/src/navigation-link/) — browse the `edit` and `save` source files, `index.php`, and more.
