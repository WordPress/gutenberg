...
- [Source directory](https://github.com/WordPress/gutenberg/tree/trunk/packages/block-library/src/latest-posts/) — browse the `edit` and `save` source files, `index.php`, and more.
