...
const deprecated = [
	// After this version we are using block supports for min-height
	// The migration for this deprecation combine and remap former
	// minHeight and minHeightUnit attributes to style.minHeight.
	// core__cover__deprecated-7.html
	{
		attributes: {
			...blockAttributes,
			title: {
		...
		// This version uses min-height values and units via attributes.
		// Min-height is controlled by block supports going forward.
		migrate: ( attributes ) => {
			const { minHeight, minHeightUnit, style } = attributes;
			return {
				...attributes,
				style: {
					...style,
