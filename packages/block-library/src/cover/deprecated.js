...
// Deprecation for blocks that used the embed-video background type.
// The feature was removed; existing blocks have their embed-video state cleared.
const v15 = {
	attributes: v15BlockAttributes,
	supports: v15BlockSupports,
	isEligible( attributes ) {
		return attributes?.backgroundType === 'embed-video';
	},
	migrate( attributes ) {
		const {
			url,
	...
	save( { attributes } ) {
		...
		const isEmbedVideoBackground = 'embed-video' === backgroundType;
