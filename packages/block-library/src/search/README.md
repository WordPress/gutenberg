...
- **dimensions**:
  - width: `.wp-block-search .wp-block-search__inside-wrapper`
...
- [Source directory](https://github.com/WordPress/gutenberg/tree/trunk/packages/block-library/src/search/) — browse the `edit` and `save` source files, `index.php`, and more.
