...
function render_block_core_search( $attributes ) {
	...
	if ( $show_button ) {
		...
		if ( ! $use_icon_button ) {
			...
			$button_internal_markup =
				'<svg class="search-icon" viewBox="0 0 24 24" width="24" height="24" style="fill: none" stroke="currentColor" stroke-width="1.5">
					<path d="M5 19L9.28769 14.7123M18.25 11C18.25 13.8995 15.8995 16.25 13 16.25C10.1005 16.25 7.75 13.8995 7.75 11C7.75 8.10051 10.1005 5.75 13 5.75C15.8995 5.75 18.25 8.10051 18.25 11Z" vector-effect="non-scaling-stroke"></path>
				</svg>';
		}
