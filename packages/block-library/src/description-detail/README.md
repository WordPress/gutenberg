...
- [Source directory](https://github.com/WordPress/gutenberg/tree/trunk/packages/block-library/src/description-detail/) — browse `edit.js`, `save.js`, `index.php`, and more.
