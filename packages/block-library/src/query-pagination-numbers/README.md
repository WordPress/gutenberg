...
- [Source directory](https://github.com/WordPress/gutenberg/tree/trunk/packages/block-library/src/query-pagination-numbers/) — browse `edit.js`, `save.js`, `index.php`, and more.
