...
function block_core_navigation_parse_blocks_from_menu_items( $menu_items, $menu_items_by_parent_id ) {
	_deprecated_function( __FUNCTION__, '5.8.0', 'WP_Navigation_Gutenberg::parse_blocks_from_menu_items' );

	return WP_Navigation_Gutenberg::parse_blocks_from_menu_items( $menu_items, $menu_items_by_parent_id );
}
...
function block_core_navigation_get_classic_menu_fallback() {
	_deprecated_function( __FUNCTION__, '5.8.0', 'WP_Navigation_Gutenberg::get_classic_menu_fallback' );

	return WP_Navigation_Gutenberg::get_classic_menu_fallback();
}
...
function block_core_navigation_get_classic_menu_fallback_blocks( $classic_nav_menu ) {
	_deprecated_function( __FUNCTION__, '5.8.0', 'WP_Navigation_Gutenberg::get_classic_menu_fallback_blocks' );

	return WP_Navigation_Gutenberg::get_classic_menu_fallback_blocks( $classic_nav_menu );
}
...
function block_core_navigation_maybe_use_classic_menu_fallback() {
	_deprecated_function( __FUNCTION__, 'X.X.X', 'WP_Navigation_Gutenberg::maybe_use_classic_menu_fallback' );

	return WP_Navigation_Gutenberg::maybe_use_classic_menu_fallback();
}
