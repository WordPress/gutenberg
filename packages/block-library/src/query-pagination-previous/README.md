...
```html
<!-- wp:query-pagination-previous { /* attributes */ } /-->
```

_See the [canonical markup fixture](https://github.com/WordPress/gutenberg/tree/trunk/test/integration/fixtures/blocks/core__query-pagination-previous.html) for a tested real-world example._
