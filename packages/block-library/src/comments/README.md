...
<div class="wp-block-comments comments-post-extra"><!-- wp:comments-title /-->
    ...
    <!-- wp:comment-template -->
    <!-- wp:columns -->
    <div class="wp-block-columns"><!-- wp:column {"style":{"dimensions":{"width":"40px"}}} -->
...
- [Source directory](https://github.com/WordPress/gutenberg/tree/trunk/packages/block-library/src/comments/) — browse the `edit` and `save` source files, `index.php`, and more.
