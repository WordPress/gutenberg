...
| `fallbacks` | `array` | `[]` | [Role](https://developer.wordpress.org/block-editor/reference-guides/block-api/block-attributes/#role): `content` |
...
- [Source directory](https://github.com/WordPress/gutenberg/tree/trunk/packages/block-library/src/embed/) — browse the `edit` and `save` source files, `index.php`, and more.
