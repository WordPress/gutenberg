	...
	echo <<<HTML
		<div
			...
			>
				...
				<button type="button" aria-label="$next_button_label" style="fill: $close_button_color" class="next-button" data-wp-bind--hidden="!state.hasNavigation" data-wp-on--click="actions.showNextImage" data-wp-bind--disabled="!state.hasNextImage">
