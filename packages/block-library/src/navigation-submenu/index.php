...
function render_block_core_navigation_submenu( $attributes, $content, $block ) {
	...
	if ( ! $open_on_click ) {
		...
		if ( $show_submenu_indicators && $has_submenu ) {
			...
			$aria_expanded = 'always' === $submenu_visibility ? '' : ' aria-expanded="false"';
			$html         .= '<button aria-label="' . esc_attr( $aria_label ) . '" class="wp-block-navigation__submenu-icon wp-block-navigation-submenu__toggle"' . $aria_expanded . '>' . block_core_navigation_submenu_render_submenu_icon() . '</button>';
		}
	} else {
		// If menus open on click, we render the parent as a button.
		$aria_expanded = 'always' === $submenu_visibility ? '' : ' aria-expanded="false"';
		$html         .= '<button aria-label="' . esc_attr( $aria_label ) . '" class="wp-block-navigation-item__content wp-block-navigation-submenu__toggle"' . $aria_expanded . '>';
