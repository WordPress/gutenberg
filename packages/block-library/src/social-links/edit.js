...
const sizeOptions = [
	{ name: _x( 'Small', 'size name' ), value: 'has-small-icon-size' },
	{ name: _x( 'Normal', 'size name' ), value: 'has-normal-icon-size' },
	{ name: _x( 'Large', 'size name' ), value: 'has-large-icon-size' },
	{ name: _x( 'Huge', 'size name' ), value: 'has-huge-icon-size' },
];
