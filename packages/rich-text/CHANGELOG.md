...
-   `useRichText`: Show the boundary of the active format or object when the editing host around the element has focus, not only when the element itself does ([#83370](https://github.com/WordPress/gutenberg/pull/83370)).
