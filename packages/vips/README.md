...
Call this from the main thread before processing a JXL image. The URL is expected to be a base64 data URL from the lazily loaded `wasm-vips/vips-jxl.wasm` module.

_Parameters_

-   _url_ `string`: Data URL to the vips-jxl.wasm module.
