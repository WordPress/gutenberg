...
Once set, the next vips operation will re-initialize the vips instance with JXL dynamic library support, enabling JPEG XL encoding and decoding.

_Parameters_

-   _url_ `string`: URL to the vips-jxl.wasm file.
