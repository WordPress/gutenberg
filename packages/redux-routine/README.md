...
-   _controls_ `Record<string, (value: any) => Promise<boolean> | boolean>`: Object of control handlers.

_Returns_

-   `(store: { dispatch: import('redux').Dispatch }) => (next: (action: import('redux').AnyAction) => Promise<unknown>) => (action: import('redux').AnyAction) => Promise<unknown>`: Co-routine runtime
