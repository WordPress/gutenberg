...
-   Add `@wordpress/string` as a bundled package, so consumer builds bundle it instead of externalizing it to a nonexistent `wp-string` script ([#81294](https://github.com/WordPress/gutenberg/pull/81294)).
