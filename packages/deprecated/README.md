...
-   _options_ `object | null`: Personalisation options
    -   _version_ `string | null`: Version in which the feature will be removed.
    -   _alternative_ `string | null`: Feature to use instead
    -   _plugin_ `string | null`: Plugin name if it's a plugin feature
    -   _link_ `string | null`: Link to documentation
    -   _hint_ `string | null`: Additional message to help transition away from the deprecated feature.
