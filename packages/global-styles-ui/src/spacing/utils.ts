 ...
 */
export function parseClampValue( value: string | undefined ): {
 ...
 */
export function generateClampValue(
	min: string | undefined,
	preferred: string | undefined,
	max: string | undefined
): string {
 ...
 */
export function parseComparisonValue( value: string | undefined ) {
	if ( ! value || typeof value !== 'string' ) {
 ...
 */
export function hasAvailableSpacingSizes(
	settings: GlobalStylesSettings | undefined | null
): boolean {
	...
	const defaultEnabled = settings?.spacing?.defaultSpacingSizes || false;
