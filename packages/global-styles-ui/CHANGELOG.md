...
-   Blocks screen: rank search results so a block whose title matches the search is listed before blocks that only match by keyword, category or description.
