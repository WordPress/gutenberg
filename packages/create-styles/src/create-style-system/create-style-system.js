 ...
 * @property {import('create-emotion').ObjectInterpolation<any>} baseStyles The base styles for the theme.
 * @property {TConfig} config The base configuration for the theme.
 * @property {TDarkConfig} darkModeConfig The dark mode config for the theme.
 * @property {THCConfig} highContrastModeConfig The HC mode config for the theme.
 * @property {TDarkHCConfig} darkHighContrastModeConfig The dark HC mode config for the theme.
 * @property {import('../create-compiler').CreateCompilerOptions} [compilerOptions] Options to pass to the compiler for the theme.
 */
...
export function createStyleSystem( options = defaultOptions ) {
	 ...
	 *
	 * @param {import('react').ComponentProps<BaseThemeProvider>} props
	 */
	const ThemeProvider = (
