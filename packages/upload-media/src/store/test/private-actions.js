...
describe( 'private actions', () => {
	...
	describe( 'prepareItem HEIC conversion failures', () => {
		// prepareItem runs as an operation handler: it throws to fail the
		// item and runOperation turns the rejection into cancelItem.
		function runPrepareItem() {
			...
			return prepareItem( 'heic-id' )( { select, dispatch } );
		}
		...
		it( 'reports a browser with no HEIC decoder as a decode error', async () => {
			...
			await expect( runPrepareItem() ).rejects.toMatchObject( {
