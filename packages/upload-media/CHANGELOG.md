...
-   Add a `media.exifOrientation` JavaScript filter to correct or skip client-side EXIF rotation, mirroring the server-side `wp_image_maybe_exif_rotate` PHP filter ([#79384](https://github.com/WordPress/gutenberg/pull/79384)).
