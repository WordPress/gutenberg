...
-   `Record< string, ImageSizeCrop >`: Image sizes record.
...
-   _state_ `State`: Upload state.
-   _name_ `string`: Image size name.z

_Returns_

-   `ImageSizeCrop | undefined`: Image size configuration or undefined if not found.
