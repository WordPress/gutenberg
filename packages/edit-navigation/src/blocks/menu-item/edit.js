...
export default function MenuItemEdit( {
	...
	const blockProps = useBlockProps( {
		ref: listItemRef,
		className: classnames( 'wp-block-menu-item', {
	...
	const innerBlocksProps = useInnerBlocksProps(
		{
			className: classnames( 'wp-block-menu-item__submenu-container', {
	...
	const classes = classnames( 'wp-block-menu-item__content', {
		'wp-block-menu-item__placeholder': ! url,
	} );
	...
	return (
		<Fragment>
			...
			<div { ...blockProps }>
				{ hasDescendants && (
					<span className="wp-block-menu-item__submenu-icon">
						<ItemSubmenuIcon />
					</span>
				) }
				...
				<a className={ classes }>
					{ /* eslint-enable */ }
					{ ! url ? (
						<div className="wp-block-menu-item__placeholder-text">
							<KeyboardShortcuts
								shortcuts={ {
									enter: () =>
						...
						<RichText
							ref={ ref }
							identifier="label"
							className="wp-block-menu-item__label"
							value={ label }
							onChange={ ( labelValue ) =>
					...
					{ isLinkOpen && (
						...
						>
							...
							/>
							<LinkControl
								className="wp-block-menu-item__inline-link-input"
								value={ link }
