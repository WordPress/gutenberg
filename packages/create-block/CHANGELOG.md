...
### New Features
-    Add `npmDevDependencies` template variable to allow definition `devDependencies`as part of a template ([#39723](https://github.com/WordPress/gutenberg/pull/39723)).
