...
describe( 'Formatter', () => {
	it( 'returns markdown', () => {
		...
		expect( docs ).toBe(
			'# API docs\n\n<a name="myDeclaration" href="#myDeclaration">#</a> **myDeclaration** [home/my-path/docs-code.js#L1-L2](home/my-path/docs-code.js#L1-L2)\n\nMy declaration example.\n\n*Parameters*\n\n- `number`: First declaration parameter.\n\n*Returns*\n\n- `number`: The result of the declaration.\n'
		);
	} );
} );
