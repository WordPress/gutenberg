...
-   Patterns: Registered patterns can be edited from the Patterns page; the edit creates a linked copy that stands in for the registered pattern, and "Reset" reverts it ([#YYYYY](https://github.com/WordPress/gutenberg/pull/YYYYY)).
