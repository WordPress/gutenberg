...
-   Refresh the pattern view configuration after deleting a pattern category, so the sidebar no longer lists the deleted category ([#82458](https://github.com/WordPress/gutenberg/pull/82458)).
