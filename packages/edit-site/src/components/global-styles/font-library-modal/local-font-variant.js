            ...
            <FontVariant
                ...
                variantName={ 
                    <HStack spacing={3} justify="flex-start">
                        <span className="font-library-modal__font-name">{fontData?.fontFamily}</span>
                        <span>{fontData?.fontStyle} {fontData?.fontWeight}</span>
                        <span className="font-library-modal__font-filename">{fontData?.file.name}</span>
                    </HStack>
                }
                actionHandler={ 
                    <Button
