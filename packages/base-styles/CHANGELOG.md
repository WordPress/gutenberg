...
-   Add `$font-weight-semibold` (`600`) while retaining `$font-weight-medium` (`499`) for backwards compatibility, and align the legacy font-family variables with the `@wordpress/theme` typography tokens ([#80093](https://github.com/WordPress/gutenberg/pull/80093)).
