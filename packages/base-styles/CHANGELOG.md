...
-   Remove `.block-editor-block-manager__category-title` and `.block-editor-block-manager__disabled-blocks-count` from the `z-index()` helper ([#77759](https://github.com/WordPress/gutenberg/pull/77759)).
