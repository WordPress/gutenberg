...
-   `BlockVariationPicker`: Set icon colors with `color` rather than `fill`, so stroke-based variation icons retain their intended unfilled appearance. ([#78808](https://github.com/WordPress/gutenberg/pull/78808))
