...
-   Inserter: Hide the edited copies of registered patterns from the user patterns lists; they are represented by the registered pattern itself ([#YYYYY](https://github.com/WordPress/gutenberg/pull/YYYYY)).
