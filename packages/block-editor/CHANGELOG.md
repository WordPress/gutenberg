...
-   `ListView`: Limit caret-at-end on keyboard activation to Paragraph. Other blocks, including Table, receive focus on the first editable field so the last cell is not selected.
