...
-   Replace the dotted-underline cue for inherited Global Styles values with a tooltipped indicator button next to the control, which becomes the reset dot once a local override is set ([#00000](https://github.com/WordPress/gutenberg/pull/00000)).
