...
-   `LinkControl`: Show a separate “No results found.” row when a content search returns no matches, while keeping available create actions accessible ([#83481](https://github.com/WordPress/gutenberg/issues/83481)).
