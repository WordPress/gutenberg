...
-   Block hooks: A pattern instance referencing a template part's pattern (`theme/part/slug`) is also an anchor for blocks hooked to `core/template-part` ([#VVVVV](https://github.com/WordPress/gutenberg/pull/VVVVV)).
