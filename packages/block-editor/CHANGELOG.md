...
-   `Iframe`: Intercept clicks on links that would navigate the editor canvas away and unmount the editor, such as links inside a Custom HTML block. The link target is shown in a popover instead, from where it can be opened in a new tab ([#82012](https://github.com/WordPress/gutenberg/issues/82012)).
