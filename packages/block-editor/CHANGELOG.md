...
-   Add support for the `blockStatesEnabled` editor setting, which hides state controls for blocks when set to `false` ([#80850](https://github.com/WordPress/gutenberg/issues/80850)).
