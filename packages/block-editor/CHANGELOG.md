...
-   `BlockManager`: Color block icons with `color` rather than `fill`, so the stroke-based ones take the intended color. ([#78812](https://github.com/WordPress/gutenberg/pull/78812))
