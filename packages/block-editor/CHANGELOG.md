...
-   `BlockCard`: Migrate the block-type badge from the private Components `Badge` to `@wordpress/ui` `Badge`. ([#82440](https://github.com/WordPress/gutenberg/issues/82440)).
