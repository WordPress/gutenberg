...
-   Add support for the `blockStatesEnabled` editor setting, which hides the block-level states control when set to `false` ([#80850](https://github.com/WordPress/gutenberg/issues/80850)).
