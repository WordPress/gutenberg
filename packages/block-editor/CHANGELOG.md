...
-   Block Toolbar: Show the parent block selector for blocks inside patterns and `contentOnly` locked blocks, so the pattern can be selected from the toolbar ([#82912](https://github.com/WordPress/gutenberg/pull/82912)).
