...
describe('actions', () => {
	...
	describe('insertBlocks', () => {
		it('should apply default styles to blocks if blocks do not contain a style', () => {
			...
			insertBlocks(blocks, 5, 'testrootid', false)({ select, dispatch });
	...
	describe('removeBlocks', () => {
		it('should dispatch REMOVE_BLOCKS action', () => {
			...
			expect(dispatch.selectPreviousBlock).toHaveBeenCalledWith(clientId);
	...
	describe('mergeBlocks', () => {
		...
		it('should only focus the blockA if the blockA has no merge function', () => {
			...
			mergeBlocks(blockA.clientId, blockB.clientId)({ select, dispatch });
