 ...
 * @property {string} [imageCrossOrigin] Optional value for requesting images with CORS, allowing them to be used in a `<canvas>` as if they were loaded from the current origin.
