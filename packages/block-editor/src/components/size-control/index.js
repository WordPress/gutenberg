...
/**
 * SizeControl renders a linked unit control and range control for setting the size of anyting.
 *
 ...
 * @param {?boolean}                   props.adaptiveRange Whether the min/max should adapt to the value
 * @param {
 *     {
 ...
 *         }
 *     }
 * }  props.rangeConfig                               The current height value.
 *
