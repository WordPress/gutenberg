		...
		<div className="editor-block-toolbar block-editor-block-toolbar">
			{ mode === 'visual' && isValid && (
				<>
					...
					<BlockControls.Slot bubblesVirtually className="editor-block-toolbar__slot" />
					<BlockFormatControls.Slot bubblesVirtually className="editor-block-toolbar__slot" />
				</>
			) }
			<BlockSettingsMenu clientIds={ blockClientIds } />
		</div>
