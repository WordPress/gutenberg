...
Filters and orders the fetched suggestions before they are shown. Called with the suggestions and an object containing `isInitialSuggestions` and `searchTerm`, and must return the suggestions to display.
