 ...
 * @property {Function=}                  transformSuggestions       Filters and orders the fetched suggestions before they are shown.
 *                                                                   Called with the suggestions and `{ isInitialSuggestions, searchTerm }`,
 *                                                                   and must return the suggestions to display.
