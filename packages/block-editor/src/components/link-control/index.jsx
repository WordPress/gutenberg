 ...
 * @property {Function=}                  transformSuggestions       Private. Only available through `PrivateLinkControl` in
 *                                                                   `privateApis`, and not part of the public LinkControl API.
 *                                                                   Filters and orders the fetched suggestions before they are
