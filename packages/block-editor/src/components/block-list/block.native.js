...
class BlockListBlock extends Component {
	...
	applyBlockStyle() {
		...
		return [
			...
			// remove margin bottom for the last block if parent is not selected (the margin is added to the parent)
			( ! isLastBlock || isParentSelected ) && styles.withMarginBottom,
