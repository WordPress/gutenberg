<?php
/**
 * Serializable field definitions for the `core/navigation-fields` field collection.
 *
 * The non-serializable extensions (getValue, render, Edit…) live in the
 * collocated `extensions.ts`, exposed as the
 * `@wordpress/field-collections/postType-wp_navigation` script module.
 *
 * This file is copied to `build/scripts/field-collections/collections/postType-wp_navigation/fields.php`
...
gutenberg_register_field_collection(
	...
	'@wordpress/field-collections/postType-wp_navigation'
);
