...
/**
 * Non-serializable extensions for the `core/template-part-fields` field
 * collection, loaded on demand as the
 * `@wordpress/field-collections/postType-wp_template_part` script module. The
 ...
 */
const templatePartFieldExtensions: Partial< Field< any > >[] = [
	{
		id: 'author',
...
export default templatePartFieldExtensions;
