...
describe( 'Popover', () => {
	...
	describe( 'open and close behavior', () => {
		it( 'should open the popover when the trigger is clicked', async () => {
			...
			await expect
				.element( await screen.findByText( 'Popover content' ) )
				.toBeVisible();
		} );
	...
	describe( 'controlled mode', () => {
		...
		it( 'should open via external state', async () => {
			...
			await expect
				.element( await screen.findByText( 'Controlled content' ) )
				.toBeVisible();
		} );
	} );
	...
	describe( 'defaultOpen', () => {
		it( 'should render open initially when defaultOpen is true', async () => {
			...
			await expect
				.element( await screen.findByText( 'Default open content' ) )
				.toBeVisible();
		} );
	} );
	...
	describe( 'variant', () => {
		it( 'should not apply popup styles when variant is unstyled', async () => {
			...
			await expect
				.element( await screen.findByText( 'Unstyled content' ) )
				.toBeVisible();
	...
	describe( 'anchor', () => {
		it( 'should render the popup when an anchor element is provided without a trigger', async () => {
			...
			await render( <AnchorTest /> );

			await expect
				.element( await screen.findByText( 'Anchored content' ) )
				.toBeVisible();
		} );
	} );
	...
	describe( 'initialFocus', () => {
		...
		it( 'should not move focus when initialFocus is false', async () => {
			...
			await expect.element( contentButton ).toBeVisible();
