...
-   `Fieldset`: Use a tighter gap between the legend and an immediately following description or details ([#82719](https://github.com/WordPress/gutenberg/pull/82719)).
