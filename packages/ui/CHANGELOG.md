...
-   `Combobox.ChipWithRemove`: Derive an accessible label from string children so virtual focus announces the chip name without the remove button label. Derive the remove button label from string children as `Remove %s`. ([#82042](https://github.com/WordPress/gutenberg/pull/82042))
