...
-   `Menu`: Align selection indicators and prefix icons with the first label line when an item includes a description. ([#82346](https://github.com/WordPress/gutenberg/pull/82346))
