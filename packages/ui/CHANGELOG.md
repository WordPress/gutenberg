...
-   `CollapsibleCard`: Support multiple `HeaderDescription` components, preserve explicit descriptions, and validate that descriptions are rendered inside `Header` ([#81227](https://github.com/WordPress/gutenberg/pull/81227)).
