...
function PostList() {
	...
	// The Extensible Site Editor opens Pages as a grid of layout previews
	// rather than the list the server configures for wp-admin.
	const defaultView = useMemo( () => {
		if ( ! serverDefaultView || postType !== 'page' ) {
