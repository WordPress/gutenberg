 ...
 * Slug: wc-athens/page-image-text
 * Description: This is a cool pattern with image and text
 * Keywords: image, about
 * Categories: pages, wc-athens
 * Inserter: true
 */
?>
...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--custom--spacing--large, 8rem);padding-bottom:2rem"><!-- wp:heading {"align":"wide","style":{"typography":{"fontSize":"clamp(4rem, 8vw, 7.5rem)","lineHeight":"1.15","fontWeight":"300"}}} -->
	<h2 class="alignwide" style="font-size:clamp(4rem, 8vw, 7.5rem);font-weight:300;line-height:1.15"><?php echo wp_kses_post( __( '<em>Watching Birds </em><br><em>in the Garden</em>', 'twentytwentytwo' ) ) ?></h2>
	<!-- /wp:heading --></div>
	<!-- /wp:group -->

	<!-- wp:image {"align":"full","style":{"color":{}}} -->
	<figure class="wp-block-image alignfull"><img src="<?php echo esc_url( get_template_directory_uri() ) ?>/assets/images/flight-path-on-transparent-b.png" alt="<?php esc_attr_x( 'TBD', 'Short for to be determined', 'twentytwentytwo' ) ?>"/></figure>
	<!-- /wp:image -->
