 ...
 */
const { h } = window.wp.interactivity.preact;
const { useEffect, useContext } = window.wp.interactivity.preactHooks;

/**
 * Internal dependencies
 */
const { store, directive, deepSignal } = window.wp.interactivity;
