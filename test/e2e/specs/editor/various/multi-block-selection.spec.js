...
test.describe( 'Multi-block selection', () => {
	...
	// @see https://github.com/WordPress/gutenberg/issues/53674
	test( 'should not skip in-between block in multi-select with shift+arrow', async ( {
		page,
		editor,
		pageUtils,
		multiBlockSelectionUtils,
		...
		// `spacer below` selected, use Shift Arrow to proceed multi-select
