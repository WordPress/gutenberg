...
test.describe( 'Navigation block', () => {
	...
	test.describe( 'Navigation colors', () => {
		...
		test( 'As a user I expect my navigation links to have appropriate default colors', async ( {
			...
			await expect( thirdLink ).toHaveCSS( 'color', 'rgb(0, 0, 0)' );
		...
		test( 'As a user I expect my navigation links to inherit the colors from the theme', async ( {
			...
			await expect( thirdLink ).toHaveCSS( 'color', 'rgb(207, 46, 46)' );
			await firstLink.click();
			await expect( firstLink ).toHaveCSS( 'color', 'rgb(155, 81, 224)' );
			await thirdLink.click();
			await expect( thirdLink ).toHaveCSS( 'color', 'rgb(155, 81, 224)' );
