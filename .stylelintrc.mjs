...
export default {
	...
	overrides: [
		{
			/*
			 * The admin design tokens experiment ships inside a cascade layer, and layer
		...
		},
		{
			 ...
			 * `!important` declarations in WordPress's admin CSS, which survive being
			 ...
			 *
			 * Every rule in that file must be cancelling a specific WordPress
