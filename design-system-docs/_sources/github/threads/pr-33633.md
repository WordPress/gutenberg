...
type: pull_request
state: MERGED
merged_at: 2021-09-02T17:07:52Z
url: https://github.com/WordPress/gutenberg/pull/33633
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #33633: Navigate regions: use React events for shortcuts (portal bubbles & contextual)

- URL: https://github.com/WordPress/gutenberg/pull/33633
- Author: ellatrix
- Created: 2021-07-22T17:32:56Z
- Updated: 2021-09-08T06:20:47Z
- Comments: 2 of 2
- Review threads: 2 of 2
- Changed files: 5 of 5
- Diff: ../pr-diffs/33633.diff
...
### github-actions on 2021-07-22T17:38:51Z

URL: https://github.com/WordPress/gutenberg/pull/33633#issuecomment-885092559
...
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 126 kB | -29 B (0%) |
| `build/block-library/index.min.js` | 147 kB | -99 B (0%) |
| `build/components/index.min.js` | 196 kB | +27 B (0%) |
| `build/edit-navigation/index.min.js` | 13.9 kB | +6 B (0%) |
| `build/edit-post/index.min.js` | 59.5 kB | +2 B (0%) |
| `build/edit-site/index.min.js` | 26 kB | +7 B (0%) |
...
### youknowriad on 2021-07-28T09:59:02Z

URL: https://github.com/WordPress/gutenberg/pull/33633#issuecomment-888178126

I actually think region navigation shortcuts should be global and just catch all events on `document`. Can't we just keep the current code which is simpler and just make it global?

## Review threads

### Review thread 1

#### ellatrix on 2021-07-24T14:29:53Z

URL: https://github.com/WordPress/gutenberg/pull/33633#discussion_r676005922
...
We should be using `useRefEffect` here because it will be called when the ref changes.

### Review thread 2

#### youknowriad on 2021-07-28T12:58:25Z

URL: https://github.com/WordPress/gutenberg/pull/33633#discussion_r678275779
Path: packages/components/src/higher-order/navigate-regions/index.js
...
#### ellatrix on 2021-07-28T13:00:22Z

URL: https://github.com/WordPress/gutenberg/pull/33633#discussion_r678277307
Path: packages/components/src/higher-order/navigate-regions/index.js
...
#### ellatrix on 2021-09-02T17:07:40Z

URL: https://github.com/WordPress/gutenberg/pull/33633#discussion_r701272704
Path: packages/components/src/higher-order/navigate-regions/index.js
...
Yes, we'll most likely need a better API. Currently we have an API to _change_ existing shortcut combinations, but not to add them to a certain region. Based on the section (global/editor, block, text etc.) we can add it to the right element.

## Changed files

- packages/components/src/higher-order/navigate-regions/index.js (MODIFIED, +62/-36)
- packages/e2e-tests/specs/editor/various/a11y.test.js (MODIFIED, +1/-1)
- packages/edit-post/src/components/layout/index.js (MODIFIED, +2/-4)
- packages/edit-widgets/src/components/layout/interface.js (MODIFIED, +2/-4)
- packages/interface/src/components/interface-skeleton/index.js (MODIFIED, +5/-5)
