...
type: pull_request
state: MERGED
merged_at: 2026-01-28T11:10:23Z
url: https://github.com/WordPress/gutenberg/pull/74617
matched_labels: ["[Package] UI","[Package] Theme"]
all_labels: ["[Type] Enhancement","[Package] Theme","[Package] UI","[Package] Boot"]
---

# PR #74617: Consolidate border tokens

- URL: https://github.com/WordPress/gutenberg/pull/74617
- Author: jameskoster
- Created: 2026-01-14T15:42:32Z
- Updated: 2026-01-28T11:11:05Z
- Comments: 4 of 4
- Review threads: 4 of 4
- Changed files: 20 of 20
- Diff: ../pr-diffs/74617.diff

## Body

I'm exploring a `@wordpress/theme` Figma library that contains all design tokens as variables. After importing `packages/theme/tokens/border.json` I noticed radius and width were split into `surface` and `interactive` families which I'm not sure are necessary. This relates a bit to the discussion about dimension tokens in https://github.com/WordPress/gutenberg/issues/74556. This PR consolidates the border tokens.

## Issue comments

### jameskoster on 2026-01-16T13:58:27Z

URL: https://github.com/WordPress/gutenberg/pull/74617#issuecomment-3760144263

> If we choose to move forward, we'll want to regenerate and commit the prebuilt assets from npm run --workspace @wordpress/theme build. We should also ideally include a CHANGELOG note reflecting the breaking change.

That should all be taken care of.

### github-actions on 2026-01-16T14:09:10Z

URL: https://github.com/WordPress/gutenberg/pull/74617#issuecomment-3760193854

**Size Change:** -245 B (-0.01%) 

**Total Size:** 3.1 MB

| Filename | Size | Change |
| :--- | :---: | :---: |
| `build/modules/boot/index.min.js` | 104 kB | -120 B (-0.12%) |
| `build/scripts/block-editor/index.min.js` | 332 kB | -3 B (0%) |
| `build/scripts/edit-site/index.min.js` | 243 kB | -6 B (0%) |
| `build/scripts/editor/index.min.js` | 316 kB | -4 B (0%) |
| `build/styles/edit-site/style-rtl.css` | 22 kB | -12 B (-0.05%) |
| `build/styles/edit-site/style-rtl.min.css` | 17 kB | -6 B (-0.04%) |
| `build/styles/edit-site/style.css` | 22 kB | -11 B (-0.05%) |
| `build/styles/edit-site/style.min.css` | 17 kB | -6 B (-0.04%) |
| `build/styles/editor/style-rtl.css` | 25.8 kB | -14 B (-0.05%) |
| `build/styles/editor/style-rtl.min.css` | 20.4 kB | -6 B (-0.03%) |
| `build/styles/editor/style.css` | 25.9 kB | -15 B (-0.06%) |
| `build/styles/editor/style.min.css` | 20.4 kB | -6 B (-0.03%) |
| `build/styles/theme/style-rtl.css` | 2.65 kB | -13 B (-0.49%) |
| `build/styles/theme/style-rtl.min.css` | 1.36 kB | -5 B (-0.37%) |
| `build/styles/theme/style.css` | 2.65 kB | -13 B (-0.49%) |
| `build/styles/theme/style.min.css` | 1.36 kB | -5 B (-0.37%) |
...
### github-actions on 2026-01-27T13:19:42Z

URL: https://github.com/WordPress/gutenberg/pull/74617#issuecomment-3805184492
...
### github-actions on 2026-01-27T13:41:33Z

URL: https://github.com/WordPress/gutenberg/pull/74617#issuecomment-3805284973

<!-- flaky-tests-report-comment -->
**Flaky tests detected in cb3c7b4be7a3e9fb91c6b0e2b32e8cabd091bd4b.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/21400435502
📝  Reported issues:
...
#### aduth on 2026-01-14T19:26:30Z

URL: https://github.com/WordPress/gutenberg/pull/74617#discussion_r2691748090
Path: packages/theme/tokens/border.json
...
We should consider updating [token naming scheme](https://github.com/WordPress/gutenberg/blob/a813786e8e43271eff3cb9c18637567de7f5278a/packages/theme/README.md#L45) documentation to reflect the changes here. I don't think it necessarily contradicts, "target" is increasingly optional in how we're structuring tokens, so should be reflected as such (square brackets similar to `modifier`).

### Review thread 2

#### ciampo on 2026-01-15T09:18:45Z

URL: https://github.com/WordPress/gutenberg/pull/74617#discussion_r2693588411
Path: packages/theme/tokens/border.json
...
should `focus` be under `width` ? Afterall, it's a stroke witdh

#### jameskoster on 2026-01-16T13:50:15Z

URL: https://github.com/WordPress/gutenberg/pull/74617#discussion_r2698590186
Path: packages/theme/tokens/border.json
...
Sorry I'm not sure what you mean. It is under width?

#### ciampo on 2026-01-16T15:40:06Z

URL: https://github.com/WordPress/gutenberg/pull/74617#discussion_r2699004564
Path: packages/theme/tokens/border.json
...
#### ciampo on 2026-01-16T15:45:57Z

URL: https://github.com/WordPress/gutenberg/pull/74617#discussion_r2699026797
...
The `--wpds-border-width-interactive-focus` token is missing from the rename list

### Review thread 4 (resolved)

#### copilot-pull-request-reviewer on 2026-01-16T15:47:22Z

URL: https://github.com/WordPress/gutenberg/pull/74617#discussion_r2699032189
...
The regex pattern for BorderWidthSize only matches xs, sm, md, and lg, but excludes the 'focus' token which is also a border width token. This should be updated to `/^wpds-border\.width\.(xs|sm|md|lg|focus)$/` to include the focus token in the type definition.
```suggestion
					patterns: [ /^wpds-border\.width\.(xs|sm|md|lg|focus)$/ ],
```

#### aduth on 2026-01-26T17:50:14Z

URL: https://github.com/WordPress/gutenberg/pull/74617#discussion_r2728633742
Path: packages/theme/terrazzo.config.ts
...
We probably just want to remove the "surface" nesting here and leave everything else the same. Although with the move away from Box component, these types probably aren't going to be super useful in general moving forward.
