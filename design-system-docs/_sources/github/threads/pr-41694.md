...
type: pull_request
state: MERGED
merged_at: 2022-06-14T16:35:17Z
url: https://github.com/WordPress/gutenberg/pull/41694
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #41694: ZStack: Convert component story to TypeScript and add inline docs

- URL: https://github.com/WordPress/gutenberg/pull/41694
- Author: walbo
- Created: 2022-06-13T15:26:07Z
- Updated: 2022-06-14T16:35:45Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 6 of 6
- Diff: ../pr-diffs/41694.diff
...
## What?
Converts the `ZStack` component story to TypeScript and update the code to follow coding standards.

## Why?
Part of the @wordpress/components's TypeScript migration (https://github.com/WordPress/gutenberg/issues/35744).

## How?
- Refactor story to TypeScript
- Move types to `types.ts`
- Update readme docs
- Added inline code example to component

## Testing Instructions
- Run npm run dev and ensure no typing errors
- Fire up the Storybook and confirm the `ZStack` continues to function as expected

## Issue comments

### github-actions on 2022-06-13T15:36:59Z

URL: https://github.com/WordPress/gutenberg/pull/41694#issuecomment-1154076831
...
- packages/components/src/z-stack/README.md (MODIFIED, +14/-3)
- packages/components/src/z-stack/component.tsx (MODIFIED, +24/-29)
- packages/components/src/z-stack/stories/index.js (DELETED, +0/-70)
- packages/components/src/z-stack/stories/index.tsx (ADDED, +76/-0)
- packages/components/src/z-stack/types.ts (ADDED, +33/-0)
