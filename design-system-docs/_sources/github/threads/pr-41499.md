...
type: pull_request
state: MERGED
merged_at: 2022-06-08T17:32:41Z
url: https://github.com/WordPress/gutenberg/pull/41499
...
# PR #41499: Components: refactor`Draggable` to pass `exhaustive-deps`

- URL: https://github.com/WordPress/gutenberg/pull/41499
- Author: chad1008
- Created: 2022-06-02T10:38:48Z
- Updated: 2022-06-10T12:52:04Z
- Comments: 1 of 1
- Review threads: 1 of 1
- Changed files: 2 of 2
- Diff: ../pr-diffs/41499.diff

## Body

## What?
Updates the `Draggable` component to satisfy the `exhaustive-deps` eslint rule (specifically by updating the `ControlPoints` subcomponent)

## Why?
Part of the effort in https://github.com/WordPress/gutenberg/pull/41166 to apply `exhuastive-deps` to the Components package

## How?
Add the three values returned as an object by `useMemo` to the dependency array so they're current.

Previously this was an empty array so it would only occur on the initial render. I'm not 100% sure if was intentional or not. My testing of this change didn't raise any red flags, but I'd love some feedback from someone more familiar with React native (cc @geriux)

## Testing Instructions
1. From your local Gutenberg directory, run `npx eslint --rule 'react-hooks/exhaustive-deps: warn' packages/components/src/draggable`
...
### github-actions on 2022-06-02T10:46:55Z

URL: https://github.com/WordPress/gutenberg/pull/41499#issuecomment-1144718156
...
| `build/block-library/blocks/cover/editor-rtl.css` | 676 B |
| `build/block-library/blocks/cover/editor.css` | 680 B |
...
#### fluiddot on 2022-06-02T10:56:11Z

URL: https://github.com/WordPress/gutenberg/pull/41499#discussion_r887824979
Path: packages/components/src/draggable/index.native.js
...
`isDragging`, `isPanActive` and `draggingId` are shared value object types created using the hook [`useSharedValue`](https://docs.swmansion.com/react-native-reanimated/docs/api/hooks/useSharedValue) provided by the React Native's Reanimated library.

https://github.com/WordPress/gutenberg/blob/3512a38246aed0e4b37d1bb174ee1dcc4699e0f1/packages/components/src/draggable/index.native.js#L48-L50
...
#### chad1008 on 2022-06-08T16:45:51Z

URL: https://github.com/WordPress/gutenberg/pull/41499#discussion_r892618685
Path: packages/components/src/draggable/index.native.js
...
#### ciampo on 2022-06-10T06:09:13Z

URL: https://github.com/WordPress/gutenberg/pull/41499#discussion_r894182447
Path: packages/components/src/draggable/index.native.js
...
#### fluiddot on 2022-06-10T08:23:58Z

URL: https://github.com/WordPress/gutenberg/pull/41499#discussion_r894281099
Path: packages/components/src/draggable/index.native.js
...
#### ciampo on 2022-06-10T12:52:03Z

URL: https://github.com/WordPress/gutenberg/pull/41499#discussion_r894488633
Path: packages/components/src/draggable/index.native.js
...
- packages/components/src/draggable/index.native.js (MODIFIED, +1/-1)
