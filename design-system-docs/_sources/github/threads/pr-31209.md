...
type: pull_request
state: MERGED
merged_at: 2021-04-27T12:16:20Z
url: https://github.com/WordPress/gutenberg/pull/31209
matched_labels: ["[Package] Components","[Feature] Component System"]
all_labels: ["[Package] Components","[Feature] Component System"]
---

# PR #31209: components: Remove G2 portal and refactor Popover to no longer use G2

- URL: https://github.com/WordPress/gutenberg/pull/31209
- Author: sarayourfriend
- Created: 2021-04-26T19:13:43Z
- Updated: 2021-04-27T12:16:49Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 14 of 14
- Diff: ../pr-diffs/31209.diff
...
## Description
Removes the G2 portal in favor of just using Reakit's portal directly. The G2 portal is no longer necessary as we don't have a theme provider anymore. We also have to refactor wp-g2 out of Popover as a consequence of this so this PR goes ahead and does that too.

Part of #30503 

## How has this been tested?
Popover continues to work in storybook.
...
### github-actions on 2021-04-26T19:23:33Z

URL: https://github.com/WordPress/gutenberg/pull/31209#issuecomment-827085649
...
| `build/components/index.js` | 270 kB | +92 B (0%) |
| `build/edit-navigation/index.js` | 13.3 kB | -1 B (0%) |
| `build/edit-site/index.js` | 25.2 kB | +1 B (0%) |
| `build/edit-widgets/index.js` | 13 kB | -1 B (0%) |
| `build/editor/index.js` | 60.5 kB | +2 B (0%) |
...
- packages/components/src/ui/card/test/__snapshots__/index.js.snap (MODIFIED, +12/-12)
- packages/components/src/ui/popover/component.js (MODIFIED, +5/-5)
- packages/components/src/ui/popover/content.js (MODIFIED, +3/-3)
- packages/components/src/ui/popover/stories/index.js (MODIFIED, +2/-4)
- packages/components/src/ui/popover/styles.js (MODIFIED, +6/-3)
- packages/components/src/ui/popover/test/__snapshots__/index.js.snap (MODIFIED, +14/-14)
- packages/components/src/ui/popover/test/index.js (MODIFIED, +1/-1)
- packages/components/src/ui/portal/README.md (DELETED, +0/-17)
- packages/components/src/ui/portal/component.js (DELETED, +0/-37)
- packages/components/src/ui/portal/index.js (DELETED, +0/-1)
- packages/components/src/ui/portal/test/index.js (DELETED, +0/-33)
- packages/components/src/ui/utils/space.ts (MODIFIED, +3/-2)
- packages/components/src/utils/config-values.js (MODIFIED, +8/-2)
- packages/components/src/utils/z-index.js (ADDED, +1/-0)
