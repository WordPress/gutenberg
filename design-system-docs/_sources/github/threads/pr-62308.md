...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/62308
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #62308: `CustomSelectControlV2`: Fix initial value not being set in the select for the V1 legacy adapter

- URL: https://github.com/WordPress/gutenberg/pull/62308
- Author: fullofcaffeine
- Created: 2024-06-05T00:09:58Z
- Updated: 2025-02-10T16:51:45Z
- Comments: 3 of 3
- Review threads: 2 of 2
- Changed files: 5 of 5
- Diff: ../pr-diffs/62308.diff
...
### github-actions on 2024-06-05T00:20:18Z

URL: https://github.com/WordPress/gutenberg/pull/62308#issuecomment-2148616920

**Size Change:** +4.64 kB (+0.27%) 

**Total Size:** 1.75 MB

| Filename | Size | Change |
| :--- | :---: | :---: |
| `build/components/index.min.js` | 227 kB | +4.64 kB (+2.09%) |
...
| `build/block-directory/index.min.js` | 7.3 kB |
...
| `build/block-editor/index.min.js` | 262 kB |
...
| `build/block-library/blocks/navigation/editor-rtl.css` | 2.24 kB |
...
| `build/edit-post/style-rtl.css` | 2.32 kB |
...
| `build/editor/index.min.js` | 96.3 kB |
...
| `build/patterns/index.min.js` | 6.49 kB |
...
### github-actions on 2024-06-05T00:29:28Z

URL: https://github.com/WordPress/gutenberg/pull/62308#issuecomment-2148624336
...
### ciampo on 2024-06-21T10:18:36Z

URL: https://github.com/WordPress/gutenberg/pull/62308#issuecomment-2182462857
...
#### fullofcaffeine on 2024-06-05T00:14:09Z

URL: https://github.com/WordPress/gutenberg/pull/62308#discussion_r1626768012
...
#### tyxla on 2024-06-05T11:31:32Z

URL: https://github.com/WordPress/gutenberg/pull/62308#discussion_r1627577471
Path: packages/components/src/custom-select-control-v2/legacy-component/index.tsx

```diff
@@ -51,6 +56,13 @@ function CustomSelectControl( props: LegacyCustomSelectProps ) {
 		},
 	} );
...
Can't we provide the `value.name` directly when calling `Ariakit.useSelectStore()`?

## Changed files

- packages/components/src/custom-select-control-v2/legacy-component/index.tsx (MODIFIED, +30/-7)
- packages/components/src/custom-select-control-v2/legacy-component/test/index.tsx (MODIFIED, +80/-12)
- packages/components/src/custom-select-control-v2/types.ts (MODIFIED, +1/-0)
- packages/components/src/custom-select-control/test/index.js (MODIFIED, +47/-9)
- packages/components/src/index.ts (MODIFIED, +3/-1)
