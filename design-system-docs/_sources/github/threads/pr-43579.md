...
type: pull_request
state: MERGED
merged_at: 2022-08-25T05:07:41Z
url: https://github.com/WordPress/gutenberg/pull/43579
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #43579: Make more components pass type checks

- URL: https://github.com/WordPress/gutenberg/pull/43579
- Author: mirka
- Created: 2022-08-24T12:55:09Z
- Updated: 2022-09-13T10:01:19Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 7 of 7
- Diff: ../pr-diffs/43579.diff
...
- ClipboardButton (Deprecated)
- FocusableIframe (Deprecated)
- withConstrainedTabbing
- withSpokenMessages
- IsolatedEventContainer (Deprecated)
...
✅ `npm run build:package-types` succeeds

## Issue comments

### mirka on 2022-08-24T13:01:41Z

URL: https://github.com/WordPress/gutenberg/pull/43579#issuecomment-1225695526

@ciampo These components are either explicitly deprecated, or HOCs that already have hook equivalents. In other words, pretty unlikely that anyone will touch them anymore. I opted for a quick fix like this, not even converting the files to `.tsx`, so we can focus our TS efforts on more important components. But let me know if you rather we convert all files anyway.

### ciampo on 2022-08-24T13:29:31Z

URL: https://github.com/WordPress/gutenberg/pull/43579#issuecomment-1225729400

> @ciampo These components are either explicitly deprecated, or HOCs that already have hook equivalents. In other words, pretty unlikely that anyone will touch them anymore. I opted for a quick fix like this, not even converting the files to `.tsx`, so we can focus our TS efforts on more important components. But let me know if you rather we convert all files anyway.

In the future we may decide to convert them to TypeScript in case we want to get rid of as many `.js` files as possible, but this already a great step forward for now.

We could alternatively also look at marking them for removal in a future version of WordPress?

### github-actions on 2022-08-24T14:02:18Z

URL: https://github.com/WordPress/gutenberg/pull/43579#issuecomment-1225770356
...
- packages/components/src/clipboard-button/index.js (MODIFIED, +13/-0)
- packages/components/src/focusable-iframe/index.js (MODIFIED, +5/-0)
- packages/components/src/higher-order/with-constrained-tabbing/index.js (MODIFIED, +1/-1)
- packages/components/src/higher-order/with-spoken-messages/index.js (MODIFIED, +2/-0)
- packages/components/src/isolated-event-container/index.js (MODIFIED, +3/-0)
