...
type: pull_request
state: MERGED
merged_at: 2021-07-07T20:38:54Z
url: https://github.com/WordPress/gutenberg/pull/33208
matched_labels: ["[Package] Components","[Feature] Component System"]
all_labels: ["[Package] Components","[Feature] Component System"]
---

# PR #33208: components: Add normalizeArrowKey

- URL: https://github.com/WordPress/gutenberg/pull/33208
- Author: sarayourfriend
- Created: 2021-07-05T17:09:21Z
- Updated: 2021-07-07T20:39:17Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/33208.diff
...
### github-actions on 2021-07-05T17:16:42Z

URL: https://github.com/WordPress/gutenberg/pull/33208#issuecomment-874246481
...
| `build/customize-widgets/index.min.js` | 10.2 kB |
...
| `build/edit-post/style-rtl.css` | 7.26 kB |
| `build/edit-post/style.css` | 7.25 kB |
...
### ciampo on 2021-07-07T16:23:44Z

URL: https://github.com/WordPress/gutenberg/pull/33208#issuecomment-875745103

> Not sure how to test this effectively without testing the implementation details.

Maybe creating a simple input element, adding this in the `onChange` listener, and leveraging React Testing library and the [`user-event` package?](https://github.com/testing-library/user-event#typeelement-text-options) to make sure that the return value is correct?

### ciampo on 2021-07-07T16:27:05Z

URL: https://github.com/WordPress/gutenberg/pull/33208#issuecomment-875747701
...
- one creating a mock event object in the way that IE / Edge would, and checking that the output is normalised
- another one creating a mock event object like other browsers would, and making sure that the output stays the same (ie it didn't need normalisation)
- a last one creating an event object that is not related to arrow keys — and making sure that the output is the same as the input

### sarayourfriend on 2021-07-07T17:15:33Z

URL: https://github.com/WordPress/gutenberg/pull/33208#issuecomment-875781945
...
- packages/components/src/utils/keyboard.js (ADDED, +28/-0)
- packages/components/src/utils/test/keyboard.js (ADDED, +34/-0)
