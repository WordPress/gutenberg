...
type: pull_request
state: MERGED
merged_at: 2022-10-26T18:24:12Z
url: https://github.com/WordPress/gutenberg/pull/43208
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Build Tooling","Internationalization (i18n)","[Package] Components"]
---

# PR #43208: Upgrade rtlcss to v4.0.0

- URL: https://github.com/WordPress/gutenberg/pull/43208
- Author: walbo
- Created: 2022-08-13T18:01:57Z
- Updated: 2022-10-26T18:24:53Z
- Comments: 2 of 2
- Review threads: 1 of 1
- Changed files: 3 of 3
- Diff: ../pr-diffs/43208.diff
...
## Why?
Upgrading rtlcss fixes some RTL issues I spotted. See screenshots. V4 support flipping left and right in `justify-content`.

## How?
Upgrade rtlcss to v4.0.0. Also upgrade postcss as rtlcss has a dependency on postcss ^8.4.6.

## Testing Instructions
1. Fire up storybook and make sure components still works in rtl.
2. Fire up the editor in rtl and make sure everything still works as expected.

## Screenshots or screencast <!-- if applicable -->
| Before | After |
| -- | -- |
| <img width="641" alt="image" src="https://user-images.githubusercontent.com/1415747/184505346-dd4a4428-71af-4bad-9fa8-e5141470e375.png"> | <img width="638" alt="image" src="https://user-images.githubusercontent.com/1415747/184505399-b1f0d17d-bca2-4ab0-910b-288fe71711f3.png"> |
| <img width="180" alt="image" src="https://user-images.githubusercontent.com/1415747/184505456-933cd69e-2c11-434f-a5c8-a660c9f227b4.png"> | <img width="178" alt="image" src="https://user-images.githubusercontent.com/1415747/184505518-54c744da-b9cf-4b9f-9f2e-fbd94aaa4fb8.png"> |

## Issue comments

### github-actions on 2022-08-13T18:10:32Z

URL: https://github.com/WordPress/gutenberg/pull/43208#issuecomment-1214200169
...
| :--- | :---: | :---: |
| `build/components/style-rtl.css` | 11.3 kB | +5 B (0%) |
...
### walbo on 2022-10-26T09:55:44Z

URL: https://github.com/WordPress/gutenberg/pull/43208#issuecomment-1291787904

Thanks @ciampo!

I'll rebase the PR later today and make sure the CI passes before merging.

## Review threads

### Review thread 1

#### walbo on 2022-08-13T18:02:48Z

URL: https://github.com/WordPress/gutenberg/pull/43208#discussion_r945174688
Path: packages/editor/src/components/post-saved-state/style.scss
...
- package-lock.json (MODIFIED, +37/-77)
- package.json (MODIFIED, +2/-2)
- packages/editor/src/components/post-saved-state/style.scss (MODIFIED, +0/-4)
