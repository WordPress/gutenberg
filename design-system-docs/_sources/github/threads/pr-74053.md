...
type: pull_request
state: MERGED
merged_at: 2025-12-17T10:29:07Z
url: https://github.com/WordPress/gutenberg/pull/74053
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #74053: SearchControl: Deprecate bottom margin

- URL: https://github.com/WordPress/gutenberg/pull/74053
- Author: mirka
- Created: 2025-12-16T18:16:21Z
- Updated: 2025-12-17T10:29:44Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 23 of 23
- Diff: ../pr-diffs/74053.diff
...
Remove the deprecated `__nextHasNoMarginBottom` prop from `SearchControl`, making the margin-free styles the permanent default.
...
- Remove the `__nextHasNoMarginBottom` prop from `SearchControl` and its types and docs.
...
### github-actions on 2025-12-16T18:17:22Z

URL: https://github.com/WordPress/gutenberg/pull/74053#issuecomment-3661819790
...
### github-actions on 2025-12-16T18:36:57Z

URL: https://github.com/WordPress/gutenberg/pull/74053#issuecomment-3661888139
...
| :--- | :---: | :---: |
| `build/scripts/block-editor/index.min.js` | 317 kB | -12 B (0%) |
| `build/scripts/block-library/index.min.js` | 281 kB | -26 B (-0.01%) |
| `build/scripts/components/index.min.js` | 272 kB | -39 B (-0.01%) |
| `build/scripts/edit-site/index.min.js` | 240 kB | -20 B (-0.01%) |
| `build/scripts/editor/index.min.js` | 284 kB | -53 B (-0.02%) |
| `build/scripts/media-utils/index.min.js` | 69.3 kB | -4 B (-0.01%) |
...
### github-actions on 2025-12-16T19:03:56Z

URL: https://github.com/WordPress/gutenberg/pull/74053#issuecomment-3661973952

<!-- flaky-tests-report-comment -->
**Flaky tests detected in b2098847390006d01eb9a9b35c77287d0c642bbd.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/20278438189
📝  Reported issues:
...
- .eslintrc.js (MODIFIED, +6/-8)
- packages/block-editor/src/components/block-manager/index.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/inserter/block-patterns-explorer/pattern-explorer-sidebar.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/inserter/media-tab/media-panel.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/inserter/menu.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/inserter/quick-inserter.js (MODIFIED, +0/-1)
- packages/block-library/src/query/edit/pattern-selection.js (MODIFIED, +0/-1)
- packages/block-library/src/template-part/edit/selection-modal.js (MODIFIED, +0/-1)
- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/navigation/menu/menu-title-search.tsx (MODIFIED, +0/-1)
- packages/components/src/search-control/README.md (MODIFIED, +0/-9)
- packages/components/src/search-control/index.tsx (MODIFIED, +30/-49)
- packages/components/src/search-control/stories/index.story.tsx (MODIFIED, +0/-1)
- packages/components/src/search-control/test/index.tsx (MODIFIED, +0/-1)
- packages/components/src/search-control/types.ts (MODIFIED, +3/-0)
- packages/dataviews/src/components/dataviews-search/index.tsx (MODIFIED, +0/-1)
- packages/edit-site/src/components/add-new-template-legacy/add-custom-template-modal-content.js (MODIFIED, +0/-1)
- packages/edit-site/src/components/add-new-template/add-custom-template-modal-content.js (MODIFIED, +0/-1)
- packages/editor/src/components/post-taxonomies/hierarchical-term-selector.js (MODIFIED, +0/-1)
- packages/editor/src/components/post-template/swap-template-button.js (MODIFIED, +0/-1)
- packages/global-styles-ui/src/font-library/font-collection.tsx (MODIFIED, +0/-1)
- packages/global-styles-ui/src/screen-block-list.tsx (MODIFIED, +0/-1)
- routes/template-list/add-new-template/add-custom-template-modal-content.tsx (MODIFIED, +0/-1)
