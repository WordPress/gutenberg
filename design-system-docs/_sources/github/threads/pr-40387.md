...
type: pull_request
state: MERGED
merged_at: 2022-04-19T11:13:32Z
url: https://github.com/WordPress/gutenberg/pull/40387
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #40387: Stop exporting individual color objects from color values file

- URL: https://github.com/WordPress/gutenberg/pull/40387
- Author: mirka
- Created: 2022-04-15T17:18:03Z
- Updated: 2022-04-19T11:14:09Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 4 of 4
- Diff: ../pr-diffs/40387.diff
...
To clean up the color values file ([as discussed](https://github.com/WordPress/gutenberg/issues/40113#issuecomment-1091161656)), we need to start de-duping the color references that are already being used.
...
The colors used in the `Navigation` component have been replaced with canonical references to the exact same color values (i.e. no colors have actually changed).

## Testing Instructions

✅ `npm run build` still works
✅ The `Navigation` component should have the same colors as before

## Issue comments

### github-actions on 2022-04-15T17:35:41Z

URL: https://github.com/WordPress/gutenberg/pull/40387#issuecomment-1100251429
...
| `build/edit-site/index.min.js` | 47.1 kB |
...
- packages/components/src/navigation/styles/navigation-styles.js (MODIFIED, +5/-5)
- packages/components/src/text/styles/text-mixins.native.js (MODIFIED, +2/-2)
- packages/components/src/utils/colors-values.js (MODIFIED, +11/-11)
