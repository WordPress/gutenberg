...
type: pull_request
state: MERGED
merged_at: 2023-06-17T10:11:37Z
url: https://github.com/WordPress/gutenberg/pull/51395
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components"]
---

# PR #51395: Button: Remove unnecessary margin from dashicon

- URL: https://github.com/WordPress/gutenberg/pull/51395
- Author: t-hamano
- Created: 2023-06-10T11:24:23Z
- Updated: 2023-06-17T10:12:02Z
- Comments: 4 of 4
- Review threads: 1 of 1
- Changed files: 5 of 5
- Diff: ../pr-diffs/51395.diff
...
### github-actions on 2023-06-10T11:41:28Z

URL: https://github.com/WordPress/gutenberg/pull/51395#issuecomment-1585629896
...
| :--- | :---: | :---: |
| `build/components/style-rtl.css` | 11.8 kB | -15 B (0%) |
| `build/components/style.css` | 11.8 kB | -15 B (0%) |
...
| `build/edit-site/index.min.js` | 70.7 kB |
...
### github-actions on 2023-06-10T12:09:53Z

URL: https://github.com/WordPress/gutenberg/pull/51395#issuecomment-1585638971

<!-- flaky-tests-report-comment -->
**Flaky tests detected in bbd89eddd8adec8c078db8737b5912d3636dc5cc.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/5297188139
📝  Reported issues:
- #43174 in `/test/e2e/specs/editor/plugins/iframed-block.spec.js`
- #35176 in `specs/editor/various/autosave.test.js`

### mirka on 2023-06-16T14:54:21Z

URL: https://github.com/WordPress/gutenberg/pull/51395#issuecomment-1594825816

Also I'm not sure if you're already aware, but we can test dashicons in Storybook now. The "WordPress" option in the global CSS toolbar addon will load the dashicons stylesheet/font. Mentioning it just in case 🙂

<img src="https://github.com/WordPress/gutenberg/assets/555336/b12a7f9e-daf0-4ccb-b130-4a55204af64c" alt="The WordPress option in the global CSS toolbar addon" width="400">

### t-hamano on 2023-06-17T08:23:39Z

URL: https://github.com/WordPress/gutenberg/pull/51395#issuecomment-1595667686

@mirka

Thanks for the review and for adding the visual regression test 🙏

I have added the approach suggested in [this comment](https://github.com/WordPress/gutenberg/pull/51395#discussion_r1225354328) and performed a visleg test locally and got the same expected results. I would like to merge when all CIs have passed 👍

## Review threads

### Review thread 1

#### t-hamano on 2023-06-10T13:12:14Z

URL: https://github.com/WordPress/gutenberg/pull/51395#discussion_r1225354328
...
As [this comment](https://github.com/WordPress/gutenberg/pull/43574#discussion_r963618135) suggests, I would ideally like to remove these margins as well, in order to solve the problem more upstream when the dashicon is used in the `DropdownMenu` component, but so far I have not found a satisfactory approach.
...
#### mirka on 2023-06-16T14:38:17Z

URL: https://github.com/WordPress/gutenberg/pull/51395#discussion_r1232341850
Path: packages/components/src/button/style.scss
...
- packages/components/src/button/stories/e2e/index.tsx (MODIFIED, +22/-0)
- packages/components/src/button/style.scss (MODIFIED, +5/-13)
- test/storybook-playwright/specs/button.spec.ts (MODIFIED, +16/-0)
- test/storybook-playwright/utils.ts (MODIFIED, +2/-2)
