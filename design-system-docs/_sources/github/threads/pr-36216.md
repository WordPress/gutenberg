...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/36216
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Focus] Accessibility (a11y)","[Package] Components"]
---

# PR #36216: Try Reakit v2

- URL: https://github.com/WordPress/gutenberg/pull/36216
- Author: diegohaz
- Created: 2021-11-04T14:42:05Z
- Updated: 2023-06-19T02:47:13Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 21 of 21
- Diff: ../pr-diffs/36216.diff

## Body

This is an experimental PR to check how the upgrade to Reakit v2 (Ariakit) feels/works. Ariakit is still in the very early alpha and is being developed on https://github.com/reakit/reakit/tree/v2

I'll add more info later.

## Issue comments

### github-actions on 2021-11-04T14:49:51Z

URL: https://github.com/WordPress/gutenberg/pull/36216#issuecomment-961097327

**Size Change:** +8.22 kB (+1%) 

**Total Size:** 1.13 MB

| Filename | Size | Change |
| :--- | :---: | :---: |
| `build/components/index.min.js` | 223 kB | +8.22 kB (+4%) |
...
### diegohaz on 2023-06-19T02:47:08Z

URL: https://github.com/WordPress/gutenberg/pull/36216#issuecomment-1596410990

Closing in favor of #51623
...
- package-lock.json (MODIFIED, +22/-0)
- packages/components/package.json (MODIFIED, +1/-0)
- packages/components/src/alignment-matrix-control/cell.js (MODIFIED, +1/-1)
- packages/components/src/alignment-matrix-control/index.js (MODIFIED, +12/-27)
- packages/components/src/alignment-matrix-control/stories/index.js (MODIFIED, +5/-1)
- packages/components/src/composite2/index.js (ADDED, +7/-0)
- packages/components/src/divider/component.tsx (MODIFIED, +1/-1)
- packages/components/src/divider/types.ts (MODIFIED, +1/-1)
- packages/components/src/index.js (MODIFIED, +6/-0)
- packages/components/src/radio-context/index.js (MODIFIED, +2/-2)
- packages/components/src/radio-group/index.js (MODIFIED, +7/-12)
- packages/components/src/radio-group/stories/index.js (MODIFIED, +3/-20)
- packages/components/src/radio/index.js (MODIFIED, +5/-5)
- packages/components/src/radio/stories/index.js (MODIFIED, +1/-2)
- packages/components/src/toggle-group-control/test/__snapshots__/index.js.snap (MODIFIED, +41/-17)
- packages/components/src/toggle-group-control/toggle-group-control-option/component.tsx (MODIFIED, +10/-4)
- packages/components/src/toggle-group-control/toggle-group-control/component.tsx (MODIFIED, +11/-31)
- packages/components/src/toggle-group-control/toggle-group-control/toggle-group-control-backdrop.tsx (MODIFIED, +3/-3)
- packages/components/src/toggle-group-control/types.ts (MODIFIED, +18/-5)
- packages/components/src/toolbar-item/index.js (MODIFIED, +2/-2)
- packages/components/src/toolbar/toolbar-container.js (MODIFIED, +3/-7)
