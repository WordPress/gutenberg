...
type: pull_request
state: MERGED
merged_at: 2021-02-11T07:08:19Z
url: https://github.com/WordPress/gutenberg/pull/28925
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Automated Testing","[Package] Components"]
---

# PR #28925: Components: Update color-picker snapshot tests to use diff matching

- URL: https://github.com/WordPress/gutenberg/pull/28925
- Author: sarayourfriend
- Created: 2021-02-10T18:35:05Z
- Updated: 2021-02-11T07:09:21Z
- Comments: 2 of 2
- Review threads: 1 of 1
- Changed files: 2 of 2
- Diff: ../pr-diffs/28925.diff
...
## Description
This PR updates the `color-picker` component's snapshot tests to use diff matching. This reduces the size of the snapshot tests to just what is changing. See #28897 for more details on how this works and why it's desirable.

## How has this been tested?
Unit tests pass. No changes to actual code, just unit tests.
...
### github-actions on 2021-02-10T18:44:32Z

URL: https://github.com/WordPress/gutenberg/pull/28925#issuecomment-776927832
...
### gziolo on 2021-02-11T07:09:20Z

URL: https://github.com/WordPress/gutenberg/pull/28925#issuecomment-777243850

It's a really nice improvement. 43% less of the output to process 😄

## Review threads

### Review thread 1

#### gziolo on 2021-02-11T07:07:51Z

URL: https://github.com/WordPress/gutenberg/pull/28925#discussion_r574284665
Path: packages/components/src/color-picker/test/__snapshots__/index.js.snap
...
Is it possible to change those hints in the output? I'm nitpicking in general, but it would better explain the intent if there was something like:
```
"Snapshot Diff:
- Base component
- Current component
...
- packages/components/src/color-picker/test/__snapshots__/index.js.snap (MODIFIED, +510/-902)
- packages/components/src/color-picker/test/index.js (MODIFIED, +17/-14)
