...
type: pull_request
state: MERGED
merged_at: 2026-03-13T13:08:35Z
url: https://github.com/WordPress/gutenberg/pull/76356
matched_labels: ["Design System","[Package] UI"]
all_labels: ["[Type] Enhancement","Design System","[Package] UI"]
---

# PR #76356: UI/Badge: Add border and neutral-strong background to `none` intent

- URL: https://github.com/WordPress/gutenberg/pull/76356
- Author: jameskoster
- Created: 2026-03-10T12:43:24Z
- Updated: 2026-03-13T13:09:26Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/76356.diff
...
### github-actions on 2026-03-10T12:55:42Z

URL: https://github.com/WordPress/gutenberg/pull/76356#issuecomment-4031190812

The following accounts have interacted with this PR and/or linked issues. I will continue to update these lists as activity occurs. You can also manually ask me to refresh this list by adding the `props-bot` label.

## Unlinked Accounts

The following contributors have not linked their GitHub and WordPress.org accounts: @verofasulo.
...
```
Unlinked contributors: verofasulo.
...
### github-actions on 2026-03-10T13:07:33Z

URL: https://github.com/WordPress/gutenberg/pull/76356#issuecomment-4031260966
...
| :--- | :---: | :---: |
| `build/scripts/block-editor/index.min.js` | 329 kB | +58 B (+0.02%) |
| `build/scripts/edit-site/index.min.js` | 250 kB | +69 B (+0.03%) |
| `build/scripts/editor/index.min.js` | 353 kB | +50 B (+0.01%) |
...
### verofasulo on 2026-03-10T13:12:38Z

URL: https://github.com/WordPress/gutenberg/pull/76356#issuecomment-4031291226

Thank you for working on this so quickly, Jay — really appreciate it! 🙏

My only feedback would be to align the text color with the rest of the set. Could we use the same dark grey used for the `Draft` option? I think it would work better overall.

### github-actions on 2026-03-10T13:19:46Z

URL: https://github.com/WordPress/gutenberg/pull/76356#issuecomment-4031334703

<!-- flaky-tests-report-comment -->
**Flaky tests detected in b050b3b17dcd92923598927ebee7ef626ab96908.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/22914421010
📝  Reported issues:
- #52831 in `/test/e2e/specs/editor/various/autocomplete-and-mentions.spec.js`
...
- packages/ui/src/badge/style.module.css (MODIFIED, +5/-2)
