...
type: pull_request
state: MERGED
merged_at: 2022-07-09T00:49:19Z
url: https://github.com/WordPress/gutenberg/pull/42262
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Feature] UI Components","[Type] Code Quality","[Package] Components"]
---

# PR #42262: Tip: Covert component to TypeScript

- URL: https://github.com/WordPress/gutenberg/pull/42262
- Author: walbo
- Created: 2022-07-08T09:51:47Z
- Updated: 2022-07-09T00:49:46Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 6 of 6
- Diff: ../pr-diffs/42262.diff
...
## What?
Converts the `Tip` component to TypeScript.

## Why?
Part of the @wordpress/components's TypeScript migration (https://github.com/WordPress/gutenberg/issues/35744).

## How?
- Refactors the current `Tip` to TypeScript.
- Refactors the storybook to TypeScript and removed knobs.

## Testing Instructions
1. Run npm run dev and ensure no typing errors
2. Fire up the Storybook and confirm the `Tip` continues to function as expected
3. Test within the Gutenberg editor

## Issue comments

### github-actions on 2022-07-08T10:00:13Z

URL: https://github.com/WordPress/gutenberg/pull/42262#issuecomment-1178795932
...
- packages/components/src/tip/index.js (DELETED, +0/-24)
- packages/components/src/tip/index.tsx (ADDED, +22/-0)
- packages/components/src/tip/stories/index.js (DELETED, +0/-26)
- packages/components/src/tip/stories/index.tsx (ADDED, +33/-0)
- packages/components/src/tip/types.ts (ADDED, +11/-0)
