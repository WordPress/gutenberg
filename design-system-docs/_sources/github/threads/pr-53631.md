...
type: pull_request
state: MERGED
merged_at: 2023-08-15T08:03:47Z
url: https://github.com/WordPress/gutenberg/pull/53631
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #53631: Components: Move accent colors to theme context

- URL: https://github.com/WordPress/gutenberg/pull/53631
- Author: tyxla
- Created: 2023-08-14T12:34:19Z
- Updated: 2023-08-15T08:04:15Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 22 of 22
- Diff: ../pr-diffs/53631.diff
...
## Why?
We're moving towards utilizing the components theming system more broadly, and that's a step in that direction. See https://github.com/WordPress/gutenberg/pull/53347#discussion_r1289335976 for more details and motivation.

## How?
We're basically renaming:

* `COLORS.ui.theme` to `COLORS.theme.accent`
* `COLORS.ui.themeDark10` to `COLORS.theme.accentDarker10`
...
### github-actions on 2023-08-14T12:48:49Z

URL: https://github.com/WordPress/gutenberg/pull/53631#issuecomment-1677254424
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 245 kB | +13 B (0%) |
...
| `build/block-editor/index.min.js` | 212 kB |
...
### github-actions on 2023-08-15T07:56:35Z

URL: https://github.com/WordPress/gutenberg/pull/53631#issuecomment-1678553893

<!-- flaky-tests-report-comment -->
**Flaky tests detected in c2b3e70663a9fc064368a2068e9c32dc9edfa15f.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/5864668255
📝  Reported issues:
...
- packages/components/src/alignment-matrix-control/styles/alignment-matrix-control-styles.ts (MODIFIED, +1/-1)
- packages/components/src/angle-picker-control/styles/angle-picker-control-styles.tsx (MODIFIED, +2/-2)
- packages/components/src/box-control/styles/box-control-visualizer-styles.ts (MODIFIED, +1/-1)
...
- packages/components/src/item-group/styles.ts (MODIFIED, +2/-2)
- packages/components/src/navigation/styles/navigation-styles.tsx (MODIFIED, +1/-1)
- packages/components/src/number-control/styles/number-control-styles.ts (MODIFIED, +1/-1)
- packages/components/src/palette-edit/styles.js (MODIFIED, +3/-3)
...
- packages/components/src/unit-control/styles/unit-control-styles.ts (MODIFIED, +1/-1)
- packages/components/src/utils/colors-values.js (MODIFIED, +6/-2)
