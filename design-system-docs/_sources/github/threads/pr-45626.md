...
type: pull_request
state: MERGED
merged_at: 2022-11-12T06:38:29Z
url: https://github.com/WordPress/gutenberg/pull/45626
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components"]
---

# PR #45626: Autocomplete: Check key events more strictly in IME composition

- URL: https://github.com/WordPress/gutenberg/pull/45626
- Author: t-hamano
- Created: 2022-11-09T13:21:02Z
- Updated: 2022-11-12T06:38:57Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/45626.diff
...
- In an empty paragraph tag, enter the text `/見出し` which is the Japanese translation of the heading block.
- Confirm that the list of candidates is narrowed down when you press the `enter` key.
- Confirm that the heading block is inserted as expected when you press the `enter` key again.

## Issue comments

### codesandbox on 2022-11-09T13:21:05Z

URL: https://github.com/WordPress/gutenberg/pull/45626#issuecomment-1308745324

<img alt="CodeSandbox logo" src="https://raw.githubusercontent.com/codesandbox/open-in-codesandbox/main/assets/csb.light.svg#gh-dark-mode-only" /><img alt="CodeSandbox logo" src="https://raw.githubusercontent.com/codesandbox/open-in-codesandbox/main/assets/csb.svg#gh-light-mode-only" />&nbsp; Open in CodeSandbox <a href="https://codesandbox.io/p/github/WordPress/gutenberg/fix/autocomplete-ime-strict?workspace=%7B%22gitSidebarPanel%22:%22PR%22,%22sidebarPanel%22:%22GIT%22%7D">Web Editor</a> | <a href="https://codesandbox.io/p/vscode?owner=WordPress&repo=gutenberg&branch=fix/autocomplete-ime-strict">VS Code</a> | <a href="https://codesandbox.io/p/vscode?owner=WordPress&repo=gutenberg&branch=fix/autocomplete-ime-strict&insiders=true">VS Code Insiders</a>

<!-- open-in-codesandbox:complete -->

### github-actions on 2022-11-09T13:31:41Z

URL: https://github.com/WordPress/gutenberg/pull/45626#issuecomment-1308763723
...
### t-hamano on 2022-11-10T13:55:12Z

URL: https://github.com/WordPress/gutenberg/pull/45626#issuecomment-1310315965

As discussed below [this comment](https://github.com/WordPress/gutenberg/pull/45607#issuecomment-1310126631), this PR should not be backported to WP6.1.1 as it needs to be thoroughly tested.
Therefore, this PR should be removed from the project board and a separate PR for WP6.1.1 will be created.
...
- packages/components/src/autocomplete/index.js (MODIFIED, +10/-1)
