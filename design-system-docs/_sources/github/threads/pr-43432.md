...
type: pull_request
state: MERGED
merged_at: 2022-08-22T12:48:22Z
url: https://github.com/WordPress/gutenberg/pull/43432
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Feature] UI Components","[Package] Components"]
---

# PR #43432: Autocomplete: use KeyboardEvent.code instead of KeyboardEvent.keyCode

- URL: https://github.com/WordPress/gutenberg/pull/43432
- Author: ciampo
- Created: 2022-08-19T14:25:44Z
- Updated: 2022-08-23T13:28:15Z
- Comments: 6 of 6
- Review threads: 2 of 2
- Changed files: 2 of 2
- Diff: ../pr-diffs/43432.diff
...
Refactor the `Autocomplete` component to rely on `code` instead of `keyCode` for keyboard events
...
The autocomplete component can be tested in the block editor in rich text blocks (e.g. autocompleting a user after typing `@`) — in particular, the arrow keys, the enter key, and the escape key

Make sure that there are no regressions compared to how the component behaves on `trunk`

## Issue comments

### github-actions on 2022-08-19T14:33:54Z

URL: https://github.com/WordPress/gutenberg/pull/43432#issuecomment-1220752668
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 198 kB | -38 B (0%) |
...
### geriux on 2022-08-23T12:24:26Z

URL: https://github.com/WordPress/gutenberg/pull/43432#issuecomment-1223995921

Hey there 👋 is there an issue tracking these changes related to the `keyCode` and `ENTER` events? This change broke the autocomplete on mobile so it'd be nice to see what else is soon to be changed so we can prevent breakages.

Thank you!

### tyxla on 2022-08-23T13:07:12Z

URL: https://github.com/WordPress/gutenberg/pull/43432#issuecomment-1224050363

@geriux could you please provide more information as to what broke? 

AFAIK there's not an issue, but these are the PRs in that direction on which we have worked so far:
...
### geriux on 2022-08-23T13:12:18Z

URL: https://github.com/WordPress/gutenberg/pull/43432#issuecomment-1224056874

>@geriux could you please provide more information as to what broke?

Sure! On mobile, we pass `keyCode` with the `onKeyPress` event, there's no `code` attribute. So for the Autocomplete, it wasn't working without `code`.

I've already [created a PR](https://github.com/WordPress/gutenberg/pull/43521) to include this for the RichText component on mobile, which fixes the Autocomplete (slash inserter).

> AFAIK there's not an issue, but these are the PRs in that direction on which we have worked so far

Thanks! I'll check that list.

### ciampo on 2022-08-23T13:20:50Z

URL: https://github.com/WordPress/gutenberg/pull/43432#issuecomment-1224068518

This one was also a PR related to this work: 
- https://github.com/WordPress/gutenberg/pull/42569

I didn't imagine this work would cause issues on the native side, since `KeyboardEvent.code` is in the spec and is supported by all major browsers. Apologies!

### geriux on 2022-08-23T13:28:15Z

URL: https://github.com/WordPress/gutenberg/pull/43432#issuecomment-1224078082
...
#### ciampo on 2022-08-19T16:04:05Z

URL: https://github.com/WordPress/gutenberg/pull/43432#discussion_r950353471
...
#### tyxla on 2022-08-22T08:58:05Z

URL: https://github.com/WordPress/gutenberg/pull/43432#discussion_r951185125
Path: packages/components/CHANGELOG.md
...
- packages/components/src/autocomplete/index.js (MODIFIED, +9/-18)
