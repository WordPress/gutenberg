...
type: pull_request
state: MERGED
merged_at: 2026-04-24T12:43:06Z
url: https://github.com/WordPress/gutenberg/pull/77575
matched_labels: ["[Package] Components","[Package] UI"]
all_labels: ["[Type] Code Quality","[Package] Components","[Package] Editor","[Package] Block library","[Package] Format library","[Package] Block editor","[Package] Edit Post","[Package] Edit Widgets","[Package] Edit Site","[Package] DataViews","[Package] Fields","[Package] UI"]
---

# PR #77575: VisuallyHidden: Recommend @wordpress/ui and migrate usages

- URL: https://github.com/WordPress/gutenberg/pull/77575
- Author: mirka
- Created: 2026-04-22T21:45:00Z
- Updated: 2026-05-05T17:05:54Z
- Comments: 6 of 6
- Review threads: 4 of 4
- Changed files: 57 of 57
- Diff: ../pr-diffs/77575.diff

## Body

## What?

Update the `VisuallyHidden` guidance to recommend `@wordpress/ui`, then migrate the remaining runtime usages over to that package.

## Why?

`VisuallyHidden` is part of the migration away from legacy `@wordpress/components` exports. This branch aligns the lint rule, Storybook guidance, and package dependencies with that direction, while keeping one explicit legacy import in the DOM test for comparison coverage.

## How?

- mark `@wordpress/components` `VisuallyHidden` as not recommended and allow `@wordpress/ui` `VisuallyHidden` in the recommended-components rule
- update the `VisuallyHidden` Storybook metadata so the `@wordpress/ui` story is manifested and the `@wordpress/components` story points consumers to `@wordpress/ui`
- migrate the remaining runtime imports to `@wordpress/ui`, add the required package dependencies, and keep the legacy import only in the targeted `block-editor` DOM test with the lint exemption moved to that test path

## Testing Instructions

1. Run `npm run lint:js -- packages/block-editor/src/components packages/block-editor/src/utils/test/dom.js packages/block-library/src packages/block-directory/src packages/customize-widgets/src packages/dataviews/src packages/edit-post/src packages/edit-site/src packages/edit-widgets/src packages/editor/src packages/fields/src`.
2. Run `rg "VisuallyHidden" packages` and confirm the only remaining `@wordpress/components` import is the intentional one in `packages/block-editor/src/utils/test/dom.js`.
3. In Storybook, verify `packages/ui/src/visually-hidden/stories/index.story.tsx` is manifested and `packages/components/src/visually-hidden/stories/index.story.tsx` is marked not recommended.
...
### github-actions on 2026-04-23T10:53:11Z

URL: https://github.com/WordPress/gutenberg/pull/77575#issuecomment-4303787594

**Size Change:** +12.7 kB (+0.16%) 
...
| :--- | :---: | :---: | :---: |
| `build/scripts/block-directory/index.min.js` | 9.98 kB | +1.95 kB (+24.3%) | 🚨 |
| `build/scripts/block-editor/index.min.js` | 341 kB | +531 B (+0.16%) |  |
| `build/scripts/block-library/index.min.js` | 319 kB | +1.85 kB (+0.58%) |  |
| `build/scripts/customize-widgets/index.min.js` | 14.3 kB | +2.02 kB (+16.48%) | ⚠️ |
| `build/scripts/edit-post/index.min.js` | 18.4 kB | +1.99 kB (+12.1%) | ⚠️ |
| `build/scripts/edit-site/index.min.js` | 263 kB | +126 B (+0.05%) |  |
| `build/scripts/edit-widgets/index.min.js` | 21.9 kB | +2.03 kB (+10.18%) | ⚠️ |
| `build/scripts/editor/index.min.js` | 422 kB | +46 B (+0.01%) |  |
| `build/scripts/format-library/index.min.js` | 12.8 kB | +2.04 kB (+19.03%) | ⚠️ |
| `build/scripts/media-utils/index.min.js` | 79.4 kB | +152 B (+0.19%) |  |
...
### github-actions on 2026-04-23T15:41:03Z

URL: https://github.com/WordPress/gutenberg/pull/77575#issuecomment-4305781840
...
### github-actions on 2026-04-24T12:29:40Z

URL: https://github.com/WordPress/gutenberg/pull/77575#issuecomment-4313147549

<!-- flaky-tests-report-comment -->
**Flaky tests detected in e8a9164d4137eef557b646368b28ce0c967b7551.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/24888260974
📝  Reported issues:
- #76524 in `/test/e2e/specs/editor/various/post-content-focus-mode.spec.js`

### talldan on 2026-05-01T04:53:46Z

URL: https://github.com/WordPress/gutenberg/pull/77575#issuecomment-4357883662

@mirka @ciampo It looks like there's a regression for the Navigation block. At the moment the visually hidden description for the block is visible ('Navigation Menu: "Navigation"'):
<img width="590" height="97" alt="Screenshot 2026-05-01 at 12 50 18 pm" src="https://github.com/user-attachments/assets/64b3ab4a-3922-4812-9076-5b8d1f1e5636" />

My guess is that the new component's styles aren't present in the block editor iframe, but I haven't debugged it.

### mirka on 2026-05-04T13:25:00Z

URL: https://github.com/WordPress/gutenberg/pull/77575#issuecomment-4371412914

@talldan Thanks for reporting. Looks like we need some special handling for the iframes. I'll look into it.

### mirka on 2026-05-05T17:05:54Z

URL: https://github.com/WordPress/gutenberg/pull/77575#issuecomment-4381389594
...
#### ciampo on 2026-04-24T10:22:19Z

URL: https://github.com/WordPress/gutenberg/pull/77575#discussion_r3137052593
Path: packages/editor/src/components/post-text-editor/index.js

This instance still needs to be migrated

#### mirka on 2026-04-24T11:13:16Z

URL: https://github.com/WordPress/gutenberg/pull/77575#discussion_r3137297503
Path: packages/editor/src/components/post-text-editor/index.js
...
#### ciampo on 2026-04-24T10:22:45Z

URL: https://github.com/WordPress/gutenberg/pull/77575#discussion_r3137054515
Path: packages/edit-widgets/src/components/header/index.js

Same here

### Review thread 3 (resolved)

#### ciampo on 2026-04-24T10:23:17Z

URL: https://github.com/WordPress/gutenberg/pull/77575#discussion_r3137057014
...
#### ciampo on 2026-04-24T11:27:03Z

URL: https://github.com/WordPress/gutenberg/pull/77575#discussion_r3137368056
Path: packages/dataviews/src/components/dataviews-layouts/activity/activity-item.tsx

```diff
@@ -162,8 +161,9 @@ function ActivityItem< Item >(
...
Nit: for consistency, should `className` always be applied on `VisuallyHidden`, or always on the `render`ed element? Currently we're doing both.

#### mirka on 2026-04-24T11:58:32Z

URL: https://github.com/WordPress/gutenberg/pull/77575#discussion_r3137514978
Path: packages/dataviews/src/components/dataviews-layouts/activity/activity-item.tsx
...
#### ciampo on 2026-04-24T12:11:45Z

URL: https://github.com/WordPress/gutenberg/pull/77575#discussion_r3137581292
Path: packages/dataviews/src/components/dataviews-layouts/activity/activity-item.tsx
...
- packages/block-directory/package.json (MODIFIED, +1/-0)
...
- packages/block-editor/src/components/block-mover/button.js (MODIFIED, +8/-6)
...
- packages/block-editor/src/components/inserter/menu.js (MODIFIED, +3/-2)
...
- packages/block-editor/src/utils/test/dom.js (MODIFIED, +1/-1)
...
- packages/components/src/visually-hidden/stories/index.story.tsx (MODIFIED, +2/-9)
- packages/customize-widgets/package.json (MODIFIED, +1/-0)
- packages/customize-widgets/src/components/more-menu/index.js (MODIFIED, +2/-2)
...
- packages/edit-site/tsconfig.json (MODIFIED, +1/-0)
- packages/edit-widgets/package.json (MODIFIED, +1/-0)
- packages/edit-widgets/src/components/header/index.js (MODIFIED, +3/-2)
- packages/edit-widgets/src/components/more-menu/index.js (MODIFIED, +3/-7)
- packages/editor/src/components/collab-sidebar/comment-form.js (MODIFIED, +3/-3)
- packages/editor/src/components/more-menu/index.js (MODIFIED, +3/-7)
...
- packages/editor/src/components/post-publish-panel/test/__snapshots__/index.js.snap (MODIFIED, +6/-14)
...
- packages/fields/src/components/media-edit/index.tsx (MODIFIED, +2/-2)
...
- tools/eslint/config.mjs (MODIFIED, +2/-2)
