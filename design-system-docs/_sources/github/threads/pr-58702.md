...
type: pull_request
state: MERGED
merged_at: 2024-02-06T15:48:37Z
url: https://github.com/WordPress/gutenberg/pull/58702
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components","has dev note"]
---

# PR #58702: FontSizePicker: Hard deprecate bottom margin

- URL: https://github.com/WordPress/gutenberg/pull/58702
- Author: mirka
- Created: 2024-02-06T00:14:11Z
- Updated: 2024-02-26T21:40:39Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 12 of 12
- Diff: ../pr-diffs/58702.diff
...
Promotes `__nextHasNoMarginBottom` on FontSizePicker to the default behavior.
...
In the Storybook for FontSizePicker, turn on the [margin checker tool](https://github.com/WordPress/gutenberg/assets/555336/f4fcf334-7c27-47ad-acba-e9b3a5f6f734) in the toolbar. The margin-free styles should now be the default, and the `__nextHasNoMarginBottom` prop should not be listed in the props table.

✅ The wrapped FontSizePicker component exported from `@wordpress/block-editor` followed the same deprecation schedule as the canonical FontSizePicker component.
✅ Other usages in the Gutenberg app already are in margin-free mode.
✅ There are no internal components that use FontSizePicker under the hood.
...
### github-actions on 2024-02-06T00:14:31Z

URL: https://github.com/WordPress/gutenberg/pull/58702#issuecomment-1928546000
...
### github-actions on 2024-02-06T00:23:51Z

URL: https://github.com/WordPress/gutenberg/pull/58702#issuecomment-1928554855
...
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 251 kB | -1 B (0%) |
| `build/components/index.min.js` | 225 kB | -169 B (0%) |
...
- packages/block-editor/src/components/font-sizes/README.MD (MODIFIED, +0/-9)
...
- packages/components/src/font-size-picker/README.md (MODIFIED, +0/-8)
- packages/components/src/font-size-picker/font-size-picker-toggle-group.tsx (MODIFIED, +2/-9)
- packages/components/src/font-size-picker/index.tsx (MODIFIED, +3/-21)
- packages/components/src/font-size-picker/stories/index.story.tsx (MODIFIED, +0/-1)
- packages/components/src/font-size-picker/styles.ts (MODIFIED, +0/-7)
- packages/components/src/font-size-picker/test/index.tsx (MODIFIED, +16/-99)
- packages/components/src/font-size-picker/types.ts (MODIFIED, +3/-1)
