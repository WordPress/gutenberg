...
type: pull_request
state: MERGED
merged_at: 2021-10-28T14:59:11Z
url: https://github.com/WordPress/gutenberg/pull/36014
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components","[Package] Block editor"]
---

# PR #36014: Update spacing in CircularOptionPicker

- URL: https://github.com/WordPress/gutenberg/pull/36014
- Author: ajlende
- Created: 2021-10-27T22:35:06Z
- Updated: 2021-10-28T14:59:41Z
- Comments: 2 of 2
- Review threads: 2 of 2
- Changed files: 2 of 2
- Diff: ../pr-diffs/36014.diff
...
### github-actions on 2021-10-27T22:42:47Z

URL: https://github.com/WordPress/gutenberg/pull/36014#issuecomment-953363608
...
| :--- | :---: | :---: |
| `build/block-editor/style-rtl.css` | 14 kB | -16 B (0%) |
| `build/block-editor/style.css` | 14 kB | -15 B (0%) |
| `build/components/style-rtl.css` | 15.4 kB | -4 B (0%) |
| `build/components/style.css` | 15.4 kB | -4 B (0%) |
...
### jasmussen on 2021-10-28T10:45:32Z

URL: https://github.com/WordPress/gutenberg/pull/36014#issuecomment-953727646

Very nice, lots of red, and gap is _made_ for this use case.
<img width="327" alt="Screenshot 2021-10-28 at 12 41 11" src="https://user-images.githubusercontent.com/1204802/139240405-603c1933-0963-4fcb-b1d1-bbca6a6f5bc2.png">

<img width="451" alt="Screenshot 2021-10-28 at 12 41 07" src="https://user-images.githubusercontent.com/1204802/139240410-3f3d40d7-0837-4591-83c4-1dee33589e7b.png">

Looks great.

I do wonder if we could polish the duotone dropdown a bit more. It looks the same as before:

<img width="789" alt="Screenshot 2021-10-28 at 12 40 14" src="https://user-images.githubusercontent.com/1204802/139240483-2d5f2931-fd96-4460-a766-c05fe3c13a5d.png">

The padding in the box, the subheading, the margin above, the margin below the swatches is all a bit wide. It seems like there's some component stuff going on here with menu items and itemgroups doubling paddings. It shouldn't block this PR from landing, but worth looking into.

But just adding space-between to the flex inside the duotone helps a lot:
<img width="396" alt="Screenshot 2021-10-28 at 12 45 23" src="https://user-images.githubusercontent.com/1204802/139240914-03edf9c2-a0f0-48d8-baba-bb3fb193365a.png">

## Review threads

### Review thread 1

#### ajlende on 2021-10-27T22:39:38Z

URL: https://github.com/WordPress/gutenberg/pull/36014#discussion_r737896729
...
#### jasmussen on 2021-10-28T10:58:10Z

URL: https://github.com/WordPress/gutenberg/pull/36014#discussion_r738275637
...
#### ajlende on 2021-10-28T14:55:04Z

URL: https://github.com/WordPress/gutenberg/pull/36014#discussion_r738478562
Path: packages/components/src/circular-option-picker/style.scss
...
![duotone-space-between](https://user-images.githubusercontent.com/5129775/139281215-8d631a71-0025-477a-bed5-c48ce63a44f6.png)
...
- packages/block-editor/src/components/colors-gradients/style.scss (MODIFIED, +3/-14)
- packages/components/src/circular-option-picker/style.scss (MODIFIED, +3/-5)
