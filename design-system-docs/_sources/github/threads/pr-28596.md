...
type: pull_request
state: MERGED
merged_at: 2021-02-16T21:01:20Z
url: https://github.com/WordPress/gutenberg/pull/28596
...
# PR #28596: Component System: Add Surface Component

- URL: https://github.com/WordPress/gutenberg/pull/28596
- Author: ItsJonQ
- Created: 2021-01-29T15:51:01Z
- Updated: 2021-02-16T21:01:45Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 9 of 9
- Diff: ../pr-diffs/28596.diff

## Body

<img width="772" alt="Screen Shot 2021-01-29 at 10 42 36 AM" src="https://user-images.githubusercontent.com/2322354/106296272-71f01600-621f-11eb-8d5a-6adff8c28110.png">

This update adds a new [Surface component](https://github.com/ItsJonQ/g2/tree/main/packages/components/src/Surface) for the [new Component System](https://github.com/WordPress/gutenberg/issues/28399).

This is a brand new layout primitive component. `@wordpress/components` previously didn't have a `Surface` component, so we didn't need to "adapt" it.

This component renders basic UI backgrounds using the "surface" values from the new Style System.
...
This is made clearer when using the new `<Text />` component within `<Surface />`.

Surface is effectively used in everything that has a standard UI background. Cards, Menus, Modals, Toolbars, Sidebars, etc...
...
### github-actions on 2021-01-29T16:00:51Z

URL: https://github.com/WordPress/gutenberg/pull/28596#issuecomment-769891584
...
### ItsJonQ on 2021-02-16T20:53:12Z

URL: https://github.com/WordPress/gutenberg/pull/28596#issuecomment-780110792
...
- packages/components/src/ui/surface/README.md (ADDED, +67/-0)
- packages/components/src/ui/surface/component.js (ADDED, +11/-0)
- packages/components/src/ui/surface/hook.js (ADDED, +70/-0)
- packages/components/src/ui/surface/index.js (ADDED, +2/-0)
- packages/components/src/ui/surface/stories/index.js (ADDED, +49/-0)
- packages/components/src/ui/surface/styles.js (ADDED, +105/-0)
- packages/components/src/ui/surface/test/__snapshots__/index.js.snap (ADDED, +133/-0)
- packages/components/src/ui/surface/test/index.js (ADDED, +64/-0)
- packages/components/src/ui/surface/types.ts (ADDED, +62/-0)
