...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/75095
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #75095: ValidatedToggleControl: Fix validation timing with callback ref

- URL: https://github.com/WordPress/gutenberg/pull/75095
- Author: ntsekouras
- Created: 2026-01-30T15:13:29Z
- Updated: 2026-02-03T16:07:18Z
- Comments: 6 of 6
- Review threads: 2 of 2
- Changed files: 3 of 3
- Diff: ../pr-diffs/75095.diff
...
### github-actions on 2026-01-30T15:13:39Z

URL: https://github.com/WordPress/gutenberg/pull/75095#issuecomment-3824256085
...
### github-actions on 2026-01-30T15:26:57Z

URL: https://github.com/WordPress/gutenberg/pull/75095#issuecomment-3824312600

**Size Change:** +1.46 kB (+0.05%) 

**Total Size:** 3 MB

| Filename | Size | Change |  |
| :--- | :---: | :---: | :---: |
| `build/scripts/components/index.min.js` | 266 kB | +15 B (+0.01%) |  |
| `build/styles/block-library/editor-rtl.css` | 12.3 kB | +186 B (+1.54%) |  |
| `build/styles/block-library/editor-rtl.min.css` | 10.1 kB | +173 B (+1.75%) |  |
| `build/styles/block-library/editor.css` | 12.3 kB | +184 B (+1.52%) |  |
| `build/styles/block-library/editor.min.css` | 10.1 kB | +170 B (+1.71%) |  |
| `build/styles/block-library/navigation/editor-rtl.css` | 3.47 kB | +184 B (+5.61%) | 🔍 |
| `build/styles/block-library/navigation/editor-rtl.min.css` | 2.46 kB | +181 B (+7.95%) | 🔍 |
| `build/styles/block-library/navigation/editor.css` | 3.47 kB | +184 B (+5.6%) | 🔍 |
| `build/styles/block-library/navigation/editor.min.css` | 2.46 kB | +180 B (+7.9%) | 🔍 |
...
### github-actions on 2026-02-02T10:18:58Z

URL: https://github.com/WordPress/gutenberg/pull/75095#issuecomment-3834221379

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 83ab062a65aa97b9be252dcff8551a5d5060e5b7.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/21585474522
📝  Reported issues:
- #74483 in `/test/e2e/specs/site-editor/pages.spec.js`

### aduth on 2026-02-02T20:16:52Z

URL: https://github.com/WordPress/gutenberg/pull/75095#issuecomment-3837314602

> We could make `ToggleControl` pass rest props down to `FormToggle` (similar to `TextControl` etc..). This would allow `required` to flow through naturally via [ControlWithError's cloneElement](https://github.com/WordPress/gutenberg/blob/trunk/packages/components/src/validated-form-controls/control-with-error.tsx#L263). Should we implement that?

Tracing back how this component was implemented, I think this could very well be the best path forward. We may not even need to pass _every_ prop through if we wanted to be more controlled/conservative about it, just `required` should suffice. It looks like the component was introduced in #70620, and [the comment about "upstream limitation"](https://github.com/WordPress/gutenberg/blob/396d67ed44b915a06f7e5470fdb2f8e577cbab5d/packages/components/src/validated-form-controls/components/toggle-control.tsx#L28) was likely carried over from an external project. As best I can tell, "upstream" in this instance actually refers to Gutenberg's own `ToggleControl`.

cc @mirka

### mirka on 2026-02-03T11:56:54Z

URL: https://github.com/WordPress/gutenberg/pull/75095#issuecomment-3840881079

Right, this workaround was originally written back when we couldn't make changes to `ToggleControl` itself. We should address the issue in `ToggleControl` if possible.

### aduth on 2026-02-03T12:57:33Z

URL: https://github.com/WordPress/gutenberg/pull/75095#issuecomment-3841160052

It looks like @SirLouen may already be implementing that in #74956 😄

## Review threads

### Review thread 1

#### aduth on 2026-01-30T16:14:37Z

URL: https://github.com/WordPress/gutenberg/pull/75095#discussion_r2746994154
Path: packages/components/src/validated-form-controls/components/toggle-control.tsx
...
#### ntsekouras on 2026-02-02T08:58:32Z

URL: https://github.com/WordPress/gutenberg/pull/75095#discussion_r2753268056
Path: packages/components/src/validated-form-controls/components/toggle-control.tsx
...
We need to have a reference of the node for `getValidityTarget` below and since we use a callback ref, we need to make `validityTargetRef` mutable (by adding the `| null`). Without it the ref is readonly.


It can be passed [null](https://react.dev/reference/react-dom/components/common#returns), yes.

>If a function is not returned by the ref callback, React will call the callback again with null as the argument when the ref gets detached.

#### aduth on 2026-02-02T19:48:00Z

URL: https://github.com/WordPress/gutenberg/pull/75095#discussion_r2755926835
Path: packages/components/src/validated-form-controls/components/toggle-control.tsx
...
Noting that the next sentence of that quoted documentation is "This behavior will be removed in a future version", but tracks with how it behaves today 👍 But we also have a [guard with early return](https://github.com/WordPress/gutenberg/blob/83ab062a65aa97b9be252dcff8551a5d5060e5b7/packages/components/src/validated-form-controls/components/toggle-control.tsx#L31-L33) that would that `null` assignment. Not a blocker in any case.

#### Mamaduka on 2026-02-03T04:08:03Z

URL: https://github.com/WordPress/gutenberg/pull/75095#discussion_r2757090986
Path: packages/components/src/validated-form-controls/components/toggle-control.tsx
...
Considering our current rate of React upgrades, the "future version", might be in far future 😅

### Review thread 2

#### aduth on 2026-01-30T16:14:51Z

URL: https://github.com/WordPress/gutenberg/pull/75095#discussion_r2746995417
Path: packages/components/src/validated-form-controls/components/toggle-control.tsx
...
#### Mamaduka on 2026-02-01T15:12:11Z

URL: https://github.com/WordPress/gutenberg/pull/75095#discussion_r2751352780
Path: packages/components/src/validated-form-controls/components/toggle-control.tsx
...
If you don't want the ref callback to be called on every re-render, we should use `useCallback`.
...
Ref: https://react.dev/reference/react-dom/components/common#ref-callback-parameters

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/validated-form-controls/components/test/index.tsx (ADDED, +44/-0)
- packages/components/src/validated-form-controls/components/toggle-control.tsx (MODIFIED, +16/-10)
