...
type: pull_request
state: MERGED
merged_at: 2024-02-07T17:39:49Z
url: https://github.com/WordPress/gutenberg/pull/58703
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components","has dev note"]
---

# PR #58703: Components: Remove deprecation warnings for `__next36pxDefaultSize`

- URL: https://github.com/WordPress/gutenberg/pull/58703
- Author: mirka
- Created: 2024-02-06T00:37:28Z
- Updated: 2024-02-26T21:37:30Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 11 of 11
- Diff: ../pr-diffs/58703.diff
...
Removes the console logging of deprecation warnings for the `__next36pxDefaultSize` prop.
...
See the Storybook for any of the affected components. Toggling the control for `__next36pxDefaultSize` to `true` should not log a deprecation warning in the console.
...
### github-actions on 2024-02-06T00:47:51Z

URL: https://github.com/WordPress/gutenberg/pull/58703#issuecomment-1928575682
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 225 kB | -135 B (0%) |
...
### github-actions on 2024-02-06T13:54:30Z

URL: https://github.com/WordPress/gutenberg/pull/58703#issuecomment-1929702777
...
```
Props 0mirka00, mciampini, tyxla, swissspidy, jorbin, costdev, richtabor, peterwilsoncc.
```
...
### github-actions on 2024-02-07T13:47:46Z

URL: https://github.com/WordPress/gutenberg/pull/58703#issuecomment-1932088945

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 0cbbc0af2b4bdf2a99cb1d85d2bca7cb4ea1abf4.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/7815564569
📝  Reported issues:
...
- packages/components/src/custom-select-control/index.js (MODIFIED, +1/-5)
- packages/components/src/form-token-field/index.tsx (MODIFIED, +1/-4)
- packages/components/src/input-control/index.tsx (MODIFIED, +1/-5)
- packages/components/src/input-control/input-base.tsx (MODIFIED, +1/-3)
- packages/components/src/number-control/index.tsx (MODIFIED, +1/-5)
- packages/components/src/select-control/index.tsx (MODIFIED, +1/-5)
- packages/components/src/tree-select/index.tsx (MODIFIED, +1/-5)
- packages/components/src/unit-control/index.tsx (MODIFIED, +1/-5)
- packages/components/src/utils/use-deprecated-props.ts (MODIFIED, +1/-18)
