...
type: pull_request
state: MERGED
merged_at: 2021-04-28T17:05:02Z
url: https://github.com/WordPress/gutenberg/pull/31292
matched_labels: ["[Package] Components","[Feature] Component System"]
all_labels: ["npm Packages","[Package] Components","Storybook","[Feature] Component System"]
---

# PR #31292: components: Remove all remenants of wp-g2

- URL: https://github.com/WordPress/gutenberg/pull/31292
- Author: sarayourfriend
- Created: 2021-04-28T15:56:33Z
- Updated: 2021-04-28T17:05:28Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 16 of 16
- Diff: ../pr-diffs/31292.diff
...
## Description
Removes all remaining remenants of wp-g2 imports and removes the dependencies.

## How has this been tested?
Run `npm run storybook:dev` and test each of the experimental g2 components to ensure they still work. The main ones that changed are `Spinner` and then the story for `Elevation` changed.
...
### github-actions on 2021-04-28T16:06:31Z

URL: https://github.com/WordPress/gutenberg/pull/31292#issuecomment-828579122
...
| `build/components/index.js` | 187 kB | 0 B |
...
- package-lock.json (MODIFIED, +24/-293)
- packages/components/package.json (MODIFIED, +0/-6)
- packages/components/src/ui/__storybook-utils/example-grid.js (MODIFIED, +14/-6)
- packages/components/src/ui/__storybook-utils/page.js (MODIFIED, +12/-6)
- packages/components/src/ui/card/stories/index.js (MODIFIED, +3/-6)
- packages/components/src/ui/control-group/stories/index.js (DELETED, +0/-49)
- packages/components/src/ui/control-group/test/__snapshots__/index.js.snap (MODIFIED, +11/-1232)
- packages/components/src/ui/control-group/test/index.js (MODIFIED, +1/-14)
- packages/components/src/ui/h-stack/component.js (MODIFIED, +1/-1)
- packages/components/src/ui/heading/hook.ts (MODIFIED, +1/-1)
- packages/components/src/ui/spinner/README.md (MODIFIED, +1/-1)
- packages/components/src/ui/spinner/component.js (MODIFIED, +1/-1)
- packages/components/src/ui/spinner/styles.js (MODIFIED, +2/-3)
- packages/components/src/ui/surface/README.md (MODIFIED, +1/-1)
- packages/components/src/ui/surface/component.js (MODIFIED, +1/-1)
