...
type: pull_request
state: MERGED
merged_at: 2025-12-11T13:54:17Z
url: https://github.com/WordPress/gutenberg/pull/73916
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #73916: CheckboxControl: Deprecate bottom margin

- URL: https://github.com/WordPress/gutenberg/pull/73916
- Author: mirka
- Created: 2025-12-11T12:20:34Z
- Updated: 2025-12-11T13:54:54Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 33 of 33
- Diff: ../pr-diffs/73916.diff
...
### github-actions on 2025-12-11T12:20:47Z

URL: https://github.com/WordPress/gutenberg/pull/73916#issuecomment-3641666565
...
### mirka on 2025-12-11T12:24:44Z

URL: https://github.com/WordPress/gutenberg/pull/73916#issuecomment-3641681375

Skipping the DataViews changelog since the changes are completely internal.

### github-actions on 2025-12-11T12:33:43Z

URL: https://github.com/WordPress/gutenberg/pull/73916#issuecomment-3641713726
...
| `build/scripts/block-library/index.min.js` | 279 kB | -19 B (-0.01%) |
| `build/scripts/components/index.min.js` | 273 kB | -37 B (-0.01%) |
| `build/scripts/edit-site/index.min.js` | 234 kB | -6 B (0%) |
| `build/scripts/editor/index.min.js` | 284 kB | -55 B (-0.02%) |
| `build/scripts/format-library/index.min.js` | 10.8 kB | -5 B (-0.05%) |
| `build/scripts/media-utils/index.min.js` | 69.4 kB | -28 B (-0.04%) |
...
- packages/block-editor/src/components/block-lock/modal.js (MODIFIED, +0/-4)
- packages/block-editor/src/components/block-manager/category.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/block-manager/checklist.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/block-manager/index.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/link-control/settings.js (MODIFIED, +0/-1)
- packages/block-library/src/breadcrumbs/edit.js (MODIFIED, +0/-2)
- packages/block-library/src/navigation-link/shared/controls.js (MODIFIED, +0/-1)
- packages/components/CHANGELOG.md (MODIFIED, +2/-1)
- packages/components/src/checkbox-control/README.md (MODIFIED, +0/-8)
- packages/components/src/checkbox-control/index.tsx (MODIFIED, +1/-4)
- packages/components/src/checkbox-control/stories/index.story.tsx (MODIFIED, +0/-7)
- packages/components/src/checkbox-control/test/index.tsx (MODIFIED, +1/-8)
- packages/components/src/checkbox-control/types.ts (MODIFIED, +1/-4)
- packages/components/src/validated-form-controls/components/checkbox-control.tsx (MODIFIED, +1/-6)
- packages/dataviews/src/components/dataviews-bulk-actions/index.tsx (MODIFIED, +0/-1)
- packages/dataviews/src/components/dataviews-picker/footer.tsx (MODIFIED, +0/-1)
- packages/dataviews/src/components/dataviews-selection-checkbox/index.tsx (MODIFIED, +0/-1)
- packages/editor/src/components/entities-saved-states/entity-record-item.js (MODIFIED, +0/-1)
- packages/editor/src/components/post-pending-status/index.js (MODIFIED, +0/-1)
- packages/editor/src/components/post-pingbacks/index.js (MODIFIED, +0/-1)
- packages/editor/src/components/post-publish-panel/index.js (MODIFIED, +0/-1)
- packages/editor/src/components/post-status/index.js (MODIFIED, +0/-1)
- packages/editor/src/components/post-sticky/index.js (MODIFIED, +0/-1)
- packages/editor/src/components/post-taxonomies/hierarchical-term-selector.js (MODIFIED, +0/-1)
- packages/editor/src/components/start-page-options/index.js (MODIFIED, +0/-1)
- packages/fields/src/fields/password/edit.tsx (MODIFIED, +0/-1)
- packages/fields/src/fields/ping-status/index.tsx (MODIFIED, +0/-1)
- packages/format-library/src/link/css-classes-setting.js (MODIFIED, +0/-1)
- packages/global-styles-ui/src/font-library/collection-font-variant.tsx (MODIFIED, +0/-1)
- packages/global-styles-ui/src/font-library/font-collection.tsx (MODIFIED, +0/-1)
- packages/global-styles-ui/src/font-library/installed-fonts.tsx (MODIFIED, +0/-1)
- packages/global-styles-ui/src/font-library/library-font-variant.tsx (MODIFIED, +0/-1)
