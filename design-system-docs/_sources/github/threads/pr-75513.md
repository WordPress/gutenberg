...
type: pull_request
state: MERGED
merged_at: 2026-02-13T18:41:05Z
url: https://github.com/WordPress/gutenberg/pull/75513
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Compose","[Package] Components","[Package] DataViews","[Package] Fields"]
---

# PR #75513: useRef: always supply initial value

- URL: https://github.com/WordPress/gutenberg/pull/75513
- Author: jsnajdr
- Created: 2026-02-13T13:02:20Z
- Updated: 2026-02-13T18:41:55Z
- Comments: 3 of 3
- Review threads: 1 of 1
- Changed files: 43 of 43
- Diff: ../pr-diffs/75513.diff
...
### github-actions on 2026-02-13T13:02:31Z

URL: https://github.com/WordPress/gutenberg/pull/75513#issuecomment-3897135905
...
### github-actions on 2026-02-13T13:19:38Z

URL: https://github.com/WordPress/gutenberg/pull/75513#issuecomment-3897206082
...
| :--- | :---: | :---: |
| `build/scripts/components/index.min.js` | 266 kB | +5 B (0%) |
| `build/scripts/compose/index.min.js` | 13.9 kB | +9 B (+0.06%) |
| `build/scripts/edit-site/index.min.js` | 244 kB | +9 B (0%) |
| `build/scripts/editor/index.min.js` | 344 kB | +5 B (0%) |
| `build/scripts/media-utils/index.min.js` | 73.6 kB | +4 B (+0.01%) |
...
### jsnajdr on 2026-02-13T14:55:11Z

URL: https://github.com/WordPress/gutenberg/pull/75513#issuecomment-3897649917

> There seem to be a number of instances remaining after the changes here in `.js` files, do those need to be updated as well?

Thanks for noticing this. These files are not typechecked, usually because given package's `tsconfig.json` doesn't include them. So there is nobody to complain about the missing arguments. We should fix them in another `useRef` fixing batch, but it's not a blocker now.

## Review threads

### Review thread 1

#### aduth on 2026-02-13T13:33:14Z

URL: https://github.com/WordPress/gutenberg/pull/75513#discussion_r2804250596
Path: packages/image-cropper/src/stories/index.story.tsx
...
Why do we need the `| null` here?

#### jsnajdr on 2026-02-13T14:53:25Z

URL: https://github.com/WordPress/gutenberg/pull/75513#discussion_r2804619518
Path: packages/image-cropper/src/stories/index.story.tsx
...
```
and this call returns a `RefObject<HtmlDivElement|null>`. It's an object whose `.current` field can be `null` and the ref is passed to a `div` as `<div ref={containerRef}>`. React is really going to assign `null` values there.
...
- packages/components/src/higher-order/with-notices/test/index.tsx (MODIFIED, +2/-2)
- packages/components/src/keyboard-shortcuts/index.tsx (MODIFIED, +1/-1)
- packages/components/src/modal/index.tsx (MODIFIED, +4/-3)
...
- packages/components/src/resizable-box/resize-tooltip/utils.ts (MODIFIED, +1/-1)
- packages/components/src/sandbox/index.tsx (MODIFIED, +1/-1)
...
- packages/compose/src/hooks/use-copy-on-click/index.js (MODIFIED, +1/-1)
- packages/compose/src/hooks/use-dialog/index.ts (MODIFIED, +1/-1)
- packages/compose/src/hooks/use-focus-on-mount/index.js (MODIFIED, +1/-1)
...
- packages/dataviews/src/components/dataform-controls/datetime.tsx (MODIFIED, +2/-1)
- packages/dataviews/src/components/dataviews-bulk-actions/index.tsx (MODIFIED, +2/-2)
- packages/dataviews/src/components/dataviews-layouts/picker-table/index.tsx (MODIFIED, +1/-1)
- packages/dataviews/src/components/dataviews-layouts/table/index.tsx (MODIFIED, +1/-1)
- packages/dataviews/src/dataviews-picker/index.tsx (MODIFIED, +1/-1)
- packages/dataviews/src/dataviews/index.tsx (MODIFIED, +1/-1)
- packages/fields/src/components/media-edit/index.tsx (MODIFIED, +1/-1)
- packages/fields/src/components/media-edit/use-moving-animation.ts (MODIFIED, +1/-1)
- packages/image-cropper/src/stories/index.story.tsx (MODIFIED, +4/-2)
