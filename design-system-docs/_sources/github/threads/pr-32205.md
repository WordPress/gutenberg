...
type: pull_request
state: MERGED
merged_at: 2021-05-27T15:03:16Z
url: https://github.com/WordPress/gutenberg/pull/32205
matched_labels: ["[Package] Components","[Feature] Component System"]
all_labels: ["[Package] Components","[Feature] Component System"]
---

# PR #32205: components: Remove all `withNext` wrappers

- URL: https://github.com/WordPress/gutenberg/pull/32205
- Author: sarayourfriend
- Created: 2021-05-25T14:46:11Z
- Updated: 2021-05-27T15:03:42Z
- Comments: 1 of 1
- Review threads: 1 of 1
- Changed files: 14 of 14
- Diff: ../pr-diffs/32205.diff
...
## Description
Because we're moving away from this strategy (see #30503 for details) we can remove the `withNext` component wrappers.
...
### github-actions on 2021-05-25T14:56:29Z

URL: https://github.com/WordPress/gutenberg/pull/32205#issuecomment-847940445
...
| `build/block-editor/index.js` | 118 kB | +56 B (0%) |  |
| `build/block-library/blocks/file/frontend.js` | 773 B | +2 B (0%) |  |
...
| `build/components/index.js` | 179 kB | -10.6 kB (-6%) | ✅ |
| `build/core-data/index.js` | 12.1 kB | -3 B (0%) |  |
| `build/customize-widgets/index.js` | 43.3 kB | +71 B (0%) |  |
...
| `build/edit-navigation/index.js` | 13.9 kB | +94 B (+1%) |  |
| `build/edit-post/index.js` | 571 kB | +77 B (0%) |  |
| `build/edit-site/index.js` | 25.9 kB | +117 B (0%) |  |
| `build/edit-widgets/index.js` | 292 kB | +85 B (0%) |  |
| `build/editor/index.js` | 38.4 kB | +36 B (0%) |  |
| `build/element/index.js` | 3.44 kB | +1 B (0%) |  |
| `build/format-library/index.js` | 5.67 kB | +2 B (0%) |  |
| `build/html-entities/index.js` | 628 B | +1 B (0%) |  |
| `build/i18n/index.js` | 3.73 kB | -1 B (0%) |  |
| `build/is-shallow-equal/index.js` | 709 B | -1 B (0%) |  |
| `build/keyboard-shortcuts/index.js` | 1.65 kB | -4 B (0%) |  |
...
| `build/react-i18n/index.js` | 924 B | +1 B (0%) |  |
| `build/redux-routine/index.js` | 2.82 kB | +2 B (0%) |  |
| `build/rich-text/index.js` | 10.6 kB | -3 B (0%) |  |
| `build/server-side-render/index.js` | 1.63 kB | -4 B (0%) |  |
...
| `build/widgets/index.js` | 1.67 kB | +2 B (0%) |  |
...
#### ciampo on 2021-05-26T10:17:14Z

URL: https://github.com/WordPress/gutenberg/pull/32205#discussion_r639590932
Path: package.json
...
The only instance of `COMPONENT_SYSTEM_PHASE` left in the codebase would be in the changelog, which raises the question: should this change be also added as a changelog entry?

#### sarayourfriend on 2021-05-26T13:22:48Z

URL: https://github.com/WordPress/gutenberg/pull/32205#discussion_r639720706
Path: package.json
...
- packages/block-editor/src/hooks/typography.js (MODIFIED, +7/-14)
- packages/components/src/index.js (MODIFIED, +0/-6)
- packages/components/src/tooltip/index.js (MODIFIED, +1/-2)
- packages/components/src/tooltip/next.js (DELETED, +0/-17)
- packages/components/src/ui/context/component-system-provider.js (DELETED, +0/-36)
- packages/components/src/ui/context/index.js (MODIFIED, +0/-2)
- packages/components/src/ui/context/with-next.js (DELETED, +0/-48)
- packages/components/src/visually-hidden/index.js (MODIFIED, +1/-2)
- packages/components/src/visually-hidden/next.js (DELETED, +0/-31)
- packages/edit-site/src/components/sidebar/global-styles-sidebar.js (MODIFIED, +3/-10)
- storybook/main.js (MODIFIED, +1/-3)
- typings/gutenberg-env/index.d.ts (MODIFIED, +0/-1)
