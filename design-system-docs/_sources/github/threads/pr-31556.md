...
type: pull_request
state: MERGED
merged_at: 2021-05-07T17:18:12Z
url: https://github.com/WordPress/gutenberg/pull/31556
matched_labels: ["[Package] Components","[Feature] Component System"]
all_labels: ["[Package] Components","[Feature] Component System"]
---

# PR #31556: components: Promote Divider and use readable prop names

- URL: https://github.com/WordPress/gutenberg/pull/31556
- Author: sarayourfriend
- Created: 2021-05-06T17:55:27Z
- Updated: 2021-05-07T17:18:38Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 11 of 11
- Diff: ../pr-diffs/31556.diff
...
## Description
Promotes `Divider` and renames its props to readable names.

## How has this been tested?
Divider is unused so just unit tests and storybook.
...
### github-actions on 2021-05-06T18:05:09Z

URL: https://github.com/WordPress/gutenberg/pull/31556#issuecomment-833743326
...
| `build/block-directory/index.js` | 6.59 kB | -8 B (0%) |
| `build/block-editor/index.js` | 116 kB | +133 B (0%) |
| `build/block-editor/style-rtl.css` | 13 kB | -42 B (0%) |
| `build/block-editor/style.css` | 13 kB | -40 B (0%) |
| `build/block-library/index.js` | 142 kB | +3 B (0%) |
| `build/blocks/index.js` | 47 kB | -2 B (0%) |
| `build/components/index.js` | 188 kB | +818 B (0%) |
| `build/compose/index.js` | 9.91 kB | -48 B (0%) |
| `build/customize-widgets/index.js` | 5.79 kB | -28 B (0%) |
...
| `build/nux/index.js` | 2.31 kB | +4 B (0%) |
...
### gziolo on 2021-05-07T05:37:58Z

URL: https://github.com/WordPress/gutenberg/pull/31556#issuecomment-834081626

Unit tests are failing and there is one error reported by ESLint. Once it's resolved it's good to go.
...
- packages/components/src/divider/README.md (RENAMED, +0/-0)
- packages/components/src/divider/component.tsx (RENAMED, +35/-23)
- packages/components/src/divider/index.ts (RENAMED, +0/-0)
- packages/components/src/divider/stories/index.js (RENAMED, +1/-1)
- packages/components/src/divider/styles.ts (RENAMED, +1/-1)
- packages/components/src/divider/test/__snapshots__/index.js.snap (RENAMED, +0/-0)
- packages/components/src/divider/test/index.js (RENAMED, +3/-3)
