...
type: pull_request
state: MERGED
merged_at: 2025-11-03T08:39:27Z
url: https://github.com/WordPress/gutenberg/pull/72883
matched_labels: ["[Package] Theme"]
all_labels: ["[Type] Performance","[Package] Theme"]
---

# PR #72883: Theme: Optimize color generating algorithm

- URL: https://github.com/WordPress/gutenberg/pull/72883
- Author: aduth
- Created: 2025-10-31T15:23:41Z
- Updated: 2025-11-03T19:12:03Z
- Comments: 2 of 2
- Review threads: 1 of 1
- Changed files: 18 of 18
- Diff: ../pr-diffs/72883.diff
...
- Uses [Color.js's procedural API](https://colorjs.io/docs/procedural)
- Optimizes color constraint matching, using techniques like "[Illinois method](https://numbersandshapes.net/posts/pegasus_method/)" to converge on colors within constraints more efficiently
...
### github-actions on 2025-10-31T15:23:52Z

URL: https://github.com/WordPress/gutenberg/pull/72883#issuecomment-3473579148
...
### github-actions on 2025-10-31T15:35:06Z

URL: https://github.com/WordPress/gutenberg/pull/72883#issuecomment-3473631457

**Size Change:** -7.09 kB (-0.3%) 

**Total Size:** 2.37 MB

| Filename | Size | Change |  |
| :--- | :---: | :---: | :---: |
| `build/scripts/theme/index.min.js` | 21.5 kB | -7.09 kB (-24.79%) | 🎉 |
...
#### aduth on 2025-10-31T15:25:21Z

URL: https://github.com/WordPress/gutenberg/pull/72883#discussion_r2481798565
...
#### aduth on 2025-10-31T15:40:39Z

URL: https://github.com/WordPress/gutenberg/pull/72883#discussion_r2481851874
Path: packages/theme/bin/generate-primitive-tokens/index.ts
...
#### aduth on 2025-11-03T19:12:03Z

URL: https://github.com/WordPress/gutenberg/pull/72883#discussion_r2487574867
Path: packages/theme/bin/generate-primitive-tokens/index.ts
...
These comments should have been removed after a rebase with #72884.

I'm following-up with this at #72940, along with making the ESLint rules stricter about unnecessary `eslint-disable`.

## Changed files

- packages/theme/bin/generate-primitive-tokens/index.ts (MODIFIED, +15/-4)
- packages/theme/bin/terrazzo-plugin-figma-ds-token-manager/index.ts (MODIFIED, +11/-4)
- packages/theme/package.json (MODIFIED, +5/-1)
- packages/theme/src/color-ramps/index.ts (MODIFIED, +17/-13)
- packages/theme/src/color-ramps/lib/cache-utils.ts (DELETED, +0/-56)
- packages/theme/src/color-ramps/lib/color-utils.ts (ADDED, +37/-0)
- packages/theme/src/color-ramps/lib/constants.ts (MODIFIED, +10/-6)
- packages/theme/src/color-ramps/lib/find-color-with-constraints.ts (MODIFIED, +73/-60)
- packages/theme/src/color-ramps/lib/index.ts (MODIFIED, +30/-16)
- packages/theme/src/color-ramps/lib/register-color-spaces.ts (ADDED, +16/-0)
- packages/theme/src/color-ramps/lib/taper-chroma.ts (MODIFIED, +50/-19)
- packages/theme/src/color-ramps/lib/utils.ts (MODIFIED, +11/-9)
- packages/theme/src/color-ramps/test/__snapshots__/index.test.ts.snap (MODIFIED, +96/-96)
- packages/theme/src/color-ramps/test/index.test.ts (MODIFIED, +30/-15)
- packages/theme/src/prebuilt/css/design-tokens.css (MODIFIED, +36/-36)
- packages/theme/src/prebuilt/json/figma.json (MODIFIED, +36/-36)
- packages/theme/src/use-theme-provider-styles.ts (MODIFIED, +44/-20)
- packages/theme/tokens/color.json (MODIFIED, +36/-36)
