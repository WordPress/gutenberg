...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/33923
...
# PR #33923: Do not execute `rtl` function in `styled` components

- URL: https://github.com/WordPress/gutenberg/pull/33923
- Author: ciampo
- Created: 2021-08-06T10:37:33Z
- Updated: 2025-02-10T16:41:37Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/33923.diff
...
### ciampo on 2021-08-06T10:40:57Z

URL: https://github.com/WordPress/gutenberg/pull/33923#issuecomment-894172447

@sarayourfriend do you think there's any change to be applied to the `rtl` styles in [`unit-control-styles.js`](https://github.com/WordPress/gutenberg/blob/9d14cdfc47951888aa0fa08ab0afdc680c0316d0/packages/components/src/unit-control/styles/unit-control-styles.js#L92-L93) ?

The function is wrapped in `css()`, which then in turn wrapped in a `styled` component. Not sure if there's any value in refactoring the `rtl` code to be called directly in the `styled` component?

### github-actions on 2021-08-06T10:44:34Z

URL: https://github.com/WordPress/gutenberg/pull/33923#issuecomment-894174087
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 216 kB | -11 B (0%) |
...
### sarayourfriend on 2021-08-06T12:35:47Z

URL: https://github.com/WordPress/gutenberg/pull/33923#issuecomment-894229828

FWIW I believe this is duplicated by https://github.com/WordPress/gutenberg/pull/33696/files#diff-810861ca827286607f443cf248a938682066e055758543043045f63166bc286dL78

But we can merge this and rebase the other PR.

### ciampo on 2021-08-06T13:49:50Z

URL: https://github.com/WordPress/gutenberg/pull/33923#issuecomment-894274317

Makes sense, thank you for the explanation.

> Because these components aren't type checked you won't get an error about this

Absolutely, writing components in TypeScript can really help with this sort of changes.
...
- packages/components/src/box-control/styles/box-control-styles.js (MODIFIED, +3/-3)
- packages/components/src/select-control/styles/select-control-styles.js (MODIFIED, +2/-2)
