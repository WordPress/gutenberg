...
type: pull_request
state: MERGED
merged_at: 2024-10-31T14:23:53Z
url: https://github.com/WordPress/gutenberg/pull/66572
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components","[Package] Editor","Needs Dev Note"]
---

# PR #66572: Radio: Deprecate 36px default size

- URL: https://github.com/WordPress/gutenberg/pull/66572
- Author: mirka
- Created: 2024-10-29T17:58:23Z
- Updated: 2024-10-31T14:24:28Z
- Comments: 3 of 3
- Review threads: 3 of 3
- Changed files: 7 of 7
- Diff: ../pr-diffs/66572.diff
...
Deprecate the 36px default size on `Radio`, which is a subcomponent of the deprecated `RadioGroup` component.

## Why?

Technically we _could_ do this without a formal deprecation, since RadioGroup is already deprecated. But due to one remaining usage in the app (#66569), we haven't been able to log a deprecation warning for the component yet, meaning that many existing consumers may not even know this component is deprecated.
...
See Storybook for `RadioGroup`.

## Issue comments

### github-actions on 2024-10-29T18:05:33Z

URL: https://github.com/WordPress/gutenberg/pull/66572#issuecomment-2444995230
...
### github-actions on 2024-10-29T18:16:21Z

URL: https://github.com/WordPress/gutenberg/pull/66572#issuecomment-2445016589
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 227 kB | +31 B (+0.01%) |
...
| `build/core-data/index.min.js` | 73.8 kB |
...
### github-actions on 2024-10-29T18:27:33Z

URL: https://github.com/WordPress/gutenberg/pull/66572#issuecomment-2445038398

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 2124cd42e902a05fec057c6df8dc4dbcc6aa7dda.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/11579855301
📝  Reported issues:
...
#### mirka on 2024-10-29T18:01:07Z

URL: https://github.com/WordPress/gutenberg/pull/66572#discussion_r1821317646
Path: packages/editor/src/components/create-template-part-modal/index.js
...
<img width="543" alt="Add New Template Part modal" src="https://github.com/user-attachments/assets/f32bd009-b7d5-41c9-899d-5d380586eb19">

### Review thread 2

#### mirka on 2024-10-29T18:02:47Z

URL: https://github.com/WordPress/gutenberg/pull/66572#discussion_r1821319702
Path: packages/components/src/utils/deprecated-36px-size.ts
...
#### mirka on 2024-10-29T18:03:41Z

URL: https://github.com/WordPress/gutenberg/pull/66572#discussion_r1821320689
...
- packages/components/src/radio-group/README.md (MODIFIED, +8/-8)
- packages/components/src/radio-group/radio.tsx (MODIFIED, +7/-0)
- packages/components/src/radio-group/stories/index.story.tsx (MODIFIED, +16/-4)
- packages/components/src/radio-group/types.ts (MODIFIED, +6/-1)
- packages/components/src/utils/deprecated-36px-size.ts (MODIFIED, +5/-2)
- packages/editor/src/components/create-template-part-modal/index.js (MODIFIED, +1/-0)
