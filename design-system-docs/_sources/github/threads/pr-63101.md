...
type: pull_request
state: MERGED
merged_at: 2024-07-03T18:48:04Z
url: https://github.com/WordPress/gutenberg/pull/63101
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #63101: ToolbarButton: Deprecate `isDisabled` prop and merge with `disabled`

- URL: https://github.com/WordPress/gutenberg/pull/63101
- Author: mirka
- Created: 2024-07-03T15:44:30Z
- Updated: 2024-07-03T18:48:26Z
- Comments: 3 of 3
- Review threads: 1 of 1
- Changed files: 6 of 6
- Diff: ../pr-diffs/63101.diff

## Body

Follow-up to https://github.com/WordPress/gutenberg/pull/62306#discussion_r1663277829
Fixes #63070

## What?

Deprecates the `isDisabled` prop on `ToolbarButton` and merges it into `disabled`.

## Why?

ToolbarButton accepts both `isDisabled` and `disabled` props to disable the button, and can result in slightly different behavior between the two, especially when wanting to achieve a focusable disabled button (see details in #63070).

Current API usage in our codebase shows that most people reach for the `disabled` prop. I could also find no meaningful significance for the `isDisabled` prop to be there ([original PR where it was introduced](https://github.com/WordPress/gutenberg/pull/20008#discussion_r421248963)).

## How?

[Passive deprecate](https://github.com/WordPress/gutenberg/issues/61099) `isDisabled` and alias it to `disabled`.

## Testing Instructions

Play around with the [Storybook code](https://github.com/WordPress/gutenberg/blob/566b82a13633cb72006d1900931ca46a8e0d7937/packages/components/src/toolbar/stories/index.story.tsx#L118-L121) for the `ToolbarButton`s in the `Toolbar` story. Passing `isDisabled` should result in the same behavior as passing `disabled`, especially in combination with accessible disabled props like `__experimentalIsFocusable` or `accessibleWhenDisabled`.

## Issue comments

### github-actions on 2024-07-03T15:45:00Z

URL: https://github.com/WordPress/gutenberg/pull/63101#issuecomment-2206622584
...
### github-actions on 2024-07-03T16:03:26Z

URL: https://github.com/WordPress/gutenberg/pull/63101#issuecomment-2206694876
...
| :--- | :---: | :---: |
| `build/block-library/index.min.js` | 219 kB | -2 B (0%) |
| `build/components/index.min.js` | 227 kB | +8 B (0%) |
...
### mirka on 2024-07-03T17:36:19Z

URL: https://github.com/WordPress/gutenberg/pull/63101#issuecomment-2206875072

> One thing that I noticed while testing is that, if I pass `disabled` and `__experimentalIsFocusable` to `ToolbarButton`, the disabled button is still skipped when using arrow keys, but is not skipped when using the Tab key.
...
#### ciampo on 2024-07-03T16:39:45Z

URL: https://github.com/WordPress/gutenberg/pull/63101#discussion_r1664477674
Path: packages/components/src/toolbar/toolbar-button/index.tsx

```diff
@@ -19,51 +19,60 @@ import ToolbarButtonContainer from './toolbar-button-container';
...
#### mirka on 2024-07-03T17:26:12Z

URL: https://github.com/WordPress/gutenberg/pull/63101#discussion_r1664532308
Path: packages/components/src/toolbar/toolbar-button/index.tsx
...
- packages/block-editor/src/components/grid/grid-item-movers.js (MODIFIED, +4/-4)
- packages/block-library/src/list-item/edit.js (MODIFIED, +1/-1)
- packages/block-library/src/navigation-submenu/edit.js (MODIFIED, +1/-1)
- packages/components/CHANGELOG.md (MODIFIED, +4/-0)
- packages/components/src/toolbar/toolbar-button/index.tsx (MODIFIED, +24/-20)
- packages/components/src/toolbar/toolbar-button/types.ts (MODIFIED, +3/-0)
