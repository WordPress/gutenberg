...
type: pull_request
state: MERGED
merged_at: 2022-09-12T12:02:18Z
url: https://github.com/WordPress/gutenberg/pull/44073
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Automated Testing","[Type] Code Quality","[Package] Components"]
---

# PR #44073: Components: Refactor `IsolatedEventContainer` tests to `@testing-library/react`

- URL: https://github.com/WordPress/gutenberg/pull/44073
- Author: tyxla
- Created: 2022-09-12T09:06:30Z
- Updated: 2022-09-13T08:15:56Z
- Comments: 1 of 1
- Review threads: 2 of 2
- Changed files: 2 of 2
- Diff: ../pr-diffs/44073.diff
...
### github-actions on 2022-09-12T09:15:59Z

URL: https://github.com/WordPress/gutenberg/pull/44073#issuecomment-1243447432
...
| `build/block-library/style-rtl.css` | 12.1 kB |
| `build/block-library/style.css` | 12.1 kB |
...
#### ciampo on 2022-09-12T09:47:23Z

URL: https://github.com/WordPress/gutenberg/pull/44073#discussion_r968208112
Path: packages/components/src/isolated-event-container/test/index.js
...
Nit: let's try to avoid using `data-testid` when possible. In this case, we could add some text to the `<p />` and use the `getByText` selector instead

#### tyxla on 2022-09-12T10:38:59Z

URL: https://github.com/WordPress/gutenberg/pull/44073#discussion_r968255760
Path: packages/components/src/isolated-event-container/test/index.js
...
Good point 👍 Updated to no longer use `data-testid` in 37dab4c64db1e88259e59b7abe46c20b28dfc3ba

### Review thread 2 (resolved)

#### ciampo on 2022-09-12T09:48:31Z

URL: https://github.com/WordPress/gutenberg/pull/44073#discussion_r968209234
Path: packages/components/src/isolated-event-container/test/index.js
...
Nit: we should either have two separate tests for `mousedown` and `keydown` events, or update the test description

#### tyxla on 2022-09-12T10:39:10Z

URL: https://github.com/WordPress/gutenberg/pull/44073#discussion_r968255936
Path: packages/components/src/isolated-event-container/test/index.js
...
Refined the description in 3a083b20ce0ea2be681acfa93328544025c378f5

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/isolated-event-container/test/index.js (MODIFIED, +53/-11)
