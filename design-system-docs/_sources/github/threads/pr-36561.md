...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/36561
matched_labels: ["[Package] Components"]
all_labels: ["[Status] In Progress","[Type] Code Quality","[Package] Components"]
---

# PR #36561: MenuGroup: refactor to TypeScript and Emotion

- URL: https://github.com/WordPress/gutenberg/pull/36561
- Author: ramonjd
- Created: 2021-11-17T10:51:33Z
- Updated: 2022-02-22T22:23:14Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 10 of 10
- Diff: ../pr-diffs/36561.diff
...
Related to https://github.com/WordPress/gutenberg/issues/35744

MenuItem over here: https://github.com/WordPress/gutenberg/pull/37020

## How has this been tested?

Ensure the build runs in CI (or locally if you like `npm run build`)

Run the unit tests `npm run test-unit packages/components/src/menu-group/test/index.js`
...
### github-actions on 2021-11-17T11:02:24Z

URL: https://github.com/WordPress/gutenberg/pull/36561#issuecomment-971466801
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 215 kB | +205 B (0%) |
| `build/components/style-rtl.css` | 15.3 kB | -61 B (0%) |
| `build/components/style.css` | 15.3 kB | -62 B (0%) |
...
### ramonjd on 2022-02-22T22:23:11Z

URL: https://github.com/WordPress/gutenberg/pull/36561#issuecomment-1048269329
...
- packages/components/src/menu-group/hook.ts (ADDED, +45/-0)
- packages/components/src/menu-group/index.js (DELETED, +0/-44)
- packages/components/src/menu-group/index.tsx (ADDED, +79/-0)
- packages/components/src/menu-group/stories/index.js (ADDED, +33/-0)
- packages/components/src/menu-group/style.scss (DELETED, +0/-22)
- packages/components/src/menu-group/styles.ts (ADDED, +37/-0)
- packages/components/src/menu-group/test/__snapshots__/index.js.snap (MODIFIED, +21/-3)
- packages/components/src/menu-group/test/index.js (MODIFIED, +7/-8)
- packages/components/src/menu-group/types.ts (ADDED, +28/-0)
