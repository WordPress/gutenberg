...
type: pull_request
state: MERGED
merged_at: 2022-05-18T07:06:53Z
url: https://github.com/WordPress/gutenberg/pull/41007
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Feature] UI Components","[Type] Code Quality","[Package] Components"]
---

# PR #41007: ButtonGroup: Convert to TypeScript

- URL: https://github.com/WordPress/gutenberg/pull/41007
- Author: walbo
- Created: 2022-05-11T19:30:18Z
- Updated: 2022-05-18T12:17:01Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 6 of 6
- Diff: ../pr-diffs/41007.diff
...
## What?
Converts the `ButtonGroup` component to TypeScript.

## Why?
Part of the @wordpress/components's TypeScript migration (#35744).

## How?
Refactors the current `ButtonGroup` to TypeScript.

## Testing Instructions
- Run npm run dev and ensure no typing errors
- Fire up the Storybook and confirm the `ButtonGroup` continues to function as expected
- Test the various button groups within the block/site editors in Gutenberg still work

## Issue comments

### github-actions on 2022-05-11T19:38:45Z

URL: https://github.com/WordPress/gutenberg/pull/41007#issuecomment-1124216256
...
- packages/components/src/button-group/index.js (DELETED, +0/-21)
- packages/components/src/button-group/index.tsx (ADDED, +47/-0)
- packages/components/src/button-group/stories/index.js (DELETED, +0/-21)
- packages/components/src/button-group/stories/index.tsx (ADDED, +41/-0)
- packages/components/src/button-group/types.ts (ADDED, +11/-0)
