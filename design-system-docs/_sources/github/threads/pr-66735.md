...
type: pull_request
state: MERGED
merged_at: 2026-01-30T07:08:42Z
url: https://github.com/WordPress/gutenberg/pull/66735
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Focus] Accessibility (a11y)","[Feature] Meta Boxes","[Package] Components","[Package] Edit Post"]
---

# PR #66735: Resize meta box pane without `ResizableBox`

- URL: https://github.com/WordPress/gutenberg/pull/66735
- Author: stokesman
- Created: 2024-11-05T05:54:09Z
- Updated: 2026-01-30T07:09:21Z
- Comments: 6 of 6
- Review threads: 3 of 3
- Changed files: 4 of 4
- Diff: ../pr-diffs/66735.diff
...
### github-actions on 2024-11-05T05:54:36Z

URL: https://github.com/WordPress/gutenberg/pull/66735#issuecomment-2456295889
...
### github-actions on 2024-11-05T06:04:20Z

URL: https://github.com/WordPress/gutenberg/pull/66735#issuecomment-2456307596

**Size Change:** -354 B (-0.01%) 
...
| `build/scripts/edit-post/index.min.js` | 16.2 kB | -286 B (-1.74%) |
| `build/styles/edit-post/style-rtl.css` | 4.06 kB | -20 B (-0.49%) |
| `build/styles/edit-post/style-rtl.min.css` | 2.62 kB | -13 B (-0.49%) |
| `build/styles/edit-post/style.css` | 4.07 kB | -21 B (-0.51%) |
| `build/styles/edit-post/style.min.css` | 2.62 kB | -13 B (-0.49%) |
...
### Mamaduka on 2024-11-05T06:05:00Z

URL: https://github.com/WordPress/gutenberg/pull/66735#issuecomment-2456308321

Thanks for the "hotfix" PR, @stokesman!

As you noted in the issue, landing a general fix for `ResizableBox` is better for general solutions. Should we focus our efforts on #65637 and follow up with minor fixes?

### github-actions on 2024-11-05T06:17:06Z

URL: https://github.com/WordPress/gutenberg/pull/66735#issuecomment-2456323464

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 1506d85848032a637a5555193b3db5ec82db2496.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/11678394532
📝  Reported issues:
- #38757 in `/test/e2e/specs/widgets/customizing-widgets.spec.js`

### stokesman on 2024-11-05T17:10:09Z

URL: https://github.com/WordPress/gutenberg/pull/66735#issuecomment-2457735517

I'm all for #65637 moving forward. Yet even if it does, I think this is worth considering because:
- it lightly reduces complexity for this use case (or at least allows more consolidated markup/styling).
- the feature added here to fully expand/collapse the pane by "swiping" would be more complex to implement with `ResizableBox` (not that I'm sold on that gesture as being the best way to provide the feature).
- I think there may be a performance advantage too as I’ve noticed chunky resizing in trunk in certain contexts and last time I replaced `ResizableBox` with `useDragging` (briefly in #65466 before reverting those changes) the performance was better. That’s something I’d still need to prove here since a different hook is used.

### stokesman on 2026-01-16T04:23:43Z

URL: https://github.com/WordPress/gutenberg/pull/66735#issuecomment-3758083697

Thanks for the response Aki. I still think this would be worthwhile so I’ve fixed the conflicts and have it up to date with trunk. 

Besides the bug fix, this improves the dragging performance in my testing. I've seen at least one complaint about that so it’s another point in favor of this.

## Review threads

### Review thread 1 (resolved)

#### t-hamano on 2026-01-17T10:00:19Z

URL: https://github.com/WordPress/gutenberg/pull/66735#discussion_r2700834632
Path: packages/components/src/private-apis.ts

```diff
@@ -41,6 +46,7 @@ lock( privateApis, {
 	DateRangeCalendar,
 	TZDate,
 	Picker,
+	useDrag,
...
Can we add a changelog that the new private API is exposed?

### Review thread 2 (resolved)

#### t-hamano on 2026-01-17T10:01:31Z

URL: https://github.com/WordPress/gutenberg/pull/66735#discussion_r2700836679
Path: packages/components/src/private-apis.ts
...
I thought we could use [the `useDragging` hook](https://github.com/WordPress/gutenberg/blob/bceabb971c43e4d066a09013f282f54d41f3e885/packages/compose/src/hooks/use-dragging/index.js#L19), but it doesn't support touch events...

### Review thread 3 (resolved)

#### t-hamano on 2026-01-29T12:55:49Z

URL: https://github.com/WordPress/gutenberg/pull/66735#discussion_r2741512119
...
Can we restore `@media not (prefers-reduced-motion)` ?

#### stokesman on 2026-01-29T19:21:55Z

URL: https://github.com/WordPress/gutenberg/pull/66735#discussion_r2743141940
Path: packages/edit-post/src/components/layout/style.scss
...
Thanks! I can’t imagine that was intentional and I probably messed up when fixing conflicts.

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +4/-0)
- packages/components/src/private-apis.ts (MODIFIED, +6/-0)
- packages/edit-post/src/components/layout/index.js (MODIFIED, +99/-132)
- packages/edit-post/src/components/layout/style.scss (MODIFIED, +14/-20)
