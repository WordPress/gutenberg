...
type: pull_request
state: MERGED
merged_at: 2022-12-01T13:42:41Z
url: https://github.com/WordPress/gutenberg/pull/46200
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Performance","[Type] Code Quality","[Package] Server Side Render","[Package] Core data","[Package] Components","[Package] Blocks","[Package] Block library","[Package] Block editor","[Package] Edit Site","[Feature] Widgets Customizer"]
---

# PR #46200: Lodash: Replace `_.isEqual()` with `fastDeepEqual`

- URL: https://github.com/WordPress/gutenberg/pull/46200
- Author: tyxla
- Created: 2022-11-30T12:43:23Z
- Updated: 2022-12-01T13:43:11Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 26 of 26
- Diff: ../pr-diffs/46200.diff
...
### github-actions on 2022-11-30T12:52:51Z

URL: https://github.com/WordPress/gutenberg/pull/46200#issuecomment-1332098420
...
| :--- | :---: | :---: | :---: |
| `build/block-editor/index.min.js` | 180 kB | +286 B (0%) |  |
| `build/block-library/index.min.js` | 196 kB | +304 B (0%) |  |
| `build/blocks/index.min.js` | 50.4 kB | +332 B (+1%) |  |
| `build/components/index.min.js` | 203 kB | +274 B (0%) |  |
| `build/core-data/index.min.js` | 15.9 kB | +296 B (+2%) |  |
| `build/customize-widgets/index.min.js` | 11.6 kB | +329 B (+3%) |  |
| `build/edit-site/index.min.js` | 60.7 kB | +321 B (+1%) |  |
...
- package-lock.json (MODIFIED, +9/-2)
- packages/block-editor/package.json (MODIFIED, +1/-0)
- packages/block-editor/src/components/inner-blocks/use-inner-block-template-sync.js (MODIFIED, +3/-3)
- packages/block-editor/src/store/reducer.js (MODIFIED, +6/-5)
- packages/block-library/package.json (MODIFIED, +1/-0)
- packages/block-library/src/table-of-contents/edit.js (MODIFIED, +2/-2)
- packages/blocks/package.json (MODIFIED, +1/-0)
- packages/blocks/src/api/validation/index.js (MODIFIED, +4/-2)
- packages/components/package.json (MODIFIED, +1/-0)
- packages/components/src/duotone-picker/duotone-picker.js (MODIFIED, +2/-2)
- packages/components/src/higher-order/with-fallback-styles/index.js (MODIFIED, +4/-2)
- packages/components/src/mobile/keyboard-aware-flat-list/index.ios.js (MODIFIED, +2/-2)
- packages/components/src/ui/context/context-system-provider.js (MODIFIED, +3/-2)
- packages/core-data/package.json (MODIFIED, +1/-0)
- packages/core-data/src/actions.js (MODIFIED, +5/-2)
- packages/core-data/src/reducer.js (MODIFIED, +4/-3)
- packages/core-data/src/utils/conservative-map-item.js (MODIFIED, +2/-2)
- packages/customize-widgets/package.json (MODIFIED, +1/-0)
- packages/customize-widgets/src/components/sidebar-block-editor/use-sidebar-block-editor.js (MODIFIED, +5/-2)
- packages/edit-site/package.json (MODIFIED, +1/-0)
- packages/edit-site/src/components/global-styles/hooks.js (MODIFIED, +3/-2)
- packages/edit-site/src/components/global-styles/screen-style-variations.js (MODIFIED, +5/-2)
- packages/is-shallow-equal/README.md (MODIFIED, +3/-3)
- packages/server-side-render/package.json (MODIFIED, +1/-0)
- packages/server-side-render/src/server-side-render.js (MODIFIED, +2/-2)
