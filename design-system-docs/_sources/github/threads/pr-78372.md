...
type: pull_request
state: MERGED
merged_at: 2026-05-18T13:48:06Z
url: https://github.com/WordPress/gutenberg/pull/78372
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Enhancement","[Package] UI"]
---

# PR #78372: [ui] Select: Default portal container to the wp compat overlay slot

- URL: https://github.com/WordPress/gutenberg/pull/78372
- Author: ciampo
- Created: 2026-05-16T09:46:46Z
- Updated: 2026-05-18T15:35:17Z
- Comments: 5 of 5
- Review threads: 0 of 0
- Changed files: 5 of 5
- Diff: ../pr-diffs/78372.diff
...
### github-actions on 2026-05-16T11:49:00Z

URL: https://github.com/WordPress/gutenberg/pull/78372#issuecomment-4466762131
...
### github-actions on 2026-05-16T11:54:49Z

URL: https://github.com/WordPress/gutenberg/pull/78372#issuecomment-4466773508
...
### github-actions on 2026-05-16T12:11:34Z

URL: https://github.com/WordPress/gutenberg/pull/78372#issuecomment-4466811165

<!-- flaky-tests-report-comment -->
**Flaky tests detected in d7233c66d69d6d713cc340cd0ac63a0c43f0d9c6.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/25960989797
📝  Reported issues:
...
### mirka on 2026-05-18T14:12:02Z

URL: https://github.com/WordPress/gutenberg/pull/78372#issuecomment-4478533316

Ugh, I just noticed at that in the playground example with the `@wordpress/components` Popover, hovering on a Select item closes the popover because hovering moves the focus to the item. Might need some special handling, not sure in what layer (in `onFocusOutside`?).

### ciampo on 2026-05-18T15:34:50Z

URL: https://github.com/WordPress/gutenberg/pull/78372#issuecomment-4479261154

> Ugh, I just noticed at that in the playground example with the `@wordpress/components` Popover, hovering on a Select item closes the popover because hovering moves the focus to the item. Might need some special handling, not sure in what layer (in `onFocusOutside`?).

This is a general issue of the `Popover` component — opened https://github.com/WordPress/gutenberg/issues/78406 to track.

Working on a tentative fix specifically for components portalled through the wp compat overlay (which only partially solves the issue) in https://github.com/WordPress/gutenberg/pull/78407
...
- packages/ui/src/form/primitives/select/portal.tsx (MODIFIED, +14/-5)
- packages/ui/src/form/primitives/select/test/index.test.tsx (MODIFIED, +106/-0)
- packages/ui/src/form/select-control/test/index.test.tsx (MODIFIED, +64/-0)
- storybook/stories/playground/wp-compat-overlay-slot.story.jsx (MODIFIED, +65/-11)
