...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/77756
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components","[Package] Editor","[Package] Block editor","[Package] Edit Widgets"]
---

# PR #77756: Popover: Render inside the overlay legacy slot

- URL: https://github.com/WordPress/gutenberg/pull/77756
- Author: ciampo
- Created: 2026-04-28T16:30:13Z
- Updated: 2026-04-30T11:44:44Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 7 of 7
- Diff: ../pr-diffs/77756.diff
...
### github-actions on 2026-04-28T16:41:04Z

URL: https://github.com/WordPress/gutenberg/pull/77756#issuecomment-4337287973
...
| :--- | :---: | :---: |
| `build/scripts/block-editor/index.min.js` | 341 kB | +60 B (+0.02%) |
| `build/scripts/components/index.min.js` | 266 kB | +126 B (+0.05%) |
| `build/scripts/customize-widgets/index.min.js` | 14.3 kB | +12 B (+0.08%) |
| `build/scripts/edit-widgets/index.min.js` | 22 kB | +44 B (+0.2%) |
| `build/scripts/editor/index.min.js` | 424 kB | +6 B (0%) |
...
- packages/block-editor/src/components/block-tools/index.js (MODIFIED, +25/-12)
- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/popover/index.tsx (MODIFIED, +4/-2)
- packages/components/src/private-apis.ts (MODIFIED, +2/-0)
- packages/customize-widgets/src/components/customize-widgets/index.js (MODIFIED, +19/-14)
- packages/edit-widgets/src/components/header/index.js (MODIFIED, +17/-6)
- packages/editor/src/components/collapsible-block-toolbar/index.js (MODIFIED, +13/-3)
