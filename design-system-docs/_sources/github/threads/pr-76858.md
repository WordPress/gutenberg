...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/76858
matched_labels: ["[Package] UI"]
all_labels: ["[Package] UI"]
---

# PR #76858: Focus utilities: Keep focus ring on aria-disabled buttons during :active

- URL: https://github.com/WordPress/gutenberg/pull/76858
- Author: ciampo
- Created: 2026-03-27T10:27:31Z
- Updated: 2026-03-27T11:05:04Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/76858.diff
...
### github-actions on 2026-03-27T10:39:57Z

URL: https://github.com/WordPress/gutenberg/pull/76858#issuecomment-4141703087
...
| :--- | :---: | :---: |
| `build/scripts/block-editor/index.min.js` | 338 kB | +22 B (+0.01%) |
| `build/scripts/edit-site/index.min.js` | 261 kB | +20 B (+0.01%) |
| `build/scripts/editor/index.min.js` | 367 kB | +22 B (+0.01%) |
...
### github-actions on 2026-03-27T10:55:15Z

URL: https://github.com/WordPress/gutenberg/pull/76858#issuecomment-4141779035

<!-- flaky-tests-report-comment -->
**Flaky tests detected in bbbdd83bf78101d3200e07f4e424ee29fad9d747.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/23641938329
📝  Reported issues:
- #76524 in `/test/e2e/specs/editor/various/post-content-focus-mode.spec.js`

### ciampo on 2026-03-27T11:05:04Z

URL: https://github.com/WordPress/gutenberg/pull/76858#issuecomment-4141828092

Closing since this fix was mostly curing a symptom rather than the real cause — which was linked to how `Dialog.Action` and `Button` were being combined together with the `loading` async workflow
...
- packages/ui/src/utils/css/focus.module.css (MODIFIED, +2/-0)
