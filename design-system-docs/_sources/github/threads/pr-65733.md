...
type: pull_request
state: MERGED
merged_at: 2024-09-30T09:46:57Z
url: https://github.com/WordPress/gutenberg/pull/65733
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components","[Package] Block editor"]
---

# PR #65733: Fix `useInstanceId` hook references

- URL: https://github.com/WordPress/gutenberg/pull/65733
- Author: tyxla
- Created: 2024-09-30T09:06:16Z
- Updated: 2024-09-30T09:47:21Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 4 of 4
- Diff: ../pr-diffs/65733.diff
...
## How?
We're using dedicated inline stable object references instead of the hooks themselves. Whether we're referencing the function or a neighbor object, there won't be a difference for `useInstanceId`.

## Testing Instructions
* Edit an image block
* Verify Duotone filter continues to work well.
...
### github-actions on 2024-09-30T09:06:37Z

URL: https://github.com/WordPress/gutenberg/pull/65733#issuecomment-2382555794
...
### github-actions on 2024-09-30T09:16:13Z

URL: https://github.com/WordPress/gutenberg/pull/65733#issuecomment-2382578403
...
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 256 kB | +39 B (+0.02%) |
| `build/components/index.min.js` | 226 kB | +21 B (+0.01%) |
...
| `build/edit-site/posts.css` | 7.37 kB |
...
- packages/block-editor/src/hooks/duotone.js (MODIFIED, +4/-1)
- packages/block-editor/src/hooks/layout-child.js (MODIFIED, +4/-1)
- packages/block-editor/src/hooks/position.js (MODIFIED, +4/-1)
