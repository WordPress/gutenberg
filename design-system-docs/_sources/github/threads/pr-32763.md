...
type: pull_request
state: MERGED
merged_at: 2021-06-23T16:55:54Z
url: https://github.com/WordPress/gutenberg/pull/32763
...
# PR #32763: Card: update Storybook story

- URL: https://github.com/WordPress/gutenberg/pull/32763
- Author: ciampo
- Created: 2021-06-17T09:23:51Z
- Updated: 2021-06-23T16:56:15Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 8 of 8
- Diff: ../pr-diffs/32763.diff
...
Rewrite storybook stories for the `<Card />` component. Previously, there were many, small stories that were showing each subcomponent in isolation, without any knobs. This approach didn't really show how to use the `<Card />` and its subcomponents in a real scenario.

The new story renders all of the components in one example and introduces many interactive controls (knobs).
...
- [ ] Check out the new story. On your machine, run `npm run storybook:dev` and visit [`http://localhost:50240/?path=/story/components-card--default`](http://localhost:50240/?path=/story/components-card--default) 

## Screenshots <!-- if applicable -->

![Screenshot 2021-06-17 at 11 20 01](https://user-images.githubusercontent.com/1083581/122368835-f7b9f700-cf5d-11eb-9909-19d7d4b3aa42.png)
...
### github-actions on 2021-06-17T09:37:56Z

URL: https://github.com/WordPress/gutenberg/pull/32763#issuecomment-863090837
...
- packages/components/src/card/stories/_index.js (DELETED, +0/-37)
- packages/components/src/card/stories/_utils.js (DELETED, +0/-50)
- packages/components/src/card/stories/body.js (DELETED, +0/-24)
- packages/components/src/card/stories/divider.js (DELETED, +0/-19)
- packages/components/src/card/stories/footer.js (DELETED, +0/-43)
- packages/components/src/card/stories/header.js (DELETED, +0/-43)
- packages/components/src/card/stories/index.js (ADDED, +201/-0)
- packages/components/src/card/stories/media.js (DELETED, +0/-160)
