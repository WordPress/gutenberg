...
type: pull_request
state: MERGED
merged_at: 2022-07-15T02:18:25Z
url: https://github.com/WordPress/gutenberg/pull/42438
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Performance","[Type] Code Quality","[Package] Core data","[Package] Components","[Package] Block library","[Package] Block editor"]
---

# PR #42438: Lodash: Refactor away from `_.compact()`

- URL: https://github.com/WordPress/gutenberg/pull/42438
- Author: tyxla
- Created: 2022-07-14T15:08:19Z
- Updated: 2022-07-15T02:18:46Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 14 of 14
- Diff: ../pr-diffs/42438.diff
...
### github-actions on 2022-07-14T15:21:06Z

URL: https://github.com/WordPress/gutenberg/pull/42438#issuecomment-1184576861
...
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 153 kB | -2 B (0%) |
| `build/block-library/index.min.js` | 183 kB | +2 B (0%) |
| `build/components/index.min.js` | 230 kB | -1 B (0%) |
...
- packages/block-editor/src/components/block-mobile-toolbar/block-actions-menu.native.js (MODIFIED, +3/-3)
- packages/block-editor/src/components/block-settings-menu-controls/index.js (MODIFIED, +2/-2)
- packages/block-editor/src/components/list-view/branch.js (MODIFIED, +1/-6)
- packages/block-library/src/columns/edit.native.js (MODIFIED, +2/-2)
- packages/block-library/src/embed/embed-placeholder.native.js (MODIFIED, +2/-3)
- packages/block-library/src/more/save.js (MODIFIED, +3/-6)
- packages/components/CHANGELOG.md (MODIFIED, +2/-0)
- packages/components/src/mobile/media-edit/index.native.js (MODIFIED, +2/-7)
- packages/components/src/tree-select/index.tsx (MODIFIED, +5/-4)
- packages/components/src/tree-select/types.ts (MODIFIED, +4/-0)
- packages/core-data/src/resolvers.js (MODIFIED, +2/-11)
- packages/core-data/src/selectors.ts (MODIFIED, +2/-2)
- tools/webpack/shared.js (MODIFIED, +2/-3)
