...
type: pull_request
state: MERGED
merged_at: 2026-02-25T15:37:00Z
url: https://github.com/WordPress/gutenberg/pull/75879
matched_labels: ["[Package] Theme"]
all_labels: ["[Type] Bug","Backported to WP Core","[Package] Theme"]
---

# PR #75879: Theme: Remove global design tokens stylesheet

- URL: https://github.com/WordPress/gutenberg/pull/75879
- Author: mirka
- Created: 2026-02-24T19:23:15Z
- Updated: 2026-02-25T15:38:50Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 1 of 1
- Diff: ../pr-diffs/75879.diff
...
### github-actions on 2026-02-24T19:35:30Z

URL: https://github.com/WordPress/gutenberg/pull/75879#issuecomment-3954306957

**Size Change:** -8.33 kB (-0.12%) 

**Total Size:** 6.83 MB

| Filename | Size | Change |  |
| :--- | :---: | :---: | :---: |
| `build/styles/theme/style-rtl.css` | 0 B | -2.76 kB (removed) | 🏆 |
| `build/styles/theme/style-rtl.min.css` | 0 B | -1.41 kB (removed) | 🏆 |
| `build/styles/theme/style.css` | 0 B | -2.76 kB (removed) | 🏆 |
| `build/styles/theme/style.min.css` | 0 B | -1.41 kB (removed) | 🏆 |
...
### github-actions on 2026-02-25T06:16:36Z

URL: https://github.com/WordPress/gutenberg/pull/75879#issuecomment-3957090763
...
### mirka on 2026-02-25T07:20:43Z

URL: https://github.com/WordPress/gutenberg/pull/75879#issuecomment-3957328029

@t-hamano Can you check that `wp-theme` is gone from all the arrays in `build/styles/registry.php`? I saw a similar stylesheet loading failure like your screenshot on my first try as well, but it was because there was an old build artifact in `build/styles/theme`. Removing that before rebuilding cleaned up the `registry.php` file so the `wp-theme` dependencies were gone.

I believe this is the correct state. #74743 was necessary because `@wordpress/dataviews` imported the `@wordpress/theme` stylesheet. It no longer does, so there should be nothing indicating the `wp-theme` stylesheet as a dependency for anything. Checking a WordPress Playground [instance](https://playground.wordpress.net/?gutenberg-pr=75879) of this PR, the clean build seems to be loading all the stylesheets correctly without `wp-theme`. (Although, `Stack` gaps are broken without the changes in #75589.)

### github-actions on 2026-02-25T15:38:49Z

URL: https://github.com/WordPress/gutenberg/pull/75879#issuecomment-3960159227

I just cherry-picked this PR to the wp/7.0 branch to get it included in the next release: d43caec9c13b273cdafb62382ded95e9e86d2c2c
...
- packages/theme/src/style.scss (DELETED, +0/-6)
