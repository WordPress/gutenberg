...
type: pull_request
state: MERGED
merged_at: 2024-01-25T18:02:10Z
url: https://github.com/WordPress/gutenberg/pull/58130
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #58130: Components: Add eslint rule for theme var regressions

- URL: https://github.com/WordPress/gutenberg/pull/58130
- Author: mirka
- Created: 2024-01-23T15:00:44Z
- Updated: 2024-01-25T18:02:32Z
- Comments: 1 of 1
- Review threads: 1 of 1
- Changed files: 5 of 5
- Diff: ../pr-diffs/58130.diff
...
Adds a Eslint rule for JS/TS files under `packages/components` to prevent unknowing usage of `--wp-admin-theme-*` color variables.

## Why?

`--wp-admin-theme-*` variables are coupled with wp-admin and do not support our component theming system.

This PR is the Eslint counterpart of the Stylelint rules proposed in #58098.

## Testing Instructions

1. Check out the first commit 64c659d4423636f2b72fcab95411e005bf5453cb that adds the eslint rule, and run `npm run lint:js`. It should error on the offending files under `packages/components`.
2. The lint should pass after all the files are fixed.

## Issue comments

### github-actions on 2024-01-23T15:12:18Z

URL: https://github.com/WordPress/gutenberg/pull/58130#issuecomment-1906257520
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 235 kB | -63 B (0%) |
...
#### mirka on 2024-01-23T15:02:10Z

URL: https://github.com/WordPress/gutenberg/pull/58130#discussion_r1463415343
Path: .eslintrc.js
...
- packages/components/CHANGELOG.md (MODIFIED, +9/-2)
- packages/components/src/dropdown-menu-v2/styles.ts (MODIFIED, +1/-1)
- packages/components/src/item-group/styles.ts (MODIFIED, +1/-4)
- packages/components/src/palette-edit/styles.ts (MODIFIED, +1/-4)
