...
type: pull_request
state: MERGED
merged_at: 2022-10-13T11:16:44Z
url: https://github.com/WordPress/gutenberg/pull/42949
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Type] Code Quality","[Package] Components"]
---

# PR #42949: Modal: Convert component to TypeScript

- URL: https://github.com/WordPress/gutenberg/pull/42949
- Author: walbo
- Created: 2022-08-03T21:58:11Z
- Updated: 2022-10-13T11:17:15Z
- Comments: 5 of 5
- Review threads: 1 of 1
- Changed files: 9 of 9
- Diff: ../pr-diffs/42949.diff
...
## What?
Refactor the `Modal` component to TypeScript.
...
- Refactored storybook from knobs to controls

## Testing Instructions
1. Run npm run dev and ensure no typing errors
2. Test the modal in the storybook.
3. Test the various use of Modals within the block/site editors in Gutenberg still work

## Issue comments

### github-actions on 2022-08-03T22:06:36Z

URL: https://github.com/WordPress/gutenberg/pull/42949#issuecomment-1204533885
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 202 kB | +25 B (0%) |
...
### mirka on 2022-10-12T11:41:12Z

URL: https://github.com/WordPress/gutenberg/pull/42949#issuecomment-1276022337

No rush, but just checking up on this one since you haven't merged yet 😄

### walbo on 2022-10-12T11:53:28Z

URL: https://github.com/WordPress/gutenberg/pull/42949#issuecomment-1276036762

Yes. Forgot about this one 🙈. I will resolve merge conflicts later today so we can get it merged.

### walbo on 2022-10-12T14:12:22Z

URL: https://github.com/WordPress/gutenberg/pull/42949#issuecomment-1276250025

Hey @mirka 

I've updated the PR and resolved the merge conflicts. Can you take another look at the PR?

### walbo on 2022-10-13T11:17:14Z

URL: https://github.com/WordPress/gutenberg/pull/42949#issuecomment-1277446304

Thanks for taking a second look after the rebase @mirka.

## Review threads

### Review thread 1 (resolved)

#### mirka on 2022-08-09T12:19:00Z

URL: https://github.com/WordPress/gutenberg/pull/42949#discussion_r941267959
...
I guess we can keep the source collapsed for this one because it isn't very helpful?

#### walbo on 2022-08-09T21:47:05Z

URL: https://github.com/WordPress/gutenberg/pull/42949#discussion_r941830974
Path: packages/components/src/modal/stories/index.tsx
...
Nice spot! Also made it so the canvas now reads `No code available`, since the code just showed a button didn't make sense.

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +6/-2)
- packages/components/src/confirm-dialog/types.ts (MODIFIED, +6/-0)
- packages/components/src/modal/README.md (MODIFIED, +53/-54)
- packages/components/src/modal/aria-helper.ts (RENAMED, +5/-7)
- packages/components/src/modal/index.tsx (RENAMED, +48/-12)
- packages/components/src/modal/stories/index.tsx (RENAMED, +47/-42)
- packages/components/src/modal/test/aria-helper.ts (RENAMED, +0/-0)
- packages/components/src/modal/test/index.tsx (RENAMED, +13/-3)
- packages/components/src/modal/types.ts (ADDED, +144/-0)
