...
type: pull_request
state: MERGED
merged_at: 2022-08-16T10:13:40Z
url: https://github.com/WordPress/gutenberg/pull/43224
matched_labels: ["[Package] Components"]
all_labels: ["[Feature] Block API","[Type] Performance","[Type] Code Quality","[Package] Components","[Package] Blocks","[Feature] List View","[Package] Block editor","[Package] Edit Post"]
---

# PR #43224: Lodash: Refactor away from `_.difference()`

- URL: https://github.com/WordPress/gutenberg/pull/43224
- Author: tyxla
- Created: 2022-08-15T10:20:47Z
- Updated: 2022-08-16T10:49:30Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 8 of 8
- Diff: ../pr-diffs/43224.diff
...
### github-actions on 2022-08-15T10:29:23Z

URL: https://github.com/WordPress/gutenberg/pull/43224#issuecomment-1214866204
...
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 159 kB | -8 B (0%) |
| `build/blocks/index.min.js` | 49 kB | +1 B (0%) |
| `build/components/index.min.js` | 232 kB | -2 B (0%) |
| `build/edit-navigation/index.min.js` | 16 kB | +1 B (0%) |
| `build/edit-post/index.min.js` | 30.5 kB | -8 B (0%) |
...
- packages/block-editor/src/components/list-view/use-block-selection.js (MODIFIED, +2/-8)
- packages/blocks/src/api/parser/fix-custom-classname.js (MODIFIED, +5/-2)
- packages/blocks/src/api/raw-handling/is-inline-content.js (MODIFIED, +3/-6)
- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/form-token-field/index.tsx (MODIFIED, +4/-2)
- packages/edit-navigation/src/store/actions.js (MODIFIED, +9/-9)
- packages/edit-post/src/components/block-settings-menu/plugin-block-settings-menu-item.js (MODIFIED, +1/-6)
