...
type: pull_request
state: MERGED
merged_at: 2021-06-24T20:54:26Z
url: https://github.com/WordPress/gutenberg/pull/32865
...
# PR #32865: [RNMobile] Tweaks to Badge Component's Styling

- URL: https://github.com/WordPress/gutenberg/pull/32865
- Author: SiobhyB
- Created: 2021-06-21T17:56:34Z
- Updated: 2021-06-24T20:54:48Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/32865.diff

## Body

`gutenberg-mobile`: https://github.com/wordpress-mobile/gutenberg-mobile/pull/3642

## Description

This PR includes some tweaks to the badge component's styling. Specifically, it reduces its padding and changes the background color to a darker gray. 

## How has this been tested?

The updated badge component was compared to the original design mocks here:

| Padding | Margin |
| ------------- | ------------- |
| <img src="https://user-images.githubusercontent.com/2998162/122748139-c5710800-d283-11eb-854a-6f7d21c8e91e.png" width="100%"> | <img src="https://user-images.githubusercontent.com/2998162/122748072-b2f6ce80-d283-11eb-99d2-85d1615d2382.png" width="100%"> |

To view the badge component:

* Navigate to the post editor in Android and add an image block.
* Upload an image to the image block and set it as the post's featured image (via Post Settings).
* Observe the _Featured_ badge to the block's upper right.

## Screenshots <!-- if applicable -->

| Before  | After |
| ------------- | ------------- |
| <img src="https://user-images.githubusercontent.com/2998162/122751342-8e9cf100-d287-11eb-8a23-aa1c7dd66fba.png" width="100%"> | <img src="https://user-images.githubusercontent.com/2998162/122807583-ab571a00-d2c3-11eb-8941-edea6cea07d5.png" width="100%"> |

_Tested on a Pixel 3a emulator, Android 10_

## Types of changes

* A few [tweaks were made to the badge component's _style.css_ file](https://github.com/WordPress/gutenberg/pull/32865/files#diff-59da596260b632571075a233c14c4c1277bdb8937125bc43fa2d153c4e0f79ab), with an updated background colour and margin/padding updates to match the component's initial design mocks.
...
### github-actions on 2021-06-21T18:01:34Z

URL: https://github.com/WordPress/gutenberg/pull/32865#issuecomment-865235129
...
| `build/block-library/editor-rtl.css` | 9.7 kB |
...
| `build/components/index.min.js` | 180 kB |
...
| `build/customize-widgets/index.min.js` | 9.98 kB |
...
| `build/widgets/style-rtl.css` | 860 B |
| `build/widgets/style.css` | 861 B |
...
### SiobhyB on 2021-06-21T18:46:04Z

URL: https://github.com/WordPress/gutenberg/pull/32865#issuecomment-865262339

@iamthomasbishop, I've made an initial pass at correcting the component's styles based on your feedback. I've followed the original padding/margin for the badge component, but let me know if there's anything else you think needs changing here.

I prefer the larger margin when the badge is by itself (without the edit button displaying) but wondered whether the badge may now look a bit "off" when displayed alongside the image block's edit button. It's possible I've been staring at this too long. :D I'll defer to your preference here, as I don't have a super strong opinion either way.
 
| Margin: 10px | Margin: 8px |
| ------------- | ------------- |
| <img src="https://user-images.githubusercontent.com/2998162/122807583-ab571a00-d2c3-11eb-8941-edea6cea07d5.png" width="100%"> | <img src="https://user-images.githubusercontent.com/2998162/122811271-2c181500-d2c8-11eb-9f3f-1b9604877b29.png" width="100%"> |

### SiobhyB on 2021-06-23T17:05:17Z

URL: https://github.com/WordPress/gutenberg/pull/32865#issuecomment-867010521

Thank you for this @iamthomasbishop, I've gone ahead to update the margin to the `8px` option shown in your second screenshot and I'll merge this tomorrow, when the (unrelated-to-this-PR) issues with the e2e failures are resolved. :)
...
- packages/components/src/mobile/badge/style.scss (MODIFIED, +3/-3)
- packages/react-native-editor/CHANGELOG.md (MODIFIED, +2/-0)
