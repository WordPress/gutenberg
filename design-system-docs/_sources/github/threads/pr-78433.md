...
type: pull_request
state: MERGED
merged_at: 2026-05-19T21:38:48Z
url: https://github.com/WordPress/gutenberg/pull/78433
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Compose","[Package] Components"]
---

# PR #78433: useDialog: handle Escape via React `onKeyDown` so cascade works through portals

- URL: https://github.com/WordPress/gutenberg/pull/78433
- Author: ciampo
- Created: 2026-05-19T09:57:10Z
- Updated: 2026-05-19T21:39:27Z
- Comments: 3 of 3
- Review threads: 2 of 2
- Changed files: 6 of 6
- Diff: ../pr-diffs/78433.diff
...
### github-actions on 2026-05-19T10:07:27Z

URL: https://github.com/WordPress/gutenberg/pull/78433#issuecomment-4486673306
...
| `build/scripts/compose/index.min.js` | 11.1 kB | +6 B (+0.05%) |
...
### github-actions on 2026-05-19T10:28:20Z

URL: https://github.com/WordPress/gutenberg/pull/78433#issuecomment-4486826488

<!-- flaky-tests-report-comment -->
**Flaky tests detected in e7475e387645c220e084123bf2038327398c3f89.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/26125403997
📝  Reported issues:
- #64334 in `/test/e2e/specs/site-editor/dataviews-list-layout-keyboard.spec.js`

### github-actions on 2026-05-19T11:33:29Z

URL: https://github.com/WordPress/gutenberg/pull/78433#issuecomment-4487312124
...
#### mirka on 2026-05-19T16:24:04Z

URL: https://github.com/WordPress/gutenberg/pull/78433#discussion_r3267880907
Path: packages/compose/src/hooks/use-dialog/index.ts

```diff
@@ -86,34 +87,31 @@ function useDialog( options: DialogOptions ): useDialogReturn {
...
Now that we return the event handler, we need to make sure it's merged with the consumer-provided handler:

https://github.com/WordPress/gutenberg/blob/79a697a84fe4f59e944151c8093b7d94cd7d4f4f/packages/components/src/popover/index.tsx#L460-L462

If we dig through the history, Ella noted in #27675 that if `dialogProps` contains React handlers, "for full compatibility we have to merge all handlers in `contentProps` and `dialogProps`", and added: "The beauty of not using React but DOM event listeners is that you don't have to merge them" 😄 So yes, we need to merge them. Maybe have `useDialog` take an optional `onKeyDown` parameter? In any case, this probably should be listed as a potential breaking change.

Also I confirmed that there are no specific reasons given in the history why it used a native event handler to begin with 👍

#### ciampo on 2026-05-19T17:01:29Z

URL: https://github.com/WordPress/gutenberg/pull/78433#discussion_r3268122273
Path: packages/compose/src/hooks/use-dialog/index.ts
...
Addressed following your suggestion.

### Review thread 2

#### mirka on 2026-05-19T17:26:26Z

URL: https://github.com/WordPress/gutenberg/pull/78433#discussion_r3268266636
Path: packages/compose/src/hooks/use-dialog/index.ts

```diff
@@ -43,6 +47,16 @@ type DialogOptions = {
 	 */
...
#### ciampo on 2026-05-19T20:55:25Z

URL: https://github.com/WordPress/gutenberg/pull/78433#discussion_r3269566375
Path: packages/compose/src/hooks/use-dialog/index.ts
...
- packages/components/src/popover/index.tsx (MODIFIED, +6/-0)
- packages/components/src/popover/test/index.tsx (MODIFIED, +19/-0)
- packages/compose/CHANGELOG.md (MODIFIED, +5/-0)
- packages/compose/src/hooks/use-dialog/README.md (MODIFIED, +52/-18)
- packages/compose/src/hooks/use-dialog/index.ts (MODIFIED, +30/-20)
- packages/compose/src/hooks/use-dialog/test/index.tsx (MODIFIED, +162/-34)
