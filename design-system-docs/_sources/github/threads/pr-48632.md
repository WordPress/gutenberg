...
type: pull_request
state: MERGED
merged_at: 2023-03-03T10:00:20Z
url: https://github.com/WordPress/gutenberg/pull/48632
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components"]
---

# PR #48632: navigateRegions: Convert to TypeScript

- URL: https://github.com/WordPress/gutenberg/pull/48632
- Author: mirka
- Created: 2023-03-01T12:15:01Z
- Updated: 2023-03-03T10:00:59Z
- Comments: 2 of 2
- Review threads: 5 of 5
- Changed files: 4 of 4
- Diff: ../pr-diffs/48632.diff
...
Converts the `navigateRegions` HOC to TypeScript.
...
### github-actions on 2023-03-01T12:24:40Z

URL: https://github.com/WordPress/gutenberg/pull/48632#issuecomment-1450065195
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 208 kB | +62 B (0%) |
...
### github-actions on 2023-03-01T12:43:55Z

URL: https://github.com/WordPress/gutenberg/pull/48632#issuecomment-1450090405

<!-- flaky-tests-report-comment -->
**Flaky tests detected in a763cd9a19530c42818634aab9a7fadee17d957f.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/4306024342
📝  Reported issues:
...
#### mirka on 2023-03-01T12:17:41Z

URL: https://github.com/WordPress/gutenberg/pull/48632#discussion_r1121628505
Path: packages/components/src/higher-order/navigate-regions/index.tsx
...
#### mirka on 2023-03-01T12:20:08Z

URL: https://github.com/WordPress/gutenberg/pull/48632#discussion_r1121632277
Path: packages/components/src/higher-order/navigate-regions/index.tsx
...
Just making the fallback explicit, as `.indexOf()` will return -1 when `wrappingRegion` is undefined.

### Review thread 3

#### mirka on 2023-03-01T12:23:41Z

URL: https://github.com/WordPress/gutenberg/pull/48632#discussion_r1121636621
...
I _think_ this is what we want, given that it's meant to handle React synthetic events? Let me know if you disagree.

#### ciampo on 2023-03-02T11:42:40Z

URL: https://github.com/WordPress/gutenberg/pull/48632#discussion_r1122969050
Path: packages/keycodes/src/index.js
...
For sure, the `onKeyDown` property returned by `useNavigateRegions` needs to take a `React.KeyboardEvent< HTMLDivElement >` as its argument.

Personally, I'm almost tempted to introduce a runtime change to the `navigateRegions` component and avoid making changes to the `@wordpress/keycodes` package, since from a quick look it seems that the package is not assuming react as a web dependency (only `react-native` is mentioned).

<details>
<summary>With this in mind, as an alternative approach we could use the `nativeEvent` property in `useNavigateRegions`</summary>
...
#### mirka on 2023-03-03T09:26:36Z

URL: https://github.com/WordPress/gutenberg/pull/48632#discussion_r1124212233
Path: packages/keycodes/src/index.js
...
Thanks for digging deeper here! I looked into the codebase to see how `isKeyboardEvent()` is being used, and it is in fact handling both [native](https://github.com/WordPress/gutenberg/blob/6be1e861fbf7049935a3733a1d2061d360c079f9/packages/block-editor/src/components/rich-text/use-remove-browser-shortcuts.js#L24) and [synthetic](https://github.com/WordPress/gutenberg/blob/6be1e861fbf7049935a3733a1d2061d360c079f9/packages/block-library/src/navigation-submenu/edit.js#L293) events. The synthetic usages would all be errors if they were typechecked. So I think it would be best to correct the types so it matches the actual usage 👉 b94985a6

How does that sound?

#### ciampo on 2023-03-03T09:59:05Z

URL: https://github.com/WordPress/gutenberg/pull/48632#discussion_r1124246742
Path: packages/keycodes/src/index.js
...
#### ciampo on 2023-03-02T10:41:58Z

URL: https://github.com/WordPress/gutenberg/pull/48632#discussion_r1122901217
...
We'll need a rebase to move this entry to the new Unreleased section

#### mirka on 2023-03-03T09:30:58Z

URL: https://github.com/WordPress/gutenberg/pull/48632#discussion_r1124216890
Path: packages/components/CHANGELOG.md
...
#### ciampo on 2023-03-02T10:43:34Z

URL: https://github.com/WordPress/gutenberg/pull/48632#discussion_r1122903034
Path: packages/components/src/higher-order/navigate-regions/index.tsx
...
- packages/components/src/higher-order/navigate-regions/index.tsx (RENAMED, +47/-11)
- packages/components/tsconfig.json (MODIFIED, +0/-1)
- packages/keycodes/src/index.js (MODIFIED, +2/-2)
