...
type: pull_request
state: MERGED
merged_at: 2026-05-08T17:26:34Z
url: https://github.com/WordPress/gutenberg/pull/78076
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Enhancement","[Package] UI"]
---

# PR #78076: Select: Support placeholder prop on Trigger

- URL: https://github.com/WordPress/gutenberg/pull/78076
- Author: mirka
- Created: 2026-05-08T00:51:03Z
- Updated: 2026-05-08T17:27:16Z
- Comments: 3 of 3
- Review threads: 4 of 4
- Changed files: 6 of 6
- Diff: ../pr-diffs/78076.diff
...
### github-actions on 2026-05-08T01:00:08Z

URL: https://github.com/WordPress/gutenberg/pull/78076#issuecomment-4402324396
...
### github-actions on 2026-05-08T01:23:41Z

URL: https://github.com/WordPress/gutenberg/pull/78076#issuecomment-4402510848
...
### github-actions on 2026-05-08T01:43:24Z

URL: https://github.com/WordPress/gutenberg/pull/78076#issuecomment-4402591823

<!-- flaky-tests-report-comment -->
**Flaky tests detected in a307d5224564a5d9e5feee273d0857f5d16205c7.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/25530899575
📝  Reported issues:
- #77329 in `/test/e2e/specs/editor/collaboration/collaboration-block-gauntlet.spec.ts`
...
#### ciampo on 2026-05-08T08:24:07Z

URL: https://github.com/WordPress/gutenberg/pull/78076#discussion_r3207384148
...
Not sure if we want to mention a couple of behavioural changes:

- Consumers relying on "item with an empty string value used as a placeholder" will lose the placeholder styling
- Previously, with no items and no selected value, the trigger rendered empty. it now renders "Select"

Slightly breaking, but also enhancements.

### Review thread 2 (resolved)

#### ciampo on 2026-05-08T08:35:54Z

URL: https://github.com/WordPress/gutenberg/pull/78076#discussion_r3207445872
Path: packages/ui/src/form/primitives/select/test/index.test.tsx

Should we add a test for the null-item clearable flow described in the docstring (open the popup, select a value, click the null item, assert the trigger reverts to the placeholder with `data-placeholder`)?

#### mirka on 2026-05-08T12:06:47Z

URL: https://github.com/WordPress/gutenberg/pull/78076#discussion_r3208523500
Path: packages/ui/src/form/primitives/select/test/index.test.tsx

This is just standard upstream behavior, so I opted to omit testing on our end.

### Review thread 3 (resolved)

#### ciampo on 2026-05-08T08:37:30Z

URL: https://github.com/WordPress/gutenberg/pull/78076#discussion_r3207454020
Path: packages/ui/src/form/primitives/select/test/index.test.tsx
...
Potentially stricter / more correct?

```ts
const trigger = screen.getByRole( 'combobox' );
expect( trigger ).toHaveTextContent( 'Item 1' );
expect( within( trigger ).getByText( 'Item 1' ) ).not.toHaveAttribute( 'data-placeholder' );
```

### Review thread 4 (resolved)

#### ciampo on 2026-05-08T08:48:18Z

URL: https://github.com/WordPress/gutenberg/pull/78076#discussion_r3207508677
...
I feel like we should flag more clearly in `Select.Trigger` that the trigger contents will get "placeholder styles" when there's no value selected, even if they supply a custom child function?

## Changed files

- packages/ui/CHANGELOG.md (MODIFIED, +3/-0)
- packages/ui/src/form/primitives/select/stories/index.story.tsx (MODIFIED, +34/-21)
- packages/ui/src/form/primitives/select/test/index.test.tsx (MODIFIED, +53/-1)
- packages/ui/src/form/primitives/select/trigger.tsx (MODIFIED, +11/-8)
- packages/ui/src/form/primitives/select/types.ts (MODIFIED, +11/-1)
