...
type: pull_request
state: MERGED
merged_at: 2022-08-16T09:29:10Z
url: https://github.com/WordPress/gutenberg/pull/43165
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components"]
---

# PR #43165: ComboboxControl: Add flag to remove bottom margin

- URL: https://github.com/WordPress/gutenberg/pull/43165
- Author: mirka
- Created: 2022-08-11T18:55:28Z
- Updated: 2022-08-16T09:34:25Z
- Comments: 1 of 1
- Review threads: 2 of 2
- Changed files: 4 of 4
- Diff: ../pr-diffs/43165.diff
...
### github-actions on 2022-08-11T19:04:23Z

URL: https://github.com/WordPress/gutenberg/pull/43165#issuecomment-1212378424

**Size Change:** -32.3 kB (-3%) 
...
| `build/block-editor/index.min.js` | 159 kB | +2.67 kB (+2%) |  |
| `build/block-editor/style-rtl.css` | 15.1 kB | +364 B (+2%) |  |
| `build/block-editor/style.css` | 15.1 kB | +364 B (+2%) |  |
...
| `build/block-library/editor-rtl.css` | 10.8 kB | -91 B (-1%) |  |
| `build/block-library/editor.css` | 10.8 kB | -96 B (-1%) |  |
| `build/block-library/index.min.js` | 185 kB | +412 B (0%) |  |
| `build/blocks/index.min.js` | 49.4 kB | +2.15 kB (+5%) | 🔍 |
| `build/components/index.min.js` | 198 kB | -33.5 kB (-14%) | 👏 |
...
| `build/core-data/index.min.js` | 15.4 kB | +137 B (+1%) |  |
| `build/date/index.min.js` | 32 kB | +5 B (0%) |  |
| `build/edit-post/index.min.js` | 30.5 kB | +20 B (0%) |  |
| `build/edit-site/index.min.js` | 57.2 kB | +386 B (+1%) |  |
| `build/edit-site/style-rtl.css` | 8.22 kB | -11 B (0%) |  |
| `build/edit-site/style.css` | 8.21 kB | -11 B (0%) |  |
| `build/editor/index.min.js` | 41.4 kB | +26 B (0%) |  |
| `build/rich-text/index.min.js` | 11.2 kB | +20 B (0%) |  |
...
#### mirka on 2022-08-11T19:05:28Z

URL: https://github.com/WordPress/gutenberg/pull/43165#discussion_r943832579
...
#### ciampo on 2022-08-16T07:53:59Z

URL: https://github.com/WordPress/gutenberg/pull/43165#discussion_r946449141
Path: packages/components/src/combobox-control/stories/index.js
...
Is this necessary? (It would probably be if the story was written in TypeScript?)

```suggestion
					onChange?.( ...changeArgs );
```

#### mirka on 2022-08-16T08:28:07Z

URL: https://github.com/WordPress/gutenberg/pull/43165#discussion_r946482521
Path: packages/components/src/combobox-control/stories/index.js
...
- packages/components/src/combobox-control/stories/index.js (MODIFIED, +9/-3)
- packages/components/src/combobox-control/style.scss (MODIFIED, +0/-1)
