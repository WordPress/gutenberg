...
type: pull_request
state: MERGED
merged_at: 2026-03-06T18:17:51Z
url: https://github.com/WordPress/gutenberg/pull/76131
matched_labels: ["Design System","[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components","Design System"]
---

# PR #76131: Tooltip: Change default placement from bottom to top

- URL: https://github.com/WordPress/gutenberg/pull/76131
- Author: jameskoster
- Created: 2026-03-04T09:51:24Z
- Updated: 2026-03-06T18:18:37Z
- Comments: 5 of 5
- Review threads: 1 of 1
- Changed files: 6 of 6
- Diff: ../pr-diffs/76131.diff
...
### github-actions on 2026-03-04T10:04:05Z

URL: https://github.com/WordPress/gutenberg/pull/76131#issuecomment-3996495766
...
| :--- | :---: | :---: |
| `build/scripts/block-editor/index.min.js` | 329 kB | +7 B (0%) |
| `build/scripts/edit-site/index.min.js` | 245 kB | +7 B (0%) |
| `build/scripts/editor/index.min.js` | 349 kB | +4 B (0%) |
| `build/scripts/media-utils/index.min.js` | 73.6 kB | +10 B (+0.01%) |
...
### github-actions on 2026-03-04T12:19:37Z

URL: https://github.com/WordPress/gutenberg/pull/76131#issuecomment-3997205548
...
### github-actions on 2026-03-04T12:42:48Z

URL: https://github.com/WordPress/gutenberg/pull/76131#issuecomment-3997317139

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 066bf18bb65ac2a658b9fb1d71cbae790303524b.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/22669052753
📝  Reported issues:
- #74664 in `/test/e2e/specs/site-editor/activate-theme.spec.js`

### aduth on 2026-03-04T15:30:14Z

URL: https://github.com/WordPress/gutenberg/pull/76131#issuecomment-3998288666

> The Tooltip's original default position was `top`.

For more context, the component was originally added in #2293, and the screenshot there clearly shows the tooltip on top.

One thing I'd want to confirm here is whether the tooltip automatically flips to the bottom if there's not enough space above it, such as in IconButtons in the post editor toolbar.

### jameskoster on 2026-03-04T15:31:11Z

URL: https://github.com/WordPress/gutenberg/pull/76131#issuecomment-3998294811
...
#### mirka on 2026-03-04T14:22:48Z

URL: https://github.com/WordPress/gutenberg/pull/76131#discussion_r2884077222
Path: packages/components/src/tooltip/types.ts

We also need to update the default values (two places) in `packages/components/src/tooltip/README.md`.

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/tooltip/README.md (MODIFIED, +2/-2)
- packages/components/src/tooltip/index.tsx (MODIFIED, +2/-2)
- packages/components/src/tooltip/types.ts (MODIFIED, +2/-2)
- packages/ui/CHANGELOG.md (MODIFIED, +1/-0)
- packages/ui/src/tooltip/popup.tsx (MODIFIED, +1/-1)
