...
type: pull_request
state: MERGED
merged_at: 2025-10-24T10:41:20Z
url: https://github.com/WordPress/gutenberg/pull/72653
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components","Backported to WP Core"]
---

# PR #72653: Badge: Add max-width for text truncation

- URL: https://github.com/WordPress/gutenberg/pull/72653
- Author: t-hamano
- Created: 2025-10-24T09:35:51Z
- Updated: 2025-10-27T01:53:27Z
- Comments: 8 of 8
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/72653.diff
...
### t-hamano on 2025-10-24T09:37:40Z

URL: https://github.com/WordPress/gutenberg/pull/72653#issuecomment-3442145228

Note that this issue is occurring in WP 6.9, so this pull request needs to be backported.

### github-actions on 2025-10-24T09:38:59Z

URL: https://github.com/WordPress/gutenberg/pull/72653#issuecomment-3442153955
...
### github-actions on 2025-10-24T09:49:34Z

URL: https://github.com/WordPress/gutenberg/pull/72653#issuecomment-3442219745
...
| :--- | :---: | :---: |
| `build/scripts/core-commands/index.min.js` | 4.1 kB | -52 B (-1.25%) |
| `build/styles/components/style-rtl.css` | 14 kB | +3 B (+0.02%) |
| `build/styles/components/style.css` | 14 kB | +4 B (+0.03%) |
...
### github-actions on 2025-10-24T10:09:19Z

URL: https://github.com/WordPress/gutenberg/pull/72653#issuecomment-3442320673

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 69c5205b6925d0a503d6a83dd0489d81270866b2.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/18775879352
📝  Reported issues:
- #51533 in `/test/e2e/specs/editor/various/list-view.spec.js`

### t-hamano on 2025-10-24T10:40:58Z

URL: https://github.com/WordPress/gutenberg/pull/72653#issuecomment-3442449653

@tyxla Thanks for the review!

### github-actions on 2025-10-24T10:42:38Z

URL: https://github.com/WordPress/gutenberg/pull/72653#issuecomment-3442454386
...
There was a conflict while trying to cherry-pick the commit to the wp/6.9 branch. Please resolve the conflict manually and create a PR to the wp/6.9 branch.
  ...
  git cherry-pick 90a2882e9ebd394c42252923d58f53e79505e610
...
### t-hamano on 2025-10-24T10:45:59Z

URL: https://github.com/WordPress/gutenberg/pull/72653#issuecomment-3442467859

> There was a conflict while trying to cherry-pick the commit to the wp/6.9 branch. Please resolve the conflict manually and create a PR to the wp/6.9 branch.
> 
>   PRs to wp/6.9 are similar to PRs to trunk, but you should base your PR on the wp/6.9 branch instead of trunk.

Unfortunately, this is a common problem with component packages and dataviews packages. (Example of a similar error: https://github.com/WordPress/gutenberg/pull/72656#issuecomment-3442454846) I will submit a backport PR later.

### t-hamano on 2025-10-27T01:53:20Z

URL: https://github.com/WordPress/gutenberg/pull/72653#issuecomment-3449194003

This pull request was manually backported to the `wp/6.9` branch: https://github.com/WordPress/gutenberg/pull/72660
