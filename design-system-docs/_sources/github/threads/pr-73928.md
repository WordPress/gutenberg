...
type: pull_request
state: MERGED
merged_at: 2025-12-12T19:24:11Z
url: https://github.com/WordPress/gutenberg/pull/73928
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Task","[Package] UI"]
---

# PR #73928: UI: Ensure Stack is exported from root package exports

- URL: https://github.com/WordPress/gutenberg/pull/73928
- Author: aduth
- Created: 2025-12-11T19:14:01Z
- Updated: 2025-12-12T19:25:30Z
- Comments: 3 of 3
- Review threads: 3 of 3
- Changed files: 8 of 8
- Diff: ../pr-diffs/73928.diff
...
Ensures that the `Stack` component is exported from the `@wordpress/ui` package.
...
- Adds export in package entrypoint `packages/ui/src/index.ts`
- Adds test coverage to ensure that each component that follows [the documented folder structure](https://github.com/WordPress/gutenberg/blob/trunk/packages/ui/CONTRIBUTING.md#folder-structure) should have its folder referenced in this entrypoint file
- A bit of miscellaneous housekeeping while I was here:
   - Establishes a `CHANGELOG.md`
   - Removes an unreferenced `lock-unlock.ts` file
   - Removes an invalid "Internal dependencies" DocBlock 

## Testing Instructions

- Add an `import { Stack } from '@wordpress/ui';` code snippet in some code file, and a corresponding `"@wordpress/ui": "../ui"` dependencies declaration in that code's closest `package.json`
- Observe that there are no lint errors references an invalid export when running `npm run lint:js`

## Screenshots or screencast <!-- if applicable -->

<img width="566" height="116" alt="image" src="https://github.com/user-attachments/assets/1807ce4c-4258-4b44-8ac8-9aa98a080660" />

## Issue comments

### github-actions on 2025-12-11T19:14:15Z

URL: https://github.com/WordPress/gutenberg/pull/73928#issuecomment-3643405073
...
### github-actions on 2025-12-11T19:44:25Z

URL: https://github.com/WordPress/gutenberg/pull/73928#issuecomment-3643523214

<!-- flaky-tests-report-comment -->
**Flaky tests detected in bf8e6d5648dbd955e4b1a3102b6ed3f78675ab36.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/20172074697
📝  Reported issues:
- #73752 in `/test/e2e/specs/site-editor/template-id-format.spec.js`

### github-actions on 2025-12-12T15:44:35Z

URL: https://github.com/WordPress/gutenberg/pull/73928#issuecomment-3647086270
...
#### jsnajdr on 2025-12-12T09:47:55Z

URL: https://github.com/WordPress/gutenberg/pull/73928#discussion_r2613596449
Path: packages/ui/src/lock-unlock.ts
...
#### aduth on 2025-12-12T15:32:22Z

URL: https://github.com/WordPress/gutenberg/pull/73928#discussion_r2614639855
Path: packages/ui/src/lock-unlock.ts
...
Good catch. Fixed in b93be579b94.

### Review thread 2

#### mirka on 2025-12-12T12:45:47Z

URL: https://github.com/WordPress/gutenberg/pull/73928#discussion_r2614094925
Path: packages/ui/src/test/index.test.ts
...
I'm paranoid about breaking in Windows again, could this need [this kind of workaround](https://www.npmjs.com/package/fast-glob#how-to-write-patterns-on-windows)? 

For example I'm seeing a normalizer used here:

https://github.com/WordPress/gutenberg/blob/b59a2456328c85e7a3af4440ca8c21eec1209276/packages/wp-build/src/build.mjs#L456-L457

#### aduth on 2025-12-12T15:06:53Z

URL: https://github.com/WordPress/gutenberg/pull/73928#discussion_r2614549490
Path: packages/ui/src/test/index.test.ts
...
#### aduth on 2025-12-12T15:10:12Z

URL: https://github.com/WordPress/gutenberg/pull/73928#discussion_r2614564160
Path: packages/ui/src/test/index.test.ts
...
Although to that point, it doesn't appear that we run unit tests in a Windows environment [_at any point_](https://github.com/WordPress/gutenberg/blob/c7dff504a2bc4f74de9a242f925e07cd852c5a7f/.github/workflows/unit-test.yml#L35-L45), so we have no guarantees that the tests _currently_ work on Windows machines 😬

#### aduth on 2025-12-12T15:15:13Z

URL: https://github.com/WordPress/gutenberg/pull/73928#discussion_r2614583142
Path: packages/ui/src/test/index.test.ts
...
I've been dabbling a bit with using [GitHub Codespaces](https://github.com/features/codespaces) and this seems like it'd be a great use for testing how code behaves on other systems, but sadly it only offers Linux containers at the moment.

#### aduth on 2025-12-12T15:28:30Z

URL: https://github.com/WordPress/gutenberg/pull/73928#discussion_r2614626832
Path: packages/ui/src/test/index.test.ts
...
It's a [requirement of `fast-glob`](https://github.com/mrmlnc/fast-glob?tab=readme-ov-file#pattern-syntax):

>⚠️ Always use forward-slashes in glob expressions (patterns and [ignore](https://github.com/mrmlnc/fast-glob?tab=readme-ov-file#ignore) option). Use backslashes for escaping characters.

I think we won't need these workarounds once we upgrade to a version of Node.js that includes [`fs.glob`](https://nodejs.org/api/fs.html#fsglobpattern-options-callback), which I suspect will handle this better (available in Node.js v22+, see #72973).

#### aduth on 2025-12-12T15:32:13Z

URL: https://github.com/WordPress/gutenberg/pull/73928#discussion_r2614639381
Path: packages/ui/src/test/index.test.ts
...
Fixed in 3bba4f579aa

### Review thread 3 (resolved)

#### mirka on 2025-12-12T16:43:55Z

URL: https://github.com/WordPress/gutenberg/pull/73928#discussion_r2614904784
Path: packages/ui/src/test/index.test.ts
...
Wouldn't this still be mixed slash?

```
C:\foobar\gutenberg\packages\ui\src\test/../*/index.ts
```

Maybe `cwd` in the options? That pattern seems to be used in a few other places.
...
#### aduth on 2025-12-12T16:54:35Z

URL: https://github.com/WordPress/gutenberg/pull/73928#discussion_r2614938840
Path: packages/ui/src/test/index.test.ts
...
- packages/ui/CHANGELOG.md (ADDED, +7/-0)
- packages/ui/package.json (MODIFIED, +0/-1)
- packages/ui/src/index.ts (MODIFIED, +1/-0)
- packages/ui/src/lock-unlock.ts (DELETED, +0/-10)
- packages/ui/src/stack/index.ts (MODIFIED, +0/-3)
- packages/ui/src/test/index.test.ts (ADDED, +22/-0)
- packages/ui/tsconfig.json (MODIFIED, +1/-5)
