...
type: pull_request
state: MERGED
merged_at: 2021-02-16T16:46:02Z
url: https://github.com/WordPress/gutenberg/pull/29038
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #29038: Components: Safe access to document in ScrollLock

- URL: https://github.com/WordPress/gutenberg/pull/29038
- Author: tyxla
- Created: 2021-02-16T12:47:54Z
- Updated: 2021-03-01T09:11:19Z
- Comments: 1 of 1
- Review threads: 1 of 1
- Changed files: 1 of 1
- Diff: ../pr-diffs/29038.diff

## Body

## Description

This PR changes the `<ScrollLock />` component to safely access `document`. This is helpful for the instances where the component is used in a Node context. 

## How has this been tested?
* Open a post for editing.
* Change the viewport size to mobile.
* Open the sidebar.
* Verify that when you scroll in the sidebar, the content of the post stays put.
* Verify that there are no console errors.
* Verify the storybook examples still work like before.
* Verify all tests still pass. 

## Types of changes
This is an enhancement for a component, aiming at providing better SSR support for the `<ScrollLock />` component.
...
### github-actions on 2021-02-16T12:58:03Z

URL: https://github.com/WordPress/gutenberg/pull/29038#issuecomment-779819949
...
#### ellatrix on 2021-03-01T09:11:12Z

URL: https://github.com/WordPress/gutenberg/pull/29038#discussion_r584547794
...
Ideally the document should be derived from a ref.

## Changed files

- packages/components/src/scroll-lock/index.js (MODIFIED, +5/-1)
