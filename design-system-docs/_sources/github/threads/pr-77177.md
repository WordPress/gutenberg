...
type: pull_request
state: MERGED
merged_at: 2026-04-26T07:51:25Z
url: https://github.com/WordPress/gutenberg/pull/77177
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Build Tooling","[Package] Components","[Package] Project management automation","[Package] Preferences"]
---

# PR #77177: Update TypeScript to tsgo (7.0)

- URL: https://github.com/WordPress/gutenberg/pull/77177
- Author: jsnajdr
- Created: 2026-04-09T07:29:11Z
- Updated: 2026-04-26T07:53:04Z
- Comments: 15 of 15
- Review threads: 10 of 10
- Changed files: 19 of 19
- Diff: ../pr-diffs/77177.diff

## Body

Trying to update the Gutenberg repo to tsgo (`@typescript/native-preview` package). After fixing errors, it works perfectly.

## Issue comments

### manzoorwanijk on 2026-04-09T07:58:57Z

URL: https://github.com/WordPress/gutenberg/pull/77177#issuecomment-4212570587

Did you see #76148?

### github-actions on 2026-04-09T08:11:57Z

URL: https://github.com/WordPress/gutenberg/pull/77177#issuecomment-4212643958

The following accounts have interacted with this PR and/or linked issues. I will continue to update these lists as activity occurs. You can also manually ask me to refresh this list by adding the `props-bot` label.

## Unlinked Accounts

The following contributors have not linked their GitHub and WordPress.org accounts: @caseymilne, @felixmanus.
...
```
Unlinked contributors: caseymilne, felixmanus.
...
### github-actions on 2026-04-09T08:16:37Z

URL: https://github.com/WordPress/gutenberg/pull/77177#issuecomment-4212671594

<!-- flaky-tests-report-comment -->
**Flaky tests detected in ed80c3817cad99f2ca5f509a19fd9ebedbd0b39b.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/24889782832
📝  Reported issues:
- #76524 in `/test/e2e/specs/editor/various/post-content-focus-mode.spec.js`

### manzoorwanijk on 2026-04-09T08:26:08Z

URL: https://github.com/WordPress/gutenberg/pull/77177#issuecomment-4212727171
...
### jsnajdr on 2026-04-09T09:18:22Z

URL: https://github.com/WordPress/gutenberg/pull/77177#issuecomment-4213029458

> Did you see https://github.com/WordPress/gutenberg/issues/76148?

I didn't, thanks for linking 🙂 

One thing that stands out is that the errors reported now are very different from what you described a month ago in the issue.

### manzoorwanijk on 2026-04-09T09:24:53Z

URL: https://github.com/WordPress/gutenberg/pull/77177#issuecomment-4213067158

> One thing that stands out is that the errors reported now are very different from what you described a month ago in the issue.

Yes, because the `tsgo` preview is rapidly changing.

### jsnajdr on 2026-04-09T09:45:05Z

URL: https://github.com/WordPress/gutenberg/pull/77177#issuecomment-4213186651

Reported one issue where I was able to isolate a minimal example: https://github.com/microsoft/typescript-go/issues/3370

### github-actions on 2026-04-24T09:27:37Z

URL: https://github.com/WordPress/gutenberg/pull/77177#issuecomment-4312081534
...
| `build/scripts/media-utils/index.min.js` | 79.3 kB |
...
### jsnajdr on 2026-04-24T09:55:46Z

URL: https://github.com/WordPress/gutenberg/pull/77177#issuecomment-4312296733

I updated the PR to the latest version from the `latest` tag (few days newer than the official `beta`) and fixed all type errors.

The PR is now green. The only thing that doesn't work for me is the VSCode/Cursor integration.

### manzoorwanijk on 2026-04-24T10:22:05Z

URL: https://github.com/WordPress/gutenberg/pull/77177#issuecomment-4312446153

> The only thing that doesn't work for me is the VSCode/Cursor integration.

Works fine for me. You need to have this in `settings.json`

```json
  "typescript.experimental.useTsgo": true
```

and then install the required extension - [TypeScript (Native Preview)](https://marketplace.visualstudio.com/items?itemName=TypeScriptTeam.native-preview)

You will need to restart VS Code after that.

### jsnajdr on 2026-04-24T10:58:29Z

URL: https://github.com/WordPress/gutenberg/pull/77177#issuecomment-4312640739

> and then install the required extension

Yes, this is what I was missing. I just enabled the setting and nothing else. Now it works perfectly 🙂

Do we want to use the `beta` in `trunk`?

### ciampo on 2026-04-24T11:18:54Z

URL: https://github.com/WordPress/gutenberg/pull/77177#issuecomment-4312745293

Do we have some numbers on the actual gains? Asking out of curiousity and excitement :D

### sirreal on 2026-04-24T11:26:19Z

URL: https://github.com/WordPress/gutenberg/pull/77177#issuecomment-4312783439

The latest static CI type checking was 3m55s. On this branch it was 2m34s. That's a substantial improvement.

The type check step seems to do much more than type checking, but if we look at these timestamps:

```
Trunk:
Fri, 24 Apr 2026 10:20:17 GMT 📘 Building TypeScript types...
Fri, 24 Apr 2026 10:23:13 GMT
Branch:
Fri, 24 Apr 2026 09:57:21 GMT 📘 Building TypeScript types...
Fri, 24 Apr 2026 09:59:02 GMT
```

That's something like 2m56s (before) vs 1m41s (after), an improvement in the ballpark of 40%. This is anecdotal of course, but it seems reasonable to believe that `tsgo` will be faster.

### tyxla on 2026-04-24T11:35:53Z

URL: https://github.com/WordPress/gutenberg/pull/77177#issuecomment-4312831738

Haven't had a chance to review this yet, but wow, the type check speed reduction is a huge improvement!

### jsnajdr on 2026-04-24T12:47:41Z

URL: https://github.com/WordPress/gutenberg/pull/77177#issuecomment-4313268424

I added timing support to the `npm run build` and `npm run dev` commands and ran them on my local machine. The results:
- uncached build, after removing all `.tsbuildinfo` files: `tsc` builds in 109s, `tsgo` in 33s. That's 3.3x speedup.
- cached incremental build: `tsc` builds in 1.8s, `tsgo` in 0.28s. That 6.5x speedup.

I ran it all just once, so I don't know how much variance there is.

> I have some optional suggestions to keep the implementation details neutral.

I agree, this was autogenerated by Cursor and at the time I didn't pay much attention, it was an experiment.

I removed all the changes that don't actually run the compiler. Now only these places change `tsc` to `tsgo`. When some comment or console message mentions `tsc`, I'm keeping it as is. When 7.0 is released, the name of the binary will be `tsc` back again, so there's no point changing the mentions, even if they are incorrect temporarily.

## Review threads

### Review thread 1

#### sirreal on 2026-04-24T11:03:06Z

URL: https://github.com/WordPress/gutenberg/pull/77177#discussion_r3137249614
Path: bin/packages/check-build-type-declaration-files.js
...
#### manzoorwanijk on 2026-04-24T11:19:01Z

URL: https://github.com/WordPress/gutenberg/pull/77177#discussion_r3137323028
Path: bin/packages/check-build-type-declaration-files.js
...
#### manzoorwanijk on 2026-04-24T11:31:09Z

URL: https://github.com/WordPress/gutenberg/pull/77177#discussion_r3137386832
Path: bin/packages/check-build-type-declaration-files.js
...
#### manzoorwanijk on 2026-04-24T11:31:38Z

URL: https://github.com/WordPress/gutenberg/pull/77177#discussion_r3137388990
Path: bin/packages/check-build-type-declaration-files.js
...
#### manzoorwanijk on 2026-04-24T11:32:00Z

URL: https://github.com/WordPress/gutenberg/pull/77177#discussion_r3137390796
Path: bin/build.mjs
...
#### manzoorwanijk on 2026-04-24T11:32:13Z

URL: https://github.com/WordPress/gutenberg/pull/77177#discussion_r3137391875
Path: bin/build.mjs
...
#### manzoorwanijk on 2026-04-24T11:32:24Z

URL: https://github.com/WordPress/gutenberg/pull/77177#discussion_r3137392859
Path: bin/dev.mjs
...
#### manzoorwanijk on 2026-04-24T11:32:33Z

URL: https://github.com/WordPress/gutenberg/pull/77177#discussion_r3137393517
Path: bin/dev.mjs
...
#### manzoorwanijk on 2026-04-24T11:33:26Z

URL: https://github.com/WordPress/gutenberg/pull/77177#discussion_r3137397738
Path: bin/dev.mjs
...
#### manzoorwanijk on 2026-04-24T11:33:33Z

URL: https://github.com/WordPress/gutenberg/pull/77177#discussion_r3137398330
Path: bin/dev.mjs
...
#### manzoorwanijk on 2026-04-24T11:34:19Z

URL: https://github.com/WordPress/gutenberg/pull/77177#discussion_r3137401656
Path: package.json
...
- package-lock.json (MODIFIED, +142/-0)
...
- packages/preferences/src/components/preferences-modal-tabs/index.tsx (MODIFIED, +1/-1)
