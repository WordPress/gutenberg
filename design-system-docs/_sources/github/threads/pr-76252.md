...
type: pull_request
state: MERGED
merged_at: 2026-03-06T18:32:10Z
url: https://github.com/WordPress/gutenberg/pull/76252
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Enhancement","[Package] UI"]
---

# PR #76252: `@wordpress/ui`: add `Card` and `CollapsibleCard` components

- URL: https://github.com/WordPress/gutenberg/pull/76252
- Author: ciampo
- Created: 2026-03-06T15:27:41Z
- Updated: 2026-03-19T12:19:59Z
- Comments: 5 of 5
- Review threads: 8 of 8
- Changed files: 20 of 20
- Diff: ../pr-diffs/76252.diff
...
Add `Card` and `CollapsibleCard` components to `@wordpress/ui`
...
Create components from scratch using DS tokens, use Base UI's `Collapsible` for expand/collapse feature
...
`CollapsibleCard` vs regular `Card`

![Screenshot 2026-03-06 at 16 43 02](https://github.com/user-attachments/assets/21613c01-6570-4d9a-9b8f-df08e4d8536e)

`CollapsibleCard` in closed state, different header content heights:

![Screenshot 2026-03-06 at 16 42 49](https://github.com/user-attachments/assets/0ef87367-98aa-4f1d-835b-1e753e5cfc88)

`CollapsibleCard` in opened state, different header content heights:

![Screenshot 2026-03-06 at 16 42 43](https://github.com/user-attachments/assets/0e70fb4f-865b-4ebc-901e-b4b4629eca37)

FullBleed content:

![Screenshot 2026-03-06 at 16 45 20](https://github.com/user-attachments/assets/9056a326-e84d-41ee-b564-3c1a2813c10c)

</details>

## Next Steps

- [x] https://github.com/WordPress/gutenberg/pull/76280
- [x] https://github.com/WordPress/gutenberg/pull/76281
- [x] https://github.com/WordPress/gutenberg/pull/76329
- [x] https://github.com/WordPress/gutenberg/pull/76368
- [x] https://github.com/WordPress/gutenberg/pull/76265
- [x] https://github.com/WordPress/gutenberg/pull/76378
- [x] https://github.com/WordPress/gutenberg/pull/76498
- [x] https://github.com/WordPress/gutenberg/pull/76678
- [x] https://github.com/WordPress/gutenberg/pull/76282
- [ ] Use `Text` and DS tokens once finalized

## Issue comments

### github-actions on 2026-03-06T15:41:02Z

URL: https://github.com/WordPress/gutenberg/pull/76252#issuecomment-4012481205
...
| `build/styles/editor/style-rtl.min.css` | 21.1 kB |
| `build/styles/editor/style.css` | 25.4 kB |
| `build/styles/editor/style.min.css` | 21.1 kB |
...
### github-actions on 2026-03-06T15:47:57Z

URL: https://github.com/WordPress/gutenberg/pull/76252#issuecomment-4012516679
...
### github-actions on 2026-03-06T16:10:53Z

URL: https://github.com/WordPress/gutenberg/pull/76252#issuecomment-4012637456

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 0778f7b14869334463e6a9a65a7b5e68ad6da7fc.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/22775256572
📝  Reported issues:
- #48558 in `/test/e2e/specs/editor/various/undo.spec.js`

### jameskoster on 2026-03-06T19:29:22Z

URL: https://github.com/WordPress/gutenberg/pull/76252#issuecomment-4013657700

I wonder if `Card.Content` should provide a default `gap`. Or should it be left to the consumer to utilise `Stack` for that purpose?

### ciampo on 2026-03-06T20:01:04Z

URL: https://github.com/WordPress/gutenberg/pull/76252#issuecomment-4013844779

> I wonder if `Card.Content` should provide a default `gap`. Or should it be left to the consumer to utilise `Stack` for that purpose?

IMO, I think it should be left to the consumer, since we can't assume that `Card.Content` will always have vertically stacked content in need of such gap.

## Review threads

### Review thread 1

#### ciampo on 2026-03-06T15:57:36Z

URL: https://github.com/WordPress/gutenberg/pull/76252#discussion_r2896543782
Path: packages/ui/src/card/stories/index.story.tsx
...
Fix here: https://github.com/WordPress/gutenberg/pull/76254

### Review thread 2 (resolved)

#### aduth on 2026-03-06T16:39:10Z

URL: https://github.com/WordPress/gutenberg/pull/76252#discussion_r2896749500
Path: packages/ui/src/card/content.tsx
...
Nit: I'd collapse all these newlines consistent with other component implementations.

### Review thread 3 (resolved)

#### aduth on 2026-03-06T16:43:38Z

URL: https://github.com/WordPress/gutenberg/pull/76252#discussion_r2896777078
Path: packages/ui/src/card/root.tsx
...
Minor: [Related comment](https://github.com/WordPress/gutenberg/pull/75870#discussion_r2885804061) about not needing to specify `children` here. I feel we should have some guidelines around `mergeProps`. For example, one nice thing I see is [classname merging](https://github.com/WordPress/gutenberg/blob/2078d6454a3bbdfd1747148d0274338614487b2b/packages/ui/src/card/header.tsx#L18) without having to use `clsx`, where other components [we use `clsx` unnecessarily](https://github.com/WordPress/gutenberg/blob/65980bfcab31125b32f2d873b0c1855fcda45917/packages/ui/src/text/text.tsx#L19-L21).

#### ciampo on 2026-03-06T17:39:21Z

URL: https://github.com/WordPress/gutenberg/pull/76252#discussion_r2897024761
Path: packages/ui/src/card/root.tsx
...
Sounds good. I've removed all unnecessary forwarding / merging.

### Review thread 4 (resolved)

#### aduth on 2026-03-06T16:47:51Z

URL: https://github.com/WordPress/gutenberg/pull/76252#discussion_r2896797079
...
Do we see these values being customizable? (For context, I observe that the density behavior can also be used to influence the padding)

#### ciampo on 2026-03-06T17:18:13Z

URL: https://github.com/WordPress/gutenberg/pull/76252#discussion_r2896934653
Path: packages/ui/src/card/style.module.css
...
They are abstracted as variables because they are either reused (for example, in the `FullBleed` negative margins), for clarity in the computations (like for the spacing between card header and content), and for a likely future "size" or "density" option, which will change the value of the variable.

### Review thread 5

#### aduth on 2026-03-06T16:48:45Z

URL: https://github.com/WordPress/gutenberg/pull/76252#discussion_r2896801109
Path: packages/ui/src/collapsible-card/content.tsx
...
#### ciampo on 2026-03-06T17:18:33Z

URL: https://github.com/WordPress/gutenberg/pull/76252#discussion_r2896935931
Path: packages/ui/src/collapsible-card/content.tsx
...
#### aduth on 2026-03-06T16:53:49Z

URL: https://github.com/WordPress/gutenberg/pull/76252#discussion_r2896825451
Path: packages/ui/src/collapsible-card/types.ts
...
#### aduth on 2026-03-06T17:07:04Z

URL: https://github.com/WordPress/gutenberg/pull/76252#discussion_r2896885560
...
+		position: relative;
+
+		/* Since the button has absolute positioning, we have to explicitly
+		  specify the wrapper's width. This value should be kept in sync with the
+			`size` prop of the `IconButton` component used for the trigger button.  */
+		/* TODO: use size DS token when available */
+		width: 32px;
+	}
+
+	.header-trigger {
+		/* Absolutely positioned to prevent making the header taller, in case
+		   the header content is not as tall as the button. This is mostly to
+			 preserve the same metrics between `Card` and `CollapsibleCard` (when open) */
+		position: absolute;
+		inset-block-start: 50%;
+		transform: translateY(-50%);
```

Interesting dilemma. I don't love the hard-coded `width` here, though I understand the need for it. Seems like we want the width of the button to contribute to its container but not the height. Ideating on alternatives with my friend Claude, they suggested a possible alternative with `max-height: 0;` + `overflow: visible`, though in practice I'm still not sure if it'd work well enough. Maybe not worth stressing over if we work toward control tokens like in #75101.

#### ciampo on 2026-03-06T17:49:48Z

URL: https://github.com/WordPress/gutenberg/pull/76252#discussion_r2897066892
Path: packages/ui/src/collapsible-card/style.module.css
...
Nice! Your friend Claude was onto something. In my tests, it seems to work as expected. Pushed

### Review thread 8 (resolved)

#### aduth on 2026-03-06T17:09:45Z

URL: https://github.com/WordPress/gutenberg/pull/76252#discussion_r2896897921
...
Interesting solution. One possible repercussion is that if someone inserts their own clickable elements inside the header, they'll also bubble to toggle the collapsing behavior, but maybe that's an acceptable risk as either "doing it wrong" or even arguably correct behavior (it's still a click inside the toggle section) that could be worked around with `stopPropagation`.

#### ciampo on 2026-03-06T17:21:22Z

URL: https://github.com/WordPress/gutenberg/pull/76252#discussion_r2896947916
Path: packages/ui/src/collapsible-card/header.tsx
...
I'd argue that `CollapsibleCard.Header` should _not_ have any interactive elements as children, given that it's interactive.

I added a comment about it in the component's JSDocs. We can also consider dropping this altogether (or make it optional behind a prop) if we get a clear sign that folks would rather have interactive children.

## Changed files

- packages/ui/CHANGELOG.md (MODIFIED, +4/-0)
- packages/ui/src/card/content.tsx (ADDED, +20/-0)
- packages/ui/src/card/full-bleed.tsx (ADDED, +26/-0)
- packages/ui/src/card/header.tsx (ADDED, +21/-0)
- packages/ui/src/card/index.ts (ADDED, +7/-0)
- packages/ui/src/card/root.tsx (ADDED, +42/-0)
- packages/ui/src/card/stories/index.story.tsx (ADDED, +128/-0)
- packages/ui/src/card/style.module.css (ADDED, +47/-0)
- packages/ui/src/card/test/index.test.tsx (ADDED, +96/-0)
- packages/ui/src/card/title.tsx (ADDED, +22/-0)
- packages/ui/src/card/types.ts (ADDED, +38/-0)
- packages/ui/src/collapsible-card/content.tsx (ADDED, +20/-0)
- packages/ui/src/collapsible-card/header.tsx (ADDED, +71/-0)
- packages/ui/src/collapsible-card/index.ts (ADDED, +5/-0)
- packages/ui/src/collapsible-card/root.tsx (ADDED, +37/-0)
- packages/ui/src/collapsible-card/stories/index.story.tsx (ADDED, +156/-0)
- packages/ui/src/collapsible-card/style.module.css (ADDED, +37/-0)
- packages/ui/src/collapsible-card/test/index.test.tsx (ADDED, +207/-0)
- packages/ui/src/collapsible-card/types.ts (ADDED, +44/-0)
