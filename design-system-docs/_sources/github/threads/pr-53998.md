...
type: pull_request
state: MERGED
merged_at: 2023-09-12T16:35:16Z
url: https://github.com/WordPress/gutenberg/pull/53998
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components","Needs User Documentation"]
---

# PR #53998: Tweak border control button to proper metrics and simpler action

- URL: https://github.com/WordPress/gutenberg/pull/53998
- Author: richtabor
- Created: 2023-08-28T16:49:57Z
- Updated: 2023-09-29T23:48:23Z
- Comments: 2 of 2
- Review threads: 2 of 2
- Changed files: 4 of 4
- Diff: ../pr-diffs/53998.diff
...
## What?
Minor fix to adjust the reset and style buttons to fit within the updated metrics (40px and 32px) buttons—as detailed in https://github.com/WordPress/gutenberg/issues/46734. Also uses the correct border-top color now.
...
3. Add a border. 
4. See the style buttons now 32px, instead of 30px.
5. See the 46px "Reset to default" button now "Reset" and 40px.

## Screenshots or screencast <!-- if applicable -->

| Before  | After |
| ------------- | ------------- |
|<img width="262" alt="CleanShot 2023-08-28 at 12 43 53" src="https://github.com/WordPress/gutenberg/assets/1813435/2a52b1a7-fcaf-4b25-9847-406392bea925">|<img width="262" alt="CleanShot 2023-08-28 at 12 53 28" src="https://github.com/WordPress/gutenberg/assets/1813435/acc8699f-a2e9-4fc1-a1b2-43b3a1048c52">|

## Issue comments

### github-actions on 2023-08-28T17:29:08Z

URL: https://github.com/WordPress/gutenberg/pull/53998#issuecomment-1696073523

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 544178bdb3fedf28e6a34aff6523972b90d3fd20.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/6002642997
📝  Reported issues:
- #53802 in `/test/e2e/specs/editor/various/behaviors.spec.js`
- #53524 in `/test/e2e/specs/editor/various/multi-block-selection.spec.js`

### github-actions on 2023-09-12T00:36:37Z

URL: https://github.com/WordPress/gutenberg/pull/53998#issuecomment-1714796512
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 255 kB | -17 B (0%) |
...
| `build/edit-post/style-rtl.css` | 7.64 kB |
...
| `build/edit-widgets/style-rtl.css` | 4.57 kB |
| `build/edit-widgets/style.css` | 4.57 kB |
...
#### ciampo on 2023-09-13T08:14:00Z

URL: https://github.com/WordPress/gutenberg/pull/53998#discussion_r1324146209
...
#### ciampo on 2023-09-13T08:16:22Z

URL: https://github.com/WordPress/gutenberg/pull/53998#discussion_r1324149281
...
- packages/components/src/border-control/styles.ts (MODIFIED, +6/-6)
