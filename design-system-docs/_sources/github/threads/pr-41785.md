...
type: pull_request
state: MERGED
merged_at: 2022-06-20T06:22:00Z
url: https://github.com/WordPress/gutenberg/pull/41785
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Performance","[Type] Code Quality","[Package] Components","[Package] Blocks"]
---

# PR #41785: Lodash: Refactor away from `_.isNil()`

- URL: https://github.com/WordPress/gutenberg/pull/41785
- Author: tyxla
- Created: 2022-06-17T11:22:57Z
- Updated: 2022-06-20T06:22:28Z
- Comments: 1 of 1
- Review threads: 1 of 1
- Changed files: 5 of 5
- Diff: ../pr-diffs/41785.diff
...
### github-actions on 2022-06-17T11:32:34Z

URL: https://github.com/WordPress/gutenberg/pull/41785#issuecomment-1158781630
...
| :--- | :---: | :---: |
| `build/block-library/index.min.js` | 183 kB | -5 B (0%) |
| `build/blocks/index.min.js` | 46.9 kB | -5 B (0%) |
| `build/components/index.min.js` | 227 kB | -38 B (0%) |
...
| `build/edit-site/index.min.js` | 48 kB |
...
| `build/element/index.min.js` | 4.25 kB |
...
#### ntsekouras on 2022-06-17T12:04:35Z

URL: https://github.com/WordPress/gutenberg/pull/41785#discussion_r900053758
...
Why checking `typeof` and not value here?
```suggestion
				( value ) => value !== null && value !== undefined
```

#### tyxla on 2022-06-17T12:11:02Z

URL: https://github.com/WordPress/gutenberg/pull/41785#discussion_r900057879
Path: packages/blocks/src/api/registration.js
...
I usually prefer relying on `typeof value === 'undefined'` because it will never throw and is generally safer. 
`value === undefined` on the other hand will also throw a `ReferenceError` when performing the check. 

Is there a good reason to choose the less safe approach?

#### ntsekouras on 2022-06-17T12:34:17Z

URL: https://github.com/WordPress/gutenberg/pull/41785#discussion_r900074810
Path: packages/blocks/src/api/registration.js
...
I think if we were worried about a `ReferenceError` we should handle it accordingly in a piece of code, and here we would have the error in the first check with `null`, wouldn't we?

So here since `undefined` is a primitive, we can just do that.

#### tyxla on 2022-06-17T12:36:35Z

URL: https://github.com/WordPress/gutenberg/pull/41785#discussion_r900076461
Path: packages/blocks/src/api/registration.js
...
Fair enough 👍  Updated in d62b5ab49715b07e069adddc95818adf6ad88e70

#### ntsekouras on 2022-06-17T12:37:51Z

URL: https://github.com/WordPress/gutenberg/pull/41785#discussion_r900077325
Path: packages/blocks/src/api/registration.js
...
Thanks! I know it was a nitpick, I would have approved either way. 😄

## Changed files

- .eslintrc.js (MODIFIED, +1/-0)
- packages/blocks/src/api/registration.js (MODIFIED, +4/-2)
- packages/components/src/elevation/hook.js (MODIFIED, +8/-8)
- packages/components/src/h-stack/utils.js (MODIFIED, +3/-3)
- packages/components/src/truncate/utils.js (MODIFIED, +5/-3)
