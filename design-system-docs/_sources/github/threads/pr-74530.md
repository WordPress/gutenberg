...
type: pull_request
state: MERGED
merged_at: 2026-01-12T09:04:35Z
url: https://github.com/WordPress/gutenberg/pull/74530
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Date","[Package] Compose","[Package] Core data","[Package] Components","[Package] Blocks","[Package] Block library","[Package] Block editor","[Package] DataViews"]
---

# PR #74530: Fully resolve some intra-package import paths

- URL: https://github.com/WordPress/gutenberg/pull/74530
- Author: jsnajdr
- Created: 2026-01-12T07:39:15Z
- Updated: 2026-01-12T19:04:30Z
- Comments: 3 of 3
- Review threads: 1 of 1
- Changed files: 24 of 24
- Diff: ../pr-diffs/74530.diff
...
### github-actions on 2026-01-12T07:49:20Z

URL: https://github.com/WordPress/gutenberg/pull/74530#issuecomment-3737262229
...
### github-actions on 2026-01-12T07:51:35Z

URL: https://github.com/WordPress/gutenberg/pull/74530#issuecomment-3737269060
...
### jsnajdr on 2026-01-12T09:04:14Z

URL: https://github.com/WordPress/gutenberg/pull/74530#issuecomment-3737505142

> This looks fine as a temporary solution but we should probably also explore updating the build tooling or lint config to catch these issues early.

One idea is to do the resolving during transpilation. We already resolve relative imports from the same package. Additionally, we could also resolve imports from other packages. If the other package has an `exports` field, validate against that. If it doesn't have `exports`, resolve the full path.

## Review threads

### Review thread 1

#### anomiex on 2026-01-12T16:42:12Z

URL: https://github.com/WordPress/gutenberg/pull/74530#discussion_r2683062457
...
#### jsnajdr on 2026-01-12T16:53:37Z

URL: https://github.com/WordPress/gutenberg/pull/74530#discussion_r2683101846
Path: packages/date/src/index.ts
...
Oh, I forgot to mention why this one is special 🙂 It should be the consumer's responsibility to define where `moment-timezone/moment-timezone` points to. In Gutenberg, there is an alias rule that redirects this module to:
```
moment-timezone/builds/moment-timezone-with-data-1970-2030.js
```
Which loads a smaller, more relevant subset of timezone data.

Jetpack should do something similar.

#### anomiex on 2026-01-12T19:04:29Z

URL: https://github.com/WordPress/gutenberg/pull/74530#discussion_r2683524940
Path: packages/date/src/index.ts
...
If that's expected, it should probably be documented somewhere. 🙂

Also, too bad https://github.com/WordPress/gutenberg/issues/43533 seems to have stalled out. 😉
