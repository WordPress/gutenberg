...
type: pull_request
state: MERGED
merged_at: 2024-10-17T15:16:37Z
url: https://github.com/WordPress/gutenberg/pull/66198
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #66198: Tabs: fix animation timings

- URL: https://github.com/WordPress/gutenberg/pull/66198
- Author: ciampo
- Created: 2024-10-17T10:17:52Z
- Updated: 2024-10-17T15:17:03Z
- Comments: 2 of 2
- Review threads: 1 of 1
- Changed files: 3 of 3
- Diff: ../pr-diffs/66198.diff
...
This PR fixes a bug introduced in https://github.com/WordPress/gutenberg/pull/65387#discussion_r1795114256 related to `Tabs` indicator animation.
...
By applying the transition styles as originally intended — see https://github.com/WordPress/gutenberg/pull/65387#discussion_r1797694534
...
- in all modes, the focus ring showing the active tab should animate without a delay
- for vertical tabs with `selectOnMove={true}`, the caret should appear with a delay, basically waiting for the indicator to animate in place before fading in

## Screenshots or screencast <!-- if applicable -->

| Before (trunk) | After (this PR) |
|---|---|
| <video src="https://github.com/user-attachments/assets/7437a11f-b9dc-4667-8f8c-7b5fcfb2533f" /> | <video src="https://github.com/user-attachments/assets/bca7ae29-656d-4d42-9f9b-e2d923a4fedf" /> |

## Issue comments

### github-actions on 2024-10-17T10:23:43Z

URL: https://github.com/WordPress/gutenberg/pull/66198#issuecomment-2419143825
...
### github-actions on 2024-10-17T10:27:59Z

URL: https://github.com/WordPress/gutenberg/pull/66198#issuecomment-2419152297
...
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 255 kB | -6 B (0%) |
...
#### tyxla on 2024-10-17T10:53:08Z

URL: https://github.com/WordPress/gutenberg/pull/66198#discussion_r1804550996
Path: packages/block-editor/src/components/inserter/category-tabs/index.js
...
https://wpdirectory.net/search/01JAD1QEN6ZR91JYSVQPSHR50E

#### ciampo on 2024-10-17T15:04:36Z

URL: https://github.com/WordPress/gutenberg/pull/66198#discussion_r1804958536
Path: packages/block-editor/src/components/inserter/category-tabs/index.js
...
I should have mentioned — applying a `className` to `Tabs` doesn't make any sense because `Tabs` doesn't render any element to the DOM (and doesn't accept a `className` prop at all)

## Changed files

- packages/block-editor/src/components/inserter/category-tabs/index.js (MODIFIED, +0/-1)
