...
type: pull_request
state: MERGED
merged_at: 2024-10-17T09:35:49Z
url: https://github.com/WordPress/gutenberg/pull/66152
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #66152: ColorPalette: Prevent overflow of custom color button background

- URL: https://github.com/WordPress/gutenberg/pull/66152
- Author: t-hamano
- Created: 2024-10-16T01:37:57Z
- Updated: 2024-10-17T09:36:18Z
- Comments: 3 of 3
- Review threads: 2 of 2
- Changed files: 2 of 2
- Diff: ../pr-diffs/66152.diff
...
- The checkerboard pattern overflows at the corners
- The checkerboard pattern overlaps the button border
...
![before_1](https://github.com/user-attachments/assets/9ce28d5e-f36a-423b-a278-8bd64256aa0d)
![before_2](https://github.com/user-attachments/assets/526514f9-7d1e-4039-9a5f-d906a8749966)


### After

![after_1](https://github.com/user-attachments/assets/4c53c0db-5c10-459b-8989-317a9eeca1ea)
![after_2](https://github.com/user-attachments/assets/f43d11fd-f0f0-4182-9fbc-de9c4fd66442)

## Issue comments

### github-actions on 2024-10-16T01:48:32Z

URL: https://github.com/WordPress/gutenberg/pull/66152#issuecomment-2415559721
...
| :--- | :---: | :---: |
| `build/components/style-rtl.css` | 12.4 kB | +9 B (+0.07%) |
| `build/components/style.css` | 12.4 kB | +12 B (+0.1%) |
...
### github-actions on 2024-10-16T02:03:00Z

URL: https://github.com/WordPress/gutenberg/pull/66152#issuecomment-2415573842
...
### github-actions on 2024-10-17T09:21:40Z

URL: https://github.com/WordPress/gutenberg/pull/66152#issuecomment-2419012842

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 3d2b24db8f9f04bc1650a91ea878d37048e65ab1.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/11381692387
📝  Reported issues:
...
#### t-hamano on 2024-10-16T02:13:33Z

URL: https://github.com/WordPress/gutenberg/pull/66152#discussion_r1802237870
Path: packages/components/src/color-palette/style.scss

```diff
@@ -41,6 +41,7 @@ $border-as-box-shadow: inset 0 0 0 $border-width rgba(0, 0, 0, 0.2);
...
If we find this approach difficult to understand, we can also solve the problem by applying `overflow: hidden` to the button itself.

#### tyxla on 2024-10-16T07:16:03Z

URL: https://github.com/WordPress/gutenberg/pull/66152#discussion_r1802492313
Path: packages/components/src/color-palette/style.scss
...
It actually makes a lot of sense, especially if we use `$border-width` for the `top`/`right`/`bottom`/`left`.

### Review thread 2 (resolved)

#### tyxla on 2024-10-16T07:14:02Z

URL: https://github.com/WordPress/gutenberg/pull/66152#discussion_r1802489718
Path: packages/components/src/color-palette/style.scss

```diff
@@ -26,10 +26,10 @@ $border-as-box-shadow: inset 0 0 0 $border-width rgba(0, 0, 0, 0.2);
 	&::after {
 		content: "";
 		position: absolute;
-		top: 0;
...
#### ciampo on 2024-10-16T09:38:13Z

URL: https://github.com/WordPress/gutenberg/pull/66152#discussion_r1802748738
Path: packages/components/src/color-palette/style.scss
...
#### tyxla on 2024-10-16T09:41:28Z

URL: https://github.com/WordPress/gutenberg/pull/66152#discussion_r1802754078
Path: packages/components/src/color-palette/style.scss
...
- packages/components/src/color-palette/style.scss (MODIFIED, +2/-4)
