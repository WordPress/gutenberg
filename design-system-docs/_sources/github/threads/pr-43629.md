...
type: pull_request
state: MERGED
merged_at: 2022-08-29T08:47:24Z
url: https://github.com/WordPress/gutenberg/pull/43629
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Build Tooling","[Type] Performance","[Type] Code Quality","[Package] Components"]
---

# PR #43629: Lodash: Refactor away from `_.escapeRegExp()`

- URL: https://github.com/WordPress/gutenberg/pull/43629
- Author: tyxla
- Created: 2022-08-26T11:27:52Z
- Updated: 2022-08-29T09:03:17Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 8 of 8
- Diff: ../pr-diffs/43629.diff
...
### github-actions on 2022-08-26T11:37:31Z

URL: https://github.com/WordPress/gutenberg/pull/43629#issuecomment-1228386389
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 197 kB | +29 B (0%) |
...
### tyxla on 2022-08-29T08:47:16Z

URL: https://github.com/WordPress/gutenberg/pull/43629#issuecomment-1229967268

> The only difference I can see with respect to the lodash function is that [the lodash function will return `''` if the original string is `undefined`](https://github.com/lodash/lodash/blob/master/escapeRegExp.js#L23-L25), while the new version from this PR will just error.
> 
...
### ciampo on 2022-08-29T09:03:17Z

URL: https://github.com/WordPress/gutenberg/pull/43629#issuecomment-1229984300
...
- bin/plugin/commands/changelog.js (MODIFIED, +12/-1)
- packages/components/CHANGELOG.md (MODIFIED, +2/-0)
- packages/components/src/autocomplete/get-default-use-items.js (MODIFIED, +6/-1)
- packages/components/src/autocomplete/index.js (MODIFIED, +2/-1)
- packages/components/src/text-highlight/index.tsx (MODIFIED, +1/-5)
- packages/components/src/utils/strings.ts (MODIFIED, +11/-0)
- tools/webpack/blocks.js (MODIFIED, +11/-1)
