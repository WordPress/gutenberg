...
type: pull_request
state: MERGED
merged_at: 2026-05-05T11:42:37Z
url: https://github.com/WordPress/gutenberg/pull/77860
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Enhancement","[Focus] Accessibility (a11y)","[Package] UI"]
---

# PR #77860: UI: Use string label type for form controls

- URL: https://github.com/WordPress/gutenberg/pull/77860
- Author: mirka
- Created: 2026-04-30T19:45:43Z
- Updated: 2026-05-05T11:43:30Z
- Comments: 3 of 3
- Review threads: 1 of 1
- Changed files: 2 of 2
- Diff: ../pr-diffs/77860.diff

## Body

## What?
Updates the shared composed form control `label` prop type to `string`.

## Why?
The composed control API expects a plain accessible label. Rich label content is still possible through the lower-level `Field.Label` primitive. (And `Field.Label`, being a `label` element, does indeed need to continue supporting arbitrary children, for example `input`s.)

## Testing Instructions

`InputControl` should only accept strings as labels.

## Issue comments

### github-actions on 2026-04-30T19:54:31Z

URL: https://github.com/WordPress/gutenberg/pull/77860#issuecomment-4355706815
...
### github-actions on 2026-05-04T16:06:22Z

URL: https://github.com/WordPress/gutenberg/pull/77860#issuecomment-4372556207
...
### github-actions on 2026-05-04T16:48:41Z

URL: https://github.com/WordPress/gutenberg/pull/77860#issuecomment-4372805160

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 797a29d187d35103bd8f847d6a9d51eb47e47451.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/25329891216
📝  Reported issues:
...
#### ciampo on 2026-05-05T09:40:39Z

URL: https://github.com/WordPress/gutenberg/pull/77860#discussion_r3187445228
Path: packages/ui/src/form/types.ts
...
In the PR description you mention "Rich label content is still possible through the lower-level `Field.Label` primitive" — should we add a similar sentence to the JSDoc for this `label` prop and/or the JSDoc of the higher-level form components and/or create an Overview Storybook page for the higher-level form components (since we already have [one for the lower-level ones](https://wordpress.github.io/gutenberg/?path=/docs/design-system-components-form-primitives--overview)?)

#### mirka on 2026-05-05T11:41:22Z

URL: https://github.com/WordPress/gutenberg/pull/77860#discussion_r3188110025
Path: packages/ui/src/form/types.ts
...
I wouldn't say it's particularly useful information for consumers, since it's not like "rich label content is possible" means "feel free to put links and buttons in the label" which is almost always what people are trying to do 😅
