...
type: pull_request
state: MERGED
merged_at: 2023-02-03T13:55:18Z
url: https://github.com/WordPress/gutenberg/pull/47691
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #47691: Components: Remove unnecessary `act()` from `ToolsPanel` tests

- URL: https://github.com/WordPress/gutenberg/pull/47691
- Author: tyxla
- Created: 2023-02-02T13:50:01Z
- Updated: 2023-02-03T13:55:44Z
- Comments: 2 of 2
- Review threads: 2 of 2
- Changed files: 1 of 1
- Diff: ../pr-diffs/47691.diff
...
### github-actions on 2023-02-02T13:59:07Z

URL: https://github.com/WordPress/gutenberg/pull/47691#issuecomment-1413790307
...
| `build/edit-site/index.min.js` | 64.4 kB | +225 B (0%) |  |
| `build/edit-site/style-rtl.css` | 9.65 kB | +98 B (+1%) |  |
| `build/edit-site/style.css` | 9.65 kB | +96 B (+1%) |  |
...
### github-actions on 2023-02-02T14:19:57Z

URL: https://github.com/WordPress/gutenberg/pull/47691#issuecomment-1413820087

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 51c3c34d0c1907ec16fa5155602d759827b28c60.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/4084567770
📝  Reported issues:
...
#### ciampo on 2023-02-02T14:45:40Z

URL: https://github.com/WordPress/gutenberg/pull/47691#discussion_r1094626501
...
Do you think it's fine to setup `userEvent` inside a utility function, rather than once per test?

#### tyxla on 2023-02-03T11:55:42Z

URL: https://github.com/WordPress/gutenberg/pull/47691#discussion_r1095720922
Path: packages/components/src/tools-panel/test/index.js
...
Yes, I believe it's fine because a subsequent [`userEvent().setup()`](https://github.com/testing-library/user-event/blob/e93a5af30a2afd05e49abcb37db3f2f212fe0df7/src/setup/setup.ts#L82-L91) will reuse all from the prior call:

* [**Preparing the document**](https://github.com/testing-library/user-event/blob/main/src/document/prepareDocument.ts#L18) - basically adding some event listeners - it's done only once, and if `prepareDocument()` is called, event listeners will not be recreated.
* [**Attaching clipboard stub to window**](https://github.com/testing-library/user-event/blob/e93a5af30a2afd05e49abcb37db3f2f212fe0df7/src/utils/dataTransfer/Clipboard.ts#L113) - will reuse the same stub if it has already been created.
* **[Retrieving the document](https://github.com/testing-library/user-event/blob/e93a5af30a2afd05e49abcb37db3f2f212fe0df7/src/setup/setup.ts#L25)** - will reuse the same document object.
...
#### mirka on 2023-02-03T13:10:13Z

URL: https://github.com/WordPress/gutenberg/pull/47691#discussion_r1095783446
Path: packages/components/src/tools-panel/test/index.js
...
The return type annotation is wrong, triggering TS warnings on the usages with await ("'await' has no effect on the type of this expression").
...
```suggestion
 * @return {Promise<HTMLElement>} The menuButton.
 */
const openDropdownMenu = async () => {
	const user = userEvent.setup();
```

#### tyxla on 2023-02-03T13:24:37Z

URL: https://github.com/WordPress/gutenberg/pull/47691#discussion_r1095795955
Path: packages/components/src/tools-panel/test/index.js
...
That makes sense, thanks, @mirka! 🙌

## Changed files

- packages/components/src/tools-panel/test/index.js (MODIFIED, +6/-6)
