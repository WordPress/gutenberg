...
type: pull_request
state: MERGED
merged_at: 2026-03-13T17:43:56Z
url: https://github.com/WordPress/gutenberg/pull/76280
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Enhancement","[Package] UI"]
---

# PR #76280: @wordpress/ui: add Collapsible component

- URL: https://github.com/WordPress/gutenberg/pull/76280
- Author: ciampo
- Created: 2026-03-07T14:40:56Z
- Updated: 2026-03-13T17:44:40Z
- Comments: 4 of 4
- Review threads: 3 of 3
- Changed files: 12 of 12
- Diff: ../pr-diffs/76280.diff
...
### github-actions on 2026-03-07T15:05:16Z

URL: https://github.com/WordPress/gutenberg/pull/76280#issuecomment-4016666862
...
### github-actions on 2026-03-07T15:18:00Z

URL: https://github.com/WordPress/gutenberg/pull/76280#issuecomment-4016688376

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 6076f972ea193e81d31f98ec87fc26d2457b57d2.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/22820275747
📝  Reported issues:
- #48567 in `/test/e2e/specs/editor/various/autocomplete-and-mentions.spec.js`
...
### github-actions on 2026-03-08T11:36:07Z

URL: https://github.com/WordPress/gutenberg/pull/76280#issuecomment-4018890076
...
### ciampo on 2026-03-13T17:20:13Z

URL: https://github.com/WordPress/gutenberg/pull/76280#issuecomment-4056710531
...
#### copilot-pull-request-reviewer on 2026-03-07T15:21:17Z

URL: https://github.com/WordPress/gutenberg/pull/76280#discussion_r2899881662
...
The `render` prop's second `state` argument (provided by Base UI, e.g., `state.open`) is no longer accessible because the `ComponentProps` utility type replaces Base UI's render function signature with one that only accepts `(props)`. This forces the workaround of checking `String(props['aria-expanded']) === 'true'` instead of the cleaner `state.open`.

While this works, it's fragile because it relies on the presence and format of the `aria-expanded` attribute rather than semantic state. A simpler and more robust approach would be to directly check `props['aria-expanded']` as a boolean (e.g., `props['aria-expanded'] === true`), since Base UI passes it as a boolean value, rather than coercing through `String()`.
```suggestion
...
#### mirka on 2026-03-10T17:23:35Z

URL: https://github.com/WordPress/gutenberg/pull/76280#discussion_r2913304766
Path: packages/ui/src/collapsible-card/header.tsx
...
#### ciampo on 2026-03-13T16:51:39Z

URL: https://github.com/WordPress/gutenberg/pull/76280#discussion_r2932520221
Path: packages/ui/src/collapsible-card/header.tsx
...
Yup, it's the approach that I've taken in https://github.com/WordPress/gutenberg/pull/76265 anyway. I may keep the code in this PR as-is and apply that change in https://github.com/WordPress/gutenberg/pull/76265

### Review thread 3 (resolved)

#### mirka on 2026-03-10T17:25:51Z

URL: https://github.com/WordPress/gutenberg/pull/76280#discussion_r2913320450
Path: packages/ui/src/collapsible/panel.tsx
...
Unnecessary destructuring? Also happens in the other two components. (No strong opinion about the naming)

## Changed files

- packages/ui/CHANGELOG.md (MODIFIED, +1/-0)
- packages/ui/src/collapsible-card/content.tsx (MODIFIED, +1/-1)
- packages/ui/src/collapsible-card/header.tsx (MODIFIED, +13/-3)
- packages/ui/src/collapsible-card/root.tsx (MODIFIED, +1/-1)
- packages/ui/src/collapsible/index.ts (ADDED, +5/-0)
- packages/ui/src/collapsible/panel.tsx (ADDED, +16/-0)
- packages/ui/src/collapsible/root.tsx (ADDED, +15/-0)
- packages/ui/src/collapsible/stories/index.story.tsx (ADDED, +108/-0)
- packages/ui/src/collapsible/test/index.test.tsx (ADDED, +228/-0)
- packages/ui/src/collapsible/trigger.tsx (ADDED, +15/-0)
- packages/ui/src/collapsible/types.ts (ADDED, +24/-0)
