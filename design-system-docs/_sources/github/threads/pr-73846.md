...
type: pull_request
state: MERGED
merged_at: 2025-12-09T20:51:56Z
url: https://github.com/WordPress/gutenberg/pull/73846
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components","[Package] Editor","[Package] Block library","[Package] Patterns"]
---

# PR #73846: FormTokenField, FlatTermSelector: Hard deprecate bottom margin

- URL: https://github.com/WordPress/gutenberg/pull/73846
- Author: mirka
- Created: 2025-12-09T14:00:22Z
- Updated: 2025-12-09T20:52:38Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 18 of 18
- Diff: ../pr-diffs/73846.diff
...
### github-actions on 2025-12-09T14:05:48Z

URL: https://github.com/WordPress/gutenberg/pull/73846#issuecomment-3632442594

The following accounts have interacted with this PR and/or linked issues. I will continue to update these lists as activity occurs. You can also manually ask me to refresh this list by adding the `props-bot` label.

## Unlinked Accounts

The following contributors have not linked their GitHub and WordPress.org accounts: @Ugoku.
...
### github-actions on 2025-12-09T14:18:35Z

URL: https://github.com/WordPress/gutenberg/pull/73846#issuecomment-3632499833

**Size Change:** -271 B (-0.01%) 

**Total Size:** 2.57 MB

| Filename | Size | Change |
| :--- | :---: | :---: |
| `build/scripts/block-library/index.min.js` | 277 kB | -15 B (-0.01%) |
| `build/scripts/components/index.min.js` | 273 kB | -43 B (-0.02%) |
| `build/scripts/editor/index.min.js` | 284 kB | -208 B (-0.07%) |
| `build/scripts/patterns/index.min.js` | 7.87 kB | -5 B (-0.06%) |
...
- packages/block-library/src/query/edit/inspector-controls/author-control.js (MODIFIED, +0/-1)
- packages/block-library/src/query/edit/inspector-controls/format-controls.js (MODIFIED, +0/-1)
- packages/block-library/src/query/edit/inspector-controls/parent-control.js (MODIFIED, +0/-1)
- packages/block-library/src/query/edit/inspector-controls/taxonomy-controls.js (MODIFIED, +0/-1)
- packages/block-library/src/terms-query/edit/inspector-controls/include-control.js (MODIFIED, +0/-1)
- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/form-token-field/README.md (MODIFIED, +0/-2)
- packages/components/src/form-token-field/index.tsx (MODIFIED, +1/-13)
- packages/components/src/form-token-field/stories/index.story.tsx (MODIFIED, +0/-2)
- packages/components/src/form-token-field/test/index.tsx (MODIFIED, +0/-1)
- packages/components/src/form-token-field/types.ts (MODIFIED, +0/-6)
- packages/components/src/query-controls/index.tsx (MODIFIED, +0/-1)
- packages/components/src/validated-form-controls/components/form-token-field.tsx (MODIFIED, +2/-6)
- packages/editor/README.md (MODIFIED, +0/-1)
- packages/editor/src/components/post-publish-panel/maybe-tags-panel.js (MODIFIED, +1/-1)
- packages/editor/src/components/post-taxonomies/flat-term-selector.js (MODIFIED, +6/-27)
- packages/editor/src/components/post-taxonomies/index.js (MODIFIED, +1/-7)
- packages/patterns/src/components/category-selector.js (MODIFIED, +0/-1)
