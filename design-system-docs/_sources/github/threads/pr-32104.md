...
type: pull_request
state: MERGED
merged_at: 2021-05-24T23:42:18Z
url: https://github.com/WordPress/gutenberg/pull/32104
...
# PR #32104: components: Add missing Divider, Heading type reference in tsconfig

- URL: https://github.com/WordPress/gutenberg/pull/32104
- Author: sarayourfriend
- Created: 2021-05-21T16:29:41Z
- Updated: 2021-05-24T23:42:39Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 1 of 1
- Diff: ../pr-diffs/32104.diff
...
## Description
@ciampo pointed out that `Divider` was missing from the `components/tsconfig.json#includes` so this fixes that.
...
### github-actions on 2021-05-21T16:44:14Z

URL: https://github.com/WordPress/gutenberg/pull/32104#issuecomment-846095893
...
### ciampo on 2021-05-24T11:36:23Z

URL: https://github.com/WordPress/gutenberg/pull/32104#issuecomment-846983670

I did quick search matching `*.{ts,tsx}` files in `packages/components/src` and got this list:

```
./packages/components/src/ui/control-group/types.ts
./packages/components/src/ui/shortcut/index.ts
./packages/components/src/ui/tooltip/types.ts
./packages/components/src/ui/context/types.ts
./packages/components/src/ui/context/get-styled-class-name-from-key.ts
./packages/components/src/ui/context/polymorphic-component.ts
./packages/components/src/ui/card/types.ts
./packages/components/src/ui/control-label/types.ts
./packages/components/src/ui/surface/types.ts
./packages/components/src/ui/utils/get-valid-children.ts
./packages/components/src/ui/utils/space.ts
./packages/components/src/ui/utils/types.ts
./packages/components/src/ui/utils/font-size.ts
./packages/components/src/ui/utils/use-responsive-value.ts
./packages/components/src/ui/utils/get-high-dpi.ts
./packages/components/src/ui/popover/types.ts
./packages/components/src/ui/scrollable/types.ts
./packages/components/src/ui/elevation/types.ts
./packages/components/src/ui/form-group/types.ts
./packages/components/src/truncate/types.ts
./packages/components/src/z-stack/styles.ts
./packages/components/src/z-stack/index.ts
./packages/components/src/heading/component.ts
./packages/components/src/heading/hook.ts
./packages/components/src/heading/index.ts
./packages/components/src/utils/types.ts
./packages/components/src/spacer/component.ts
./packages/components/src/spacer/hook.ts
./packages/components/src/spacer/index.ts
./packages/components/src/divider/styles.ts
./packages/components/src/divider/index.ts
./packages/components/src/v-stack/types.ts
./packages/components/src/text/types.ts
./packages/components/src/text/get-line-height.ts
./packages/components/src/h-stack/types.ts
./packages/components/src/flex/context.ts
./packages/components/src/flex/types.ts
./packages/components/src/grid/types.ts
./packages/components/src/ui/shortcut/component.tsx
./packages/components/src/ui/utils/create-component.tsx
./packages/components/src/z-stack/component.tsx
./packages/components/src/divider/component.tsx
```

It looks like the `heading` folder is also missing in `tsconfig.json`, should we add it in this PR too?


Also, I noticed that `tsconfig.json` includes some folders that don't have any TypeScript code, like `src/animate/**/*` — what is the criterion around which folders should be listed? Since we're already excluding certain files/folders, why don't we include the whole `src` directory?

### sarayourfriend on 2021-05-24T14:22:05Z

URL: https://github.com/WordPress/gutenberg/pull/32104#issuecomment-847076818

> Also, I noticed that tsconfig.json includes some folders that don't have any TypeScript code, like src/animate/**/* — what is the criterion around which folders should be listed? Since we're already excluding certain files/folders, why don't we include the whole src directory?

When we include something in `includes` TypeScript will run the checker on the JavaScript _or_ TypeScript. If it's JavaScript it'll check it based on the JSDoc. So that's what's going on with Animate.

`heading` should be included, I'll update the PR to include it.
