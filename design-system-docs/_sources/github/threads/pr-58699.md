...
type: pull_request
state: MERGED
merged_at: 2024-02-06T13:51:47Z
url: https://github.com/WordPress/gutenberg/pull/58699
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components","has dev note"]
---

# PR #58699: CustomGradientPicker: Hard deprecate outer margins

- URL: https://github.com/WordPress/gutenberg/pull/58699
- Author: mirka
- Created: 2024-02-05T23:25:47Z
- Updated: 2024-02-26T21:39:58Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 7 of 7
- Diff: ../pr-diffs/58699.diff
...
Promotes `__nextHasNoMargin` on CustomGradientPicker to the default behavior.
...
In the Storybook for CustomGradientPicker, turn on the [margin checker tool](https://github.com/WordPress/gutenberg/assets/555336/f4fcf334-7c27-47ad-acba-e9b3a5f6f734) in the toolbar. The margin-free styles should now be the default, and the `__nextHasNoMargin` prop should not be listed in the props table.

✅ CustomGradientPicker is not directly used in the Gutenberg app.
...
### github-actions on 2024-02-05T23:26:06Z

URL: https://github.com/WordPress/gutenberg/pull/58699#issuecomment-1928487188
...
### github-actions on 2024-02-05T23:38:20Z

URL: https://github.com/WordPress/gutenberg/pull/58699#issuecomment-1928510111
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 226 kB | -38 B (0%) |
| `build/components/style-rtl.css` | 12 kB | -26 B (0%) |
| `build/components/style.css` | 12 kB | -27 B (0%) |
...
- packages/components/src/custom-gradient-picker/index.tsx (MODIFIED, +1/-21)
- packages/components/src/custom-gradient-picker/stories/index.story.tsx (MODIFIED, +0/-3)
- packages/components/src/custom-gradient-picker/style.scss (MODIFIED, +0/-7)
- packages/components/src/custom-gradient-picker/types.ts (MODIFIED, +2/-0)
- packages/components/src/gradient-picker/index.tsx (MODIFIED, +0/-1)
