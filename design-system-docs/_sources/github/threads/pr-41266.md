...
type: pull_request
state: MERGED
merged_at: 2022-05-25T05:22:41Z
url: https://github.com/WordPress/gutenberg/pull/41266
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #41266: Update @types/react-dates

- URL: https://github.com/WordPress/gutenberg/pull/41266
- Author: noisysocks
- Created: 2022-05-24T05:19:51Z
- Updated: 2022-05-25T05:23:08Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 5 of 5
- Diff: ../pr-diffs/41266.diff

## Body

## What?
Updates the version of `@types/react-dates` we're using.

## Why?
- Newer is always better [citation needed].
- Allows us to remove ugly `const TypedDayPickerSingleDateController` hack.
- Needed so that we can use `renderMonthElement` in https://github.com/WordPress/gutenberg/pull/41097.

## How?
- Bumped the version of `@types/react-dates` to correspond to version of `react-dates` that `@wordpress/components` uses.
- Had to also bump version of `moment` that `@wordpress/components` uses because `@types/react-dates` expects `moment.Moment` to have extra attributes that the older version of `moment` doesn't have.
...
### github-actions on 2022-05-24T05:29:42Z

URL: https://github.com/WordPress/gutenberg/pull/41266#issuecomment-1135427189
