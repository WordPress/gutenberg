...
type: pull_request
state: MERGED
merged_at: 2024-01-10T14:28:52Z
url: https://github.com/WordPress/gutenberg/pull/57547
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #57547: Update @ariakit/react to v0.3.12 and @ariakit/test to v0.3.7

- URL: https://github.com/WordPress/gutenberg/pull/57547
- Author: ciampo
- Created: 2024-01-04T14:09:57Z
- Updated: 2024-01-10T14:29:14Z
- Comments: 5 of 5
- Review threads: 2 of 2
- Changed files: 6 of 6
- Diff: ../pr-diffs/57547.diff
...
### github-actions on 2024-01-04T14:20:38Z

URL: https://github.com/WordPress/gutenberg/pull/57547#issuecomment-1877172293
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 235 kB | -31 B (0%) |
...
### ciampo on 2024-01-04T14:49:23Z

URL: https://github.com/WordPress/gutenberg/pull/57547#issuecomment-1877218992

A few unit tests broke — it looks like the failures are related to keyboard focus. I'll look into it

### ciampo on 2024-01-05T12:09:33Z

URL: https://github.com/WordPress/gutenberg/pull/57547#issuecomment-1878568490

The issues seemed related to the general incompatibility between `@testing-library` and `ariakit` components. Updating the failing unit tests to using `@ariakit/test` seems to fix the issue.

This PR is (once again) ready for review.

### diegohaz on 2024-01-05T20:52:27Z

URL: https://github.com/WordPress/gutenberg/pull/57547#issuecomment-1879243782
...
### ciampo on 2024-01-10T12:02:38Z

URL: https://github.com/WordPress/gutenberg/pull/57547#issuecomment-1884720190
...
#### tyxla on 2024-01-05T17:00:30Z

URL: https://github.com/WordPress/gutenberg/pull/57547#discussion_r1443124062
Path: packages/components/src/toggle-group-control/test/index.tsx

```diff
@@ -143,19 +140,29 @@ describe.each( [
...
Why do we need two `hover` calls?

#### ciampo on 2024-01-10T12:00:11Z

URL: https://github.com/WordPress/gutenberg/pull/57547#discussion_r1447293017
Path: packages/components/src/toggle-group-control/test/index.tsx
...
That is something that I derived from looking at how ariakit tests are written, and it is used to simulate hovering outside an element. I refactored it to a separate utility function to better clarify. [`ec59f15` (#57547)](https://github.com/WordPress/gutenberg/pull/57547/commits/ec59f150e0c9ea0143b43c37f542de047b87d59b)

### Review thread 2

#### tyxla on 2024-01-05T17:01:23Z

URL: https://github.com/WordPress/gutenberg/pull/57547#discussion_r1443124846
Path: packages/components/src/toggle-group-control/test/index.tsx
...
Is `waitForElementToBeRemoved()` a better possible alternative here?

#### ciampo on 2024-01-10T12:01:39Z

URL: https://github.com/WordPress/gutenberg/pull/57547#discussion_r1447294447
Path: packages/components/src/toggle-group-control/test/index.tsx
...
It is not, because it turns out that there is no need to wait for it — the tooltip gets removed immediately, so I refactored the code and removed the `waitFor` altogether. I also took the chance to refine some tooltip-related tests in `ToggleGroupControl` to actually test that the tooltip doesn't show even after its default delay has passed https://github.com/WordPress/gutenberg/pull/57547/commits/428809ba6a87e1bc9a263ee09fe42e64edffe74c

## Changed files

- package-lock.json (MODIFIED, +69/-83)
- package.json (MODIFIED, +1/-1)
- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/package.json (MODIFIED, +1/-1)
- packages/components/src/alignment-matrix-control/test/index.tsx (MODIFIED, +10/-16)
- packages/components/src/toggle-group-control/test/index.tsx (MODIFIED, +58/-45)
