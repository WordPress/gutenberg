...
type: pull_request
state: MERGED
merged_at: 2023-03-20T17:03:14Z
url: https://github.com/WordPress/gutenberg/pull/49116
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #49116: Fix misaligned textarea input control

- URL: https://github.com/WordPress/gutenberg/pull/49116
- Author: richtabor
- Created: 2023-03-15T20:20:04Z
- Updated: 2023-03-20T17:03:53Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/49116.diff
...
### github-actions on 2023-03-15T20:29:39Z

URL: https://github.com/WordPress/gutenberg/pull/49116#issuecomment-1470796398
...
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 197 kB | -91 B (0%) |
| `build/block-library/index.min.js` | 201 kB | +16 B (0%) |
| `build/blocks/index.min.js` | 51 kB | +19 B (0%) |
| `build/components/index.min.js` | 208 kB | +4 B (0%) |
...
### richtabor on 2023-03-16T21:19:04Z

URL: https://github.com/WordPress/gutenberg/pull/49116#issuecomment-1472756601

> Love it. Thank you Rich! Should we fix this awkward wrapping while we're in here?
...
### jasmussen on 2023-03-17T07:12:12Z

URL: https://github.com/WordPress/gutenberg/pull/49116#issuecomment-1473279694

> I think perhaps there's an opportunity to improve that description (in a follow-up). How often are images purely decorative and shouldn't have alt text?

Agree, here's an older tiny reduction I pondered:

<img width="332" alt="Screenshot 2023-03-17 at 08 09 02" src="https://user-images.githubusercontent.com/1204802/225836523-a27c3d57-aee6-4118-96a8-866c13b16b28.png">

I wonder if we could even do without the link. It seems an awkward way to have random external links in help text.

To answer your question to the best of my understanding, though, images are _very rarely_ [decorative](https://www.w3.org/WAI/tutorials/images/decorative/) to the point that they need no description. Things like separators or backgrounds below text. But when they _are_ decorative, it's important that the alt tag is empty, so we don't make a page overly verbose for a screen reader to read.

### github-actions on 2023-03-17T22:43:31Z

URL: https://github.com/WordPress/gutenberg/pull/49116#issuecomment-1474479745

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 4264d2d149fdfe927b04cf8bb2b81df6f6e2a1aa.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/4461392032
📝  Reported issues:
...
- packages/components/src/utils/input/input-control.js (MODIFIED, +1/-0)
