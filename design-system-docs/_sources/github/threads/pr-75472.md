...
type: pull_request
state: MERGED
merged_at: 2026-02-13T14:57:43Z
url: https://github.com/WordPress/gutenberg/pull/75472
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components","Storybook"]
---

# PR #75472: Story types: fix StoryFns used as React components

- URL: https://github.com/WordPress/gutenberg/pull/75472
- Author: jsnajdr
- Created: 2026-02-12T13:09:17Z
- Updated: 2026-02-13T14:58:38Z
- Comments: 2 of 2
- Review threads: 1 of 1
- Changed files: 3 of 3
- Diff: ../pr-diffs/75472.diff
...
### github-actions on 2026-02-12T13:09:30Z

URL: https://github.com/WordPress/gutenberg/pull/75472#issuecomment-3890868342
...
### github-actions on 2026-02-12T13:21:14Z

URL: https://github.com/WordPress/gutenberg/pull/75472#issuecomment-3890924297
...
#### aduth on 2026-02-12T19:17:58Z

URL: https://github.com/WordPress/gutenberg/pull/75472#discussion_r2800643963
Path: packages/components/src/color-palette/stories/index.story.tsx
...
#### jsnajdr on 2026-02-13T09:19:23Z

URL: https://github.com/WordPress/gutenberg/pull/75472#discussion_r2803149315
Path: packages/components/src/color-palette/stories/index.story.tsx
...
I don't really see the opportunities for simplification. The only common point for all `color-palette` stories is the `render: Template` line. Then two stories share the "red/white/blue" color options, but that's just two stories, other stories use different colors.

So, in the end, it would be replacing one line (`render: Template`) with another (`...Default`). And I think the explicit `render` is better, it makes the stories self-contained without extra verbosity, and I don't need to scroll elsewhere to figure out what `Default` is.

The other stories in other files already use `...Default` or `...Default.args` where useful.

#### aduth on 2026-02-13T14:50:19Z

URL: https://github.com/WordPress/gutenberg/pull/75472#discussion_r2804605232
Path: packages/components/src/color-palette/stories/index.story.tsx
...
Hm, we should probably get some consensus and consistency on whether we want to optimize for stories being self-contained, or stories building on the default in a more inheritance-like model. There's quite a few examples of the latter.

## Changed files

- packages/components/src/color-palette/stories/index.story.tsx (MODIFIED, +56/-48)
- packages/components/src/font-size-picker/stories/index.story.tsx (MODIFIED, +133/-125)
- packages/components/src/gradient-picker/stories/index.story.tsx (MODIFIED, +48/-42)
