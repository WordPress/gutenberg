...
type: pull_request
state: MERGED
merged_at: 2026-03-31T17:33:26Z
url: https://github.com/WordPress/gutenberg/pull/76740
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Focus] Accessibility (a11y)","[Package] Components"]
---

# PR #76740: ToggleGroupControl: Fix accessible association of `help` text

- URL: https://github.com/WordPress/gutenberg/pull/76740
- Author: mirka
- Created: 2026-03-20T21:40:28Z
- Updated: 2026-03-31T17:34:18Z
- Comments: 4 of 4
- Review threads: 3 of 3
- Changed files: 7 of 7
- Diff: ../pr-diffs/76740.diff

## Body

## What?

Fix the `help` prop on `ToggleGroupControl` so that it is programmatically associated with the control via `aria-describedby`. Also refactor the component to use `useBaseControlProps` more fully, delegating label and help rendering to `BaseControl`.

## Why?

The `help` text was being rendered visually but had no accessible association with the radiogroup (or button group, in the `isDeselectable` case). Screen reader users would not hear the help text when interacting with the control.

The component was also hand-rolling its `hideLabelFromVision` logic and not using the `id` from `useBaseControlProps`, duplicating what `BaseControl` already provides.

## How?

- Call `useBaseControlProps` with `id`, `help`, `label`, and `hideLabelFromVision`, and spread the returned props onto `BaseControl` and the inner control.
- This gives the help element an `id` and adds `aria-describedby` to the radiogroup/button group.
- `BaseControl` now handles label rendering (including the `hideLabelFromVision` case), removing the need for the manual `VisualLabelWrapper` and `BaseControl.VisualLabel` usage.
- Remove the now-unused `VisualLabelWrapper` styled component (and the `styled` import from Emotion).
...
- Label is rendered visually by default
- Label still provides an accessible name when `hideLabelFromVision` is true
- `help` text is associated with the `radiogroup` via `aria-describedby`
- `help` text is associated with the `group` via `aria-describedby` when `isDeselectable`

### Manual

1. Open the `ToggleGroupControl` story in Storybook.
2. Set the `help` prop to some text.
3. Inspect the radiogroup element and confirm it has `aria-describedby` pointing to the help text element.
...
### github-actions on 2026-03-20T21:45:17Z

URL: https://github.com/WordPress/gutenberg/pull/76740#issuecomment-4101116646
...
### github-actions on 2026-03-20T21:57:26Z

URL: https://github.com/WordPress/gutenberg/pull/76740#issuecomment-4101159617
...
### github-actions on 2026-03-20T22:12:32Z

URL: https://github.com/WordPress/gutenberg/pull/76740#issuecomment-4101213600

<!-- flaky-tests-report-comment -->
**Flaky tests detected in d36bc76e25c5cbbe2d727508bcf79253920d4f30.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/23802187611
📝  Reported issues:
...
### mirka on 2026-03-31T14:20:22Z

URL: https://github.com/WordPress/gutenberg/pull/76740#issuecomment-4163013649

> I realised we don't set the `id` to the `View` when `ToggleGroupControl` is used as a button group.

Good catch, fixed in a56651ca14282c841d09f73011c2c2c0c5479137

## Review threads

### Review thread 1

#### ciampo on 2026-03-26T10:55:06Z

URL: https://github.com/WordPress/gutenberg/pull/76740#discussion_r2993985312
...
#### mirka on 2026-03-31T14:16:34Z

URL: https://github.com/WordPress/gutenberg/pull/76740#discussion_r3016224298
Path: packages/components/src/toggle-group-control/toggle-group-control/component.tsx
...
#### ciampo on 2026-03-26T10:56:57Z

URL: https://github.com/WordPress/gutenberg/pull/76740#discussion_r2993994424
Path: packages/components/src/toggle-group-control/toggle-group-control/component.tsx
...
Can we remove `VisualLabelWrapper` without causing a regression (see [original reson why it was added](https://github.com/WordPress/gutenberg/pull/43331#discussion_r948105997))

#### mirka on 2026-03-31T13:32:39Z

URL: https://github.com/WordPress/gutenberg/pull/76740#discussion_r3015946008
Path: packages/components/src/toggle-group-control/toggle-group-control/component.tsx
...
Yes, confirmed horizontal alignment is correct.

<img width="517" height="97" alt="Three different controls in a row" src="https://github.com/user-attachments/assets/b9918396-0dcb-49c6-b22d-df391df64cdb" />

### Review thread 3

#### ciampo on 2026-03-26T10:59:19Z

URL: https://github.com/WordPress/gutenberg/pull/76740#discussion_r2994006033
...
#### mirka on 2026-03-31T14:20:00Z

URL: https://github.com/WordPress/gutenberg/pull/76740#discussion_r3016245379
Path: packages/components/src/toggle-group-control/stories/index.story.tsx
...
- packages/components/src/toggle-group-control/test/__snapshots__/index.tsx.snap (MODIFIED, +124/-164)
...
- packages/components/src/toggle-group-control/toggle-group-control/styles.ts (MODIFIED, +0/-6)
