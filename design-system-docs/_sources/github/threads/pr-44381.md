...
type: pull_request
state: MERGED
merged_at: 2022-09-28T18:34:59Z
url: https://github.com/WordPress/gutenberg/pull/44381
...
# PR #44381: Components: refactor `SearchControl` native files to ignore `exhaustive-deps`

- URL: https://github.com/WordPress/gutenberg/pull/44381
- Author: chad1008
- Created: 2022-09-22T16:25:22Z
- Updated: 2022-09-28T18:35:39Z
- Comments: 1 of 1
- Review threads: 1 of 1
- Changed files: 2 of 2
- Diff: ../pr-diffs/44381.diff

## Body

## What?
Updates the `SearchControl` native files currently throwing warnings to ignore the `exhaustive-deps` eslint rule
...
## How?
Added inline ignore comments to all `exhaustive-deps` warnings in the`SearchControl` component directory

## Issue comments

### github-actions on 2022-09-22T16:40:13Z

URL: https://github.com/WordPress/gutenberg/pull/44381#issuecomment-1255282500
...
#### ciampo on 2022-09-23T12:44:46Z

URL: https://github.com/WordPress/gutenberg/pull/44381#discussion_r978597780
...
We'll need to move this CHANGELOG entry to the `Unreleased` section before merging

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/search-control/index.native.js (MODIFIED, +6/-0)
