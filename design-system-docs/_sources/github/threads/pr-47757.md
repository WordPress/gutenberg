...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/47757
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #47757: ToolsPanel: refactor unit tests and stories to TypeScript

- URL: https://github.com/WordPress/gutenberg/pull/47757
- Author: ciampo
- Created: 2023-02-04T17:47:51Z
- Updated: 2025-02-10T16:45:39Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 8 of 8
- Diff: ../pr-diffs/47757.diff
...
Refactor `ToolsPanel` unit tests to TypeScript, and tweak the component's types in the process.

## Why?
<!-- Why is this PR necessary? What problem is it solving? Reference any existing previous issue(s) or PR(s), but please add a short summary here, too -->

See #35744 for more details.

## How?
<!-- How is your PR addressing the issue at hand? What are the implementation details? -->

For more details, review commit-by-commit (each commit message should be quite clear about what and why something changed).

I will also leave a few comments through self-reviewing this PR to flag the most notable points.
...
- tests pass
- components works as expected in Storybook and in the editor (e.g block controls in the sidebar)

## Issue comments

### github-actions on 2023-02-05T22:47:49Z

URL: https://github.com/WordPress/gutenberg/pull/47757#issuecomment-1418286126
...
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 192 kB | +243 B (0%) |
...
### github-actions on 2023-02-05T23:06:50Z

URL: https://github.com/WordPress/gutenberg/pull/47757#issuecomment-1418290548

<!-- flaky-tests-report-comment -->
**Flaky tests detected in d60a277181fdf5c6053872dce71c5bb849ae5f33.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/4098804295
📝  Reported issues:
- #35387 in `/test/e2e/specs/editor/various/preview.spec.js`

### ciampo on 2023-02-09T19:35:41Z

URL: https://github.com/WordPress/gutenberg/pull/47757#issuecomment-1424710705

Will close this PR, and open two separate ones:
- type inconsistencies + Storybook
- unit tests
...
- packages/components/src/tools-panel/stories/index.tsx (RENAMED, +144/-51)
- packages/components/src/tools-panel/stories/utils/tools-panel-with-item-group-slot.tsx (RENAMED, +68/-15)
- packages/components/src/tools-panel/test/index.tsx (RENAMED, +88/-60)
- packages/components/src/tools-panel/tools-panel-item/README.md (MODIFIED, +5/-3)
- packages/components/src/tools-panel/tools-panel-item/hook.ts (MODIFIED, +4/-2)
- packages/components/src/tools-panel/tools-panel/README.md (MODIFIED, +3/-1)
- packages/components/src/tools-panel/tools-panel/hook.ts (MODIFIED, +2/-2)
- packages/components/src/tools-panel/types.ts (MODIFIED, +22/-12)
