...
type: pull_request
state: MERGED
merged_at: 2021-05-06T14:15:16Z
url: https://github.com/WordPress/gutenberg/pull/31509
matched_labels: ["[Package] Components","[Feature] Component System"]
all_labels: ["[Package] Components","[Feature] Component System"]
---

# PR #31509: components: Add Spacer

- URL: https://github.com/WordPress/gutenberg/pull/31509
- Author: sarayourfriend
- Created: 2021-05-05T16:01:33Z
- Updated: 2021-05-06T14:26:43Z
- Comments: 1 of 1
- Review threads: 4 of 4
- Changed files: 9 of 9
- Diff: ../pr-diffs/31509.diff
...
## Description
Adds a `Spacer` component. This component is meant to be composed with `HStack` and `VStack` as well as on its own.

## How has this been tested?
Unit tests pass and have the expected style snapshot values applied.
...
### github-actions on 2021-05-05T16:12:07Z

URL: https://github.com/WordPress/gutenberg/pull/31509#issuecomment-832821449
...
| `build/block-editor/index.js` | 116 kB | +4 B (0%) |
| `build/block-library/index.js` | 142 kB | +2 B (0%) |
| `build/blocks/index.js` | 47 kB | +59 B (0%) |
| `build/components/index.js` | 187 kB | +302 B (0%) |
| `build/compose/index.js` | 9.96 kB | -2 B (0%) |
| `build/core-data/index.js` | 12.1 kB | -5 B (0%) |
| `build/customize-widgets/index.js` | 5.83 kB | +3 B (0%) |
| `build/date/index.js` | 31.8 kB | -2 B (0%) |
| `build/edit-navigation/index.js` | 13.7 kB | +1 B (0%) |
| `build/edit-post/index.js` | 333 kB | -172 B (0%) |
| `build/edit-site/index.js` | 26.2 kB | +12 B (0%) |
| `build/edit-widgets/index.js` | 12.6 kB | +3 B (0%) |
...
#### gziolo on 2021-05-06T06:38:58Z

URL: https://github.com/WordPress/gutenberg/pull/31509#discussion_r627117390
Path: packages/components/src/spacer/README.md
...
#### gziolo on 2021-05-06T06:39:40Z

URL: https://github.com/WordPress/gutenberg/pull/31509#discussion_r627117948
Path: packages/components/src/spacer/README.md
...
#### gziolo on 2021-05-06T06:44:00Z

URL: https://github.com/WordPress/gutenberg/pull/31509#discussion_r627121661
Path: packages/components/src/spacer/README.md
...
The names of all props here don't follow WordPress Coding Standards:
...
Is there any strong argument towards going with all those short names?

### Review thread 4 (resolved)

#### gziolo on 2021-05-06T06:44:36Z

URL: https://github.com/WordPress/gutenberg/pull/31509#discussion_r627122153
Path: packages/components/src/spacer/index.ts
...
The export could be more specific like in other places:
...
- packages/components/src/spacer/README.md (ADDED, +118/-0)
- packages/components/src/spacer/component.ts (ADDED, +36/-0)
- packages/components/src/spacer/hook.ts (ADDED, +163/-0)
- packages/components/src/spacer/index.ts (ADDED, +3/-0)
- packages/components/src/spacer/test/__snapshots__/index.js.snap (ADDED, +199/-0)
- packages/components/src/spacer/test/index.js (ADDED, +118/-0)
