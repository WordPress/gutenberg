...
type: pull_request
state: MERGED
merged_at: 2026-04-09T08:46:47Z
url: https://github.com/WordPress/gutenberg/pull/77148
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #77148: Components: update React function names for better ESLint detection

- URL: https://github.com/WordPress/gutenberg/pull/77148
- Author: jsnajdr
- Created: 2026-04-08T13:07:33Z
- Updated: 2026-04-09T08:50:27Z
- Comments: 7 of 7
- Review threads: 0 of 0
- Changed files: 6 of 6
- Diff: ../pr-diffs/77148.diff
...
### github-actions on 2026-04-08T13:16:59Z

URL: https://github.com/WordPress/gutenberg/pull/77148#issuecomment-4206510132
...
### github-actions on 2026-04-08T13:19:40Z

URL: https://github.com/WordPress/gutenberg/pull/77148#issuecomment-4206527549
...
| :--- | :---: | :---: |
| `build/scripts/edit-site/index.min.js` | 262 kB | -84 B (-0.03%) |
| `build/scripts/editor/index.min.js` | 412 kB | -7 B (0%) |
| `build/styles/edit-site/style-rtl.css` | 20.9 kB | -11 B (-0.05%) |
| `build/styles/edit-site/style-rtl.min.css` | 17 kB | -8 B (-0.05%) |
| `build/styles/edit-site/style.css` | 20.9 kB | -9 B (-0.04%) |
| `build/styles/edit-site/style.min.css` | 17 kB | -8 B (-0.05%) |
| `build/styles/editor/style-rtl.css` | 26.6 kB | -10 B (-0.04%) |
| `build/styles/editor/style-rtl.min.css` | 22.5 kB | -9 B (-0.04%) |
| `build/styles/editor/style.css` | 26.7 kB | -9 B (-0.03%) |
| `build/styles/editor/style.min.css` | 22.5 kB | -9 B (-0.04%) |
...
### github-actions on 2026-04-08T13:37:47Z

URL: https://github.com/WordPress/gutenberg/pull/77148#issuecomment-4206646067

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 5c5e1a45ba136d772da2428d210dfaae2b9e5223.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/24178774005
📝  Reported issues:
- #36123 in `/test/e2e/specs/editor/blocks/classic.spec.js`
- #68892 in `/test/e2e/specs/site-editor/homepage-settings.spec.js`

### ciampo on 2026-04-08T14:46:28Z

URL: https://github.com/WordPress/gutenberg/pull/77148#issuecomment-4207127876

Trying to remember why I prefixed that component with `_`, I _think_ it was to implicitly flag that it was an internal component and wasn't meant to be used directly (but only as the underlying common implementation of the two different custom select controls). No blockers on my end :)

### manzoorwanijk on 2026-04-09T06:24:37Z

URL: https://github.com/WordPress/gutenberg/pull/77148#issuecomment-4211912031

I guess this is ready to be shipped?

### Mamaduka on 2026-04-09T06:54:03Z

URL: https://github.com/WordPress/gutenberg/pull/77148#issuecomment-4212061524

Yeah, it should be good to merge. Not sure if similar minor internal changes warrant a changelog entry.

### jsnajdr on 2026-04-09T07:46:09Z

URL: https://github.com/WordPress/gutenberg/pull/77148#issuecomment-4212464350
...
- packages/components/src/custom-select-control-v2/custom-select.tsx (MODIFIED, +4/-4)
- packages/components/src/custom-select-control-v2/index.tsx (MODIFIED, +2/-2)
- packages/components/src/custom-select-control-v2/types.ts (MODIFIED, +1/-1)
- packages/components/src/custom-select-control/index.tsx (MODIFIED, +3/-3)
- packages/components/src/sandbox/index.native.js (MODIFIED, +1/-1)
