...
type: pull_request
state: MERGED
merged_at: 2026-05-19T17:00:30Z
url: https://github.com/WordPress/gutenberg/pull/78442
matched_labels: ["[Package] Components","[Package] UI"]
all_labels: ["[Type] Code Quality","[Package] Components","[Package] UI"]
---

# PR #78442: UI Tabs: Recommend component for use

- URL: https://github.com/WordPress/gutenberg/pull/78442
- Author: mirka
- Created: 2026-05-19T14:29:44Z
- Updated: 2026-05-19T19:33:01Z
- Comments: 3 of 3
- Review threads: 1 of 1
- Changed files: 5 of 5
- Diff: ../pr-diffs/78442.diff
...
Marks the `Tabs` component from `@wordpress/ui` as recommended for use.

## Why?
To encourage use of the new `@wordpress/ui` Tabs component instead of the older tabs components from `@wordpress/components`.

## Testing Instructions

See the Storybook guidance.

## Issue comments

### github-actions on 2026-05-19T14:58:42Z

URL: https://github.com/WordPress/gutenberg/pull/78442#issuecomment-4489055525
...
| :--- | :---: | :---: |
| `build/scripts/block-editor/index.min.js` | 346 kB | -17 B (0%) |
...
### github-actions on 2026-05-19T15:26:14Z

URL: https://github.com/WordPress/gutenberg/pull/78442#issuecomment-4489317569
...
### github-actions on 2026-05-19T15:39:38Z

URL: https://github.com/WordPress/gutenberg/pull/78442#issuecomment-4489440722

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 98e794a64272ca045aedfdcd3f315a344d00fa24.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/26106003980
📝  Reported issues:
...
#### mirka on 2026-05-19T15:06:10Z

URL: https://github.com/WordPress/gutenberg/pull/78442#discussion_r3267363513
Path: packages/eslint-plugin/rules/use-recommended-components.js

```diff
@@ -50,6 +51,8 @@ const DENYLIST = {
 		CardHeader:
...
This won't actually work yet — I'll add private component support to the lint rule as a follow up.

#### mirka on 2026-05-19T19:33:01Z

URL: https://github.com/WordPress/gutenberg/pull/78442#discussion_r3269075220
Path: packages/eslint-plugin/rules/use-recommended-components.js
...
Support added in #78451

## Changed files

- packages/components/src/tab-panel/stories/index.story.tsx (MODIFIED, +2/-13)
- packages/components/src/tabs/stories/index.story.tsx (MODIFIED, +2/-13)
- packages/eslint-plugin/rules/__tests__/use-recommended-components.js (MODIFIED, +12/-1)
- packages/eslint-plugin/rules/use-recommended-components.js (MODIFIED, +3/-0)
- packages/ui/src/tabs/stories/index.story.tsx (MODIFIED, +2/-2)
