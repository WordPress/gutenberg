...
type: pull_request
state: MERGED
merged_at: 2023-03-17T16:28:54Z
url: https://github.com/WordPress/gutenberg/pull/49146
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components"]
---

# PR #49146: CustomGradientPicker: improve initial state UI

- URL: https://github.com/WordPress/gutenberg/pull/49146
- Author: ciampo
- Created: 2023-03-16T19:01:46Z
- Updated: 2023-03-17T16:29:22Z
- Comments: 2 of 2
- Review threads: 2 of 2
- Changed files: 5 of 5
- Diff: ../pr-diffs/49146.diff
...
### github-actions on 2023-03-16T19:20:46Z

URL: https://github.com/WordPress/gutenberg/pull/49146#issuecomment-1472613647
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 208 kB | +39 B (0%) |
...
### github-actions on 2023-03-17T16:12:55Z

URL: https://github.com/WordPress/gutenberg/pull/49146#issuecomment-1474073782

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 3e2dea4a2cc23fc9fc21999c761d45e18b92c897.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/4449184008
📝  Reported issues:
...
#### chad1008 on 2023-03-17T13:20:48Z

URL: https://github.com/WordPress/gutenberg/pull/49146#discussion_r1140229431
...
#### chad1008 on 2023-03-17T13:35:12Z

URL: https://github.com/WordPress/gutenberg/pull/49146#discussion_r1140246618
Path: packages/components/src/custom-gradient-picker/index.tsx

```diff
@@ -148,19 +147,19 @@ export function CustomGradientPicker( {
 	onChange,
...
I notice you've changed this comment, but the function returning `gradientAST` is still named `getGradientAstWithDefault`. Did you mean to rename the function now that it's handling default gradients differently?

#### ciampo on 2023-03-17T14:51:54Z

URL: https://github.com/WordPress/gutenberg/pull/49146#discussion_r1140338805
Path: packages/components/src/custom-gradient-picker/index.tsx
...
- packages/components/src/custom-gradient-picker/gradient-bar/index.tsx (MODIFIED, +7/-1)
- packages/components/src/custom-gradient-picker/index.tsx (MODIFIED, +3/-4)
- packages/components/src/custom-gradient-picker/style.scss (MODIFIED, +25/-4)
- packages/components/src/custom-gradient-picker/utils.ts (MODIFIED, +10/-6)
