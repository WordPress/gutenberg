...
type: pull_request
state: MERGED
merged_at: 2022-08-26T08:18:10Z
url: https://github.com/WordPress/gutenberg/pull/43604
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Feature] UI Components","[Package] Components"]
---

# PR #43604: Guide: use `code` instead of `keyCode` for keyboard events

- URL: https://github.com/WordPress/gutenberg/pull/43604
- Author: ciampo
- Created: 2022-08-25T11:35:23Z
- Updated: 2022-08-26T08:18:44Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 4 of 4
- Diff: ../pr-diffs/43604.diff
...
- Refactor the `Guide` component to rely on `code` instead of `keyCode` for keyboard events
- add `preventDefault` to the event callback, so that pressing arrows doesn't scroll the page
- Add unit test for keyboard interactions
- Move page control unit tests to the same file, rewrite them in order to test for user interactions (and not implementation details)
...
On Storybook, make sure that the `Guide` component:
 - navigates through pages 
 - narrow the page until a horizontal scrollbar appears, and make sure that navigating through the pages with arrow keys doesn't scroll the page's contents

## Issue comments

### github-actions on 2022-08-25T11:55:47Z

URL: https://github.com/WordPress/gutenberg/pull/43604#issuecomment-1227159585
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 197 kB | +3 B (0%) |
...
- packages/components/src/guide/index.js (MODIFIED, +6/-3)
- packages/components/src/guide/test/index.js (MODIFIED, +138/-1)
- packages/components/src/guide/test/page-control.js (DELETED, +0/-40)
