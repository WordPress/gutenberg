...
type: pull_request
state: MERGED
merged_at: 2023-01-06T19:04:00Z
url: https://github.com/WordPress/gutenberg/pull/46774
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components"]
---

# PR #46774: ResizableBox: Remove knobs in stories

- URL: https://github.com/WordPress/gutenberg/pull/46774
- Author: mirka
- Created: 2022-12-23T18:06:18Z
- Updated: 2023-01-06T19:08:04Z
- Comments: 3 of 3
- Review threads: 5 of 5
- Changed files: 4 of 4
- Diff: ../pr-diffs/46774.diff
...
Remove the Knobs add-on from `ResizableBox` stories.
...
2. Go to the `ResizableBox` component.
...
### github-actions on 2022-12-23T18:15:38Z

URL: https://github.com/WordPress/gutenberg/pull/46774#issuecomment-1364164613
...
| :--- | :---: | :---: | :---: |
| `build/block-editor/index.min.js` | 182 kB | +35 B (0%) |  |
| `build/block-editor/style-rtl.css` | 14.8 kB | +22 B (0%) |  |
| `build/block-editor/style.css` | 14.8 kB | +22 B (0%) |  |
| `build/block-library/index.min.js` | 198 kB | +346 B (0%) |  |
...
| `build/edit-navigation/style-rtl.css` | 4.12 kB | +9 B (0%) |  |
| `build/edit-navigation/style.css` | 4.13 kB | +9 B (0%) |  |
| `build/edit-post/index.min.js` | 34.6 kB | -207 B (-1%) |  |
| `build/edit-post/style-rtl.css` | 7.45 kB | +5 B (0%) |  |
| `build/edit-post/style.css` | 7.44 kB | +22 B (0%) |  |
| `build/edit-site/index.min.js` | 64.9 kB | -224 B (0%) |  |
| `build/edit-site/style-rtl.css` | 9.06 kB | +4 B (0%) |  |
| `build/edit-site/style.css` | 9.07 kB | +5 B (0%) |  |
| `build/edit-widgets/style-rtl.css` | 4.46 kB | +8 B (0%) |  |
| `build/edit-widgets/style.css` | 4.47 kB | +7 B (0%) |  |
...
### mirka on 2023-01-05T17:41:12Z

URL: https://github.com/WordPress/gutenberg/pull/46774#issuecomment-1372529875

> With respect to the version on trunk, the `enable` prop is not always showing (it's only showing in the specific storybook example) — should we look into having it always visible in the component controls?

✅ Done in 7cd7eab

### github-actions on 2023-01-05T18:37:13Z

URL: https://github.com/WordPress/gutenberg/pull/46774#issuecomment-1372590886

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 4cc4395c198e08dfef902164364da1df6f180d61.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/3857597185
📝  Reported issues:
...
#### mirka on 2022-12-23T18:07:13Z

URL: https://github.com/WordPress/gutenberg/pull/46774#discussion_r1056539663
...
#### mirka on 2022-12-23T18:09:00Z

URL: https://github.com/WordPress/gutenberg/pull/46774#discussion_r1056540219
Path: packages/components/src/resizable-box/stories/index.tsx
...
#### mirka on 2022-12-23T18:09:36Z

URL: https://github.com/WordPress/gutenberg/pull/46774#discussion_r1056540426
Path: packages/components/src/resizable-box/stories/index.js
...
`content` is not an actual component prop.

### Review thread 4

#### ciampo on 2023-01-05T12:18:37Z

URL: https://github.com/WordPress/gutenberg/pull/46774#discussion_r1062412563
Path: packages/components/src/resizable-box/stories/index.tsx
...
#### mirka on 2023-01-05T17:53:31Z

URL: https://github.com/WordPress/gutenberg/pull/46774#discussion_r1062740835
Path: packages/components/src/resizable-box/stories/index.tsx
...
However, all the props coming from the upstream [`re-resizable`](https://github.com/WordPress/gutenberg/blob/d3eaa6cacb4038fd2cab7f49ef4444e64ba6e6eb/packages/components/src/resizable-box/index.tsx#L90) are not shown at all 🤔 So I think what will happen is that in the full TypeScript migration, we'll decide which ones of the upstream props are noteworthy, and add our own typings/descriptions for them so they'll be shown in the Storybook props table. For all the other upstream props, the main component description will nudge people toward the `re-resizable` docs as written in the [readme](https://github.com/WordPress/gutenberg/blob/trunk/packages/components/src/resizable-box/README.md).

#### ciampo on 2023-01-05T20:20:24Z

URL: https://github.com/WordPress/gutenberg/pull/46774#discussion_r1062862735
Path: packages/components/src/resizable-box/stories/index.tsx
...
#### ciampo on 2023-01-05T20:19:20Z

URL: https://github.com/WordPress/gutenberg/pull/46774#discussion_r1062861929
Path: packages/components/src/resizable-box/stories/index.tsx
...
#### mirka on 2023-01-06T18:33:05Z

URL: https://github.com/WordPress/gutenberg/pull/46774#discussion_r1063682001
Path: packages/components/src/resizable-box/stories/index.tsx
...
- packages/components/src/resizable-box/README.md (MODIFIED, +2/-2)
- packages/components/src/resizable-box/index.tsx (MODIFIED, +7/-6)
- packages/components/src/resizable-box/stories/index.js (DELETED, +0/-97)
- packages/components/src/resizable-box/stories/index.tsx (ADDED, +92/-0)
