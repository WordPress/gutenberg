...
type: pull_request
state: MERGED
merged_at: 2025-07-01T12:17:05Z
url: https://github.com/WordPress/gutenberg/pull/70299
matched_labels: ["Design System"]
all_labels: ["[Type] Enhancement","[Package] Icons","Design System"]
---

# PR #70299: Update icons: Help, PlusCircle, Typography

- URL: https://github.com/WordPress/gutenberg/pull/70299
- Author: jameskoster
- Created: 2025-06-03T12:15:58Z
- Updated: 2025-07-01T12:17:40Z
- Comments: 9 of 9
- Review threads: 2 of 2
- Changed files: 4 of 4
- Diff: ../pr-diffs/70299.diff
...
## Why?
* Help and PlusCircle are updated to dimensionally align with other circular icons
* Typography path is tidied up so that it renders better at larger sizes

## Testing Instructions
1. `npm run storybook`
2. Check the new icons appear as expected

## Screenshots
<img width="723" alt="icons" src="https://github.com/user-attachments/assets/d10a3966-66ca-4559-af0f-f5de2d8cb160" />

## Issue comments

### github-actions on 2025-06-03T12:16:09Z

URL: https://github.com/WordPress/gutenberg/pull/70299#issuecomment-2934962522
...
- **Labels found**: [Package] Icons, Design System.
...
URL: https://github.com/WordPress/gutenberg/pull/70299#issuecomment-2934962524
...
### github-actions on 2025-06-03T12:26:56Z

URL: https://github.com/WordPress/gutenberg/pull/70299#issuecomment-2934999735
...
| :--- | :---: | :---: |
| `build/edit-site/index.min.js` | 227 kB | +396 B (+0.17%) |
| `build/format-library/index.min.js` | 8.09 kB | +8 B (+0.1%) |
...
### github-actions on 2025-06-04T07:38:39Z

URL: https://github.com/WordPress/gutenberg/pull/70299#issuecomment-2938951716
...
### jasmussen on 2025-06-06T07:27:09Z

URL: https://github.com/WordPress/gutenberg/pull/70299#issuecomment-2948351743

We should, yes! Good eye. I took as tab in [this Figma file](https://www.figma.com/design/G5EAVfxQEXTVnU83El3ENJ/Circle-icons?node-id=0-1&t=fkJbjeYbKOVtEay3-1).

Here's a before and after:

<img width="537" alt="before and after" src="https://github.com/user-attachments/assets/c54d6b62-cf2d-4207-b56c-d2fce4ece681" />

### jameskoster on 2025-06-10T08:19:09Z

URL: https://github.com/WordPress/gutenberg/pull/70299#issuecomment-2958129693

Yes there is a big group of circular icons that need updating. I probably won't get to those in the near term though. 

Up to y'all if we want to merge this, or wait for a comprehensive PR that targets all circular icons.

### t-hamano on 2025-06-11T04:34:19Z

URL: https://github.com/WordPress/gutenberg/pull/70299#issuecomment-2961211428

> Up to y'all if we want to merge this, or wait for a comprehensive PR that targets all circular icons.

If all circular icons will ultimately be unified, I think it's fine to merge as is.

Regarding the `plusCircle` icon, we expect the circle to be exactly 32px in size, but it contains a fractional value. Should we not care about this?

![image](https://github.com/user-attachments/assets/95e70ae9-f10f-49ba-afb0-43bd1a465b04)

### jasmussen on 2025-07-01T11:40:05Z

URL: https://github.com/WordPress/gutenberg/pull/70299#issuecomment-3023584717

I'm going to merge this one and follow up with the remaining icons.

### jasmussen on 2025-07-01T11:40:29Z

URL: https://github.com/WordPress/gutenberg/pull/70299#issuecomment-3023585882
...
#### jasmussen on 2025-06-04T07:37:27Z

URL: https://github.com/WordPress/gutenberg/pull/70299#discussion_r2125900101
Path: packages/icons/src/library/plus-circle.js
...
#### jasmussen on 2025-06-04T07:38:05Z

URL: https://github.com/WordPress/gutenberg/pull/70299#discussion_r2125901231
Path: packages/icons/src/library/plus-circle.js
...
- packages/icons/src/library/help.js (MODIFIED, +1/-1)
- packages/icons/src/library/plus-circle.js (MODIFIED, +6/-2)
- packages/icons/src/library/typography.js (MODIFIED, +1/-1)
