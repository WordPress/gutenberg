...
type: pull_request
state: MERGED
merged_at: 2026-05-22T14:49:57Z
url: https://github.com/WordPress/gutenberg/pull/78573
matched_labels: ["[Package] Theme"]
all_labels: ["[Type] Code Quality","[Package] Theme"]
---

# PR #78573: Theme: Remove and prevent dependency grouping comments

- URL: https://github.com/WordPress/gutenberg/pull/78573
- Author: aduth
- Created: 2026-05-22T13:12:17Z
- Updated: 2026-05-22T14:54:14Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 22 of 22
- Diff: ../pr-diffs/78573.diff
...
### github-actions on 2026-05-22T13:20:37Z

URL: https://github.com/WordPress/gutenberg/pull/78573#issuecomment-4519037105
...
### github-actions on 2026-05-22T13:30:34Z

URL: https://github.com/WordPress/gutenberg/pull/78573#issuecomment-4519122614
...
### aduth on 2026-05-22T14:54:14Z

URL: https://github.com/WordPress/gutenberg/pull/78573#issuecomment-4519773567

I did an AI-assisted scan of [open pull requests with the "[Package] Theme" label](https://github.com/WordPress/gutenberg/pulls?q=is%3Aopen+is%3Apr+label%3A%22%5BPackage%5D+Theme%22) for any proposed additions of these comments (i.e. which would conflict with these changes) and confirmed there are none.
...
- packages/theme/bin/generate-default-ramps/index.ts (MODIFIED, +0/-10)
- packages/theme/bin/generate-primitive-tokens/index.ts (MODIFIED, +0/-7)
- packages/theme/bin/terrazzo-plugin-ds-tokens-docs/index.ts (MODIFIED, +0/-3)
- packages/theme/bin/terrazzo-plugin-inline-alias-values/index.ts (MODIFIED, +0/-3)
- packages/theme/bin/terrazzo-plugin-known-wpds-css-variables/index.ts (MODIFIED, +0/-3)
- packages/theme/bin/terrazzo-plugin-mode-overrides/index.ts (MODIFIED, +0/-3)
- packages/theme/src/color-ramps/index.ts (MODIFIED, +0/-7)
- packages/theme/src/color-ramps/lib/default-ramps.ts (MODIFIED, +0/-3)
- packages/theme/src/color-ramps/lib/index.ts (MODIFIED, +0/-4)
- packages/theme/src/color-ramps/lib/ramp-configs.ts (MODIFIED, +0/-3)
- packages/theme/src/color-ramps/lib/types.ts (MODIFIED, +0/-3)
- packages/theme/src/color-ramps/stories/index.story.tsx (MODIFIED, +0/-7)
- packages/theme/src/color-ramps/stories/ramp-table.tsx (MODIFIED, +0/-7)
- packages/theme/src/context.ts (MODIFIED, +0/-7)
- packages/theme/src/lock-unlock.ts (MODIFIED, +0/-3)
- packages/theme/src/private-apis.ts (MODIFIED, +0/-3)
- packages/theme/src/stories/index.story.tsx (MODIFIED, +0/-11)
- packages/theme/src/theme-provider.tsx (MODIFIED, +0/-11)
- packages/theme/src/types.ts (MODIFIED, +0/-3)
- packages/theme/src/use-theme-provider-styles.ts (MODIFIED, +0/-11)
- packages/theme/terrazzo.config.ts (MODIFIED, +0/-7)
- tools/eslint/config.mjs (MODIFIED, +5/-1)
