...
type: pull_request
state: MERGED
merged_at: 2023-04-20T07:55:05Z
url: https://github.com/WordPress/gutenberg/pull/49794
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Performance","[Type] Code Quality","[Package] Components"]
---

# PR #49794: Lodash: Remove remaining Lodash from `@wordpress/components` package

- URL: https://github.com/WordPress/gutenberg/pull/49794
- Author: tyxla
- Created: 2023-04-13T12:24:03Z
- Updated: 2023-04-24T10:20:48Z
- Comments: 1 of 1
- Review threads: 8 of 8
- Changed files: 5 of 5
- Diff: ../pr-diffs/49794.diff
...
### github-actions on 2023-04-13T12:35:00Z

URL: https://github.com/WordPress/gutenberg/pull/49794#issuecomment-1506887597
...
#### tyxla on 2023-04-13T12:38:52Z

URL: https://github.com/WordPress/gutenberg/pull/49794#discussion_r1165462330
...
#### ciampo on 2023-04-24T10:16:06Z

URL: https://github.com/WordPress/gutenberg/pull/49794#discussion_r1175079861
Path: packages/components/package.json
...
#### tyxla on 2023-04-24T10:20:48Z

URL: https://github.com/WordPress/gutenberg/pull/49794#discussion_r1175084672
Path: packages/components/package.json
...
#### tyxla on 2023-04-13T12:39:30Z

URL: https://github.com/WordPress/gutenberg/pull/49794#discussion_r1165463135
Path: packages/components/src/mobile/bottom-sheet/cell.native.js
...
As you can see below, `value` is used as a string, therefore we can safely use it as a string in the `if()`, simplifying the condition.

### Review thread 3

#### tyxla on 2023-04-13T12:39:46Z

URL: https://github.com/WordPress/gutenberg/pull/49794#discussion_r1165463443
Path: packages/components/src/mobile/bottom-sheet/cell.native.js
...
As you can see above and below, `help` is used as a string, therefore we can safely use it as a string in the `if()`, simplifying the condition.

### Review thread 4

#### tyxla on 2023-04-13T12:40:59Z

URL: https://github.com/WordPress/gutenberg/pull/49794#discussion_r1165464866
Path: packages/components/src/mobile/bottom-sheet/cell.native.js
...
`platformStyles` is already being used as an object in this component, so using `platformStyles.activeOpacity` is safe. We're keeping the optional chaining for `.opacity` since it is not certain that it will exist.

### Review thread 5

#### tyxla on 2023-04-13T12:41:50Z

URL: https://github.com/WordPress/gutenberg/pull/49794#discussion_r1165465825
...
#### tyxla on 2023-04-13T12:43:22Z

URL: https://github.com/WordPress/gutenberg/pull/49794#discussion_r1165467451
...
Optional chaining here will help us handle nullish values both at the first level and nested inside objects or arrays, making the function essentially as save as `get()` was.

### Review thread 7

#### tyxla on 2023-04-13T12:44:21Z

URL: https://github.com/WordPress/gutenberg/pull/49794#discussion_r1165468685
Path: packages/components/src/mobile/global-styles-context/utils.native.js
...
This is as safe as `get()` was, because `getValueFromObjectPath()` will handle nullish values.

### Review thread 8

#### tyxla on 2023-04-13T12:44:25Z

URL: https://github.com/WordPress/gutenberg/pull/49794#discussion_r1165468743
Path: packages/components/src/mobile/global-styles-context/utils.native.js
...
- packages/components/src/mobile/bottom-sheet/cell.native.js (MODIFIED, +4/-5)
- packages/components/src/mobile/global-styles-context/utils.native.js (MODIFIED, +18/-3)
