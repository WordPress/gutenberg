...
type: pull_request
state: MERGED
merged_at: 2026-05-11T15:15:21Z
url: https://github.com/WordPress/gutenberg/pull/78162
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #78162: Menu: Fix flaky keyboard focus test

- URL: https://github.com/WordPress/gutenberg/pull/78162
- Author: mirka
- Created: 2026-05-11T13:06:42Z
- Updated: 2026-05-13T16:55:02Z
- Comments: 5 of 5
- Review threads: 0 of 0
- Changed files: 1 of 1
- Diff: ../pr-diffs/78162.diff
...
### github-actions on 2026-05-11T13:11:47Z

URL: https://github.com/WordPress/gutenberg/pull/78162#issuecomment-4421004981
...
### github-actions on 2026-05-11T13:14:45Z

URL: https://github.com/WordPress/gutenberg/pull/78162#issuecomment-4421028549
...
### github-actions on 2026-05-11T13:40:40Z

URL: https://github.com/WordPress/gutenberg/pull/78162#issuecomment-4421245492

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 152b7566c5f8809d8f629fe5fdc6da4c12193038.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/25672026343
📝  Reported issues:
- #77701 in `/test/e2e/specs/editor/various/upload-save-lock.spec.js`

### jsnajdr on 2026-05-13T08:31:19Z

URL: https://github.com/WordPress/gutenberg/pull/78162#issuecomment-4438945724

@mirka I just a got a unit test failure in this PR run:

https://github.com/WordPress/gutenberg/actions/runs/25787106519/job/75743092320?pr=78193

This `{ detail: 0 }` patch is applied, and yet it fails again:
```
      24 | const waitForFocusedMenuItem = ( name: string ) =>
      25 | 	waitFor( () =>
    > 26 | 		expect( screen.getByRole( 'menuitem', { name } ) ).toHaveFocus()
         | 		                                                   ^
      27 | 	);
      28 |
      29 | // Open dropdown => open menu
```
Or is it something else?

### mirka on 2026-05-13T16:55:02Z

URL: https://github.com/WordPress/gutenberg/pull/78162#issuecomment-4443372609

@jsnajdr Oof, yes it does look like we're still getting flakes on this. Reducing the test scope in #78246.
...
- packages/components/src/menu/test/index.tsx (MODIFIED, +3/-1)
