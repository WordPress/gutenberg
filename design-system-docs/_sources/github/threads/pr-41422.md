...
type: pull_request
state: MERGED
merged_at: 2022-05-30T17:40:57Z
url: https://github.com/WordPress/gutenberg/pull/41422
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components"]
---

# PR #41422: Use @testing-library/user-event in `BoxControl` tests

- URL: https://github.com/WordPress/gutenberg/pull/41422
- Author: stokesman
- Created: 2022-05-29T19:54:43Z
- Updated: 2022-05-30T17:41:24Z
- Comments: 1 of 1
- Review threads: 1 of 1
- Changed files: 2 of 2
- Diff: ../pr-diffs/41422.diff

## Body

## What?
Updates the `BoxControl` unit tests to use `@testing-library/user-event` for interacting with the component and modifies one test to cover its `onChange` handling.
...
### github-actions on 2022-05-29T20:03:16Z

URL: https://github.com/WordPress/gutenberg/pull/41422#issuecomment-1140516036
...
#### stokesman on 2022-05-29T21:15:27Z

URL: https://github.com/WordPress/gutenberg/pull/41422#discussion_r884325145
...
This test wasn't previously testing what `onChange` was called with. It seems appropriate to cover because even if the input remains empty, the feature may break as mentioned in https://github.com/WordPress/gutenberg/pull/40518#issuecomment-1140518857.

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/box-control/test/index.js (MODIFIED, +120/-109)
