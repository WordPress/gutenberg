...
type: pull_request
state: MERGED
merged_at: 2026-04-01T19:34:06Z
url: https://github.com/WordPress/gutenberg/pull/76969
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Data","[Package] Url","[Package] Core data","[Package] DOM","[Package] Components","[Package] Blocks","[Package] Editor","[Package] Block library","[Package] Block editor","[Package] E2E Tests","[Package] Icons","[Package] Edit Site","[Package] Warning","[Package] Style Engine","[Package] Interactivity","[Package] Patterns","[Package] Interactivity Router","[Package] Sync"]
---

# PR #76969: Remove unused catch block variables across the codebase

- URL: https://github.com/WordPress/gutenberg/pull/76969
- Author: manzoorwanijk
- Created: 2026-04-01T18:18:42Z
- Updated: 2026-04-01T19:34:48Z
- Comments: 9 of 9
- Review threads: 0 of 0
- Changed files: 83 of 83
- Diff: ../pr-diffs/76969.diff
...
### github-actions on 2026-04-01T18:18:55Z

URL: https://github.com/WordPress/gutenberg/pull/76969#issuecomment-4172072950
...
### github-actions on 2026-04-01T18:18:56Z

URL: https://github.com/WordPress/gutenberg/pull/76969#issuecomment-4172073047
...
- **Labels found**: [Package] Data, [Package] Url, [Package] Core data, [Package] DOM, [Package] Components, [Package] Blocks, [Package] Editor, [Package] Block library, [Package] Block editor, [Package] E2E Tests, [Package] Edit Site, [Package] Warning, [Package] Style Engine, [Package] Interactivity, [Package] Patterns, [Package] Interactivity Router, [Package] Sync.
...
URL: https://github.com/WordPress/gutenberg/pull/76969#issuecomment-4172073061
...
### aduth on 2026-04-01T18:23:58Z

URL: https://github.com/WordPress/gutenberg/pull/76969#issuecomment-4172099042

> ESLint v10 changes the `no-unused-vars` rule default for `caughtErrors` from `"none"` to `"all"`, which flags unused catch block variables as errors.
...
### manzoorwanijk on 2026-04-01T18:26:08Z

URL: https://github.com/WordPress/gutenberg/pull/76969#issuecomment-4172110370

> Should we configure that here, to avoid new issues between now and the upgrade landing? I don't think it hurts to be explicit in the configuration anyways.

Good idea. Thanks

### github-actions on 2026-04-01T18:30:45Z

URL: https://github.com/WordPress/gutenberg/pull/76969#issuecomment-4172136753
...
| :--- | :---: | :---: |
| `build/scripts/block-editor/index.min.js` | 339 kB | -1 B (0%) |
...
### manzoorwanijk on 2026-04-01T18:38:42Z

URL: https://github.com/WordPress/gutenberg/pull/76969#issuecomment-4172181738

I realized that making the rule change (https://github.com/WordPress/gutenberg/pull/76969/commits/f9b8b69fc20da78ab347575c29781edf5a43e230) to the plugin will be a breaking change for eslint-plugin, so I reverted that and added the change to the repo eslint config.

### aduth on 2026-04-01T18:51:49Z

URL: https://github.com/WordPress/gutenberg/pull/76969#issuecomment-4172260860

> I realized that making the rule change ([f9b8b69](https://github.com/WordPress/gutenberg/commit/f9b8b69fc20da78ab347575c29781edf5a43e230)) to the plugin will be a breaking change for eslint-plugin, so I reverted that and added the change to the repo eslint config.

Makes sense. Let's save the breaking change upgrade for ESLint v10 😅

### github-actions on 2026-04-01T19:21:05Z

URL: https://github.com/WordPress/gutenberg/pull/76969#issuecomment-4172438498

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 32fc06210cefbbf52da4a223738291860eda41e8.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/23865271590
📝  Reported issues:
...
- .eslintrc.js (MODIFIED, +18/-0)
- bin/packages/check-build-type-declaration-files.js (MODIFIED, +1/-1)
- packages/block-editor/src/components/block-draggable/test/helpers.native.js (MODIFIED, +1/-1)
...
- packages/block-library/src/cover/embed-video-utils.js (MODIFIED, +1/-1)
- packages/block-library/src/embed/test/index.native.js (MODIFIED, +3/-2)
- packages/block-library/src/file/utils/index.js (MODIFIED, +1/-1)
- packages/block-library/src/form/view.js (MODIFIED, +1/-1)
- packages/block-library/src/navigation-link/link-ui/page-creator.js (MODIFIED, +1/-1)
- packages/block-library/src/navigation-link/shared/update-attributes.js (MODIFIED, +1/-1)
- packages/block-library/src/navigation-link/shared/use-link-preview.js (MODIFIED, +1/-1)
...
- packages/blocks/src/api/children.js (MODIFIED, +1/-1)
- packages/blocks/src/api/node.js (MODIFIED, +1/-1)
- packages/blocks/src/api/raw-handling/image-corrector.js (MODIFIED, +1/-1)
- packages/blocks/src/api/serializer.js (MODIFIED, +1/-1)
- packages/blocks/src/api/validation/index.js (MODIFIED, +1/-1)
- packages/components/src/mobile/utils/get-px-from-css-unit.native.js (MODIFIED, +1/-1)
- packages/components/src/sandbox/index.native.js (MODIFIED, +1/-1)
- packages/components/src/sandbox/index.tsx (MODIFIED, +2/-2)
- packages/core-data/src/resolvers.js (MODIFIED, +6/-6)
- packages/create-block/lib/templates.js (MODIFIED, +1/-1)
- packages/data/src/plugins/persistence/index.ts (MODIFIED, +1/-1)
- packages/data/src/plugins/persistence/storage/default.ts (MODIFIED, +1/-1)
- packages/data/src/redux-store/metadata/test/selectors.js (MODIFIED, +1/-1)
- packages/data/src/registry.ts (MODIFIED, +3/-3)
...
- packages/e2e-test-utils-playwright/src/admin/visit-site-editor.ts (MODIFIED, +1/-1)
- packages/e2e-test-utils-playwright/src/test.ts (MODIFIED, +1/-1)
- packages/e2e-tests/plugins/interactive-blocks/generator-scope/view.js (MODIFIED, +1/-1)
- packages/e2e-tests/plugins/interactive-blocks/router-navigate/view.js (MODIFIED, +1/-1)
- packages/edit-site/src/components/more-menu/site-export.js (MODIFIED, +1/-1)
- packages/editor/src/components/collaborators-overlay/cursor-dom-utils.ts (MODIFIED, +1/-1)
- packages/editor/src/components/collaborators-overlay/timing-utils.ts (MODIFIED, +1/-1)
- packages/editor/src/components/error-boundary/index.js (MODIFIED, +1/-1)
- packages/editor/src/components/error-boundary/index.native.js (MODIFIED, +1/-1)
- packages/editor/src/components/post-title/index.js (MODIFIED, +1/-1)
- packages/env/lib/config/load-config.js (MODIFIED, +1/-1)
- packages/env/lib/config/parse-source-string.js (MODIFIED, +1/-1)
- packages/env/lib/runtime/docker/wordpress.js (MODIFIED, +1/-1)
- packages/env/lib/runtime/playground/index.js (MODIFIED, +2/-2)
- packages/eslint-plugin/utils/is-package-installed.js (MODIFIED, +1/-1)
- packages/global-styles-engine/src/preview-state-styles.ts (MODIFIED, +1/-1)
- packages/global-styles-ui/src/font-library/font-collection.tsx (MODIFIED, +1/-1)
- packages/global-styles-ui/src/font-library/upload-fonts.tsx (MODIFIED, +1/-1)
- packages/icons/lib/validate-collection.cjs (MODIFIED, +1/-1)
- packages/interactivity-router/src/assets/dynamic-importmap/fetch.ts (MODIFIED, +1/-1)
- packages/interactivity-router/src/assets/dynamic-importmap/resolver.ts (MODIFIED, +1/-1)
- packages/interactivity-router/src/index.ts (MODIFIED, +2/-2)
- packages/interactivity/src/directives.tsx (MODIFIED, +2/-2)
- packages/interactivity/src/proxies/test/state-proxy.ts (MODIFIED, +1/-1)
- packages/interactivity/src/test/utils.ts (MODIFIED, +1/-1)
- packages/interactivity/src/utils.ts (MODIFIED, +1/-1)
- packages/list-reusable-blocks/src/utils/import.js (MODIFIED, +1/-1)
- packages/patterns/src/store/actions.js (MODIFIED, +1/-1)
- packages/react-native-editor/__device-tests__/helpers/utils.js (MODIFIED, +2/-2)
- packages/react-native-editor/bin/extract-files-from-sourcemap.js (MODIFIED, +4/-4)
- packages/react-native-editor/i18n-cache/index.js (MODIFIED, +1/-1)
- packages/report-flaky-tests/src/markdown.ts (MODIFIED, +1/-1)
- packages/scripts/scripts/test-playwright.js (MODIFIED, +1/-1)
- packages/scripts/utils/config.js (MODIFIED, +2/-2)
- packages/style-engine/src/styles/utils.ts (MODIFIED, +1/-1)
- packages/sync/src/utils.ts (MODIFIED, +1/-1)
- packages/url/src/get-filename.ts (MODIFIED, +1/-1)
- packages/url/src/get-query-string.ts (MODIFIED, +1/-1)
- packages/url/src/safe-decode-uri-component.ts (MODIFIED, +1/-1)
- packages/url/src/safe-decode-uri.ts (MODIFIED, +1/-1)
- packages/warning/src/index.ts (MODIFIED, +1/-1)
- packages/wp-build/lib/route-utils.mjs (MODIFIED, +1/-1)
- test/e2e/specs/admin/font-library.spec.js (MODIFIED, +1/-1)
- test/e2e/specs/editor/blocks/cover.spec.js (MODIFIED, +1/-1)
- test/integration/fixtures/utils.js (MODIFIED, +1/-1)
- test/native/matchers/utils.js (MODIFIED, +1/-1)
- test/unit/config/matchers/to-match-style-diff-snapshot.js (MODIFIED, +1/-1)
