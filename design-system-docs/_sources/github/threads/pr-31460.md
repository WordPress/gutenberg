...
type: pull_request
state: MERGED
merged_at: 2021-05-06T10:19:58Z
url: https://github.com/WordPress/gutenberg/pull/31460
matched_labels: ["[Feature] Component System"]
all_labels: ["[Feature] UI Components","[Type] Code Quality","[Feature] Component System"]
---

# PR #31460: Add ToolbarDropdownMenu to render dropdown menus properly inside toolbars

- URL: https://github.com/WordPress/gutenberg/pull/31460
- Author: youknowriad
- Created: 2021-05-04T12:55:36Z
- Updated: 2021-05-06T10:20:40Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 12 of 12
- Diff: ../pr-diffs/31460.diff
...
### github-actions on 2021-05-04T13:06:15Z

URL: https://github.com/WordPress/gutenberg/pull/31460#issuecomment-831926597
...
| `build/block-editor/index.js` | 116 kB | -38 B (0%) |
| `build/block-library/index.js` | 142 kB | -11 B (0%) |
| `build/blocks/index.js` | 47 kB | -1 B (0%) |
| `build/components/index.js` | 186 kB | +28 B (0%) |
| `build/compose/index.js` | 9.96 kB | -2 B (0%) |
| `build/edit-navigation/index.js` | 13.6 kB | +1 B (0%) |
| `build/edit-post/index.js` | 334 kB | -2 B (0%) |
| `build/edit-site/index.js` | 25.7 kB | -6 B (0%) |
| `build/edit-widgets/index.js` | 12.5 kB | -2 B (0%) |
| `build/editor/index.js` | 60.4 kB | -2 B (0%) |
...
### youknowriad on 2021-05-05T13:02:01Z

URL: https://github.com/WordPress/gutenberg/pull/31460#issuecomment-832668352

Added to must-have to avoid leaking the isToolbarButton API into Core.
...
- packages/block-editor/src/components/alignment-control/ui.js (MODIFIED, +3/-4)
- packages/block-editor/src/components/block-alignment-control/ui.js (MODIFIED, +3/-4)
- packages/block-editor/src/components/block-vertical-alignment-control/ui.js (MODIFIED, +3/-4)
- packages/block-editor/src/components/justify-content-control/ui.js (MODIFIED, +3/-4)
- packages/block-editor/src/components/navigable-toolbar/index.js (MODIFIED, +2/-1)
- packages/block-library/src/paragraph/edit.js (MODIFIED, +6/-3)
- packages/block-library/src/site-title/edit/level-toolbar.js (MODIFIED, +2/-3)
- packages/components/src/dropdown-menu/index.js (MODIFIED, +2/-6)
- packages/components/src/index.js (MODIFIED, +1/-0)
- packages/components/src/toolbar-dropdown-menu/README.md (ADDED, +106/-0)
- packages/components/src/toolbar-dropdown-menu/index.js (ADDED, +42/-0)
