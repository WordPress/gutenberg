...
type: pull_request
state: MERGED
merged_at: 2022-06-21T12:25:11Z
url: https://github.com/WordPress/gutenberg/pull/41587
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Feature] UI Components","[Type] Code Quality","[Package] Components"]
---

# PR #41587: ColorIndicator: Convert component to TypeScript

- URL: https://github.com/WordPress/gutenberg/pull/41587
- Author: walbo
- Created: 2022-06-07T21:49:46Z
- Updated: 2022-06-21T12:25:56Z
- Comments: 1 of 1
- Review threads: 4 of 4
- Changed files: 10 of 10
- Diff: ../pr-diffs/41587.diff
...
## What?
Converts the `ColorIndicator` component to TypeScript.

## Why?
Part of the @wordpress/components's TypeScript migration (https://github.com/WordPress/gutenberg/issues/35744).

## How?
Refactors the current `ColorIndicator` to TypeScript.

## Testing Instructions
1. Run npm run dev and ensure no typing errors
2. Fire up the Storybook and confirm the `ColorIndicator` continues to function as expected
3. Test the various color indicators within the block/site editors in Gutenberg still work

## Issue comments

### github-actions on 2022-06-07T22:01:34Z

URL: https://github.com/WordPress/gutenberg/pull/41587#issuecomment-1149216323
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 228 kB | +13 B (0%) |
...
#### mirka on 2022-06-13T15:49:20Z

URL: https://github.com/WordPress/gutenberg/pull/41587#discussion_r895879643
Path: packages/components/src/color-indicator/test/__snapshots__/index.tsx.snap
...
So this changed from `#fff` to `rgb(255, 255, 255)` because... of the switch from Enzyme to Testing Library, I presume? 🤔 Interesting.

#### walbo on 2022-06-13T19:05:44Z

URL: https://github.com/WordPress/gutenberg/pull/41587#discussion_r896044801
Path: packages/components/src/color-indicator/test/__snapshots__/index.tsx.snap
...
I notices that too. Not sure why, but when inspecting the DOM where it is used in Gutenberg i get `rgb` so maybe a better representation.

### Review thread 2 (resolved)

#### mirka on 2022-06-13T15:51:06Z

URL: https://github.com/WordPress/gutenberg/pull/41587#discussion_r895881407
Path: packages/components/src/color-indicator/types.ts
...
Maybe add a little tweak for clarity here?

```suggestion
	 * The color of the indicator. Any value from the CSS `background` property is
```

#### walbo on 2022-06-13T19:08:03Z

URL: https://github.com/WordPress/gutenberg/pull/41587#discussion_r896046718
Path: packages/components/src/color-indicator/types.ts
...
Makes sense clearify it 👍

### Review thread 3 (resolved)

#### mirka on 2022-06-13T18:57:39Z

URL: https://github.com/WordPress/gutenberg/pull/41587#discussion_r896038703
Path: packages/components/src/color-indicator/stories/index.tsx
...
Is this an artifact from a copy paste? 😄 🧹

#### walbo on 2022-06-13T19:06:23Z

URL: https://github.com/WordPress/gutenberg/pull/41587#discussion_r896045541
Path: packages/components/src/color-indicator/stories/index.tsx
...
#### ciampo on 2022-06-14T16:41:00Z

URL: https://github.com/WordPress/gutenberg/pull/41587#discussion_r897054645
Path: packages/components/src/color-indicator/index.tsx
...
Should we `forwardRef` here as well? cc @mirka

#### walbo on 2022-06-14T16:57:59Z

URL: https://github.com/WordPress/gutenberg/pull/41587#discussion_r897070367
Path: packages/components/src/color-indicator/index.tsx
...
#### mirka on 2022-06-15T07:00:55Z

URL: https://github.com/WordPress/gutenberg/pull/41587#discussion_r897605813
Path: packages/components/src/color-indicator/index.tsx
...
#### ciampo on 2022-06-15T10:53:14Z

URL: https://github.com/WordPress/gutenberg/pull/41587#discussion_r897831655
Path: packages/components/src/color-indicator/index.tsx
...
We've just updated the [Migration guidelines](https://github.com/WordPress/gutenberg/blob/trunk/packages/components/CONTRIBUTING.md#refactoring-a-component-to-typescript) to include a point re. this  (point `7 / vii`):
...
#### walbo on 2022-06-17T12:08:50Z

URL: https://github.com/WordPress/gutenberg/pull/41587#discussion_r900056403
Path: packages/components/src/color-indicator/index.tsx
...
#### walbo on 2022-06-21T09:31:44Z

URL: https://github.com/WordPress/gutenberg/pull/41587#discussion_r902387870
Path: packages/components/src/color-indicator/index.tsx
...
- packages/components/src/color-indicator/README.md (MODIFIED, +7/-9)
- packages/components/src/color-indicator/index.js (DELETED, +0/-16)
- packages/components/src/color-indicator/index.tsx (ADDED, +47/-0)
- packages/components/src/color-indicator/stories/index.js (DELETED, +0/-22)
- packages/components/src/color-indicator/stories/index.tsx (ADDED, +37/-0)
- packages/components/src/color-indicator/test/__snapshots__/index.js.snap (DELETED, +0/-13)
- packages/components/src/color-indicator/test/__snapshots__/index.tsx.snap (ADDED, +11/-0)
- packages/components/src/color-indicator/test/index.tsx (RENAMED, +4/-4)
- packages/components/src/color-indicator/types.ts (ADDED, +12/-0)
