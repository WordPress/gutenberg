...
type: pull_request
state: MERGED
merged_at: 2021-09-28T08:36:51Z
url: https://github.com/WordPress/gutenberg/pull/35163
matched_labels: ["[Package] Components","[Feature] Component System"]
all_labels: ["[Status] In Progress","[Type] Automated Testing","[Type] Code Quality","[Package] Components","[Feature] Component System"]
---

# PR #35163: Components: add tests for `Navigator*`

- URL: https://github.com/WordPress/gutenberg/pull/35163
- Author: ciampo
- Created: 2021-09-27T19:31:08Z
- Updated: 2021-09-28T08:37:16Z
- Comments: 1 of 1
- Review threads: 1 of 1
- Changed files: 1 of 1
- Diff: ../pr-diffs/35163.diff
...
_This is part of a series of smaller PRs that aim at refining the family of `Navigator` components and is part of a larger effort tracked in #34907._

This PR adds unit and integration tests for the `Navigator*` family of components. The tests are written from the point of view of the end-user, and focus more on the integration of the `Navigator*` components working as expected, rather than testing the implementation details of every single part in isolation.

A future follow-up PR will refactor the components to TypeScript.
...
### github-actions on 2021-09-27T19:39:13Z

URL: https://github.com/WordPress/gutenberg/pull/35163#issuecomment-928210375
...
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 134 kB | +13 B (0%) |
...
| `build/edit-site/index.min.js` | 28 kB | +311 B (+1%) |
...
#### ciampo on 2021-09-28T07:45:02Z

URL: https://github.com/WordPress/gutenberg/pull/35163#discussion_r717311883
...
- packages/components/src/navigator/test/index.js (ADDED, +218/-0)
