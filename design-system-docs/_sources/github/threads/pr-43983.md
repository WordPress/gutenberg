...
type: pull_request
state: MERGED
merged_at: 2022-09-08T16:53:04Z
url: https://github.com/WordPress/gutenberg/pull/43983
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #43983: Components: Fix TS types for `isValueDefined()`/`isValueEmpty()`

- URL: https://github.com/WordPress/gutenberg/pull/43983
- Author: mirka
- Created: 2022-09-08T13:50:26Z
- Updated: 2022-09-08T16:53:42Z
- Comments: 1 of 1
- Review threads: 1 of 1
- Changed files: 4 of 4
- Diff: ../pr-diffs/43983.diff

## Body

Follow-up to https://github.com/WordPress/gutenberg/pull/43791#discussion_r964767921 

## What?

Fixes the TypeScript types for the `isValueDefined()`/`isValueEmpty()` utility functions so it can properly narrow down execution paths.

## Why?

When typed properly, TypeScript should be able to tell that `nextValue` will always be never be `undefined`:
...
### github-actions on 2022-09-08T14:01:38Z

URL: https://github.com/WordPress/gutenberg/pull/43983#issuecomment-1240760466
...
#### mirka on 2022-09-08T13:52:06Z

URL: https://github.com/WordPress/gutenberg/pull/43983#discussion_r965999045
...
- packages/components/src/number-control/index.tsx (MODIFIED, +7/-7)
- packages/components/src/utils/math.js (MODIFIED, +4/-4)
- packages/components/src/utils/values.js (MODIFIED, +4/-6)
