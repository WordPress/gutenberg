...
type: pull_request
state: MERGED
merged_at: 2024-01-30T09:49:07Z
url: https://github.com/WordPress/gutenberg/pull/56682
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Date","[Package] Components","[Package] Editor","Backported to WP Core"]
---

# PR #56682: Add a timezone offset value for display purposes

- URL: https://github.com/WordPress/gutenberg/pull/56682
- Author: afercia
- Created: 2023-11-30T12:39:55Z
- Updated: 2024-02-08T07:11:38Z
- Comments: 8 of 8
- Review threads: 0 of 0
- Changed files: 7 of 7
- Diff: ../pr-diffs/56682.diff
...
Fixes https://github.com/WordPress/gutenberg/issues/56254
...
The timezone offset value is displayed 'as is stored' with decimals instead of minutes. E.g. `5.75` instead of `5.45`.
...
- Adds a compact file to override the core `wp.date.setSettings`.
- I'm not familiar with how to handle compact files, so please consider this part candidate to be changed / improved.
- Adds a `formattedOffset` to the `timezone` settings, this new value is meant for display purposes.
- The new value just uses a simple replacement to change decimal values to minutes as Core already does [here](https://github.com/WordPress/wordpress-develop/blob/7c492d36e0c6e219e54ce22eb6d1f5ae4610092b/src/wp-includes/functions.php#L6701).
- Uses the new value in two relevant places: the timezone component and the post-schedule label.
...
<!-- 3. etc. -->
- Repeat the reproduction steps from the issue https://github.com/WordPress/gutenberg/issues/56254
- Observe the displayed value is now `UTC+5:45`.
...
### github-actions on 2023-11-30T12:41:07Z

URL: https://github.com/WordPress/gutenberg/pull/56682#issuecomment-1833704475
...
<details>
  ...
  <br>:grey_question: lib/compat/wordpress-6.5/script-loader.php<br>:grey_question: lib/load.php<br>
</details>

### github-actions on 2023-11-30T12:47:07Z

URL: https://github.com/WordPress/gutenberg/pull/56682#issuecomment-1833718472
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 235 kB | +4 B (0%) |
| `build/date/index.min.js` | 17.9 kB | +6 B (0%) |
| `build/editor/index.min.js` | 61.7 kB | +3 B (0%) |
...
### ciampo on 2023-11-30T20:43:42Z

URL: https://github.com/WordPress/gutenberg/pull/56682#issuecomment-1834533483
...
### afercia on 2023-12-05T11:17:45Z

URL: https://github.com/WordPress/gutenberg/pull/56682#issuecomment-1840547218

@Mamaduka hi. Any familiarity with compat files? When you have a chance, some help would be greatly appreciated 🙏

### afercia on 2023-12-19T12:31:59Z

URL: https://github.com/WordPress/gutenberg/pull/56682#issuecomment-1862676070

@Mamaduka thanks for your review.

> @afercia, I wonder if we should just do the conversion on the client side since the human-readable offset is only used when displaying the text.
...
> P.S. The new compat file looks good to me. There's already a `gutenberg_update_wp_date_settings` filter in WP 6.4; we should probably remove it to avoid double filtering.

I have no idea how the compat files mechanism works. Glad to remove it if necessary, just let me know.
I will create a Trac ticket to add the relevant change into core.

### afercia on 2024-01-30T09:04:35Z

URL: https://github.com/WordPress/gutenberg/pull/56682#issuecomment-1916371759

Rebased on top of latest trunk.

### getdave on 2024-01-31T09:07:10Z

URL: https://github.com/WordPress/gutenberg/pull/56682#issuecomment-1918678434

Thank you for working on this and the associated backport to WP Core. I added it to the [PHP Sync Tracking Issue](https://github.com/WordPress/gutenberg/issues/57959).

Once the code is merged into WP Core we'd be grateful if you could:

- check off the line items in the [PHP Sync Tracking Issue](https://github.com/WordPress/gutenberg/issues/57959) 
- remove the `Needs PHP backport` label
- add the `Backported to WP Core` label

Thank you in advance 🙇

### ramonjd on 2024-01-31T21:59:36Z

URL: https://github.com/WordPress/gutenberg/pull/56682#issuecomment-1920047065
...
- lib/compat/wordpress-6.5/script-loader.php (ADDED, +101/-0)
- lib/load.php (MODIFIED, +1/-1)
- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/date-time/time/timezone.tsx (MODIFIED, +1/-1)
- packages/date/src/index.js (MODIFIED, +7/-6)
- packages/editor/src/components/post-schedule/label.js (MODIFIED, +1/-1)
- packages/editor/src/components/post-schedule/test/label.js (MODIFIED, +19/-7)
