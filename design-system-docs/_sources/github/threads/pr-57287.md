...
type: pull_request
state: MERGED
merged_at: 2024-01-08T19:40:03Z
url: https://github.com/WordPress/gutenberg/pull/57287
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #57287: Components: replace `TabPanel` with `Tabs` in the Style Book

- URL: https://github.com/WordPress/gutenberg/pull/57287
- Author: chad1008
- Created: 2023-12-20T21:06:16Z
- Updated: 2024-01-08T19:40:29Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/57287.diff
...
### github-actions on 2023-12-20T21:13:16Z

URL: https://github.com/WordPress/gutenberg/pull/57287#issuecomment-1865146113
...
| :--- | :---: | :---: |
| `build/edit-site/index.min.js` | 194 kB | +46 B (0%) |
| `build/edit-site/style-rtl.css` | 14.8 kB | -6 B (0%) |
| `build/edit-site/style.css` | 14.8 kB | -6 B (0%) |
...
| `build/editor/index.min.js` | 55.9 kB |
...
### github-actions on 2023-12-20T21:24:36Z

URL: https://github.com/WordPress/gutenberg/pull/57287#issuecomment-1865158092

<!-- flaky-tests-report-comment -->
**Flaky tests detected in ac336980c72d680c2c0961869ed7294b2adf8500.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/7280931751
📝  Reported issues:
- #35641 in `/test/e2e/specs/editor/various/publish-button.spec.js`

### chad1008 on 2024-01-08T19:39:21Z

URL: https://github.com/WordPress/gutenberg/pull/57287#issuecomment-1881710290

> One slightly different behavior that I noticed: on trunk, pressing Tab while focusing a tab moves focus to the tabpanel, while on this PR focus moves directly to the first focusable element in the tabpanel.

This observation threw me a bit, because I'd specifically tried to emulate the existing behavior so I played around with it a bit and I think I understand what's happening (though not entirely why, but that's a question for another day/PR)

If you launch the site editor, and immediately open the Global Styles sidebar, followed by the Style Book, <kbd>Tab</kbd> will move you to the first/current tab, and then to the first focusable item within the displayed `tabpanel`.

However, if you mess around in the editor and focus a block before opening Global Styles & Style Book, the focus behavior changes. <kbd>Tab</kbd> still starts by landing on the currently selected tab, but then cycles through various other elements instead of moving directly into the `tabpanel`.

While this feels off, and I'm not sure what causes it, the behavior seems consistent between `trunk` and this PR. I don't see any mention of the this `tab` > `tabpanel` focus switching in the PR where Style Book was implemented, so I'm going to proceed with the merge 👍
...
- packages/edit-site/src/components/style-book/index.js (MODIFIED, +32/-17)
- packages/edit-site/src/components/style-book/style.scss (MODIFIED, +3/-3)
