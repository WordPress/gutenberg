...
type: pull_request
state: MERGED
merged_at: 2024-03-28T12:32:45Z
url: https://github.com/WordPress/gutenberg/pull/60163
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components","[Package] Editor"]
---

# PR #60163: date-fns: bump to v3.6

- URL: https://github.com/WordPress/gutenberg/pull/60163
- Author: tyxla
- Created: 2024-03-25T11:23:06Z
- Updated: 2024-03-28T14:13:29Z
- Comments: 6 of 6
- Review threads: 0 of 0
- Changed files: 4 of 4
- Diff: ../pr-diffs/60163.diff
...
### github-actions on 2024-03-25T11:33:15Z

URL: https://github.com/WordPress/gutenberg/pull/60163#issuecomment-2017800581
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 222 kB | -1.24 kB (-1%) |
| `build/editor/index.min.js` | 64.7 kB | -469 B (-1%) |
...
### github-actions on 2024-03-27T15:37:21Z

URL: https://github.com/WordPress/gutenberg/pull/60163#issuecomment-2023085606
...
### tyxla on 2024-03-28T12:32:27Z

URL: https://github.com/WordPress/gutenberg/pull/60163#issuecomment-2025077253
...
Thanks for reporting @Mamaduka! 

I took a look and I'm able to reproduce on `trunk`.

After a second look, it looks like this is intentional because of the 1-minute threshold we're adding to accommodate time differences between the server and the client, see https://github.com/WordPress/gutenberg/pull/3036.

cc @youknowriad if he has any thoughts, but I think we should leave this as-is to keep preventing the issue Riad described in the PR.

### Mamaduka on 2024-03-28T12:50:27Z

URL: https://github.com/WordPress/gutenberg/pull/60163#issuecomment-2025110784

@tyxla, even when I adjust minutes (remove 5min), I get the same result.

I'll cover up my report on an issue and look into it separately. Thanks for the confirmation.

### tyxla on 2024-03-28T13:05:37Z

URL: https://github.com/WordPress/gutenberg/pull/60163#issuecomment-2025140317

Thanks @Mamaduka, this is definitely worth some additional attention since it might be misbehaving.

Have you tried with disabling that threshold functionality manually, just to see if that resolves it for you?

### Mamaduka on 2024-03-28T14:13:28Z

URL: https://github.com/WordPress/gutenberg/pull/60163#issuecomment-2025285282
...
- package-lock.json (MODIFIED, +22/-32)
