...
type: pull_request
state: MERGED
merged_at: 2026-03-18T17:55:57Z
url: https://github.com/WordPress/gutenberg/pull/76603
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Enhancement","[Package] UI"]
---

# PR #76603: UI: Update @base-ui/react from 1.2.0 to 1.3.0

- URL: https://github.com/WordPress/gutenberg/pull/76603
- Author: mirka
- Created: 2026-03-17T21:34:05Z
- Updated: 2026-03-18T17:57:37Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 6 of 6
- Diff: ../pr-diffs/76603.diff

## Body

## What?

Updates `@base-ui/react` from 1.2.0 to 1.3.0 in `@wordpress/ui`.

## Why?

[v1.3.0](https://github.com/mui/base-ui/blob/master/CHANGELOG.md#v130) (Mar 12, 2026) includes bug fixes for components we use (Autocomplete, Combobox, Select, Tabs, Tooltip, Field, ScrollArea, among others).

## How?

- Rename `DEFAULT_RENDER` constant to `defaultRender` in Field, and the `Render` inner function to `textareaRender` in Textarea. Base UI 1.3 now [warns](https://github.com/mui/base-ui/pull/4077) when the `render` prop receives a function whose name starts with an uppercase letter, interpreting it as a mistakenly passed component. This is a workaround — [an upstream issue](https://github.com/mui/base-ui/issues/4361) has been filed since the warning doesn't apply to our usage (we're passing render functions, not components).
- Add a `getAnimations` polyfill to global test mocks. Base UI's ScrollArea now calls `Element.getAnimations()`, which jsdom doesn't implement.
...
### github-actions on 2026-03-17T21:38:19Z

URL: https://github.com/WordPress/gutenberg/pull/76603#issuecomment-4078154075
...
### github-actions on 2026-03-17T21:50:18Z

URL: https://github.com/WordPress/gutenberg/pull/76603#issuecomment-4078203951

**Size Change:** +507 B (+0.01%) 

**Total Size:** 8.75 MB

| Filename | Size | Change |
| :--- | :---: | :---: |
| `build/modules/boot/index.min.js` | 16.9 kB | +66 B (+0.39%) |
| `build/scripts/block-editor/index.min.js` | 330 kB | +41 B (+0.01%) |
| `build/scripts/components/index.min.js` | 265 kB | -21 B (-0.01%) |
| `build/scripts/edit-site/index.min.js` | 250 kB | +85 B (+0.03%) |
| `build/scripts/editor/index.min.js` | 355 kB | +282 B (+0.08%) |
| `build/scripts/media-utils/index.min.js` | 75.2 kB | +54 B (+0.07%) |
...
### github-actions on 2026-03-17T22:10:37Z

URL: https://github.com/WordPress/gutenberg/pull/76603#issuecomment-4078285115

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 44685bcee11a627e2cc28418b402b9ee76a34e62.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/23217597565
📝  Reported issues:
...
- package-lock.json (MODIFIED, +27/-27)
...
- packages/ui/src/form/primitives/textarea/textarea.tsx (MODIFIED, +1/-1)
- test/unit/config/global-mocks.js (MODIFIED, +5/-0)
