...
type: pull_request
state: MERGED
merged_at: 2026-04-30T12:18:50Z
url: https://github.com/WordPress/gutenberg/pull/77812
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #77812: TabPanel: Fix tab indicator animation

- URL: https://github.com/WordPress/gutenberg/pull/77812
- Author: mirka
- Created: 2026-04-29T18:15:55Z
- Updated: 2026-04-30T12:19:37Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/77812.diff

## Body

## What?

Fixes the `TabPanel` tab indicator animation by narrowing the animated CSS properties.

## Why?

When switching between tabs, the indicator could briefly appear black and show a thin blue line below it. This happened because `transition: all` also animated the high-contrast outline on the indicator pseudo-element.

While this component is no longer used in Gutenberg itself, it's still the standard stable tabs component for consumers, so we should fix it. Noticed while trying to update the legacy tab component designs to match the new component in `@wordpress/ui`.

## How?

Updates the tab indicator to only transition `height`, and the focus ring pseudo-element to only transition `box-shadow`.

## Testing Instructions

1. Open a screen or Storybook example that renders `TabPanel`.
2. Click between tabs.
3. Confirm the active indicator stays the accent color while animating.
4. Confirm there is no extra thin blue line below the indicator.

## Screenshots or screencast

### Before

https://github.com/user-attachments/assets/10d6fdcf-ff1e-45dc-8219-f2d4ef71f227

### After

https://github.com/user-attachments/assets/48186ca9-2a07-4c80-804e-20f51e8589dc

## Issue comments

### github-actions on 2026-04-29T18:21:14Z

URL: https://github.com/WordPress/gutenberg/pull/77812#issuecomment-4346386970
...
### github-actions on 2026-04-29T18:33:17Z

URL: https://github.com/WordPress/gutenberg/pull/77812#issuecomment-4346471895
...
| :--- | :---: | :---: |
| `build/styles/components/style-rtl.css` | 17.5 kB | +2 B (+0.01%) |
| `build/styles/components/style-rtl.min.css` | 14.3 kB | +2 B (+0.01%) |
| `build/styles/components/style.css` | 17.5 kB | +2 B (+0.01%) |
...
### github-actions on 2026-04-29T18:54:38Z

URL: https://github.com/WordPress/gutenberg/pull/77812#issuecomment-4346663779

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 88dfff6826c5de278367b7e81c4eb4d8c075962e.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/25163035758
📝  Reported issues:
