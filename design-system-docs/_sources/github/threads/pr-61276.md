...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/61276
...
# PR #61276: Persist busy state on hover

- URL: https://github.com/WordPress/gutenberg/pull/61276
- Author: jameskoster
- Created: 2024-05-01T10:55:13Z
- Updated: 2025-02-10T16:51:24Z
- Comments: 6 of 6
- Review threads: 2 of 2
- Changed files: 3 of 3
- Diff: ../pr-diffs/61276.diff
...
### github-actions on 2024-05-01T10:55:28Z

URL: https://github.com/WordPress/gutenberg/pull/61276#issuecomment-2088287292
...
### github-actions on 2024-05-01T11:04:44Z

URL: https://github.com/WordPress/gutenberg/pull/61276#issuecomment-2088295441
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 220 kB | +4 B (0%) |
| `build/components/style-rtl.css` | 12 kB | +28 B (+0.23%) |
| `build/components/style.css` | 12 kB | +27 B (+0.23%) |
| `build/edit-post/index.min.js` | 16.2 kB | +9 B (+0.06%) |
...
### jameskoster on 2024-05-01T13:02:45Z

URL: https://github.com/WordPress/gutenberg/pull/61276#issuecomment-2088432580
...
### t-hamano on 2024-05-01T13:19:05Z

URL: https://github.com/WordPress/gutenberg/pull/61276#issuecomment-2088450927

My understanding is that opting in to `__experimentalIsFocusable` is a good approach if you don't want to lose focus.
...
### jameskoster on 2024-05-01T13:38:55Z

URL: https://github.com/WordPress/gutenberg/pull/61276#issuecomment-2088478013
...
### jameskoster on 2024-05-08T14:38:04Z

URL: https://github.com/WordPress/gutenberg/pull/61276#issuecomment-2100743005
...
#### tyxla on 2024-05-08T16:02:11Z

URL: https://github.com/WordPress/gutenberg/pull/61276#discussion_r1594277428
...
I disagree with this change. IMHO you might want to keep the button appearing busy, but still allow it to be non-disabled. If you really want to disable it, we do have the `disabled` prop that allows you to do it.

### Review thread 2

#### tyxla on 2024-05-08T16:18:03Z

URL: https://github.com/WordPress/gutenberg/pull/61276#discussion_r1594296708
...
Although most component libraries make loading/busy buttons disabled, I can definitely see a valid case for a busy button that's still not disabled. Maybe an optimistic "Add to Cart" button that remains enabled? Or any other counter-like button that counts something inline but also submits data to the server? We also have `__experimentalIsFocusable` so that fixes the a11y concerns about disabled busy buttons.
...
#### jameskoster on 2024-05-08T17:39:13Z

URL: https://github.com/WordPress/gutenberg/pull/61276#discussion_r1594399937
Path: packages/components/src/button/style.scss
...
For the example in the OP I guess the solution would be to make the Button `busy` and `disabled`.
...
- packages/components/src/button/style.scss (MODIFIED, +8/-4)
