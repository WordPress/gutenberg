...
type: pull_request
state: MERGED
merged_at: 2022-07-05T10:11:17Z
url: https://github.com/WordPress/gutenberg/pull/42094
matched_labels: ["[Package] Components"]
all_labels: ["[Focus] Accessibility (a11y)","[Package] Components","Needs Dev Note"]
---

# PR #42094: Change the BoxControl ARIA role from region to group.

- URL: https://github.com/WordPress/gutenberg/pull/42094
- Author: afercia
- Created: 2022-07-01T13:39:29Z
- Updated: 2022-09-15T13:17:43Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 4 of 4
- Diff: ../pr-diffs/42094.diff
...
### github-actions on 2022-07-01T13:49:17Z

URL: https://github.com/WordPress/gutenberg/pull/42094#issuecomment-1172370237
...
| `build/block-library/index.min.js` | 183 kB | -99 B (0%) |  |
| `build/block-library/style-rtl.css` | 11.5 kB | +12 B (0%) |  |
| `build/block-library/style.css` | 11.5 kB | +11 B (0%) |  |
| `build/block-library/theme-rtl.css` | 695 B | +18 B (+3%) |  |
| `build/block-library/theme.css` | 700 B | +18 B (+3%) |  |
| `build/blocks/index.min.js` | 47.1 kB | +22 B (0%) |  |
| `build/components/index.min.js` | 230 kB | -39 B (0%) |  |
| `build/core-data/index.min.js` | 14.7 kB | -3 B (0%) |  |
| `build/edit-post/index.min.js` | 30.4 kB | +70 B (0%) |  |
| `build/edit-site/index.min.js` | 52 kB | +1.03 kB (+2%) |  |
| `build/edit-widgets/index.min.js` | 16.5 kB | +18 B (0%) |  |
| `build/editor/index.min.js` | 39.3 kB | +75 B (0%) |  |
| `build/rich-text/index.min.js` | 11.1 kB | +4 B (0%) |  |
...
### afercia on 2022-07-05T08:46:11Z

URL: https://github.com/WordPress/gutenberg/pull/42094#issuecomment-1174789819

Updated the changelog. Also, updated some docs to clarify the usage of the ARIA `role="region"` and do update some links to the W3C site.

### Mamaduka on 2022-07-05T08:56:52Z

URL: https://github.com/WordPress/gutenberg/pull/42094#issuecomment-1174801361

Thank you, @afercia. This is good to merge after all checks are passing 👍

### mburridge on 2022-09-15T13:17:43Z

URL: https://github.com/WordPress/gutenberg/pull/42094#issuecomment-1248089730
...
- packages/components/src/higher-order/navigate-regions/README.md (MODIFIED, +4/-1)
