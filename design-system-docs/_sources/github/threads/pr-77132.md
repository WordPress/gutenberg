...
type: pull_request
state: MERGED
merged_at: 2026-04-10T07:51:22Z
url: https://github.com/WordPress/gutenberg/pull/77132
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components","[Package] DataViews"]
---

# PR #77132: Checkbox: fix disabled styles

- URL: https://github.com/WordPress/gutenberg/pull/77132
- Author: oandregal
- Created: 2026-04-08T09:24:54Z
- Updated: 2026-04-10T07:52:09Z
- Comments: 7 of 7
- Review threads: 4 of 4
- Changed files: 5 of 5
- Diff: ../pr-diffs/77132.diff
...
Add disabled styles for the `CheckboxControl` component.

## Why?

The `CheckboxControl` component had no CSS styles for the `:disabled` state. When a checkbox was both checked and disabled, the blue accent background (`$components-color-accent`) rendered at full opacity, making it visually indistinguishable from an enabled checkbox.

This was visible in the DataForm field types boolean story where setting `disabled: true` had no visual effect on the checkbox.

Before | After 
--- | ---
<img width="1082" height="769" alt="Screenshot 2026-04-08 at 11 30 08" src="https://github.com/user-attachments/assets/4f0d8742-39ee-4348-9e40-ac7c43bb0af3" /> | <img width="1082" height="769" alt="Screenshot 2026-04-08 at 11 24 18" src="https://github.com/user-attachments/assets/7b06f7c0-72ea-4d66-92bd-66997e0792d5" />


## How?

- Added `:disabled` styles to `packages/components/src/checkbox-control/style.scss`:
  - `opacity: 0.3` on `.components-checkbox-control__input-container:has(:disabled)` to dim both the custom-styled input and the absolutely-positioned SVG checkmark icon uniformly — matching the toggle's disabled opacity.
  - `cursor: default` on the disabled input and on the label (via `.components-checkbox-control:has(:disabled)`).
- Updated the DataForm Layout Regular story to use `Edit: 'toggle'` for the `can_comment` field and moved it next to the `sticky` checkbox so both boolean control variants are visible together.

## Testing Instructions

1. Run `npm run storybook`.
2. Navigate to **DataViews > DataForm > Layout Regular**.
3. Enable the checkbox and toggle controls.
4. In the Controls panel, set **disabled** to `True`.
5. Verify the checkbox and toggle all appear visually muted/disabled with similar opacity.
...
### github-actions on 2026-04-08T09:25:04Z

URL: https://github.com/WordPress/gutenberg/pull/77132#issuecomment-4205213939
...
### github-actions on 2026-04-08T09:38:10Z

URL: https://github.com/WordPress/gutenberg/pull/77132#issuecomment-4205293786
...
| :--- | :---: | :---: |
| `build/styles/components/style-rtl.css` | 17.2 kB | +54 B (+0.32%) |
| `build/styles/components/style-rtl.min.css` | 14 kB | +53 B (+0.38%) |
| `build/styles/components/style.css` | 17.2 kB | +52 B (+0.3%) |
| `build/styles/components/style.min.css` | 14 kB | +46 B (+0.33%) |
...
### github-actions on 2026-04-08T09:59:29Z

URL: https://github.com/WordPress/gutenberg/pull/77132#issuecomment-4205418950

<!-- flaky-tests-report-comment -->
**Flaky tests detected in da276f1c894fb26435346dedbe2eff8136bbb880.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/24204880620
📝  Reported issues:
...
### oandregal on 2026-04-08T12:07:01Z

URL: https://github.com/WordPress/gutenberg/pull/77132#issuecomment-4206103770

~There's this conversation about whether we go this route or another that's important to figure out for this PR to land: https://github.com/WordPress/gutenberg/pull/77127#issuecomment-4205630869~ 
...
### oandregal on 2026-04-09T18:08:18Z

URL: https://github.com/WordPress/gutenberg/pull/77132#issuecomment-4216417276

@mirka This PR makes the enabled checkbox gray when disabled (as opposed to using oppacity), and so we'd have this:

False | True
--- | ---
<img width="663" height="265" alt="Screenshot 2026-04-09 at 20 05 33" src="https://github.com/user-attachments/assets/6de4d6bf-2e1c-4494-bd7a-321d8d91087b" /> |<img width="663" height="265" alt="Screenshot 2026-04-09 at 20 05 22" src="https://github.com/user-attachments/assets/7e0e9e9c-863e-4bb2-a322-296df8f72dfa" /> 

What are your thoughts of doing the same for the toggle control (as opposed to using opacity, like this was doing before)?

### mirka on 2026-04-09T18:12:42Z

URL: https://github.com/WordPress/gutenberg/pull/77132#issuecomment-4216441339

Oh, I somehow assumed a `ToggleControl` PR would be coming up in my queue 😂 I'll fix the `ToggleControl` to stop doing the accent color when disabled. Gray is correct when disabled.

### mirka on 2026-04-09T19:07:39Z

URL: https://github.com/WordPress/gutenberg/pull/77132#issuecomment-4216817923

`FormToggle` disabled styles update in #77208

## Review threads

### Review thread 1 (resolved)

#### oandregal on 2026-04-09T14:40:04Z

URL: https://github.com/WordPress/gutenberg/pull/77132#discussion_r3058612957
...
#### mirka on 2026-04-09T17:50:12Z

URL: https://github.com/WordPress/gutenberg/pull/77132#discussion_r3059689485
...
#### mirka on 2026-04-09T17:51:35Z

URL: https://github.com/WordPress/gutenberg/pull/77132#discussion_r3059696376
Path: packages/components/CHANGELOG.md
...
#### mirka on 2026-04-09T17:54:55Z

URL: https://github.com/WordPress/gutenberg/pull/77132#discussion_r3059718053
...
- packages/components/src/checkbox-control/style.scss (MODIFIED, +16/-4)
...
- packages/dataviews/src/dataform/stories/layout-regular.tsx (MODIFIED, +2/-2)
