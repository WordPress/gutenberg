...
type: pull_request
state: MERGED
merged_at: 2026-04-17T11:01:55Z
url: https://github.com/WordPress/gutenberg/pull/77338
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Developer Documentation","[Package] UI"]
---

# PR #77338: UI/Docs: Clarify package setup for custom WP Admin pages

- URL: https://github.com/WordPress/gutenberg/pull/77338
- Author: ciampo
- Created: 2026-04-14T15:48:07Z
- Updated: 2026-04-17T11:02:44Z
- Comments: 3 of 3
- Review threads: 2 of 2
- Changed files: 2 of 2
- Diff: ../pr-diffs/77338.diff
...
### github-actions on 2026-04-14T15:48:22Z

URL: https://github.com/WordPress/gutenberg/pull/77338#issuecomment-4245269477
...
### github-actions on 2026-04-14T16:02:00Z

URL: https://github.com/WordPress/gutenberg/pull/77338#issuecomment-4245367029
...
### github-actions on 2026-04-14T17:19:23Z

URL: https://github.com/WordPress/gutenberg/pull/77338#issuecomment-4245833444

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 02dfd79f474532dc94a6d6edb986d5eecb09af98.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/24554145182
📝  Reported issues:
...
#### simison on 2026-04-14T18:37:31Z

URL: https://github.com/WordPress/gutenberg/pull/77338#discussion_r3081638863
...
Could also mention pages built in plugins with "WP Build tool"?

#### ciampo on 2026-04-14T19:30:24Z

URL: https://github.com/WordPress/gutenberg/pull/77338#discussion_r3081903443
Path: packages/ui/README.md
...
#### mirka on 2026-04-15T12:41:08Z

URL: https://github.com/WordPress/gutenberg/pull/77338#discussion_r3086486094
Path: packages/ui/README.md
...
- `@wordpress/ui` is already built with token fallback values, so it doesn't matter what build tool the consumer uses. Unless you want full theming capabilities, you don't need to set up the design tokens stylesheet.
- We might want to change the groupings to "Within standard WordPress editor screens" and "Elsewhere" then. The important thing is that consumers _don't_ add design tokens stylesheets and isolation styles themselves to a shared context like the standard editor screens. Setup should be handled centrally by Gutenberg itself.

#### ciampo on 2026-04-17T07:43:33Z

URL: https://github.com/WordPress/gutenberg/pull/77338#discussion_r3098648317
Path: packages/ui/README.md
...
Good points — the WP Build tool mention was misleading. Reworked the sections:

- Renamed to **"Within standard WordPress editor screens"** and **"Elsewhere"**
- Dropped the `@wordpress/scripts` mention entirely — the build tool isn't the relevant distinction
- The editor section now explicitly says not to add setup yourself in that shared context, to prevent conflicts
- The "Elsewhere" section notes that components work out of the box with fallbacks, and the design tokens stylesheet is only needed for full theming capabilities
