...
url: https://github.com/WordPress/gutenberg/pull/54903
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #54903: Tidying `CircularOptionPicker.Option`

- URL: https://github.com/WordPress/gutenberg/pull/54903
- Author: andrewhayward
- Created: 2023-09-28T09:08:45Z
- Updated: 2023-09-29T09:52:05Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 4 of 4
- Diff: ../pr-diffs/54903.diff
...
### github-actions on 2023-09-28T09:18:59Z

URL: https://github.com/WordPress/gutenberg/pull/54903#issuecomment-1738783788
...
| `build/block-editor/index.min.js` | 218 kB | +21 B (0%) |
| `build/block-library/index.min.js` | 207 kB | +32 B (0%) |
| `build/blocks/index.min.js` | 51.5 kB | +7 B (0%) |
| `build/commands/index.min.js` | 15.5 kB | +6 B (0%) |
| `build/components/index.min.js` | 248 kB | +56 B (0%) |
| `build/components/style-rtl.css` | 11.9 kB | +23 B (0%) |
| `build/components/style.css` | 11.9 kB | +24 B (0%) |
...
| `build/edit-site/index.min.js` | 185 kB | +49 B (0%) |
...
### github-actions on 2023-09-28T10:28:47Z

URL: https://github.com/WordPress/gutenberg/pull/54903#issuecomment-1738885655

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 7fc9c022235b4aa690da76fd24bc6ce88212b009.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/6337308503
📝  Reported issues:
- #47916 in `/test/e2e/specs/editor/various/autocomplete-and-mentions.spec.js`

### madhusudhand on 2023-09-29T08:51:25Z

URL: https://github.com/WordPress/gutenberg/pull/54903#issuecomment-1740537243

@andrewhayward This change brought the following side effect on tab-panel component.

Before:
<img width="1002" alt="image" src="https://github.com/WordPress/gutenberg/assets/1935113/9175ad6d-f813-4fe3-a9cc-26404ac4a83b">

After:
<img width="1002" alt="image" src="https://github.com/WordPress/gutenberg/assets/1935113/584df932-11ae-4f54-ad5b-6a083f3d1203">

Steps:
1. Under global styles -> typography, click on `Aa` or any font to invoke the font library modal.
2. Observe that active tab is given black background.

### andrewhayward on 2023-09-29T09:52:05Z

URL: https://github.com/WordPress/gutenberg/pull/54903#issuecomment-1740619801
...
- packages/components/src/circular-option-picker/circular-option-picker-option.tsx (MODIFIED, +9/-11)
- packages/components/src/circular-option-picker/style.scss (MODIFIED, +2/-1)
