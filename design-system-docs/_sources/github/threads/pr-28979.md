...
type: pull_request
state: MERGED
merged_at: 2021-02-16T17:04:11Z
url: https://github.com/WordPress/gutenberg/pull/28979
...
# PR #28979: Components: Add hooks based Scrollable component wrapper

- URL: https://github.com/WordPress/gutenberg/pull/28979
- Author: sarayourfriend
- Created: 2021-02-12T19:18:51Z
- Updated: 2021-02-16T17:04:36Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 9 of 9
- Diff: ../pr-diffs/28979.diff
...
## Description
Adds a hooks based `Scrollable` component. This component wraps a View and makes it scrollable.
...
### github-actions on 2021-02-12T19:28:05Z

URL: https://github.com/WordPress/gutenberg/pull/28979#issuecomment-778404229
...
| `build/block-directory/index.js` | 9.1 kB | +12 B (0%) |  |
| `build/block-editor/index.js` | 124 kB | +102 B (0%) |  |
...
| `build/block-library/index.js` | 145 kB | +178 B (0%) |  |
| `build/block-serialization-default-parser/index.js` | 1.88 kB | -1 B (0%) |  |
| `build/blocks/index.js` | 48.3 kB | +39 B (0%) |  |
| `build/components/index.js` | 272 kB | +2.58 kB (+1%) |  |
| `build/compose/index.js` | 11 kB | +25 B (0%) |  |
...
| `build/editor/index.js` | 41.9 kB | +12 B (0%) |  |
...
- packages/components/src/ui/scrollable/README.md (ADDED, +31/-0)
- packages/components/src/ui/scrollable/component.js (ADDED, +30/-0)
- packages/components/src/ui/scrollable/hook.js (ADDED, +45/-0)
- packages/components/src/ui/scrollable/index.js (ADDED, +3/-0)
- packages/components/src/ui/scrollable/stories/index.js (ADDED, +18/-0)
- packages/components/src/ui/scrollable/styles.js (ADDED, +59/-0)
- packages/components/src/ui/scrollable/test/__snapshots__/index.js.snap (ADDED, +91/-0)
- packages/components/src/ui/scrollable/test/index.js (ADDED, +31/-0)
- packages/components/src/ui/scrollable/types.ts (ADDED, +16/-0)
