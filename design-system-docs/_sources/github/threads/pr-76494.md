...
type: pull_request
state: MERGED
merged_at: 2026-03-17T18:23:12Z
url: https://github.com/WordPress/gutenberg/pull/76494
matched_labels: ["Design System","[Package] Components","[Package] UI"]
all_labels: ["[Type] Enhancement","[Package] Components","[Package] Block editor","[Package] Edit Site","[Package] Base styles","Design System","[Package] UI"]
---

# PR #76494: Adopt surface-width design tokens for Dialog, Notice, and Modal widths

- URL: https://github.com/WordPress/gutenberg/pull/76494
- Author: jameskoster
- Created: 2026-03-13T15:13:56Z
- Updated: 2026-03-17T18:25:39Z
- Comments: 6 of 6
- Review threads: 8 of 8
- Changed files: 13 of 13
- Diff: ../pr-diffs/76494.diff

## Body

Follow-up to https://github.com/WordPress/gutenberg/pull/76047.
...
| Before | After |
| --- | --- |
| <img width="543" height="339" alt="Screenshot 2026-03-13 at 15 11 08" src="https://github.com/user-attachments/assets/e2619b7c-e289-43ab-8017-b68c12ee9a2f" /> | <img width="540" height="326" alt="Screenshot 2026-03-13 at 15 11 19" src="https://github.com/user-attachments/assets/225c10ab-a24f-4d1b-b35e-18a4b9e3fc61" /> |
...
### github-actions on 2026-03-13T15:16:20Z

URL: https://github.com/WordPress/gutenberg/pull/76494#issuecomment-4055921984
...
### github-actions on 2026-03-13T15:40:10Z

URL: https://github.com/WordPress/gutenberg/pull/76494#issuecomment-4056083068

<!-- flaky-tests-report-comment -->
**Flaky tests detected in fcb71f01eaa462f0d539ea23b90214426543bc29.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/23207913834
📝  Reported issues:
...
### github-actions on 2026-03-16T16:29:40Z

URL: https://github.com/WordPress/gutenberg/pull/76494#issuecomment-4068981247
...
| :--- | :---: | :---: |
| `build/styles/components/style-rtl.css` | 17 kB | +29 B (+0.17%) |
| `build/styles/components/style-rtl.min.css` | 13.8 kB | +37 B (+0.27%) |
| `build/styles/components/style.css` | 17.1 kB | +30 B (+0.18%) |
| `build/styles/components/style.min.css` | 13.8 kB | +37 B (+0.27%) |
| `build/styles/edit-site/style-rtl.css` | 20.8 kB | -5 B (-0.02%) |
| `build/styles/edit-site/style-rtl.min.css` | 16.9 kB | -1 B (-0.01%) |
| `build/styles/edit-site/style.css` | 20.8 kB | -5 B (-0.02%) |
| `build/styles/edit-site/style.min.css` | 16.9 kB | -1 B (-0.01%) |
...
| `build/scripts/upload-media/index.min.js` | 7.87 kB |
...
### ciampo on 2026-03-16T16:31:17Z

URL: https://github.com/WordPress/gutenberg/pull/76494#issuecomment-4068991852
...
### jameskoster on 2026-03-16T16:48:02Z

URL: https://github.com/WordPress/gutenberg/pull/76494#issuecomment-4069104797

@ciampo would you prefer to update any component with a hard-coded width in this PR? `Snackbar` should be trivial. `Guide` will need some attention because instances in the Editor it contain images that have been designed to suit the current width. That's why I was inclined to leave it out of this PR. I suppose we could add TODO's where appropriate...

### ciampo on 2026-03-17T13:47:12Z

URL: https://github.com/WordPress/gutenberg/pull/76494#issuecomment-4075088066

> @ciampo would you prefer to update any component with a hard-coded width in this PR? `Snackbar` should be trivial. `Guide` will need some attention because instances in the Editor it contain images that have been designed to suit the current width. That's why I was inclined to leave it out of this PR. I suppose we could add TODO's where appropriate...

I'm definitely ok with working on those components in follow-ups, as far as we can still somehow apply the current tokens.

What I want to avoid is having a set of tokens that don't suit our needs. So I think we're aligned?

## Review threads

### Review thread 1 (resolved)

#### mirka on 2026-03-13T16:36:00Z

URL: https://github.com/WordPress/gutenberg/pull/76494#discussion_r2932419790
...
#### jameskoster on 2026-03-16T16:04:46Z

URL: https://github.com/WordPress/gutenberg/pull/76494#discussion_r2941375423
Path: packages/components/CHANGELOG.md
...
No, if they're available in this context let's use them :)

#### jameskoster on 2026-03-16T16:07:26Z

URL: https://github.com/WordPress/gutenberg/pull/76494#discussion_r2941392708
Path: packages/components/CHANGELOG.md
...
I guess we can mark the scss vars as deprecated and add todos to replace them.

### Review thread 2 (resolved)

#### mirka on 2026-03-13T16:38:23Z

URL: https://github.com/WordPress/gutenberg/pull/76494#discussion_r2932435009
Path: packages/components/CHANGELOG.md

Should we remove this comment now?

https://github.com/WordPress/gutenberg/blob/d660ae426df24b201a66a412df352bcc6a284ce8/packages/components/src/modal/style.scss#L91-L93

### Review thread 3 (resolved)

#### mirka on 2026-03-13T16:40:03Z

URL: https://github.com/WordPress/gutenberg/pull/76494#discussion_r2932445842
...
#### jameskoster on 2026-03-16T16:17:38Z

URL: https://github.com/WordPress/gutenberg/pull/76494#discussion_r2941458165
Path: packages/block-editor/src/components/link-control/style.scss

```diff
@@ -18,12 +18,13 @@ $block-editor-link-control-number-of-actions: 1;
...
I replaced this with a hard-coded value for now because the new modal min-width value caused a small visual regression:

<img width="391" height="354" alt="Screenshot 2026-03-16 at 16 08 58" src="https://github.com/user-attachments/assets/784a8cb8-c7ed-47ed-b162-a2fc720741c0" />

#### ciampo on 2026-03-16T16:20:05Z

URL: https://github.com/WordPress/gutenberg/pull/76494#discussion_r2941472450
Path: packages/block-editor/src/components/link-control/style.scss
...
#### jameskoster on 2026-03-16T16:24:43Z

URL: https://github.com/WordPress/gutenberg/pull/76494#discussion_r2941498580
Path: packages/block-editor/src/components/link-control/style.scss
...
#### ciampo on 2026-03-16T16:27:33Z

URL: https://github.com/WordPress/gutenberg/pull/76494#discussion_r2941513568
Path: packages/block-editor/src/components/link-control/style.scss
...
#### jameskoster on 2026-03-16T16:58:09Z

URL: https://github.com/WordPress/gutenberg/pull/76494#discussion_r2941692526
Path: packages/block-editor/src/components/link-control/style.scss
...
#### mirka on 2026-03-17T15:49:06Z

URL: https://github.com/WordPress/gutenberg/pull/76494#discussion_r2947771675
Path: packages/block-editor/src/components/link-control/style.scss
...
To clarify, design tokens are now available for use in _any_ packages built in this repo, at least in a minimally viable way. The `design-tokens` stylesheet doesn't have to be loaded for it to work (due to fallback values being injected at build time), and accent colors shades will be roughly appropriate for the colors set by `--wp-admin-theme-color`.

### Review thread 5 (resolved)

#### ciampo on 2026-03-16T16:21:07Z

URL: https://github.com/WordPress/gutenberg/pull/76494#discussion_r2941478508
Path: packages/base-styles/CHANGELOG.md
...
We should probably also mention that the values held by the SASS variables have changed?

### Review thread 6 (resolved)

#### ciampo on 2026-03-16T16:24:31Z

URL: https://github.com/WordPress/gutenberg/pull/76494#discussion_r2941497397
...
Have you tried using the DS token in the container query? I haven't looked into it much, but I assumed it should work? (as far as the value doesn't change dynamically)

#### jameskoster on 2026-03-16T16:39:02Z

URL: https://github.com/WordPress/gutenberg/pull/76494#discussion_r2941579257
Path: packages/ui/src/notice/style.module.css
...
I was surprised too, but they don't work;
...
#### ciampo on 2026-03-16T17:43:42Z

URL: https://github.com/WordPress/gutenberg/pull/76494#discussion_r2941944728
Path: packages/ui/src/notice/style.module.css
...
Werid, I thought they worked according to [this change](https://github.com/w3c/csswg-drafts/issues/8088)

So, they don't work locally on your machine?

#### jameskoster on 2026-03-17T13:01:50Z

URL: https://github.com/WordPress/gutenberg/pull/76494#discussion_r2946613785
Path: packages/ui/src/notice/style.module.css
...
Correct, it's not working for me.

#### ciampo on 2026-03-17T13:47:27Z

URL: https://github.com/WordPress/gutenberg/pull/76494#discussion_r2946902251
Path: packages/ui/src/notice/style.module.css
...
#### ciampo on 2026-03-16T16:29:23Z

URL: https://github.com/WordPress/gutenberg/pull/76494#discussion_r2941523343
Path: packages/block-editor/src/components/url-popover/style.scss
...
Should we add the same TODO comment here, too?

### Review thread 8 (resolved)

#### ciampo on 2026-03-17T13:49:09Z

URL: https://github.com/WordPress/gutenberg/pull/76494#discussion_r2946913275
Path: packages/block-editor/src/components/link-control/style.scss
...
Nit: missing TODO here, too.

## Changed files

- packages/base-styles/CHANGELOG.md (MODIFIED, +4/-0)
- packages/base-styles/_variables.scss (MODIFIED, +6/-4)
- packages/block-editor/src/components/link-control/style.scss (MODIFIED, +4/-2)
...
- packages/components/src/modal/style.scss (MODIFIED, +4/-7)
- packages/components/src/snackbar/style.scss (MODIFIED, +1/-0)
- packages/edit-site/src/components/page-patterns/style.scss (MODIFIED, +1/-0)
- packages/ui/CHANGELOG.md (MODIFIED, +1/-0)
- packages/ui/src/dialog/style.module.css (MODIFIED, +5/-5)
- packages/ui/src/dialog/types.ts (MODIFIED, +3/-3)
