...
type: pull_request
state: MERGED
merged_at: 2022-08-26T09:43:35Z
url: https://github.com/WordPress/gutenberg/pull/43570
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components"]
---

# PR #43570: ColorPalette: Make popover style consistent

- URL: https://github.com/WordPress/gutenberg/pull/43570
- Author: mirka
- Created: 2022-08-24T10:15:18Z
- Updated: 2022-08-26T09:45:41Z
- Comments: 3 of 3
- Review threads: 2 of 2
- Changed files: 4 of 4
- Diff: ../pr-diffs/43570.diff
...
### github-actions on 2022-08-24T12:14:03Z

URL: https://github.com/WordPress/gutenberg/pull/43570#issuecomment-1225639703
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 198 kB | +20 B (0%) |
...
### jameskoster on 2022-08-24T14:02:02Z

URL: https://github.com/WordPress/gutenberg/pull/43570#issuecomment-1225769937

Thanks for working on this, it's working as advertised for me. 

While we're here, it might be nice to make the panels the same width, assuming it's not too much work? If so, we can tackle it later :)

### mirka on 2022-08-25T03:27:35Z

URL: https://github.com/WordPress/gutenberg/pull/43570#issuecomment-1226727854

> While we're here, it might be nice to make the panels the same width, assuming it's not too much work? If so, we can tackle it later :)

It looks like the ColorPicker width is pretty [tightly hardcoded](https://github.com/WordPress/gutenberg/search?q=%22216px%22), so let's tackle it separately 👍 (Also relevant: We're planning on reducing the circular swatch size from 28px to a consistent 20px soon.)

## Review threads

### Review thread 1

#### mirka on 2022-08-24T10:16:08Z

URL: https://github.com/WordPress/gutenberg/pull/43570#discussion_r953615120
...
#### mirka on 2022-08-24T10:16:50Z

URL: https://github.com/WordPress/gutenberg/pull/43570#discussion_r953615743
Path: packages/components/src/color-palette/style.scss
...
- packages/components/src/color-palette/index.js (MODIFIED, +8/-5)
- packages/components/src/color-palette/style.scss (MODIFIED, +0/-14)
- packages/components/src/color-palette/test/__snapshots__/index.js.snap (MODIFIED, +11/-4)
