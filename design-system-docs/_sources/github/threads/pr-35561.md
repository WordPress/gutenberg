...
type: pull_request
state: MERGED
merged_at: 2021-10-13T11:09:59Z
url: https://github.com/WordPress/gutenberg/pull/35561
...
# PR #35561: Components: remove unused `useJumpStep` utility

- URL: https://github.com/WordPress/gutenberg/pull/35561
- Author: ciampo
- Created: 2021-10-12T16:33:32Z
- Updated: 2021-10-13T11:10:23Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 4 of 4
- Diff: ../pr-diffs/35561.diff
...
Remove the unused `useJumpStep` function as discussed in https://github.com/WordPress/gutenberg/issues/34817
...
### github-actions on 2021-10-12T16:42:11Z

URL: https://github.com/WordPress/gutenberg/pull/35561#issuecomment-941184408
...
| :--- | :---: | :---: | :---: |
| `build/block-editor/index.min.js` | 134 kB | +7 B (0%) |  |
...
| `build/block-library/editor-rtl.css` | 9.83 kB | +38 B (0%) |  |
| `build/block-library/editor.css` | 9.83 kB | +38 B (0%) |  |
| `build/block-library/index.min.js` | 148 kB | +54 B (0%) |  |
...
### ciampo on 2021-10-13T08:47:32Z

URL: https://github.com/WordPress/gutenberg/pull/35561#issuecomment-942074160

Thank you for the quick review!

> Also, it looks like we aren't exporting the functions from `/packages/components/src/utils/` in [wordpress/gutenberg@`trunk`/packages/components/src/index.js](https://github.com/wordpress/gutenberg/blob/trunk/packages/components/src/index.js), so I assume it's safe to remove the utility function without adding a removal entry to the components package [changelog](https://github.com/wordpress/gutenberg/blob/a90686ba8ba9b27f137020157d6dbf2e8069f8d3/packages/components/CHANGELOG.md) file.

Yeah, at this point this is just an internal change. I still went ahead and added it to the CHANGELOG under the `Internal` section, mostly for having a future reference in the repo to this PR.
...
- packages/components/src/utils/hooks/test/use-jump-step.js (DELETED, +0/-127)
- packages/components/src/utils/hooks/use-jump-step.js (DELETED, +0/-51)
