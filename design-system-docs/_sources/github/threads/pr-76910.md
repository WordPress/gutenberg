...
type: pull_request
state: MERGED
merged_at: 2026-03-31T17:39:36Z
url: https://github.com/WordPress/gutenberg/pull/76910
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Enhancement","[Package] UI"]
---

# PR #76910: UI/Dialog: deprioritize close icon for initial focus

- URL: https://github.com/WordPress/gutenberg/pull/76910
- Author: ciampo
- Created: 2026-03-30T18:09:41Z
- Updated: 2026-03-31T17:42:36Z
- Comments: 6 of 6
- Review threads: 4 of 4
- Changed files: 8 of 8
- Diff: ../pr-diffs/76910.diff
...
### github-actions on 2026-03-30T18:21:44Z

URL: https://github.com/WordPress/gutenberg/pull/76910#issuecomment-4157169321
...
### github-actions on 2026-03-30T18:39:42Z

URL: https://github.com/WordPress/gutenberg/pull/76910#issuecomment-4157290961

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 1b7a7f3e8be279b01686b6f7a0bb462b9bcfe2e7.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/23808321092
📝  Reported issues:
...
### github-actions on 2026-03-30T20:21:42Z

URL: https://github.com/WordPress/gutenberg/pull/76910#issuecomment-4157936973
...
### carolinan on 2026-03-31T06:44:03Z

URL: https://github.com/WordPress/gutenberg/pull/76910#issuecomment-4160314605

(@sethrubenstein this is relevant also for the block.)

### ciampo on 2026-03-31T08:23:24Z

URL: https://github.com/WordPress/gutenberg/pull/76910#issuecomment-4160813720

@carolinan @sethrubenstein I'm not sure which "block" you're referring to, but to clarify, this component is not for an end-user-facing dialog; it's for the editor and admin interfaces.

To add some extra context, this change affects the `Dialog` component from the `@wordpress/ui` package, ie. the new set of UI primitives that we're building for the editor and admin interface. It's meant to add a better/smarter default "initial focus" when the dialog is opened, while still allowing consumers of the component to pass a custom behavior if needed.

### carolinan on 2026-03-31T08:29:45Z

URL: https://github.com/WordPress/gutenberg/pull/76910#issuecomment-4160850426

Yes, that is clear, but the same, avoid focusing on the close icon by default (if there are other focusable elements) should be considered for [the dialog block.](https://github.com/WordPress/gutenberg/issues/61297)

## Review threads

### Review thread 1 (resolved)

#### aduth on 2026-03-31T14:10:29Z

URL: https://github.com/WordPress/gutenberg/pull/76910#discussion_r3016186808
Path: packages/ui/src/dialog/popup.tsx

```diff
@@ -13,6 +15,21 @@ import type { PopupProps } from './types';
...
I'm not familiar with this formatting for `@see`, is it intentional? Or should it be something like...

```suggestion
 * @see https://github.com/floating-ui/floating-ui/blob/master/packages/react/src/utils/tabbable.ts
```

#### aduth on 2026-03-31T14:13:03Z

URL: https://github.com/WordPress/gutenberg/pull/76910#discussion_r3016203271
Path: packages/ui/src/dialog/popup.tsx
...
Out of curiosity, could we import this function directly from [`@floating-ui/react/utils`](https://github.com/floating-ui/floating-ui/blob/d8020ee98c702caa31fa9b4d929ca782c6b58c59/packages/react/package.json#L23-L31) ?

#### ciampo on 2026-03-31T16:22:00Z

URL: https://github.com/WordPress/gutenberg/pull/76910#discussion_r3016962492
Path: packages/ui/src/dialog/popup.tsx
...
Comment updated, but unfortunately I couldn't find a way to import from `@floating-ui` or `@base-ui`

### Review thread 2 (resolved)

#### aduth on 2026-03-31T14:14:11Z

URL: https://github.com/WordPress/gutenberg/pull/76910#discussion_r3016210202
Path: packages/ui/src/dialog/popup.tsx
...
Might be good to include some test coverage for this scenario.

#### ciampo on 2026-03-31T16:22:17Z

URL: https://github.com/WordPress/gutenberg/pull/76910#discussion_r3016964022
Path: packages/ui/src/dialog/popup.tsx
...
#### aduth on 2026-03-31T14:16:44Z

URL: https://github.com/WordPress/gutenberg/pull/76910#discussion_r3016225390
Path: packages/ui/src/dialog/popup.tsx
...
Minor code readabillity suggestion: Might be a good case for another early return:
...
#### ciampo on 2026-03-31T16:22:46Z

URL: https://github.com/WordPress/gutenberg/pull/76910#discussion_r3016966561
Path: packages/ui/src/dialog/popup.tsx
...
#### aduth on 2026-03-31T14:41:39Z

URL: https://github.com/WordPress/gutenberg/pull/76910#discussion_r3016382638
Path: packages/ui/src/dialog/popup.tsx
...
Side thought: Do we even need to merge these refs, or could we create a default in absence of one provided by the consumer and otherwise use their ref directly?

#### ciampo on 2026-03-31T16:24:02Z

URL: https://github.com/WordPress/gutenberg/pull/76910#discussion_r3016973218
Path: packages/ui/src/dialog/popup.tsx
...
As I refactored the code to a shared utility (since it will be needed by other overlays such as `Popover` and potentially `Drawer`), merging refs optionally was not really a choice, and therefore I kept the `useMergeRefs` call around.
...
- packages/ui/src/dialog/close-icon.tsx (MODIFIED, +1/-0)
- packages/ui/src/dialog/popup.tsx (MODIFIED, +12/-2)
- packages/ui/src/dialog/test/index.test.tsx (MODIFIED, +117/-0)
- packages/ui/src/utils/test/use-deprioritized-initial-focus.test.tsx (ADDED, +230/-0)
- packages/ui/src/utils/use-deprioritized-initial-focus.ts (ADDED, +83/-0)
