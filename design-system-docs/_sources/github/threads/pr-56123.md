...
type: pull_request
state: MERGED
merged_at: 2023-11-16T14:09:14Z
url: https://github.com/WordPress/gutenberg/pull/56123
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Focus] Accessibility (a11y)","[Package] Components","[Block] Image","[Block] Media & Text","[Package] Block editor"]
---

# PR #56123: Fix the image link button pressed state.

- URL: https://github.com/WordPress/gutenberg/pull/56123
- Author: afercia
- Created: 2023-11-14T16:26:00Z
- Updated: 2023-11-16T14:09:39Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 3 of 3
- Diff: ../pr-diffs/56123.diff
...
### github-actions on 2023-11-14T16:32:44Z

URL: https://github.com/WordPress/gutenberg/pull/56123#issuecomment-1810631063
...
| `build/components/style-rtl.css` | 12 kB | -6 B (0%) |
| `build/components/style.css` | 12 kB | -9 B (0%) |
...
### afercia on 2023-11-16T09:08:12Z

URL: https://github.com/WordPress/gutenberg/pull/56123#issuecomment-1814047395

@alexstine thanks for the review.

I'd still like to have a review about the `packages/components/src/toolbar/toolbar-button/style.scss` file. I suspect it's a remnant of a previous implementation to show some `subscript` text within buttons. I have the impression it is no longer in use and can be entirely removed but I'm not 100% sure.

I see occurrences of a `data-subscript` attribute and `subscript` prop in other two files:
packages/components/src/button/index.native.js
packages/components/src/toolbar/toolbar-button/index.tsx

### jasmussen on 2023-11-16T13:02:59Z

URL: https://github.com/WordPress/gutenberg/pull/56123#issuecomment-1814397542

Works well. In trunk a linked image has no visual change to the link button:

![before](https://github.com/WordPress/gutenberg/assets/1204802/65837b17-e09e-4b91-8d8a-b101b5d42f31)

In this PR, the link button appears toggled:

![after](https://github.com/WordPress/gutenberg/assets/1204802/e8893a37-81c2-4c6d-9d85-b0e7d35080e8)

These days I'm unable to respond with haste to pings, so it might be useful to ping the broader `@WordPress/gutenberg-design` when you need a quick check.

### afercia on 2023-11-16T14:08:40Z

URL: https://github.com/WordPress/gutenberg/pull/56123#issuecomment-1814503818

Thanks everyone for your feedback and reviews.
I didn't know about the @WordPress/gutenberg-design handle
I will split the `subscript` thing in a separate issue.
...
- packages/block-editor/src/components/url-popover/image-url-input-ui.js (MODIFIED, +1/-0)
- packages/components/CHANGELOG.md (MODIFIED, +4/-0)
- packages/components/src/toolbar/toolbar-button/style.scss (MODIFIED, +0/-5)
