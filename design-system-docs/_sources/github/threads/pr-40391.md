...
type: pull_request
state: MERGED
merged_at: 2022-04-20T15:25:21Z
url: https://github.com/WordPress/gutenberg/pull/40391
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components"]
---

# PR #40391: Components: Unify black color to gray-900

- URL: https://github.com/WordPress/gutenberg/pull/40391
- Author: mirka
- Created: 2022-04-15T17:48:05Z
- Updated: 2022-04-20T15:25:53Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 13 of 13
- Diff: ../pr-diffs/40391.diff
...
- Replace usage of pure black with gray-900.
- `Heading`: Replace usage of `#050505` with gray-900.
...
### github-actions on 2022-04-15T17:57:09Z

URL: https://github.com/WordPress/gutenberg/pull/40391#issuecomment-1100263633
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 223 kB | -57 B (0%) |
...
### mirka on 2022-04-19T17:28:46Z

URL: https://github.com/WordPress/gutenberg/pull/40391#issuecomment-1102906964

> I just noticed that the label in `InputControl` (and descendant components) is still using pure black in Storybook. The reason seems to be [this line of code](https://github.com/WordPress/gutenberg/blob/5c98447da4c6f8d52f52dae375d7b6d53e6ac4cb/packages/components/src/input-control/styles/input-control-styles.tsx#L248) — I quickly tried deleting it and it seemed to work fine, although I'm not sure why that rule was there in the first place 🤞
...
- packages/components/src/alignment-matrix-control/styles/alignment-matrix-control-styles.js (MODIFIED, +5/-3)
- packages/components/src/heading/hook.ts (MODIFIED, +1/-1)
- packages/components/src/heading/test/__snapshots__/index.js.snap (MODIFIED, +3/-3)
- packages/components/src/input-control/styles/input-control-styles.tsx (MODIFIED, +1/-2)
- packages/components/src/select-control/styles/select-control-styles.ts (MODIFIED, +1/-1)
...
- packages/components/src/ui/spinner/test/__snapshots__/index.js.snap (MODIFIED, +3/-3)
- packages/components/src/utils/colors-values.js (MODIFIED, +7/-11)
