...
type: pull_request
state: MERGED
merged_at: 2023-06-23T04:23:40Z
url: https://github.com/WordPress/gutenberg/pull/51018
...
# PR #51018: Autocomplete: Announce results to screen readers when first becoming visible

- URL: https://github.com/WordPress/gutenberg/pull/51018
- Author: alexstine
- Created: 2023-05-26T18:16:59Z
- Updated: 2023-06-23T04:24:05Z
- Comments: 13 of 13
- Review threads: 0 of 0
- Changed files: 4 of 4
- Diff: ../pr-diffs/51018.diff
...
Changes the `speak()` function to fire when autocomplete items change. This allows screen reader users to know how many results exist initially before filtering.
...
2. Add a new block.
3. Type "/".
4. Notice how the `aria-live="assertive"` region at the bottom of the page announces the initial 9 results. This uses debounce, wait a few seconds.
5. Enter another keyword and ensure the results are updated.
6. Pressing escape should close suggestions list.
...
### github-actions on 2023-05-26T18:31:13Z

URL: https://github.com/WordPress/gutenberg/pull/51018#issuecomment-1564775550
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 240 kB | +70 B (0%) |
...
### github-actions on 2023-05-27T18:34:18Z

URL: https://github.com/WordPress/gutenberg/pull/51018#issuecomment-1565638630

<!-- flaky-tests-report-comment -->
**Flaky tests detected in b501426dcc6afdf43c74e28a9eff69ec63a872df.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/5106252126
📝  Reported issues:
- #50799 in `/test/e2e/specs/site-editor/style-book.spec.js`

### joedolson on 2023-05-28T16:12:43Z

URL: https://github.com/WordPress/gutenberg/pull/51018#issuecomment-1566186659
...
1) Differentiate between initial state and search results (e.g. "9 most recent blocks shown. Use arrow keys..." vs. "9 results found"
2) Provide instructions in initial state. "9 most recent blocks shown. Start typing to search blocks. Use arrow keys..."

### alexstine on 2023-05-28T16:20:29Z

URL: https://github.com/WordPress/gutenberg/pull/51018#issuecomment-1566190401

@joedolson This field has a label already? Type slash to insert a block or start typing to create a paragraph block.

### alexstine on 2023-05-28T16:21:45Z

URL: https://github.com/WordPress/gutenberg/pull/51018#issuecomment-1566190631
...
### joedolson on 2023-05-28T16:24:24Z

URL: https://github.com/WordPress/gutenberg/pull/51018#issuecomment-1566191149

This is about the state when you first type the slash. The results brought up are not search results, and there's no information about what they are or what to do if the block you want isn't in that collection.

Seems like you'd know it was initial state just be catching the keycode of the slash character. Is there a reason that wouldn't work?

### alexstine on 2023-05-28T19:06:43Z

URL: https://github.com/WordPress/gutenberg/pull/51018#issuecomment-1566232329
...
### alexstine on 2023-05-28T20:24:04Z

URL: https://github.com/WordPress/gutenberg/pull/51018#issuecomment-1566251713
...
### joedolson on 2023-05-28T20:34:37Z

URL: https://github.com/WordPress/gutenberg/pull/51018#issuecomment-1566254406

Definitely moving in the right direction. My only quibble here is that the text implies that you're filtering the initial set (e.g, you've been given a set that contains all results, and you're filtering those results), but you've actually only been given a subset. Filtering allows you to filter the set of all blocks, not just the initial set.

That might be a subtlety that isn't really crucial, however. It's definitely better than it was before!

### alexstine on 2023-05-28T22:02:16Z

URL: https://github.com/WordPress/gutenberg/pull/51018#issuecomment-1566279670

@joedolson I tried again. Maybe now it is clear?

### joedolson on 2023-06-01T15:48:20Z

URL: https://github.com/WordPress/gutenberg/pull/51018#issuecomment-1572304415
...
### chad1008 on 2023-06-01T16:45:59Z

URL: https://github.com/WordPress/gutenberg/pull/51018#issuecomment-1572400719

I was actually keying in more on the word "initial", because with a small dataset, the items displayed aren't "initial" (which implies there are more that aren't currently shown). If a given completer returns a short enough list (like the three-user site example above) the completer will open with the _full_ list. I don't think it's a huge problem, and the cases where it actually causes any confusion will be few and far between.

### joedolson on 2023-06-01T16:47:42Z

URL: https://github.com/WordPress/gutenberg/pull/51018#issuecomment-1572404565
...
- packages/components/src/autocomplete/autocompleter-ui.tsx (MODIFIED, +44/-2)
- packages/components/src/autocomplete/index.tsx (MODIFIED, +2/-32)
- test/e2e/specs/editor/various/autocomplete-and-mentions.spec.js (MODIFIED, +28/-0)
