...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/55015
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Task","[Package] Components"]
---

# PR #55015: Components: Add itemToString to custom-select-control props

- URL: https://github.com/WordPress/gutenberg/pull/55015
- Author: jeyip
- Created: 2023-10-03T18:12:15Z
- Updated: 2025-02-10T16:48:24Z
- Comments: 5 of 5
- Review threads: 0 of 0
- Changed files: 4 of 4
- Diff: ../pr-diffs/55015.diff
...
### github-actions on 2023-10-03T18:24:19Z

URL: https://github.com/WordPress/gutenberg/pull/55015#issuecomment-1745499623
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 249 kB | +2 B (0%) |
...
### github-actions on 2023-10-03T19:15:22Z

URL: https://github.com/WordPress/gutenberg/pull/55015#issuecomment-1745572565

<!-- flaky-tests-report-comment -->
**Flaky tests detected in d330ffd0172f4c5741f2d8fb028d6f00fcd52307.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/6485504771
📝  Reported issues:
- #47916 in `/test/e2e/specs/editor/various/autocomplete-and-mentions.spec.js`

### jeyip on 2023-10-03T19:54:22Z

URL: https://github.com/WordPress/gutenberg/pull/55015#issuecomment-1745630233

**Note:**

I'm currently thinking about whether or not we need to and how we'd rename `itemToString` for the CustomSelectControl interface 🤔 

_Edit:_ I still think that `itemToString` doesn't convey the prop's purpose well, so I feel like we _should_ rename it for CustomSelectControl's public interface, but I'm unsure what a good name would look like. Perhaps something like `getAccessibilitySelectionMessage`

_Edit 2:_ After more consideration and discussion with Dehan, perhaps `itemToString` is intuitive enough. Leaving the naming as is for now

```
Item -> Colloquially talks about <select> items
toString -> Colloquially talks about the toString of an object
```

### ciampo on 2023-10-17T07:18:53Z

URL: https://github.com/WordPress/gutenberg/pull/55015#issuecomment-1765812581

Hey @jeyip !

Thank you for working on this!

Coincidentally, we have just started working on a CustomSelectControl rewrite, which will introduce the option to pass react 'children' directly to the component.

Therefore, my suggestions here is that we put this PR on hold, since the new version of the component should support your use case.

cc @brookewp

### jeyip on 2023-10-18T17:40:37Z

URL: https://github.com/WordPress/gutenberg/pull/55015#issuecomment-1769033295

Closing this PR in regards to Marco's comment https://github.com/WordPress/gutenberg/pull/55015#issuecomment-1765812581
...
- packages/components/src/custom-select-control/README.md (MODIFIED, +8/-1)
- packages/components/src/custom-select-control/index.js (MODIFIED, +3/-2)
- packages/components/src/custom-select-control/stories/index.story.js (MODIFIED, +38/-0)
