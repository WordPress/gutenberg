...
type: pull_request
state: MERGED
merged_at: 2026-01-09T16:14:17Z
url: https://github.com/WordPress/gutenberg/pull/74463
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Enhancement","[Package] UI"]
---

# PR #74463: `@wordpress/ui` `Button`: add `destructive` tone

- URL: https://github.com/WordPress/gutenberg/pull/74463
- Author: ciampo
- Created: 2026-01-08T17:08:55Z
- Updated: 2026-01-12T10:48:38Z
- Comments: 11 of 11
- Review threads: 2 of 2
- Changed files: 3 of 3
- Diff: ../pr-diffs/74463.diff
...
### github-actions on 2026-01-08T17:09:09Z

URL: https://github.com/WordPress/gutenberg/pull/74463#issuecomment-3724840758
...
### ciampo on 2026-01-08T17:11:34Z

URL: https://github.com/WordPress/gutenberg/pull/74463#issuecomment-3724849526

@jameskoster let me know if I'm using the correct tokens (for example, was I supposed to use `--wpds-color-stroke-interactive-error-strong` at all?)

### github-actions on 2026-01-08T17:20:07Z

URL: https://github.com/WordPress/gutenberg/pull/74463#issuecomment-3724882984
...
| `build/scripts/media-utils/index.min.js` | 71.1 kB |
...
### ciampo on 2026-01-09T09:16:51Z

URL: https://github.com/WordPress/gutenberg/pull/74463#issuecomment-3728001295

Cool! Maybe let's wait for designers' feedback too before merging

### fcoveram on 2026-01-09T09:23:44Z

URL: https://github.com/WordPress/gutenberg/pull/74463#issuecomment-3728034805

Looking at the recording. It looks great to me ✨

### github-actions on 2026-01-09T09:36:36Z

URL: https://github.com/WordPress/gutenberg/pull/74463#issuecomment-3728088908

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 197e678e841574a187e80cc03ebe3d5bed333e35.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/20847013101
📝  Reported issues:
- #44332 in `/test/e2e/specs/editor/various/patterns.spec.js`

### mirka on 2026-01-09T17:42:12Z

URL: https://github.com/WordPress/gutenberg/pull/74463#issuecomment-3729941049

I think @aduth and I had discussed somewhere that ideally we don't make the `destructive` tone an official API on `Button` directly, but only support it as part of a `ConfirmDialog` API. This is because we agreed with designers that destructive colors should only be used in certain patterns, and having it readily available on `Button` would encourage misuse.

Does anyone know if any of those design decisions changed?

### aduth on 2026-01-09T19:24:42Z

URL: https://github.com/WordPress/gutenberg/pull/74463#issuecomment-3730281365

That's a good point @mirka . Given that the proposed logic in https://github.com/WordPress/gutenberg/issues/66810#issuecomment-3531947620 about how we'd apply destructive actions in the context of confirmation dialogs exclusively (as far as I understand), it could make sense to limit it to being available only for that component (which doesn't exist at the moment).

### ciampo on 2026-01-10T14:34:49Z

URL: https://github.com/WordPress/gutenberg/pull/74463#issuecomment-3732898516

> Does anyone know if any of those design decisions changed?

I was not aware of this decision, apologies for going ahead and adding the `destructive` tone to `Button`. And I'm not sure if @jameskoster was either, given his [earlier request](https://github.com/WordPress/gutenberg/pull/74415#issuecomment-3723124503)?

How do y'all suggest we iterate from here? Remove the prop and the styles? And add them only to the sub-component of dialog, expanding `Button`'s APIs?

### mirka on 2026-01-12T09:39:33Z

URL: https://github.com/WordPress/gutenberg/pull/74463#issuecomment-3737654340

> How do y'all suggest we iterate from here? Remove the prop and the styles? And add them only to the sub-component of dialog, expanding `Button`'s APIs?

Yes, let's try that.

### jameskoster on 2026-01-12T10:48:38Z

URL: https://github.com/WordPress/gutenberg/pull/74463#issuecomment-3737931573

I didn't realise it was possible to restrict usage that way. Sounds good to me :)

## Review threads

### Review thread 1

#### ciampo on 2026-01-08T17:10:24Z

URL: https://github.com/WordPress/gutenberg/pull/74463#discussion_r2673183804
...
This is the only actual change in the file, the rest is whitespace

### Review thread 2

#### aduth on 2026-01-08T20:30:05Z

URL: https://github.com/WordPress/gutenberg/pull/74463#discussion_r2673794069
Path: packages/ui/src/button/stories/index.story.tsx

Should we have a dedicated story? In particular, since we have some pretty specific guidance around how this variant should be used, I wonder how we'd want to go about communicating that guidance?

#### ciampo on 2026-01-09T09:16:10Z

URL: https://github.com/WordPress/gutenberg/pull/74463#discussion_r2675424778
Path: packages/ui/src/button/stories/index.story.tsx

https://github.com/WordPress/gutenberg/pull/74463/changes/197e678e841574a187e80cc03ebe3d5bed333e35

More in general, I feel like we may actually remove some stories, since we can expect consumers to use Storybook controls to check all tones/variants. We can still keep the "matrix" story though, as it's a nice recap.

## Changed files

- packages/ui/src/button/stories/index.story.tsx (MODIFIED, +64/-54)
- packages/ui/src/button/style.module.css (MODIFIED, +33/-0)
- packages/ui/src/button/types.ts (MODIFIED, +5/-2)
