...
type: pull_request
state: MERGED
merged_at: 2023-01-30T11:48:33Z
url: https://github.com/WordPress/gutenberg/pull/47540
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Focus] Accessibility (a11y)","[Package] Components"]
---

# PR #47540: Fix and simplify the Modal dialog close button label

- URL: https://github.com/WordPress/gutenberg/pull/47540
- Author: afercia
- Created: 2023-01-30T09:16:56Z
- Updated: 2023-07-24T12:55:45Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 22 of 22
- Diff: ../pr-diffs/47540.diff
...
### github-actions on 2023-01-30T09:26:29Z

URL: https://github.com/WordPress/gutenberg/pull/47540#issuecomment-1408255810
...
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 192 kB | -19 B (0%) |
| `build/block-library/index.min.js` | 199 kB | -48 B (0%) |
...
| `build/edit-site/index.min.js` | 63.1 kB | -24 B (0%) |
...
### afercia on 2023-01-31T08:59:20Z

URL: https://github.com/WordPress/gutenberg/pull/47540#issuecomment-1409988838

> I also tried the template part creation modal in the site editor. [...] The button has the correct aria-label (Close) but it has no tooltip.
...
- packages/block-editor/src/components/inserter/block-patterns-explorer/explorer.js (MODIFIED, +0/-1)
- packages/block-library/src/navigation/edit/navigation-menu-delete-control.js (MODIFIED, +0/-1)
- packages/block-library/src/page-list/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/query/edit/index.js (MODIFIED, +0/-1)
- packages/block-library/src/template-part/edit/index.js (MODIFIED, +0/-1)
- packages/block-library/src/template-part/edit/title-modal.js (MODIFIED, +0/-1)
- packages/components/src/modal/index.tsx (MODIFIED, +1/-2)
- packages/customize-widgets/src/components/keyboard-shortcut-help-modal/index.js (MODIFIED, +0/-1)
- packages/e2e-tests/specs/editor/various/nux.test.js (MODIFIED, +2/-2)
- packages/edit-post/src/components/preferences-modal/test/__snapshots__/index.js.snap (MODIFIED, +2/-2)
- packages/edit-post/src/components/sidebar/post-template/create-modal.js (MODIFIED, +0/-1)
- packages/edit-post/src/components/start-page-options/index.js (MODIFIED, +0/-1)
- packages/edit-site/src/components/add-new-template/add-custom-generic-template-modal.js (MODIFIED, +0/-1)
- packages/edit-site/src/components/add-new-template/add-custom-template-modal.js (MODIFIED, +0/-1)
- packages/edit-site/src/components/create-template-part-modal/index.js (MODIFIED, +0/-1)
- packages/edit-site/src/components/keyboard-shortcut-help-modal/index.js (MODIFIED, +0/-1)
- packages/edit-site/src/components/list/actions/rename-menu-item.js (MODIFIED, +0/-1)
- packages/edit-widgets/src/components/keyboard-shortcut-help-modal/index.js (MODIFIED, +0/-1)
- packages/interface/src/components/preferences-modal/index.js (MODIFIED, +0/-1)
- packages/reusable-blocks/src/components/reusable-blocks-menu-items/reusable-block-convert-button.js (MODIFIED, +0/-1)
- test/e2e/specs/editor/various/preview.spec.js (MODIFIED, +3/-1)
