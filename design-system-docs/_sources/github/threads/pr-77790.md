...
type: pull_request
state: MERGED
merged_at: 2026-04-29T15:51:46Z
url: https://github.com/WordPress/gutenberg/pull/77790
...
# PR #77790: ExternalLink: Align appearance with Link from @wordpress/ui

- URL: https://github.com/WordPress/gutenberg/pull/77790
- Author: jameskoster
- Created: 2026-04-29T09:46:19Z
- Updated: 2026-05-04T03:00:24Z
- Comments: 6 of 6
- Review threads: 3 of 3
- Changed files: 4 of 4
- Diff: ../pr-diffs/77790.diff
...
### github-actions on 2026-04-29T09:46:29Z

URL: https://github.com/WordPress/gutenberg/pull/77790#issuecomment-4342557324
...
### github-actions on 2026-04-29T10:02:54Z

URL: https://github.com/WordPress/gutenberg/pull/77790#issuecomment-4342701410

**Size Change:** +664 B (+0.01%) 
...
| :--- | :---: | :---: |
| `build/modules/user-taxonomies/index.min.js` | 48.8 kB | +2 B (0%) |
| `build/styles/components/style-rtl.css` | 17.5 kB | +170 B (+0.98%) |
| `build/styles/components/style-rtl.min.css` | 14.3 kB | +159 B (+1.12%) |
| `build/styles/components/style.css` | 17.5 kB | +172 B (+0.99%) |
| `build/styles/components/style.min.css` | 14.3 kB | +161 B (+1.14%) |
...
### github-actions on 2026-04-29T10:20:52Z

URL: https://github.com/WordPress/gutenberg/pull/77790#issuecomment-4342813168

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 58512966c0d9f5ab885c45854c02040aa2e99ba6.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/25116695303
📝  Reported issues:
- #77720 in `/test/e2e/specs/editor/various/post-content-focus-mode.spec.js`
- #76608 in `/test/e2e/specs/editor/various/list-view.spec.js`

### simison on 2026-04-30T09:38:20Z

URL: https://github.com/WordPress/gutenberg/pull/77790#issuecomment-4351347346

Do we need the same treatment for `<Button variant="link" href="#">` from `@wordpress/components`?

<img width="120" height="40" alt="Screenshot 2026-04-30 at 12 37 28" src="https://github.com/user-attachments/assets/0d3b3368-a587-40a9-8d1d-830e00ca6a94" />

### ciampo on 2026-04-30T09:43:56Z

URL: https://github.com/WordPress/gutenberg/pull/77790#issuecomment-4351389373

Good point — I guess so? cc @jameskoster

### t-hamano on 2026-05-04T03:00:24Z

URL: https://github.com/WordPress/gutenberg/pull/77790#issuecomment-4367920633

This PR appears to cause an unintended focus outline, possibly influenced by the WordPress dashboard styling.

| OS | Before | After |
|--------|--------|--------|
| Windows |  <img width="274" height="173" alt="Image" src="https://github.com/user-attachments/assets/56113e03-5335-4f4e-8906-22e0bc3c35ba" /> | <img width="255" height="182" alt="image" src="https://github.com/user-attachments/assets/f6f15a76-4f6d-4e41-9dab-23623278a174" /> |
| MacOS |<img width="272" height="178" alt="mac_before" src="https://github.com/user-attachments/assets/d5fc4308-83e9-42ea-bfa8-2cf78d198394" /> | <img width="272" height="178" alt="mac_after" src="https://github.com/user-attachments/assets/bee5bea7-0828-4485-9017-cd9e43117e5f" /> |

## Review threads

### Review thread 1 (resolved)

#### ciampo on 2026-04-29T13:13:43Z

URL: https://github.com/WordPress/gutenberg/pull/77790#discussion_r3161244247
...
#### ciampo on 2026-04-29T13:15:56Z

URL: https://github.com/WordPress/gutenberg/pull/77790#discussion_r3161258620
Path: packages/components/src/external-link/style.scss
...
#### ciampo on 2026-04-29T13:20:34Z

URL: https://github.com/WordPress/gutenberg/pull/77790#discussion_r3161292048
Path: packages/components/src/external-link/style.scss
...
- apply `0.5px` inside a `@media (min-resolution: 2dppx)` query, and fallback to `1px`
- test the [`from font` value](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/text-decoration-thickness#from-font)

In any case, we should update `Link` in `@wordpress/ui`, too

#### jameskoster on 2026-04-29T14:38:07Z

URL: https://github.com/WordPress/gutenberg/pull/77790#discussion_r3161837968
Path: packages/components/src/external-link/style.scss
...
- packages/components/src/external-link/style.scss (MODIFIED, +30/-2)
