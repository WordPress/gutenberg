...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/56500
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #56500: Bug: ToggleGroupControl doesn't update the UI on programmatic changes

- URL: https://github.com/WordPress/gutenberg/pull/56500
- Author: luisherranz
- Created: 2023-11-24T11:35:46Z
- Updated: 2024-01-10T11:49:16Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 6 of 6
- Diff: ../pr-diffs/56500.diff
...
### github-actions on 2023-11-24T11:42:29Z

URL: https://github.com/WordPress/gutenberg/pull/56500#issuecomment-1825553886
...
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 248 kB | +25 B (0%) |
| `build/block-editor/style-rtl.css` | 15.7 kB | -2 B (0%) |
| `build/block-editor/style.css` | 15.7 kB | -1 B (0%) |
| `build/block-library/index.min.js` | 212 kB | +234 B (0%) |
| `build/components/index.min.js` | 256 kB | -3 B (0%) |
| `build/components/style-rtl.css` | 12 kB | +5 B (0%) |
| `build/components/style.css` | 12 kB | +6 B (0%) |
| `build/edit-site/index.min.js` | 208 kB | -91 B (0%) |
| `build/edit-site/style-rtl.css` | 14.4 kB | +24 B (0%) |
| `build/edit-site/style.css` | 14.4 kB | +24 B (0%) |
| `build/editor/index.min.js` | 47.2 kB | +97 B (0%) |
...
### ciampo on 2023-11-25T00:14:59Z

URL: https://github.com/WordPress/gutenberg/pull/56500#issuecomment-1826156801

@luisherranz I pushed a couple of commits:

- https://github.com/WordPress/gutenberg/pull/56500/commits/3dc9d6bac6415f65fc3f16be90eaa0fbbaa25be2 should include the suggested fix
- https://github.com/WordPress/gutenberg/pull/56500/commits/04f618f76efebef5a78fc15dcdc8ed1e7edd622d is an improvement to how `ToggleGroupControls` is used — the `value` prop [shouldn't be a boolean](https://github.com/WordPress/gutenberg/blob/f4389b9851256d1f02b513d8379ee544e446af98/packages/components/src/toggle-group-control/types.ts#L110-L113)

If this works well for you, I will go ahead and open a separate PR with just the fix to `ToggleGroupControl`

### luisherranz on 2024-01-10T11:49:07Z

URL: https://github.com/WordPress/gutenberg/pull/56500#issuecomment-1884701403

Sorry for my late response here and thanks for fixing this, @ciampo 🙂

Closing now as fixed in https://github.com/WordPress/gutenberg/pull/56678.
...
- docs/reference-guides/core-blocks.md (MODIFIED, +9/-0)
- packages/block-library/src/bug/block.json (ADDED, +12/-0)
- packages/block-library/src/bug/edit.js (ADDED, +40/-0)
- packages/block-library/src/bug/index.js (ADDED, +16/-0)
- packages/block-library/src/index.js (MODIFIED, +3/-0)
- packages/components/src/toggle-group-control/toggle-group-control/utils.ts (MODIFIED, +12/-8)
