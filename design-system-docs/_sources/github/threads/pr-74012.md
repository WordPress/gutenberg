...
type: pull_request
state: MERGED
merged_at: 2025-12-16T09:32:36Z
url: https://github.com/WordPress/gutenberg/pull/74012
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #74012: ToggleControl: Deprecate bottom margin

- URL: https://github.com/WordPress/gutenberg/pull/74012
- Author: mirka
- Created: 2025-12-15T21:03:56Z
- Updated: 2025-12-16T09:33:10Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 79 of 79
- Diff: ../pr-diffs/74012.diff
...
Remove the deprecated `__nextHasNoMarginBottom` prop from `ToggleControl`, making the margin-free styles the permanent default.
...
- Remove the `__nextHasNoMarginBottom` prop from `ToggleControl` and its types and docs.
...
### github-actions on 2025-12-15T21:04:06Z

URL: https://github.com/WordPress/gutenberg/pull/74012#issuecomment-3657596042
...
### github-actions on 2025-12-15T21:17:21Z

URL: https://github.com/WordPress/gutenberg/pull/74012#issuecomment-3657644897

**Size Change:** -350 B (-0.01%) 

**Total Size:** 2.58 MB

| Filename | Size | Change |
| :--- | :---: | :---: |
| `build/scripts/block-editor/index.min.js` | 316 kB | +3 B (0%) |
| `build/scripts/block-library/index.min.js` | 281 kB | -101 B (-0.04%) |
| `build/scripts/components/index.min.js` | 272 kB | -176 B (-0.06%) |
| `build/scripts/edit-post/index.min.js` | 16.4 kB | -20 B (-0.12%) |
| `build/scripts/edit-site/index.min.js` | 240 kB | -3 B (0%) |
| `build/scripts/editor/index.min.js` | 284 kB | -11 B (0%) |
| `build/scripts/media-utils/index.min.js` | 69.5 kB | -3 B (0%) |
| `build/scripts/patterns/index.min.js` | 7.86 kB | -7 B (-0.09%) |
| `build/scripts/preferences/index.min.js` | 3.29 kB | -18 B (-0.54%) |
| `build/scripts/reusable-blocks/index.min.js` | 2.91 kB | -14 B (-0.48%) |
...
- packages/block-editor/src/components/background-image-control/index.js (MODIFIED, +0/-2)
- packages/block-editor/src/components/block-lock/modal.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/date-format-picker/index.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/global-styles/image-settings-panel.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/inspector-controls/README.md (MODIFIED, +0/-1)
- packages/block-editor/src/components/responsive-block-control/index.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/url-popover/image-url-input-ui.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/url-popover/stories/index.story.jsx (MODIFIED, +0/-1)
- packages/block-editor/src/hooks/block-hooks.js (MODIFIED, +0/-1)
- packages/block-editor/src/hooks/layout.js (MODIFIED, +0/-1)
- packages/block-editor/src/layouts/flex.js (MODIFIED, +0/-1)
- packages/block-library/src/accordion-item/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/accordion/edit.js (MODIFIED, +0/-2)
- packages/block-library/src/archives/edit.js (MODIFIED, +0/-3)
- packages/block-library/src/audio/edit.js (MODIFIED, +0/-2)
- packages/block-library/src/avatar/edit.js (MODIFIED, +0/-2)
- packages/block-library/src/breadcrumbs/edit.js (MODIFIED, +0/-2)
- packages/block-library/src/categories/edit.js (MODIFIED, +0/-6)
- packages/block-library/src/columns/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/comment-author-name/edit.js (MODIFIED, +0/-2)
- packages/block-library/src/comment-date/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/comment-edit-link/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/comments-title/edit.js (MODIFIED, +0/-2)
- packages/block-library/src/cover/edit/inspector-controls.js (MODIFIED, +0/-2)
- packages/block-library/src/details/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/embed/embed-controls.js (MODIFIED, +0/-1)
- packages/block-library/src/file/inspector.js (MODIFIED, +0/-3)
- packages/block-library/src/gallery/edit.js (MODIFIED, +0/-6)
- packages/block-library/src/latest-comments/edit.js (MODIFIED, +0/-2)
- packages/block-library/src/latest-posts/edit.js (MODIFIED, +0/-5)
- packages/block-library/src/list/ordered-list-settings.js (MODIFIED, +0/-2)
- packages/block-library/src/loginout/edit.js (MODIFIED, +0/-2)
- packages/block-library/src/media-text/edit.js (MODIFIED, +0/-2)
- packages/block-library/src/more/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/navigation/edit/index.js (MODIFIED, +0/-2)
- packages/block-library/src/navigation/edit/overlay-menu-preview-controls.js (MODIFIED, +0/-1)
- packages/block-library/src/navigation/edit/overlay-menu-preview.js (MODIFIED, +0/-1)
- packages/block-library/src/paragraph/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/post-author-name/edit.js (MODIFIED, +0/-2)
- packages/block-library/src/post-author/edit.js (MODIFIED, +0/-4)
- packages/block-library/src/post-date/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/post-excerpt/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/post-featured-image/edit.js (MODIFIED, +0/-2)
- packages/block-library/src/post-navigation-link/edit.js (MODIFIED, +0/-2)
- packages/block-library/src/post-time-to-read/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/post-title/edit.js (MODIFIED, +0/-2)
- packages/block-library/src/query-pagination/query-pagination-label-control.js (MODIFIED, +0/-1)
- packages/block-library/src/query-title/edit.js (MODIFIED, +0/-3)
- packages/block-library/src/query/edit/inspector-controls/enhanced-pagination-control.js (MODIFIED, +0/-1)
- packages/block-library/src/read-more/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/rss/edit.js (MODIFIED, +0/-4)
- packages/block-library/src/search/edit.js (MODIFIED, +0/-2)
- packages/block-library/src/site-logo/edit.js (MODIFIED, +0/-3)
- packages/block-library/src/site-title/edit.js (MODIFIED, +0/-2)
- packages/block-library/src/social-links/edit.js (MODIFIED, +0/-2)
- packages/block-library/src/tab/controls.js (MODIFIED, +0/-1)
- packages/block-library/src/table-of-contents/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/table/edit.js (MODIFIED, +0/-3)
- packages/block-library/src/tabs/controls.js (MODIFIED, +0/-1)
- packages/block-library/src/tag-cloud/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/term-name/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/terms-query/edit/inspector-controls/empty-terms-control.js (MODIFIED, +0/-1)
- packages/block-library/src/terms-query/edit/inspector-controls/nested-terms-control.js (MODIFIED, +1/-6)
- packages/block-library/src/video/edit-common-settings.js (MODIFIED, +0/-5)
- packages/block-library/src/video/tracks-editor.js (MODIFIED, +0/-1)
- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/toggle-control/README.md (MODIFIED, +0/-9)
- packages/components/src/toggle-control/index.tsx (MODIFIED, +1/-22)
- packages/components/src/toggle-control/stories/index.story.tsx (MODIFIED, +0/-1)
- packages/components/src/toggle-control/test/index.tsx (MODIFIED, +1/-7)
- packages/components/src/toggle-control/types.ts (MODIFIED, +8/-1)
- packages/components/src/validated-form-controls/components/toggle-control.tsx (MODIFIED, +2/-10)
- packages/dataviews/src/components/dataviews-view-config/infinite-scroll-toggle.tsx (MODIFIED, +0/-1)
- packages/edit-post/src/components/init-pattern-modal/index.js (MODIFIED, +0/-1)
- packages/global-styles-ui/src/font-sizes/font-size.tsx (MODIFIED, +0/-2)
- packages/patterns/src/components/create-pattern-modal.js (MODIFIED, +0/-1)
- packages/preferences/src/components/preference-base-option/index.tsx (MODIFIED, +0/-1)
