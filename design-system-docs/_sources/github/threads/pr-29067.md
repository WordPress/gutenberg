...
type: pull_request
state: MERGED
merged_at: 2021-02-17T11:11:19Z
url: https://github.com/WordPress/gutenberg/pull/29067
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #29067: Components: Safe window access in ResizableBox utils

- URL: https://github.com/WordPress/gutenberg/pull/29067
- Author: tyxla
- Created: 2021-02-17T09:22:38Z
- Updated: 2021-02-17T11:11:20Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 1 of 1
- Diff: ../pr-diffs/29067.diff
...
### github-actions on 2021-02-17T09:33:02Z

URL: https://github.com/WordPress/gutenberg/pull/29067#issuecomment-780426579
...
| :--- | :---: | :---: |
| `build/components/index.js` | 272 kB | +9 B (0%) |
...
### tyxla on 2021-02-17T09:53:33Z

URL: https://github.com/WordPress/gutenberg/pull/29067#issuecomment-780438531

> Any idea how we could prevent this type of issues rather than patch them one by one after the fact?

I guess those pop up only when used in Node context. We encountered them all when attempting to use `VisuallyHidden ` in https://github.com/Automattic/wp-calypso/pull/50094. 

One thing we could try would be to have a test playground that loads all components and packages in node context, and have a test to verify that the build passes. What do you think?

### gziolo on 2021-02-17T09:57:27Z

URL: https://github.com/WordPress/gutenberg/pull/29067#issuecomment-780440892

I think you read my mind, see:
https://github.com/WordPress/gutenberg/issues/17273

Jest is going to change the default env to `node` in the next major version. I think it will only make it easier to add smoke tests like that. I would also consider converting as many tests as possible to work with `node` env by default.

### tyxla on 2021-02-17T10:35:13Z

URL: https://github.com/WordPress/gutenberg/pull/29067#issuecomment-780463330

TIL about this issue. That would be great to have indeed 👍
...
- packages/components/src/resizable-box/resize-tooltip/utils.js (MODIFIED, +2/-1)
