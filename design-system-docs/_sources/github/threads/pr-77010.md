...
type: pull_request
state: MERGED
merged_at: 2026-04-02T19:28:03Z
url: https://github.com/WordPress/gutenberg/pull/77010
matched_labels: ["[Package] Components","[Package] Theme"]
all_labels: ["[Type] Code Quality","[Package] Components","[Package] Editor","[Package] Notices","[Package] DataViews","[Package] Theme"]
---

# PR #77010: Build Tools: Update TypeScript to 6.0.2

- URL: https://github.com/WordPress/gutenberg/pull/77010
- Author: manzoorwanijk
- Created: 2026-04-02T18:03:15Z
- Updated: 2026-04-07T12:22:14Z
- Comments: 3 of 3
- Review threads: 3 of 3
- Changed files: 22 of 22
- Diff: ../pr-diffs/77010.diff
...
### github-actions on 2026-04-02T18:03:28Z

URL: https://github.com/WordPress/gutenberg/pull/77010#issuecomment-4179539635
...
### github-actions on 2026-04-02T18:16:47Z

URL: https://github.com/WordPress/gutenberg/pull/77010#issuecomment-4179612472
...
| :--- | :---: | :---: |
| `build/scripts/components/index.min.js` | 265 kB | -2 B (0%) |
...
| `build/scripts/sync/index.min.js` | 38.2 kB |
...
### github-actions on 2026-04-02T18:35:42Z

URL: https://github.com/WordPress/gutenberg/pull/77010#issuecomment-4179718769

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 0735e453ef1ed26a521383481dd8be90cb2c7b10.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/23916347646
📝  Reported issues:
...
#### aduth on 2026-04-02T18:19:35Z

URL: https://github.com/WordPress/gutenberg/pull/77010#discussion_r3029604296
...
Is the second optional chaining here necessary? AFAICT `getTextInfo()` won't ever return `undefined` ([docs](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/Locale/getTextInfo)), and we're primarily concerned with a browser that doesn't implement `getTextInfo` at all. (which itself may be worth retaining as an inline comment)

```suggestion
	const direction = localeObj.getTextInfo?.().direction;
```

(Noticed as I was trying to sense whether the addition of the `direction` truthy condition changes the actual behavior, but I guess it retains the check of whether `getTextInfo` is available)

#### manzoorwanijk on 2026-04-02T18:44:13Z

URL: https://github.com/WordPress/gutenberg/pull/77010#discussion_r3029719563
Path: packages/components/src/calendar/utils/use-localization-props.ts
...
I think it should work without that.

### Review thread 2

#### jsnajdr on 2026-04-07T09:36:21Z

URL: https://github.com/WordPress/gutenberg/pull/77010#discussion_r3044123311
Path: typings/style-imports/index.d.ts
...
@mirka recently opened an issue (#76744) proposing that we eliminate these non-module CSS imports from our codebase.

At this moment most these imports are in the `boot` package. And all of them are very recent additions.

### Review thread 3

#### jsnajdr on 2026-04-07T09:37:32Z

URL: https://github.com/WordPress/gutenberg/pull/77010#discussion_r3044131089
...
#### manzoorwanijk on 2026-04-07T12:22:14Z

URL: https://github.com/WordPress/gutenberg/pull/77010#discussion_r3044933848
Path: tsconfig.base.json
...
- package-lock.json (MODIFIED, +18/-4)
...
- packages/dataviews/tsconfig.json (MODIFIED, +6/-1)
- packages/editor/tsconfig.json (MODIFIED, +1/-0)
- packages/image-cropper/tsconfig.json (MODIFIED, +1/-0)
- packages/lazy-editor/tsconfig.json (MODIFIED, +1/-0)
- packages/notices/tsconfig.json (MODIFIED, +1/-1)
- packages/theme/tsconfig.src.json (MODIFIED, +1/-1)
- tsconfig.base.json (MODIFIED, +0/-2)
- typings/style-imports/index.d.ts (RENAMED, +3/-0)
