...
type: pull_request
state: MERGED
merged_at: 2023-03-06T11:10:58Z
url: https://github.com/WordPress/gutenberg/pull/48637
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #48637: `PaletteEdit`: refactor away from `lodash.kebabCase`

- URL: https://github.com/WordPress/gutenberg/pull/48637
- Author: flootr
- Created: 2023-03-01T14:06:17Z
- Updated: 2023-03-06T11:11:25Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 1 of 1
- Diff: ../pr-diffs/48637.diff
...
### github-actions on 2023-03-01T14:15:55Z

URL: https://github.com/WordPress/gutenberg/pull/48637#issuecomment-1450223931
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 208 kB | +413 B (0%) |
...
### github-actions on 2023-03-01T14:38:11Z

URL: https://github.com/WordPress/gutenberg/pull/48637#issuecomment-1450258163

<!-- flaky-tests-report-comment -->
**Flaky tests detected in e32d9ad7c9c696566e370515e2006bf51c881f58.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/4304365943
📝  Reported issues:
- #48033 in `/test/e2e/specs/editor/blocks/navigation.spec.js`

### tyxla on 2023-03-03T13:53:21Z

URL: https://github.com/WordPress/gutenberg/pull/48637#issuecomment-1453564230

Just to clarify, here's an example of such a difference:

```
const original = "test12";

const res1 = paramCase(original);
const res2 = kebabCase(original);

console.log("paramCase: " + res1); // paramCase: test12 
console.log("kebabCase: " + res2); // kebabCase: test-12 
```
