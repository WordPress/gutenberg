...
type: pull_request
state: MERGED
merged_at: 2026-02-20T09:29:22Z
url: https://github.com/WordPress/gutenberg/pull/75737
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components","Backported to WP Core"]
---

# PR #75737: `ToggleGroupControl`: Make unselected item color consistent across all variants

- URL: https://github.com/WordPress/gutenberg/pull/75737
- Author: ciampo
- Created: 2026-02-19T16:29:00Z
- Updated: 2026-02-20T09:46:46Z
- Comments: 6 of 6
- Review threads: 2 of 2
- Changed files: 3 of 3
- Diff: ../pr-diffs/75737.diff
...
### github-actions on 2026-02-19T16:29:14Z

URL: https://github.com/WordPress/gutenberg/pull/75737#issuecomment-3928364837
...
### github-actions on 2026-02-19T16:42:42Z

URL: https://github.com/WordPress/gutenberg/pull/75737#issuecomment-3928443847
...
| :--- | :---: | :---: |
| `build/scripts/components/index.min.js` | 265 kB | +14 B (+0.01%) |
...
| `build/scripts/core-data/index.min.js` | 27.9 kB |
...
### jasmussen on 2026-02-19T17:37:49Z

URL: https://github.com/WordPress/gutenberg/pull/75737#issuecomment-3928787367

Nice, thanks for doing this!

At a glance, this looks good, what's the hex code color? I had some problem with my env trying to test this, just want to make sure the gray color is at least the equivalent of gray 600 or around 700, either of those is fine.

### ciampo on 2026-02-20T06:46:50Z

URL: https://github.com/WordPress/gutenberg/pull/75737#issuecomment-3932011078

> At a glance, this looks good, what's the hex code color? I had some problem with my env trying to test this, just want to make sure the gray color is at least the equivalent of gray 600 or around 700, either of those is fine.

Yup, it's `gray-700` (`#757575`), which ensures `4.6:1` text contrast.

> I still have concerns about differentiation between disabled and unselected
...
> Also I noticed a bug. It's subtle, but there's a hover effect on disabled items [...] your call on whether a fix can be sneaked in here 

👀  🧹  🐛  ❌   I included a fix for that, too.

### github-actions on 2026-02-20T07:20:57Z

URL: https://github.com/WordPress/gutenberg/pull/75737#issuecomment-3932131611

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 3dccb648ab7a179f7557c860dd3129461e922a75.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/22214636685
📝  Reported issues:
- #36123 in `/test/e2e/specs/editor/blocks/classic.spec.js`
- #48558 in `/test/e2e/specs/editor/various/undo.spec.js`

### github-actions on 2026-02-20T09:46:46Z

URL: https://github.com/WordPress/gutenberg/pull/75737#issuecomment-3932730534

I just cherry-picked this PR to the wp/7.0 branch to get it included in the next release: 430c8b6f335edd28c3b8c2d41ccd70d107107f7f

## Review threads

### Review thread 1

#### ciampo on 2026-02-19T16:32:34Z

URL: https://github.com/WordPress/gutenberg/pull/75737#discussion_r2828866863
...
#### mirka on 2026-02-19T19:37:26Z

URL: https://github.com/WordPress/gutenberg/pull/75737#discussion_r2829790662
...
This was a bit unclear/misleading to me, how about something like:
...
- packages/components/src/toggle-group-control/test/__snapshots__/index.tsx.snap (MODIFIED, +18/-16)
