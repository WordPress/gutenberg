...
type: pull_request
state: MERGED
merged_at: 2026-02-25T23:59:57Z
url: https://github.com/WordPress/gutenberg/pull/75442
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Compose","[Package] Components"]
---

# PR #75442: Convert focus on mount hook to TypeScript

- URL: https://github.com/WordPress/gutenberg/pull/75442
- Author: stokesman
- Created: 2026-02-11T23:06:20Z
- Updated: 2026-02-26T00:00:35Z
- Comments: 5 of 5
- Review threads: 6 of 6
- Changed files: 8 of 8
- Diff: ../pr-diffs/75442.diff
...
### github-actions on 2026-02-11T23:17:53Z

URL: https://github.com/WordPress/gutenberg/pull/75442#issuecomment-3887776121
...
| :--- | :---: | :---: |
| `build/scripts/compose/index.min.js` | 13.9 kB | -23 B (-0.17%) |
| `build/scripts/core-data/index.min.js` | 28.5 kB | -3 B (-0.01%) |
| `build/scripts/sync/index.min.js` | 36.8 kB | +1 B (0%) |
...
| `build/scripts/media-utils/index.min.js` | 73.2 kB |
...
| `build/styles/edit-site/style-rtl.css` | 20.4 kB |
...
| `build/styles/editor/style-rtl.css` | 23.2 kB |
...
### github-actions on 2026-02-12T02:46:31Z

URL: https://github.com/WordPress/gutenberg/pull/75442#issuecomment-3888365391
...
### github-actions on 2026-02-16T17:05:50Z

URL: https://github.com/WordPress/gutenberg/pull/75442#issuecomment-3909600999

<!-- flaky-tests-report-comment -->
**Flaky tests detected in af6371188dd31d73d8be7a7b63a76842bf330120.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/22416455819
📝  Reported issues:
- #74664 in `/test/e2e/specs/site-editor/activate-theme.spec.js`

### ciampo on 2026-02-24T17:21:18Z

URL: https://github.com/WordPress/gutenberg/pull/75442#issuecomment-3953593663

I don't have more feedback to add. Happy to defer to @aduth and @jsnajdr for a final review on this PR.

### stokesman on 2026-02-26T00:00:06Z

URL: https://github.com/WordPress/gutenberg/pull/75442#issuecomment-3962993914
...
#### stokesman on 2026-02-12T02:43:47Z

URL: https://github.com/WordPress/gutenberg/pull/75442#discussion_r2796506690
Path: packages/compose/src/hooks/use-focus-on-mount/index.ts
...
Just to note this formatting doesn’t come out great in the generated readme but I figure optimizing for code editors is worthwhile:

| Readme | my IDE |
|----|----|
| <img width="717" height="201" alt="Image" src="https://github.com/user-attachments/assets/0ea75be0-3f1b-4274-8c05-418ca89d7dff" /> | <img width="767" height="272" alt="Image" src="https://github.com/user-attachments/assets/602ee33d-bbc0-4cd4-bcf9-ca0c39613c8a" /> |

#### aduth on 2026-02-12T20:04:11Z

URL: https://github.com/WordPress/gutenberg/pull/75442#discussion_r2800823766
Path: packages/compose/src/hooks/use-focus-on-mount/index.ts
...
I haven't checked, but would IDE follow if we made the parameter type a named `type` and put the extended description there?
 ...
 * ...
 */
type FocusOnMountBehavior = boolean | 'firstElement' | 'firstInputElement';
```

#### stokesman on 2026-02-13T00:26:21Z

URL: https://github.com/WordPress/gutenberg/pull/75442#discussion_r2801691421
Path: packages/compose/src/hooks/use-focus-on-mount/index.ts
...
#### stokesman on 2026-02-16T17:20:38Z

URL: https://github.com/WordPress/gutenberg/pull/75442#discussion_r2813416637
Path: packages/compose/src/hooks/use-focus-on-mount/index.ts
...
I tried it and, at least in my IDE, I’ve been unable see the description even though the named type is recognized. In contrast, this kind of thing does work when parameters are objects and their property names can be hovered.

#### jsnajdr on 2026-02-19T11:48:05Z

URL: https://github.com/WordPress/gutenberg/pull/75442#discussion_r2827364957
Path: packages/compose/src/hooks/use-focus-on-mount/index.ts
...
The generated doc is permanently broken, so that's a bad tradeoff IMO. But it looks more like a bug in the tool that generates the doc. The alignment is right.

We could avoid all this trouble if we created a named type for the param and moved the documentation to the named type.

#### stokesman on 2026-02-20T06:29:36Z

URL: https://github.com/WordPress/gutenberg/pull/75442#discussion_r2831609761
Path: packages/compose/src/hooks/use-focus-on-mount/index.ts
...
I revised the doc comment to avoid the formatting issue ed010953931fbbeb8598778c2a118f381f5dc517 but kept it where it is. At least in my IDE (sublime), there doesn’t seem to be a way to see the comment/doc when it’s moved to the named type. When it’s in the jsdoc block then hovering the function shows it.

I’m not opinionated about this and would be happy to follow advice.

### Review thread 2 (resolved)

#### aduth on 2026-02-12T20:01:59Z

URL: https://github.com/WordPress/gutenberg/pull/75442#discussion_r2800815596
Path: packages/compose/src/hooks/use-focus-on-mount/index.ts

```diff
@@ -72,19 +72,12 @@ export default function useFocusOnMount( focusOnMount = 'firstElement' ) {
 			return;
 		}
...
Could you explain these changes? I'd hope our test coverage is sufficient to catch any regression this may cause, though the fact that we were previously being much more defensive about DOM presence and using a shared timer ref makes me wonder if there's some edge cases we had needed to consider in the past.

#### stokesman on 2026-02-13T00:18:20Z

URL: https://github.com/WordPress/gutenberg/pull/75442#discussion_r2801658852
Path: packages/compose/src/hooks/use-focus-on-mount/index.ts
...
Starting with the timer ref, it was introduced in 5a94c5695efd5df06b49b321cb2612d07c61e6a4 and the hook relied on on separate effect to clear the timeout so the ref was to share across the effect and callback hooks. Since 6b79edb49b17ed7429930fd53033d9ca43e1d3aa, which replaced the callback hook with the ref effect hook that contains its own cleanup effect, the ref isn’t actually shared and not required.

The defensive condition around `querySelector` came with #72322 and I’ve been unable to see how it would ever be necessary. The `node` reference should still be an element when the timeout callback executes because if unmounted the cleanup would clear the timeout first. It even strikes me as potentially problematic because `node instanceof window.Element` could fail if `node` is from a different window instance. I appreciate the caution here. Since this was part of a new feature it does seem more probable that there aren’t tests that depend on it yet.

I did request a review from @jorgefilipecosta in hopes of learning why it is that way.

#### stokesman on 2026-02-16T17:17:58Z

URL: https://github.com/WordPress/gutenberg/pull/75442#discussion_r2813408331
Path: packages/compose/src/hooks/use-focus-on-mount/index.ts
...
> Since this was part of a new feature it does seem more probable that there aren’t tests that depend on it yet.

I manually retested this new feature. It works as expected. In the PR description I added a screen recording demonstrating it.

#### jsnajdr on 2026-02-19T11:36:17Z

URL: https://github.com/WordPress/gutenberg/pull/75442#discussion_r2827303897
Path: packages/compose/src/hooks/use-focus-on-mount/index.ts
...
These changes look good to me. The defensive checks about `window` and type of `node` are not needed. Refs and effects are assigned only when running in browser, in a valid DOM environment. With server-side rendering these callbacks are never executed.

The TypeScript types should be enough to catch errors.

The `node instanceof window.Element` check possibly has only one function: it will fail when `node` is an element from another "realm", i.e., from another iframe. Then the `node`'s prototype and `window.Element` can be different objects, although they are both an `Element`. But they are different instances in different realms.

But as the defensive code was never explained in the original PR, and as there is no obvious reason why focusing code should care, I think we can remove it.

### Review thread 3 (resolved)

#### jsnajdr on 2026-02-19T11:10:59Z

URL: https://github.com/WordPress/gutenberg/pull/75442#discussion_r2827167541
...
This should be a named type instead of a complicated nested type reference. And somehow exported from the `compose` package alongside the `useFocusOnMount` function itself.

A nice way to expose this is a namespace:
```ts
export function useFocusOnMount;
export namespace useFocusOnMount {
  export type FocusStrategy = boolean | 'firstElement' | 'firstInputElement';
}
```
The Base UI library uses this pattern all the time. Example: https://github.com/mui/base-ui/blob/master/packages/react/src/use-button/useButton.ts#L245-L248

#### stokesman on 2026-02-20T06:12:14Z

URL: https://github.com/WordPress/gutenberg/pull/75442#discussion_r2831559592
Path: packages/components/src/dropdown/types.ts
...
Thanks for the suggestion. I implemented it in 971093f8bd3e67b96204e677e83181bd5b81a329.

### Review thread 4 (resolved)

#### jsnajdr on 2026-02-19T11:40:36Z

URL: https://github.com/WordPress/gutenberg/pull/75442#discussion_r2827325100
Path: packages/components/src/dropdown/types.ts
...
Is it really true that `false` should not be used or is it something that a LLM has made up?

When it comes to accessibility, there is an anti-autofocus ESLint rule that says the opposite, that an auto-focusing behavior should not be used because it's bad for a11y:

https://github.com/jsx-eslint/eslint-plugin-jsx-a11y/blob/main/docs/rules/no-autofocus.md

#### stokesman on 2026-02-20T06:09:08Z

URL: https://github.com/WordPress/gutenberg/pull/75442#discussion_r2831551818
Path: packages/components/src/dropdown/types.ts
...
The existing comment here says roughly the same thing:
https://github.com/WordPress/gutenberg/blob/28637a8c5fd25e3ce347163c5a60cf9094dfd1dd/packages/components/src/dropdown/types.ts#L48-L50

In the context of the components involved in this PR, it seems like the proper advice. At least as far as I know a dropdown, popover or modal are not supposed to leave focus on their trigger elements. The rewording/formatting was a touch from my low-powered meat-based LLM.

#### ciampo on 2026-02-20T06:52:10Z

URL: https://github.com/WordPress/gutenberg/pull/75442#discussion_r2831679251
Path: packages/components/src/dropdown/types.ts
...
`autofocus` in general is seen as a bad practice since it moves keyboard focus in a potentially unexpected way for the end user.

Dialogs are a bit different, since there is an expectation that, when the dialog is open, focus moves to the dialog. Therefore, this comment feels correct to me and coherent with other documentation.

#### jsnajdr on 2026-02-25T07:48:29Z

URL: https://github.com/WordPress/gutenberg/pull/75442#discussion_r2851413396
Path: packages/components/src/dropdown/types.ts
...
#### jsnajdr on 2026-02-25T07:58:19Z

URL: https://github.com/WordPress/gutenberg/pull/75442#discussion_r2851449773
Path: packages/components/src/dropdown/types.ts
...
Thank you both for explaining 🙂 I got confused by the general-purpose advice that autofocus is bad for a11y. And didn't notice that the new text is not new, just converted into a list.

### Review thread 5 (resolved)

#### ciampo on 2026-02-20T06:54:31Z

URL: https://github.com/WordPress/gutenberg/pull/75442#discussion_r2831687660
Path: packages/compose/src/hooks/use-focus-on-mount/index.ts
...
Although this works (thanks to JS hoisting), my preference would be to follow a more "natural" order, ie. define => argument => export :

1. `useFocusOnMount` function declaration
2. `useFocusOnMount` namespace declaration
3. default export

### Review thread 6

#### jsnajdr on 2026-02-25T07:56:49Z

URL: https://github.com/WordPress/gutenberg/pull/75442#discussion_r2851444239
Path: packages/compose/src/hooks/use-focus-on-mount/index.ts

```diff
@@ -100,9 +87,13 @@ export default function useFocusOnMount( focusOnMount = 'firstElement' ) {
 		}, 0 );
...
We can remove the default export (and update imports accordingly). Now when the `useFocusOnMount` export is named, we don't need a second duplicate one.

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +4/-0)
- packages/components/src/dropdown/types.ts (MODIFIED, +9/-14)
- packages/components/src/modal/types.ts (MODIFIED, +9/-5)
- packages/components/src/popover/types.ts (MODIFIED, +10/-10)
- packages/compose/README.md (MODIFIED, +3/-3)
- packages/compose/src/hooks/use-dialog/index.ts (MODIFIED, +9/-6)
- packages/compose/src/hooks/use-focus-on-mount/index.ts (RENAMED, +23/-34)
- packages/compose/src/index.js (MODIFIED, +1/-1)
