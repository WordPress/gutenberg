...
type: pull_request
state: MERGED
merged_at: 2026-02-18T15:03:11Z
url: https://github.com/WordPress/gutenberg/pull/75677
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Enhancement","[Package] UI"]
---

# PR #75677: ui/IconButton: make icon always 24px regardless of `size` prop

- URL: https://github.com/WordPress/gutenberg/pull/75677
- Author: ciampo
- Created: 2026-02-18T11:48:31Z
- Updated: 2026-02-18T16:09:03Z
- Comments: 12 of 12
- Review threads: 0 of 0
- Changed files: 3 of 3
- Diff: ../pr-diffs/75677.diff
...
### github-actions on 2026-02-18T11:51:54Z

URL: https://github.com/WordPress/gutenberg/pull/75677#issuecomment-3920389846
...
### github-actions on 2026-02-18T12:03:05Z

URL: https://github.com/WordPress/gutenberg/pull/75677#issuecomment-3920437793
...
| :--- | :---: | :---: |
| `build/scripts/block-editor/index.min.js` | 328 kB | -37 B (-0.01%) |
...
### github-actions on 2026-02-18T12:17:23Z

URL: https://github.com/WordPress/gutenberg/pull/75677#issuecomment-3920508270

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 0a158f919f4899fb8b58d0dffd4c3d89af4b8e9f.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/22138542851
📝  Reported issues:
- #75667 in `/test/e2e/specs/site-editor/page-list.spec.js`

### ciampo on 2026-02-18T13:24:30Z

URL: https://github.com/WordPress/gutenberg/pull/75677#issuecomment-3920819899

@jasmussen @jameskoster are you still OK to merge these changes despite what Lena flagged?

### jasmussen on 2026-02-18T14:42:19Z

URL: https://github.com/WordPress/gutenberg/pull/75677#issuecomment-3921222646

Sorry I missed that context. That feedback is valid, feel free to dismiss my approval.

But the thing is, the icons are not designed for being smaller than 24x24. We could go 16x16 on these. I'll defer to Jay and Lena.

### jameskoster on 2026-02-18T14:52:48Z

URL: https://github.com/WordPress/gutenberg/pull/75677#issuecomment-3921278443

I should say, I agree that the `small` IconButton sharing a footprint with the icon itself is a bit problematic, but I think that's something to figure out separately. This PR fixes an issue where currently the icons render at 22px which is unique and imo unwarranted. It also restores parity between `ui` and `components` packages.

### ciampo on 2026-02-18T15:03:20Z

URL: https://github.com/WordPress/gutenberg/pull/75677#issuecomment-3921334526

Right, let's merge and iterate.

### jameskoster on 2026-02-18T15:13:25Z

URL: https://github.com/WordPress/gutenberg/pull/75677#issuecomment-3921388117

Noting that changing icon size based on button size can also (arguably) be problematic. See the different ellipsis icons here, they look a little uncanny to me:

<img width="212" height="239" alt="Screenshot 2026-02-18 at 15 01 04" src="https://github.com/user-attachments/assets/cdab4d26-2156-42d2-ab77-665ab8507b7a" />

A controversial take, but currently I'd lean towards not having a `small` `IconButton` at all. At 24x24 it's the bare minimum size for AA compliance but not very ergonomic and I think we could do better. But that's a discussion for another issue... 😅

### jasmussen on 2026-02-18T15:23:38Z

URL: https://github.com/WordPress/gutenberg/pull/75677#issuecomment-3921440923

I think it's situationally useful, but I agree it's a size we should vitually never use. I'd stop short of removing it, though! Yes, can be a separate discussion, because I don't have strong opinions and can be swayed by arguments.

### mirka on 2026-02-18T15:32:19Z

URL: https://github.com/WordPress/gutenberg/pull/75677#issuecomment-3921493599

The small icon button is used relatively often in the [suffix of `InputControl`](https://wordpress.github.io/gutenberg/?path=/story/components-inputcontrol--show-password) 😅

### jasmussen on 2026-02-18T15:36:35Z

URL: https://github.com/WordPress/gutenberg/pull/75677#issuecomment-3921519483

That's important context, though, because in that context I feel it extra important the icon isn't scaled down.

### jameskoster on 2026-02-18T16:09:02Z

URL: https://github.com/WordPress/gutenberg/pull/75677#issuecomment-3921707281

I (perhaps naively) think most instances of `small` `IconButton` could be carefully refactored to the `compact` size without affecting the visual design too much. I recognise it's not a trivial change though!

Fortunately there are very few (if any) instances of `small` outline/solid icon buttons (where the issue is most prominent), so it's probably not a high priority.
...
- packages/ui/src/icon-button/style.module.css (MODIFIED, +7/-0)
