...
type: pull_request
state: MERGED
merged_at: 2026-04-22T01:48:59Z
url: https://github.com/WordPress/gutenberg/pull/77191
matched_labels: ["[Package] Components","[Package] UI"]
all_labels: ["[Type] Enhancement","[Package] Components","[Package] Editor","[Package] Block editor","[Package] UI"]
---

# PR #77191: Expand support for `isElementVisible` (`VisuallyHidden`)

- URL: https://github.com/WordPress/gutenberg/pull/77191
- Author: mirka
- Created: 2026-04-09T10:40:33Z
- Updated: 2026-04-22T01:50:31Z
- Comments: 3 of 3
- Review threads: 8 of 8
- Changed files: 11 of 11
- Diff: ../pr-diffs/77191.diff
...
Expands support for the `isElementVisible()` utility function in `@wordpress/block-editor` so any component can opt in by adding a `data-visually-hidden` attribute on itself.

## Why?

`isElementVisible()` function does its best to detect element visibility, but there's a limit to that because `VisuallyHidden`-like components are intentionally designed to evade these kinds of checks so they can remain in the accessibility tree. So there used to be some special handling for the `VisuallyHidden` component in `@wordpress/components`, based on its CSS class name.

There are several scalability issues with this approach, because arbitrary components cannot willingly add themselves to this special handling, and also not all components have identifiable CSS classes.

I considered a few possible approaches (including trying to specifically detect a `VisuallyHidden`-like pattern with more CSS-based checks), and I concluded that the best way was to change the approach from a CSS class name to a data attribute.
...
### github-actions on 2026-04-09T11:58:45Z

URL: https://github.com/WordPress/gutenberg/pull/77191#issuecomment-4214028335
...
### github-actions on 2026-04-09T12:12:45Z

URL: https://github.com/WordPress/gutenberg/pull/77191#issuecomment-4214106848
...
| :--- | :---: | :---: |
| `build/scripts/block-editor/index.min.js` | 341 kB | -9 B (0%) |
| `build/scripts/components/index.min.js` | 265 kB | +6 B (0%) |
...
| `build/modules/boot/index.min.js` | 17.1 kB |
...
| `build/scripts/editor/index.min.js` | 406 kB |
...
| `build/styles/editor/style-rtl.css` | 27.3 kB |
...
### github-actions on 2026-04-09T12:55:05Z

URL: https://github.com/WordPress/gutenberg/pull/77191#issuecomment-4214373629

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 1558ba2816250841d473878bdcc3f11716cba378.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/24754615673
📝  Reported issues:
...
#### mirka on 2026-04-09T10:42:24Z

URL: https://github.com/WordPress/gutenberg/pull/77191#discussion_r3057194942
...
#### mirka on 2026-04-09T10:44:32Z

URL: https://github.com/WordPress/gutenberg/pull/77191#discussion_r3057205610
Path: packages/ui/src/visually-hidden/visually-hidden.tsx

```diff
@@ -13,7 +13,11 @@ export const VisuallyHidden = forwardRef< HTMLDivElement, VisuallyHiddenProps >(
 			render,
 			ref,
...
#### ciampo on 2026-04-10T13:47:08Z

URL: https://github.com/WordPress/gutenberg/pull/77191#discussion_r3064656245
Path: packages/ui/src/visually-hidden/visually-hidden.tsx
...
#### mirka on 2026-04-15T12:09:28Z

URL: https://github.com/WordPress/gutenberg/pull/77191#discussion_r3086309007
Path: packages/ui/src/visually-hidden/visually-hidden.tsx
...
I considered it, but the point here is that arbitrary parties can opt into this. So I think it's marginally better without a prefix, and safe enough if there happen to be clashes.

### Review thread 4 (resolved)

#### ciampo on 2026-04-10T13:49:12Z

URL: https://github.com/WordPress/gutenberg/pull/77191#discussion_r3064669795
Path: packages/block-editor/src/utils/dom.js
...
#### mirka on 2026-04-15T12:12:32Z

URL: https://github.com/WordPress/gutenberg/pull/77191#discussion_r3086325810
Path: packages/block-editor/src/utils/dom.js
...
Fixed in 61233f3b17c5

### Review thread 5 (resolved)

#### ciampo on 2026-04-10T14:02:16Z

URL: https://github.com/WordPress/gutenberg/pull/77191#discussion_r3064743756
Path: packages/block-editor/src/utils/test/dom.js
...
URL: https://github.com/WordPress/gutenberg/pull/77191#discussion_r3086325821
Path: packages/block-editor/src/utils/test/dom.js
...
Fixed in 2002eff4f26a

### Review thread 6

#### ciampo on 2026-04-21T16:19:02Z

URL: https://github.com/WordPress/gutenberg/pull/77191#discussion_r3118869123
Path: packages/ui/src/visually-hidden/visually-hidden.tsx
...
#### ciampo on 2026-04-21T16:20:33Z

URL: https://github.com/WordPress/gutenberg/pull/77191#discussion_r3118877305
Path: packages/block-editor/src/utils/test/dom.js
...
#### ciampo on 2026-04-21T16:21:27Z

URL: https://github.com/WordPress/gutenberg/pull/77191#discussion_r3118882090
Path: packages/ui/src/visually-hidden/visually-hidden.tsx
...
- packages/editor/src/components/post-publish-panel/test/__snapshots__/index.js.snap (MODIFIED, +2/-0)
- packages/ui/src/visually-hidden/visually-hidden.tsx (MODIFIED, +5/-1)
