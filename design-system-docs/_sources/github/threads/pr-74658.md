...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/74658
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components"]
---

# PR #74658: ToggleControl: Add togglePosition prop for flexible switch placement

- URL: https://github.com/WordPress/gutenberg/pull/74658
- Author: shaunandrews
- Created: 2026-01-15T15:29:20Z
- Updated: 2026-01-21T19:20:56Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 6 of 6
- Diff: ../pr-diffs/74658.diff
...
### github-actions on 2026-01-15T15:40:19Z

URL: https://github.com/WordPress/gutenberg/pull/74658#issuecomment-3755472117
...
| :--- | :---: | :---: |
| `build/scripts/components/index.min.js` | 267 kB | +40 B (+0.02%) |
| `build/styles/components/style-rtl.css` | 16.9 kB | +16 B (+0.09%) |
| `build/styles/components/style-rtl.min.css` | 13.8 kB | +16 B (+0.12%) |
| `build/styles/components/style.css` | 17 kB | +14 B (+0.08%) |
| `build/styles/components/style.min.css` | 13.8 kB | +15 B (+0.11%) |
...
### github-actions on 2026-01-16T12:00:22Z

URL: https://github.com/WordPress/gutenberg/pull/74658#issuecomment-3759719245
...
### mirka on 2026-01-16T12:15:30Z

URL: https://github.com/WordPress/gutenberg/pull/74658#issuecomment-3759772197

Given the patterns that we currently see, I'd say it's better to leave this to custom-composed implementations using the `FormToggle` component. Right-aligned toggles tend to be used with arbitrary content on the left side, so supporting right alignment at the `ToggleControl` level is likely going to be restrictive and have limited use cases anyway.

I also feel like we shouldn't be actively promoting this right-aligned pattern in this (and other similar controls like radio and checkbox), as it would encourage inconsistency. Unless we first create guidelines on when they're appropriate.

### shaunandrews on 2026-01-21T19:20:55Z

URL: https://github.com/WordPress/gutenberg/pull/74658#issuecomment-3780737005
...
- packages/components/src/toggle-control/README.md (MODIFIED, +87/-22)
- packages/components/src/toggle-control/index.tsx (MODIFIED, +43/-19)
- packages/components/src/toggle-control/stories/index.story.tsx (MODIFIED, +17/-0)
- packages/components/src/toggle-control/style.scss (MODIFIED, +4/-0)
- packages/components/src/toggle-control/test/index.tsx (MODIFIED, +50/-0)
- packages/components/src/toggle-control/types.ts (MODIFIED, +18/-2)
