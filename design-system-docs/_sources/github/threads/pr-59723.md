...
type: pull_request
state: MERGED
merged_at: 2024-03-12T19:42:46Z
url: https://github.com/WordPress/gutenberg/pull/59723
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #59723: Add: Support for menu group to the Dropdown

- URL: https://github.com/WordPress/gutenberg/pull/59723
- Author: enejb
- Created: 2024-03-09T00:32:28Z
- Updated: 2024-03-12T19:43:07Z
- Comments: 3 of 3
- Review threads: 3 of 3
- Changed files: 4 of 4
- Diff: ../pr-diffs/59723.diff
...
### github-actions on 2024-03-09T00:32:43Z

URL: https://github.com/WordPress/gutenberg/pull/59723#issuecomment-1986601062
...
### github-actions on 2024-03-09T00:40:18Z

URL: https://github.com/WordPress/gutenberg/pull/59723#issuecomment-1986605065
...
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 252 kB | -263 B (0%) |
| `build/block-editor/style-rtl.css` | 15.6 kB | -79 B (-1%) |
| `build/block-editor/style.css` | 15.6 kB | -85 B (-1%) |
| `build/block-library/index.min.js` | 217 kB | +113 B (0%) |
...
| `build/edit-site/style-rtl.css` | 15 kB | +1 B (0%) |
| `build/edit-site/style.css` | 15 kB | +1 B (0%) |
| `build/editor/index.min.js` | 63.8 kB | +91 B (0%) |
...
### jasmussen on 2024-03-11T09:00:37Z

URL: https://github.com/WordPress/gutenberg/pull/59723#issuecomment-1987914990

Looks good to me. Will refer to Marin for the ✅!

## Review threads

### Review thread 1 (resolved)

#### tyxla on 2024-03-12T17:16:17Z

URL: https://github.com/WordPress/gutenberg/pull/59723#discussion_r1521849646
Path: packages/components/src/dropdown/stories/index.story.tsx

```diff
@@ -83,3 +85,25 @@ WithNoPadding.args = {
...
At first, I thought it needed updating, but I think we can completely remove the comment, which seems like a copy-pasta artifact anyway.
...
#### tyxla on 2024-03-12T17:16:50Z

URL: https://github.com/WordPress/gutenberg/pull/59723#discussion_r1521850395
Path: packages/components/src/dropdown/stories/index.story.tsx
...
No need for the `DropdownContentWrapper` wrapper since we don't play with the padding here, right?
...
#### tyxla on 2024-03-12T17:16:56Z

URL: https://github.com/WordPress/gutenberg/pull/59723#discussion_r1521850519
Path: packages/components/src/dropdown/stories/index.story.tsx
...
- packages/components/src/dropdown-menu/style.scss (MODIFIED, +0/-25)
- packages/components/src/dropdown/stories/index.story.tsx (MODIFIED, +19/-0)
- packages/components/src/dropdown/style.scss (MODIFIED, +26/-0)
