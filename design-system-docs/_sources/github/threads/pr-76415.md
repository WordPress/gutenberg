...
type: pull_request
state: MERGED
merged_at: 2026-03-17T19:19:40Z
url: https://github.com/WordPress/gutenberg/pull/76415
matched_labels: ["[Package] Theme"]
all_labels: ["[Type] Enhancement","[Package] Theme"]
---

# PR #76415: Theme: Add `no-token-fallback-values` stylelint rule

- URL: https://github.com/WordPress/gutenberg/pull/76415
- Author: mirka
- Created: 2026-03-11T20:24:00Z
- Updated: 2026-03-17T19:21:30Z
- Comments: 3 of 3
- Review threads: 3 of 3
- Changed files: 16 of 16
- Diff: ../pr-diffs/76415.diff

## Body

## What?

Adds a new stylelint rule `plugin-wpds/no-token-fallback-values` that disallows manually authored fallback values for `--wpds-*` design tokens.
...
The [`addFallbackToVar` PostCSS plugin](https://github.com/WordPress/gutenberg/blob/trunk/packages/theme/src/postcss-plugins/add-fallback-to-var.ts) in `@wordpress/theme` already injects fallbacks for `--wpds-*` tokens at build time. Manual fallbacks in source are redundant and can drift out of sync with the token definitions.

This is a companion rule to that build plugin, similar to how `no-unknown-ds-tokens` validates that tokens exist and `no-setting-wpds-custom-properties` prevents defining tokens outside of the design system.

## How?

- New plugin at `packages/theme/src/stylelint-plugins/no-token-fallback-values.mjs`. Uses a regex to match `var(--wpds-<name>,` patterns (the comma indicates a fallback).
...
- Refactors the existing stylelint plugin test setup to use per-rule config files instead of a shared config, so each rule's fixtures only need to satisfy their own rule.
...
### github-actions on 2026-03-11T20:41:29Z

URL: https://github.com/WordPress/gutenberg/pull/76415#issuecomment-4042080690
...
### github-actions on 2026-03-17T16:49:17Z

URL: https://github.com/WordPress/gutenberg/pull/76415#issuecomment-4076435705
...
### github-actions on 2026-03-17T17:06:58Z

URL: https://github.com/WordPress/gutenberg/pull/76415#issuecomment-4076580150

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 74ec5cee9f8359e69e3353ed3e444bd3b82d5270.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/23209966517
📝  Reported issues:
...
#### ciampo on 2026-03-17T17:05:59Z

URL: https://github.com/WordPress/gutenberg/pull/76415#discussion_r2948280752
Path: packages/theme/src/stylelint-plugins/no-token-fallback-values.mjs
...
Nit: for more precise error messages
...
Although we could also apply this in a separate PR to all of the lint rules we've created

#### mirka on 2026-03-17T18:25:46Z

URL: https://github.com/WordPress/gutenberg/pull/76415#discussion_r2948744092
Path: packages/theme/src/stylelint-plugins/no-token-fallback-values.mjs
...
910cc1f1e47df2fdbe89ac08d19befbe56656811

### Review thread 2 (resolved)

#### ciampo on 2026-03-17T17:07:35Z

URL: https://github.com/WordPress/gutenberg/pull/76415#discussion_r2948290678
Path: packages/theme/src/stylelint-plugins/test/fixtures/no-token-fallback-values-valid.css
...
#### mirka on 2026-03-17T18:26:02Z

URL: https://github.com/WordPress/gutenberg/pull/76415#discussion_r2948745297
Path: packages/theme/src/stylelint-plugins/test/fixtures/no-token-fallback-values-valid.css
...
74ec5cee9f8359e69e3353ed3e444bd3b82d5270

### Review thread 3 (resolved)

#### ciampo on 2026-03-17T17:08:06Z

URL: https://github.com/WordPress/gutenberg/pull/76415#discussion_r2948293956
Path: packages/theme/src/stylelint-plugins/test/fixtures/no-token-fallback-values-invalid.css
...
#### mirka on 2026-03-17T18:26:08Z

URL: https://github.com/WordPress/gutenberg/pull/76415#discussion_r2948745837
Path: packages/theme/src/stylelint-plugins/test/fixtures/no-token-fallback-values-invalid.css
...
- packages/theme/README.md (MODIFIED, +25/-2)
- packages/theme/package.json (MODIFIED, +5/-0)
- packages/theme/src/stylelint-plugins/no-token-fallback-values.mjs (ADDED, +55/-0)
- packages/theme/src/stylelint-plugins/test/.stylelintrc.json (DELETED, +0/-10)
- packages/theme/src/stylelint-plugins/test/.stylelintrc.no-setting-wpds-custom-properties.json (ADDED, +6/-0)
- packages/theme/src/stylelint-plugins/test/.stylelintrc.no-token-fallback-values.json (ADDED, +6/-0)
- packages/theme/src/stylelint-plugins/test/.stylelintrc.no-unknown-ds-tokens.json (ADDED, +6/-0)
- packages/theme/src/stylelint-plugins/test/__snapshots__/no-token-fallback-values.test.ts.snap (ADDED, +60/-0)
- packages/theme/src/stylelint-plugins/test/fixtures/no-token-fallback-values-invalid.css (ADDED, +16/-0)
- packages/theme/src/stylelint-plugins/test/fixtures/no-token-fallback-values-valid.css (ADDED, +18/-0)
- packages/theme/src/stylelint-plugins/test/no-setting-wpds-custom-properties.test.ts (MODIFIED, +6/-2)
- packages/theme/src/stylelint-plugins/test/no-token-fallback-values.test.ts (ADDED, +51/-0)
- packages/theme/src/stylelint-plugins/test/no-unknown-ds-tokens.test.ts (MODIFIED, +6/-2)
- packages/theme/src/stylelint-plugins/test/utils/index.ts (MODIFIED, +7/-4)
