...
type: pull_request
state: MERGED
merged_at: 2024-02-15T16:21:18Z
url: https://github.com/WordPress/gutenberg/pull/59022
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #59022: Components: Add lint rules for theme color CSS var usage

- URL: https://github.com/WordPress/gutenberg/pull/59022
- Author: mirka
- Created: 2024-02-14T15:51:47Z
- Updated: 2024-02-15T16:21:45Z
- Comments: 3 of 3
- Review threads: 1 of 1
- Changed files: 4 of 4
- Diff: ../pr-diffs/59022.diff
...
Adds stylelint and eslint rules to prevent direct usage of `wp-components-color-*` CSS variables in the components package.
...
Although we are restricting variable access through `var()`, at the moment I would still like to allow overriding definitions (`--wp-components-color-foo: #000`). There are legitimate use cases for it, and for now it's helpful to understand what those needs are.

## Testing Instructions

1. In the first commit where the eslint rule is added (6ccb546a496856f9935ea43c1cafcab2bf39df84), run `npm run lint:js`. The violations should be caught.
2. In the next commit where the violations are fixed (94f6be31a3319ef489c8c87af2aa91d296319242), the linter should pass.
3. In the final commit where the stylelint rule is added (1a0dc3b0993a0bb12c4631bd27a3f7ec88739f6b), run `npm run lint:css`. The linter should pass.
4. Test that the stylelint rule is working by adding a violation in a wp-components SCSS file somewhere.

## Issue comments

### github-actions on 2024-02-14T15:52:07Z

URL: https://github.com/WordPress/gutenberg/pull/59022#issuecomment-1944110754
...
### github-actions on 2024-02-14T15:59:45Z

URL: https://github.com/WordPress/gutenberg/pull/59022#issuecomment-1944126364
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 226 kB | -3 B (0%) |
...
| `build/editor/index.min.js` | 63.2 kB |
...
### github-actions on 2024-02-14T16:10:49Z

URL: https://github.com/WordPress/gutenberg/pull/59022#issuecomment-1944147316

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 221fcaac05a64a1f2ad775435a6c6f4434830452.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/7918586662
📝  Reported issues:
...
#### andrewhayward on 2024-02-15T12:24:08Z

URL: https://github.com/WordPress/gutenberg/pull/59022#discussion_r1490931501
Path: .eslintrc.js
...
#### mirka on 2024-02-15T15:50:15Z

URL: https://github.com/WordPress/gutenberg/pull/59022#discussion_r1491229910
Path: .eslintrc.js
...
- .eslintrc.js (MODIFIED, +9/-4)
- packages/components/.stylelintrc.js (MODIFIED, +2/-2)
