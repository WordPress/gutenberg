...
type: pull_request
state: MERGED
merged_at: 2022-08-17T07:05:01Z
url: https://github.com/WordPress/gutenberg/pull/43265
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components","Storybook"]
---

# PR #43265: ToggleGroupControl: Improve stories for Docs view

- URL: https://github.com/WordPress/gutenberg/pull/43265
- Author: mirka
- Created: 2022-08-16T10:54:10Z
- Updated: 2022-08-17T07:05:36Z
- Comments: 1 of 1
- Review threads: 3 of 3
- Changed files: 6 of 6
- Diff: ../pr-diffs/43265.diff

## Body

## What?

- Populate the props table with TypeScript data.
- Refactor the stories to use Controls instead of Knobs (#35665).
- Merge the WithAriaLabel story into the WithTooltip story.
- Remove the WithReset story since it doesn't serve a clear purpose anymore.
...
1. `npm run storybook:dev` and see the ToggleGroupControl page in Docs view.

## Issue comments

### github-actions on 2022-08-16T11:42:26Z

URL: https://github.com/WordPress/gutenberg/pull/43265#issuecomment-1216521427
...
| :--- | :---: | :---: |
| `build/block-directory/index.min.js` | 7.05 kB | +34 B (0%) |
| `build/block-editor/index.min.js` | 159 kB | +12 B (0%) |
| `build/block-editor/style-rtl.css` | 15.1 kB | -10 B (0%) |
| `build/block-editor/style.css` | 15.1 kB | -10 B (0%) |
| `build/block-library/index.min.js` | 186 kB | +10 B (0%) |
| `build/blocks/index.min.js` | 49.5 kB | +20 B (0%) |
| `build/components/index.min.js` | 198 kB | +514 B (0%) |
| `build/components/style-rtl.css` | 11.6 kB | -8 B (0%) |
| `build/components/style.css` | 11.6 kB | -7 B (0%) |
| `build/edit-navigation/style-rtl.css` | 4 kB | -18 B (0%) |
| `build/edit-navigation/style.css` | 4.01 kB | -19 B (0%) |
| `build/edit-site/index.min.js` | 57.3 kB | -18 B (0%) |
| `build/editor/index.min.js` | 41.5 kB | +92 B (0%) |
...
#### mirka on 2022-08-16T10:57:48Z

URL: https://github.com/WordPress/gutenberg/pull/43265#discussion_r946627773
...
@ciampo Thoughts? I don't think it makes sense for this to be polymorphic.

#### ciampo on 2022-08-16T19:19:16Z

URL: https://github.com/WordPress/gutenberg/pull/43265#discussion_r947170281
Path: packages/components/src/toggle-group-control/stories/index.tsx
...
Makes sense — this component has quite strong semantics, afterall

### Review thread 2

#### ciampo on 2022-08-16T19:30:32Z

URL: https://github.com/WordPress/gutenberg/pull/43265#discussion_r947178778
Path: packages/components/src/toggle-group-control/stories/index.tsx
...
#### ciampo on 2022-08-16T19:30:53Z

URL: https://github.com/WordPress/gutenberg/pull/43265#discussion_r947179043
Path: packages/components/src/toggle-group-control/stories/index.tsx
...
- packages/components/src/toggle-group-control/stories/index.js (DELETED, +0/-211)
- packages/components/src/toggle-group-control/stories/index.tsx (ADDED, +127/-0)
- packages/components/src/toggle-group-control/toggle-group-control/README.md (MODIFIED, +2/-0)
- packages/components/src/toggle-group-control/toggle-group-control/component.tsx (MODIFIED, +9/-6)
