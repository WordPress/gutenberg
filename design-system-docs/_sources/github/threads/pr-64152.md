...
type: pull_request
state: MERGED
merged_at: 2024-08-07T16:29:09Z
url: https://github.com/WordPress/gutenberg/pull/64152
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #64152: Button: Fix tertiary destructive hover style

- URL: https://github.com/WordPress/gutenberg/pull/64152
- Author: mirka
- Created: 2024-07-31T19:23:12Z
- Updated: 2024-08-07T16:29:33Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/64152.diff

## Body

Found when testing #62480

## What?

Fixes the hover/active colors of a Button with `variant="tertiary"` and `isDestructive`.

## Testing Instructions

See the "Tertiary" story for Button in Storybook and add a `isDestructive` prop.

For regression testing, try `npm run storybook:e2e:dev`. (The changes shouldn't affect other variants though)

## Screenshots or screencast <!-- if applicable -->

### Before
https://github.com/user-attachments/assets/b820dc23-1968-422f-81e6-a5b31da23a3b

### After
https://github.com/user-attachments/assets/508b7cf5-556d-490a-bad4-87133d123e68

## Issue comments

### github-actions on 2024-07-31T19:33:57Z

URL: https://github.com/WordPress/gutenberg/pull/64152#issuecomment-2261284392
...
### github-actions on 2024-08-06T20:52:09Z

URL: https://github.com/WordPress/gutenberg/pull/64152#issuecomment-2272130512
...
- packages/components/src/button/style.scss (MODIFIED, +10/-0)
