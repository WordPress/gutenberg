...
type: pull_request
state: MERGED
merged_at: 2022-02-09T21:33:10Z
url: https://github.com/WordPress/gutenberg/pull/38640
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Developer Documentation","[Package] Components","Storybook"]
---

# PR #38640: Storybook: Move experimental components to correct section

- URL: https://github.com/WordPress/gutenberg/pull/38640
- Author: mirka
- Created: 2022-02-08T21:08:37Z
- Updated: 2022-02-09T21:33:34Z
- Comments: 2 of 2
- Review threads: 1 of 1
- Changed files: 12 of 12
- Diff: ../pr-diffs/38640.diff
...
### github-actions on 2022-02-08T21:15:29Z

URL: https://github.com/WordPress/gutenberg/pull/38640#issuecomment-1033068923
...
### mirka on 2022-02-09T21:32:42Z

URL: https://github.com/WordPress/gutenberg/pull/38640#issuecomment-1034211871

> Should we add an entry to the CHANGELOG before merging?

I don't think we can add changelog entries for Storybook changes because it isn't versioned or exported as part of wp-components 🤷

## Review threads

### Review thread 1

#### ciampo on 2022-02-09T21:07:03Z

URL: https://github.com/WordPress/gutenberg/pull/38640#discussion_r803088145
...
What happens if we add another section to Storybook and we forget to add it to this sort list? Will it get displayed anyway or will it stay hidden?

#### mirka on 2022-02-09T21:26:44Z

URL: https://github.com/WordPress/gutenberg/pull/38640#discussion_r803101727
Path: storybook/preview.js
...
Good question. Unlisted sections will just be displayed after all the listed ones. And if someone is unhappy with that display order, a google search for "storybook section order" or something should easily guide their way to this config file 👍

## Changed files

- packages/components/src/alignment-matrix-control/README.md (MODIFIED, +4/-0)
- packages/components/src/alignment-matrix-control/stories/index.js (MODIFIED, +1/-1)
- packages/components/src/box-control/stories/index.js (MODIFIED, +4/-1)
- packages/components/src/input-control/stories/index.js (MODIFIED, +1/-1)
- packages/components/src/navigation/stories/index.js (MODIFIED, +1/-1)
- packages/components/src/number-control/stories/index.js (MODIFIED, +1/-1)
- packages/components/src/radio-group/stories/index.js (MODIFIED, +4/-1)
- packages/components/src/radio/stories/index.js (MODIFIED, +1/-1)
- packages/components/src/toggle-group-control/stories/index.js (MODIFIED, +1/-1)
- packages/components/src/tree-grid/stories/index.js (MODIFIED, +4/-1)
- packages/components/src/unit-control/stories/index.js (MODIFIED, +1/-1)
- storybook/preview.js (MODIFIED, +12/-0)
