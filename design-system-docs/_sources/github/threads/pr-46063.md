...
type: pull_request
state: MERGED
merged_at: 2022-11-28T13:55:59Z
url: https://github.com/WordPress/gutenberg/pull/46063
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #46063: LinkedButton: remove unnecessary span tag

- URL: https://github.com/WordPress/gutenberg/pull/46063
- Author: t-hamano
- Created: 2022-11-25T15:00:16Z
- Updated: 2022-11-28T13:56:25Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/46063.diff

## Body

Check this discussion for details: https://github.com/WordPress/gutenberg/pull/43802#discussion_r961459921

## What?
This PR removes an unnecessary `span` tag from the `LinkedButton` component.

## Why?
The link/unlink button design has been updated in #43802. We found that the `Button` component is directly placed below the `Tooltip` component, the button had an unexpected `.has-text` class and was not sized as intended.

![before](https://user-images.githubusercontent.com/54422211/204012184-56681e5f-c52c-43bd-955d-e42a1cb2164b.png)

However, #44198 fixed that problem, so now we can safely remove this `span` tag.

## Testing Instructions
Confirm that the `LinkedButton` component doesn't have `.has-text` class and maintains the intended size (square).

![after](https://user-images.githubusercontent.com/54422211/204012624-b846445c-32be-48c4-9dd1-3b9e46a30ccf.png)

## Issue comments

### codesandbox on 2022-11-25T15:00:18Z

URL: https://github.com/WordPress/gutenberg/pull/46063#issuecomment-1327604616

<img alt="CodeSandbox logo" src="https://raw.githubusercontent.com/codesandbox/open-in-codesandbox/main/assets/csb.light.svg#gh-dark-mode-only" /><img alt="CodeSandbox logo" src="https://raw.githubusercontent.com/codesandbox/open-in-codesandbox/main/assets/csb.svg#gh-light-mode-only" />&nbsp; Open in CodeSandbox <a href="https://codesandbox.io/p/github/WordPress/gutenberg/quality/linked-button-remove-span?workspace=%7B%22gitSidebarPanel%22:%22PR%22,%22sidebarPanel%22:%22GIT%22%7D">Web Editor</a> | <a href="https://codesandbox.io/p/vscode?owner=WordPress&repo=gutenberg&branch=quality/linked-button-remove-span">VS Code</a> | <a href="https://codesandbox.io/p/vscode?owner=WordPress&repo=gutenberg&branch=quality/linked-button-remove-span&insiders=true">VS Code Insiders</a>

<!-- open-in-codesandbox:complete -->

### github-actions on 2022-11-25T15:16:58Z

URL: https://github.com/WordPress/gutenberg/pull/46063#issuecomment-1327619738
...
### t-hamano on 2022-11-28T12:58:19Z

URL: https://github.com/WordPress/gutenberg/pull/46063#issuecomment-1329047924
...
- packages/components/src/box-control/linked-button.js (MODIFIED, +8/-11)
