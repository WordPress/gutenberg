...
type: pull_request
state: MERGED
merged_at: 2022-10-18T07:20:20Z
url: https://github.com/WordPress/gutenberg/pull/45012
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #45012: Components: Refactor `withFocusReturn` tests to RTL

- URL: https://github.com/WordPress/gutenberg/pull/45012
- Author: tyxla
- Created: 2022-10-17T09:43:04Z
- Updated: 2022-10-18T07:20:53Z
- Comments: 6 of 6
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/45012.diff
...
### github-actions on 2022-10-17T09:53:39Z

URL: https://github.com/WordPress/gutenberg/pull/45012#issuecomment-1280596050
...
### tyxla on 2022-10-17T13:33:34Z

URL: https://github.com/WordPress/gutenberg/pull/45012#issuecomment-1280869689

> Suggestion (non-blocking): I was wondering if we should also refactor from `fireEvent` to `userEvent`, and help with efforts in #44952.

Sure thing! Actually, the `fireEvent()` was not necessary for this specific test, so I've refactored it further to remove the `fireEvent` usage.

### Mamaduka on 2022-10-17T13:35:56Z

URL: https://github.com/WordPress/gutenberg/pull/45012#issuecomment-1280872976

Thanks again, @tyxla!

### ciampo on 2022-10-17T13:40:49Z

URL: https://github.com/WordPress/gutenberg/pull/45012#issuecomment-1280879960

> > Suggestion (non-blocking): I was wondering if we should also refactor from `fireEvent` to `userEvent`, and help with efforts in #44952.
> 
> Sure thing! Actually, the `fireEvent()` was not necessary for this specific test, so I've refactored it further to remove the `fireEvent` usage.

Focusing the `textarea` imperatively goes a bit against the principles that we've been adopting in our tests throughout the repo (i.e. testinfrom the point of view of the user) — in that sense, my preference would be to focus the `textarea` by clicking it / tabbing into it. WDYT ?

### tyxla on 2022-10-17T13:45:50Z

URL: https://github.com/WordPress/gutenberg/pull/45012#issuecomment-1280887583
...
This actually makes a lot of sense and I agree with the sentiment. In that case, we'll need `user-event` after all. 

I've changed it in https://github.com/WordPress/gutenberg/pull/45012/commits/24b2f4e72fb2648c2c34185c512ebeb63aae5f73 to actually resemble a user click on the textarea, which consequently focuses it.

### tyxla on 2022-10-17T13:46:03Z

URL: https://github.com/WordPress/gutenberg/pull/45012#issuecomment-1280887886

Thank you @ciampo and @Mamaduka 🙌
...
- packages/components/src/higher-order/with-focus-return/test/index.js (MODIFIED, +31/-27)
