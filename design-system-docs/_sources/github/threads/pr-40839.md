...
type: pull_request
state: MERGED
merged_at: 2022-05-05T09:47:17Z
url: https://github.com/WordPress/gutenberg/pull/40839
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Automated Testing","[Type] Code Quality","[Package] Components"]
---

# PR #40839: Setup user-event inline once per test

- URL: https://github.com/WordPress/gutenberg/pull/40839
- Author: ciampo
- Created: 2022-05-05T05:59:07Z
- Updated: 2022-05-05T09:47:59Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 3 of 3
- Diff: ../pr-diffs/40839.diff
...
As pointed out in [this comment](https://github.com/WordPress/gutenberg/pull/40790#pullrequestreview-961217027), currently `@testing-library/user-event` is setup once _per test file_ while the official docs [recommend setting it up **inline, once _per test_**](https://testing-library.com/docs/user-event/intro/#writing-tests-with-userevent).
...
Refactored `UnitControl` and `FormFileUpload` unit tests so that the `userEvent.setup()` call happens inline, once per test.
...
### github-actions on 2022-05-05T06:09:53Z

URL: https://github.com/WordPress/gutenberg/pull/40839#issuecomment-1118208597
...
- packages/components/src/form-file-upload/test/index.js (MODIFIED, +8/-4)
- packages/components/src/unit-control/test/index.tsx (MODIFIED, +84/-4)
