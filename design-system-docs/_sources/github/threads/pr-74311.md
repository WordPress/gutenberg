...
type: pull_request
state: MERGED
merged_at: 2026-01-07T19:25:53Z
url: https://github.com/WordPress/gutenberg/pull/74311
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Enhancement","[Package] UI"]
---

# PR #74311: UI: Add `Icon` component

- URL: https://github.com/WordPress/gutenberg/pull/74311
- Author: mirka
- Created: 2026-01-01T14:00:07Z
- Updated: 2026-01-08T07:28:05Z
- Comments: 3 of 3
- Review threads: 3 of 3
- Changed files: 10 of 10
- Diff: ../pr-diffs/74311.diff
...
Add `Icon` component to `@wordpress/ui`.

## Why?

This is a replacement for the `Icon` component in `@wordpress/components`, with these changes:

- Drops support for Dashicons, and anything other than normal svgs or `SVG`s from `@wordpress/primitives`.
- Defaults to `fill="currentColor"`.
...
<img width="689" height="343" alt="Storybook story for Icon" src="https://github.com/user-attachments/assets/b54f26d3-33d2-410b-b10c-75a93bd49f89" />

## Issue comments

### github-actions on 2026-01-01T14:02:43Z

URL: https://github.com/WordPress/gutenberg/pull/74311#issuecomment-3703727776
...
### github-actions on 2026-01-01T14:13:13Z

URL: https://github.com/WordPress/gutenberg/pull/74311#issuecomment-3703747932
...
### github-actions on 2026-01-01T18:10:39Z

URL: https://github.com/WordPress/gutenberg/pull/74311#issuecomment-3703960910

<!-- flaky-tests-report-comment -->
**Flaky tests detected in b707d57f0ddca897a3dbd32f26c459c93f00fb0e.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/20642807566
📝  Reported issues:
...
#### aduth on 2026-01-02T15:20:34Z

URL: https://github.com/WordPress/gutenberg/pull/74311#discussion_r2657895332
...
Random thought: `icon` feels like it's mostly identical in purpose to [the `render` prop](https://github.com/WordPress/gutenberg/blob/trunk/packages/ui/README.md#custom-rendering) in how it functions. I feel like `icon` is a more intuitive name, though maybe there'd be some benefit in using the `useRender` hook to manage its rendering? Then again, this doesn't feel very complex as it is.

### Review thread 2 (resolved)

#### aduth on 2026-01-02T15:27:05Z

URL: https://github.com/WordPress/gutenberg/pull/74311#discussion_r2657905631
Path: packages/ui/src/icon/stories/index.story.tsx
...
#### mirka on 2026-01-07T18:45:28Z

URL: https://github.com/WordPress/gutenberg/pull/74311#discussion_r2669685860
Path: packages/ui/src/icon/stories/index.story.tsx
...
aff0d1d69825a4e6487e2f79163dfeecf135e2a1

### Review thread 3

#### aduth on 2026-01-02T15:29:33Z

URL: https://github.com/WordPress/gutenberg/pull/74311#discussion_r2657909335
Path: packages/ui/src/icon/icon.tsx
...
I'm not sure what the plans are with the native editor, but given [past mentions of it being "paused"](https://github.com/WordPress/gutenberg/issues/71336) and ongoing development of [GutenbergKit](https://github.com/wordpress-mobile/GutenbergKit), do we think we'll need this primitive, or could we start with a plain `<svg />` ?

#### mirka on 2026-01-07T18:43:07Z

URL: https://github.com/WordPress/gutenberg/pull/74311#discussion_r2669677177
Path: packages/ui/src/icon/icon.tsx
...
1. React Native (things breaking in the shipping WordPress/Jetpack mobile apps).
2. [Mandatory addition](https://github.com/WordPress/gutenberg/blob/f8f3cf88f65be26e3d06caadc250257836b6887c/packages/primitives/src/svg/index.js#L98) of a `aria-hidden="true"`.
3. The [lint rule](https://github.com/WordPress/gutenberg/blob/f8f3cf88f65be26e3d06caadc250257836b6887c/.eslintrc.js#L242) that enforces the above two concerns on every `svg` in the codebase.
...
#### dcalhoun on 2026-01-07T22:50:27Z

URL: https://github.com/WordPress/gutenberg/pull/74311#discussion_r2670313394
Path: packages/ui/src/icon/icon.tsx
...
#### mirka on 2026-01-08T07:28:05Z

URL: https://github.com/WordPress/gutenberg/pull/74311#discussion_r2671198384
Path: packages/ui/src/icon/icon.tsx
...
- packages/ui/src/icon/icon.tsx (ADDED, +30/-0)
- packages/ui/src/icon/index.ts (ADDED, +1/-0)
- packages/ui/src/icon/stories/index.story.tsx (ADDED, +47/-0)
- packages/ui/src/icon/test/icon.test.tsx (ADDED, +13/-0)
- packages/ui/src/icon/types.ts (ADDED, +14/-0)
- packages/ui/src/index.ts (MODIFIED, +1/-0)
- packages/ui/tsconfig.json (MODIFIED, +2/-0)
