...
type: pull_request
state: MERGED
merged_at: 2024-07-08T13:08:43Z
url: https://github.com/WordPress/gutenberg/pull/63134
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #63134: FontSizePicker: use CustomSelectControl V2 legacy adapter

- URL: https://github.com/WordPress/gutenberg/pull/63134
- Author: ciampo
- Created: 2024-07-04T14:32:37Z
- Updated: 2024-07-08T13:09:06Z
- Comments: 4 of 4
- Review threads: 1 of 1
- Changed files: 4 of 4
- Diff: ../pr-diffs/63134.diff
...
### github-actions on 2024-07-04T14:32:50Z

URL: https://github.com/WordPress/gutenberg/pull/63134#issuecomment-2209137072
...
### github-actions on 2024-07-04T16:37:42Z

URL: https://github.com/WordPress/gutenberg/pull/63134#issuecomment-2209330013

**Size Change:** +683 B (+0.04%) 

**Total Size:** 1.76 MB

| Filename | Size | Change |
| :--- | :---: | :---: |
| `build/components/index.min.js` | 228 kB | +683 B (+0.3%) |
...
| `build/editor/index.min.js` | 97.8 kB |
...
### ciampo on 2024-07-08T09:52:43Z

URL: https://github.com/WordPress/gutenberg/pull/63134#issuecomment-2213562020

Merged https://github.com/WordPress/gutenberg/pull/63137 and rebased on top of latest `trunk`. This PR should be ready for a final round of review

### ciampo on 2024-07-08T11:11:28Z

URL: https://github.com/WordPress/gutenberg/pull/63134#issuecomment-2213712761

The main differences that I notice:

1. on this PR, the white space between the selected value and its hint (eg. between "Tiny" and "8") in the trigger button is 2px less than on `trunk`
2. the gap after the checkmark is smaller in this PR than on `trunk`
3. the popover size is slightly larger on `trunk` than in this PR

In my opinion:
- 1 is negligible and can be ignored;
- 2 is the expected design (the rightmost part of the checkmark is aligned with the rightmost part of the chevron down icon in the trigger button). This was introduced in https://github.com/WordPress/gutenberg/pull/62850 and should get "better" visually as we switch all instances of `CustomSelectControl` to the new 40px default size;
- 3 can be ignored (the new component represents an improvement over the old one).

I believe we can merge this PR, and address any potential further design feedback separately.

## Review threads

### Review thread 1

#### ciampo on 2024-07-04T16:29:34Z

URL: https://github.com/WordPress/gutenberg/pull/63134#discussion_r1665902498
...
This change was cherry-picked from https://github.com/WordPress/gutenberg/pull/63137 just to speed up development on this PR.

I will wait for https://github.com/WordPress/gutenberg/pull/63137 to be merged, rebase and remove this change from this PR before merging.
...
- packages/components/src/font-size-picker/test/index.tsx (MODIFIED, +6/-6)
- test/e2e/specs/editor/various/font-size-picker.spec.js (MODIFIED, +3/-3)
