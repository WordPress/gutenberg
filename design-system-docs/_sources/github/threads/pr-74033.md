...
type: pull_request
state: MERGED
merged_at: 2025-12-16T18:01:53Z
url: https://github.com/WordPress/gutenberg/pull/74033
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #74033: RangeControl: Deprecate bottom margin

- URL: https://github.com/WordPress/gutenberg/pull/74033
- Author: mirka
- Created: 2025-12-16T11:01:05Z
- Updated: 2025-12-16T18:08:26Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 38 of 38
- Diff: ../pr-diffs/74033.diff
...
Remove the deprecated `__nextHasNoMarginBottom` prop from `RangeControl`, making the margin-free styles the permanent default.
...
- Remove the `__nextHasNoMarginBottom` prop from `RangeControl` and its types and docs.
...
### github-actions on 2025-12-16T11:01:16Z

URL: https://github.com/WordPress/gutenberg/pull/74033#issuecomment-3659965278
...
### github-actions on 2025-12-16T11:16:13Z

URL: https://github.com/WordPress/gutenberg/pull/74033#issuecomment-3660021919
...
| :--- | :---: | :---: |
| `build/scripts/block-editor/index.min.js` | 317 kB | -18 B (-0.01%) |
| `build/scripts/block-library/index.min.js` | 281 kB | -11 B (0%) |
| `build/scripts/components/index.min.js` | 272 kB | -37 B (-0.01%) |
| `build/scripts/edit-site/index.min.js` | 240 kB | -3 B (0%) |
| `build/scripts/editor/index.min.js` | 284 kB | -6 B (0%) |
| `build/scripts/media-utils/index.min.js` | 69.4 kB | -3 B (0%) |
...
### github-actions on 2025-12-16T11:32:41Z

URL: https://github.com/WordPress/gutenberg/pull/74033#issuecomment-3660082405

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 32371d8d60adbb0d6f3eaa664d746dfdb860b259.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/20275610091
📝  Reported issues:
...
- packages/block-library/src/gallery/edit.js (MODIFIED, +0/-2)
- packages/block-library/src/latest-comments/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/latest-posts/edit.js (MODIFIED, +0/-2)
...
- packages/components/src/range-control/index.tsx (MODIFIED, +2/-5)
- packages/components/src/range-control/stories/index.story.tsx (MODIFIED, +0/-7)
- packages/components/src/range-control/styles/range-control-styles.ts (MODIFIED, +1/-9)
- packages/components/src/range-control/test/index.tsx (MODIFIED, +1/-7)
- packages/components/src/range-control/types.ts (MODIFIED, +9/-5)
- packages/components/src/validated-form-controls/components/range-control.tsx (MODIFIED, +1/-2)
- packages/dataviews/src/dataviews-layouts/grid/preview-size-picker.tsx (MODIFIED, +0/-1)
- packages/dataviews/src/dataviews-layouts/utils/preview-size-picker.tsx (MODIFIED, +0/-1)
