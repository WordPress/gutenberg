...
type: pull_request
state: MERGED
merged_at: 2022-08-11T14:29:59Z
url: https://github.com/WordPress/gutenberg/pull/43148
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #43148: Components: Refactor `Guide` `PageControl` tests to @testing-library/react

- URL: https://github.com/WordPress/gutenberg/pull/43148
- Author: tyxla
- Created: 2022-08-11T13:06:32Z
- Updated: 2022-08-11T14:30:31Z
- Comments: 1 of 1
- Review threads: 1 of 1
- Changed files: 1 of 1
- Diff: ../pr-diffs/43148.diff

## Body

## What?
This PR refactors the `<PageControl />` tests to use `@testing-library` instead of `enzyme`. 
...
We're straightforwardly using `@testing-library/react`'s `render()` and `user-event` for dispatching events.

## Testing Instructions
Verify tests pass: `npm run test:unit packages/components/src/guide/test/page-control.js`

## Issue comments

### github-actions on 2022-08-11T13:14:07Z

URL: https://github.com/WordPress/gutenberg/pull/43148#issuecomment-1211973275
...
#### ciampo on 2022-08-11T13:23:52Z

URL: https://github.com/WordPress/gutenberg/pull/43148#discussion_r943480462
Path: packages/components/src/guide/test/page-control.js

```diff
@@ -15,29 +11,28 @@ import PageControl from '../page-control';
...
We usually setup `userEvent ` this way:
...
Could we do the same here, for consistency's sake?

#### tyxla on 2022-08-11T13:28:39Z

URL: https://github.com/WordPress/gutenberg/pull/43148#discussion_r943485801
Path: packages/components/src/guide/test/page-control.js
...
- packages/components/src/guide/test/page-control.js (MODIFIED, +14/-17)
