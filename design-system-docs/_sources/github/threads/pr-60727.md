...
type: pull_request
state: MERGED
merged_at: 2024-04-16T15:51:02Z
url: https://github.com/WordPress/gutenberg/pull/60727
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #60727: Components: Remove CSS hack for Internet Explorer 11

- URL: https://github.com/WordPress/gutenberg/pull/60727
- Author: t-hamano
- Created: 2024-04-14T04:01:37Z
- Updated: 2024-04-16T15:51:31Z
- Comments: 2 of 2
- Review threads: 1 of 1
- Changed files: 3 of 3
- Diff: ../pr-diffs/60727.diff
...
- Run Syorybook and access the URL below.
  - `Placeholder`: http://localhost:50240/?path=/story/components-placeholder--default
  - `Toolbar`: http://localhost:50240/?path=/story/components-toolbar--default&args=label: (From my understanding, one scenario for having a legacy toolbar, i.e. `components-toolbar` class, is to have an empty label.)
- The exact same CSS as before should be applied.
...
| Before | After |
|--------|--------|
| ![image](https://github.com/WordPress/gutenberg/assets/54422211/96a290ed-7b8d-49f5-a8d6-e327e5fc54ca) | ![image](https://github.com/WordPress/gutenberg/assets/54422211/df32aa97-fc28-40b1-9a2d-f9c48b3f9eb6) | 

### Toolbar

| Before | After |
|--------|--------|
|  ![image](https://github.com/WordPress/gutenberg/assets/54422211/b8e8d975-532c-45d4-8afc-21df3a973007)|  ![image](https://github.com/WordPress/gutenberg/assets/54422211/8e63ae69-aab7-4c11-8d52-0a97f1b25922)|

## Issue comments

### github-actions on 2024-04-14T04:06:41Z

URL: https://github.com/WordPress/gutenberg/pull/60727#issuecomment-2053891336
...
### github-actions on 2024-04-14T04:11:18Z

URL: https://github.com/WordPress/gutenberg/pull/60727#issuecomment-2053892702
...
#### t-hamano on 2024-04-14T04:04:34Z

URL: https://github.com/WordPress/gutenberg/pull/60727#discussion_r1564438487
...
I think this is a typo. `top` was not the correct property value and was not working properly in the first place, so I removed it.

#### tyxla on 2024-04-15T15:13:44Z

URL: https://github.com/WordPress/gutenberg/pull/60727#discussion_r1565962861
Path: packages/components/src/placeholder/style.scss
...
I wonder if it was meant to be `justify-content: start`?

#### t-hamano on 2024-04-16T01:38:36Z

URL: https://github.com/WordPress/gutenberg/pull/60727#discussion_r1566605970
Path: packages/components/src/placeholder/style.scss
...
This change was made in [#54216](https://github.com/WordPress/gutenberg/pull/54216/files#diff-e6d39e2bf2050a2e7a7022d39b3ddb498bf87165293fd8759302bab4c2dfb346R19) and was changed from `center`, but I think it was intended for `start`. It was probably added to explicitly align child elements to the top.

However, even if this component had an explicit height, it seems to have no effect with or without `justify-content: top`. Should we add `justify-content: top` just to be sure?


https://github.com/WordPress/gutenberg/assets/54422211/54191b08-722f-4a37-9290-a8de8911946e

#### tyxla on 2024-04-16T12:09:12Z

URL: https://github.com/WordPress/gutenberg/pull/60727#discussion_r1567246101
Path: packages/components/src/placeholder/style.scss
...
Since `top` is not a valid value, adding it will be the same as not adding it, so I think we can just omit it.

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/placeholder/style.scss (MODIFIED, +3/-7)
- packages/components/src/toolbar/toolbar-group/style.scss (MODIFIED, +1/-6)
