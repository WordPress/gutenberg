...
type: pull_request
state: OPEN
url: https://github.com/WordPress/gutenberg/pull/78472
matched_labels: ["[Package] Components","[Package] UI"]
all_labels: ["[Type] Task","[Package] Components","Storybook","[Package] UI"]
---

# PR #78472: Storybook: Create centralized registry of component statuses

- URL: https://github.com/WordPress/gutenberg/pull/78472
- Author: aduth
- Created: 2026-05-20T16:49:58Z
- Updated: 2026-05-21T18:52:40Z
- Comments: 4 of 4
- Review threads: 2 of 2
- Changed files: 135 of 135
- Diff: ../pr-diffs/78472.diff
...
- Extending component manifests to include component status notes and then surfacing those status notes through the `@wordpress/design-system-mcp`
- Replacing the current manual process for decorating component stories with the `'manifest'` tag for inclusion in the design system component manifest with an automated process using the centralized configuration

Component status isn't directly tied to Storybook, and while these updates don't yet detach it from the current Storybook usage (it still lives within the private `@wordpress/storybook` package under `storybook/`), it does make it a smaller step to maintain this data elsewhere.

## How?

- Adds new `storybook/component-status.ts` with a combined configuration of current component statuses
- Exposes this data as a `@wordpress/storybook/component-status` export (note: this is a private package, not published)
- Updates the existing Storybook UI extension to use this as the source of component status rather than the story configuration
- Removes `componentStatus` from individual stories

This doesn't yet include the changes to add the component status to the components manifest or surfacing that information through the MCP server, which will be implemented separately (see #78475).
...
2. Go to http://localhost:50240/?path=/docs/components-button--docs
3. See the same status indicator as on [the live version of the Storybook](https://wordpress.github.io/gutenberg/?path=/docs/components-button--docs)

## Screenshots or screencast <!-- if applicable -->

Screenshot for reference, but this is unchanged from what already exists:

<img width="1330" height="854" alt="image" src="https://github.com/user-attachments/assets/90a7b327-017c-4dd7-879c-dcc181626bdf" />

## Use of AI Tools

Researched and implemented with Claude Code & Cursor + Claude Opus 4.7. Iterations based on manual review (e.g. removing `componentStatus` outright instead of replacing with utility function). Some code comments replaced with hand-written comments after manual review.

## Issue comments

### github-actions on 2026-05-20T16:50:25Z

URL: https://github.com/WordPress/gutenberg/pull/78472#issuecomment-4500630265
...
### github-actions on 2026-05-20T16:58:09Z

URL: https://github.com/WordPress/gutenberg/pull/78472#issuecomment-4500685391
...
### github-actions on 2026-05-20T17:32:06Z

URL: https://github.com/WordPress/gutenberg/pull/78472#issuecomment-4500924897

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 10f3acf2ab544f81a23046ceb45e524d57a1d5ec.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/26244302741
📝  Reported issues:
- #77721 in `/test/e2e/specs/editor/various/publish-panel.spec.js`

### aduth on 2026-05-21T18:52:40Z

URL: https://github.com/WordPress/gutenberg/pull/78472#issuecomment-4511789386

While it should be fine here, I think I'll need to revisit canonical component names in #78475. Many of our components are known to Storybook by their dot-deliminated names like `Tabs.Root`, so a flat name reference here `Tabs` will fail. Conversely, we could keep the full names and lean into that with status tracking, but then we might have the opposite issue with how other existing code ([example](https://github.com/WordPress/gutenberg/blob/db5c55ffb1f0b6ea617157ec515f8d0f5a2716dc/packages/design-system-mcp/src/parse-components.ts#L61-L74)) canonicalizes to strip the suffixes. I kinda like the flat names and they conform to how the component's named package exports are used, but using the full name for the status keys could allow for addressing the exactness-over-convention concern I raised in https://github.com/WordPress/gutenberg/pull/78472#discussion_r3283373925.

## Review threads

### Review thread 1

#### mirka on 2026-05-21T16:29:13Z

URL: https://github.com/WordPress/gutenberg/pull/78472#discussion_r3282758375
Path: storybook/component-status.ts

I guess we should remove `packages/components/storybook.d.ts` now?

### Review thread 2

#### mirka on 2026-05-21T16:39:50Z

URL: https://github.com/WordPress/gutenberg/pull/78472#discussion_r3282824300
Path: storybook/component-status.ts
...
Many components don't expose the registry key here, so the component status can get lost on components that previously had them. For example `Slot`, and wp-ui `Tabs` and `Tooltip`.

<img width="1392" height="786" alt="Tabs in Storybook" src="https://github.com/user-attachments/assets/db542843-81e1-4284-a7a1-7634d242dad1" />

#### aduth on 2026-05-21T17:35:59Z

URL: https://github.com/WordPress/gutenberg/pull/78472#discussion_r3283166017
Path: storybook/component-status.ts
...
#### aduth on 2026-05-21T18:10:14Z

URL: https://github.com/WordPress/gutenberg/pull/78472#discussion_r3283373925
Path: storybook/component-status.ts
...
I updated this in 10f3acf2ab544f81a23046ceb45e524d57a1d5ec to use `useOf( 'story' )` instead of `useOf( 'meta' )` which gives us a `fileName` path we can derive to a package with relative confidence. Extracting the component name from the Storybook title still feels a bit fragile, but there's nothing about Storybook that necessarily ties a Story to some export of a package, so this convention feels like the best we can do to attach it to the named export.

## Changed files

- packages/components/src/alignment-matrix-control/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/angle-picker-control/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/animate/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/badge/stories/index.story.tsx (MODIFIED, +0/-7)
- packages/components/src/base-control/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/border-box-control/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/border-control/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/box-control/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/button/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/card/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/checkbox-control/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/circular-option-picker/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/color-indicator/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/color-palette/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/color-picker/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/combobox-control/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/composite/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/confirm-dialog/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/custom-gradient-picker/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/custom-select-control-v2/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/custom-select-control/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/date-time/stories/date-time.story.tsx (MODIFIED, +0/-5)
- packages/components/src/date-time/stories/date.story.tsx (MODIFIED, +0/-5)
- packages/components/src/date-time/stories/time.story.tsx (MODIFIED, +0/-5)
- packages/components/src/disabled/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/divider/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/draggable/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/drop-zone/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/dropdown-menu/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/dropdown/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/duotone-picker/stories/duotone-picker.story.tsx (MODIFIED, +0/-4)
- packages/components/src/duotone-picker/stories/duotone-swatch.story.tsx (MODIFIED, +0/-4)
- packages/components/src/elevation/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/external-link/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/flex/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/focal-point-picker/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/font-size-picker/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/form-file-upload/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/form-toggle/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/form-token-field/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/gradient-picker/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/grid/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/guide/stories/index.story.tsx (MODIFIED, +0/-6)
- packages/components/src/h-stack/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/heading/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/icon/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/input-control/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/item-group/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/keyboard-shortcuts/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/menu-group/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/menu-item/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/menu-items-choice/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/menu/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/modal/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/navigable-container/stories/navigable-menu.story.tsx (MODIFIED, +0/-4)
- packages/components/src/navigable-container/stories/tabbable-container.story.tsx (MODIFIED, +0/-5)
- packages/components/src/navigator/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/notice/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/number-control/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/palette-edit/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/panel/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/placeholder/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/popover/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/progress-bar/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/query-controls/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/radio-control/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/range-control/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/resizable-box/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/responsive-wrapper/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/sandbox/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/scroll-lock/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/scrollable/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/search-control/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/select-control/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/shortcut/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/slot-fill/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/snackbar/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/spacer/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/spinner/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/surface/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/tab-panel/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/tabs/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/text-control/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/text-highlight/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/text/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/textarea-control/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/theme/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/tip/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/toggle-control/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/toggle-group-control/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/toolbar/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/tools-panel/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/tooltip/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/tree-grid/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/tree-select/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/truncate/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/unit-control/stories/index.story.tsx (MODIFIED, +0/-4)
- packages/components/src/v-stack/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/view/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/visually-hidden/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/components/src/z-stack/stories/index.story.tsx (MODIFIED, +0/-5)
- packages/grid/src/dashboard-grid/stories/index.story.tsx (MODIFIED, +0/-7)
- packages/grid/src/dashboard-lanes/stories/index.story.tsx (MODIFIED, +0/-7)
- packages/ui/src/alert-dialog/stories/index.story.tsx (MODIFIED, +0/-7)
- packages/ui/src/badge/stories/index.story.tsx (MODIFIED, +0/-6)
- packages/ui/src/button/stories/index.story.tsx (MODIFIED, +0/-7)
- packages/ui/src/card/stories/index.story.tsx (MODIFIED, +0/-6)
- packages/ui/src/collapsible-card/stories/index.story.tsx (MODIFIED, +0/-6)
- packages/ui/src/collapsible/stories/index.story.tsx (MODIFIED, +0/-6)
- packages/ui/src/dialog/stories/index.story.tsx (MODIFIED, +0/-7)
- packages/ui/src/drawer/stories/index.story.tsx (MODIFIED, +0/-7)
- packages/ui/src/empty-state/stories/index.story.tsx (MODIFIED, +0/-6)
- packages/ui/src/form/input-control/stories/index.story.tsx (MODIFIED, +0/-7)
- packages/ui/src/form/primitives/autocomplete/stories/index.story.tsx (MODIFIED, +0/-7)
- packages/ui/src/form/primitives/field/stories/index.story.tsx (MODIFIED, +0/-7)
- packages/ui/src/form/primitives/fieldset/stories/index.story.tsx (MODIFIED, +0/-7)
- packages/ui/src/form/primitives/input-layout/stories/index.story.tsx (MODIFIED, +0/-7)
- packages/ui/src/form/primitives/input/stories/index.story.tsx (MODIFIED, +0/-7)
- packages/ui/src/form/primitives/select/stories/index.story.tsx (MODIFIED, +0/-7)
- packages/ui/src/form/primitives/textarea/stories/index.story.tsx (MODIFIED, +0/-7)
- packages/ui/src/icon-button/stories/index.story.tsx (MODIFIED, +0/-7)
- packages/ui/src/icon/stories/index.story.tsx (MODIFIED, +0/-7)
- packages/ui/src/link/stories/index.story.tsx (MODIFIED, +0/-6)
- packages/ui/src/notice/stories/index.story.tsx (MODIFIED, +0/-7)
- packages/ui/src/popover/stories/index.story.tsx (MODIFIED, +0/-7)
- packages/ui/src/stack/stories/index.story.tsx (MODIFIED, +0/-6)
- packages/ui/src/tabs/stories/index.story.tsx (MODIFIED, +0/-6)
- packages/ui/src/text/stories/index.story.tsx (MODIFIED, +0/-6)
- packages/ui/src/tooltip/stories/index.story.tsx (MODIFIED, +0/-7)
- packages/ui/src/tooltip/stories/usage-guidelines.story.tsx (MODIFIED, +0/-5)
- packages/ui/src/visually-hidden/stories/index.story.tsx (MODIFIED, +0/-6)
- storybook/component-status.ts (ADDED, +695/-0)
- storybook/components/component-status-indicator/index.tsx (MODIFIED, +6/-7)
- storybook/package.json (MODIFIED, +2/-1)
- storybook/types.d.ts (DELETED, +0/-15)
