...
type: pull_request
state: OPEN
url: https://github.com/WordPress/gutenberg/pull/57062
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components"]
---

# PR #57062: Popover: Try hide when reference is hidden

- URL: https://github.com/WordPress/gutenberg/pull/57062
- Author: mirka
- Created: 2023-12-14T13:37:01Z
- Updated: 2026-01-28T10:51:49Z
- Comments: 5 of 5
- Review threads: 0 of 0
- Changed files: 3 of 3
- Diff: ../pr-diffs/57062.diff
...
### github-actions on 2023-12-14T13:37:22Z

URL: https://github.com/WordPress/gutenberg/pull/57062#issuecomment-1855869308
...
### github-actions on 2023-12-14T13:44:10Z

URL: https://github.com/WordPress/gutenberg/pull/57062#issuecomment-1855880108
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 257 kB | +227 B (0%) |
| `build/components/style-rtl.css` | 12.1 kB | +15 B (0%) |
...
### github-actions on 2023-12-14T13:55:38Z

URL: https://github.com/WordPress/gutenberg/pull/57062#issuecomment-1855897863

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 39800c47ebf3f1ee56fb98540474d01354302e0a.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/7209657643
📝  Reported issues:
- #56776 in `/test/e2e/specs/site-editor/font-library.spec.js`

### ciampo on 2023-12-14T14:40:06Z

URL: https://github.com/WordPress/gutenberg/pull/57062#issuecomment-1855972889

This is an interesting solution, although it doesn't entirely fix the issue when the tooltip leaves the overflow container before the anchor

![Screenshot 2023-12-14 at 15 37 47](https://github.com/WordPress/gutenberg/assets/1083581/30137845-1680-487d-a9c6-750d90579ee4)

Another minor difference compared to "true" scroll overflow is that the tooltip disappears completely when the anchor is hidden, instead of being partially cutoff.

### mirka on 2023-12-14T15:48:14Z

URL: https://github.com/WordPress/gutenberg/pull/57062#issuecomment-1856093294

Is that an issue though? I think the general expectation is that a floating-ui is not clipped by its reference element's clipping context. It may not be crucial in something small like a simple tooltip, but imagine something bigger like a dropdown menu or a color palette. You want that to be visible in whole as long as the viewport allows it (and don't forget there's the x-axis, too).

<img width="341" alt="A dropdown menu displayed above the clipping context boundary" src="https://github.com/WordPress/gutenberg/assets/555336/9810ab23-2b24-4c19-97b5-c6eec28715dd">
...
- packages/components/src/popover/index.tsx (MODIFIED, +4/-1)
- packages/components/src/popover/stories/index.story.tsx (MODIFIED, +21/-12)
- packages/components/src/popover/style.scss (MODIFIED, +4/-0)
