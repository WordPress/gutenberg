...
type: pull_request
state: MERGED
merged_at: 2022-06-09T19:34:56Z
url: https://github.com/WordPress/gutenberg/pull/41472
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Feature] UI Components","[Package] Components"]
---

# PR #41472: AnglePickerControl: Use NumberControl as input field

- URL: https://github.com/WordPress/gutenberg/pull/41472
- Author: walbo
- Created: 2022-05-31T20:48:46Z
- Updated: 2022-06-09T19:35:20Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/41472.diff
...
## What?
Update the `AnglePickerControl` to use `NumberControl`

## Why?
Since the input field expects a number the `NumberControl` should be used. This adds a few enhancements that the `InputControl` doesn't have:

- It adds the ability to use the up/down arrows on the keyboard to change the number.
- It contrains the value to be between 0 and 360
- Input text is disallowed 
- Enabled the option to drag

## How?
Remove `InputControl` with `NumberControl`

## Testing Instructions
1. Test the component in storybook and make sure everything works as expected
2. Test the component where it is used and make sure everything works as expected. Ex. in the `GradientPicker`
3. Type in a too large number, ex. 9999. On blur the number should be contrained to 360.
4. Typing text should show in the input


## Screenshots or screencast <!-- if applicable -->
| Before | After |
| - | - |
| ![before](https://user-images.githubusercontent.com/1415747/171281697-fd37b78c-eeef-491b-8b20-f5504d4d9846.gif) | ![after](https://user-images.githubusercontent.com/1415747/171281790-37f59850-df0a-41cf-851c-0734aed1f765.gif) |

## Issue comments

### github-actions on 2022-05-31T21:01:39Z

URL: https://github.com/WordPress/gutenberg/pull/41472#issuecomment-1142636236
