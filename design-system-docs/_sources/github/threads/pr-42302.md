...
type: pull_request
state: MERGED
merged_at: 2022-07-14T07:43:07Z
url: https://github.com/WordPress/gutenberg/pull/42302
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Feature] UI Components","[Type] Code Quality","[Package] Components"]
---

# PR #42302: Elevation: Convert component to TypeScript

- URL: https://github.com/WordPress/gutenberg/pull/42302
- Author: walbo
- Created: 2022-07-10T22:00:18Z
- Updated: 2022-07-14T07:43:34Z
- Comments: 1 of 1
- Review threads: 4 of 4
- Changed files: 14 of 14
- Diff: ../pr-diffs/42302.diff
...
## What?
Converts the `Elevation` component to TypeScript.

## Why?
Part of the @wordpress/components's TypeScript migration (https://github.com/WordPress/gutenberg/issues/35744).

## How?
- Refactors the current `Elevation` to TypeScript.
- Refactors the test to TypeScript.
- Refactors storybook to TypeScript and controls. With controls the storybook can be simplified.

## Testing Instructions
1. Run npm run dev and ensure no typing errors
2. Fire up the Storybook and confirm the `Elevation` continues to function as expected

## Issue comments

### github-actions on 2022-07-10T22:10:56Z

URL: https://github.com/WordPress/gutenberg/pull/42302#issuecomment-1179809194
...
#### mirka on 2022-07-12T22:20:39Z

URL: https://github.com/WordPress/gutenberg/pull/42302#discussion_r919472171
Path: packages/components/src/elevation/stories/index.tsx
...
We can fix the `jsx-a11y` problem by using a `button` instead:
...
(Also removed some unnecessary styles for brevity in the code snippets, and added a "Click me" label.)

#### walbo on 2022-07-13T18:53:14Z

URL: https://github.com/WordPress/gutenberg/pull/42302#discussion_r920403352
Path: packages/components/src/elevation/stories/index.tsx
...
#### mirka on 2022-07-12T22:23:43Z

URL: https://github.com/WordPress/gutenberg/pull/42302#discussion_r919473630
Path: packages/components/src/elevation/stories/index.tsx
...
It took me a while to understand what the `isInteractive` prop is for. I find it more understandable if this is broken into three stories. What do you think?
...
#### walbo on 2022-07-13T18:58:36Z

URL: https://github.com/WordPress/gutenberg/pull/42302#discussion_r920407670
Path: packages/components/src/elevation/stories/index.tsx
...
Yes. Makes sense. Will update the story 👍

### Review thread 3 (resolved)

#### mirka on 2022-07-13T01:29:29Z

URL: https://github.com/WordPress/gutenberg/pull/42302#discussion_r919562998
Path: packages/components/src/elevation/types.ts

```diff
@@ -35,18 +39,22 @@ export type Props = {
 	 */
 	offset?: number;
 	/**
...
I _think_ this is what's missing in this phrase?
...
#### mirka on 2022-07-13T01:35:28Z

URL: https://github.com/WordPress/gutenberg/pull/42302#discussion_r919565178
Path: packages/components/src/elevation/types.ts
...
Personally, this note and example about the `isInteractive` doesn't quite make sense to me here as part of the `value` prop description, and made me more confused 😅 What do you think about removing them? The description for the `isInteractive` prop itself, coupled with the improved Storybook stories, should be sufficient.

#### walbo on 2022-07-13T19:10:27Z

URL: https://github.com/WordPress/gutenberg/pull/42302#discussion_r920416435
Path: packages/components/src/elevation/types.ts
...
- packages/components/src/elevation/README.md (MODIFIED, +16/-14)
- packages/components/src/elevation/component.js (DELETED, +0/-43)
- packages/components/src/elevation/component.tsx (ADDED, +48/-0)
- packages/components/src/elevation/hook.ts (RENAMED, +20/-17)
- packages/components/src/elevation/index.ts (RENAMED, +0/-0)
- packages/components/src/elevation/stories/index.js (DELETED, +0/-148)
- packages/components/src/elevation/stories/index.tsx (ADDED, +85/-0)
- packages/components/src/elevation/styles.ts (RENAMED, +0/-0)
- packages/components/src/elevation/test/__snapshots__/index.tsx.snap (RENAMED, +19/-13)
- packages/components/src/elevation/test/index.js (DELETED, +0/-51)
- packages/components/src/elevation/test/index.tsx (ADDED, +64/-0)
- packages/components/src/elevation/types.ts (MODIFIED, +12/-19)
