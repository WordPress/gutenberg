...
type: pull_request
state: MERGED
merged_at: 2026-03-17T16:49:06Z
url: https://github.com/WordPress/gutenberg/pull/76254
matched_labels: ["[Package] Theme"]
all_labels: ["[Type] Bug","[Package] Theme"]
---

# PR #76254: Fix token fallback plugins breaking JS strings with quoted font names

- URL: https://github.com/WordPress/gutenberg/pull/76254
- Author: ciampo
- Created: 2026-03-06T15:49:37Z
- Updated: 2026-03-17T16:49:58Z
- Comments: 3 of 3
- Review threads: 3 of 3
- Changed files: 7 of 7
- Diff: ../pr-diffs/76254.diff
...
### github-actions on 2026-03-06T15:49:47Z

URL: https://github.com/WordPress/gutenberg/pull/76254#issuecomment-4012525623
...
### github-actions on 2026-03-06T16:06:10Z

URL: https://github.com/WordPress/gutenberg/pull/76254#issuecomment-4012613103
...
### github-actions on 2026-03-06T16:38:06Z

URL: https://github.com/WordPress/gutenberg/pull/76254#issuecomment-4012781787

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 15c33aeba6ee81c6dba51dbe52cffccc7e073221.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/22780899036
📝  Reported issues:
...
#### copilot-pull-request-reviewer on 2026-03-06T15:59:55Z

URL: https://github.com/WordPress/gutenberg/pull/76254#discussion_r2896556123
Path: packages/theme/src/postcss-plugins/ds-token-fallbacks.mjs
...
The header note says this logic “mirrors `add-fallback-to-var.ts`”, but `ds-token-fallbacks.mjs` now has additional behavior (`escapeQuotes` option + different signature) that is not present in `add-fallback-to-var.ts`. To avoid the two implementations drifting, either add the same `escapeQuotes` option to `add-fallback-to-var.ts` (and keep signatures aligned), or update this NOTE to explicitly state what is and isn’t mirrored (e.g., only the regex).

### Review thread 2 (resolved)

#### copilot-pull-request-reviewer on 2026-03-06T15:59:55Z

URL: https://github.com/WordPress/gutenberg/pull/76254#discussion_r2896556158
Path: packages/theme/src/postcss-plugins/ds-token-fallbacks.mjs
...
`escapeQuotes` introduces new escaping behavior that can affect runtime output for JS/TS transforms, but there’s no automated test covering it. Please add a unit test that asserts fallback values containing quoted font names are escaped when `escapeQuotes: true`, and unchanged when the option is omitted/false.

### Review thread 3

#### mirka on 2026-03-10T16:29:35Z

URL: https://github.com/WordPress/gutenberg/pull/76254#discussion_r2912987000
Path: packages/theme/src/postcss-plugins/ds-token-fallbacks.mjs
...
#### ciampo on 2026-03-17T16:48:51Z

URL: https://github.com/WordPress/gutenberg/pull/76254#discussion_r2948172770
Path: packages/theme/src/postcss-plugins/ds-token-fallbacks.mjs
...
Yeah, it's unfortunate but hopefully still ok

## Changed files

- packages/theme/src/esbuild-plugins/esbuild-ds-token-fallbacks.mjs (MODIFIED, +1/-1)
- packages/theme/src/postcss-plugins/add-fallback-to-var.ts (MODIFIED, +19/-8)
- packages/theme/src/postcss-plugins/ds-token-fallbacks.mjs (MODIFIED, +21/-7)
- packages/theme/src/postcss-plugins/test/add-fallback-to-var.test.ts (MODIFIED, +52/-0)
- packages/theme/src/vite-plugins/vite-ds-token-fallbacks.mjs (MODIFIED, +4/-1)
- packages/ui/src/card/stories/index.story.tsx (MODIFIED, +1/-1)
- packages/ui/src/collapsible-card/stories/index.story.tsx (MODIFIED, +1/-1)
