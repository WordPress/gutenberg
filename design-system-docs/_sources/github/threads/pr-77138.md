...
type: pull_request
state: MERGED
merged_at: 2026-04-10T09:30:02Z
url: https://github.com/WordPress/gutenberg/pull/77138
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components","[Package] DataViews"]
---

# PR #77138: Calendar: fix disabled styles

- URL: https://github.com/WordPress/gutenberg/pull/77138
- Author: oandregal
- Created: 2026-04-08T10:07:07Z
- Updated: 2026-04-10T09:32:47Z
- Comments: 9 of 9
- Review threads: 2 of 2
- Changed files: 5 of 5
- Diff: ../pr-diffs/77138.diff
...
### github-actions on 2026-04-08T10:12:35Z

URL: https://github.com/WordPress/gutenberg/pull/77138#issuecomment-4205495485
...
### github-actions on 2026-04-08T10:23:34Z

URL: https://github.com/WordPress/gutenberg/pull/77138#issuecomment-4205556463
...
| `build/scripts/edit-site/index.min.js` | 262 kB | +11 B (0%) |
| `build/scripts/editor/index.min.js` | 412 kB | +11 B (0%) |
| `build/scripts/media-utils/index.min.js` | 77.5 kB | +10 B (+0.01%) |
| `build/styles/components/style-rtl.css` | 17.3 kB | -1 B (-0.01%) |
| `build/styles/components/style-rtl.min.css` | 14.1 kB | +1 B (+0.01%) |
| `build/styles/components/style.min.css` | 14.1 kB | +1 B (+0.01%) |
...
### github-actions on 2026-04-08T10:47:13Z

URL: https://github.com/WordPress/gutenberg/pull/77138#issuecomment-4205686743

<!-- flaky-tests-report-comment -->
**Flaky tests detected in a1ab520c4001182815a64440db687c11dcde7fb5.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/24234627492
📝  Reported issues:
...
### oandregal on 2026-04-08T12:07:10Z

URL: https://github.com/WordPress/gutenberg/pull/77138#issuecomment-4206104445
...
### ciampo on 2026-04-08T14:53:19Z

URL: https://github.com/WordPress/gutenberg/pull/77138#issuecomment-4207174012

Before we go ahead, I wanted to share [this comment of mine](https://github.com/WordPress/gutenberg/pull/75683#issuecomment-3950952567) from the recent tweaks I made to the disabled colors:

> I opted for keeping the color of disabled chevrons and disabled (but selected) date background unchanged for two reasons:
> 
...
More in general, let's make sure that the changes that were applied in #75683 are kept, since they were following feedback from project stakeholders.

### ciampo on 2026-04-08T15:00:20Z

URL: https://github.com/WordPress/gutenberg/pull/77138#issuecomment-4207219610

Re. the new color picked for the background of the disabled date, we also need to make sure it carries enough contrast — even if the component is not interactive, being able to "visually find" and read the selected date is still meaningful information for the end user?

On the other hand, if we take the new DS componentry and tokens into account, I guess we should aim for the same colrs as a [disabled, neutral, primary button](https://wordpress.github.io/gutenberg/?path=/story/design-system-components-button--default&args=tone:neutral;disabled:!true) — which is quite similar to what we have already.

### oandregal on 2026-04-09T12:05:28Z

URL: https://github.com/WordPress/gutenberg/pull/77138#issuecomment-4214066830
...
I didn't know this existed. I've pushed https://github.com/WordPress/gutenberg/pull/77138/commits/31810c971efbe5d02f6f8a57132574e8c885faf3 to disable navigation as well.

### oandregal on 2026-04-09T12:08:27Z

URL: https://github.com/WordPress/gutenberg/pull/77138#issuecomment-4214082999

Before | After
--- | ---
<img width="659" height="584" alt="Screenshot 2026-04-09 at 14 06 08" src="https://github.com/user-attachments/assets/02732bb1-82b8-42de-92c8-57735d74ccba" /> | <img width="627" height="1020" alt="Screenshot 2026-04-09 at 14 06 18" src="https://github.com/user-attachments/assets/08d34b13-5b3e-47a0-9d89-f3565c02bec7" />

@ciampo colors are now aligned with existing components. I operate with the assumption we should hold the same standards for all of them (re: contrast). Let me know if there's any adjustment you'd like to make before merging.

### oandregal on 2026-04-10T08:49:31Z

URL: https://github.com/WordPress/gutenberg/pull/77138#issuecomment-4222331504

Following suit to https://github.com/WordPress/gutenberg/pull/77208/ I've reduced the surface for the changes in calendar: just changed the `$components-color-disabled` to `$components-color-gray-400` (same as FormControl when enabled).
...
#### copilot-pull-request-reviewer on 2026-04-08T10:16:40Z

URL: https://github.com/WordPress/gutenberg/pull/77138#discussion_r3050666645
...
#### copilot-pull-request-reviewer on 2026-04-08T10:16:41Z

URL: https://github.com/WordPress/gutenberg/pull/77138#discussion_r3050666690
...
#### oandregal on 2026-04-09T12:04:52Z

URL: https://github.com/WordPress/gutenberg/pull/77138#discussion_r3057664837
Path: packages/components/src/calendar/style.scss
...
The `:has` selector is pre-existing.

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/calendar/style.scss (MODIFIED, +1/-1)
- packages/dataviews/CHANGELOG.md (MODIFIED, +1/-0)
- packages/dataviews/src/components/dataform-controls/date.tsx (MODIFIED, +1/-0)
- packages/dataviews/src/dataform/stories/layout-regular.tsx (MODIFIED, +9/-2)
