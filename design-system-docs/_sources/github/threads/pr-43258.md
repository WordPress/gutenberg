...
type: pull_request
state: MERGED
merged_at: 2022-08-16T12:06:40Z
url: https://github.com/WordPress/gutenberg/pull/43258
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Performance","[Type] Code Quality","[Package] Components","[Package] Blocks","[Package] Editor","[Package] Block editor","[Feature] Block Directory"]
---

# PR #43258: Lodash: Refactor away from `_.mapKeys()`

- URL: https://github.com/WordPress/gutenberg/pull/43258
- Author: tyxla
- Created: 2022-08-16T09:55:19Z
- Updated: 2022-08-16T13:07:50Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 8 of 8
- Diff: ../pr-diffs/43258.diff
...
### github-actions on 2022-08-16T10:14:06Z

URL: https://github.com/WordPress/gutenberg/pull/43258#issuecomment-1216438941
...
| `build/block-editor/index.min.js` | 159 kB | +42 B (0%) |
| `build/blocks/index.min.js` | 49.5 kB | +19 B (0%) |
| `build/components/index.min.js` | 198 kB | +8 B (0%) |
| `build/editor/index.min.js` | 41.4 kB | +30 B (0%) |
...
- packages/block-directory/src/store/resolvers.js (MODIFIED, +6/-2)
- packages/block-editor/src/components/rich-text/use-format-types.js (MODIFIED, +6/-6)
- packages/block-editor/src/store/selectors.js (MODIFIED, +5/-4)
- packages/blocks/src/api/registration.js (MODIFIED, +9/-7)
- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/utils/rtl.js (MODIFIED, +6/-2)
- packages/editor/src/hooks/custom-sources-backwards-compatibility.js (MODIFIED, +14/-12)
