...
type: pull_request
state: MERGED
merged_at: 2026-01-15T22:24:53Z
url: https://github.com/WordPress/gutenberg/pull/74622
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #74622: `@wordpress/components`: lint and fix `@wordpress/components-no-missing-40px-size-prop` rule

- URL: https://github.com/WordPress/gutenberg/pull/74622
- Author: ciampo
- Created: 2026-01-14T17:45:16Z
- Updated: 2026-01-15T22:25:26Z
- Comments: 3 of 3
- Review threads: 2 of 2
- Changed files: 48 of 48
- Diff: ../pr-diffs/74622.diff
...
Following up the work from https://github.com/WordPress/gutenberg/pull/74611, this PR applies the `@wordpress/components-no-missing-40px-size-prop` ESLint rule to the `@wordpress/components` package and then applies all the necessary changes to fix all the resulting violations.

## Why?
<!-- Why is this PR necessary? What problem is it solving? Reference any existing previous issue(s) or PR(s), but please add a short summary here, too -->

The code in the `@wordpress/components` package should be using its own components correctly too, holding itself to the same standards as its consumers.

This has a few advantages:

- better Storybook examples (including code snippets)
- less expections, more clarity

## How?
<!-- How is your PR addressing the issue at hand? What are the implementation details? -->

- Enabled the `@wordpress/components-no-missing-40px-size-prop` for local imports in the `@wordpress/components`
- Tweaked the rule to exempt `Button` components with `variant="link"`
- Fixed all errors one by one
...
### ciampo on 2026-01-14T17:59:19Z

URL: https://github.com/WordPress/gutenberg/pull/74622#issuecomment-3750893024

In a lot of cases, I opted for adding an explicit `__next40pxDefaultSize`, even when:

- the prop wouldn't make any difference (like in unit tests)
- the component would already receive the `__next40pxDefaultSize` (for example, via Storybook args)

I otherwise decided to skip the rule check if the parent component is also linted for the same rule and is forwarding the `__next40pxDefaultSize` prop.

### github-actions on 2026-01-14T17:59:35Z

URL: https://github.com/WordPress/gutenberg/pull/74622#issuecomment-3750894318
...
### github-actions on 2026-01-14T18:05:09Z

URL: https://github.com/WordPress/gutenberg/pull/74622#issuecomment-3750916932
...
#### ciampo on 2026-01-14T17:56:33Z

URL: https://github.com/WordPress/gutenberg/pull/74622#discussion_r2691476043
Path: packages/eslint-plugin/rules/components-no-missing-40px-size-prop.js

Changes to the lint rule:

- lint local default imports
- exempt `<Button variant="link" />` 
- add more component to the list of components to check

### Review thread 2

#### ciampo on 2026-01-14T17:57:29Z

URL: https://github.com/WordPress/gutenberg/pull/74622#discussion_r2691478844
Path: .eslintrc.js
...
I decided to use `**/*.@(android|ios|native).[tj]s?(x)` everywhere, as it seems like the most complete glob for native files

## Changed files

- .eslintrc.js (MODIFIED, +7/-6)
- packages/components/src/base-control/stories/index.story.tsx (MODIFIED, +3/-1)
- packages/components/src/border-box-control/border-box-control-split-controls/component.tsx (MODIFIED, +9/-0)
- packages/components/src/border-box-control/stories/index.story.tsx (MODIFIED, +2/-0)
- packages/components/src/border-box-control/test/index.tsx (MODIFIED, +51/-20)
- packages/components/src/border-control/stories/index.story.tsx (MODIFIED, +1/-0)
- packages/components/src/border-control/test/index.js (MODIFIED, +37/-34)
- packages/components/src/box-control/index.tsx (MODIFIED, +6/-0)
- packages/components/src/box-control/stories/index.story.tsx (MODIFIED, +2/-1)
- packages/components/src/button-group/stories/index.story.tsx (MODIFIED, +4/-2)
- packages/components/src/button/deprecated.tsx (MODIFIED, +2/-0)
- packages/components/src/button/stories/e2e/index.story.tsx (MODIFIED, +8/-4)
- packages/components/src/button/stories/index.story.tsx (MODIFIED, +8/-4)
- packages/components/src/card/stories/index.story.tsx (MODIFIED, +3/-1)
- packages/components/src/circular-option-picker/circular-option-picker-option.tsx (MODIFIED, +2/-1)
- packages/components/src/clipboard-button/index.tsx (MODIFIED, +2/-0)
- packages/components/src/clipboard-button/types.ts (MODIFIED, +1/-0)
...
- packages/components/src/font-size-picker/stories/e2e/index.story.tsx (MODIFIED, +2/-0)
- packages/components/src/font-size-picker/stories/index.story.tsx (MODIFIED, +1/-0)
- packages/components/src/form-file-upload/index.tsx (MODIFIED, +2/-0)
...
- packages/components/src/guide/stories/index.story.tsx (MODIFIED, +5/-1)
- packages/components/src/input-control/stories/index.story.tsx (MODIFIED, +2/-1)
- packages/components/src/menu/stories/index.story.tsx (MODIFIED, +4/-1)
- packages/components/src/modal/stories/index.story.tsx (MODIFIED, +10/-2)
- packages/components/src/navigation/stories/utils/controlled-state.tsx (MODIFIED, +3/-0)
...
- packages/components/src/popover/stories/index.story.tsx (MODIFIED, +8/-1)
- packages/components/src/radio-group/radio.tsx (MODIFIED, +2/-0)
- packages/components/src/range-control/stories/index.story.tsx (MODIFIED, +4/-0)
- packages/components/src/scroll-lock/stories/index.story.tsx (MODIFIED, +5/-1)
- packages/components/src/select-control/stories/index.story.tsx (MODIFIED, +2/-0)
- packages/components/src/tabs/stories/index.story.tsx (MODIFIED, +10/-2)
- packages/components/src/text-control/stories/index.story.tsx (MODIFIED, +1/-0)
- packages/components/src/theme/stories/index.story.tsx (MODIFIED, +7/-3)
- packages/components/src/tooltip/stories/index.story.tsx (MODIFIED, +13/-3)
...
- packages/components/src/unit-control/stories/index.story.tsx (MODIFIED, +2/-0)
- packages/eslint-plugin/rules/__tests__/components-no-missing-40px-size-prop.js (MODIFIED, +7/-0)
- packages/eslint-plugin/rules/components-no-missing-40px-size-prop.js (MODIFIED, +51/-0)
