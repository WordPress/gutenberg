...
type: pull_request
state: MERGED
merged_at: 2022-08-29T07:44:11Z
url: https://github.com/WordPress/gutenberg/pull/43617
matched_labels: ["[Package] Components"]
all_labels: ["[Feature] UI Components","[Type] Regression","[Package] Components","Needs Dev Note"]
---

# PR #43617: Popover: enable auto-updating every animation frame

- URL: https://github.com/WordPress/gutenberg/pull/43617
- Author: ciampo
- Created: 2022-08-25T14:15:55Z
- Updated: 2022-10-04T13:37:10Z
- Comments: 4 of 4
- Review threads: 1 of 1
- Changed files: 4 of 4
- Diff: ../pr-diffs/43617.diff
...
### github-actions on 2022-08-25T14:35:23Z

URL: https://github.com/WordPress/gutenberg/pull/43617#issuecomment-1227347362
...
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 159 kB | -9 B (0%) |
| `build/components/index.min.js` | 197 kB | -58 B (0%) |
...
### ciampo on 2022-08-29T06:32:55Z

URL: https://github.com/WordPress/gutenberg/pull/43617#issuecomment-1229838624

Just rebased this PR, will merge once CI is ✅ 

Regarding performance, I didn't really spot increased lagginess, but I really didn't do much testing on that, as I focused on fixing the bugs.

Once this PR gets merged, I should be able to work on https://github.com/WordPress/gutenberg/pull/43335, which hopefully may bring some perf improvements 🤞 although the "real" fix will be to improve cross-document support directly in `floating-ui` (https://github.com/floating-ui/floating-ui/issues/1869)

### ciampo on 2022-08-31T08:10:57Z

URL: https://github.com/WordPress/gutenberg/pull/43617#issuecomment-1232609681

This PR seems to have broken the [draggable block e2e tests](https://github.com/WordPress/gutenberg/blob/c4bdc602cce6b885eca90a538a412d7175039689/packages/e2e-tests/specs/editor/various/draggable-block.test.js), I'll see if I can make the test work — otherwise I will open a PR that will  partially undo the changes from this PR

### ciampo on 2022-08-31T09:21:23Z

URL: https://github.com/WordPress/gutenberg/pull/43617#issuecomment-1232689910
...
#### youknowriad on 2022-10-03T07:54:57Z

URL: https://github.com/WordPress/gutenberg/pull/43617#discussion_r985479949
...
It now happens in the "select" and "inserter open" metrics after this PR https://github.com/WordPress/gutenberg/pull/42722 but it can also happen I guess for other interactions when there's a big list of popovers.

So can we remove it or is it still necessary? Are there alternatives?

#### kevin940726 on 2022-10-03T08:17:42Z

URL: https://github.com/WordPress/gutenberg/pull/43617#discussion_r985499513
Path: packages/components/src/popover/index.js
...
From the [floating-ui](https://floating-ui.com/docs/autoUpdate#animationframe) doc:
...
#### ciampo on 2022-10-04T11:23:38Z

URL: https://github.com/WordPress/gutenberg/pull/43617#discussion_r986745228
Path: packages/components/src/popover/index.js
...
This was introduced mainly to fix https://github.com/WordPress/gutenberg/issues/42725, I expect that bug (and any other nested popover) to happen again if we undo this change — maybe it could be just enabled for the block toolbar?
...
#### youknowriad on 2022-10-04T11:33:24Z

URL: https://github.com/WordPress/gutenberg/pull/43617#discussion_r986754259
Path: packages/components/src/popover/index.js
...
#### ciampo on 2022-10-04T13:37:10Z

URL: https://github.com/WordPress/gutenberg/pull/43617#discussion_r986877300
Path: packages/components/src/popover/index.js
...
- packages/block-editor/src/components/block-popover/index.js (MODIFIED, +0/-2)
- packages/components/CHANGELOG.md (MODIFIED, +4/-0)
- packages/components/src/popover/index.js (MODIFIED, +17/-35)
- packages/components/src/popover/stories/index.js (MODIFIED, +0/-1)
