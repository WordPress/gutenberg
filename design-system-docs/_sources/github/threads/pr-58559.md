...
type: pull_request
state: MERGED
merged_at: 2024-02-01T14:24:01Z
url: https://github.com/WordPress/gutenberg/pull/58559
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #58559: Components: Allow limiting the number of maximum visible Snackbars

- URL: https://github.com/WordPress/gutenberg/pull/58559
- Author: Mamaduka
- Created: 2024-02-01T13:13:53Z
- Updated: 2024-02-02T08:01:23Z
- Comments: 7 of 7
- Review threads: 0 of 0
- Changed files: 5 of 5
- Diff: ../pr-diffs/58559.diff
...
### github-actions on 2024-02-01T13:23:47Z

URL: https://github.com/WordPress/gutenberg/pull/58559#issuecomment-1921317365
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 235 kB | +28 B (0%) |
| `build/edit-widgets/index.min.js` | 17.3 kB | +9 B (0%) |
| `build/editor/index.min.js` | 61.6 kB | +9 B (0%) |
...
### richtabor on 2024-02-01T14:48:25Z

URL: https://github.com/WordPress/gutenberg/pull/58559#issuecomment-1921506574

I like it, but not that the 3+ snackbars show up after dismissing a more recent one. 

I would expect that the old snackers are actually gone when they're "gone".

### Mamaduka on 2024-02-01T14:56:12Z

URL: https://github.com/WordPress/gutenberg/pull/58559#issuecomment-1921522513

I checked other libraries like [Sonner](https://sonner.emilkowal.ski/), and they have the same behavior. The prop controls how many Snackbars are visible simultaneously; it's not actually removing the snackbars from the store.

### mirka on 2024-02-01T16:21:09Z

URL: https://github.com/WordPress/gutenberg/pull/58559#issuecomment-1921702203

Is there a reason the consumer can't modify the notice array themselves before it hits `SnackbarList`? The reason I'm asking is because it's not self-evident with a `maxVisible` prop that the slicing would happen from the tail end of the array. Some consumers may want the opposite behavior. It seems simpler for the consumer to handle that, rather than add specific props to SnackbarList to control it.

### Mamaduka on 2024-02-01T16:28:30Z

URL: https://github.com/WordPress/gutenberg/pull/58559#issuecomment-1921718250

> Is there a reason the consumer can't modify the notice array themselves before it hits SnackbarList?

I don't have a strong opinion here, happy to move logic into consumers. I will create a follow-up tomorrow morning.

### Mamaduka on 2024-02-02T08:01:09Z

URL: https://github.com/WordPress/gutenberg/pull/58559#issuecomment-1923276848

Here's the follow-up.

### github-actions on 2024-02-02T08:01:21Z

URL: https://github.com/WordPress/gutenberg/pull/58559#issuecomment-1923277147
...
```
Props: mamaduka, andraganescu, richtabor, 0mirka00, glendaviesnz, joen.
```
...
- packages/components/src/snackbar/list.tsx (MODIFIED, +3/-1)
- packages/components/src/snackbar/types.ts (MODIFIED, +1/-0)
- packages/edit-widgets/src/components/notices/index.js (MODIFIED, +1/-0)
- packages/editor/src/components/editor-snackbars/index.js (MODIFIED, +1/-0)
