...
type: pull_request
state: MERGED
merged_at: 2021-09-10T01:08:20Z
url: https://github.com/WordPress/gutenberg/pull/34632
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Type] Enhancement","[Feature] UI Components","[Package] Components","[Feature] Design Tools"]
---

# PR #34632: ToolsPanel: Allow SlotFill injection of panel items

- URL: https://github.com/WordPress/gutenberg/pull/34632
- Author: aaronrobertshaw
- Created: 2021-09-08T06:02:54Z
- Updated: 2021-09-10T01:08:50Z
- Comments: 3 of 3
- Review threads: 4 of 4
- Changed files: 11 of 11
- Diff: ../pr-diffs/34632.diff
...
### github-actions on 2021-09-08T06:11:00Z

URL: https://github.com/WordPress/gutenberg/pull/34632#issuecomment-914947717
...
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 120 kB | +39 B (0%) |
...
| `build/block-library/editor-rtl.css` | 9.54 kB | +6 B (0%) |
| `build/block-library/editor.css` | 9.52 kB | +5 B (0%) |
| `build/block-library/index.min.js` | 151 kB | +16 B (0%) |
| `build/components/index.min.js` | 209 kB | +110 B (0%) |
...
| `build/edit-site/index.min.js` | 26.6 kB | +206 B (+1%) |
...
### gziolo on 2021-09-08T07:56:46Z

URL: https://github.com/WordPress/gutenberg/pull/34632#issuecomment-915007380

I see changes in the public API but it seems to be fine `ToolsPanel` and `ToolsPanelItem` are still considered experimental:

https://github.com/WordPress/gutenberg/blob/e3591aa86bfc4fe02da616ef50e722504ba8b3d8/packages/components/src/index.js#L141-L144

### aaronrobertshaw on 2021-09-09T06:41:14Z

URL: https://github.com/WordPress/gutenberg/pull/34632#issuecomment-915807558
...
Thanks for catching that @ciampo! 
...
I've added another unit test for this along with a fix. I now get the following behaviour:

https://user-images.githubusercontent.com/60436221/132624756-cd71b628-b79b-4853-94a8-89327d98de8a.mp4

> Also, do you think it'd be valuable to add a Storybook example showing how to use the panelId props, especially in the context of injection of panel items via a SlotFill?

I've added another storybook example that creates its own SlotFill and uses that to illustrate injecting items into the panel. Hopefully, that makes sense and is useful. I'm not tied to it so if anyone has any suggestions on improving it or even removing it, that's fine by me.

The rewording of the docs and some typo fixes have been made as well.

## Review threads

### Review thread 1 (resolved)

#### gziolo on 2021-09-08T11:44:22Z

URL: https://github.com/WordPress/gutenberg/pull/34632#discussion_r704339029
Path: packages/components/src/tools-panel/tools-panel/README.md
...
Continuing on the comment from @ciampo, it feels like this prop needs a better description that is disconnected from the SlotFill pattern. `@wordpress/components` is a set of general purpose components so it feels like this part is tightly couple with the higher-level abstraction that doesn't fit here.

#### aaronrobertshaw on 2021-09-09T06:42:43Z

URL: https://github.com/WordPress/gutenberg/pull/34632#discussion_r705016472
Path: packages/components/src/tools-panel/tools-panel/README.md
...
I've had another go at [describing this prop](https://github.com/WordPress/gutenberg/pull/34632/commits/ee6b6821b9a5960f56ec3c8e38f513c31600c58a) free of mentioning the SlotFill pattern. Let me know if that misses the mark and needs some further rewording.

#### gziolo on 2021-09-09T07:08:57Z

URL: https://github.com/WordPress/gutenberg/pull/34632#discussion_r705038032
Path: packages/components/src/tools-panel/tools-panel/README.md
...
Thank you. I like more general phrasing more 👍🏻

### Review thread 2 (resolved)

#### gziolo on 2021-09-09T07:11:32Z

URL: https://github.com/WordPress/gutenberg/pull/34632#discussion_r705040605
Path: packages/components/src/tools-panel/stories/index.js
...
#### aaronrobertshaw on 2021-09-09T07:23:12Z

URL: https://github.com/WordPress/gutenberg/pull/34632#discussion_r705051833
Path: packages/components/src/tools-panel/stories/index.js
...
It does work although I get a warning about the `Slot` property not existing on type. Which can be avoided by simply using the `Slot` direct from `createSlotFill`. I was trying to stay consistent with how most other SlotFills are handled in other packages.

I'll update this so the code is as simple as possible.

#### aaronrobertshaw on 2021-09-09T07:24:48Z

URL: https://github.com/WordPress/gutenberg/pull/34632#discussion_r705053792
Path: packages/components/src/tools-panel/stories/index.js
...
#### gziolo on 2021-09-09T07:37:14Z

URL: https://github.com/WordPress/gutenberg/pull/34632#discussion_r705068142
Path: packages/components/src/tools-panel/stories/index.js
...
#### aaronrobertshaw on 2021-09-09T07:55:02Z

URL: https://github.com/WordPress/gutenberg/pull/34632#discussion_r705081156
Path: packages/components/src/tools-panel/stories/index.js
...
It makes sense in terms of being able to remove the need for `panelId` on the `ToolsPanel` itself. At this stage though, I don't have much of an idea how the individual `ToolsPanelItem`s would be working.

#### gziolo on 2021-09-09T08:14:26Z

URL: https://github.com/WordPress/gutenberg/pull/34632#discussion_r705095699
Path: packages/components/src/tools-panel/stories/index.js
...
#### ciampo on 2021-09-09T09:18:31Z

URL: https://github.com/WordPress/gutenberg/pull/34632#discussion_r705146836
Path: packages/components/src/tools-panel/tools-panel/README.md
...
- packages/components/src/tools-panel/index.js (MODIFIED, +1/-0)
- packages/components/src/tools-panel/stories/index.js (MODIFIED, +94/-6)
- packages/components/src/tools-panel/test/index.js (MODIFIED, +23/-4)
- packages/components/src/tools-panel/tools-panel-header/README.md (MODIFIED, +4/-9)
- packages/components/src/tools-panel/tools-panel-header/component.js (MODIFIED, +4/-5)
- packages/components/src/tools-panel/tools-panel-item/README.md (MODIFIED, +38/-2)
- packages/components/src/tools-panel/tools-panel-item/hook.js (MODIFIED, +18/-6)
- packages/components/src/tools-panel/tools-panel/README.md (MODIFIED, +11/-12)
- packages/components/src/tools-panel/tools-panel/component.js (MODIFIED, +1/-3)
- packages/components/src/tools-panel/tools-panel/hook.js (MODIFIED, +40/-7)
