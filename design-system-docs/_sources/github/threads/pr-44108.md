...
type: pull_request
state: MERGED
merged_at: 2022-09-15T05:39:15Z
url: https://github.com/WordPress/gutenberg/pull/44108
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #44108: Components: Refactor `ColorPalette` tests to `@testing-library/react`

- URL: https://github.com/WordPress/gutenberg/pull/44108
- Author: tyxla
- Created: 2022-09-13T08:10:37Z
- Updated: 2022-09-15T05:39:40Z
- Comments: 1 of 1
- Review threads: 2 of 2
- Changed files: 3 of 3
- Diff: ../pr-diffs/44108.diff
...
### github-actions on 2022-09-13T08:24:59Z

URL: https://github.com/WordPress/gutenberg/pull/44108#issuecomment-1245069100
...
| :--- | :---: | :---: | :---: |
| `build/block-editor/index.min.js` | 162 kB | -1.03 kB (-1%) |  |
...
| `build/block-library/index.min.js` | 190 kB | +1.01 kB (+1%) |  |
| `build/block-library/style-rtl.css` | 12.2 kB | +173 B (+1%) |  |
| `build/block-library/style.css` | 12.2 kB | +172 B (+1%) |  |
...
#### ciampo on 2022-09-13T14:28:05Z

URL: https://github.com/WordPress/gutenberg/pull/44108#discussion_r969703778
...
To make this test slightly better, we could check that `onChange` was called with the value of the color that was clicked?

#### tyxla on 2022-09-14T13:59:53Z

URL: https://github.com/WordPress/gutenberg/pull/44108#discussion_r970848533
Path: packages/components/src/color-palette/test/index.js
...
Good call - done in 833aa6f8d5bbdd3aaeb496f1f3928d6f7974f6fb

### Review thread 2

#### ciampo on 2022-09-13T14:30:07Z

URL: https://github.com/WordPress/gutenberg/pull/44108#discussion_r969706283
Path: packages/components/src/color-palette/test/index.js
...
Should we add a spy for the `onToggle` callback prop and make sure that `.toHaveBeenCalledTimes( 1 )`, like in the original test?

#### tyxla on 2022-09-14T14:00:22Z

URL: https://github.com/WordPress/gutenberg/pull/44108#discussion_r970849278
Path: packages/components/src/color-palette/test/index.js
...
#### ciampo on 2022-09-14T15:38:37Z

URL: https://github.com/WordPress/gutenberg/pull/44108#discussion_r970990064
Path: packages/components/src/color-palette/test/index.js
...
My bad, I didn't realize that the `Dropdown` component is an implementation detail, internal to `ColorPalette` and therefore it's not possible to pass a spy for `onToggle` 😅

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/color-palette/test/__snapshots__/index.js.snap (MODIFIED, +169/-1106)
- packages/components/src/color-palette/test/index.js (MODIFIED, +107/-61)
