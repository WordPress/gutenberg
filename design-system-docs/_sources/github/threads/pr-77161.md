...
type: pull_request
state: MERGED
merged_at: 2026-04-10T14:42:36Z
url: https://github.com/WordPress/gutenberg/pull/77161
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Enhancement","[Package] UI"]
---

# PR #77161: ui/`Dialog`: update Header layout, refactor Title to use Text

- URL: https://github.com/WordPress/gutenberg/pull/77161
- Author: ciampo
- Created: 2026-04-08T20:47:04Z
- Updated: 2026-04-14T15:04:34Z
- Comments: 3 of 3
- Review threads: 1 of 1
- Changed files: 4 of 4
- Diff: ../pr-diffs/77161.diff
...
### github-actions on 2026-04-08T20:59:17Z

URL: https://github.com/WordPress/gutenberg/pull/77161#issuecomment-4209613748
...
| `build/styles/components/style.css` | 17.3 kB |
...
### github-actions on 2026-04-08T21:37:49Z

URL: https://github.com/WordPress/gutenberg/pull/77161#issuecomment-4209839923

<!-- flaky-tests-report-comment -->
**Flaky tests detected in a705a5939d8a7b7200451159d4e9a54fee0a6d9d.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/24245773783
📝  Reported issues:
- #76524 in `/test/e2e/specs/editor/various/post-content-focus-mode.spec.js`
- #77108 in `/test/e2e/specs/site-editor/page-list.spec.js`
- #68892 in `/test/e2e/specs/site-editor/homepage-settings.spec.js`

### github-actions on 2026-04-09T10:29:29Z

URL: https://github.com/WordPress/gutenberg/pull/77161#issuecomment-4213440287
...
#### jameskoster on 2026-04-10T13:01:17Z

URL: https://github.com/WordPress/gutenberg/pull/77161#discussion_r3064404778
...
In my testing this isn't being applied for some reason 🤔 

<img width="676" height="309" alt="Image" src="https://github.com/user-attachments/assets/e981971e-e7a6-4118-b876-cba6b47eeaf5" />

#### ciampo on 2026-04-10T13:39:55Z

URL: https://github.com/WordPress/gutenberg/pull/77161#discussion_r3064614545
Path: packages/ui/src/dialog/style.module.css
...
Well spotted — this is a side-effect of the changes from https://github.com/WordPress/gutenberg/issues/76783, where the defense styles for `headings` have higher specificity of the `margin-inline-end` rule I had originally written.
...
#### mirka on 2026-04-14T12:32:26Z

URL: https://github.com/WordPress/gutenberg/pull/77161#discussion_r3079448902
Path: packages/ui/src/dialog/style.module.css
...
@ciampo Not sure how we can enforce this programmatically, but let's make sure the CSS works _without_ the `gcd` stuff also. Because the assumption is that one day we're going to remove the `gcd` code.

So in this case I think we do want to keep the `margin-inline-end: auto;` rule as well.

#### ciampo on 2026-04-14T15:04:34Z

URL: https://github.com/WordPress/gutenberg/pull/77161#discussion_r3080453109
Path: packages/ui/src/dialog/style.module.css
...
https://github.com/WordPress/gutenberg/pull/77334

## Changed files

- packages/ui/CHANGELOG.md (MODIFIED, +2/-0)
- packages/ui/src/alert-dialog/popup.tsx (MODIFIED, +0/-1)
- packages/ui/src/dialog/style.module.css (MODIFIED, +7/-6)
- packages/ui/src/dialog/title.tsx (MODIFIED, +11/-8)
