...
type: pull_request
state: MERGED
merged_at: 2026-04-27T15:51:30Z
url: https://github.com/WordPress/gutenberg/pull/77648
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Code Quality","[Package] UI"]
---

# PR #77648: ui: Align WithCustomZIndex Storybook examples across overlays

- URL: https://github.com/WordPress/gutenberg/pull/77648
- Author: ciampo
- Created: 2026-04-24T12:27:58Z
- Updated: 2026-04-29T17:31:32Z
- Comments: 7 of 7
- Review threads: 0 of 0
- Changed files: 6 of 6
- Diff: ../pr-diffs/77648.diff
...
### github-actions on 2026-04-24T12:28:08Z

URL: https://github.com/WordPress/gutenberg/pull/77648#issuecomment-4313137892
...
### github-actions on 2026-04-24T12:28:09Z

URL: https://github.com/WordPress/gutenberg/pull/77648#issuecomment-4313137924
...
### github-actions on 2026-04-24T12:41:39Z

URL: https://github.com/WordPress/gutenberg/pull/77648#issuecomment-4313220405
...
### github-actions on 2026-04-24T12:59:04Z

URL: https://github.com/WordPress/gutenberg/pull/77648#issuecomment-4313376110

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 7fe7c0c816fb02b5b3c632aecbafad285f9b3955.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/24889516212
📝  Reported issues:
...
### mirka on 2026-04-24T13:30:29Z

URL: https://github.com/WordPress/gutenberg/pull/77648#issuecomment-4313562348

> * The inline-on-Popup form worked only because `style` is silently forwarded to the internal positioner, which isn't obvious from the API.

You know, now that we have the `portal` prop pattern, I think we can drop the silent forwarding of `className` and `style` to the positioner. Let me fix that in `Select` and `Autocomplete`.

### mirka on 2026-04-24T13:46:37Z

URL: https://github.com/WordPress/gutenberg/pull/77648#issuecomment-4313669032

> Let me fix that in `Select` and `Autocomplete`.

I just noticed that `Popover` does it too. Do we agree that this behavior is no longer needed?

### ciampo on 2026-04-27T13:22:30Z

URL: https://github.com/WordPress/gutenberg/pull/77648#issuecomment-4327310274

> > Let me fix that in `Select` and `Autocomplete`.
> 
> I just noticed that `Popover` does it too. Do we agree that this behavior is no longer needed?

@mirka good point, opened https://github.com/WordPress/gutenberg/pull/77693
...
- packages/ui/src/alert-dialog/stories/index.story.tsx (MODIFIED, +3/-4)
- packages/ui/src/dialog/stories/index.story.tsx (MODIFIED, +3/-4)
- packages/ui/src/drawer/stories/index.story.tsx (MODIFIED, +1/-2)
- packages/ui/src/form/primitives/select/stories/index.story.tsx (MODIFIED, +17/-12)
- packages/ui/src/popover/stories/index.story.tsx (MODIFIED, +20/-14)
- packages/ui/src/tooltip/stories/index.story.tsx (MODIFIED, +3/-3)
