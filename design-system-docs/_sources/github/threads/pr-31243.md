...
type: pull_request
state: MERGED
merged_at: 2021-04-27T16:11:44Z
url: https://github.com/WordPress/gutenberg/pull/31243
matched_labels: ["[Package] Components","[Feature] Component System"]
all_labels: ["[Package] Components","[Feature] Component System"]
---

# PR #31243: components: Remove wp-g2 from flex, vstack, hstack, spinner and contr…

- URL: https://github.com/WordPress/gutenberg/pull/31243
- Author: sarayourfriend
- Created: 2021-04-27T14:33:01Z
- Updated: 2021-04-27T16:15:29Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 16 of 16
- Diff: ../pr-diffs/31243.diff
...
### github-actions on 2021-04-27T14:51:56Z

URL: https://github.com/WordPress/gutenberg/pull/31243#issuecomment-827668339
...
| `build/block-editor/index.js` | 116 kB | +2 B (0%) |
| `build/block-library/index.js` | 142 kB | +4 B (0%) |
| `build/components/index.js` | 268 kB | +33 B (0%) |
| `build/core-data/index.js` | 12 kB | -3 B (0%) |
| `build/customize-widgets/index.js` | 5.79 kB | -1 B (0%) |
| `build/data-controls/index.js` | 831 B | +4 B (0%) |
| `build/data/index.js` | 7.56 kB | +2 B (0%) |
| `build/edit-post/index.js` | 335 kB | -3 B (0%) |
| `build/edit-site/index.js` | 25.2 kB | -2 B (0%) |
| `build/editor/index.js` | 60.5 kB | +7 B (0%) |
...
- packages/components/src/ui/flex/context.ts (ADDED, +12/-0)
- packages/components/src/ui/flex/flex.js (MODIFIED, +24/-7)
- packages/components/src/ui/flex/test/__snapshots__/index.js.snap (MODIFIED, +16/-15)
- packages/components/src/ui/flex/use-flex-item.js (MODIFIED, +5/-2)
- packages/components/src/ui/flex/use-flex.js (MODIFIED, +1/-1)
- packages/components/src/ui/h-stack/hook.js (MODIFIED, +2/-14)
- packages/components/src/ui/popover/test/__snapshots__/index.js.snap (MODIFIED, +10/-10)
- packages/components/src/ui/spinner/component.js (MODIFIED, +2/-6)
- packages/components/src/ui/spinner/test/__snapshots__/index.js.snap (MODIFIED, +4/-2)
- packages/components/src/ui/text/test/__snapshots__/text.js.snap (MODIFIED, +0/-1)
- packages/components/src/ui/text/test/text.js (MODIFIED, +1/-1)
- packages/components/src/ui/text/utils.js (MODIFIED, +0/-3)
- packages/components/src/ui/utils/get-valid-children.ts (ADDED, +25/-0)
- packages/components/src/ui/v-stack/hook.js (MODIFIED, +1/-5)
- packages/components/src/ui/v-stack/test/__snapshots__/index.js.snap (MODIFIED, +6/-12)
