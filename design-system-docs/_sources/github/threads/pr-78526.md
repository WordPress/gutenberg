...
type: pull_request
state: MERGED
merged_at: 2026-05-22T14:14:05Z
url: https://github.com/WordPress/gutenberg/pull/78526
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Bug","[Package] UI"]
---

# PR #78526: IconButton: Fix `focusableWhenDisabled` default

- URL: https://github.com/WordPress/gutenberg/pull/78526
- Author: mirka
- Created: 2026-05-21T20:25:09Z
- Updated: 2026-05-22T14:15:09Z
- Comments: 4 of 4
- Review threads: 1 of 1
- Changed files: 3 of 3
- Diff: ../pr-diffs/78526.diff
...
### github-actions on 2026-05-21T20:31:24Z

URL: https://github.com/WordPress/gutenberg/pull/78526#issuecomment-4512520461
...
### github-actions on 2026-05-21T20:39:44Z

URL: https://github.com/WordPress/gutenberg/pull/78526#issuecomment-4512579417
...
| :--- | :---: | :---: |
| `build/modules/content-types/index.min.js` | 156 kB | +2 B (0%) |
...
| `build/scripts/block-editor/index.min.js` | 378 kB |
...
| `build/scripts/components/index.min.js` | 264 kB |
...
| `build/scripts/edit-post/index.min.js` | 19.4 kB |
...
### mirka on 2026-05-22T13:37:29Z

URL: https://github.com/WordPress/gutenberg/pull/78526#issuecomment-4519183539

> Do we need to be handling `disabled` and `focusableWhenDisabled` at all from this component

Yes in this instance, since the `focusableWhenDisabled` prop needs to be destructured to pass onto `Tooltip.Trigger` anyway. Good instinct though 👍

### aduth on 2026-05-22T14:09:33Z

URL: https://github.com/WordPress/gutenberg/pull/78526#issuecomment-4519442522

> Yes in this instance, since the `focusableWhenDisabled` prop needs to be destructured to pass onto `Tooltip.Trigger` anyway. Good instinct though 👍

Ah, I mistook `Tooltip.Trigger`'s `disabled` as just passing through to the underlying `Button`, but I see now it's used internally to determine whether to show the tooltip.

## Review threads

### Review thread 1

#### aduth on 2026-05-21T20:36:56Z

URL: https://github.com/WordPress/gutenberg/pull/78526#discussion_r3284180664
...
I dunno about having a third case for all the scenarios, but it'd be nice to have coverage for the "not explicitly specified" case. Maybe it could be incorporated into the "focusably disabled" below, or that one adapted to become the test for omission of the prop (similar to what this test case was doing before these changes).

#### mirka on 2026-05-22T13:37:57Z

URL: https://github.com/WordPress/gutenberg/pull/78526#discussion_r3288764076
Path: packages/ui/src/icon-button/test/index.test.tsx
...
Good point, addressed in 77cdc1c2.

## Changed files

- packages/ui/CHANGELOG.md (MODIFIED, +1/-0)
- packages/ui/src/icon-button/icon-button.tsx (MODIFIED, +1/-1)
- packages/ui/src/icon-button/test/index.test.tsx (MODIFIED, +10/-10)
