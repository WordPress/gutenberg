...
type: pull_request
state: MERGED
merged_at: 2022-06-14T08:22:48Z
url: https://github.com/WordPress/gutenberg/pull/41703
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Performance","[Feature] Synced Patterns","[Type] Code Quality","[Package] Core data","[Package] Plugins","[Package] Components","[Package] Blocks","[Package] Block editor"]
---

# PR #41703: Lodash: Refactor away from `_.isFunction()`

- URL: https://github.com/WordPress/gutenberg/pull/41703
- Author: tyxla
- Created: 2022-06-14T05:33:38Z
- Updated: 2022-06-14T08:23:23Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 20 of 20
- Diff: ../pr-diffs/41703.diff
...
### github-actions on 2022-06-14T05:40:53Z

URL: https://github.com/WordPress/gutenberg/pull/41703#issuecomment-1154739207
...
| `build/blocks/index.min.js` | 47 kB | +1 B (0%) |
| `build/components/index.min.js` | 227 kB | +14 B (0%) |
| `build/core-data/index.min.js` | 14.6 kB | -2 B (0%) |
| `build/plugins/index.min.js` | 1.96 kB | -14 B (-1%) |
| `build/reusable-blocks/index.min.js` | 2.22 kB | -15 B (-1%) |
...
- packages/block-editor/src/components/link-control/search-create-button.js (MODIFIED, +4/-2)
- packages/block-editor/src/components/url-input/index.js (MODIFIED, +11/-1)
- packages/blocks/src/api/raw-handling/utils.js (MODIFIED, +2/-2)
- packages/blocks/src/api/utils.js (MODIFIED, +2/-2)
- packages/blocks/src/store/actions.js (MODIFIED, +11/-1)
- packages/components/src/dimension-control/index.js (MODIFIED, +1/-2)
- packages/components/src/dropdown-menu/index.js (MODIFIED, +11/-1)
- packages/components/src/dropdown-menu/index.native.js (MODIFIED, +11/-1)
- packages/components/src/higher-order/with-spoken-messages/test/index.js (MODIFIED, +1/-1)
- packages/components/src/navigable-container/container.js (MODIFIED, +2/-2)
- packages/components/src/slot-fill/fill.js (MODIFIED, +1/-5)
- packages/components/src/slot-fill/slot.js (MODIFIED, +11/-1)
- packages/components/src/toggle-control/index.js (MODIFIED, +1/-2)
- packages/components/src/toggle-control/index.native.js (MODIFIED, +2/-6)
- packages/core-data/src/batch/create-batch.js (MODIFIED, +2/-2)
- packages/plugins/src/api/index.js (MODIFIED, +1/-6)
- packages/reusable-blocks/package.json (MODIFIED, +1/-2)
- packages/reusable-blocks/src/store/actions.js (MODIFIED, +1/-6)
