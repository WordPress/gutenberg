...
type: pull_request
state: MERGED
merged_at: 2026-05-12T17:42:44Z
url: https://github.com/WordPress/gutenberg/pull/78180
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components","[Package] Base styles"]
---

# PR #78180: Popover: Remove close button z-index

- URL: https://github.com/WordPress/gutenberg/pull/78180
- Author: mirka
- Created: 2026-05-11T18:11:37Z
- Updated: 2026-05-12T17:43:37Z
- Comments: 3 of 3
- Review threads: 1 of 1
- Changed files: 4 of 4
- Diff: ../pr-diffs/78180.diff
...
### github-actions on 2026-05-11T18:20:49Z

URL: https://github.com/WordPress/gutenberg/pull/78180#issuecomment-4423552936
...
| :--- | :---: | :---: |
| `build/styles/components/style-rtl.css` | 17.6 kB | -11 B (-0.06%) |
| `build/styles/components/style-rtl.min.css` | 14.3 kB | -16 B (-0.11%) |
| `build/styles/components/style.css` | 17.6 kB | -14 B (-0.08%) |
| `build/styles/components/style.min.css` | 14.4 kB | -16 B (-0.11%) |
...
### github-actions on 2026-05-11T18:42:36Z

URL: https://github.com/WordPress/gutenberg/pull/78180#issuecomment-4423737187

<!-- flaky-tests-report-comment -->
**Flaky tests detected in ed723398210bbee31929103d4ed1cec54dd183e7.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/25688465295
📝  Reported issues:
- #77711 in `/test/e2e/specs/editor/blocks/navigation-frontend-interactivity.spec.js`

### github-actions on 2026-05-11T20:40:40Z

URL: https://github.com/WordPress/gutenberg/pull/78180#issuecomment-4424998904
...
#### ciampo on 2026-05-12T13:56:24Z

URL: https://github.com/WordPress/gutenberg/pull/78180#discussion_r3226969139
...
Are we sure that we safely remove the `z-index` here, rather than inlining the value? There may be consumers of the component that may rely on that value for stacking UI "under" the close button?

#### mirka on 2026-05-12T17:42:29Z

URL: https://github.com/WordPress/gutenberg/pull/78180#discussion_r3228567898
Path: packages/components/src/popover/style.scss
...
As noted in the description, any situation where this would happen is very hacky, and there were no instances like this in third-party `Popover`/`Dropdown` usage, based on a scan of WP Directory (apparently now known as Veloria). So I would prefer ripping the band-aid off and removing here.
