...
type: pull_request
state: MERGED
merged_at: 2026-01-01T19:49:24Z
url: https://github.com/WordPress/gutenberg/pull/74317
matched_labels: ["[Package] Components","[Package] Theme"]
all_labels: ["[Type] Code Quality","[Package] Components","[Package] DataViews","[Package] Theme"]
---

# PR #74317: Update eslint-plugin-storybook to 10.1.11

- URL: https://github.com/WordPress/gutenberg/pull/74317
- Author: mirka
- Created: 2026-01-01T17:54:23Z
- Updated: 2026-02-19T13:34:29Z
- Comments: 12 of 12
- Review threads: 0 of 0
- Changed files: 142 of 142
- Diff: ../pr-diffs/74317.diff
...
Updates `eslint-plugin-storybook` to the latest 10.1.11.
...
```
  4:1  error  Do not import renderer package "@storybook/react" directly. Use a framework package instead (e.g. @storybook/nextjs, @storybook/react-vite, @storybook/nextjs-vite, @storybook/react-webpack5, @storybook/react-native-web-vite)  storybook/no-renderer-packages
```
...
### github-actions on 2026-01-01T17:54:32Z

URL: https://github.com/WordPress/gutenberg/pull/74317#issuecomment-3703947112
...
### github-actions on 2026-01-01T18:05:09Z

URL: https://github.com/WordPress/gutenberg/pull/74317#issuecomment-3703955268
...
### github-actions on 2026-01-01T18:23:18Z

URL: https://github.com/WordPress/gutenberg/pull/74317#issuecomment-3703972950

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 214cb46eb46e029d97cde850faf17e92a1a5928e.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/20642954843
📝  Reported issues:
- #69784 in `/test/e2e/specs/editor/various/inserting-blocks.spec.js`

### t-hamano on 2026-01-03T11:45:40Z

URL: https://github.com/WordPress/gutenberg/pull/74317#issuecomment-3706998974

Since this PR, my ESLint extension plugin no longer works in my code editor (Cursor) and outputs the following error:

<img width="1417" height="654" alt="531619875-9d52f854-b8a3-4542-b03f-23d8760648bb" src="https://github.com/user-attachments/assets/ba7797d9-1255-4c76-8747-b0ca0ffca31c" />

```
2026-01-03 20:39:02.696 [info] ESLint server is starting.
2026-01-03 20:39:02.696 [info] ESLint server running in node v20.18.2
2026-01-03 20:39:02.696 [info] ESLint server is running.
2026-01-03 20:39:03.168 [info] ESLint library loaded from: /home/t-hamano/projects/_core-dev/gutenberg/node_modules/eslint/lib/api.js
2026-01-03 20:39:04.330 [error] Calculating config file for file:///home/t-hamano/projects/_core-dev/gutenberg/.eslintrc.js) failed.
Error [ERR_REQUIRE_ESM]: require() of ES Module /home/t-hamano/projects/_core-dev/gutenberg/node_modules/eslint-plugin-storybook/dist/index.js from /home/t-hamano/projects/_core-dev/gutenberg/node_modules/@eslint/eslintrc/dist/eslintrc.cjs not supported.
Instead change the require of index.js in /home/t-hamano/projects/_core-dev/gutenberg/node_modules/@eslint/eslintrc/dist/eslintrc.cjs to a dynamic import() which is available in all CommonJS modules.
    at ConfigArrayFactory._loadPlugin (/home/t-hamano/projects/_core-dev/gutenberg/node_modules/@eslint/eslintrc/dist/eslintrc.cjs:3433:42)
    at ConfigArrayFactory._loadExtendedPluginConfig (/home/t-hamano/projects/_core-dev/gutenberg/node_modules/@eslint/eslintrc/dist/eslintrc.cjs:3233:29)
    at ConfigArrayFactory._loadExtends (/home/t-hamano/projects/_core-dev/gutenberg/node_modules/@eslint/eslintrc/dist/eslintrc.cjs:3154:29)
    at ConfigArrayFactory._normalizeObjectConfigDataBody (/home/t-hamano/projects/_core-dev/gutenberg/node_modules/@eslint/eslintrc/dist/eslintrc.cjs:3095:25)
    at _normalizeObjectConfigDataBody.next (<anonymous>)
```

Perhaps it's related to the fact that [Storybook 10 now only supports ESM](https://github.com/storybookjs/storybook/blob/next/CHANGELOG.md#1000:~:text=Storybook%2010%20contains%20one%20breaking%20change%3A%20it%E2%80%99s%20ESM%2Donly.)? In fact, if I downgrade `eslint-plugin-storybook` from version `10.1.11` to `9.1.16`, the ESLint extension seems to work correctly 🤔

### jsnajdr on 2026-01-05T07:49:21Z

URL: https://github.com/WordPress/gutenberg/pull/74317#issuecomment-3709301351

> `Error [ERR_REQUIRE_ESM]: require() of ES Module /home/t-hamano/projects/_core-dev/gutenberg/node_modules/eslint-plugin-storybook/dist/index.js from /home/t-hamano/projects/_core-dev/gutenberg/node_modules/@eslint/eslintrc/dist/eslintrc.cjs not supported.`

This happens because you can't `require` an ESM module from a CJS module. At least in Node 20.18.2 that you're using. The easiest solution would be to update the `.nvmrc` requirement to 20.19 where this problem is fixed.

### jsnajdr on 2026-01-05T08:02:18Z

URL: https://github.com/WordPress/gutenberg/pull/74317#issuecomment-3709333732

> The easiest solution would be to update the .nvmrc requirement to 20.19 where this problem is fixed.

Proposing this in #74342.

### t-hamano on 2026-01-05T08:03:39Z

URL: https://github.com/WordPress/gutenberg/pull/74317#issuecomment-3709337190

@jsnajdr Thanks for the information.

> The easiest solution would be to update the `.nvmrc` requirement to 20.19 where this problem is fixed.

Unfortunately, this didn't work for me, possibly because I'm using Volta.

Instead, I was able to solve the problem by writing the following settings to `.vscode/settings.json`:
...
### manzoorwanijk on 2026-01-07T08:15:03Z

URL: https://github.com/WordPress/gutenberg/pull/74317#issuecomment-3717770495

> Since this PR, my ESLint extension plugin no longer works in my code editor (Cursor) and outputs the following error:

It seems to be fine on latest trunk - 6c90b9e35d2f309dc5d90c8a1a70c5cf84d862fc

### t-hamano on 2026-01-08T09:58:08Z

URL: https://github.com/WordPress/gutenberg/pull/74317#issuecomment-3723102525
...
It still seems the ESLint plugin won't work without this workaround. There's probably a problem somewhere in my environment.

### ciampo on 2026-01-13T10:01:39Z

URL: https://github.com/WordPress/gutenberg/pull/74317#issuecomment-3743395338
...
A few more questions that will maybe help you figure out what's going on:

- Can you reproduce with different node versions?
- Can you run eslint correctly via the command line?
- Have you checked your local cursor extensions and settings related to eslint?
- Can you setup another IDE correctly?

### t-hamano on 2026-01-15T12:24:46Z

URL: https://github.com/WordPress/gutenberg/pull/74317#issuecomment-3754476567

> Can you reproduce with different node versions?

Yes. Even if I change the node version with the `volta install node@XX` command, the ESLint server always uses a fixed Node version.

> Can you run eslint correctly via the command line?

Yes. In this case, the linter runs correctly using the node version I'm using in the project.

> Have you checked your local cursor extensions and settings related to eslint?

Yes. There are no special rules for ESLint.

I'm missing a key point, but I'm running into this issue in WSL. On a Windows host OS, the ESLint plugin works fine. However, the ESLint Server runs on a fixed node version 22.20.0.

Considering that it works fine in the CLI, it might be an issue with the ESLint plugin, or maybe my local Node version isn't loading correctly for some reason.

### im3dabasia on 2026-02-19T13:34:29Z

URL: https://github.com/WordPress/gutenberg/pull/74317#issuecomment-3927354163

I’m facing the same error. I’ve tested with both Node v22 and v20, and the issue persists.

After debugging, it appears to be a dependency-related problem and a CommonJS vs ESM import mismatch. Specifically, `ESLint (via @eslint/eslintrc)` is loading plugins using `require()`, but eslint-plugin-storybook is now ESM-only, which causes the `ERR_REQUIRE_ESM` failure.


I know the ESLint version has been bumped up to 8.57.1, but this did not solve the problem for me! Am I missing something?

_PS: I tried it in my friend's laptop as well, he got the same issue!_

<img width="1011" height="395" alt="image" src="https://github.com/user-attachments/assets/0497e048-692a-496e-840c-d71a6fd056b6" />
...
- .eslintrc.js (MODIFIED, +0/-4)
- package-lock.json (MODIFIED, +226/-25)
...
- packages/dataviews/package.json (MODIFIED, +1/-2)
