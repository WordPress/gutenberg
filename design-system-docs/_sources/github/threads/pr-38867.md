...
type: pull_request
state: MERGED
merged_at: 2022-02-17T10:02:31Z
url: https://github.com/WordPress/gutenberg/pull/38867
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components","Storybook"]
---

# PR #38867: Storybook: Remove story for Typography Panel

- URL: https://github.com/WordPress/gutenberg/pull/38867
- Author: mirka
- Created: 2022-02-16T21:19:33Z
- Updated: 2022-02-17T10:03:03Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/38867.diff

## Body

## Description

As agreed in https://github.com/WordPress/gutenberg/pull/37160#discussion_r807329689, this removes the story for Typography Panel since it is no longer very useful.

## Testing Instructions

1. `npm run storybook:dev`
2. The Typography Panel story under `ToolsPanel` is gone.
...
### github-actions on 2022-02-16T21:30:34Z

URL: https://github.com/WordPress/gutenberg/pull/38867#issuecomment-1042328649
...
| `build/edit-site/index.min.js` | 42.2 kB |
...
### ciampo on 2022-02-17T08:35:06Z

URL: https://github.com/WordPress/gutenberg/pull/38867#issuecomment-1042696317

Thank you @mirka !

> If it turns out in the future we do want a living story to refine the typography panel, I think a dedicated story rather than being under `ToolsPanel` might work out better.
...
- packages/components/src/tools-panel/stories/index.js (MODIFIED, +0/-1)
- packages/components/src/tools-panel/stories/typography-panel.js (DELETED, +0/-217)
