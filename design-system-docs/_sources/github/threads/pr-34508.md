...
type: pull_request
state: MERGED
merged_at: 2021-09-13T11:05:59Z
url: https://github.com/WordPress/gutenberg/pull/34508
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #34508: Components: ColorPicker: replace global shortcut event handlers with local ones

- URL: https://github.com/WordPress/gutenberg/pull/34508
- Author: ellatrix
- Created: 2021-09-02T15:16:13Z
- Updated: 2021-09-13T11:52:52Z
- Comments: 7 of 7
- Review threads: 0 of 0
- Changed files: 6 of 6
- Diff: ../pr-diffs/34508.diff
...
### github-actions on 2021-09-02T15:23:06Z

URL: https://github.com/WordPress/gutenberg/pull/34508#issuecomment-911803537
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 209 kB | -26 B (0%) |
| `build/keycodes/index.min.js` | 1.3 kB | +42 B (+3%) |
...
### ellatrix on 2021-09-02T16:44:22Z

URL: https://github.com/WordPress/gutenberg/pull/34508#issuecomment-911871190
...
### ellatrix on 2021-09-02T16:50:44Z

URL: https://github.com/WordPress/gutenberg/pull/34508#issuecomment-911875901

> using a third-party component

Why are we replacing it with a third party component? What's wrong with the current one?

### jorgefilipecosta on 2021-09-03T14:33:24Z

URL: https://github.com/WordPress/gutenberg/pull/34508#issuecomment-912585297
...
The PR that added the new third-party component is https://github.com/WordPress/gutenberg/pull/33714, and the tracking issue for the task of replacing the component is here https://github.com/WordPress/gutenberg/issues/34284. I'm going to cc @ciampo in case @ciampo has some insights on why we are replacing the component.

### ciampo on 2021-09-03T14:52:54Z

URL: https://github.com/WordPress/gutenberg/pull/34508#issuecomment-912598685

Thank you for the ping, @jorgefilipecosta !

We are not replacing the current ColorPicker with a third-party component; we are replacing it with a new, first-party version that aligns more closely with the design and the needs that were mostly outlined in the context of the Global Styles sidebar (see https://github.com/WordPress/gutenberg/issues/27331 for more context)

The new version of the `ColorPicker` already exists in https://github.com/WordPress/gutenberg/tree/trunk/packages/components/src/ui/color-picker, and the plan is to soon swap the version that is currently in production with this newer version (see the tracking issue for more details: https://github.com/WordPress/gutenberg/issues/34284)

Hope this clarifies your doubts! (cc'ing @mtias in case he wanted to add on top of my explanation)

I wonder if, since the current version of the ColorPicker should soon be replaced by the new one and then deleted, we should make any changes to it.

### ellatrix on 2021-09-13T11:05:46Z

URL: https://github.com/WordPress/gutenberg/pull/34508#issuecomment-918082766
...
### ciampo on 2021-09-13T11:52:52Z

URL: https://github.com/WordPress/gutenberg/pull/34508#issuecomment-918115511
...
- packages/components/src/color-picker/alpha.js (MODIFIED, +63/-53)
- packages/components/src/color-picker/hue.js (MODIFIED, +67/-59)
- packages/components/src/color-picker/saturation.js (MODIFIED, +61/-50)
- packages/components/src/color-picker/test/__snapshots__/index.js.snap (MODIFIED, +455/-459)
- packages/keycodes/README.md (MODIFIED, +16/-0)
- packages/keycodes/src/index.js (MODIFIED, +20/-0)
