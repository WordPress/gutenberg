...
type: pull_request
state: MERGED
merged_at: 2022-09-22T11:04:44Z
url: https://github.com/WordPress/gutenberg/pull/44207
...
# PR #44207: Components refactor `Mobile` to ignore `exhuastive-deps`

- URL: https://github.com/WordPress/gutenberg/pull/44207
- Author: chad1008
- Created: 2022-09-15T18:49:04Z
- Updated: 2022-09-22T11:05:17Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 15 of 15
- Diff: ../pr-diffs/44207.diff

## Body

## What?
Refactor the Mobile components to ignore the `exhaustive-deps` eslint rule.
...
## How?
Added inline ignore comments to all `exhaustive-deps` warnings in the `Mobile` component directory

## Testing Instructions

1. From your local Gutenberg directory, run `npx eslint --rule 'react-hooks/exhaustive-deps: warn' packages/components/src/mobile`
2. Confirm that the linter returns no errors

## Issue comments

### github-actions on 2022-09-15T19:01:51Z

URL: https://github.com/WordPress/gutenberg/pull/44207#issuecomment-1248489651
...
### fluiddot on 2022-09-16T10:03:44Z

URL: https://github.com/WordPress/gutenberg/pull/44207#issuecomment-1249176179

> Because the Components squad generally lacks the React Native expertise and tools/environments to effectively refactor these components, we'll defer to the native team to handle when they're ready.

Good point @chad1008, I advocate the idea of deferring to the native team to handle the review of the dependencies, especially, since some of them might require further exploration, thanks!

We don't have too much bandwidth currently for tackling this in the short term but I hope we could do it in the future.

**UPDATE:** As a follow-up task, I created [this issue](https://github.com/WordPress/gutenberg/issues/44226) to continue the refactor of the native files.
...
- packages/components/src/mobile/bottom-sheet/bottom-sheet-navigation/navigation-container.native.js (MODIFIED, +9/-0)
- packages/components/src/mobile/bottom-sheet/bottom-sheet-navigation/navigation-screen.native.js (MODIFIED, +11/-0)
- packages/components/src/mobile/bottom-sheet/sub-sheet/index.native.js (MODIFIED, +3/-0)
- packages/components/src/mobile/color-settings/index.native.js (MODIFIED, +3/-0)
- packages/components/src/mobile/color-settings/picker-screen.native.js (MODIFIED, +3/-0)
- packages/components/src/mobile/image/index.native.js (MODIFIED, +3/-0)
- packages/components/src/mobile/keyboard-avoiding-view/index.ios.js (MODIFIED, +3/-0)
- packages/components/src/mobile/link-picker/index.native.js (MODIFIED, +3/-0)
- packages/components/src/mobile/link-picker/link-picker-results.native.js (MODIFIED, +3/-0)
- packages/components/src/mobile/link-picker/link-picker-screen.native.js (MODIFIED, +3/-0)
- packages/components/src/mobile/link-settings/index.native.js (MODIFIED, +18/-0)
- packages/components/src/mobile/link-settings/link-settings-screen.native.js (MODIFIED, +3/-0)
- packages/components/src/mobile/segmented-control/index.native.js (MODIFIED, +6/-0)
- packages/components/src/mobile/utils/use-unit-converter-to-mobile.native.js (MODIFIED, +6/-0)
