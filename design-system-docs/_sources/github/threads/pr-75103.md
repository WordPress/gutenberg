...
type: pull_request
state: MERGED
merged_at: 2026-02-05T21:19:40Z
url: https://github.com/WordPress/gutenberg/pull/75103
matched_labels: ["[Package] Theme"]
all_labels: ["[Type] Task","[Package] Theme"]
---

# PR #75103: Theme: Update elevation tokens to use abbreviated size names

- URL: https://github.com/WordPress/gutenberg/pull/75103
- Author: aduth
- Created: 2026-01-30T20:12:07Z
- Updated: 2026-02-05T21:20:30Z
- Comments: 6 of 6
- Review threads: 2 of 2
- Changed files: 7 of 7
- Diff: ../pr-diffs/75103.diff
...
- There should be no local changes after `npm run --workspace=@wordpress/theme build`
- Verify there are no lingering internal usage of the old variables names (this would also be enforced by ESLint & Stylelint rules)

## Issue comments

### github-actions on 2026-01-30T20:12:16Z

URL: https://github.com/WordPress/gutenberg/pull/75103#issuecomment-3825531981
...
### github-actions on 2026-01-30T20:23:19Z

URL: https://github.com/WordPress/gutenberg/pull/75103#issuecomment-3825579394
...
| :--- | :---: | :---: |
| `build/modules/boot/index.min.js` | 14.6 kB | -4 B (-0.03%) |
| `build/styles/theme/style-rtl.css` | 2.69 kB | -1 B (-0.04%) |
| `build/styles/theme/style-rtl.min.css` | 1.39 kB | -5 B (-0.36%) |
| `build/styles/theme/style.css` | 2.69 kB | -1 B (-0.04%) |
| `build/styles/theme/style.min.css` | 1.39 kB | -5 B (-0.36%) |
...
### ciampo on 2026-02-04T16:26:01Z

URL: https://github.com/WordPress/gutenberg/pull/75103#issuecomment-3848441002

Changes are looking good overall, although it will need a rebase to solve conflicts.

I was wondering if we have a clear idea about what to do for elevation tokens when the theme is dark?

### aduth on 2026-02-04T20:24:17Z

URL: https://github.com/WordPress/gutenberg/pull/75103#issuecomment-3849571607

> I was wondering if we have a clear idea about what to do for elevation tokens when the theme is dark?

Nope 😄 I can create a tracking issue for this.

My hunch is that the current default tokens are probably fine as-is, and we can handle overrides in `ThemeProvider` when the generated palette is detected to be dark enough that we'd want to invert to a white-based shadow? Although that makes an assumption that inverting is the right approach for handling elevation on dark colors.

### aduth on 2026-02-04T20:30:18Z

URL: https://github.com/WordPress/gutenberg/pull/75103#issuecomment-3849595326

Pushed a rebase.

### aduth on 2026-02-05T20:37:55Z

URL: https://github.com/WordPress/gutenberg/pull/75103#issuecomment-3856062476

> Let's create a separate issue to discuss. I'm not sure if we want to go darker or lighter for the shadows in light mode.

Opened a new issue at #75266

## Review threads

### Review thread 1

#### aduth on 2026-01-30T20:13:27Z

URL: https://github.com/WordPress/gutenberg/pull/75103#discussion_r2747842214
...
#### ciampo on 2026-02-05T10:42:52Z

URL: https://github.com/WordPress/gutenberg/pull/75103#discussion_r2768311023
Path: packages/theme/CHANGELOG.md
...
The changelog order looks off:

- changes from #74470, #74226 and #74011 should be under the `0.5.0` release
- changes from #74617 should be under the `0.6.0` release
- changes #75054 and this PR should be under `Unreleased`

#### aduth on 2026-02-05T20:37:39Z

URL: https://github.com/WordPress/gutenberg/pull/75103#discussion_r2771047117
Path: packages/theme/CHANGELOG.md
...
Good catch, this is fixed now in bfce2af9d05. I also added a link to the pull request for the changes made here.

## Changed files

- packages/theme/CHANGELOG.md (MODIFIED, +34/-42)
- packages/theme/docs/tokens.md (MODIFIED, +6/-6)
- packages/theme/src/prebuilt/css/design-tokens.css (MODIFIED, +4/-4)
- packages/theme/src/prebuilt/js/design-tokens.mjs (MODIFIED, +4/-4)
- packages/theme/tokens/elevation.json (MODIFIED, +4/-4)
