...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/54611
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #54611: Use admin colors in CanvasLoader ProgressBar

- URL: https://github.com/WordPress/gutenberg/pull/54611
- Author: richtabor
- Created: 2023-09-19T15:23:50Z
- Updated: 2025-02-10T16:48:04Z
- Comments: 6 of 6
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/54611.diff
...
### github-actions on 2023-09-19T15:33:12Z

URL: https://github.com/WordPress/gutenberg/pull/54611#issuecomment-1725901189
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 255 kB | +12 B (0%) |
| `build/edit-site/index.min.js` | 181 kB | -77 B (0%) |
...
### github-actions on 2023-09-19T16:00:20Z

URL: https://github.com/WordPress/gutenberg/pull/54611#issuecomment-1725948425

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 00c48bc8de244f3f42562149db83cd4ee42c2110.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/6237651901
📝  Reported issues:
- #53524 in `/test/e2e/specs/editor/various/multi-block-selection.spec.js`

### jasmussen on 2023-09-19T18:15:14Z

URL: https://github.com/WordPress/gutenberg/pull/54611#issuecomment-1726255355
...
### richtabor on 2023-09-20T01:57:21Z

URL: https://github.com/WordPress/gutenberg/pull/54611#issuecomment-1726768220

>  once we get the real style color to consistently load as the background color for the preview.

I think the only way this works, would be to use variations of the text color as the theming values for track and fill. 

The accent color doesn’t quite work for TT3 or TT4 themes, which are technically using the correct background color (as they’re white(ish)). 

Think that’s something we can get in for 6.4?

### jasmussen on 2023-09-22T07:57:50Z

URL: https://github.com/WordPress/gutenberg/pull/54611#issuecomment-1730975203

I would echo to not change to admin colors until we have a chance to try and fix the current system as it was intended. I think there's a path forward as described here: https://github.com/WordPress/gutenberg/issues/54202#issuecomment-1729003302

### richtabor on 2023-10-13T03:37:02Z

URL: https://github.com/WordPress/gutenberg/pull/54611#issuecomment-1760711575

Closed in lieu of https://github.com/WordPress/gutenberg/pull/55285
...
- packages/components/src/progress-bar/styles.ts (MODIFIED, +2/-1)
- packages/edit-site/src/components/canvas-loader/index.js (MODIFIED, +2/-12)
