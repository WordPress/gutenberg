...
type: pull_request
state: MERGED
merged_at: 2026-03-18T22:31:59Z
url: https://github.com/WordPress/gutenberg/pull/76410
matched_labels: ["[Package] Theme"]
all_labels: ["[Type] Enhancement","[Package] Theme"]
---

# PR #76410: ThemeProvider: Add `cursor` prop

- URL: https://github.com/WordPress/gutenberg/pull/76410
- Author: mirka
- Created: 2026-03-11T19:40:12Z
- Updated: 2026-03-18T22:32:55Z
- Comments: 3 of 3
- Review threads: 3 of 3
- Changed files: 9 of 9
- Diff: ../pr-diffs/76410.diff
...
Adds a `cursor` prop to `ThemeProvider`, allowing the `--wpds-cursor-control` design token to be configured at the theme level. Also adds a "Cursor control" option to the Storybook theme toolbar.

## Why?

The `--wpds-cursor-control` token (adopted in #76218) controls the cursor style for interactive non-link controls. Without `ThemeProvider` integration, there's no way to configure this token declaratively — and the value wouldn't propagate to portaled popovers (Select, Dialog, Tooltip), which render outside the ThemeProvider's DOM subtree.

## How?

* Added `cursor?: { control?: 'default' | 'pointer' }` to `ThemeProviderSettings`.
* `ThemeProvider` sets `--wpds-cursor-control` via an inline `style` on its wrapper div. The value is resolved through the same prop → inherited → fallback chain as `color`, and included in `ThemeContext` so child providers (used in portals) inherit it.
* Added a "Cursor control" section (Default / Pointer) to the Storybook design system theme toolbar.

## Testing Instructions

1. Run `npm run storybook:dev` and navigate to any Design System component story.
2. Open the **Theme** toolbar (mirror icon) — there should be a "Cursor control" section with Default and Pointer options.
3. Select **Pointer** and verify that buttons, select triggers, tabs, etc. show `cursor: pointer`.
4. Open a Select story and verify that the popup items also show the pointer cursor (confirming portal propagation).
5. Switch back to **Default** and verify everything returns to `cursor: default`.

## Issue comments

### github-actions on 2026-03-11T20:04:57Z

URL: https://github.com/WordPress/gutenberg/pull/76410#issuecomment-4041868575
...
| :--- | :---: | :---: |
| `build/scripts/theme/index.min.js` | 22 kB | +70 B (+0.32%) |
...
| `build/scripts/core-data/index.min.js` | 30 kB |
...
| `build/scripts/media-utils/index.min.js` | 75.2 kB |
...
| `build/styles/editor/style-rtl.min.css` | 22.2 kB |
| `build/styles/editor/style.css` | 26.4 kB |
| `build/styles/editor/style.min.css` | 22.2 kB |
...
### github-actions on 2026-03-11T20:18:54Z

URL: https://github.com/WordPress/gutenberg/pull/76410#issuecomment-4041950099

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 1a2d1890568b857096a1767de366849d2b12b792.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/23268803708
📝  Reported issues:
- #76524 in `/test/e2e/specs/editor/various/post-content-focus-mode.spec.js`

### github-actions on 2026-03-17T16:49:29Z

URL: https://github.com/WordPress/gutenberg/pull/76410#issuecomment-4076437118
...
#### ciampo on 2026-03-17T16:55:09Z

URL: https://github.com/WordPress/gutenberg/pull/76410#discussion_r2948212293
...
#### ciampo on 2026-03-17T16:57:29Z

URL: https://github.com/WordPress/gutenberg/pull/76410#discussion_r2948226647
Path: packages/theme/src/theme-provider.tsx
...
#### ciampo on 2026-03-17T17:01:50Z

URL: https://github.com/WordPress/gutenberg/pull/76410#discussion_r2948256055
Path: packages/theme/src/theme-provider.tsx
...
#### mirka on 2026-03-17T19:33:00Z

URL: https://github.com/WordPress/gutenberg/pull/76410#discussion_r2949124922
Path: packages/theme/src/theme-provider.tsx
...
Good point 2826e2b8f387dfeab19bc30e4df24b149492b35e

### Review thread 2 (resolved)

#### ciampo on 2026-03-17T16:58:42Z

URL: https://github.com/WordPress/gutenberg/pull/76410#discussion_r2948234383
Path: packages/theme/src/theme-provider.tsx

```diff
@@ -48,13 +48,15 @@ function generateCSSSelector( {
...
For consistency, we should probably update `packages/theme/src/context.ts` and add `cursor` there, too

#### mirka on 2026-03-17T19:35:01Z

URL: https://github.com/WordPress/gutenberg/pull/76410#discussion_r2949135160
Path: packages/theme/src/theme-provider.tsx
...
Right 👍 899da669ec221a88c6fc360d13568745b150e8f5

### Review thread 3

#### ciampo on 2026-03-18T11:52:23Z

URL: https://github.com/WordPress/gutenberg/pull/76410#discussion_r2952889000
Path: packages/theme/src/use-theme-provider-styles.ts

```diff
@@ -218,11 +222,16 @@ export function useThemeProviderStyles( {
 			}
 		} );
...
#### mirka on 2026-03-18T22:00:23Z

URL: https://github.com/WordPress/gutenberg/pull/76410#discussion_r2956478465
Path: packages/theme/src/use-theme-provider-styles.ts
...
Done in 1a2d1890568b857096a1767de366849d2b12b792 👍

## Changed files

- packages/theme/CHANGELOG.md (MODIFIED, +1/-0)
- packages/theme/README.md (MODIFIED, +6/-2)
- packages/theme/src/context.ts (MODIFIED, +1/-0)
- packages/theme/src/theme-provider.tsx (MODIFIED, +2/-0)
- packages/theme/src/types.ts (MODIFIED, +14/-0)
- packages/theme/src/use-theme-provider-styles.ts (MODIFIED, +16/-2)
- storybook/addons/design-system-theme/manager.ts (MODIFIED, +10/-0)
- storybook/decorators/with-design-system-theme.tsx (MODIFIED, +7/-1)
