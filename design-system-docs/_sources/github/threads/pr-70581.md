...
type: pull_request
state: MERGED
merged_at: 2025-07-01T13:26:12Z
url: https://github.com/WordPress/gutenberg/pull/70581
matched_labels: ["Design System"]
all_labels: ["[Type] Enhancement","[Package] Icons","Design System"]
---

# PR #70581: Update circle icons to have a unified footprint

- URL: https://github.com/WordPress/gutenberg/pull/70581
- Author: jasmussen
- Created: 2025-07-01T12:22:04Z
- Updated: 2025-08-04T09:20:38Z
- Comments: 6 of 6
- Review threads: 0 of 0
- Changed files: 9 of 9
- Diff: ../pr-diffs/70581.diff

## Body

## What?

Followup to #70299. There are a number of circular icons that are not the correct size as defined by the icon blueprint template, and are arbitrarily larger:

<img width="537" alt="before and after" src="https://github.com/user-attachments/assets/eecc3216-a994-443e-8c88-711267f34606" />

This PR addresses the remaining ones, ensuring all circular icons are uniform in size. 

## Testing Instructions

Run storybook: npm run storybook:dev, then go to Icons > Library, then check the following icons:
...
### github-actions on 2025-07-01T12:25:30Z

URL: https://github.com/WordPress/gutenberg/pull/70581#issuecomment-3023799642
...
### github-actions on 2025-07-01T12:36:27Z

URL: https://github.com/WordPress/gutenberg/pull/70581#issuecomment-3023837983

**Size Change:** -143 B (-0.01%) 

**Total Size:** 1.87 MB

| Filename | Size | Change |
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 264 kB | -6 B (0%) |
| `build/block-library/index.min.js` | 228 kB | +2 B (0%) |
| `build/components/index.min.js` | 230 kB | -128 B (-0.06%) |
| `build/edit-site/index.min.js` | 227 kB | -11 B (0%) |
...
### Mamaduka on 2025-07-01T12:49:15Z

URL: https://github.com/WordPress/gutenberg/pull/70581#issuecomment-3023880897

The failing unit test is unrelated - https://github.com/WordPress/gutenberg/pull/70567#issuecomment-3023828941.

### danieliser on 2025-07-30T07:39:57Z

URL: https://github.com/WordPress/gutenberg/pull/70581#issuecomment-3135194008

@jasmussen @Mamaduka This change broke some icons. currencyDollar for example goes from a $ in a circle, to just a dotted circle

<img width="62" height="69" alt="image" src="https://github.com/user-attachments/assets/c12d6d88-a2f6-473a-a169-66ea18310d09" />

<img width="61" height="68" alt="image" src="https://github.com/user-attachments/assets/5472eff0-dc3c-4cb6-b5ee-ac4e254ad3b1" />

### t-hamano on 2025-07-30T11:08:23Z

URL: https://github.com/WordPress/gutenberg/pull/70581#issuecomment-3135832092

@danieliser Thanks for the report. I also confirmed the problem.

The `currencyDollar` icon unintentionally has a path that is the same as the `swatch` icon.

https://github.com/WordPress/gutenberg/blob/30d3b3840ebe7a07416fc5acc9a29f551992298b/packages/icons/src/library/currency-dollar.tsx#L6-L10

https://github.com/WordPress/gutenberg/blob/30d3b3840ebe7a07416fc5acc9a29f551992298b/packages/icons/src/library/swatch.tsx#L6-L10

### jasmussen on 2025-08-04T09:20:38Z

URL: https://github.com/WordPress/gutenberg/pull/70581#issuecomment-3149782036

My apologies for the tardy fix and thank you for the report. I have a fix in https://github.com/WordPress/gutenberg/pull/71042.
...
- packages/icons/CHANGELOG.md (MODIFIED, +1/-0)
- packages/icons/src/library/cancel-circle-filled.js (MODIFIED, +1/-1)
- packages/icons/src/library/currency-dollar.js (MODIFIED, +1/-1)
- packages/icons/src/library/currency-euro.js (MODIFIED, +1/-1)
- packages/icons/src/library/currency-pound.js (MODIFIED, +1/-1)
- packages/icons/src/library/globe.js (MODIFIED, +1/-1)
- packages/icons/src/library/help-filled.js (MODIFIED, +1/-1)
- packages/icons/src/library/site-logo.js (MODIFIED, +1/-1)
- packages/icons/src/library/swatch.js (MODIFIED, +1/-1)
