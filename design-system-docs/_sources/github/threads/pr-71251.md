...
type: pull_request
state: MERGED
merged_at: 2025-08-19T16:10:06Z
url: https://github.com/WordPress/gutenberg/pull/71251
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #71251: MenuItem: make accessible when disabled

- URL: https://github.com/WordPress/gutenberg/pull/71251
- Author: ciampo
- Created: 2025-08-19T15:24:00Z
- Updated: 2025-08-19T16:10:41Z
- Comments: 2 of 2
- Review threads: 2 of 2
- Changed files: 3 of 3
- Diff: ../pr-diffs/71251.diff
...
### github-actions on 2025-08-19T15:25:10Z

URL: https://github.com/WordPress/gutenberg/pull/71251#issuecomment-3201216753
...
### github-actions on 2025-08-19T15:46:06Z

URL: https://github.com/WordPress/gutenberg/pull/71251#issuecomment-3201287208
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 250 kB | +2 B (0%) |
| `build/components/style-rtl.css` | 13.6 kB | -18 B (-0.13%) |
| `build/components/style.css` | 13.6 kB | -18 B (-0.13%) |
...
#### ciampo on 2025-08-19T15:30:54Z

URL: https://github.com/WordPress/gutenberg/pull/71251#discussion_r2285632539
...
https://github.com/WordPress/gutenberg/blob/15bff410d4ca9f53a8c45098fb484c083a968628/packages/components/src/dropdown-menu/index.tsx#L205-L209


I would typically work on refactoring `DropdownMenu` to use `MenuItem` internally, but it's probably not worth it given that we already have a newer `Menu` component, and the [upcoming DS effort](https://github.com/WordPress/gutenberg/issues/71196)

### Review thread 2

#### tyxla on 2025-08-19T15:37:57Z

URL: https://github.com/WordPress/gutenberg/pull/71251#discussion_r2285650372
Path: packages/components/src/menu-item/index.tsx
...
#### ciampo on 2025-08-19T15:52:12Z

URL: https://github.com/WordPress/gutenberg/pull/71251#discussion_r2285685256
Path: packages/components/src/menu-item/index.tsx
...
- the `DropdownMenu` component already sets `accessibleWhenDisabled` internally when using the `controls` prop instead of `children` (see [this comment](https://github.com/WordPress/gutenberg/pull/71251#discussion_r2285632539));
...
#### tyxla on 2025-08-19T15:54:55Z

URL: https://github.com/WordPress/gutenberg/pull/71251#discussion_r2285691974
Path: packages/components/src/menu-item/index.tsx
...
- packages/block-library/src/navigation/edit/test/navigation-menu-selector.js (MODIFIED, +2/-2)
