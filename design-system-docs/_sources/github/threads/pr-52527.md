...
type: pull_request
state: MERGED
merged_at: 2023-07-14T01:40:32Z
url: https://github.com/WordPress/gutenberg/pull/52527
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Type] Copy","[Package] Components"]
---

# PR #52527: Adapt template part hint copy

- URL: https://github.com/WordPress/gutenberg/pull/52527
- Author: richtabor
- Created: 2023-07-11T18:42:38Z
- Updated: 2023-07-17T17:13:50Z
- Comments: 6 of 6
- Review threads: 0 of 0
- Changed files: 1 of 1
- Diff: ../pr-diffs/52527.diff
...
### github-actions on 2023-07-11T18:54:41Z

URL: https://github.com/WordPress/gutenberg/pull/52527#issuecomment-1631351440
...
| :--- | :---: | :---: | :---: |
| `build/block-editor/index.min.js` | 209 kB | +25 B (0%) |  |
...
| `build/block-library/index.min.js` | 202 kB | +90 B (0%) |  |
| `build/components/index.min.js` | 240 kB | +12 B (0%) |  |
| `build/edit-site/index.min.js` | 87.6 kB | +83 B (0%) |  |
...
### jameskoster on 2023-07-11T20:40:09Z

URL: https://github.com/WordPress/gutenberg/pull/52527#issuecomment-1631479760

I wonder if it might be best to avoid "page" or "panel" until the nomenclature has matured a bit.

> Looking for template parts? Find them in "Patterns"

Could work.

Is there any logic around when this message appears? I was thinking earlier that it might be strange to see on a fresh install if you're new to WordPress or otherwise unfamiliar with "Template parts".

### richtabor on 2023-07-12T16:24:44Z

URL: https://github.com/WordPress/gutenberg/pull/52527#issuecomment-1632849125

> I wonder if it might be best to avoid "page" or "panel" until the nomenclature has matured a bit.

Agreed. I pushed up the change.

### annezazu on 2023-07-12T21:24:31Z

URL: https://github.com/WordPress/gutenberg/pull/52527#issuecomment-1633232522

I like the idea of leaving it out for now. Ideally, it would be excellent to have a direct link to the section too rather than needing to guess where to go.

### github-actions on 2023-07-13T22:50:52Z

URL: https://github.com/WordPress/gutenberg/pull/52527#issuecomment-1635026877

<!-- flaky-tests-report-comment -->
**Flaky tests detected in ed3da5dd29929843468c23235d57aa7ff3b1bbe0.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/5534047679
📝  Reported issues:
- #48827 in `specs/editor/plugins/block-context.test.js`

### tellthemachines on 2023-07-14T01:56:41Z

URL: https://github.com/WordPress/gutenberg/pull/52527#issuecomment-1635149572

I just cherry-picked this PR to the update/first-batch-pre-RC1 branch to get it included in the next release: ebbd078248
...
- packages/edit-site/src/components/sidebar-navigation-screen-main/template-part-hint.js (MODIFIED, +1/-3)
