...
type: pull_request
state: MERGED
merged_at: 2022-08-19T17:21:05Z
url: https://github.com/WordPress/gutenberg/pull/43429
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Feature] UI Components","[Package] Components"]
---

# PR #43429: Modal: use code instead of keyCode for keyboard events

- URL: https://github.com/WordPress/gutenberg/pull/43429
- Author: ciampo
- Created: 2022-08-19T14:14:02Z
- Updated: 2022-08-19T17:21:31Z
- Comments: 2 of 2
- Review threads: 5 of 5
- Changed files: 4 of 4
- Diff: ../pr-diffs/43429.diff
...
Refactor the `Modal` component to rely on `code` instead of `keyCode` for keyboard events
...
On Storybook, make sure that the `Modal` still closes when pressing the `Escape` key (if the `shouldCloseOnEsc` property is set to `true`)

## Issue comments

### github-actions on 2022-08-19T14:26:37Z

URL: https://github.com/WordPress/gutenberg/pull/43429#issuecomment-1220744070
...
### ciampo on 2022-08-19T15:04:03Z

URL: https://github.com/WordPress/gutenberg/pull/43429#issuecomment-1220784641

> Good move 👍

I realized that `ConfirmDialog`'s test needed to be updated to have this PR pass (as they were also relying on `keyCode`), and so I took the chance to refactor them to use `user-event` instead (plus a small fix to `Modal`'s unit tests too!)

## Review threads

### Review thread 1

#### ciampo on 2022-08-19T15:05:23Z

URL: https://github.com/WordPress/gutenberg/pull/43429#discussion_r950293042
...
#### ciampo on 2022-08-19T15:05:57Z

URL: https://github.com/WordPress/gutenberg/pull/43429#discussion_r950293521
Path: packages/components/src/confirm-dialog/test/index.js
...
#### ciampo on 2022-08-19T15:06:15Z

URL: https://github.com/WordPress/gutenberg/pull/43429#discussion_r950293782
Path: packages/components/src/confirm-dialog/test/index.js
...
#### ciampo on 2022-08-19T15:07:01Z

URL: https://github.com/WordPress/gutenberg/pull/43429#discussion_r950294426
...
#### ciampo on 2022-08-19T15:07:29Z

URL: https://github.com/WordPress/gutenberg/pull/43429#discussion_r950294825
Path: packages/components/src/modal/test/index.js
...
- packages/components/src/confirm-dialog/test/index.js (MODIFIED, +57/-34)
- packages/components/src/modal/index.js (MODIFIED, +1/-2)
- packages/components/src/modal/test/index.js (MODIFIED, +11/-9)
