...
type: pull_request
state: MERGED
merged_at: 2021-05-07T13:24:37Z
url: https://github.com/WordPress/gutenberg/pull/31559
...
# PR #31559: components: Promote Grid

- URL: https://github.com/WordPress/gutenberg/pull/31559
- Author: sarayourfriend
- Created: 2021-05-06T18:10:46Z
- Updated: 2021-05-07T13:34:30Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 17 of 17
- Diff: ../pr-diffs/31559.diff
...
## Description
Export `Grid` from `@wordpress/components`.

@diegohaz I suspect this could use an accessibility review 🤔 
...
<img width="1456" alt="Captura de Tela 2021-05-06 às 11 08 56" src="https://user-images.githubusercontent.com/24264157/117345603-93cee980-ae5b-11eb-80f5-ae95d7604804.png">
...
### github-actions on 2021-05-06T18:20:59Z

URL: https://github.com/WordPress/gutenberg/pull/31559#issuecomment-833754104
...
| `build/components/index.js` | 187 kB | +441 B (0%) |
| `build/compose/index.js` | 9.96 kB | +1 B (0%) |
| `build/customize-widgets/index.js` | 5.82 kB | -1 B (0%) |
| `build/data-controls/index.js` | 830 B | +1 B (0%) |
| `build/data/index.js` | 7.22 kB | -3 B (0%) |
| `build/edit-navigation/index.js` | 13.7 kB | +1 B (0%) |
| `build/edit-post/index.js` | 333 kB | +1 B (0%) |
| `build/edit-site/index.js` | 26.2 kB | -5 B (0%) |
| `build/edit-widgets/index.js` | 12.6 kB | +1 B (0%) |
...
- packages/components/src/grid/README.md (RENAMED, +4/-2)
- packages/components/src/grid/component.js (RENAMED, +2/-2)
- packages/components/src/grid/hook.js (RENAMED, +4/-4)
- packages/components/src/grid/index.js (RENAMED, +0/-0)
- packages/components/src/grid/stories/index.js (RENAMED, +3/-3)
- packages/components/src/grid/test/grid.js (RENAMED, +2/-2)
- packages/components/src/grid/types.ts (RENAMED, +0/-0)
- packages/components/src/grid/utils.js (RENAMED, +0/-0)
