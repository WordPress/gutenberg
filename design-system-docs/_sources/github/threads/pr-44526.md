...
type: pull_request
state: MERGED
merged_at: 2022-09-29T07:35:13Z
url: https://github.com/WordPress/gutenberg/pull/44526
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Focus] Accessibility (a11y)","[Package] Components"]
---

# PR #44526: TokenInput field: try alternative approach to fix screen reader focus issue

- URL: https://github.com/WordPress/gutenberg/pull/44526
- Author: ciampo
- Created: 2022-09-28T10:18:49Z
- Updated: 2022-10-04T00:57:27Z
- Comments: 5 of 5
- Review threads: 2 of 2
- Changed files: 4 of 4
- Diff: ../pr-diffs/44526.diff
...
### github-actions on 2022-09-28T10:28:59Z

URL: https://github.com/WordPress/gutenberg/pull/44526#issuecomment-1260707311
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 199 kB | +36 B (0%) |
...
### ciampo on 2022-09-28T10:39:12Z

URL: https://github.com/WordPress/gutenberg/pull/44526#issuecomment-1260718210

(cc @costdev @joedolson @alexstine  )

### ciampo on 2022-09-29T07:19:38Z

URL: https://github.com/WordPress/gutenberg/pull/44526#issuecomment-1261869084

Thank you both, @alexstine and @andrewserong !

I'll go ahead and merge this PR as soon as CI is ✅ 

>  Separately to this PR, it might be worth exploring reducing that timeout interval down to something lower (or even use requestAnimationFrame if it isn't too expensive to do on every frame).

Well spotted! I've opened #44573 to fix it

More in general, select-like and combobox-like control components (`SelectControl`, `ComboboxControl` and `FormTokenField`) are all in need of a refactor, which is on our radar for the upcoming months.

### michalczaplinski on 2022-10-03T23:01:16Z

URL: https://github.com/WordPress/gutenberg/pull/44526#issuecomment-1266170597

Cherry-picked for the 6.1 release in https://github.com/WordPress/gutenberg/pull/44656

### alexstine on 2022-10-04T00:57:27Z

URL: https://github.com/WordPress/gutenberg/pull/44526#issuecomment-1266268387
...
#### ciampo on 2022-09-28T10:34:59Z

URL: https://github.com/WordPress/gutenberg/pull/44526#discussion_r982235466
...
This is only to make it easier to test for this fix. I will undo this change before merging, if this PR will get approved.

### Review thread 2

#### ciampo on 2022-09-28T10:36:17Z

URL: https://github.com/WordPress/gutenberg/pull/44526#discussion_r982236634
...
For now, I decided to delete those lines like in the original PR. See https://github.com/WordPress/gutenberg/pull/44347#discussion_r978615389 and https://github.com/WordPress/gutenberg/pull/44347#discussion_r981917387 for additional context and motivations for this change
...
- packages/components/src/combobox-control/index.js (MODIFIED, +0/-5)
- packages/components/src/form-token-field/test/index.tsx (MODIFIED, +22/-1)
- packages/components/src/form-token-field/token-input.tsx (MODIFIED, +25/-3)
