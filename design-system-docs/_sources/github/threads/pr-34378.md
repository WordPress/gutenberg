...
type: pull_request
state: MERGED
merged_at: 2021-08-31T06:19:15Z
url: https://github.com/WordPress/gutenberg/pull/34378
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #34378: Try: Simplify & polish heading levels.

- URL: https://github.com/WordPress/gutenberg/pull/34378
- Author: jasmussen
- Created: 2021-08-30T08:53:26Z
- Updated: 2021-09-07T08:57:49Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 3 of 3
- Diff: ../pr-diffs/34378.diff
...
### github-actions on 2021-08-30T09:00:35Z

URL: https://github.com/WordPress/gutenberg/pull/34378#issuecomment-908170271
...
| :--- | :---: | :---: | :---: |
| `build/block-library/blocks/heading/editor-rtl.css` | 0 B | -113 B (removed) | 🏆 |
| `build/block-library/blocks/heading/editor.css` | 0 B | -113 B (removed) | 🏆 |
| `build/block-library/editor-rtl.css` | 9.9 kB | -33 B (0%) |  |
| `build/block-library/editor.css` | 9.89 kB | -32 B (0%) |  |
| `build/components/style-rtl.css` | 15.8 kB | -1 B (0%) |  |
| `build/components/style.css` | 15.8 kB | -1 B (0%) |  |
...
### andrewserong on 2021-09-01T03:12:05Z

URL: https://github.com/WordPress/gutenberg/pull/34378#issuecomment-909837099

Just carrying over the conversation from #34406, it looks like this PR introduced a regression for a number of components that add a negative margin to offset the  `.components-popover__content > div` padding. So components that previously used `-$grid-unit-15` will now need to be updated to use `-$grid-unit-10` instead to avoid scrollbars. Here's a couple of examples:

Scrollbars introduced:

| Selecting between edit and select modes | Replacing media in an image block |
| --- | --- |
| ![image](https://user-images.githubusercontent.com/14988353/131605337-b66079ff-4553-4437-80d2-0db41ad227e3.png) | ![image](https://user-images.githubusercontent.com/14988353/131605407-08ece117-d14d-4e2f-a73c-0ff0d3ca9002.png) | 

@jasmussen do we want to work through those instances that need their negative margins updated (I'm happy to open a couple of PRs, I already updated the drop down menu component in #34406). Alternately, did we want to update the Heading dropdown to use its own negative margins instead of globally updating padding for the children of the popover content?

Happy to help out!

### jasmussen on 2021-09-01T06:56:47Z

URL: https://github.com/WordPress/gutenberg/pull/34378#issuecomment-909975898
...
- packages/block-library/src/heading/editor.scss (DELETED, +0/-8)
