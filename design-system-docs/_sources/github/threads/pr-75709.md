...
type: pull_request
state: MERGED
merged_at: 2026-02-19T22:16:45Z
url: https://github.com/WordPress/gutenberg/pull/75709
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components","[Package] Base styles","Backported to WP Core"]
---

# PR #75709: Snackbar: Fix scaling issue with snackbars that update their content via a common id

- URL: https://github.com/WordPress/gutenberg/pull/75709
- Author: andrewserong
- Created: 2026-02-19T04:15:32Z
- Updated: 2026-02-23T09:39:53Z
- Comments: 6 of 6
- Review threads: 2 of 2
- Changed files: 3 of 3
- Diff: ../pr-diffs/75709.diff
...
### github-actions on 2026-02-19T04:27:17Z

URL: https://github.com/WordPress/gutenberg/pull/75709#issuecomment-3924621936
...
| :--- | :---: | :---: |
| `build/modules/boot/index.min.js` | 14.8 kB | -4 B (-0.03%) |
| `build/scripts/components/index.min.js` | 265 kB | +12 B (0%) |
| `build/styles/edit-post/style-rtl.min.css` | 2.56 kB | -7 B (-0.27%) |
| `build/styles/edit-post/style.css` | 3.93 kB | +2 B (+0.05%) |
| `build/styles/edit-post/style.min.css` | 2.56 kB | -9 B (-0.35%) |
| `build/styles/edit-site/style-rtl.css` | 20.3 kB | -8 B (-0.04%) |
| `build/styles/edit-site/style-rtl.min.css` | 16.4 kB | -7 B (-0.04%) |
| `build/styles/edit-site/style.css` | 20.3 kB | -5 B (-0.02%) |
| `build/styles/edit-site/style.min.css` | 16.4 kB | -4 B (-0.02%) |
| `build/styles/edit-widgets/style-rtl.css` | 5.16 kB | -14 B (-0.27%) |
| `build/styles/edit-widgets/style-rtl.min.css` | 3.78 kB | -6 B (-0.16%) |
| `build/styles/edit-widgets/style.css` | 5.15 kB | -16 B (-0.31%) |
| `build/styles/edit-widgets/style.min.css` | 3.79 kB | -8 B (-0.21%) |
| `build/styles/media-utils/style-rtl.css` | 1.67 kB | -18 B (-1.07%) |
| `build/styles/media-utils/style-rtl.min.css` | 784 B | -16 B (-2%) |
| `build/styles/media-utils/style.css` | 1.67 kB | -17 B (-1.01%) |
| `build/styles/media-utils/style.min.css` | 783 B | -17 B (-2.13%) |
...
### github-actions on 2026-02-19T04:57:35Z

URL: https://github.com/WordPress/gutenberg/pull/75709#issuecomment-3924695550
...
### github-actions on 2026-02-19T05:14:41Z

URL: https://github.com/WordPress/gutenberg/pull/75709#issuecomment-3924738545

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 4f7bd27a7fdca68590a75f02e66f1ddcae9b3507.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/22168534864
📝  Reported issues:
- #75667 in `/test/e2e/specs/site-editor/page-list.spec.js`
- #71871 in `/test/e2e/specs/editor/various/mentions.spec.js`

### andrewserong on 2026-02-19T22:14:00Z

URL: https://github.com/WordPress/gutenberg/pull/75709#issuecomment-3930441048
...
No, it took a little while to land on the changes here, but the reason we need the `100%` width and auto margin rules is that without this, Motion will detect horizontal position changes and animate the snackbar left and right when the content changes.

I'm sure we can continue to improve how this works, but the additional rules are to ensure that when content changes within the snackbar, it "snaps" to the new size of the snackbar instead of either scaling (what's happening on trunk) or shifting left and right.

Thanks so much for the speedy reviews, everyone!

I'll land this now, but happy to help out with follow-ups (and expand on the comments) if it's not quite right, we encounter issues, or if things need further clarification.

### github-actions on 2026-02-20T01:39:20Z

URL: https://github.com/WordPress/gutenberg/pull/75709#issuecomment-3931091024

I just cherry-picked this PR to the wp/7.0 branch to get it included in the next release: a48139afe1a185a26841b09dd607222a03a8768c

### ockham on 2026-02-23T09:39:53Z

URL: https://github.com/WordPress/gutenberg/pull/75709#issuecomment-3943656223

I just cherry-picked this PR to the release/22.6 branch to get it included in the next release: e71d4411e72

## Review threads

### Review thread 1

#### t-hamano on 2026-02-19T07:28:29Z

URL: https://github.com/WordPress/gutenberg/pull/75709#discussion_r2826088111
...
#### andrewserong on 2026-02-19T22:15:33Z

URL: https://github.com/WordPress/gutenberg/pull/75709#discussion_r2830419244
Path: packages/components/src/snackbar/list.tsx
...
#### ciampo on 2026-02-19T09:18:05Z

URL: https://github.com/WordPress/gutenberg/pull/75709#discussion_r2826516214
Path: packages/components/src/snackbar/list.tsx
...
#### andrewserong on 2026-02-19T22:10:31Z

URL: https://github.com/WordPress/gutenberg/pull/75709#discussion_r2830402078
Path: packages/components/src/snackbar/list.tsx
...
- packages/base-styles/_mixins.scss (MODIFIED, +8/-6)
