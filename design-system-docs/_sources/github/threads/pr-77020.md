...
type: pull_request
state: MERGED
merged_at: 2026-04-04T06:56:34Z
url: https://github.com/WordPress/gutenberg/pull/77020
matched_labels: ["[Package] Components"]
all_labels: ["[Feature] UI Components","[Type] Code Quality","[Package] Components"]
---

# PR #77020: Autocomplete: Refactor useAutocomplete to use useReducer

- URL: https://github.com/WordPress/gutenberg/pull/77020
- Author: Mamaduka
- Created: 2026-04-03T07:27:02Z
- Updated: 2026-04-04T06:58:13Z
- Comments: 3 of 3
- Review threads: 2 of 2
- Changed files: 3 of 3
- Diff: ../pr-diffs/77020.diff

## Body

## What?
PR contains the following code quality improvements for the `useAutocomplete` hook:

- Replace four separate `useState` calls with a single `useReducer` to simplify related state updates.
- Derive `AutocompleterUI` component via `useMemo` instead of storing it in state, since it's just a function of `autocompleter`. This removes the awkward `setState(() => component)` workaround needed to store a function in state.
- Combine `ArrowUp`/`ArrowDown` key handlers — they only differed in index calculation, now unified with modular arithmetic.
- A simplified completion object getter - `getCompletionObject`.
...
### github-actions on 2026-04-03T07:28:17Z

URL: https://github.com/WordPress/gutenberg/pull/77020#issuecomment-4182310337
...
### github-actions on 2026-04-03T07:47:45Z

URL: https://github.com/WordPress/gutenberg/pull/77020#issuecomment-4182373857
...
| :--- | :---: | :---: |
| `build/scripts/components/index.min.js` | 265 kB | +124 B (+0.05%) |
...
### github-actions on 2026-04-03T08:06:11Z

URL: https://github.com/WordPress/gutenberg/pull/77020#issuecomment-4182433021

<!-- flaky-tests-report-comment -->
**Flaky tests detected in c95c8910c68484b09a28ed18d22c2b0dbfc0b406.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/23938399425
📝  Reported issues:
...
#### Mamaduka on 2026-04-03T07:28:04Z

URL: https://github.com/WordPress/gutenberg/pull/77020#discussion_r3031803772
Path: packages/components/src/autocomplete/index.tsx

```diff
@@ -50,19 +100,14 @@ export function useAutocomplete( {
 	contentRef,
...
#### Mamaduka on 2026-04-03T07:37:05Z

URL: https://github.com/WordPress/gutenberg/pull/77020#discussion_r3031830054
Path: packages/components/src/autocomplete/index.tsx
...
- packages/components/src/autocomplete/index.tsx (MODIFIED, +80/-84)
- packages/components/src/autocomplete/types.ts (MODIFIED, +13/-0)
