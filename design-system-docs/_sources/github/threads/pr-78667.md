...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/78667
matched_labels: ["[Package] Theme"]
all_labels: ["[Package] Theme"]
---

# PR #78667: @wordpress/theme: extract static legacy overrides from ThemeProvider

- URL: https://github.com/WordPress/gutenberg/pull/78667
- Author: ciampo
- Created: 2026-05-26T09:07:00Z
- Updated: 2026-05-26T10:20:31Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 5 of 5
- Diff: ../pr-diffs/78667.diff
...
### github-actions on 2026-05-26T09:16:52Z

URL: https://github.com/WordPress/gutenberg/pull/78667#issuecomment-4542693359

**Size Change:** -15 kB (-0.18%) 
...
| :--- | :---: | :---: | :---: |
| `build/modules/boot/index.min.js` | 19.7 kB | +157 B (+0.8%) |  |
| `build/scripts/block-editor/index.min.js` | 379 kB | +34 B (+0.01%) |  |
| `build/scripts/block-library/index.min.js` | 323 kB | +1 B (0%) |  |
| `build/scripts/blocks/index.min.js` | 57.1 kB | +28 B (+0.05%) |  |
| `build/scripts/components/index.min.js` | 264 kB | +51 B (+0.02%) |  |
| `build/scripts/editor/index.min.js` | 462 kB | -91 B (-0.02%) |  |
| `build/scripts/element/index.min.js` | 5.2 kB | -437 B (-7.76%) | ✅ |
| `build/scripts/keyboard-shortcuts/index.min.js` | 1.65 kB | -5 B (-0.3%) |  |
| `build/scripts/theme/index.min.js` | 21.9 kB | -155 B (-0.7%) |  |
| `build/scripts/vendors/react-dom.min.js` | 43.3 kB | -14.4 kB (-24.94%) | 🎉 |
| `build/scripts/vendors/react-jsx-runtime.min.js` | 667 B | +154 B (+30.02%) | 🚨 |
| `build/scripts/vendors/react.min.js` | 2.77 kB | -323 B (-10.44%) | 👏 |
...
### ciampo on 2026-05-26T10:20:20Z

URL: https://github.com/WordPress/gutenberg/pull/78667#issuecomment-4543319865

Closing in favor of #78664, which addresses B3 together with B2.
...
- packages/boot/src/style.scss (MODIFIED, +1/-0)
- packages/theme/CHANGELOG.md (MODIFIED, +4/-0)
- packages/theme/package.json (MODIFIED, +1/-0)
- packages/theme/src/prebuilt/css/legacy-overrides.css (ADDED, +25/-0)
- packages/theme/src/use-theme-provider-styles.ts (MODIFIED, +14/-60)
