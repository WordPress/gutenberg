...
type: pull_request
state: MERGED
merged_at: 2022-06-08T15:02:14Z
url: https://github.com/WordPress/gutenberg/pull/41536
...
# PR #41536: TreeSelect Convert to Typescript.

- URL: https://github.com/WordPress/gutenberg/pull/41536
- Author: torounit
- Created: 2022-06-03T11:12:02Z
- Updated: 2022-06-08T15:02:59Z
- Comments: 1 of 1
- Review threads: 2 of 2
- Changed files: 9 of 9
- Diff: ../pr-diffs/41536.diff
...
Props changed to match `<SelectControl />`.
...
### github-actions on 2022-06-03T11:18:50Z

URL: https://github.com/WordPress/gutenberg/pull/41536#issuecomment-1145862510
...
#### mirka on 2022-06-07T14:08:47Z

URL: https://github.com/WordPress/gutenberg/pull/41536#discussion_r891282948
...
#### mirka on 2022-06-07T14:16:04Z

URL: https://github.com/WordPress/gutenberg/pull/41536#discussion_r891292218
Path: packages/components/src/tree-select/stories/index.tsx

```diff
@@ -33,15 +47,9 @@ const TreeSelectWithState = ( props ) => {
 	);
 };
...
Could we keep these demo values in the `Default.args`? Just so we get a good visual of the most commonly used props.
...
- packages/components/src/select-control/stories/index.tsx (MODIFIED, +1/-1)
- packages/components/src/tree-select/README.md (MODIFIED, +2/-2)
- packages/components/src/tree-select/index.js (DELETED, +0/-48)
- packages/components/src/tree-select/index.tsx (ADDED, +99/-0)
- packages/components/src/tree-select/stories/index.js (DELETED, +0/-80)
- packages/components/src/tree-select/stories/index.tsx (ADDED, +81/-0)
- packages/components/src/tree-select/types.ts (ADDED, +35/-0)
