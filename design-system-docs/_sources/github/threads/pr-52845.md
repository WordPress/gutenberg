...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/52845
...
# PR #52845: Add `fitted` prop to TabPanel

- URL: https://github.com/WordPress/gutenberg/pull/52845
- Author: jameskoster
- Created: 2023-07-21T16:08:39Z
- Updated: 2025-02-10T16:47:29Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 3 of 3
- Diff: ../pr-diffs/52845.diff
...
### github-actions on 2023-07-21T16:20:57Z

URL: https://github.com/WordPress/gutenberg/pull/52845#issuecomment-1645921128
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 241 kB | +20 B (0%) |
| `build/components/style-rtl.css` | 11.8 kB | +19 B (0%) |
| `build/components/style.css` | 11.8 kB | +19 B (0%) |
...
### mirka on 2023-07-24T12:46:42Z

URL: https://github.com/WordPress/gutenberg/pull/52845#issuecomment-1647847422

Could this feature wait a little bit? We are in the process of building a new version of this component that would be more modular in design, so that the consumer can achieve this kind of tab style more easily, perhaps not even requiring a prop. 

cc @chad1008

### jameskoster on 2023-07-24T16:12:07Z

URL: https://github.com/WordPress/gutenberg/pull/52845#issuecomment-1648211190

It can totally wait :)

### ciampo on 2023-09-01T13:35:14Z

URL: https://github.com/WordPress/gutenberg/pull/52845#issuecomment-1702760776

Let's close this PR for now, since — as @mirka explained — [we're working on a new version of `Tabs`](https://github.com/WordPress/gutenberg/pull/53960) which will expose each subcomponent individually, thus allowing the "fitter" behavior without the need for a dedicated prop

We can always re-open this PR in the future if needed.
...
- packages/components/src/tab-panel/index.tsx (MODIFIED, +6/-1)
- packages/components/src/tab-panel/style.scss (MODIFIED, +6/-0)
- packages/components/src/tab-panel/types.ts (MODIFIED, +8/-0)
