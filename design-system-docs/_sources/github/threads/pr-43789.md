...
type: pull_request
state: MERGED
merged_at: 2022-09-05T09:51:00Z
url: https://github.com/WordPress/gutenberg/pull/43789
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Feature] UI Components","[Type] Code Quality","[Package] Components"]
---

# PR #43789: BorderBoxControl: use Popover's new anchor prop

- URL: https://github.com/WordPress/gutenberg/pull/43789
- Author: ciampo
- Created: 2022-09-01T18:00:54Z
- Updated: 2022-09-05T09:51:00Z
- Comments: 2 of 2
- Review threads: 6 of 6
- Changed files: 4 of 4
- Diff: ../pr-diffs/43789.diff
...
### github-actions on 2022-09-01T18:09:07Z

URL: https://github.com/WordPress/gutenberg/pull/43789#issuecomment-1234618068
...
### ciampo on 2022-09-05T09:50:38Z

URL: https://github.com/WordPress/gutenberg/pull/43789#issuecomment-1236782863

Thank you for the review, @aaronrobertshaw !

> P.S. We'll need a changelog 🙂

Good call. I'm planning on adding CHANGELOG entries on [the base PR](https://github.com/WordPress/gutenberg/pull/43691) before merging to `trunk`

## Review threads

### Review thread 1

#### ciampo on 2022-09-01T18:03:41Z

URL: https://github.com/WordPress/gutenberg/pull/43789#discussion_r960960748
Path: packages/components/src/border-box-control/border-box-control-split-controls/component.tsx
...
This changes are in place to make sure that, when the `containerRef` is updated, `popoverProps` are updated too.

Without it, the ref would be updated _after_ the initial value of `popoverProps` was computed, and because of how React refs work, React wouldn't re-render the component — meaning that the `anchor` property in `popoverProps` would be stale until a re-render would be caused by whatever reason.

### Review thread 2

#### ciampo on 2022-09-01T18:04:03Z

URL: https://github.com/WordPress/gutenberg/pull/43789#discussion_r960961058
Path: packages/components/src/border-box-control/border-box-control-split-controls/component.tsx
...
#### ciampo on 2022-09-01T18:04:30Z

URL: https://github.com/WordPress/gutenberg/pull/43789#discussion_r960961395
...
Same set of changes as [in the other component](https://github.com/WordPress/gutenberg/pull/43789#discussion_r960960748)

### Review thread 4

#### ciampo on 2022-09-01T18:05:10Z

URL: https://github.com/WordPress/gutenberg/pull/43789#discussion_r960961911
Path: packages/components/src/border-box-control/types.ts
...
#### ciampo on 2022-09-04T13:57:31Z

URL: https://github.com/WordPress/gutenberg/pull/43789#discussion_r962318742
Path: packages/components/src/border-box-control/types.ts
...
Working on it https://github.com/WordPress/gutenberg/pull/43823

### Review thread 5

#### ciampo on 2022-09-01T18:06:55Z

URL: https://github.com/WordPress/gutenberg/pull/43789#discussion_r960963175
Path: packages/components/src/border-box-control/stories/index.js
...
I added `popoverPlacement` while testing for the [stale `anchor` value](https://github.com/WordPress/gutenberg/pull/43789/files#r960960748), and decided to keep it for convenience.

But the component's stories definitely need to be rewritten in TypeScript so that they can show all props

#### aaronrobertshaw on 2022-09-05T09:35:30Z

URL: https://github.com/WordPress/gutenberg/pull/43789#discussion_r962702361
Path: packages/components/src/border-box-control/stories/index.js
...
#### ciampo on 2022-09-01T18:08:32Z

URL: https://github.com/WordPress/gutenberg/pull/43789#discussion_r960964370
Path: packages/components/src/border-box-control/border-box-control-split-controls/component.tsx
...
- packages/components/src/border-box-control/border-box-control-split-controls/component.tsx (MODIFIED, +20/-9)
- packages/components/src/border-box-control/border-box-control/component.tsx (MODIFIED, +21/-9)
- packages/components/src/border-box-control/stories/index.js (MODIFIED, +1/-0)
- packages/components/src/border-box-control/types.ts (MODIFIED, +16/-2)
