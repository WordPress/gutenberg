...
type: pull_request
state: MERGED
merged_at: 2025-12-12T18:45:37Z
url: https://github.com/WordPress/gutenberg/pull/73970
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #73970: TextareaControl: Deprecate bottom margin

- URL: https://github.com/WordPress/gutenberg/pull/73970
- Author: mirka
- Created: 2025-12-12T14:11:08Z
- Updated: 2025-12-12T18:46:18Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 20 of 20
- Diff: ../pr-diffs/73970.diff
...
### github-actions on 2025-12-12T14:11:30Z

URL: https://github.com/WordPress/gutenberg/pull/73970#issuecomment-3646638749
...
### github-actions on 2025-12-12T14:32:49Z

URL: https://github.com/WordPress/gutenberg/pull/73970#issuecomment-3646714677
...
| :--- | :---: | :---: |
| `build/scripts/block-editor/index.min.js` | 315 kB | -5 B (0%) |
| `build/scripts/block-library/index.min.js` | 281 kB | -10 B (0%) |
| `build/scripts/components/index.min.js` | 272 kB | -21 B (-0.01%) |
| `build/scripts/editor/index.min.js` | 284 kB | +4 B (0%) |
| `build/scripts/format-library/index.min.js` | 10.8 kB | -8 B (-0.07%) |
| `build/scripts/media-utils/index.min.js` | 69.5 kB | -4 B (-0.01%) |
...
### github-actions on 2025-12-12T14:49:03Z

URL: https://github.com/WordPress/gutenberg/pull/73970#issuecomment-3646771069

<!-- flaky-tests-report-comment -->
**Flaky tests detected in e23396e753bee62f709eea54056c2257d4d8fc81.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/20169631488
📝  Reported issues:
...
- packages/block-editor/src/components/global-styles/advanced-panel.js (MODIFIED, +0/-1)
...
- packages/block-library/src/math/edit.js (MODIFIED, +0/-1)
...
- packages/components/src/textarea-control/README.md (MODIFIED, +0/-8)
- packages/components/src/textarea-control/index.tsx (MODIFIED, +3/-4)
- packages/components/src/textarea-control/stories/index.story.tsx (MODIFIED, +0/-1)
- packages/components/src/textarea-control/types.ts (MODIFIED, +1/-1)
- packages/components/src/validated-form-controls/components/textarea-control.tsx (MODIFIED, +2/-10)
- packages/editor/src/components/post-excerpt/index.js (MODIFIED, +0/-1)
- packages/editor/src/components/post-title/post-title-raw.js (MODIFIED, +0/-1)
- packages/format-library/src/image/index.js (MODIFIED, +0/-1)
- packages/media-fields/src/alt_text/index.tsx (MODIFIED, +0/-1)
- packages/media-fields/src/caption/index.tsx (MODIFIED, +0/-1)
- packages/media-fields/src/description/index.tsx (MODIFIED, +0/-1)
