...
type: pull_request
state: MERGED
merged_at: 2022-07-20T08:39:16Z
url: https://github.com/WordPress/gutenberg/pull/42272
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Feature] UI Components","[Type] Code Quality","[Package] Components"]
---

# PR #42272: Shortcut: Covert component to TypeScript

- URL: https://github.com/WordPress/gutenberg/pull/42272
- Author: walbo
- Created: 2022-07-08T14:12:10Z
- Updated: 2022-07-20T08:39:45Z
- Comments: 1 of 1
- Review threads: 1 of 1
- Changed files: 6 of 6
- Diff: ../pr-diffs/42272.diff
...
## What?
Converts the `Shortcut` component to TypeScript.

## Why?
Part of the @wordpress/components's TypeScript migration (https://github.com/WordPress/gutenberg/issues/35744).

## How?
- Refactors the current `Shortcut` to TypeScript.
- Refactors the test to TypeScript and refactored to use `@testing-library/react`.

## Testing Instructions
1. Run npm run dev and ensure no typing errors
2. Test within the Gutenberg editor

## Issue comments

### github-actions on 2022-07-08T14:20:49Z

URL: https://github.com/WordPress/gutenberg/pull/42272#issuecomment-1179045107
...
#### ciampo on 2022-07-19T13:59:47Z

URL: https://github.com/WordPress/gutenberg/pull/42272#discussion_r924540407
Path: packages/components/src/shortcut/test/index.tsx
...
I wonder if we could write this test in a way that explicitly tests the accessible label, maybe something like:

```suggestion
		expect( screen. getByLabelText( 'shortcut label' ) ).toHaveTextContent('shortcut text');
```

#### walbo on 2022-07-19T14:25:24Z

URL: https://github.com/WordPress/gutenberg/pull/42272#discussion_r924570864
Path: packages/components/src/shortcut/test/index.tsx
...
#### ciampo on 2022-07-20T06:59:09Z

URL: https://github.com/WordPress/gutenberg/pull/42272#discussion_r925243269
Path: packages/components/src/shortcut/test/index.tsx
...
https://github.com/WordPress/gutenberg/pull/42272/commits/041ee3b952f4a6be92ecd3cae8b90ae142e6de40 looks good!

In general, my preference would be to prefer this style of tests over snapshots when possible.

Thank you, and feel free to merge!

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/shortcut/index.tsx (RENAMED, +5/-9)
- packages/components/src/shortcut/test/__snapshots__/index.tsx.snap (ADDED, +15/-0)
- packages/components/src/shortcut/test/index.js (DELETED, +0/-37)
- packages/components/src/shortcut/test/index.tsx (ADDED, +41/-0)
- packages/components/src/shortcut/types.ts (ADDED, +10/-0)
