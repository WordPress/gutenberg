...
type: pull_request
state: MERGED
merged_at: 2022-08-31T17:23:55Z
url: https://github.com/WordPress/gutenberg/pull/43694
matched_labels: ["[Feature] Component System"]
all_labels: ["[Type] Enhancement","[Type] Code Quality","[Package] Block editor","[Feature] Component System"]
---

# PR #43694: ListViewDropIndicator: use Popover's new anchor prop

- URL: https://github.com/WordPress/gutenberg/pull/43694
- Author: ciampo
- Created: 2022-08-30T08:41:41Z
- Updated: 2022-08-31T17:23:56Z
- Comments: 1 of 1
- Review threads: 4 of 4
- Changed files: 1 of 1
- Diff: ../pr-diffs/43694.diff
...
### github-actions on 2022-08-30T08:50:38Z

URL: https://github.com/WordPress/gutenberg/pull/43694#issuecomment-1231364906
...
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 160 kB | +18 B (0%) |
...
#### ciampo on 2022-08-30T08:42:23Z

URL: https://github.com/WordPress/gutenberg/pull/43694#discussion_r958187922
Path: packages/block-editor/src/components/list-view/drop-indicator.js
...
Change no. 1: return `undefined` instead of an empty object, since it wouldn't be a valid value for the `anchor` prop

### Review thread 2

#### ciampo on 2022-08-30T08:43:39Z

URL: https://github.com/WordPress/gutenberg/pull/43694#discussion_r958189685
Path: packages/block-editor/src/components/list-view/drop-indicator.js
...
Change no. 2: instead of returning an empty object at the end of this function if `dropPosition` didn't have the required values, I moved that check at the start of the function.

### Review thread 3

#### ciampo on 2022-08-30T08:44:00Z

URL: https://github.com/WordPress/gutenberg/pull/43694#discussion_r958190100
Path: packages/block-editor/src/components/list-view/drop-indicator.js
...
Change no. 3: `ownerDocument` is passed as a top-level property

### Review thread 4

#### ciampo on 2022-08-30T08:45:27Z

URL: https://github.com/WordPress/gutenberg/pull/43694#discussion_r958191695
Path: packages/block-editor/src/components/list-view/drop-indicator.js
...
Change no. 4: the logic was kept unchanged, but moved inside the `getBoundingClientRect` function.

Instead of returning a "handmade" rect-like object, we use `DOMRect` to make sure the return value is guaranteed to have the correct type
