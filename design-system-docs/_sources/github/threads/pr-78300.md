...
type: pull_request
state: MERGED
merged_at: 2026-05-18T12:58:36Z
url: https://github.com/WordPress/gutenberg/pull/78300
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Enhancement","[Package] UI"]
---

# PR #78300: UI Button: Optimize overflow styles

- URL: https://github.com/WordPress/gutenberg/pull/78300
- Author: mirka
- Created: 2026-05-14T14:30:07Z
- Updated: 2026-05-18T12:59:21Z
- Comments: 7 of 7
- Review threads: 1 of 1
- Changed files: 3 of 3
- Diff: ../pr-diffs/78300.diff
...
### github-actions on 2026-05-14T14:38:26Z

URL: https://github.com/WordPress/gutenberg/pull/78300#issuecomment-4451677142
...
| :--- | :---: | :---: |
| `build/modules/content-types/index.min.js` | 156 kB | +49 B (+0.03%) |
...
### github-actions on 2026-05-14T15:16:34Z

URL: https://github.com/WordPress/gutenberg/pull/78300#issuecomment-4452010191

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 74b27216457222477a4f7730790d0ba4d3384ca8.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/25927455362
📝  Reported issues:
- #77710 in `/test/e2e/specs/widgets/editing-widgets.spec.js`
- #77701 in `/test/e2e/specs/editor/various/upload-save-lock.spec.js`

### github-actions on 2026-05-14T16:32:13Z

URL: https://github.com/WordPress/gutenberg/pull/78300#issuecomment-4452610504
...
### jameskoster on 2026-05-15T08:23:42Z

URL: https://github.com/WordPress/gutenberg/pull/78300#issuecomment-4458202916

A couple of small design considerations:

1. Should we use `hyphens: auto` to improve readability of broken words?
2. Should we add `padding-block` to create some more space between the label and the button edge in cases where it wraps to multiple lines?

### mirka on 2026-05-15T16:02:40Z

URL: https://github.com/WordPress/gutenberg/pull/78300#issuecomment-4461327900

> 1. Should we use `hyphens: auto` to improve readability of broken words?

We generally can't do this with library components because there are strings that should never be hyphenated (e.g. product names, slugs, ids, etc).

> 2. Should we add `padding-block` to create some more space between the label and the button edge in cases where it wraps to multiple lines?

I added a 4px "courtesy" padding (except for in `small` size), which I would say is appropriate given how multiple-line buttons are an emergency layout:

| Default | Compact | Small |
|--------|--------|--------|
| <img width="1046" height="554" alt="Overflowing buttons, default" src="https://github.com/user-attachments/assets/912ad644-5315-4745-9ec5-76389782f980" /> | <img width="1046" height="556" alt="Overflowing buttons, compact" src="https://github.com/user-attachments/assets/80dba459-11cc-4838-b3b7-6892c5984588" /> | <img width="1046" height="466" alt="Overflowing buttons, small" src="https://github.com/user-attachments/assets/b0174f65-36c7-439b-b1fc-ddffa5c3b6f4" /> |

### jameskoster on 2026-05-18T09:01:07Z

URL: https://github.com/WordPress/gutenberg/pull/78300#issuecomment-4476049391

> We generally can't do this with library components because there are strings that should never be hyphenated (e.g. product names, slugs, ids, etc).

Makes sense, but the legibility of broken long words suffers quite a bit. Should it be a prop? 🤔

### mirka on 2026-05-18T12:58:08Z

URL: https://github.com/WordPress/gutenberg/pull/78300#issuecomment-4477900971

I'd say it's fine to leave as something a consumer could write CSS for if they want that behavior. Wrapped button labels are usually going to be something that people want to _fix_, rather than make legible.

## Review threads

### Review thread 1

#### mirka on 2026-05-14T16:27:13Z

URL: https://github.com/WordPress/gutenberg/pull/78300#discussion_r3242769421
...
- `anywhere` — This will break long words, but the downside is that it will shrink down the button width in `min-content` situations. See the min-content example in the e2e Storybook, or the change we'd have to make in [`packages/ui/src/button/stories/index.story.tsx`](https://github.com/WordPress/gutenberg/pull/78300/changes#diff-36001c5847bf3124ed65ffe90338f34a589dd8a87b2ffe39c372da0fd992d0be).
...
#### mirka on 2026-05-14T16:31:45Z

URL: https://github.com/WordPress/gutenberg/pull/78300#discussion_r3242798161
Path: packages/ui/src/button/style.module.css
...
#### ciampo on 2026-05-14T16:57:26Z

URL: https://github.com/WordPress/gutenberg/pull/78300#discussion_r3242945394
Path: packages/ui/src/button/style.module.css
...
#### jameskoster on 2026-05-15T08:18:18Z

URL: https://github.com/WordPress/gutenberg/pull/78300#discussion_r3246836291
Path: packages/ui/src/button/style.module.css
...
- packages/ui/src/button/style.module.css (MODIFIED, +7/-1)
