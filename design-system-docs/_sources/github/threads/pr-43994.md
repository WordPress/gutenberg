...
type: pull_request
state: MERGED
merged_at: 2022-09-12T20:07:38Z
url: https://github.com/WordPress/gutenberg/pull/43994
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components"]
---

# PR #43994: Components: Retire `LIGHT_GRAY` color object

- URL: https://github.com/WordPress/gutenberg/pull/43994
- Author: mirka
- Created: 2022-09-08T17:27:59Z
- Updated: 2022-09-13T10:06:47Z
- Comments: 7 of 7
- Review threads: 0 of 0
- Changed files: 6 of 6
- Diff: ../pr-diffs/43994.diff
...
### github-actions on 2022-09-08T17:42:18Z

URL: https://github.com/WordPress/gutenberg/pull/43994#issuecomment-1241033643
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 198 kB | -45 B (0%) |
...
### jasmussen on 2022-09-09T06:49:48Z

URL: https://github.com/WordPress/gutenberg/pull/43994#issuecomment-1241569396

Not for this PR or even anything urgent, but just a general question. These components going back to their original G2 name were designed with this blue ("Blueberry" #3858E9) color in mind:
<img width="310" alt="Screenshot 2022-09-09 at 08 47 45" src="https://user-images.githubusercontent.com/1204802/189288568-8cad46fd-dd33-499d-a1c9-98910fb066a2.png">

The current blue is a classic WordPress blue:
<img width="167" alt="Screenshot 2022-09-09 at 08 47 18" src="https://user-images.githubusercontent.com/1204802/189288664-57257d55-012d-4c74-8597-9dd688c5fe54.png">

That classic WordPress blue is currently applied using a CSS variable across components:

<img width="336" alt="Screenshot 2022-09-09 at 08 47 31" src="https://user-images.githubusercontent.com/1204802/189288696-75d4f225-3feb-4889-8120-87385a142546.png">

Could we replace that hardcoded classic blue with the new Blueberry as a default for the components? So that consumers outside of the wp-admin context will get the correct blue?

### ciampo on 2022-09-09T18:20:26Z

URL: https://github.com/WordPress/gutenberg/pull/43994#issuecomment-1242320706

> Could we replace that hardcoded classic blue with the new Blueberry as a default for the components? So that consumers outside of the wp-admin context will get the correct blue?

That is definitely something that we'd like to do as part of the work on theming.

Ideally the component package would expose a few variables — in this specific case, something like "primary color" (or whatever name we find more appropriate). The package could use "blueberry blue" as the default value for that variable, but any consumer of the package would be able to override it (for example, Gutenberg could override it to whatever the admin color is).
...
### jasmussen on 2022-09-12T09:05:47Z

URL: https://github.com/WordPress/gutenberg/pull/43994#issuecomment-1243434536

That sounds great!

### mirka on 2022-09-12T20:07:16Z

URL: https://github.com/WordPress/gutenberg/pull/43994#issuecomment-1244342088

@jasmussen Do we want to update the default color scheme _just_ for the components package? I looked into it and found that almost all `@wordpress/*` packages ship with the [classic wp blue color scheme](https://github.com/WordPress/gutenberg/blob/c1c046e2d6d87c29fff10c98d9b17c970062e1c9/packages/base-styles/_default-custom-properties.scss#L6), as part of the [standard build process](https://github.com/WordPress/gutenberg/blob/c1c046e2d6d87c29fff10c98d9b17c970062e1c9/bin/packages/build-worker.js#L107-L109). We could, for example, update `@wordpress/base-styles/default-custom-properties` to default to the [new color scheme](https://github.com/WordPress/gutenberg/blob/c1c046e2d6d87c29fff10c98d9b17c970062e1c9/packages/base-styles/_mixins.scss#L455), which would apply to all packages at once. Or is this change intended only for the components package?

I don't have a problem with either, just checking so we can take the correct approach!

### jasmussen on 2022-09-13T06:31:54Z

URL: https://github.com/WordPress/gutenberg/pull/43994#issuecomment-1244960626

Thanks for following up. For now, mainly for the components package.

### ciampo on 2022-09-13T10:06:47Z

URL: https://github.com/WordPress/gutenberg/pull/43994#issuecomment-1245189179

Created https://github.com/WordPress/gutenberg/issues/44116 to have a central place for theming conversations
...
- packages/components/src/range-control/styles/range-control-styles.ts (MODIFIED, +8/-8)
- packages/components/src/unit-control/styles/unit-control-styles.ts (MODIFIED, +1/-1)
- packages/components/src/utils/colors-values.js (MODIFIED, +0/-12)
