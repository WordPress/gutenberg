...
type: pull_request
state: MERGED
merged_at: 2022-09-12T10:40:48Z
url: https://github.com/WordPress/gutenberg/pull/44075
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Automated Testing","[Type] Code Quality","[Package] Components"]
---

# PR #44075: Components: Refactor `KeyboardShortcuts` tests to `@testing-library/react`

- URL: https://github.com/WordPress/gutenberg/pull/44075
- Author: tyxla
- Created: 2022-09-12T09:31:16Z
- Updated: 2022-09-13T08:15:42Z
- Comments: 1 of 1
- Review threads: 1 of 1
- Changed files: 2 of 2
- Diff: ../pr-diffs/44075.diff
...
### github-actions on 2022-09-12T09:41:57Z

URL: https://github.com/WordPress/gutenberg/pull/44075#issuecomment-1243479669
...
#### ciampo on 2022-09-12T09:51:08Z

URL: https://github.com/WordPress/gutenberg/pull/44075#discussion_r968211766
Path: packages/components/src/keyboard-shortcuts/test/index.js
...
It would be great if we could follow-up with a refactor from `fireEvent` to `user-event` (and from `keyCode` to `code` for keyboard events)

#### tyxla on 2022-09-12T10:40:20Z

URL: https://github.com/WordPress/gutenberg/pull/44075#discussion_r968256986
Path: packages/components/src/keyboard-shortcuts/test/index.js
...
Good call. While I'm not prioritizing that refactor at this time, I'm going to add it to my list so it doesn't fall through the cracks.

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/keyboard-shortcuts/test/index.js (MODIFIED, +16/-31)
