...
type: pull_request
state: MERGED
merged_at: 2024-05-08T13:48:50Z
url: https://github.com/WordPress/gutenberg/pull/61476
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Feature] UI Components","[Package] Components"]
---

# PR #61476: RadioControl: Fix shrinking radio controls

- URL: https://github.com/WordPress/gutenberg/pull/61476
- Author: tyxla
- Created: 2024-05-08T08:21:02Z
- Updated: 2024-05-08T14:07:36Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 1 of 1
- Diff: ../pr-diffs/61476.diff
...
### github-actions on 2024-05-08T08:29:35Z

URL: https://github.com/WordPress/gutenberg/pull/61476#issuecomment-2100041902
...
| `build/editor/style-rtl.css` | 7.56 kB | +12 B (+0.16%) |
| `build/editor/style.css` | 7.56 kB | +11 B (+0.15%) |
...
| `build/edit-post/style-rtl.css` | 3.78 kB |
| `build/edit-post/style.css` | 3.78 kB |
...
| `build/editor/index.min.js` | 81.3 kB |
...
### github-actions on 2024-05-08T13:03:48Z

URL: https://github.com/WordPress/gutenberg/pull/61476#issuecomment-2100531049
...
### jameskoster on 2024-05-08T13:06:19Z

URL: https://github.com/WordPress/gutenberg/pull/61476#issuecomment-2100535765

As a sidenote, it might be nice to follow-up to fix the alignment when labels wrap so the first line is centrally aligned with the radio:

<img width="117" alt="Screenshot 2024-05-08 at 14 03 45" src="https://github.com/WordPress/gutenberg/assets/846565/de0e1230-6a7a-4cf6-9d5c-db579b70ab1e">

Additionally we can probably increase the gap between rows too, it's a bit tight at the moment.

### tyxla on 2024-05-08T14:07:35Z

URL: https://github.com/WordPress/gutenberg/pull/61476#issuecomment-2100672992

No objections to both - feel free to work on a follow-up PR, I'm happy to help with the reviews. They do seem a bit packed right now (especially when you have a focused radio control):

 
![Screenshot 2024-05-08 at 16 58 25](https://github.com/WordPress/gutenberg/assets/8436925/755dac88-2f36-4df1-866f-c9aff2b82d3b)
...
- packages/base-styles/_mixins.scss (MODIFIED, +4/-0)
