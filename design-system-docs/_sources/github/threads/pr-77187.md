...
type: pull_request
state: MERGED
merged_at: 2026-04-10T16:22:41Z
url: https://github.com/WordPress/gutenberg/pull/77187
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Code Quality","[Package] UI"]
---

# PR #77187: ui/Card: Remove redundant margin reset from Card.Title

- URL: https://github.com/WordPress/gutenberg/pull/77187
- Author: ciampo
- Created: 2026-04-09T10:17:15Z
- Updated: 2026-04-10T16:24:06Z
- Comments: 4 of 4
- Review threads: 1 of 1
- Changed files: 3 of 3
- Diff: ../pr-diffs/77187.diff
...
### github-actions on 2026-04-09T11:40:33Z

URL: https://github.com/WordPress/gutenberg/pull/77187#issuecomment-4213883083
...
### github-actions on 2026-04-09T11:45:07Z

URL: https://github.com/WordPress/gutenberg/pull/77187#issuecomment-4213926051
...
| :--- | :---: | :---: |
| `build/scripts/block-editor/index.min.js` | 339 kB | -59 B (-0.02%) |
| `build/scripts/block-library/index.min.js` | 317 kB | -84 B (-0.03%) |
| `build/scripts/edit-site/index.min.js` | 262 kB | +17 B (+0.01%) |
| `build/scripts/editor/index.min.js` | 411 kB | -48 B (-0.01%) |
...
### github-actions on 2026-04-09T12:53:48Z

URL: https://github.com/WordPress/gutenberg/pull/77187#issuecomment-4214365950

<!-- flaky-tests-report-comment -->
**Flaky tests detected in deb1de3421dabdd01d77a66250520bcd37f9ce8c.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/24184969624
📝  Reported issues:
...
### ciampo on 2026-04-10T16:24:06Z

URL: https://github.com/WordPress/gutenberg/pull/77187#issuecomment-4225217681
...
Makes sense. As often, when things are "human-driven", there's a gray area that is up to interpretation. My personal preference would  be to log everything, but to do so with a better system than manually writing a CHANGELOG (and fighting through conflicts and merge queues).

More importantly, though, we should just be consistent with whatver approach we agree on

## Review threads

### Review thread 1

#### ciampo on 2026-04-09T10:20:43Z

URL: https://github.com/WordPress/gutenberg/pull/77187#discussion_r3057082685
Path: packages/ui/src/card/title.tsx
...
The forwrding of `render` and `ref` is being improved separately in https://github.com/WordPress/gutenberg/pull/77160

## Changed files

- packages/ui/CHANGELOG.md (MODIFIED, +1/-0)
- packages/ui/src/card/style.module.css (MODIFIED, +0/-4)
- packages/ui/src/card/title.tsx (MODIFIED, +1/-4)
