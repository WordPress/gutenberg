...
type: pull_request
state: MERGED
merged_at: 2021-03-08T11:25:23Z
url: https://github.com/WordPress/gutenberg/pull/29110
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Feature] UI Components","[Package] Components","Needs Accessibility Feedback"]
---

# PR #29110: Add expandOnFocus, showHowTo and validateInput experimental props to FormTokenField

- URL: https://github.com/WordPress/gutenberg/pull/29110
- Author: Aljullu
- Created: 2021-02-18T11:33:34Z
- Updated: 2021-03-08T11:25:54Z
- Comments: 4 of 4
- Review threads: 2 of 2
- Changed files: 7 of 7
- Diff: ../pr-diffs/29110.diff
...
### github-actions on 2021-02-18T11:44:18Z

URL: https://github.com/WordPress/gutenberg/pull/29110#issuecomment-781285903
...
| :--- | :---: | :---: |
| `build/components/index.js` | 272 kB | +123 B (0%) |
| `build/components/style-rtl.css` | 15.6 kB | +12 B (0%) |
...
### Aljullu on 2021-02-19T11:47:20Z

URL: https://github.com/WordPress/gutenberg/pull/29110#issuecomment-782025840

Thanks for the review @diegohaz! I updated this PR with your suggestions, so it's ready for another look.

> I noticed that the aria-expanded attribute on the input is not changing anymore when the popup opens. It's always false.

I'm unable to reproduce, it seems to work fine for me with all prop combinations I tried:

![form-token-field-expanded](https://user-images.githubusercontent.com/3616980/108500517-3097d700-72b0-11eb-9bf6-24cf910c5ef5.gif)

> I'd also add the new props as [experimental](https://github.com/WordPress/gutenberg/blob/master/docs/contributors/coding-guidelines.md#experimental-and-unstable-apis) for now so we have some space to test them and iterate.

Right! Done in 21d6bbb80b5c66f254ae2ed6e1e0d9271fcea44e.

### Aljullu on 2021-03-04T10:15:06Z

URL: https://github.com/WordPress/gutenberg/pull/29110#issuecomment-790500844

Hey @diegohaz, did you have any chance to take another look at this pull?

### Aljullu on 2021-03-08T11:25:16Z

URL: https://github.com/WordPress/gutenberg/pull/29110#issuecomment-792690000

Thanks for the review @diegohaz!

> It feels a bit weird that we don't have any visual feedback when we try to insert an invalid item. But that's not a blocker I guess.

Good point. I used the behavior of the WooCommerce attribute filter block as a base, which currently doesn't show any visual feedback when an invalid input is submitted, but I agree that it would be a good addition. I will merge this PR as-is for now and we can iterate on it in the future if needed.

## Review threads

### Review thread 1 (resolved)

#### diegohaz on 2021-02-18T16:01:23Z

URL: https://github.com/WordPress/gutenberg/pull/29110#discussion_r578539922
...
Can this be done without mutating the object? Something like this?

```suggestion
			this.setState( {
				isActive: true,
				isExpanded: !! expandOnFocus || this.state.isExpanded,
			} );
```

#### Aljullu on 2021-02-19T11:39:58Z

URL: https://github.com/WordPress/gutenberg/pull/29110#discussion_r579123649
Path: packages/components/src/form-token-field/index.js
...
Good idea, changed in 71e13ed8d0549550a993d4f6bf77aea7891808d2.

### Review thread 2 (resolved)

#### diegohaz on 2021-02-18T16:06:00Z

URL: https://github.com/WordPress/gutenberg/pull/29110#discussion_r578543484
Path: packages/components/src/form-token-field/index.js

```diff
@@ -397,14 +402,19 @@ class FormTokenField extends Component {
 	}
...
It looks like the `messages` prop is not documented. It would also be cool to have a story with `validateInput` so we can test with screen readers.

#### Aljullu on 2021-02-19T11:41:09Z

URL: https://github.com/WordPress/gutenberg/pull/29110#discussion_r579124270
Path: packages/components/src/form-token-field/index.js
...
I documented the `messages` prop in b9df95d0a4f9531a94f3903f0e23904c23bdf428 and added a knob that enables validation in 581d3e7fa339f7a386e949854b72093bc2dd7ad4.

## Changed files

- packages/components/src/combobox-control/stories/index.js (MODIFIED, +1/-1)
- packages/components/src/form-token-field/README.md (MODIFIED, +8/-0)
- packages/components/src/form-token-field/index.js (MODIFIED, +41/-13)
- packages/components/src/form-token-field/stories/index.js (MODIFIED, +30/-0)
- packages/components/src/form-token-field/style.scss (MODIFIED, +1/-1)
- packages/components/src/form-token-field/test/index.js (MODIFIED, +43/-3)
- packages/components/src/form-token-field/test/lib/token-field-wrapper.js (MODIFIED, +1/-0)
