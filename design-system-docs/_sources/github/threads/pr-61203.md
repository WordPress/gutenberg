...
type: pull_request
state: MERGED
merged_at: 2024-05-10T06:33:58Z
url: https://github.com/WordPress/gutenberg/pull/61203
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Focus] Accessibility (a11y)","[Package] Components"]
---

# PR #61203: Remove usage of aria-details from InputControl and BaseControl.

- URL: https://github.com/WordPress/gutenberg/pull/61203
- Author: afercia
- Created: 2024-04-29T14:46:52Z
- Updated: 2024-05-10T06:34:28Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 7 of 7
- Diff: ../pr-diffs/61203.diff
...
### github-actions on 2024-04-29T14:59:12Z

URL: https://github.com/WordPress/gutenberg/pull/61203#issuecomment-2082972716
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 220 kB | -33 B (0%) |
...
| `build/edit-post/style-rtl.css` | 4.06 kB |
| `build/edit-post/style.css` | 4.05 kB |
...
| `build/editor/index.min.js` | 80.3 kB |
| `build/editor/style-rtl.css` | 7.19 kB |
| `build/editor/style.css` | 7.2 kB |
...
### github-actions on 2024-04-30T07:16:35Z

URL: https://github.com/WordPress/gutenberg/pull/61203#issuecomment-2084551889
...
### afercia on 2024-05-09T12:31:33Z

URL: https://github.com/WordPress/gutenberg/pull/61203#issuecomment-2102573253

@WordPress/gutenberg-core I'd appreciate a review, when anyone of you has a chance 🙇🏽‍♂️

### afercia on 2024-05-10T06:33:19Z

URL: https://github.com/WordPress/gutenberg/pull/61203#issuecomment-2103958282

> It also seems that DevTools a11y tools have better handling for aria-describedby; previously, it did not render the aria-details value in the panel.

It didn't because `aria-details`, as explained in the issue, doesn't take part to the calculation of the accessibel description. That means browsers don't expose `aria-details` in the accessible tree as a description.
...
- packages/components/src/base-control/hooks.ts (MODIFIED, +1/-5)
- packages/components/src/base-control/test/index.tsx (MODIFIED, +3/-3)
- packages/components/src/base-control/types.ts (MODIFIED, +1/-2)
- packages/components/src/input-control/index.tsx (MODIFIED, +1/-4)
- packages/components/src/input-control/test/index.js (MODIFIED, +2/-2)
