...
type: pull_request
state: MERGED
merged_at: 2021-02-15T14:15:45Z
url: https://github.com/WordPress/gutenberg/pull/28948
matched_labels: ["[Feature] Component System"]
all_labels: ["[Feature] Component System"]
---

# PR #28948: Components: Rename ui files to match simpler scheme

- URL: https://github.com/WordPress/gutenberg/pull/28948
- Author: sarayourfriend
- Created: 2021-02-11T14:30:16Z
- Updated: 2021-02-15T14:16:10Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 25 of 25
- Diff: ../pr-diffs/28948.diff
...
## Description
Update `ui` file names to match simpler `hook`, `component` scheme.

See https://github.com/WordPress/gutenberg/pull/28887#issuecomment-777250495
...
### github-actions on 2021-02-11T14:40:40Z

URL: https://github.com/WordPress/gutenberg/pull/28948#issuecomment-777508883
...
- packages/components/src/ui/flex/styles.js (RENAMED, +0/-0)
- packages/components/src/ui/flex/use-flex-item.js (MODIFIED, +1/-1)
- packages/components/src/ui/flex/use-flex.js (MODIFIED, +1/-1)
- packages/components/src/ui/grid/component.js (RENAMED, +1/-1)
- packages/components/src/ui/grid/hook.js (RENAMED, +0/-0)
- packages/components/src/ui/grid/index.js (MODIFIED, +2/-2)
- packages/components/src/ui/grid/stories/index.js (MODIFIED, +1/-1)
- packages/components/src/ui/grid/test/grid.js (MODIFIED, +1/-1)
- packages/components/src/ui/h-stack/component.js (RENAMED, +1/-1)
- packages/components/src/ui/h-stack/hook.js (RENAMED, +1/-1)
- packages/components/src/ui/h-stack/index.js (MODIFIED, +2/-2)
- packages/components/src/ui/h-stack/utils.js (RENAMED, +0/-0)
- packages/components/src/ui/text/component.js (RENAMED, +1/-1)
- packages/components/src/ui/text/hook.js (RENAMED, +0/-0)
- packages/components/src/ui/text/index.js (MODIFIED, +2/-2)
- packages/components/src/ui/text/stories/index.js (MODIFIED, +1/-1)
- packages/components/src/ui/text/test/text.js (MODIFIED, +1/-1)
- packages/components/src/ui/truncate/component.js (RENAMED, +1/-1)
- packages/components/src/ui/truncate/hook.js (RENAMED, +0/-0)
- packages/components/src/ui/truncate/index.js (MODIFIED, +2/-2)
- packages/components/src/ui/truncate/stories/index.js (MODIFIED, +1/-1)
- packages/components/src/ui/truncate/test/truncate.js (MODIFIED, +1/-1)
- packages/components/src/ui/v-stack/component.js (RENAMED, +1/-1)
- packages/components/src/ui/v-stack/hook.js (RENAMED, +0/-0)
- packages/components/src/ui/v-stack/index.js (MODIFIED, +2/-2)
