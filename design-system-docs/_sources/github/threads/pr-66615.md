...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/66615
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #66615: Allow define RadioControl label with ReactNode component

- URL: https://github.com/WordPress/gutenberg/pull/66615
- Author: retrofox
- Created: 2024-10-30T18:17:05Z
- Updated: 2026-03-23T08:33:54Z
- Comments: 9 of 9
- Review threads: 6 of 6
- Changed files: 3 of 3
- Diff: ../pr-diffs/66615.diff
...
### github-actions on 2024-10-30T18:17:19Z

URL: https://github.com/WordPress/gutenberg/pull/66615#issuecomment-2447990344
...
### retrofox on 2024-11-27T13:20:11Z

URL: https://github.com/WordPress/gutenberg/pull/66615#issuecomment-2503863058

> Sorry for the delay!
> 
> Like I [noted](https://github.com/WordPress/gutenberg/issues/66603#issuecomment-2447586158) in the original issue, I think a requirement for this change is that we stop using a `<label>` internally and associate the input with a `aria-labelledby` instead. The usage example in this PR already renders invalid HTML (`<div>` inside a `<label>`), so we can assume other consumers would make the same mistake 😄

Never stop learning. Thanks a bunch for your :-)  feedback

### github-actions on 2024-11-27T13:45:40Z

URL: https://github.com/WordPress/gutenberg/pull/66615#issuecomment-2503919030

<!-- flaky-tests-report-comment -->
**Flaky tests detected in cbb4084015935f5cde0a121d3a28aca5ec5b9b27.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/23350889152
📝  Reported issues:
- #76524 in `/test/e2e/specs/editor/various/post-content-focus-mode.spec.js`

### tyxla on 2024-12-04T14:40:30Z

URL: https://github.com/WordPress/gutenberg/pull/66615#issuecomment-2517631154

Nothing from my end 👍

### mirka on 2024-12-04T18:44:48Z

URL: https://github.com/WordPress/gutenberg/pull/66615#issuecomment-2518260322

> Looks like all feedback so far has been addressed

The internals need to be [altered](https://github.com/WordPress/gutenberg/pull/66615#pullrequestreview-2462579828) to stop using `<label>`.

### retrofox on 2024-12-18T07:26:19Z

URL: https://github.com/WordPress/gutenberg/pull/66615#issuecomment-2550552395

> Sorry for the delay!
> 
> Like I [noted](https://github.com/WordPress/gutenberg/issues/66603#issuecomment-2447586158) in the original issue, I think a requirement for this change is that we stop using a `<label>` internally and associate the input with a `aria-labelledby` instead. 

Does it mean we need to handle the onClick event when the user clicks on the not-label element (span, div, ...)?

### mirka on 2024-12-18T19:26:43Z

URL: https://github.com/WordPress/gutenberg/pull/66615#issuecomment-2552106217
...
### github-actions on 2026-03-20T16:15:03Z

URL: https://github.com/WordPress/gutenberg/pull/66615#issuecomment-4099334720
...
### mirka on 2026-03-20T17:11:34Z

URL: https://github.com/WordPress/gutenberg/pull/66615#issuecomment-4099664786

This will be better addressed with the new `Radio` primitives (#74178).

## Review threads

### Review thread 1 (resolved)

#### mirka on 2024-11-26T20:11:16Z

URL: https://github.com/WordPress/gutenberg/pull/66615#discussion_r1859166105
...
Removing `string` as it's included in `ReactNode`. Also adding accessibility guidance.
...
#### mirka on 2024-11-26T20:12:14Z

URL: https://github.com/WordPress/gutenberg/pull/66615#discussion_r1859167824
...
#### mirka on 2024-11-26T20:12:26Z

URL: https://github.com/WordPress/gutenberg/pull/66615#discussion_r1859168022
Path: packages/components/src/radio-control/types.ts
...
#### mirka on 2024-11-26T20:16:57Z

URL: https://github.com/WordPress/gutenberg/pull/66615#discussion_r1859172475
Path: packages/components/src/radio-control/stories/index.story.tsx

```diff
@@ -91,3 +92,55 @@ WithOptionDescriptions.args = {
 		},
 	],
 };
+
...
I would suggest these changes for simplicity:

- Use an icon from the library.
- Add a description for accessibility guidance.
- Use the standard `aria-label` prop.
- Remove the `title` (it's not what we want to highlight here, and we usually use Tooltip for these things).
- Decrease the number of options to the minimum viable number to demonstrate the point.

```diff
diff --git a/packages/components/src/radio-control/stories/index.story.tsx b/packages/components/src/radio-control/stories/index.story.tsx
index 3b3efbe952..108a58b12f 100644
--- a/packages/components/src/radio-control/stories/index.story.tsx
+++ b/packages/components/src/radio-control/stories/index.story.tsx
@@ -7,12 +7,13 @@ import type { Meta, StoryFn } from '@storybook/react';
...
@@ -93,27 +94,20 @@ WithOptionDescriptions.args = {
 	],
 };
...
@@ -123,23 +117,15 @@ WithComponentLabels.args = {
 	label: 'Rating',
 	options: [
 		{
...
#### retrofox on 2024-11-27T17:14:50Z

URL: https://github.com/WordPress/gutenberg/pull/66615#discussion_r1861019667
Path: packages/components/src/radio-control/stories/index.story.tsx
...
addressed here b9a85c08d4f79b42b999104658b9396af05428fd

<img width="386" alt="image" src="https://github.com/user-attachments/assets/9d20e653-76b9-4ca7-91ef-186f02a258d6">

### Review thread 5

#### tyxla on 2024-11-27T11:16:54Z

URL: https://github.com/WordPress/gutenberg/pull/66615#discussion_r1860479646
Path: packages/components/src/radio-control/types.ts
...
#### retrofox on 2024-11-27T17:16:58Z

URL: https://github.com/WordPress/gutenberg/pull/66615#discussion_r1861022077
Path: packages/components/src/radio-control/types.ts
...
#### retrofox on 2024-11-27T17:21:01Z

URL: https://github.com/WordPress/gutenberg/pull/66615#discussion_r1861027019
Path: packages/components/src/radio-control/types.ts
...
[c6b9c9e](https://github.com/WordPress/gutenberg/pull/66615/commits/c6b9c9e6f3ea978180b8805e0bc3c88638683aaa)

#### mirka on 2024-11-27T22:55:18Z

URL: https://github.com/WordPress/gutenberg/pull/66615#discussion_r1861323374
Path: packages/components/src/radio-control/types.ts
...
#### tyxla on 2024-11-28T10:36:01Z

URL: https://github.com/WordPress/gutenberg/pull/66615#discussion_r1861941893
Path: packages/components/src/radio-control/types.ts
...
#### ciampo on 2024-12-04T10:46:14Z

URL: https://github.com/WordPress/gutenberg/pull/66615#discussion_r1869197903
Path: packages/components/src/radio-control/README.md
...
#### ciampo on 2024-12-11T06:57:37Z

URL: https://github.com/WordPress/gutenberg/pull/66615#discussion_r1879446788
Path: packages/components/src/radio-control/README.md
...
Based on https://github.com/WordPress/gutenberg/pull/66615#discussion_r1861323374, it looks like we may want to revert to `ReactNode`. In that case, feel free to ignore my suggestion above, and instead let's change the TypeScript type back to `ReactNode`.

## Changed files

- packages/components/src/radio-control/README.md (MODIFIED, +2/-1)
- packages/components/src/radio-control/stories/index.story.tsx (MODIFIED, +40/-0)
- packages/components/src/radio-control/types.ts (MODIFIED, +4/-2)
