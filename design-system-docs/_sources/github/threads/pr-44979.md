...
type: pull_request
state: MERGED
merged_at: 2022-10-17T13:29:44Z
url: https://github.com/WordPress/gutenberg/pull/44979
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components","Storybook"]
---

# PR #44979: Navigator: refactor Storybook code to TypeScript and controls

- URL: https://github.com/WordPress/gutenberg/pull/44979
- Author: ciampo
- Created: 2022-10-14T12:51:58Z
- Updated: 2022-10-17T13:30:13Z
- Comments: 1 of 1
- Review threads: 2 of 2
- Changed files: 13 of 13
- Diff: ../pr-diffs/44979.diff
...
### github-actions on 2022-10-14T13:11:20Z

URL: https://github.com/WordPress/gutenberg/pull/44979#issuecomment-1278991155
...
#### ciampo on 2022-10-14T13:03:25Z

URL: https://github.com/WordPress/gutenberg/pull/44979#discussion_r995736950
Path: packages/components/src/navigator/stories/index.tsx
...
I disabled the control for `initialPath` because changing it doesn't make any difference (it's only used on the component's first render)

### Review thread 2

#### ciampo on 2022-10-14T14:09:42Z

URL: https://github.com/WordPress/gutenberg/pull/44979#discussion_r995804871
...
- packages/components/src/navigator/index.ts (MODIFIED, +4/-4)
- packages/components/src/navigator/navigator-back-button/component.tsx (MODIFIED, +4/-4)
- packages/components/src/navigator/navigator-back-button/index.ts (MODIFIED, +1/-1)
- packages/components/src/navigator/navigator-button/component.tsx (MODIFIED, +4/-4)
- packages/components/src/navigator/navigator-button/index.ts (MODIFIED, +1/-1)
- packages/components/src/navigator/navigator-provider/component.tsx (MODIFIED, +4/-4)
- packages/components/src/navigator/navigator-provider/index.ts (MODIFIED, +1/-1)
- packages/components/src/navigator/navigator-screen/component.tsx (MODIFIED, +7/-4)
- packages/components/src/navigator/navigator-screen/index.ts (MODIFIED, +1/-1)
- packages/components/src/navigator/stories/index.js (DELETED, +0/-194)
- packages/components/src/navigator/stories/index.tsx (ADDED, +210/-0)
- packages/components/src/navigator/types.ts (MODIFIED, +1/-0)
