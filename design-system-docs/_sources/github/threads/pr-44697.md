...
type: pull_request
state: MERGED
merged_at: 2022-10-05T09:52:51Z
url: https://github.com/WordPress/gutenberg/pull/44697
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #44697: Components: Refactor `withState` to `@testing-library/react`

- URL: https://github.com/WordPress/gutenberg/pull/44697
- Author: tyxla
- Created: 2022-10-05T08:46:59Z
- Updated: 2022-10-05T09:53:53Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 1 of 1
- Diff: ../pr-diffs/44697.diff

## Body

## What?
This PR refactors the tests of `withState` to use `@testing-library/react`'s render instead of `react-dom` render. This addresses one of the changes needed to upgrade to React 18, as touched in #32765.
...
Verify tests still pass: `npm run test:unit packages/compose/src/higher-order/with-state/test/index.js`

## Issue comments

### github-actions on 2022-10-05T08:55:11Z

URL: https://github.com/WordPress/gutenberg/pull/44697#issuecomment-1268146578
...
- packages/compose/src/higher-order/with-state/test/index.js (MODIFIED, +13/-26)
