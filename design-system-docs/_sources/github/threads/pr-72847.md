...
type: pull_request
state: MERGED
merged_at: 2025-11-03T08:46:49Z
url: https://github.com/WordPress/gutenberg/pull/72847
matched_labels: ["[Package] Theme"]
all_labels: ["[Type] Performance","[Package] Theme"]
---

# PR #72847: Theme: Generate default ramps at compile time

- URL: https://github.com/WordPress/gutenberg/pull/72847
- Author: aduth
- Created: 2025-10-30T18:27:16Z
- Updated: 2025-11-03T14:58:31Z
- Comments: 2 of 2
- Review threads: 3 of 3
- Changed files: 11 of 11
- Diff: ../pr-diffs/72847.diff
...
- Adds type-checking to `packages/theme/bin`
   - To support this, revisions were made to the tsconfig validator to consider references in any file matching `tsconfig*.json` in a package
- Allow direct execution of `.ts` files in Node.js using [`esbuild-esm-loader`](https://www.npmjs.com/package/esbuild-esm-loader). This should be a temporary solution until we migrate to a version of Node.js supporting [native type-stripping](https://nodejs.org/en/learn/typescript/run-natively) ([see related discussion](https://github.com/WordPress/gutenberg/pull/71091#issuecomment-3462773907)), and is intended to integrate with our existing ESBuild toolchain.
...
### github-actions on 2025-10-30T18:39:39Z

URL: https://github.com/WordPress/gutenberg/pull/72847#issuecomment-3469534837
...
### github-actions on 2025-10-30T19:01:16Z

URL: https://github.com/WordPress/gutenberg/pull/72847#issuecomment-3469630331
...
| :--- | :---: | :---: |
| `build/scripts/theme/index.min.js` | 28.5 kB | -22 B (-0.08%) |
...
#### aduth on 2025-10-30T18:33:17Z

URL: https://github.com/WordPress/gutenberg/pull/72847#discussion_r2479134887
Path: bin/validate-tsconfig.mjs
...
tsconfig files are JSONC files, so we may as well use a JSONC parser than trying to transform the string into something we can shove into `JSON.parse`. This is the library that TypeScript itself maintains and [uses internally](https://github.com/microsoft/TypeScript/blob/6fd2874d0dc24aeca92887bdadf6a63429ce1f1b/scripts/build/utils.mjs#L5).

### Review thread 2

#### aduth on 2025-10-30T18:34:51Z

URL: https://github.com/WordPress/gutenberg/pull/72847#discussion_r2479140529
Path: package.json
...
This is a [package](https://www.npmjs.com/package/esbuild-esm-loader) that I maintain and have used in a number of other projects. It itself is pretty light-weight and delegates most of the underlying work to [Node's module customization hooks](https://nodejs.org/docs/latest/api/module.html#customization-hooks) and ESBuild.

#### youknowriad on 2025-10-30T21:30:26Z

URL: https://github.com/WordPress/gutenberg/pull/72847#discussion_r2479580862
Path: package.json
...
#### aduth on 2025-10-31T00:31:35Z

URL: https://github.com/WordPress/gutenberg/pull/72847#discussion_r2479862729
Path: package.json
...
#### youknowriad on 2025-10-31T11:56:27Z

URL: https://github.com/WordPress/gutenberg/pull/72847#discussion_r2481177063
Path: package.json
...
#### aduth on 2025-10-31T12:59:21Z

URL: https://github.com/WordPress/gutenberg/pull/72847#discussion_r2481336827
Path: package.json
...
#### aduth on 2025-10-31T13:00:50Z

URL: https://github.com/WordPress/gutenberg/pull/72847#discussion_r2481340336
Path: package.json
...
#### aduth on 2025-10-31T13:02:44Z

URL: https://github.com/WordPress/gutenberg/pull/72847#discussion_r2481344679
Path: package.json
...
Updated in d02d9e072e (allow devDependencies) and 72ad4d18e6 (shift to package devDependency).

### Review thread 3

#### jsnajdr on 2025-11-03T08:45:43Z

URL: https://github.com/WordPress/gutenberg/pull/72847#discussion_r2485701020
Path: packages/theme/src/color-ramps/lib/default-ramps.ts
...
#### aduth on 2025-11-03T14:55:32Z

URL: https://github.com/WordPress/gutenberg/pull/72847#discussion_r2486772737
Path: packages/theme/src/color-ramps/lib/default-ramps.ts
...
#### aduth on 2025-11-03T14:58:31Z

URL: https://github.com/WordPress/gutenberg/pull/72847#discussion_r2486782648
Path: packages/theme/src/color-ramps/lib/default-ramps.ts
...
- .npmpackagejsonlintrc.json (MODIFIED, +2/-5)
- bin/validate-tsconfig.mjs (MODIFIED, +8/-19)
- package-lock.json (MODIFIED, +41/-29)
- package.json (MODIFIED, +1/-1)
- packages/theme/bin/build-tokens.js (DELETED, +0/-83)
- packages/theme/bin/generate-default-ramps/index.ts (ADDED, +46/-0)
- packages/theme/package.json (MODIFIED, +7/-1)
- packages/theme/src/color-ramps/lib/default-ramps.ts (ADDED, +173/-0)
- packages/theme/tsconfig.bin.json (ADDED, +13/-0)
- packages/theme/tsconfig.json (MODIFIED, +5/-6)
- packages/theme/tsconfig.src.json (ADDED, +9/-0)
