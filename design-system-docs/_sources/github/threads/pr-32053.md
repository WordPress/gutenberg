...
type: pull_request
state: MERGED
merged_at: 2021-05-21T10:34:05Z
url: https://github.com/WordPress/gutenberg/pull/32053
matched_labels: ["[Package] Components","[Feature] Component System"]
all_labels: ["[Feature] UI Components","[Type] Code Quality","[Package] Components","[Feature] Component System"]
---

# PR #32053: Components: Rename `ViewOwnProps` to `PolymorphicComponentProps`

- URL: https://github.com/WordPress/gutenberg/pull/32053
- Author: ciampo
- Created: 2021-05-20T15:29:12Z
- Updated: 2021-05-21T10:34:24Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 39 of 39
- Diff: ../pr-diffs/32053.diff
...
Rename `ViewOwnProps` `type` to `PolymorphicComponentProps` to better reflect its meaning and usage
...
- [ ] Project and `@wordpress/components` package build correctly and all tests pass
...
### github-actions on 2021-05-20T18:39:48Z

URL: https://github.com/WordPress/gutenberg/pull/32053#issuecomment-845370553
...
- packages/components/src/heading/hook.ts (MODIFIED, +4/-2)
- packages/components/src/spacer/hook.ts (MODIFIED, +4/-2)
...
- packages/components/src/ui/context/context-connect.js (MODIFIED, +2/-2)
- packages/components/src/ui/context/polymorphic-component.ts (MODIFIED, +9/-12)
...
- packages/components/src/ui/elevation/hook.js (MODIFIED, +1/-1)
...
- packages/components/src/ui/popover/component.js (MODIFIED, +2/-2)
- packages/components/src/ui/popover/content.js (MODIFIED, +1/-1)
- packages/components/src/ui/scrollable/hook.js (MODIFIED, +1/-1)
- packages/components/src/ui/shortcut/component.tsx (MODIFIED, +2/-2)
- packages/components/src/ui/spinner/component.js (MODIFIED, +1/-1)
- packages/components/src/ui/surface/hook.js (MODIFIED, +1/-1)
- packages/components/src/ui/tooltip/component.js (MODIFIED, +1/-1)
- packages/components/src/ui/tooltip/content.js (MODIFIED, +1/-1)
- packages/components/src/ui/utils/create-component.tsx (MODIFIED, +10/-7)
