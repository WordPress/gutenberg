...
url: https://github.com/WordPress/gutenberg/pull/54931
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #54931: Reverting addition of `aria-selected` style hook in `Button`

- URL: https://github.com/WordPress/gutenberg/pull/54931
- Author: andrewhayward
- Created: 2023-09-29T10:08:57Z
- Updated: 2023-09-29T11:32:40Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/54931.diff
...
### github-actions on 2023-09-29T10:20:57Z

URL: https://github.com/WordPress/gutenberg/pull/54931#issuecomment-1740656865
...
| :--- | :---: | :---: |
| `build/components/style-rtl.css` | 11.8 kB | -13 B (0%) |
| `build/components/style.css` | 11.8 kB | -12 B (0%) |
...
### andrewhayward on 2023-09-29T10:57:45Z

URL: https://github.com/WordPress/gutenberg/pull/54931#issuecomment-1740704939

> On the long term, I wonder if a better fix would be to override styles specifically in the `TabPanel` component, instead of removing them from `Button`

Agreed that longer term more default consistency between `aria-pressed`, `aria-selected` and `aria-checked` on `Button` is probably warranted. But we should probably review how `Button` is used first, which I neglected to do in #54903, so the safest thing seemed to be to revert this change for the moment.
...
- packages/components/src/button/style.scss (MODIFIED, +1/-2)
