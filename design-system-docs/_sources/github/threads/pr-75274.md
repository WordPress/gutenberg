...
type: pull_request
state: MERGED
merged_at: 2026-02-09T07:18:16Z
url: https://github.com/WordPress/gutenberg/pull/75274
...
# PR #75274: Slot: fix ref forwarding

- URL: https://github.com/WordPress/gutenberg/pull/75274
- Author: talldan
- Created: 2026-02-06T08:06:29Z
- Updated: 2026-02-09T07:19:02Z
- Comments: 5 of 5
- Review threads: 4 of 4
- Changed files: 3 of 3
- Diff: ../pr-diffs/75274.diff
...
### github-actions on 2026-02-06T08:15:31Z

URL: https://github.com/WordPress/gutenberg/pull/75274#issuecomment-3858726300
...
### github-actions on 2026-02-06T08:27:21Z

URL: https://github.com/WordPress/gutenberg/pull/75274#issuecomment-3858778526
...
| `build/scripts/sync/index.min.js` | 42.2 kB |
...
| `build/styles/block-library/playlist/style-rtl.css` | 819 B |
| `build/styles/block-library/playlist/style-rtl.min.css` | 436 B |
| `build/styles/block-library/playlist/style.css` | 820 B |
| `build/styles/block-library/playlist/style.min.css` | 436 B |
...
| `build/styles/edit-site/style-rtl.css` | 19.8 kB |
...
### Mamaduka on 2026-02-06T08:48:24Z

URL: https://github.com/WordPress/gutenberg/pull/75274#issuecomment-3858858039

Can't wait for React 19 update, so we don't have to do all this dance with forwarding refs.

cc @jsnajdr, who's the resident expert for all SlotFill related :)

### talldan on 2026-02-06T09:17:48Z

URL: https://github.com/WordPress/gutenberg/pull/75274#issuecomment-3858992939

I've updated the PR description, I think I had some aspects wrong about `bubblesVirtually`, that's actually the situation where the ref should be forwarded, not the other way around.

The non-bubblesVirtually slot doesn't support refs from what I can tell.

### ciampo on 2026-02-06T09:54:19Z

URL: https://github.com/WordPress/gutenberg/pull/75274#issuecomment-3859236240

> Can't wait for React 19 update, so we don't have to do all this dance with forwarding refs.
> 
> cc @jsnajdr, who's the resident expert for all SlotFill related :)

And the react 19 update expert too 🥳

## Review threads

### Review thread 1 (resolved)

#### jsnajdr on 2026-02-06T10:02:21Z

URL: https://github.com/WordPress/gutenberg/pull/75274#discussion_r2773292910
Path: packages/components/src/slot-fill/test/index.js

```diff
@@ -82,4 +87,54 @@ describe( 'createSlotFill', () => {
...
I think this test is redundant. We're doing standard ref forwarding with standard React API, our code doesn't really touch the ref at all. Testing a callback ref explicitly means that we're testing React callback ref support, not our own Gutenberg code.

### Review thread 2

#### jsnajdr on 2026-02-06T10:05:31Z

URL: https://github.com/WordPress/gutenberg/pull/75274#discussion_r2773307101
Path: packages/components/src/slot-fill/test/index.js
...
Yes, the `bubblesVirtually` slot renders a `<div>` which is a container for a portal, and the ref will point to this `div` element. On the other hand, the "base" slot doesn't render any element on its own, it's a fragment with the fills.

### Review thread 3

#### jsnajdr on 2026-02-06T10:20:01Z

URL: https://github.com/WordPress/gutenberg/pull/75274#discussion_r2773372297
...
This is an ugly and verbose type cast, just to make the `__unstableName` field legal, but I wasn't able to avoid it when I tried.

### Review thread 4 (resolved)

#### jsnajdr on 2026-02-06T10:21:06Z

URL: https://github.com/WordPress/gutenberg/pull/75274#discussion_r2773377011
...
We always have a dot at the end of the entry in this changelog 🙂
