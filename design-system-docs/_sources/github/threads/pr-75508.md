...
type: pull_request
state: MERGED
merged_at: 2026-02-13T19:31:16Z
url: https://github.com/WordPress/gutenberg/pull/75508
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Element","[Package] Components","[Package] Editor","[Package] React i18n","[Package] DataViews","[Package] Fields"]
---

# PR #75508: Prefix usages of JSX namespaces with React.JSX

- URL: https://github.com/WordPress/gutenberg/pull/75508
- Author: jsnajdr
- Created: 2026-02-13T12:21:48Z
- Updated: 2026-02-13T19:31:58Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 43 of 43
- Diff: ../pr-diffs/75508.diff
...
### github-actions on 2026-02-13T12:34:03Z

URL: https://github.com/WordPress/gutenberg/pull/75508#issuecomment-3896973732
...
| `build/scripts/core-commands/index.min.js` | 4.29 kB |
...
| `build/scripts/editor/index.min.js` | 344 kB |
...
### github-actions on 2026-02-13T13:04:23Z

URL: https://github.com/WordPress/gutenberg/pull/75508#issuecomment-3897144410
...
### jsnajdr on 2026-02-13T14:56:56Z

URL: https://github.com/WordPress/gutenberg/pull/75508#issuecomment-3897657933

> And one I'm not really sure what to make of:

This one is using `preact`, which has its own `JSX` usage conventions. Everything in `packages/interactivity` uses `preact` and is OK type-wise.

I'll update the other usages. For some reason I searched and updated only `JSX.Element` usages and missed the other ones 🙁

### jsnajdr on 2026-02-13T19:25:10Z

URL: https://github.com/WordPress/gutenberg/pull/75508#issuecomment-3898977469

> Do these need to be updated?

All the `JSX.IntrinsicElements` usage are now updated, too :+1:
...
- packages/boot/src/components/navigation/items.tsx (MODIFIED, +1/-1)
...
- packages/components/src/autocomplete/index.tsx (MODIFIED, +1/-1)
...
- packages/components/src/draggable/types.ts (MODIFIED, +1/-1)
...
- packages/components/src/modal/types.ts (MODIFIED, +1/-1)
- packages/components/src/navigation/README.md (MODIFIED, +1/-1)
- packages/components/src/navigation/types.ts (MODIFIED, +1/-1)
...
- packages/editor/src/components/style-book/color-examples.tsx (MODIFIED, +1/-1)
- packages/editor/src/components/style-book/duotone-examples.tsx (MODIFIED, +1/-5)
- packages/editor/src/components/style-book/types.ts (MODIFIED, +1/-1)
- packages/element/README.md (MODIFIED, +1/-1)
- packages/element/src/raw-html.ts (MODIFIED, +1/-4)
- packages/fields/src/actions/duplicate-post.tsx (MODIFIED, +1/-1)
- packages/fields/src/actions/reorder-page.tsx (MODIFIED, +1/-1)
- packages/global-styles-ui/src/font-library/google-fonts-confirm-dialog.tsx (MODIFIED, +1/-1)
- packages/media-fields/src/types.ts (MODIFIED, +1/-1)
- packages/react-i18n/README.md (MODIFIED, +1/-1)
- packages/react-i18n/src/index.tsx (MODIFIED, +1/-1)
