...
type: pull_request
state: MERGED
merged_at: 2026-04-22T15:56:51Z
url: https://github.com/WordPress/gutenberg/pull/77460
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #77460: components: Menu popover render + surface/motion split

- URL: https://github.com/WordPress/gutenberg/pull/77460
- Author: ciampo
- Created: 2026-04-17T15:01:27Z
- Updated: 2026-04-22T15:58:00Z
- Comments: 5 of 5
- Review threads: 0 of 0
- Changed files: 3 of 3
- Diff: ../pr-diffs/77460.diff
...
Continues the same changes as [#77450](https://github.com/WordPress/gutenberg/pull/77450), with the head branch on **`WordPress/gutenberg`** instead of a fork (GitHub does not support retargeting an existing PR from a fork to the upstream repo).
...
### github-actions on 2026-04-17T15:14:51Z

URL: https://github.com/WordPress/gutenberg/pull/77460#issuecomment-4269206056
...
| :--- | :---: | :---: |
| `build/scripts/components/index.min.js` | 265 kB | +125 B (+0.05%) |
...
### github-actions on 2026-04-17T15:32:56Z

URL: https://github.com/WordPress/gutenberg/pull/77460#issuecomment-4269328960

<!-- flaky-tests-report-comment -->
**Flaky tests detected in ce86bb59effea4dff6380b04907f162e94060960.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/24571891937
📝  Reported issues:
...
### github-actions on 2026-04-17T16:48:57Z

URL: https://github.com/WordPress/gutenberg/pull/77460#issuecomment-4269786073
...
### mirka on 2026-04-22T15:28:11Z

URL: https://github.com/WordPress/gutenberg/pull/77460#issuecomment-4297553134

Are you framing this as a temporary local patch for the upstream bug? The PR description is a bit contradictory on this point ("keeping the same motion behavior as `trunk`" vs "no exit animation") so I can't tell whether the trade off was intentional, but as far as I can tell we are in fact losing the exit animation for this fix.

I guess it's fine if it's meant as a quick temporary patch, But I also wonder if it's better to wait for the upstream fix or just prepare the new Base UI `Menu` for `@wordpress/ui` to replace the old `Menu` (which is still private).

### ciampo on 2026-04-22T15:34:20Z

URL: https://github.com/WordPress/gutenberg/pull/77460#issuecomment-4297605546

I'm suggesting this fix as the best compromise for the time being — the visual difference is limited, and the fix is real and needed in Dataviews if we want to start using the new `Dialog`.

If the issue is fixed upstream, we'll be able to remove the workaround. As we update to the `@wordpress/ui` `Menu`, we will also eventually be able to fully remove the ariakit-based `Menu`, since it's a private API.
