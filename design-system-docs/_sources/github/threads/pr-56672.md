...
type: pull_request
state: MERGED
merged_at: 2023-11-30T20:42:03Z
url: https://github.com/WordPress/gutenberg/pull/56672
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #56672: FormToggle: do not use "/" math operator

- URL: https://github.com/WordPress/gutenberg/pull/56672
- Author: ciampo
- Created: 2023-11-30T09:31:39Z
- Updated: 2023-11-30T22:17:22Z
- Comments: 6 of 6
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/56672.diff
...
Refactor `FormToggle`'s styles away from using the `/` math operator

## Why?
<!-- Why is this PR necessary? What problem is it solving? Reference any existing previous issue(s) or PR(s), but please add a short summary here, too -->

As flagged in https://github.com/WordPress/gutenberg/pull/56515#discussion_r1410184116, the `/` operator is deprecated in Sass

## How?
<!-- How is your PR addressing the issue at hand? What are the implementation details? -->

Using the `math` module and the `math.div` operator (as suggested [here](https://github.com/WordPress/gutenberg/pull/56515#discussion_r1410396390))
...
- Make sure that `FormToggle` renders correctly in Windows High Contrast Mode
- Make sure that there are no deprecation warnings when building the plugin locally (as mentioned by @andrewserong [here](https://github.com/WordPress/gutenberg/pull/56515#discussion_r1410184116))

## Issue comments

### ciampo on 2023-11-30T09:32:41Z

URL: https://github.com/WordPress/gutenberg/pull/56672#issuecomment-1833399858

Probably there's no need for a CHANGELOG entry, if this is part of the same Gutenberg release.

### ciampo on 2023-11-30T09:39:39Z

URL: https://github.com/WordPress/gutenberg/pull/56672#issuecomment-1833410811

Yup, Andrew suggested a cleaner solution — just updated the PR to implement his suggestion

### github-actions on 2023-11-30T09:45:00Z

URL: https://github.com/WordPress/gutenberg/pull/56672#issuecomment-1833419021
...
### github-actions on 2023-11-30T10:01:15Z

URL: https://github.com/WordPress/gutenberg/pull/56672#issuecomment-1833444077

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 9cc302f77395d69c249331ee1ba8019e790b13c7.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/7044611846
📝  Reported issues:
- #53524 in `/test/e2e/specs/editor/various/multi-block-selection.spec.js`

### andrewhayward on 2023-11-30T10:07:24Z

URL: https://github.com/WordPress/gutenberg/pull/56672#issuecomment-1833454975

> ...I'll defer to him if he prefers another path forward.

I'm not overly concerned which approach we use, but going the recommended route is probably better for future-proofing.
...
```
-   `FormToggle`: refine animation and improve high contrast styles
    ([#56515](https://github.com/WordPress/gutenberg/pull/56515))
    ([#56672](https://github.com/WordPress/gutenberg/pull/56672)).
```

### andrewserong on 2023-11-30T22:17:21Z

URL: https://github.com/WordPress/gutenberg/pull/56672#issuecomment-1834649128
...
- packages/components/src/form-toggle/style.scss (MODIFIED, +4/-2)
