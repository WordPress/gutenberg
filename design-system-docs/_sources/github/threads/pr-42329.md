...
type: pull_request
state: MERGED
merged_at: 2022-07-12T11:07:42Z
url: https://github.com/WordPress/gutenberg/pull/42329
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Regression","[Package] Components"]
---

# PR #42329: [Components - Popover]: Fix regression of inbetween inserter in site editor

- URL: https://github.com/WordPress/gutenberg/pull/42329
- Author: ntsekouras
- Created: 2022-07-11T13:38:58Z
- Updated: 2022-07-12T11:08:09Z
- Comments: 4 of 4
- Review threads: 1 of 1
- Changed files: 3 of 3
- Diff: ../pr-diffs/42329.diff
...
### github-actions on 2022-07-11T13:46:58Z

URL: https://github.com/WordPress/gutenberg/pull/42329#issuecomment-1180431403
...
### talldan on 2022-07-12T07:34:30Z

URL: https://github.com/WordPress/gutenberg/pull/42329#issuecomment-1181420255

I'm possibly seeing a bit of a performance drop in drag and drop after checking out this PR. I tested in the demo post (http://localhost:8888/wp-admin/post-new.php?gutenberg-demo), dragging a paragraph. Dragging to particular areas in the post seems to cause a lot of lag and glitchiness, like some code is triggering repetitively. It doesn't seem perfect in `trunk` but a bit better.

I tested using Brave browser on Mac OS. Anyone else seeing the same?

### ciampo on 2022-07-12T09:02:02Z

URL: https://github.com/WordPress/gutenberg/pull/42329#issuecomment-1181508732

> I'm possibly seeing a bit of a performance drop in drag and drop after checking out this PR ... I tested using Brave browser on Mac OS. Anyone else seeing the same?

I gave it a look too but honestly I can't really tell with the naked eye.

---

More in general I'm good with this PR being merged, but I'm also going to play devil's advocate:

given how `getAnchorRect` was supposed to be used (also explained in the docs), should we have focused our efforts on fixing the problem from the Site Editor's side?

> I think the early return in the old implementation was because the computation was happening inside a `useLayoutEffect` with different dependencies and order
...
### ntsekouras on 2022-07-12T11:07:33Z

URL: https://github.com/WordPress/gutenberg/pull/42329#issuecomment-1181625876

>This is good to know, but unfortunately it wasn't documented anywhere. Relying on tightly-couple logic and ad-hoc exceptions across packages will not serve us well in the long term, and we're already paying the price with the numerous regressions that the Popover refactor surfaced.

I agree with that and I'm too investing time to fully understand how to make everything work as it should be without 'hacks' or stop gap solutions - still not there yet 😄 . Having said that, the specific PR just removes the extra check that some `getAnchorRect` don't even use, fixes the inbetween inserter issues and I also didn't notice something performance wise(without metrics though).

I'm going to merge this and keep on studying the issues we have and all the current implementation to help make the correct adjustments where needed.

## Review threads

### Review thread 1 (resolved)

#### aaronrobertshaw on 2022-07-12T02:15:47Z

URL: https://github.com/WordPress/gutenberg/pull/42329#discussion_r918487944
