...
type: pull_request
state: MERGED
merged_at: 2021-02-05T19:38:25Z
url: https://github.com/WordPress/gutenberg/pull/28707
matched_labels: ["[Package] Components","[Feature] Component System"]
all_labels: ["[Package] Components","[Feature] Component System"]
---

# PR #28707: Components: Add HStack

- URL: https://github.com/WordPress/gutenberg/pull/28707
- Author: sarayourfriend
- Created: 2021-02-03T20:31:19Z
- Updated: 2021-02-11T22:19:13Z
- Comments: 2 of 2
- Review threads: 2 of 2
- Changed files: 13 of 13
- Diff: ../pr-diffs/28707.diff
...
### github-actions on 2021-02-03T22:29:41Z

URL: https://github.com/WordPress/gutenberg/pull/28707#issuecomment-772870761
...
| :--- | :---: | :---: |
| `build/block-editor/index.js` | 124 kB | +97 B (0%) |
| `build/block-editor/style-rtl.css` | 12 kB | -16 B (0%) |
...
| `build/block-library/editor-rtl.css` | 9.06 kB | +1 B (0%) |
| `build/block-library/editor.css` | 9.05 kB | +1 B (0%) |
| `build/block-library/index.js` | 144 kB | +640 B (0%) |
...
| `build/components/index.js` | 270 kB | +15 B (0%) |
| `build/edit-site/index.js` | 24.3 kB | +36 B (0%) |
| `build/i18n/index.js` | 3.73 kB | -12 B (0%) |
...
### ItsJonQ on 2021-02-04T18:49:38Z

URL: https://github.com/WordPress/gutenberg/pull/28707#issuecomment-773527874

Since this updates `@wp-g2` to the latest versions, it will include the `SelectDropdown` fix for `FontSizePicker` (https://github.com/WordPress/gutenberg/pull/28408).

We still need to resolve the E2E font reset issue. Will try to look into that now

## Review threads

### Review thread 1

#### gziolo on 2021-02-05T19:47:01Z

URL: https://github.com/WordPress/gutenberg/pull/28707#discussion_r571210290
...
#### sarayourfriend on 2021-02-08T14:50:02Z

URL: https://github.com/WordPress/gutenberg/pull/28707#discussion_r572105933
Path: packages/e2e-tests/specs/editor/various/font-size-picker.test.js
...
#### gziolo on 2021-02-08T17:05:26Z

URL: https://github.com/WordPress/gutenberg/pull/28707#discussion_r572213596
Path: packages/e2e-tests/specs/editor/various/font-size-picker.test.js
...
#### sarayourfriend on 2021-02-08T17:16:29Z

URL: https://github.com/WordPress/gutenberg/pull/28707#discussion_r572222561
Path: packages/e2e-tests/specs/editor/various/font-size-picker.test.js
...
#### gziolo on 2021-02-05T19:47:44Z

URL: https://github.com/WordPress/gutenberg/pull/28707#discussion_r571210745
Path: packages/e2e-tests/specs/editor/various/font-size-picker.test.js
...
#### sarayourfriend on 2021-02-08T14:49:27Z

URL: https://github.com/WordPress/gutenberg/pull/28707#discussion_r572105440
Path: packages/e2e-tests/specs/editor/various/font-size-picker.test.js
...
- package-lock.json (MODIFIED, +135/-184)
- packages/components/package.json (MODIFIED, +4/-4)
- packages/components/src/ui/flex/types.ts (MODIFIED, +1/-1)
- packages/components/src/ui/h-stack/README.md (ADDED, +127/-0)
- packages/components/src/ui/h-stack/h-stack-utils.js (ADDED, +56/-0)
- packages/components/src/ui/h-stack/h-stack.js (ADDED, +11/-0)
- packages/components/src/ui/h-stack/index.js (ADDED, +2/-0)
- packages/components/src/ui/h-stack/stories/HStack.stories.js (ADDED, +22/-0)
- packages/components/src/ui/h-stack/test/__snapshots__/index.js.snap (ADDED, +295/-0)
- packages/components/src/ui/h-stack/test/index.js (ADDED, +42/-0)
- packages/components/src/ui/h-stack/types.ts (ADDED, +123/-0)
- packages/components/src/ui/h-stack/use-h-stack.js (ADDED, +79/-0)
- packages/e2e-tests/specs/editor/various/font-size-picker.test.js (MODIFIED, +10/-0)
