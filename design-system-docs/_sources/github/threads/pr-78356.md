...
type: pull_request
state: MERGED
merged_at: 2026-05-15T17:30:54Z
url: https://github.com/WordPress/gutenberg/pull/78356
matched_labels: ["[Package] Components","[Package] UI"]
all_labels: ["[Type] Developer Documentation","[Package] Components","[Package] UI"]
---

# PR #78356: [ui] Trim verbose comments and prose around the compat overlay slot

- URL: https://github.com/WordPress/gutenberg/pull/78356
- Author: ciampo
- Created: 2026-05-15T16:15:08Z
- Updated: 2026-05-15T17:31:38Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 16 of 16
- Diff: ../pr-diffs/78356.diff

## Body

## What

Trims the JSDoc, inline comments, README, and CHANGELOG copy added by #77851, #78095, and #78183 around the `@wordpress/ui` compat overlay slot.
...
- **Public API docs** (exported JSDoc, README, CHANGELOG) keep the *what / when / two opt-in paths* guidance.
- **Internal comments** keep only the non-obvious choices (e.g. why `position: fixed` is load-bearing, physical-not-logical CSS, the `typeof null === 'object'` guard).
- **Tests** drop restatements of what the test name and assertions already say.

Comment-only; no behavior changes.

## Issue comments

### github-actions on 2026-05-15T16:24:31Z

URL: https://github.com/WordPress/gutenberg/pull/78356#issuecomment-4461471729
...
### github-actions on 2026-05-15T16:34:57Z

URL: https://github.com/WordPress/gutenberg/pull/78356#issuecomment-4461537099
...
### github-actions on 2026-05-15T16:59:00Z

URL: https://github.com/WordPress/gutenberg/pull/78356#issuecomment-4461681815

<!-- flaky-tests-report-comment -->
**Flaky tests detected in e3288d47154dc1dd4832d7e51be311560e3e0931.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/25930537378
📝  Reported issues:
- #65157 in `/test/e2e/specs/editor/blocks/image.spec.js`
...
- packages/components/src/draggable/index.tsx (MODIFIED, +6/-10)
- packages/components/src/draggable/stories/index.story.tsx (MODIFIED, +3/-3)
- packages/components/src/draggable/style.module.scss (MODIFIED, +5/-6)
- packages/components/src/draggable/types.ts (MODIFIED, +3/-3)
- packages/ui/README.md (MODIFIED, +2/-2)
- packages/ui/src/tooltip/portal.tsx (MODIFIED, +1/-1)
- packages/ui/src/tooltip/test/index.test.tsx (MODIFIED, +3/-10)
- packages/ui/src/utils/css/wp-compat-overlay-slot.module.css (MODIFIED, +12/-34)
- packages/ui/src/utils/test/use-enable-wp-compat-overlay-slot.test.tsx (MODIFIED, +3/-8)
- packages/ui/src/utils/test/wp-compat-overlay-slot.test.ts (MODIFIED, +16/-45)
- packages/ui/src/utils/use-enable-wp-compat-overlay-slot.ts (MODIFIED, +14/-23)
- packages/ui/src/utils/wp-compat-overlay-slot.ts (MODIFIED, +34/-81)
- storybook/stories/playground/popover-with-slotfill.story.jsx (MODIFIED, +3/-3)
- storybook/stories/playground/with-wp-compat-overlay-slot.tsx (MODIFIED, +5/-5)
- storybook/stories/playground/wp-compat-overlay-slot.story.jsx (MODIFIED, +3/-5)
- test/e2e/specs/editor/various/draggable-blocks.spec.js (MODIFIED, +1/-2)
