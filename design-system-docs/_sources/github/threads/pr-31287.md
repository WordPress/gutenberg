...
type: pull_request
state: MERGED
merged_at: 2021-04-28T15:38:54Z
url: https://github.com/WordPress/gutenberg/pull/31287
matched_labels: ["[Package] Components","[Feature] Component System"]
all_labels: ["[Package] Components","[Feature] Component System"]
---

# PR #31287: components: Remove wp-g2 fontsize control

- URL: https://github.com/WordPress/gutenberg/pull/31287
- Author: sarayourfriend
- Created: 2021-04-28T14:31:21Z
- Updated: 2021-04-28T16:52:42Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 10 of 10
- Diff: ../pr-diffs/31287.diff
...
<img width="284" alt="Captura de Tela 2021-04-28 às 07 30 04" src="https://user-images.githubusercontent.com/24264157/116421295-8ed2c000-a7f3-11eb-912c-532f4b03a082.png">
...
### github-actions on 2021-04-28T14:42:19Z

URL: https://github.com/WordPress/gutenberg/pull/31287#issuecomment-828512782

**Size Change:** -82.7 kB (-6%) ✅
...
| `build/block-editor/index.js` | 116 kB | -32 B (0%) |  |
| `build/block-library/index.js` | 142 kB | -11 B (0%) |  |
| `build/blocks/index.js` | 47 kB | -9 B (0%) |  |
| `build/components/index.js` | 187 kB | -81.6 kB (-30%) | 🎉 |
| `build/compose/index.js` | 9.96 kB | -6 B (0%) |  |
| `build/core-data/index.js` | 12 kB | +6 B (0%) |  |
| `build/customize-widgets/index.js` | 5.79 kB | +1 B (0%) |  |
...
| `build/edit-navigation/index.js` | 13.4 kB | +6 B (0%) |  |
| `build/edit-post/index.js` | 334 kB | -1 kB (0%) |  |
| `build/edit-site/index.js` | 25.2 kB | -4 B (0%) |  |
| `build/edit-widgets/index.js` | 13.1 kB | -6 B (0%) |  |
| `build/editor/index.js` | 60.4 kB | -20 B (0%) |  |
| `build/element/index.js` | 3.44 kB | -1 B (0%) |  |
| `build/format-library/index.js` | 5.68 kB | +2 B (0%) |  |
| `build/i18n/index.js` | 3.73 kB | -4 B (0%) |  |
| `build/notices/index.js` | 1.07 kB | +1 B (0%) |  |
| `build/plugins/index.js` | 2 kB | -6 B (0%) |  |
...
### youknowriad on 2021-04-28T14:55:12Z

URL: https://github.com/WordPress/gutenberg/pull/31287#issuecomment-828523218

Nice 30% gain in the components package :)

### sarayourfriend on 2021-04-28T15:38:48Z

URL: https://github.com/WordPress/gutenberg/pull/31287#issuecomment-828558158

> components and that we could remove them now from package.json?

I was going to do it in a separate follow up PR 😁

### gziolo on 2021-04-28T16:50:31Z

URL: https://github.com/WordPress/gutenberg/pull/31287#issuecomment-828612356

> Nice 30% gain in the components package :)

With -82.7 kB, we should be back to where we were before 😄 

From https://github.com/WordPress/gutenberg/pull/27594#issuecomment-742365468:

![](https://user-images.githubusercontent.com/699132/101740332-f8fafa80-3ac8-11eb-8f67-0959b6c86d05.png)
...
- packages/components/src/font-size-picker/index.js (MODIFIED, +1/-2)
- packages/components/src/font-size-picker/next.js (DELETED, +0/-26)
- packages/components/src/ui/font-size-control/README.md (DELETED, +0/-5)
- packages/components/src/ui/font-size-control/font-size-control.js (DELETED, +0/-78)
- packages/components/src/ui/font-size-control/index.js (DELETED, +0/-2)
- packages/components/src/ui/font-size-control/select.js (DELETED, +0/-100)
- packages/components/src/ui/font-size-control/slider.js (DELETED, +0/-55)
- packages/components/src/ui/font-size-control/styles.js (DELETED, +0/-11)
- packages/components/src/ui/font-size-control/use-font-size-control.js (DELETED, +0/-113)
- packages/components/src/ui/font-size-control/utils.js (DELETED, +0/-105)
