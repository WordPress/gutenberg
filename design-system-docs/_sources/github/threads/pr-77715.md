...
type: pull_request
state: MERGED
merged_at: 2026-04-28T14:34:51Z
url: https://github.com/WordPress/gutenberg/pull/77715
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components","[Package] Base styles"]
---

# PR #77715: CircularOptionPicker: Inline z-index values

- URL: https://github.com/WordPress/gutenberg/pull/77715
- Author: mirka
- Created: 2026-04-27T16:55:36Z
- Updated: 2026-04-28T14:35:34Z
- Comments: 3 of 3
- Review threads: 1 of 1
- Changed files: 4 of 4
- Diff: ../pr-diffs/77715.diff

## Body

## What?

Localizes the `CircularOptionPicker` z-index values that were previously defined in the shared `z-index()` helper.

## Why?

These stacking values only describe layering within the `CircularOptionPicker` component, so keeping them in the local component styles makes the shared z-index map smaller and easier to reserve for cross-component stacking concerns.

## How?

- Removes the `CircularOptionPicker` entries from `packages/base-styles/_z-index.scss`.
- Adds `isolation: isolate` to the component root.
- Replaces the `z-index()` calls with local z-index values in `packages/components/src/circular-option-picker/style.scss`.

## Testing Instructions

1. Run `npm run lint:css -- packages/base-styles/_z-index.scss packages/components/src/circular-option-picker/style.scss`.
2. Open a post or page in the editor.
3. Open a color palette that uses `CircularOptionPicker`.
4. Hover and select color swatches, and confirm the swatch tooltip, selected state, and checkmark still layer correctly above the rest of the picker UI.


## Screenshots

<img width="254" height="169" alt="A CircularOptionPicker in the app" src="https://github.com/user-attachments/assets/bb6a2c80-a225-4323-966f-b4d0c1346af8" />

## Issue comments

### github-actions on 2026-04-27T17:17:23Z

URL: https://github.com/WordPress/gutenberg/pull/77715#issuecomment-4329040547
...
| :--- | :---: | :---: |
| `build/styles/components/style-rtl.css` | 17.3 kB | +5 B (+0.03%) |
| `build/styles/components/style-rtl.min.css` | 14.1 kB | +4 B (+0.03%) |
| `build/styles/components/style.css` | 17.4 kB | +5 B (+0.03%) |
| `build/styles/components/style.min.css` | 14.2 kB | +5 B (+0.04%) |
...
### github-actions on 2026-04-27T17:18:12Z

URL: https://github.com/WordPress/gutenberg/pull/77715#issuecomment-4329045496
...
### github-actions on 2026-04-28T14:20:55Z

URL: https://github.com/WordPress/gutenberg/pull/77715#issuecomment-4336086823

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 6c0b5179abd094821c73ccc8700ca7bd7aa66771.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/25056785055
📝  Reported issues:
- #77711 in `/test/e2e/specs/editor/blocks/navigation-frontend-interactivity.spec.js`
...
#### ciampo on 2026-04-28T08:02:57Z

URL: https://github.com/WordPress/gutenberg/pull/77715#discussion_r3152455522
...
Should we add a CHANGELOG entry every time we add `isolation`, like we already did in https://github.com/WordPress/gutenberg/pull/77619 ? For this and all PRs doing this

## Changed files

- packages/base-styles/CHANGELOG.md (MODIFIED, +1/-0)
- packages/base-styles/_z-index.scss (MODIFIED, +0/-12)
