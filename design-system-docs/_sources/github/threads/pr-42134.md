...
type: pull_request
state: MERGED
merged_at: 2022-07-05T16:40:39Z
url: https://github.com/WordPress/gutenberg/pull/42134
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Focus] Accessibility (a11y)","[Feature] UI Components","[Package] Components"]
---

# PR #42134: ComboboxControl: use custom prefix when generating the instanceId

- URL: https://github.com/WordPress/gutenberg/pull/42134
- Author: ciampo
- Created: 2022-07-04T18:13:47Z
- Updated: 2022-07-05T16:41:14Z
- Comments: 2 of 2
- Review threads: 1 of 1
- Changed files: 2 of 2
- Diff: ../pr-diffs/42134.diff
...
### github-actions on 2022-07-04T18:22:07Z

URL: https://github.com/WordPress/gutenberg/pull/42134#issuecomment-1174057301
...
| `build/editor/index.min.js` | 39.3 kB |
...
### ciampo on 2022-07-04T19:17:09Z

URL: https://github.com/WordPress/gutenberg/pull/42134#issuecomment-1174130214
...
There isn't a convention (at least that I'm aware of), especially since the `instanceId` seems to be an implementation detail of each component (and not a value that external consumers should rely on).

Cc'ing @sarayourfriend (who may have some additional context on this function) and @mirka  in case I'm missing anything here, before merging

## Review threads

### Review thread 1

#### ciampo on 2022-07-04T18:14:11Z

URL: https://github.com/WordPress/gutenberg/pull/42134#discussion_r913194144
...
- packages/components/src/combobox-control/index.js (MODIFIED, +4/-1)
