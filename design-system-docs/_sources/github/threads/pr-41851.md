...
type: pull_request
state: MERGED
merged_at: 2022-06-23T07:28:51Z
url: https://github.com/WordPress/gutenberg/pull/41851
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components"]
---

# PR #41851: Spacer: Convert knobs to controls in Storybook

- URL: https://github.com/WordPress/gutenberg/pull/41851
- Author: walbo
- Created: 2022-06-21T23:06:07Z
- Updated: 2022-06-23T07:29:14Z
- Comments: 1 of 1
- Review threads: 2 of 2
- Changed files: 4 of 4
- Diff: ../pr-diffs/41851.diff

## Body

## What?

Removes knobs in the `Spacer` story.
...
2. See the `Spacer` story. The knobs should all be controls now, with the same default values.

## Issue comments

### github-actions on 2022-06-21T23:15:20Z

URL: https://github.com/WordPress/gutenberg/pull/41851#issuecomment-1162452003
...
#### mirka on 2022-06-22T19:43:08Z

URL: https://github.com/WordPress/gutenberg/pull/41851#discussion_r904164226
Path: packages/components/src/spacer/stories/index.tsx
...
Any reason we want `null` instead of `text`?
...
#### mirka on 2022-06-22T20:19:02Z

URL: https://github.com/WordPress/gutenberg/pull/41851#discussion_r904190826
Path: packages/components/src/spacer/stories/index.tsx
...
I just noticed [this discrepancy](https://github.com/WordPress/gutenberg/issues/41882) in the `SpaceInput` type description. We can keep these `number` controls for now, but we might end up changing them to `text` later. Not sure yet! Up for discussion.

#### walbo on 2022-06-22T20:36:50Z

URL: https://github.com/WordPress/gutenberg/pull/41851#discussion_r904205160
Path: packages/components/src/spacer/stories/index.tsx
...
I feel its easier to test the story when I can use the arrow keys to change the spacing, but as the issue points out it would be great to use all supported values.

Happy to change it to `text` and get it correct.

#### walbo on 2022-06-22T20:46:03Z

URL: https://github.com/WordPress/gutenberg/pull/41851#discussion_r904212173
Path: packages/components/src/spacer/stories/index.tsx
...
- packages/components/src/spacer/component.tsx (MODIFIED, +3/-4)
- packages/components/src/spacer/stories/index.js (DELETED, +0/-59)
- packages/components/src/spacer/stories/index.tsx (ADDED, +70/-0)
