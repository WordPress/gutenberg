...
type: pull_request
state: MERGED
merged_at: 2022-06-23T20:54:39Z
url: https://github.com/WordPress/gutenberg/pull/41843
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components"]
---

# PR #41843: BorderControl: Complete TypeScript migration

- URL: https://github.com/WordPress/gutenberg/pull/41843
- Author: mirka
- Created: 2022-06-21T15:33:22Z
- Updated: 2022-06-23T20:55:04Z
- Comments: 1 of 1
- Review threads: 1 of 1
- Changed files: 4 of 4
- Diff: ../pr-diffs/41843.diff
...
Adds the finishing touches to BorderControl's TypeScript support.

## Why?

- In preparation for adding a large size variant.
- To autogenerate docs in Storybook.

## How?

- Properly export the named component so the type data can be extracted.
- Mark the component as non-polymorphic. (Is this reasonable?)
- Add a main JSDoc to the component.
- Convert stories to TS.

## Testing Instructions

1. `npm run storybook:dev`
2. Check the docs for BorderControl.

## Issue comments

### github-actions on 2022-06-21T15:44:51Z

URL: https://github.com/WordPress/gutenberg/pull/41843#issuecomment-1161935208
...
| `build/block-editor/index.min.js` | 152 kB | +427 B (0%) |  |
...
| `build/block-library/index.min.js` | 183 kB | +222 B (0%) |  |
| `build/block-library/style-rtl.css` | 11.5 kB | -27 B (0%) |  |
| `build/block-library/style.css` | 11.5 kB | -27 B (0%) |  |
| `build/blocks/index.min.js` | 47 kB | +75 B (0%) |  |
| `build/components/index.min.js` | 228 kB | -8 B (0%) |  |
| `build/customize-widgets/index.min.js` | 11.2 kB | +22 B (0%) |  |
| `build/edit-post/index.min.js` | 30.4 kB | +15 B (0%) |  |
| `build/edit-site/index.min.js` | 50.7 kB | +692 B (+1%) |  |
...
#### walbo on 2022-06-22T13:33:24Z

URL: https://github.com/WordPress/gutenberg/pull/41843#discussion_r903750390
Path: packages/components/src/border-control/stories/index.tsx
...
Should `@ts-expect-error` be used instead?

```suggestion
			{ /* @ts-expect-error Ignore until Popover is converted to TS */ }
```

#### mirka on 2022-06-22T15:25:35Z

URL: https://github.com/WordPress/gutenberg/pull/41843#discussion_r903901482
Path: packages/components/src/border-control/stories/index.tsx
...
Good point, we do want to be alerted when the Popover migration is done.

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/border-control/border-control/component.tsx (MODIFIED, +41/-4)
- packages/components/src/border-control/stories/index.js (DELETED, +0/-119)
- packages/components/src/border-control/stories/index.tsx (ADDED, +150/-0)
