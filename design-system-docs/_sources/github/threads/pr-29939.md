...
type: pull_request
state: MERGED
merged_at: 2021-03-18T12:24:42Z
url: https://github.com/WordPress/gutenberg/pull/29939
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Feature] Inserter","[Package] Components"]
---

# PR #29939: Components: Allow multiple words in the autocomplete phrase matcher

- URL: https://github.com/WordPress/gutenberg/pull/29939
- Author: gziolo
- Created: 2021-03-17T17:20:40Z
- Updated: 2021-03-18T13:07:01Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 1 of 1
- Diff: ../pr-diffs/29939.diff
...
### github-actions on 2021-03-17T17:32:46Z

URL: https://github.com/WordPress/gutenberg/pull/29939#issuecomment-801273227
...
| :--- | :---: | :---: |
| `build/components/index.js` | 284 kB | +46 B (0%) |
...
| `build/block-library/blocks/gallery/editor-rtl.css` | 696 B | 0 B |
| `build/block-library/blocks/gallery/editor.css` | 696 B | 0 B |
...
| `build/block-library/blocks/navigation/editor.css` | 1.1 kB | 0 B |
...
| `build/block-library/editor-rtl.css` | 9.59 kB | 0 B |
| `build/block-library/editor.css` | 9.59 kB | 0 B |
...
| `build/edit-post/style-rtl.css` | 6.88 kB | 0 B |
| `build/edit-post/style.css` | 6.87 kB | 0 B |
...
### gziolo on 2021-03-17T17:56:20Z

URL: https://github.com/WordPress/gutenberg/pull/29939#issuecomment-801290770

I think we should also add a simple e2e test that will prevent future regressions.

### gziolo on 2021-03-18T13:07:01Z

URL: https://github.com/WordPress/gutenberg/pull/29939#issuecomment-801911869

> I think we should also add a simple e2e test that will prevent future regressions.

A follow-up ready in #29978.
...
- packages/components/src/autocomplete/index.js (MODIFIED, +14/-3)
