...
type: pull_request
state: MERGED
merged_at: 2025-12-18T12:48:09Z
url: https://github.com/WordPress/gutenberg/pull/74077
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #74077: BaseControl: Deprecate bottom margin

- URL: https://github.com/WordPress/gutenberg/pull/74077
- Author: mirka
- Created: 2025-12-17T19:33:18Z
- Updated: 2025-12-18T12:48:51Z
- Comments: 5 of 5
- Review threads: 0 of 0
- Changed files: 49 of 49
- Diff: ../pr-diffs/74077.diff
...
### github-actions on 2025-12-17T19:33:31Z

URL: https://github.com/WordPress/gutenberg/pull/74077#issuecomment-3666851320
...
### github-actions on 2025-12-17T19:51:20Z

URL: https://github.com/WordPress/gutenberg/pull/74077#issuecomment-3666909298

**Size Change:** -509 B (-0.02%) 

**Total Size:** 2.58 MB

| Filename | Size | Change |
| :--- | :---: | :---: |
| `build/scripts/block-editor/index.min.js` | 317 kB | -155 B (-0.05%) |
| `build/scripts/block-library/index.min.js` | 281 kB | -13 B (0%) |
| `build/scripts/components/index.min.js` | 272 kB | -235 B (-0.09%) |
| `build/scripts/edit-site/index.min.js` | 240 kB | -26 B (-0.01%) |
| `build/scripts/editor/index.min.js` | 284 kB | -35 B (-0.01%) |
| `build/scripts/media-utils/index.min.js` | 69.3 kB | -29 B (-0.04%) |
| `build/scripts/patterns/index.min.js` | 7.85 kB | -16 B (-0.2%) |
...
### github-actions on 2025-12-17T20:08:30Z

URL: https://github.com/WordPress/gutenberg/pull/74077#issuecomment-3666973148

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 527fb309697410f2dfbaf98a848b21634c753087.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/20315055994
📝  Reported issues:
...
### mirka on 2025-12-18T12:00:53Z

URL: https://github.com/WordPress/gutenberg/pull/74077#issuecomment-3669948822

Good questions! Both are intentional in this case:

> 1. There are some cases where  `__nextHasNoMarginBottom`  is still in some types. For example `SearchControlProps` use `InputControlProps` and the `__nextHasNoMarginBottom`. Should it be updated with `Pick< BaseControlProps, '__nextHasNoMarginBottom'` like some other changes here?

These were left as is because I noticed they aren't actually based on `BaseControl`. I don't think it matters that much in practice, but just kept separate for hygiene reasons 😄

> 2. What about the remaining `__nextHasNoMarginBottom: _, // Prevent passing to internal component` cases? Do we still need them?
...
### ntsekouras on 2025-12-18T12:43:01Z

URL: https://github.com/WordPress/gutenberg/pull/74077#issuecomment-3670105259
...
- .eslintrc.js (MODIFIED, +0/-7)
- packages/block-editor/src/components/block-allowed-blocks/allowed-blocks-control.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/colors-gradients/control.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/content-only-controls/rich-text/index.js (MODIFIED, +1/-1)
- packages/block-editor/src/components/global-styles/typography-panel.js (MODIFIED, +0/-3)
- packages/block-editor/src/components/link-picker/link-picker.js (MODIFIED, +1/-2)
...
- packages/block-editor/src/hooks/fit-text.js (MODIFIED, +0/-1)
- packages/block-editor/src/hooks/position.js (MODIFIED, +1/-4)
- packages/block-library/src/button/edit.js (MODIFIED, +6/-18)
- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/base-control/README.md (MODIFIED, +2/-13)
- packages/components/src/base-control/index.tsx (MODIFIED, +3/-25)
- packages/components/src/base-control/stories/index.story.tsx (MODIFIED, +0/-1)
- packages/components/src/base-control/styles/base-control-styles.ts (MODIFIED, +0/-22)
- packages/components/src/base-control/test/index.tsx (MODIFIED, +1/-1)
- packages/components/src/base-control/types.ts (MODIFIED, +2/-8)
- packages/components/src/box-control/input-control.tsx (MODIFIED, +0/-2)
- packages/components/src/checkbox-control/index.tsx (MODIFIED, +0/-1)
- packages/components/src/checkbox-control/types.ts (MODIFIED, +4/-10)
- packages/components/src/combobox-control/index.tsx (MODIFIED, +0/-1)
- packages/components/src/combobox-control/types.ts (MODIFIED, +5/-8)
- packages/components/src/focal-point-picker/index.tsx (MODIFIED, +1/-3)
- packages/components/src/focal-point-picker/types.ts (MODIFIED, +1/-10)
- packages/components/src/form-token-field/index.tsx (MODIFIED, +0/-1)
- packages/components/src/input-control/index.tsx (MODIFIED, +1/-6)
- packages/components/src/radio-control/index.tsx (MODIFIED, +0/-2)
- packages/components/src/range-control/index.tsx (MODIFIED, +0/-1)
- packages/components/src/range-control/types.ts (MODIFIED, +1/-8)
- packages/components/src/select-control/index.tsx (MODIFIED, +1/-6)
- packages/components/src/select-control/types.ts (MODIFIED, +1/-8)
- packages/components/src/text-control/index.tsx (MODIFIED, +0/-1)
- packages/components/src/text-control/types.ts (MODIFIED, +5/-10)
- packages/components/src/textarea-control/index.tsx (MODIFIED, +0/-1)
- packages/components/src/textarea-control/types.ts (MODIFIED, +1/-10)
- packages/components/src/toggle-control/index.tsx (MODIFIED, +0/-1)
- packages/components/src/toggle-control/types.ts (MODIFIED, +1/-8)
- packages/components/src/toggle-group-control/toggle-group-control/component.tsx (MODIFIED, +1/-1)
- packages/components/src/toggle-group-control/types.ts (MODIFIED, +4/-8)
- packages/dataviews/src/dataform-controls/date.tsx (MODIFIED, +0/-2)
- packages/dataviews/src/dataform-controls/datetime.tsx (MODIFIED, +0/-1)
- packages/dataviews/src/dataform-controls/textarea.tsx (MODIFIED, +0/-1)
- packages/dataviews/src/dataform-controls/toggle.tsx (MODIFIED, +0/-1)
- packages/dataviews/src/dataform-controls/utils/relative-date-control.tsx (MODIFIED, +0/-1)
- packages/dataviews/src/dataform-controls/utils/validated-number.tsx (MODIFIED, +0/-1)
- packages/editor/src/hooks/push-changes-to-global-styles/index.js (MODIFIED, +0/-1)
- packages/global-styles-ui/src/size-control/index.tsx (MODIFIED, +2/-7)
- packages/patterns/src/components/pattern-overrides-controls.js (MODIFIED, +0/-1)
