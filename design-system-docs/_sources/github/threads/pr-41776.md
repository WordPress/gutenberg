...
type: pull_request
state: MERGED
merged_at: 2022-06-17T09:26:55Z
url: https://github.com/WordPress/gutenberg/pull/41776
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Performance","[Feature] Shortcodes","[Type] Code Quality","[Package] Element","[Package] Components","[Feature] Annotations"]
---

# PR #41776: Lodash: Refactor away from `_.isNumber()`

- URL: https://github.com/WordPress/gutenberg/pull/41776
- Author: tyxla
- Created: 2022-06-17T08:34:31Z
- Updated: 2022-06-17T09:27:31Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 5 of 5
- Diff: ../pr-diffs/41776.diff
...
### github-actions on 2022-06-17T08:42:50Z

URL: https://github.com/WordPress/gutenberg/pull/41776#issuecomment-1158643229
...
### tyxla on 2022-06-17T08:52:31Z

URL: https://github.com/WordPress/gutenberg/pull/41776#issuecomment-1158652325

> The only edge case here is that `isNumber` [is also checking](https://github.com/lodash/lodash/blob/master/isNumber.js#L30-L31) if the `value` is an instance of the [`Number` wrapper object](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number), although I don't think that the code ever branched into this edge case.

Thanks for the swift review @ciampo!

Indeed, as I mentioned in the PR description, we're intentionally not supporting this, as it's not used anywhere and I think we should discourage it anyway because it adds unnecessary indirection.
...
- packages/annotations/src/store/reducer.js (MODIFIED, +3/-3)
- packages/components/src/box-control/utils.js (MODIFIED, +4/-4)
- packages/element/src/utils.js (MODIFIED, +2/-2)
- packages/shortcode/src/index.js (MODIFIED, +6/-3)
