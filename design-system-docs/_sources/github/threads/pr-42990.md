...
type: pull_request
state: MERGED
merged_at: 2022-08-09T17:29:58Z
url: https://github.com/WordPress/gutenberg/pull/42990
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Type] Code Quality","[Package] Components"]
---

# PR #42990: Placeholder: Convert component to TypeScript

- URL: https://github.com/WordPress/gutenberg/pull/42990
- Author: walbo
- Created: 2022-08-04T19:55:52Z
- Updated: 2022-08-09T17:30:24Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 7 of 7
- Diff: ../pr-diffs/42990.diff
...
## What?
Refactor the `Placeholder` component to TypeScript.
...
- Refactored storybook to typescript and controls

_Note_
Tests are not converted to TypeScript since it uses `enzyme` and need to be refactored. Will do that in a follow-up PR.

## Testing Instructions
1. Run npm run dev and ensure no typing errors
2. Test the Placeholder in the storybook.
3. Test the various use of Placeholders within the block/site editors in Gutenberg still works

## Issue comments

### github-actions on 2022-08-04T20:06:01Z

URL: https://github.com/WordPress/gutenberg/pull/42990#issuecomment-1205715354
...
- packages/components/src/placeholder/README.md (MODIFIED, +49/-9)
- packages/components/src/placeholder/index.tsx (RENAMED, +27/-23)
- packages/components/src/placeholder/stories/index.js (DELETED, +0/-44)
- packages/components/src/placeholder/stories/index.tsx (ADDED, +64/-0)
- packages/components/src/placeholder/types.ts (ADDED, +48/-0)
