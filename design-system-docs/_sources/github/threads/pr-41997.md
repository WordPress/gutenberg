...
type: pull_request
state: MERGED
merged_at: 2022-06-28T10:16:25Z
url: https://github.com/WordPress/gutenberg/pull/41997
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components"]
---

# PR #41997: NumberControl: Add 40px size variant to Storybook

- URL: https://github.com/WordPress/gutenberg/pull/41997
- Author: mirka
- Created: 2022-06-28T07:04:43Z
- Updated: 2022-06-28T10:17:20Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 1 of 1
- Diff: ../pr-diffs/41997.diff

## Body

Part of #41973
In preparation for #41795

## What?

Adds a `size` control for the NumberControl story.

## Why?

Size variants were already supported on NumberControl due to the pass-thru props on the underlying InputControl, but it was hard to tell because there was no `size` control in the Storybook.

## Testing Instructions

1. `npm run storybook:dev`
2. See the story for NumberControl.

## Issue comments

### github-actions on 2022-06-28T07:12:27Z

URL: https://github.com/WordPress/gutenberg/pull/41997#issuecomment-1168324099
...
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 152 kB | +91 B (0%) |
| `build/block-library/index.min.js` | 183 kB | +9 B (0%) |
...
- packages/components/src/number-control/stories/index.js (MODIFIED, +7/-0)
