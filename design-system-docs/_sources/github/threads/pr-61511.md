...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/61511
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components","[Feature] Zoom Out"]
---

# PR #61511: Zoom Out: Show a preview when dragging and dropping patterns from the inserter.

- URL: https://github.com/WordPress/gutenberg/pull/61511
- Author: scruffian
- Created: 2024-05-09T03:54:23Z
- Updated: 2025-02-10T16:51:37Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 3 of 3
- Diff: ../pr-diffs/61511.diff
...
### github-actions on 2024-05-09T03:54:38Z

URL: https://github.com/WordPress/gutenberg/pull/61511#issuecomment-2101885514
...
### github-actions on 2024-05-09T04:03:50Z

URL: https://github.com/WordPress/gutenberg/pull/61511#issuecomment-2101893398

**Size Change:** +1.65 kB (+0.09%) 

**Total Size:** 1.74 MB

| Filename | Size | Change |
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 258 kB | +332 B (+0.13%) |
| `build/block-editor/style-rtl.css` | 15.5 kB | +51 B (+0.33%) |
| `build/block-editor/style.css` | 15.5 kB | +48 B (+0.31%) |
...
| `build/edit-site/index.min.js` | 223 kB | +752 B (+0.34%) |
...
### ntsekouras on 2024-05-10T05:12:10Z

URL: https://github.com/WordPress/gutenberg/pull/61511#issuecomment-2103877997

We need to find a different handling for this because right now the browser takes a screenshot and can include the pattern's title and hover styles, which is not what we want.

### draganescu on 2024-09-30T07:04:25Z

URL: https://github.com/WordPress/gutenberg/pull/61511#issuecomment-2382276365

I will close this because no progress and also because we use the chip in all the other places.
...
- packages/block-editor/src/components/inserter-draggable-blocks/index.js (MODIFIED, +9/-5)
- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/draggable/index.tsx (MODIFIED, +5/-0)
