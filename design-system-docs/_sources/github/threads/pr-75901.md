...
type: pull_request
state: MERGED
merged_at: 2026-02-25T15:36:33Z
url: https://github.com/WordPress/gutenberg/pull/75901
matched_labels: ["[Package] Theme"]
all_labels: ["[Type] Bug","[Package] Theme"]
---

# PR #75901: Theme: Add build plugins to inject design token fallbacks

- URL: https://github.com/WordPress/gutenberg/pull/75901
- Author: mirka
- Created: 2026-02-25T11:03:07Z
- Updated: 2026-02-25T15:36:36Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 21 of 21
- Diff: ../pr-diffs/75901.diff

## Body

Cherry picking #75586 and #75589 to the `wp/7.0` branch.

## Issue comments

### github-actions on 2026-02-25T11:03:18Z

URL: https://github.com/WordPress/gutenberg/pull/75901#issuecomment-3958476812
...
### github-actions on 2026-02-25T11:20:28Z

URL: https://github.com/WordPress/gutenberg/pull/75901#issuecomment-3958574012
...
| :--- | :---: | :---: |
| `build/modules/boot/index.min.js` | 14.8 kB | +21 B (+0.14%) |
| `build/scripts/block-editor/index.min.js` | 328 kB | +265 B (+0.08%) |
| `build/scripts/edit-site/index.min.js` | 244 kB | +269 B (+0.11%) |
...
| `build/styles/edit-site/style-rtl.css` | 20.3 kB | +34 B (+0.17%) |
| `build/styles/edit-site/style-rtl.min.css` | 16.5 kB | +27 B (+0.16%) |
| `build/styles/edit-site/style.css` | 20.4 kB | +34 B (+0.17%) |
| `build/styles/edit-site/style.min.css` | 16.5 kB | +28 B (+0.17%) |
| `build/styles/editor/style-rtl.css` | 23.2 kB | +22 B (+0.1%) |
| `build/styles/editor/style-rtl.min.css` | 19.7 kB | +28 B (+0.14%) |
| `build/styles/editor/style.css` | 23.2 kB | +22 B (+0.09%) |
...
| `build/scripts/upload-media/index.min.js` | 7.72 kB |
...
| `build/styles/block-library/editor.css` | 12.4 kB |
...
### mirka on 2026-02-25T11:34:20Z

URL: https://github.com/WordPress/gutenberg/pull/75901#issuecomment-3958647195

Some test failures due to #75782 not being on the release branch yet.

### t-hamano on 2026-02-25T12:05:25Z

URL: https://github.com/WordPress/gutenberg/pull/75901#issuecomment-3958814968

I cherry-picked #75782 into `wp/7.0`. Let's see if the CI check passes.
...
- packages/theme/src/prebuilt/js/design-token-fallbacks.mjs (ADDED, +156/-0)
