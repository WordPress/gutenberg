...
type: pull_request
state: MERGED
merged_at: 2026-05-14T13:37:03Z
url: https://github.com/WordPress/gutenberg/pull/78291
matched_labels: ["[Package] Components"]
all_labels: ["Internationalization (i18n)","[Type] Code Quality","[Package] Components"]
---

# PR #78291: Routes: Enforce logical CSS properties in stylesheets

- URL: https://github.com/WordPress/gutenberg/pull/78291
- Author: mirka
- Created: 2026-05-14T12:14:48Z
- Updated: 2026-05-25T07:40:47Z
- Comments: 2 of 2
- Review threads: 1 of 1
- Changed files: 8 of 8
- Diff: ../pr-diffs/78291.diff
...
### github-actions on 2026-05-14T12:22:15Z

URL: https://github.com/WordPress/gutenberg/pull/78291#issuecomment-4450608415
...
### github-actions on 2026-05-14T12:23:07Z

URL: https://github.com/WordPress/gutenberg/pull/78291#issuecomment-4450613852
...
#### aduth on 2026-05-14T13:16:35Z

URL: https://github.com/WordPress/gutenberg/pull/78291#discussion_r3241578160
Path: routes/guidelines/style.scss
...
Without wanting to bloat the scope of this pull request, is it not safe enough to just go ahead and make the equivalent logical conversions here? 

```suggestion
	margin-inline-start: -$grid-unit-20;
```

#### mirka on 2026-05-14T13:36:08Z

URL: https://github.com/WordPress/gutenberg/pull/78291#discussion_r3241697237
Path: routes/guidelines/style.scss
...
Hard to say without verifying each occurrence in the UI and see what's happening, since not everything should be flipped in RTL.

In one sense, mechanically fixing here is no different from running the code through `rtlcss()`, but there's a bit more of a intentionality signal that I wouldn't want to convey by changing these to logical without even looking 😅

## Changed files

- .stylelintrc.js (MODIFIED, +5/-1)
- routes/guidelines/components/block-guidelines.scss (MODIFIED, +2/-4)
- routes/guidelines/components/guideline-actions-section.scss (MODIFIED, +1/-2)
- routes/guidelines/style.scss (MODIFIED, +3/-2)
- routes/post-list/style.scss (MODIFIED, +1/-0)
- routes/styles/style.scss (MODIFIED, +1/-2)
- routes/template-list/add-new-template/style.scss (MODIFIED, +2/-2)
- routes/template-list/style.scss (MODIFIED, +2/-0)
