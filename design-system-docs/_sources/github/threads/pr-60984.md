...
type: pull_request
state: MERGED
merged_at: 2024-04-25T08:44:58Z
url: https://github.com/WordPress/gutenberg/pull/60984
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #60984: Box Control: fix issue with negative values

- URL: https://github.com/WordPress/gutenberg/pull/60984
- Author: MaggieCabrera
- Created: 2024-04-23T08:14:17Z
- Updated: 2024-04-25T08:45:29Z
- Comments: 5 of 5
- Review threads: 1 of 1
- Changed files: 5 of 5
- Diff: ../pr-diffs/60984.diff
...
### github-actions on 2024-04-23T08:22:32Z

URL: https://github.com/WordPress/gutenberg/pull/60984#issuecomment-2071709866
...
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 256 kB | +44 B (0%) |
| `build/components/index.min.js` | 220 kB | -130 B (0%) |
...
| `build/editor/index.min.js` | 79.4 kB |
...
### MaggieCabrera on 2024-04-24T09:49:02Z

URL: https://github.com/WordPress/gutenberg/pull/60984#issuecomment-2074551997

> Thanks for the quick fix!
> 
> I pushed unit tests ([5e9785d](https://github.com/WordPress/gutenberg/commit/5e9785de51f31b82c7e4ba1df1100f898560fcdc)) to clarify what broke in #60347. It broke the default min value for the input, as well as the ability to pass props through to the input via the `inputProps` prop. You can also manually check this in the [Storybook](https://wordpress.github.io/gutenberg/?path=/docs/components-experimental-boxcontrol--docs).
> 
> I also noticed that the [drag behavior changes](https://github.com/WordPress/gutenberg/pull/60347/commits/6c98a0e05aeecf1c539f71dd5db4cf0cdd63d86b) were only made on one specific case ([unlinked and not split on axis](https://github.com/WordPress/gutenberg/blob/c08285229c256b2af061ab550c78ff056ab8c1b0/packages/components/src/box-control/index.tsx#L186-L188)), of which there are two other cases ([linked](https://github.com/WordPress/gutenberg/blob/c08285229c256b2af061ab550c78ff056ab8c1b0/packages/components/src/box-control/index.tsx#L168-L172), [unlinked and split on axis](https://github.com/WordPress/gutenberg/blob/c08285229c256b2af061ab550c78ff056ab8c1b0/packages/components/src/box-control/index.tsx#L183-L185)). This wasn't intentional, right? And since the original intent was to modify behavior for the margin controls in the block editor dimensions panel, not all instances of BoxControl, I believe we should move this dragging logic out of BoxControl as well. We can just as easily pass down those `onDrag` props via the `inputProps` prop from the `dimensions-panel.js` file, like we did with the `min` value.
...
### MaggieCabrera on 2024-04-24T10:45:03Z

URL: https://github.com/WordPress/gutenberg/pull/60984#issuecomment-2074656517
...
I gave it a try [here](https://github.com/WordPress/gutenberg/pull/60984/commits/8e2b1ced63cf31d0d9f2c84106abc5da82d3fcf9), but I'm unsure if it's okay to do like that since we are changing the min for all sides? I suppose since we recheck on onDragStart, it should be fine

### github-actions on 2024-04-24T14:12:42Z

URL: https://github.com/WordPress/gutenberg/pull/60984#issuecomment-2075051872
...
### MaggieCabrera on 2024-04-24T14:13:14Z

URL: https://github.com/WordPress/gutenberg/pull/60984#issuecomment-2075053053
...
#### mirka on 2024-04-24T12:56:47Z

URL: https://github.com/WordPress/gutenberg/pull/60984#discussion_r1577838450
Path: packages/block-editor/src/components/global-styles/dimensions-panel.js
...
This seems logically equivalent and more performant to me — is there a reason we need to constantly monitor for value updates if we want to restrict negative dragging no matter what?
...
#### MaggieCabrera on 2024-04-24T14:03:34Z

URL: https://github.com/WordPress/gutenberg/pull/60984#discussion_r1577952602
Path: packages/block-editor/src/components/global-styles/dimensions-panel.js
...
You know what, you are absolutely right. I will comment it though, since it's unclear why we are doing this without the condition.

## Changed files

- packages/block-editor/src/components/global-styles/dimensions-panel.js (MODIFIED, +17/-2)
- packages/components/CHANGELOG.md (MODIFIED, +0/-1)
- packages/components/src/box-control/index.tsx (MODIFIED, +6/-5)
- packages/components/src/box-control/input-controls.tsx (MODIFIED, +0/-20)
- packages/components/src/box-control/test/index.tsx (MODIFIED, +22/-0)
