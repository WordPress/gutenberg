...
type: pull_request
state: MERGED
merged_at: 2022-08-29T10:14:41Z
url: https://github.com/WordPress/gutenberg/pull/43626
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Performance","[Type] Code Quality","[Package] Data","Mobile App - i.e. Android or iOS","[Package] Components","[Package] Blocks","[Package] Editor","[Package] Block editor","[Package] Edit Site"]
---

# PR #43626: Lodash: Refactor away from `_.has()`

- URL: https://github.com/WordPress/gutenberg/pull/43626
- Author: tyxla
- Created: 2022-08-26T09:32:26Z
- Updated: 2022-08-29T10:15:13Z
- Comments: 1 of 1
- Review threads: 1 of 1
- Changed files: 11 of 11
- Diff: ../pr-diffs/43626.diff
...
### github-actions on 2022-08-26T09:43:26Z

URL: https://github.com/WordPress/gutenberg/pull/43626#issuecomment-1228288028
...
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 159 kB | +17 B (0%) |
| `build/block-library/index.min.js` | 186 kB | +71 B (0%) |
...
#### sgomes on 2022-08-29T10:00:03Z

URL: https://github.com/WordPress/gutenberg/pull/43626#discussion_r957130483
...
This will work if a segment is always either an object or a falsy value, but will fail if it's anything else (say, a number). I don't think that's much of a concern here, as it'd be a symptom of a problem elsewhere instead, but I thought I'd point it out.

## Changed files

- .eslintrc.js (MODIFIED, +1/-0)
- packages/block-editor/src/hooks/align.js (MODIFIED, +2/-2)
- packages/block-editor/src/hooks/anchor.js (MODIFIED, +1/-6)
- packages/block-editor/src/hooks/layout.js (MODIFIED, +2/-2)
- packages/block-editor/src/hooks/lock.js (MODIFIED, +1/-6)
- packages/block-library/src/image/edit.js (MODIFIED, +3/-3)
- packages/blocks/src/api/utils.js (MODIFIED, +2/-2)
- packages/components/src/mobile/global-styles-context/utils.native.js (MODIFIED, +7/-2)
- packages/data/src/redux-store/metadata/reducer.ts (MODIFIED, +2/-2)
- packages/edit-site/src/components/global-styles/hooks.js (MODIFIED, +3/-5)
- packages/editor/src/components/post-featured-image/index.js (MODIFIED, +3/-3)
