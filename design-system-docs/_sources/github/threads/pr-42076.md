...
type: pull_request
state: MERGED
merged_at: 2022-07-05T06:23:11Z
url: https://github.com/WordPress/gutenberg/pull/42076
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Feature] UI Components","[Package] Components"]
---

# PR #42076: Popover: pass missing anchor ref to the getAnchorRect callback prop

- URL: https://github.com/WordPress/gutenberg/pull/42076
- Author: ciampo
- Created: 2022-06-30T14:05:29Z
- Updated: 2022-07-05T06:23:42Z
- Comments: 2 of 2
- Review threads: 2 of 2
- Changed files: 2 of 2
- Diff: ../pr-diffs/42076.diff
...
### github-actions on 2022-06-30T14:18:05Z

URL: https://github.com/WordPress/gutenberg/pull/42076#issuecomment-1171279213
...
| :--- | :---: | :---: | :---: |
| `build/block-editor/index.min.js` | 152 kB | +25 B (0%) |  |
...
| `build/block-library/style-rtl.css` | 11.5 kB | +40 B (0%) |  |
| `build/block-library/style.css` | 11.5 kB | +41 B (0%) |  |
| `build/components/index.min.js` | 230 kB | +212 B (0%) |  |
| `build/components/style-rtl.css` | 14 kB | -13 B (0%) |  |
| `build/components/style.css` | 14 kB | -13 B (0%) |  |
| `build/edit-post/index.min.js` | 30.4 kB | -503 B (-2%) |  |
| `build/edit-post/style-rtl.css` | 7.04 kB | -33 B (0%) |  |
| `build/edit-post/style.css` | 7.04 kB | -32 B (0%) |  |
| `build/edit-site/index.min.js` | 51 kB | +6 B (0%) |  |
| `build/editor/index.min.js` | 39.2 kB | +479 B (+1%) |  |
...
### ciampo on 2022-07-01T11:33:37Z

URL: https://github.com/WordPress/gutenberg/pull/42076#issuecomment-1172249961

Hey @andrewserong , thank you for your review! Your observations make a lot of sense, and I made changes so that both calls to `getAnchorRect` behave consistently and in accordance to what the README states:

- `getAnchorRect` now receives `anchorRefFallback.current` as an argument also in the second function call that you mentioned
- both calls to `getAnchorRect` are now wrapped in a `if` statement checking that `anchorRefFallback.current` is defined
...
#### ciampo on 2022-06-30T14:06:53Z

URL: https://github.com/WordPress/gutenberg/pull/42076#discussion_r911072036
...
This extra check is to mimic the logic from the [early return statement](https://github.com/WordPress/gutenberg/blob/b99e6688fba7037ccee46cb6b7d70917a5f2c418/packages/components/src/popover/index.js#L57-L59) that existed prior to the refactor from #40740).
...
#### andrewserong on 2022-07-01T00:32:25Z

URL: https://github.com/WordPress/gutenberg/pull/42076#discussion_r911531700
Path: packages/components/src/popover/index.js
...
#### andrewserong on 2022-07-01T00:48:08Z

URL: https://github.com/WordPress/gutenberg/pull/42076#discussion_r911536477
...
I've updated the PR description, too, hope you don't mind!

#### ciampo on 2022-07-01T11:01:35Z

URL: https://github.com/WordPress/gutenberg/pull/42076#discussion_r911862342
Path: packages/components/CHANGELOG.md
...
Thank you! I've been mispelling ref / rect all day 🤦
