...
type: pull_request
state: MERGED
merged_at: 2021-06-02T09:25:51Z
url: https://github.com/WordPress/gutenberg/pull/32344
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #32344: SuggestionsList: Try to use a unique "key"

- URL: https://github.com/WordPress/gutenberg/pull/32344
- Author: Mamaduka
- Created: 2021-05-31T09:51:00Z
- Updated: 2021-06-07T09:40:07Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 1 of 1
- Diff: ../pr-diffs/32344.diff
...
### github-actions on 2021-05-31T09:58:42Z

URL: https://github.com/WordPress/gutenberg/pull/32344#issuecomment-851375230
...
### Mamaduka on 2021-06-02T09:13:06Z

URL: https://github.com/WordPress/gutenberg/pull/32344#issuecomment-852856586

Thanks for the review, @ntsekouras

I also noticed that we have a "duplicate" [`ComboboxControl`](https://github.com/WordPress/gutenberg/blob/trunk/packages/components/src/form-token-field/combobox.js) in the `FormTokenField` component, which isn't exported or used anywhere I can find.

Do you think we should remove it?

cc @youknowriad

### youknowriad on 2021-06-02T09:45:30Z

URL: https://github.com/WordPress/gutenberg/pull/32344#issuecomment-852880808

> I also noticed that we have a "duplicate" ComboboxControl in the FormTokenField component, which isn't exported or used anywhere I can find.

Mmm, yeah in that case remove it. probably a left over from the PR that introduced the ComboboxControl component. 

There's also a lot of duplication between `ComboboxControl` and `FormTokenField`, `FormTokenField` was introduced first and then later we added `ComboboxControl` which is a simplified version but that doesn't map exactly to `FormTokenField` (also that name is not great since all other controls are `SomethingControl`), I believe at some point we could do some work to align/share code between these two components.

### Mamaduka on 2021-06-02T09:53:41Z

URL: https://github.com/WordPress/gutenberg/pull/32344#issuecomment-852887436

Makes sense.

I will create PR for removing the duplicate.
...
- packages/components/src/form-token-field/suggestions-list.js (MODIFIED, +5/-1)
