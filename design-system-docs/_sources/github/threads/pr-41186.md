...
type: pull_request
state: MERGED
merged_at: 2022-05-20T10:32:13Z
url: https://github.com/WordPress/gutenberg/pull/41186
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #41186: Components: Remove 'useCombinedRef' hook

- URL: https://github.com/WordPress/gutenberg/pull/41186
- Author: Mamaduka
- Created: 2022-05-20T07:21:38Z
- Updated: 2022-05-20T10:32:36Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 3 of 3
- Diff: ../pr-diffs/41186.diff

## Body

## What?
PR removes `useCombinedRef` hook and refactors `SearchControl` to use `useMergeRefs` hook.

It was an internal hook, so there was no need for depreciation or changelog update.

## Why?
No need to maintain two separate hooks.

## Testing Instructions
Creating search control using the `x` button should focus on the input field

## Issue comments

### github-actions on 2022-05-20T07:29:02Z

URL: https://github.com/WordPress/gutenberg/pull/41186#issuecomment-1132573729
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 227 kB | -88 B (0%) |
...
- packages/components/src/search-control/index.js (MODIFIED, +6/-7)
- packages/components/src/utils/hooks/index.js (MODIFIED, +0/-1)
- packages/components/src/utils/hooks/use-combined-ref.ts (DELETED, +0/-28)
