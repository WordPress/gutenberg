...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/33055
...
# PR #33055: components: Remove `@emotion/css` from Spacer

- URL: https://github.com/WordPress/gutenberg/pull/33055
- Author: sarayourfriend
- Created: 2021-06-28T21:48:25Z
- Updated: 2021-07-08T15:52:11Z
- Comments: 2 of 2
- Review threads: 3 of 3
- Changed files: 7 of 7
- Diff: ../pr-diffs/33055.diff
...
### github-actions on 2021-06-28T21:55:20Z

URL: https://github.com/WordPress/gutenberg/pull/33055#issuecomment-870070811
...
| `build/block-editor/style-rtl.css` | 13.8 kB | +3 B (0%) |  |
| `build/block-editor/style.css` | 13.8 kB | +7 B (0%) |  |
...
| `build/block-library/index.min.js` | 146 kB | +10 B (0%) |  |
| `build/blocks/index.min.js` | 47.3 kB | +1 B (0%) |  |
| `build/components/index.min.js` | 182 kB | -39 B (0%) |  |
| `build/compose/index.min.js` | 10.2 kB | +1 B (0%) |  |
| `build/customize-widgets/index.min.js` | 10.2 kB | +19 B (0%) |  |
| `build/data-controls/index.min.js` | 829 B | +1 B (0%) |  |
| `build/edit-post/index.min.js` | 58.7 kB | +26 B (0%) |  |
| `build/edit-site/index.min.js` | 25.9 kB | +4 B (0%) |  |
| `build/edit-widgets/index.min.js` | 16.1 kB | +26 B (0%) |  |
| `build/server-side-render/index.min.js` | 1.63 kB | +1 B (0%) |  |
| `build/widgets/index.min.js` | 6.31 kB | +80 B (+1%) |  |
...
### sarayourfriend on 2021-07-05T16:04:02Z

URL: https://github.com/WordPress/gutenberg/pull/33055#issuecomment-874213437

> we should also look for every usage of <Spacer />
...
#### ciampo on 2021-07-02T15:29:03Z

URL: https://github.com/WordPress/gutenberg/pull/33055#discussion_r663094801
Path: packages/components/src/spacer/styles.ts
...
#### ciampo on 2021-07-02T16:26:38Z

URL: https://github.com/WordPress/gutenberg/pull/33055#discussion_r663127112
Path: packages/components/src/spacer/styles.ts
...
Currently the more "generic" properties, when set, override the more "specific" properties.

If we swapped the order, we would enable scenarios where the more generic and the more specific properties could be defined at the same time (e.g. `padding` and `padding-left`
...
#### ciampo on 2021-07-02T16:28:03Z

URL: https://github.com/WordPress/gutenberg/pull/33055#discussion_r663127923
Path: packages/components/src/spacer/stories/index.js
...
- packages/components/src/spacer/component.tsx (RENAMED, +34/-8)
- packages/components/src/spacer/hook.ts (DELETED, +0/-172)
- packages/components/src/spacer/index.ts (MODIFIED, +1/-2)
- packages/components/src/spacer/stories/index.js (ADDED, +53/-0)
- packages/components/src/spacer/styles.ts (ADDED, +53/-0)
