...
type: pull_request
state: MERGED
merged_at: 2026-04-17T14:27:15Z
url: https://github.com/WordPress/gutenberg/pull/77432
matched_labels: ["[Package] Theme"]
all_labels: ["[Type] Task","[Type] Code Quality","dependencies","[Package] Theme"]
---

# PR #77432: Theme: Update Terrazzo packages to 2.0

- URL: https://github.com/WordPress/gutenberg/pull/77432
- Author: aduth
- Created: 2026-04-16T17:32:11Z
- Updated: 2026-04-29T17:31:13Z
- Comments: 3 of 3
- Review threads: 6 of 6
- Changed files: 9 of 9
- Diff: ../pr-diffs/77432.diff
...
Updates [Terrazzo](https://terrazzo.app/) dependencies used in `@wordpress/theme` from 0.x to 2.0.

Related migration guide: https://terrazzo.app/docs/guides/migrating-v2/ 

## Why?

General maintenance to reduce drift and take advantage of features and bug fixes.

Specifically, this includes at least one bug fix we previously had to work-around in plugin typings (https://github.com/terrazzoapp/terrazzo/pull/632).

## How?

Some issues / behavior changes to note:

- Terrazzo 2 alphabetizes tokens by default. To preserve our size scheme order (2xs -> 2xl) as-is, I disabled this. But this in turn has another issue ([reported upstream](https://github.com/terrazzoapp/terrazzo/issues/734)) that for now includes a temporary workaround here to patch.
- `@terrazzo/cli` now includes Vite 8 as a dependency, which has a huge dependency chain. To avoid this, I opted to remove this dependency and write a thin wrapper script instead. Since we used very few features of the CLI, this seems like a simpler option (see also removed net negative lines of code on the pull request, largely from removed dependencies).
...
### github-actions on 2026-04-16T17:32:21Z

URL: https://github.com/WordPress/gutenberg/pull/77432#issuecomment-4262137334
...
### github-actions on 2026-04-16T17:53:01Z

URL: https://github.com/WordPress/gutenberg/pull/77432#issuecomment-4262272981
...
| :--- | :---: | :---: |
| `build/modules/boot/index.min.js` | 17 kB | -29 B (-0.17%) |
| `build/scripts/theme/index.min.js` | 22 kB | -4 B (-0.02%) |
| `build/styles/edit-post/style.css` | 3.99 kB | -1 B (-0.03%) |
| `build/styles/edit-site/style-rtl.css` | 20.9 kB | -1 B (0%) |
| `build/styles/edit-site/style.css` | 20.9 kB | -1 B (0%) |
...
### github-actions on 2026-04-16T18:12:49Z

URL: https://github.com/WordPress/gutenberg/pull/77432#issuecomment-4262384884

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 638444a79bceae23fad7d5733a0c79f82d2918a4.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/24566013034
📝  Reported issues:
...
#### aduth on 2026-04-16T17:32:47Z

URL: https://github.com/WordPress/gutenberg/pull/77432#discussion_r3095156614
...
#### aduth on 2026-04-16T17:34:37Z

URL: https://github.com/WordPress/gutenberg/pull/77432#discussion_r3095168757
Path: packages/theme/bin/terrazzo-plugin-inline-alias-values/index.ts

```diff
@@ -49,7 +49,7 @@ export default function inlineAliasValues( {
...
#### aduth on 2026-04-16T17:37:51Z

URL: https://github.com/WordPress/gutenberg/pull/77432#discussion_r3095191280
Path: packages/theme/terrazzo.config.ts

```diff
@@ -299,4 +302,8 @@ export default defineConfig( {
 	// 		],
 	// 	},
 	// },
+};
...
I didn't see this mentioned in the [migration guide](https://terrazzo.app/docs/guides/migrating-v2/) or [package release notes](https://github.com/terrazzoapp/terrazzo/releases/tag/%40terrazzo%2Fparser%402.0.0), but [the code itself errors if `cwd` is not specified](https://github.com/terrazzoapp/terrazzo/blob/fefd4b149d03ca2199eaddc7b197e4e081169e7f/packages/parser/src/config.ts#L17-L19).

### Review thread 4

#### aduth on 2026-04-16T17:38:38Z

URL: https://github.com/WordPress/gutenberg/pull/77432#discussion_r3095196639
...
#### aduth on 2026-04-16T17:44:29Z

URL: https://github.com/WordPress/gutenberg/pull/77432#discussion_r3095232774
Path: packages/theme/terrazzo.config.ts
...
This is needed because the function return types allow `undefined` but not `void`. Apparently in [my fix proposal](https://github.com/terrazzoapp/terrazzo/pull/632) I originally [included it](https://github.com/terrazzoapp/terrazzo/pull/632/commits/bbb255e74e2c310075644b0dc72e54065314082d) but [later reverted it](https://github.com/terrazzoapp/terrazzo/pull/632/commits/87e582d3b56303496e408281081eff1d1b559280). I'm not sure why I reverted it 😅

### Review thread 6

#### mirka on 2026-04-17T11:05:59Z

URL: https://github.com/WordPress/gutenberg/pull/77432#discussion_r3099775593
Path: packages/theme/bin/build-design-tokens/index.ts
...
#### aduth on 2026-04-17T12:48:51Z

URL: https://github.com/WordPress/gutenberg/pull/77432#discussion_r3100376521
Path: packages/theme/bin/build-design-tokens/index.ts
...
- package-lock.json (MODIFIED, +82/-359)
