...
type: pull_request
state: MERGED
merged_at: 2022-07-18T03:07:43Z
url: https://github.com/WordPress/gutenberg/pull/42468
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Performance","[Type] Code Quality","[Package] Components"]
---

# PR #42468: Lodash: Refactor a few components away from `_.isEmpty()`

- URL: https://github.com/WordPress/gutenberg/pull/42468
- Author: tyxla
- Created: 2022-07-15T13:09:14Z
- Updated: 2022-07-18T03:08:09Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 4 of 4
- Diff: ../pr-diffs/42468.diff

## Body

## What?
This PR removes the `_.isEmpty()` usage from a few components: `BoxControl`, `RadioControl` and `SelectControl`. 
...
The usages we're replacing are straightforward to replace with `.length` because they are always arrays. We add some optional chaining just in case an external consumer might unintentionally pass a nullish value for `options` and cause an error.

## Testing Instructions
* Verify all tests still pass.
* Smoke test `BoxControl`, `RadioControl` and `SelectControl` in storybook.

## Issue comments

### github-actions on 2022-07-15T13:19:42Z

URL: https://github.com/WordPress/gutenberg/pull/42468#issuecomment-1185539026
...
- packages/components/src/box-control/utils.js (MODIFIED, +6/-13)
- packages/components/src/radio-control/index.tsx (MODIFIED, +1/-2)
- packages/components/src/select-control/index.tsx (MODIFIED, +1/-2)
