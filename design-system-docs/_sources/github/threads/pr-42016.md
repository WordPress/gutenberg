...
type: pull_request
state: MERGED
merged_at: 2022-07-01T14:00:17Z
url: https://github.com/WordPress/gutenberg/pull/42016
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Feature] UI Components","[Type] Code Quality","[Package] Components"]
---

# PR #42016: Scrollable: Convert component to TypeScript

- URL: https://github.com/WordPress/gutenberg/pull/42016
- Author: walbo
- Created: 2022-06-28T16:16:33Z
- Updated: 2022-07-01T14:00:43Z
- Comments: 1 of 1
- Review threads: 2 of 2
- Changed files: 11 of 11
- Diff: ../pr-diffs/42016.diff
...
2. Fire up the Storybook and confirm the `Scrollable` continues to function as expected

## Issue comments

### github-actions on 2022-06-28T16:24:54Z

URL: https://github.com/WordPress/gutenberg/pull/42016#issuecomment-1168938933
...
#### ciampo on 2022-07-01T12:52:03Z

URL: https://github.com/WordPress/gutenberg/pull/42016#discussion_r911935169
...
#### walbo on 2022-07-01T13:09:06Z

URL: https://github.com/WordPress/gutenberg/pull/42016#discussion_r911948244
Path: packages/components/CHANGELOG.md
...
#### ciampo on 2022-07-01T13:06:22Z

URL: https://github.com/WordPress/gutenberg/pull/42016#discussion_r911946054
Path: packages/components/src/scrollable/stories/index.tsx
...
Is this changes on purpose? Previously, the `right` attribute could also have a value of `initial`

#### walbo on 2022-07-01T13:13:31Z

URL: https://github.com/WordPress/gutenberg/pull/42016#discussion_r911951744
Path: packages/components/src/scrollable/stories/index.tsx
...
Yes the change was intended. In my testing the out of view element was outside the scrollable area. Setting `right: 0` made `scrollDirection` work with all both `x`, `y` and `auto`.

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/scrollable/README.md (MODIFIED, +14/-8)
- packages/components/src/scrollable/component.tsx (RENAMED, +13/-10)
- packages/components/src/scrollable/hook.ts (RENAMED, +5/-7)
- packages/components/src/scrollable/index.ts (RENAMED, +0/-0)
- packages/components/src/scrollable/stories/index.tsx (RENAMED, +29/-34)
- packages/components/src/scrollable/styles.ts (RENAMED, +0/-0)
- packages/components/src/scrollable/test/__snapshots__/index.tsx.snap (RENAMED, +1/-0)
- packages/components/src/scrollable/test/index.js (DELETED, +0/-31)
- packages/components/src/scrollable/test/index.tsx (ADDED, +34/-0)
- packages/components/src/scrollable/types.ts (MODIFIED, +10/-5)
