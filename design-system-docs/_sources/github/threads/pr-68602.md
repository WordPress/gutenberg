...
type: pull_request
state: MERGED
merged_at: 2025-01-14T09:58:50Z
url: https://github.com/WordPress/gutenberg/pull/68602
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Focus] Accessibility (a11y)","[Package] Components"]
---

# PR #68602: Fix usage of tooltip in the Circular option picker.

- URL: https://github.com/WordPress/gutenberg/pull/68602
- Author: afercia
- Created: 2025-01-10T14:40:38Z
- Updated: 2025-01-14T09:59:21Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 21 of 21
- Diff: ../pr-diffs/68602.diff
...
### github-actions on 2025-01-10T15:40:53Z

URL: https://github.com/WordPress/gutenberg/pull/68602#issuecomment-2582988868
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 229 kB | -43 B (-0.02%) |
...
| `build/block-library/blocks/gallery/editor-rtl.css` | 933 B |
| `build/block-library/blocks/gallery/editor.css` | 938 B |
...
| `build/editor/style.css` | 9.36 kB |
...
### github-actions on 2025-01-13T12:50:01Z

URL: https://github.com/WordPress/gutenberg/pull/68602#issuecomment-2587021151
...
### afercia on 2025-01-13T12:52:37Z

URL: https://github.com/WordPress/gutenberg/pull/68602#issuecomment-2587026804
...
- packages/block-editor/src/components/colors-gradients/test/control.js (MODIFIED, +2/-2)
- packages/block-library/src/cover/test/edit.js (MODIFIED, +7/-7)
- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/border-control/test/index.js (MODIFIED, +12/-4)
- packages/components/src/circular-option-picker/README.md (MODIFIED, +1/-2)
- packages/components/src/circular-option-picker/circular-option-picker-option.tsx (MODIFIED, +17/-10)
- packages/components/src/circular-option-picker/circular-option-picker.tsx (MODIFIED, +0/-1)
- packages/components/src/circular-option-picker/stories/index.story.tsx (MODIFIED, +0/-1)
- packages/components/src/color-palette/index.tsx (MODIFIED, +0/-7)
- packages/components/src/color-palette/test/index.tsx (MODIFIED, +2/-8)
- packages/components/src/palette-edit/test/index.tsx (MODIFIED, +1/-1)
...
- test/e2e/specs/editor/various/format-library/text-color.spec.js (MODIFIED, +1/-1)
- test/e2e/specs/editor/various/keep-styles-on-block-transforms.spec.js (MODIFIED, +1/-1)
- test/e2e/specs/editor/various/list-view.spec.js (MODIFIED, +4/-1)
- test/e2e/specs/site-editor/style-variations.spec.js (MODIFIED, +3/-3)
- test/e2e/specs/site-editor/user-global-styles-revisions.spec.js (MODIFIED, +1/-1)
