...
type: pull_request
state: MERGED
merged_at: 2021-10-15T15:40:49Z
url: https://github.com/WordPress/gutenberg/pull/35673
...
# PR #35673: Components: mark `CustomSelectControl` `hint` option as experimental

- URL: https://github.com/WordPress/gutenberg/pull/35673
- Author: ciampo
- Created: 2021-10-15T13:54:49Z
- Updated: 2021-10-15T15:41:15Z
- Comments: 6 of 6
- Review threads: 1 of 1
- Changed files: 3 of 3
- Diff: ../pr-diffs/35673.diff
...
Rename the `hint` property for the `CustomSelectControl` options introduced in #35395 to `__experimentalHint`, add CHANGELOG entry
...
### ciampo on 2021-10-15T14:26:41Z

URL: https://github.com/WordPress/gutenberg/pull/35673#issuecomment-944346236

> I was wondering if we should make this experimental for now

Usually marking a component as experimental means:

- Marking it as such in the README
- Exporting it with a `__experimental` prefix
...
### ntsekouras on 2021-10-15T14:29:36Z

URL: https://github.com/WordPress/gutenberg/pull/35673#issuecomment-944348401

Oh no... I meant making(prefixing) the new property experimental, not the component. Sorry for the confusion I caused 😄

### ciampo on 2021-10-15T14:33:20Z

URL: https://github.com/WordPress/gutenberg/pull/35673#issuecomment-944350779

> Oh no... I meant making(prefixing) the new property experimental, not the component. Sorry for the confusion I caused 😄

Ah I see! Do you mean something like `__experimentalHint` ?

### ntsekouras on 2021-10-15T14:34:47Z

URL: https://github.com/WordPress/gutenberg/pull/35673#issuecomment-944351820

>Ah I see! Do you mean something like __experimentalHint ?

Exactly!

### ciampo on 2021-10-15T14:43:50Z

URL: https://github.com/WordPress/gutenberg/pull/35673#issuecomment-944358615

> > Ah I see! Do you mean something like __experimentalHint ?
> 
> Exactly!

Hey @ntsekouras , I renamed the prop as suggested, based the changes made in #35395.

Could you give it another round of review and make sure that I haven't missed any place when renaming the prop? Thank you!

### github-actions on 2021-10-15T14:47:39Z

URL: https://github.com/WordPress/gutenberg/pull/35673#issuecomment-944361407
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 212 kB | +13 B (0%) |
...
#### ciampo on 2021-10-15T13:55:29Z

URL: https://github.com/WordPress/gutenberg/pull/35673#discussion_r729840988
...
Not 100% sure about the type of `hint` — @ntsekouras can you confirm if this is correct?

#### ntsekouras on 2021-10-15T14:13:23Z

URL: https://github.com/WordPress/gutenberg/pull/35673#discussion_r729858017
Path: packages/components/src/custom-select-control/README.md
...
I think the type you have is okay 👍

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/custom-select-control/index.js (MODIFIED, +3/-3)
- packages/components/src/font-size-picker/utils.js (MODIFIED, +2/-1)
