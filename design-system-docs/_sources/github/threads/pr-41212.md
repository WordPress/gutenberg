...
type: pull_request
state: MERGED
merged_at: 2022-05-31T16:04:12Z
url: https://github.com/WordPress/gutenberg/pull/41212
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Feature] UI Components","[Type] Code Quality","[Package] Components"]
---

# PR #41212: Surface: Convert component to TypeScript

- URL: https://github.com/WordPress/gutenberg/pull/41212
- Author: walbo
- Created: 2022-05-20T22:18:31Z
- Updated: 2022-05-31T16:04:38Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 12 of 12
- Diff: ../pr-diffs/41212.diff
...
## What?
Converts the `Surface` component to TypeScript.

## Why?
Part of the @wordpress/components's TypeScript migration (#35744).

## How?
Refactors the current `Surface` component to TypeScript.

## Testing Instructions
- Run npm run dev and ensure no typing errors
- Fire up the Storybook and confirm the `Surface` continues to function as expected

## Issue comments

### github-actions on 2022-05-20T22:26:50Z

URL: https://github.com/WordPress/gutenberg/pull/41212#issuecomment-1133433428
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 228 kB | +5 B (0%) |
...
- packages/components/src/surface/component.tsx (RENAMED, +13/-7)
- packages/components/src/surface/hook.ts (RENAMED, +13/-12)
- packages/components/src/surface/index.ts (RENAMED, +0/-0)
- packages/components/src/surface/stories/index.js (DELETED, +0/-46)
- packages/components/src/surface/stories/index.tsx (ADDED, +40/-0)
- packages/components/src/surface/styles.ts (RENAMED, +15/-44)
- packages/components/src/surface/test/__snapshots__/index.tsx.snap (RENAMED, +0/-0)
- packages/components/src/surface/test/index.tsx (RENAMED, +2/-1)
