...
type: pull_request
state: MERGED
merged_at: 2026-03-06T08:24:22Z
url: https://github.com/WordPress/gutenberg/pull/76230
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components","[Package] Editor"]
---

# PR #76230: Revert "`Button`: Add `word-break: break-word`"

- URL: https://github.com/WordPress/gutenberg/pull/76230
- Author: ntsekouras
- Created: 2026-03-06T07:36:19Z
- Updated: 2026-03-06T08:25:07Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 6 of 6
- Diff: ../pr-diffs/76230.diff
...
### github-actions on 2026-03-06T07:41:03Z

URL: https://github.com/WordPress/gutenberg/pull/76230#issuecomment-4010115127
...
### github-actions on 2026-03-06T07:53:40Z

URL: https://github.com/WordPress/gutenberg/pull/76230#issuecomment-4010162467
...
| :--- | :---: | :---: |
| `build/scripts/editor/index.min.js` | 350 kB | +11 B (0%) |
| `build/styles/components/style-rtl.css` | 17.6 kB | -12 B (-0.07%) |
| `build/styles/components/style-rtl.min.css` | 14.4 kB | -18 B (-0.12%) |
...
| `build/styles/editor/style-rtl.min.css` | 19.9 kB | +11 B (+0.06%) |
| `build/styles/editor/style.css` | 23.4 kB | +14 B (+0.06%) |
| `build/styles/editor/style.min.css` | 19.9 kB | +11 B (+0.06%) |
...
### github-actions on 2026-03-06T08:05:14Z

URL: https://github.com/WordPress/gutenberg/pull/76230#issuecomment-4010206283

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 94d51d411921307e5ca1ab438f116a8dcd3a612c.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/22753982000
📝  Reported issues:
...
### ntsekouras on 2026-03-06T08:12:08Z

URL: https://github.com/WordPress/gutenberg/pull/76230#issuecomment-4010235449

>Do we also need to revert the follow-ups? I trust your judgement on this.

The only follow up that landed was the [DateTimePicker](https://github.com/WordPress/gutenberg/pull/76084) one, which was the right thing to do regardless and isn't affected visually by making the `padding:0`.
...
- packages/editor/src/components/post-url/panel.js (MODIFIED, +1/-0)
- packages/editor/src/components/post-url/style.scss (MODIFIED, +5/-0)
