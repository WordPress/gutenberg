...
type: pull_request
state: MERGED
merged_at: 2022-11-29T09:51:13Z
url: https://github.com/WordPress/gutenberg/pull/45968
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #45968: Components: Improve `BoxControl` tests

- URL: https://github.com/WordPress/gutenberg/pull/45968
- Author: tyxla
- Created: 2022-11-22T12:40:08Z
- Updated: 2022-11-29T09:51:46Z
- Comments: 3 of 3
- Review threads: 1 of 1
- Changed files: 1 of 1
- Diff: ../pr-diffs/45968.diff

## Body

## What?
This PR is improving the existing tests of the `BoxControl` component. Easiest to review commit-by-commit.
...
* Fixing the `no-node-access` violation by using a `screen.getByRole()` query.
* Get rid of `getInput()` helper and improve input query.
* Get rid of `getSelect()` helper and improve the combobox query.
* Get rid of `getReset()` helper and improve reset button query.
* Get rid of `setupUser()` and inline its calls.
* Add whitespaces to improve readability of tests.
* Improve the name of the first test.
* Inline all constants that are used just once.
* Use `.toHaveLength()` instead of `x.length.toBe()`
* Improve precision of existing queries by using `getByRole()` instead of the less-specific queries.
* Remove wrapper component mock redundancy and improve related assertions to be more user-centric.
...
### codesandbox on 2022-11-22T12:40:11Z

URL: https://github.com/WordPress/gutenberg/pull/45968#issuecomment-1323618908

<img alt="CodeSandbox logo" src="https://raw.githubusercontent.com/codesandbox/open-in-codesandbox/main/assets/csb.light.svg#gh-dark-mode-only" /><img alt="CodeSandbox logo" src="https://raw.githubusercontent.com/codesandbox/open-in-codesandbox/main/assets/csb.svg#gh-light-mode-only" />&nbsp; Open in CodeSandbox <a href="https://codesandbox.io/p/github/WordPress/gutenberg/improve/box-control-tests?workspace=%7B%22gitSidebarPanel%22:%22PR%22,%22sidebarPanel%22:%22GIT%22%7D">Web Editor</a> | <a href="https://codesandbox.io/p/vscode?owner=WordPress&repo=gutenberg&branch=improve/box-control-tests">VS Code</a> | <a href="https://codesandbox.io/p/vscode?owner=WordPress&repo=gutenberg&branch=improve/box-control-tests&insiders=true">VS Code Insiders</a>

<!-- open-in-codesandbox:complete -->

### github-actions on 2022-11-22T12:49:11Z

URL: https://github.com/WordPress/gutenberg/pull/45968#issuecomment-1323629431
...
### tyxla on 2022-11-23T12:44:18Z

URL: https://github.com/WordPress/gutenberg/pull/45968#issuecomment-1325002764

Note that the failing check is not related to this PR and I've filed a fix for it in https://github.com/WordPress/gutenberg/pull/45999.

## Review threads

### Review thread 1 (resolved)

#### Mamaduka on 2022-11-23T05:57:00Z

URL: https://github.com/WordPress/gutenberg/pull/45968#discussion_r1030043969
Path: packages/components/src/box-control/test/index.js

```diff
@@ -164,6 +192,9 @@ describe( 'BoxControl', () => {
...
Should we use the wrapper testing component in the remaining places where we "mock" the state?
...
#### tyxla on 2022-11-23T12:35:17Z

URL: https://github.com/WordPress/gutenberg/pull/45968#discussion_r1030389280
Path: packages/components/src/box-control/test/index.js
...
Sure thing! This is the only bit we haven't touched in this refactor PR 😅 

I've addressed your suggestion in https://github.com/WordPress/gutenberg/pull/45968/commits/c3f0a3718de23a07ade06d20b878701795d6046d where I removed the wrapper component mock redundancy and improved related assertions to be more user-centric.

Let me know what you think!

## Changed files

- packages/components/src/box-control/test/index.js (MODIFIED, +206/-135)
