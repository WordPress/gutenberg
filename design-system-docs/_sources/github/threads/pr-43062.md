...
type: pull_request
state: MERGED
merged_at: 2022-08-11T18:50:28Z
url: https://github.com/WordPress/gutenberg/pull/43062
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #43062: FontSizePicker: Add flag to remove bottom margin

- URL: https://github.com/WordPress/gutenberg/pull/43062
- Author: mirka
- Created: 2022-08-08T12:31:24Z
- Updated: 2022-08-11T18:50:58Z
- Comments: 2 of 2
- Review threads: 2 of 2
- Changed files: 10 of 10
- Diff: ../pr-diffs/43062.diff
...
### github-actions on 2022-08-08T12:38:31Z

URL: https://github.com/WordPress/gutenberg/pull/43062#issuecomment-1208074248
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 231 kB | +95 B (0%) |
| `build/components/style-rtl.css` | 14 kB | +13 B (0%) |
| `build/components/style.css` | 14 kB | +14 B (0%) |
...
### mirka on 2022-08-11T15:55:49Z

URL: https://github.com/WordPress/gutenberg/pull/43062#issuecomment-1212179698

> Also noting that e2e may be related, since they're flagging an issue with the Font Size Picker tests

It was 😱 I'm so glad there was a test that caught it, it would've been very bad if that was merged 😱😱 9db8f69

_Conditional Components: A Cautionary Tale_

## Review threads

### Review thread 1 (resolved)

#### mirka on 2022-08-08T13:25:01Z

URL: https://github.com/WordPress/gutenberg/pull/43062#discussion_r940234870
Path: packages/components/src/font-size-picker/index.js

```diff
@@ -118,6 +126,13 @@ function FontSizePicker(
 		return null;
 	}
...
This is needed to maintain the spacing before the slider in the `withSlider` case 😅

#### ciampo on 2022-08-10T13:44:56Z

URL: https://github.com/WordPress/gutenberg/pull/43062#discussion_r942470823
Path: packages/components/src/font-size-picker/index.js
...
Thank you! It would have taken me a while to understand, without this comment :)

### Review thread 2

#### mirka on 2022-08-08T13:29:40Z

URL: https://github.com/WordPress/gutenberg/pull/43062#discussion_r940243128
...
![Small space after the input field](https://user-images.githubusercontent.com/555336/183429306-41b5434d-2a6c-498b-b4b0-20a1591f83ed.png)

#### ciampo on 2022-08-10T13:44:27Z

URL: https://github.com/WordPress/gutenberg/pull/43062#discussion_r942470241
Path: packages/components/src/range-control/index.tsx
...
The easiest fix would be to change `RangeControl`'s [`Root` element](https://github.com/WordPress/gutenberg/blob/a862658f8a8b94e1be4e2c53ebc4c12fdf02d575/packages/components/src/range-control/styles/range-control-styles.ts#L32) from `display: inline-flex` to `display: flex`.
...
#### mirka on 2022-08-11T15:52:36Z

URL: https://github.com/WordPress/gutenberg/pull/43062#discussion_r943649123
Path: packages/components/src/range-control/index.tsx
...
- packages/components/src/font-size-picker/index.js (MODIFIED, +132/-102)
- packages/components/src/font-size-picker/stories/index.js (MODIFIED, +1/-0)
- packages/components/src/font-size-picker/style.scss (MODIFIED, +4/-1)
- packages/components/src/range-control/index.tsx (MODIFIED, +3/-0)
- packages/components/src/range-control/styles/range-control-styles.ts (MODIFIED, +9/-3)
- packages/components/src/range-control/types.ts (MODIFIED, +5/-2)
- packages/components/src/toggle-group-control/stories/index.js (MODIFIED, +5/-2)
- packages/components/src/toggle-group-control/toggle-group-control/component.tsx (MODIFIED, +5/-1)
- packages/components/src/toggle-group-control/types.ts (MODIFIED, +50/-53)
