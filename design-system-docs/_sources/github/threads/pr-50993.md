...
type: pull_request
state: MERGED
merged_at: 2023-05-27T04:55:17Z
url: https://github.com/WordPress/gutenberg/pull/50993
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Focus] Accessibility (a11y)","[Package] Components"]
---

# PR #50993: Add aria labels to the focal point picker component

- URL: https://github.com/WordPress/gutenberg/pull/50993
- Author: carolinan
- Created: 2023-05-26T08:15:02Z
- Updated: 2023-07-24T12:55:54Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 3 of 3
- Diff: ../pr-diffs/50993.diff
...
Previously, when using a screen reader, the focal point picker input controls would only announced "left" and "top" without context.
Before:
value, left, stepper
value, top, stepper

This PR adds an aria label to each input control. The visible text label is unchanged.
After:
value, focal point left position, stepper
value, focal point top position, stepper

Closes
https://github.com/WordPress/gutenberg/issues/50991

## Why?
<!-- Why is this PR necessary? What problem is it solving? Reference any existing previous issue(s) or PR(s), but please add a short summary here, too -->
The lack of context made the control confusing.
...
Activate your screen reader. I tested with VoiceOver on mac.
In the block editor, add a cover block with an image.
Navigate to the block settings sidebar, and tab through the settings tab.
Confirm that the aria labels for the focal point picker are announced.

## Issue comments

### github-actions on 2023-05-26T08:51:11Z

URL: https://github.com/WordPress/gutenberg/pull/50993#issuecomment-1564039691
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 230 kB | +22 B (0%) |
...
- packages/components/src/focal-point-picker/controls.tsx (MODIFIED, +2/-0)
- packages/components/src/focal-point-picker/test/index.js (MODIFIED, +9/-3)
