...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/75265
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components","[Package] Editor"]
---

# PR #75265: DateTimePicker: Fix Invalid Date errors in date field validation

- URL: https://github.com/WordPress/gutenberg/pull/75265
- Author: getdave
- Created: 2026-02-05T20:03:18Z
- Updated: 2026-02-10T14:32:22Z
- Comments: 8 of 8
- Review threads: 0 of 0
- Changed files: 5 of 5
- Diff: ../pr-diffs/75265.diff
...
### github-actions on 2026-02-05T20:11:51Z

URL: https://github.com/WordPress/gutenberg/pull/75265#issuecomment-3855957148
...
### getdave on 2026-02-05T20:12:46Z

URL: https://github.com/WordPress/gutenberg/pull/75265#issuecomment-3855960871
...
### github-actions on 2026-02-05T20:14:33Z

URL: https://github.com/WordPress/gutenberg/pull/75265#issuecomment-3855968325
...
| :--- | :---: | :---: |
| `build/scripts/components/index.min.js` | 266 kB | +336 B (+0.13%) |
| `build/scripts/editor/index.min.js` | 323 kB | +33 B (+0.01%) |
...
### getdave on 2026-02-06T09:41:54Z

URL: https://github.com/WordPress/gutenberg/pull/75265#issuecomment-3859150893

Yes I agree there's a route here to ship a simple targeted fix to the Core error. 

I still think we'll need to circle back to addrss some of the UX issues though. The picker provides a very poor experience. After all it's a _scheduling_ interface that allows picking dates in the _past_.

### tyxla on 2026-02-06T09:48:16Z

URL: https://github.com/WordPress/gutenberg/pull/75265#issuecomment-3859195495
...
### getdave on 2026-02-06T09:54:09Z

URL: https://github.com/WordPress/gutenberg/pull/75265#issuecomment-3859235347

> Yes I agree there's a route here to ship a simple targeted fix to the Core error.

I agree - here's my simpler fix https://github.com/WordPress/gutenberg/pull/75285

### getdave on 2026-02-06T10:31:04Z

URL: https://github.com/WordPress/gutenberg/pull/75265#issuecomment-3859515882

I've raised #75285 as a simpler alternative approach to this PR. It focuses on a minimal changeset by adding validation at the `onChange` emission point in the TimePicker component, incorporating your suggestion to use `isFinite()` for the Invalid Date check. Would appreciate your thoughts on which approach you think is better for addressing #75254.

### tyxla on 2026-02-06T11:05:22Z

URL: https://github.com/WordPress/gutenberg/pull/75265#issuecomment-3859759538
...
- packages/components/src/date-time/test/utils.test.ts (MODIFIED, +53/-1)
- packages/components/src/date-time/time/index.tsx (MODIFIED, +99/-11)
- packages/components/src/date-time/time/test/index.tsx (MODIFIED, +361/-0)
- packages/components/src/date-time/utils.ts (MODIFIED, +30/-1)
- packages/editor/src/components/post-schedule/index.js (MODIFIED, +5/-3)
