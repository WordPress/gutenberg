...
type: pull_request
state: MERGED
merged_at: 2021-06-23T23:23:16Z
url: https://github.com/WordPress/gutenberg/pull/32852
...
# PR #32852: components: Remove duplicated space utilities

- URL: https://github.com/WordPress/gutenberg/pull/32852
- Author: sarayourfriend
- Created: 2021-06-21T14:48:26Z
- Updated: 2021-06-23T23:23:39Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 8 of 8
- Diff: ../pr-diffs/32852.diff
...
## Description
Removes the old `space` utility and replaces it with the one from `ui`. In a follow up PR I'll move the `ui/utils/space` into the upper `utils` folder.

Note: The old space utility used a base of 8 and the new one uses a base of 4, so I just had to double all the values being passed into the old utility.

## How has this been tested?
Test in storybook. Go to each of the affected components (`BaseControl`, `RangeControl`, `Navigation`, and `Card`) and compare against production (https://wordpress.github.ui/gutenberg) and ensure that the padding and spacings are all the same.
...
### github-actions on 2021-06-21T14:54:48Z

URL: https://github.com/WordPress/gutenberg/pull/32852#issuecomment-865098409
...
| `build/edit-widgets/style-rtl.css` | 3.5 kB |
| `build/edit-widgets/style.css` | 3.5 kB |
...
| `build/widgets/style-rtl.css` | 722 B |
| `build/widgets/style.css` | 722 B |
...
### ciampo on 2021-06-22T13:31:55Z

URL: https://github.com/WordPress/gutenberg/pull/32852#issuecomment-865987206

@sarayourfriend would you mind rebasing, since the merging of #32566 caused some conflicts?

The new `Card` component should already be using the new `space` util function (via the common `CONFIG` object)
...
- packages/components/src/base-control/styles/base-control-styles.js (MODIFIED, +4/-3)
- packages/components/src/color-picker/test/__snapshots__/index.js.snap (MODIFIED, +12/-12)
- packages/components/src/navigation/styles/navigation-styles.js (MODIFIED, +27/-28)
- packages/components/src/range-control/styles/range-control-styles.js (MODIFIED, +4/-3)
- packages/components/src/utils/space.js (DELETED, +0/-13)
- packages/components/src/utils/style-mixins.js (MODIFIED, +0/-1)
- packages/edit-post/src/components/preferences-modal/options/test/__snapshots__/enable-custom-fields.js.snap (MODIFIED, +4/-4)
