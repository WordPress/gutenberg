...
type: pull_request
state: MERGED
merged_at: 2022-08-24T10:16:02Z
url: https://github.com/WordPress/gutenberg/pull/43495
matched_labels: ["[Package] Components"]
all_labels: ["[Feature] Document Settings","[Type] Code Quality","[Package] Components"]
---

# PR #43495: `DateTimePicker`: address feedback after recent refactor to `date-fns` and `use-lilius`

- URL: https://github.com/WordPress/gutenberg/pull/43495
- Author: noisysocks
- Created: 2022-08-23T01:30:08Z
- Updated: 2022-08-24T12:03:08Z
- Comments: 1 of 1
- Review threads: 2 of 2
- Changed files: 8 of 8
- Diff: ../pr-diffs/43495.diff
...
### github-actions on 2022-08-23T01:38:05Z

URL: https://github.com/WordPress/gutenberg/pull/43495#issuecomment-1223413004
...
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 159 kB | +370 B (0%) |
...
| `build/block-library/index.min.js` | 186 kB | +212 B (0%) |
...
| `build/components/index.min.js` | 198 kB | -511 B (0%) |
...
#### ciampo on 2022-08-23T15:50:45Z

URL: https://github.com/WordPress/gutenberg/pull/43495#discussion_r952805833
Path: packages/components/src/date-time/date/styles.ts

```diff
@@ -35,6 +39,7 @@ export const Calendar = styled.div`
...
We also need to set the `line-height`, otherwise it will get overridden by WordPress styles
...
#### ciampo on 2022-08-23T16:03:04Z

URL: https://github.com/WordPress/gutenberg/pull/43495#discussion_r952822439
...
We could add a comment here explaining that the `! isUTCOffset()` check guarantees that `timezone` is not a `number`, and therefore is a `string`

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/date-time/date-time/index.tsx (MODIFIED, +3/-4)
- packages/components/src/date-time/date-time/styles.ts (MODIFIED, +9/-0)
- packages/components/src/date-time/date/index.tsx (MODIFIED, +26/-6)
- packages/components/src/date-time/date/styles.ts (MODIFIED, +6/-0)
- packages/components/src/date-time/date/test/index.tsx (MODIFIED, +6/-2)
- packages/components/src/date-time/time/styles.ts (MODIFIED, +1/-0)
- packages/date/src/index.js (MODIFIED, +2/-1)
