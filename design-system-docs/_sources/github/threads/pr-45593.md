...
type: pull_request
state: MERGED
merged_at: 2022-11-11T18:43:34Z
url: https://github.com/WordPress/gutenberg/pull/45593
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #45593: Making size prop work for icon components using dash icon strings

- URL: https://github.com/WordPress/gutenberg/pull/45593
- Author: matiasbenedetto
- Created: 2022-11-07T18:57:21Z
- Updated: 2022-11-11T18:44:02Z
- Comments: 3 of 3
- Review threads: 3 of 3
- Changed files: 4 of 4
- Diff: ../pr-diffs/45593.diff
...
## What?
Making size prop work for icon components using dash icon strings.


## Why?
Because currently is not working as the docs state: https://developer.wordpress.org/block-editor/reference-guides/components/icon/#size

## How?
Passing the prop to the child component and rendering the right styles/

## Testing Instructions
<!-- Please include step by step instructions on how to test this PR. -->
1. Import the icon component from `@wordpress/components` as:
`import { Icon }  from @wordpress/components;`
2. Render a dashicon like this:
`<Icon icon="plus-alt" size={10} />`
3. Check that the icon width and height are is10px.

## Issue comments

### codesandbox on 2022-11-07T18:57:23Z

URL: https://github.com/WordPress/gutenberg/pull/45593#issuecomment-1306048999

<img alt="CodeSandbox logo" src="https://raw.githubusercontent.com/codesandbox/open-in-codesandbox/main/assets/csb.light.svg#gh-dark-mode-only" /><img alt="CodeSandbox logo" src="https://raw.githubusercontent.com/codesandbox/open-in-codesandbox/main/assets/csb.svg#gh-light-mode-only" />&nbsp; Open in CodeSandbox <a href="https://codesandbox.io/p/github/WordPress/gutenberg/fix/dashicon-component-size?workspace=%7B%22gitSidebarPanel%22:%22PR%22,%22sidebarPanel%22:%22GIT%22%7D">Web Editor</a> | <a href="https://codesandbox.io/p/vscode?owner=WordPress&repo=gutenberg&branch=fix/dashicon-component-size">VS Code</a> | <a href="https://codesandbox.io/p/vscode?owner=WordPress&repo=gutenberg&branch=fix/dashicon-component-size&insiders=true">VS Code Insiders</a>

<!-- open-in-codesandbox:complete -->

### github-actions on 2022-11-07T19:10:14Z

URL: https://github.com/WordPress/gutenberg/pull/45593#issuecomment-1306065826
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 203 kB | +73 B (0%) |
...
### matiasbenedetto on 2022-11-10T19:37:35Z

URL: https://github.com/WordPress/gutenberg/pull/45593#issuecomment-1310805038

Thanks for the detailed review @mirka !
I think I addressed all your comments in the latest commits.

## Review threads

### Review thread 1

#### mirka on 2022-11-09T20:15:13Z

URL: https://github.com/WordPress/gutenberg/pull/45593#discussion_r1018373221
Path: packages/components/src/dashicon/index.js

```diff
@@ -20,7 +22,17 @@ function Dashicon( { icon, className, ...extraProps } ) {
 		.filter( Boolean )
 		.join( ' ' );
...
Should we also consider `"20"` (as string) to be the same as the default?

(No strong opinion on this one, it's just that a lot of people do things like `size="20"` and `size={ 20 }` kind of interchangeably in practice.)

#### matiasbenedetto on 2022-11-10T19:35:50Z

URL: https://github.com/WordPress/gutenberg/pull/45593#discussion_r1019540093
Path: packages/components/src/dashicon/index.js
...
I used `!=` to catch both 20 and "20". I added an inline comment to explain that.

### Review thread 2

#### mirka on 2022-11-09T20:16:26Z

URL: https://github.com/WordPress/gutenberg/pull/45593#discussion_r1018374240
Path: packages/components/src/dashicon/index.js
...
I think we need to merge the incoming `style` prop so it works as before.

```jsx
// So something like this still works
<Dashicon icon="foo" style={{ background: 'yellow' }} />
```

#### matiasbenedetto on 2022-11-10T19:34:42Z

URL: https://github.com/WordPress/gutenberg/pull/45593#discussion_r1019539169
Path: packages/components/src/dashicon/index.js
...
Goog catch, thanks! Done.

### Review thread 3

#### mirka on 2022-11-09T20:17:55Z

URL: https://github.com/WordPress/gutenberg/pull/45593#discussion_r1018375397
Path: packages/components/src/icon/test/index.js
...
- packages/components/src/dashicon/index.js (MODIFIED, +21/-2)
- packages/components/src/icon/index.tsx (MODIFIED, +3/-2)
- packages/components/src/icon/test/index.js (MODIFIED, +10/-0)
