...
type: pull_request
state: MERGED
merged_at: 2026-03-30T19:50:57Z
url: https://github.com/WordPress/gutenberg/pull/76761
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Focus] Accessibility (a11y)","[Package] Components"]
---

# PR #76761: ComboboxControl: Fix accessible association of `help` text

- URL: https://github.com/WordPress/gutenberg/pull/76761
- Author: mirka
- Created: 2026-03-23T12:05:40Z
- Updated: 2026-03-30T19:53:35Z
- Comments: 3 of 3
- Review threads: 4 of 4
- Changed files: 5 of 5
- Diff: ../pr-diffs/76761.diff

## Body

## What?

Fix the `help` prop on `ComboboxControl` so that it is programmatically associated with the combobox input via `aria-describedby`.

## Why?

The `help` text was being rendered visually (via `BaseControl`) but had no `aria-describedby` linking it to the combobox input. Screen reader users would not hear the help text when interacting with the control.

## How?

- In `ComboboxControl`, pass `aria-describedby` pointing to the `BaseControl`-rendered help element to `TokenInput` when `help` is provided.
- In `TokenInput`, merge any externally passed `aria-describedby` with the existing howto description ID, so both are present on the input.


Also adds `help` text to the default Storybook story.

## Testing Instructions

1. Run `npm run storybook:dev` and navigate to the `ComboboxControl` default story.
2. Inspect the combobox input and confirm it has `aria-describedby` referencing the help text element's `id`.
...
### github-actions on 2026-03-23T12:21:33Z

URL: https://github.com/WordPress/gutenberg/pull/76761#issuecomment-4110218418
...
| :--- | :---: | :---: |
| `build/scripts/components/index.min.js` | 265 kB | +24 B (+0.01%) |
...
| `build/scripts/edit-site/index.min.js` | 260 kB |
...
| `build/scripts/vendors/react-dom.min.js` | 43.5 kB |
...
### github-actions on 2026-03-23T12:30:41Z

URL: https://github.com/WordPress/gutenberg/pull/76761#issuecomment-4110270361
...
### github-actions on 2026-03-23T12:36:46Z

URL: https://github.com/WordPress/gutenberg/pull/76761#issuecomment-4110303657

<!-- flaky-tests-report-comment -->
**Flaky tests detected in c77de1f62f0b81f64c071edb107cc8b79e10b7f8.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/23762176772
📝  Reported issues:
...
#### mirka on 2026-03-23T12:06:14Z

URL: https://github.com/WordPress/gutenberg/pull/76761#discussion_r2974622909
...
#### mirka on 2026-03-23T12:06:40Z

URL: https://github.com/WordPress/gutenberg/pull/76761#discussion_r2974624987
Path: packages/components/src/combobox-control/index.tsx

```diff
@@ -358,6 +358,11 @@ function ComboboxControl( props: ComboboxControlProps ) {
 									matchingSuggestions
 								) }
...
#### ciampo on 2026-03-26T10:45:27Z

URL: https://github.com/WordPress/gutenberg/pull/76761#discussion_r2993934762
Path: packages/components/src/combobox-control/index.tsx
...
#### mirka on 2026-03-30T18:56:52Z

URL: https://github.com/WordPress/gutenberg/pull/76761#discussion_r3011621688
Path: packages/components/src/combobox-control/index.tsx
...
Added todo comment in 433fd0e98da994929035f5fd1850aa6cd381da12

### Review thread 3 (resolved)

#### aduth on 2026-03-25T20:15:23Z

URL: https://github.com/WordPress/gutenberg/pull/76761#discussion_r2990799534
Path: packages/components/src/combobox-control/index.tsx
...
Passing comment before taking a closer look, but curious if/how this actually works, since looking at the FormTokenInput implementation, my instinct is that its own [`aria-describedby` assignment](https://github.com/WordPress/gutenberg/blob/d340215b6f1e72ca295feece063241b352e5b2a3/packages/components/src/form-token-field/token-input.tsx#L89) would take precedence over [applied incoming props](https://github.com/WordPress/gutenberg/blob/d340215b6f1e72ca295feece063241b352e5b2a3/packages/components/src/form-token-field/token-input.tsx#L61).

#### ciampo on 2026-03-26T10:16:46Z

URL: https://github.com/WordPress/gutenberg/pull/76761#discussion_r2993783116
Path: packages/components/src/combobox-control/index.tsx
...
@aduth it looks like this PR applies changes to that component that merge the internal and external `aria-describedby` values?

#### aduth on 2026-03-26T11:58:15Z

URL: https://github.com/WordPress/gutenberg/pull/76761#discussion_r2994376101
Path: packages/components/src/combobox-control/index.tsx
...
🤦 I should have scrolled down in the diff rather than looking at the file on my copy of `trunk`.

### Review thread 4

#### ciampo on 2026-03-26T10:45:21Z

URL: https://github.com/WordPress/gutenberg/pull/76761#discussion_r2993934231
...
#### mirka on 2026-03-30T18:58:01Z

URL: https://github.com/WordPress/gutenberg/pull/76761#discussion_r3011627205
Path: packages/components/src/combobox-control/stories/index.story.tsx
...
Tweaked to make the help text generic like we do with newer components, and tweaked the label text so they follow our copy guidance (c77de1f62f0b81f64c071edb107cc8b79e10b7f8).

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/combobox-control/index.tsx (MODIFIED, +6/-0)
- packages/components/src/combobox-control/stories/index.story.tsx (MODIFIED, +3/-2)
- packages/components/src/combobox-control/test/index.tsx (MODIFIED, +16/-9)
- packages/components/src/form-token-field/token-input.tsx (MODIFIED, +7/-1)
