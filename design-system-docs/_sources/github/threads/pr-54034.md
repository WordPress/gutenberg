...
type: pull_request
state: MERGED
merged_at: 2023-09-04T12:33:48Z
url: https://github.com/WordPress/gutenberg/pull/54034
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #54034: PaletteEdit: Fix padding in RTL mode

- URL: https://github.com/WordPress/gutenberg/pull/54034
- Author: walbo
- Created: 2023-08-29T16:58:31Z
- Updated: 2023-09-04T12:34:10Z
- Comments: 1 of 1
- Review threads: 1 of 1
- Changed files: 2 of 2
- Diff: ../pr-diffs/54034.diff
...
Fix right and left padding on `PaletteEdit` for RTL languages.

## Why?
<!-- Why is this PR necessary? What problem is it solving? Reference any existing previous issue(s) or PR(s), but please add a short summary here, too -->
Make the component design look correct in both LTR og RTL sites.

## How?
<!-- How is your PR addressing the issue at hand? What are the implementation details? -->
Flip `padding-left` and `padding-right` values on RTL sites by using the `rtl` function.

## Testing Instructions
1. Open up the storybook.
2. Navigate to `PaletteEdit` component.
3. Turn on RTL in storybook.
4. Test the component.

## Screenshots or screencast <!-- if applicable -->
| Before | After |
|-----|-----|
| <img width="290" alt="image" src="https://github.com/WordPress/gutenberg/assets/1415747/c583da3c-0ab4-4ae5-82e7-bead346ea411"> | <img width="290" alt="image" src="https://github.com/WordPress/gutenberg/assets/1415747/36b81ac4-a3c2-42f4-964f-b90fd0c4c315"> |

## Issue comments

### github-actions on 2023-08-29T17:11:53Z

URL: https://github.com/WordPress/gutenberg/pull/54034#issuecomment-1697839208
...
#### mirka on 2023-08-31T19:37:21Z

URL: https://github.com/WordPress/gutenberg/pull/54034#discussion_r1312136641
Path: packages/components/src/palette-edit/styles.js
...
Could we just use `padding-inline-start`?

#### walbo on 2023-09-04T07:13:07Z

URL: https://github.com/WordPress/gutenberg/pull/54034#discussion_r1314524109
Path: packages/components/src/palette-edit/styles.js
...
Yes 👍  Start seems like a better solution. I will update the PR later today.

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +4/-0)
- packages/components/src/palette-edit/styles.js (MODIFIED, +2/-1)
