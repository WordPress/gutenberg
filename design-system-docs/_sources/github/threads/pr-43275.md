...
type: pull_request
state: MERGED
merged_at: 2022-08-18T11:10:46Z
url: https://github.com/WordPress/gutenberg/pull/43275
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #43275: Components: Refactor `MenuGroup` tests to `@testing-library/react`

- URL: https://github.com/WordPress/gutenberg/pull/43275
- Author: tyxla
- Created: 2022-08-16T13:58:02Z
- Updated: 2022-08-18T11:19:56Z
- Comments: 1 of 1
- Review threads: 1 of 1
- Changed files: 3 of 3
- Diff: ../pr-diffs/43275.diff
...
This PR refactors the `<MenuGroup />` component tests from `enzyme` to `@testing-library/react`.
...
## How?
We're straightforwardly replacing `enzyme` tests with `@testing-library/react` ones, using `jest-dom` matchers and screen queries to find elements.

We're also removing an unnecessary snapshot test and replacing it with user-oriented functionality tests.

## Testing Instructions
Verify tests pass: `npm run test:unit packages/components/src/menu-group/test/index.js`

## Issue comments

### github-actions on 2022-08-16T14:33:48Z

URL: https://github.com/WordPress/gutenberg/pull/43275#issuecomment-1216722866
...
#### mirka on 2022-08-18T08:51:19Z

URL: https://github.com/WordPress/gutenberg/pull/43275#discussion_r948830484
Path: packages/components/src/menu-group/test/index.js
...
(If you want, I think we can convert this test file to a `.tsx` and it will warn about these RTL mishaps.)

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/menu-group/test/__snapshots__/index.js.snap (DELETED, +0/-23)
- packages/components/src/menu-group/test/index.js (MODIFIED, +18/-7)
