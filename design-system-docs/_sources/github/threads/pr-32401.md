...
type: pull_request
state: MERGED
merged_at: 2021-06-03T12:30:28Z
url: https://github.com/WordPress/gutenberg/pull/32401
...
# PR #32401: Storybook: fix misc warnings

- URL: https://github.com/WordPress/gutenberg/pull/32401
- Author: ciampo
- Created: 2021-06-02T13:12:31Z
- Updated: 2021-06-03T12:30:50Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 3 of 3
- Diff: ../pr-diffs/32401.diff
...
Fixes a few warnings prompted in Storybook related to:

- incorrect import path for the `View` component
- missing `ref` parameter in the `<ItemGroup />` component
- broken DOM structure and layout in `ContextSystemProvider` story
...
On latest `trunk`, run `npm run storybook:dev`. Once Storybook has loaded in the browser, open the dev console and check these warnings: 
![image](https://user-images.githubusercontent.com/1083581/120485436-5f940d80-c3b4-11eb-9e6e-26eed99d3dba.png)

Now check this PR out, run the same `npm run storybook:dev` out, and make sure that the warnings are gone, while the `<ItemGroup />` story continues to work.


Also, visit `http://localhost:50240/?path=/story/g2-components-experimental-contextsystemprovider--default` and make sure that the `ContextSystemProvider` story renders correctly
...
### github-actions on 2021-06-02T13:20:57Z

URL: https://github.com/WordPress/gutenberg/pull/32401#issuecomment-853022186
...
| :--- | :---: | :---: |
| `build/block-editor/style-rtl.css` | 12.9 kB | -2 B (0%) |
| `build/block-editor/style.css` | 12.9 kB | -3 B (0%) |
| `build/block-library/index.js` | 147 kB | +122 B (0%) |
| `build/edit-post/index.js` | 58.4 kB | +16 B (0%) |
| `build/edit-site/index.js` | 25.9 kB | +10 B (0%) |
...
- packages/components/src/ui/context/stories/ComponentsProvider.stories.js (MODIFIED, +6/-2)
- packages/components/src/ui/item-group/item-group.tsx (MODIFIED, +11/-2)
