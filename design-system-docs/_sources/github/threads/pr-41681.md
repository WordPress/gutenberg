...
type: pull_request
state: MERGED
merged_at: 2022-06-14T16:06:02Z
url: https://github.com/WordPress/gutenberg/pull/41681
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Feature] UI Components","[Type] Code Quality","[Package] Components"]
---

# PR #41681: ExternalLink: Convert component to TypeScript

- URL: https://github.com/WordPress/gutenberg/pull/41681
- Author: walbo
- Created: 2022-06-12T22:02:52Z
- Updated: 2022-06-14T16:06:30Z
- Comments: 1 of 1
- Review threads: 1 of 1
- Changed files: 8 of 8
- Diff: ../pr-diffs/41681.diff
...
## What?
Converts the `ExternalLink` component to TypeScript.

## Why?
Part of the @wordpress/components's TypeScript migration (https://github.com/WordPress/gutenberg/issues/35744).

## How?
Refactors the current `ExternalLink` to TypeScript.

## Testing Instructions
1. Run npm run dev and ensure no typing errors
2. Fire up the Storybook and confirm the `ExternalLink` continues to function as expected
3. Test the various external links within the block/site editors in Gutenberg still work

## Issue comments

### github-actions on 2022-06-12T22:10:37Z

URL: https://github.com/WordPress/gutenberg/pull/41681#issuecomment-1153304832
...
#### mirka on 2022-06-13T23:14:17Z

URL: https://github.com/WordPress/gutenberg/pull/41681#discussion_r896243668
Path: packages/components/src/external-link/types.ts
...
I feel like we should mark `children` as a required prop, no?

I'm also wondering if we should explicitly mark `href` as a required prop. What do you think? (cc @ciampo)

#### walbo on 2022-06-14T07:53:18Z

URL: https://github.com/WordPress/gutenberg/pull/41681#discussion_r896494094
Path: packages/components/src/external-link/types.ts
...
👍 I agree. Will update later today if no objections.

#### ciampo on 2022-06-14T12:58:21Z

URL: https://github.com/WordPress/gutenberg/pull/41681#discussion_r896785216
Path: packages/components/src/external-link/types.ts
...
Agreed on marking both `children` and `href` as required!

We should update the README accordingly too

#### walbo on 2022-06-14T14:40:18Z

URL: https://github.com/WordPress/gutenberg/pull/41681#discussion_r896913422
Path: packages/components/src/external-link/types.ts
...
👍  Have marked them as required and synced the README file

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/external-link/README.md (MODIFIED, +18/-0)
- packages/components/src/external-link/index.tsx (RENAMED, +26/-6)
- packages/components/src/external-link/stories/index.js (DELETED, +0/-23)
- packages/components/src/external-link/stories/index.tsx (ADDED, +36/-0)
- packages/components/src/external-link/styles/external-link-styles.ts (RENAMED, +0/-0)
- packages/components/src/external-link/types.ts (ADDED, +15/-0)
