...
type: pull_request
state: MERGED
merged_at: 2024-10-28T16:41:34Z
url: https://github.com/WordPress/gutenberg/pull/66097
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #66097: Tabs: remove custom logic

- URL: https://github.com/WordPress/gutenberg/pull/66097
- Author: ciampo
- Created: 2024-10-14T14:26:23Z
- Updated: 2024-10-31T09:48:21Z
- Comments: 12 of 12
- Review threads: 18 of 18
- Changed files: 5 of 5
- Diff: ../pr-diffs/66097.diff
...
### github-actions on 2024-10-14T17:01:33Z

URL: https://github.com/WordPress/gutenberg/pull/66097#issuecomment-2411798047
...
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 255 kB | +66 B (+0.03%) |
| `build/components/index.min.js` | 227 kB | -89 B (-0.04%) |
...
### github-actions on 2024-10-15T14:27:13Z

URL: https://github.com/WordPress/gutenberg/pull/66097#issuecomment-2414088856
...
### ciampo on 2024-10-15T14:28:44Z

URL: https://github.com/WordPress/gutenberg/pull/66097#issuecomment-2414092978
...
### ciampo on 2024-10-18T13:38:59Z

URL: https://github.com/WordPress/gutenberg/pull/66097#issuecomment-2422501515

Excuses for the many pings — not sure why GitHub decided to add as many reviewers on my behalf as the result of a rebase + target branch change. Please feel free to ignore this PR if you're _currently_ listed as a reviewer

### tyxla on 2024-10-22T15:20:20Z

URL: https://github.com/WordPress/gutenberg/pull/66097#issuecomment-2429579239

@ciampo is this one ready for review after the related PRs landed? If so, would it be possible to add some manual testing instructions?

### ciampo on 2024-10-22T15:33:08Z

URL: https://github.com/WordPress/gutenberg/pull/66097#issuecomment-2429610843

Yes, this PR is ready to review. I'll prepare some additional manual testing instructions specifically to the behavioural changes that happen when removing the custom logic, and ping you when they're ready.

### ciampo on 2024-10-23T08:29:38Z

URL: https://github.com/WordPress/gutenberg/pull/66097#issuecomment-2431296791

@tyxla I've added more details on the behavioral changes added by this PR. Hopefully, they can help in testing such changes (even if, probably, most of the behavioral changes can't be currently experienced in the editor). 

Let me know if you'd like more details — otherwise, this PR is ready for a review round.

### tyxla on 2024-10-23T15:15:30Z

URL: https://github.com/WordPress/gutenberg/pull/66097#issuecomment-2432584697

@ciampo sorry - I couldn't make it to testing and reviewing this one today, but planning to devote some time tomorrow.

### tyxla on 2024-10-29T09:18:11Z

URL: https://github.com/WordPress/gutenberg/pull/66097#issuecomment-2443663815

The performance impact of this PR on [inserter opening](https://www.codevitals.run/project/gutenberg/inserterOpen) is impressive:

![Screenshot 2024-10-29 at 11 16 59](https://github.com/user-attachments/assets/fad442d0-5f74-435e-a31b-0dff425e02e0)

### ciampo on 2024-10-29T09:20:56Z

URL: https://github.com/WordPress/gutenberg/pull/66097#issuecomment-2443669724
...
### ellatrix on 2024-10-31T09:13:06Z

URL: https://github.com/WordPress/gutenberg/pull/66097#issuecomment-2449383746

@ciampo Curious, what has changed here? Just rendering less components?

### ciampo on 2024-10-31T09:24:36Z

URL: https://github.com/WordPress/gutenberg/pull/66097#issuecomment-2449403306

@ellatrix  we removed a few hooks that were applying some logic to `Tabs`'s initial selection and re-selection if the selected tab becomes disabled or is removed (see https://github.com/WordPress/gutenberg/issues/66011 for more details).

The tabs in the inserter sidebar used some (but not all) of that logic, and so we only re-added the necessary bits (see https://github.com/WordPress/gutenberg/pull/66097#discussion_r1801253430)

## Review threads

### Review thread 1

#### ciampo on 2024-10-15T14:09:56Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1801253430
Path: packages/block-editor/src/components/inserter/category-tabs/index.js

```diff
@@ -31,11 +32,23 @@ function CategoryTabs( {
...
The custom logic added in https://github.com/WordPress/gutenberg/pull/60681 is now applied directly where `Tabs` is consumed. The result should be the same. (cc @jeryj )

#### jeryj on 2024-10-16T16:31:20Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1803450992
Path: packages/block-editor/src/components/inserter/category-tabs/index.js
...
#### ciampo on 2024-10-15T14:25:51Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1801287450
...
This is a bug fix that can be extracted and merged on `trunk`

#### ciampo on 2024-10-17T14:23:18Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1804888995
Path: packages/components/src/tabs/tablist.tsx
...
Fix extracted in https://github.com/WordPress/gutenberg/pull/66209

### Review thread 3 (resolved)

#### ciampo on 2024-10-15T14:26:49Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1801290344
...
The addition of these props, and their usage in the patterns inserter can be extracted to a separate PR

#### ciampo on 2024-10-18T13:12:41Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1806471671
Path: packages/components/src/tabs/types.ts
...
Added in https://github.com/WordPress/gutenberg/pull/66223

### Review thread 4

#### ciampo on 2024-10-23T07:58:12Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1812113140
...
The behaviour applied by this last custom hook is currently being discussed in https://github.com/ariakit/ariakit/issues/4213 , to understand whether it will be even incorporated into ariakit, or if it's even a reasonable fix to implement on our side in the first place.

It will be kept around for the time being.

### Review thread 5

#### ciampo on 2024-10-23T08:12:44Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1812145119
...
All of these extra, initial assertions were added to increase test stability — basically, we are waiting for ariakit to initialise and we do that by waiting for the correct tab to be selected.

### Review thread 6

#### ciampo on 2024-10-23T08:13:41Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1812147054
Path: packages/components/src/tabs/test/index.tsx
...
no behavioural change here, just moved assertions around to ensure better test stability

### Review thread 7

#### ciampo on 2024-10-23T08:14:17Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1812148227
Path: packages/components/src/tabs/test/index.tsx
...
#### ciampo on 2024-10-23T08:14:54Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1812149390
Path: packages/components/src/tabs/test/index.tsx
...
This test has changed to test the new behaviour

### Review thread 9

#### ciampo on 2024-10-23T08:16:24Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1812152472
Path: packages/components/src/tabs/test/index.tsx

```diff
@@ -715,14 +729,16 @@ describe( 'Tabs', () => {
...
This test was updated to test the new behavior

### Review thread 10

#### ciampo on 2024-10-23T08:16:54Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1812153883
Path: packages/components/src/tabs/test/index.tsx
...
#### ciampo on 2024-10-23T08:17:43Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1812155808
Path: packages/components/src/tabs/test/index.tsx
...
#### ciampo on 2024-10-23T08:19:26Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1812159301
Path: packages/components/src/tabs/test/index.tsx
...
#### ciampo on 2024-10-23T08:19:42Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1812159854
Path: packages/components/src/tabs/test/index.tsx
...
#### ciampo on 2024-10-23T08:20:02Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1812160562
Path: packages/components/src/tabs/test/index.tsx
...
This test was update to reflect the new behaviour

### Review thread 15

#### ciampo on 2024-10-23T08:21:09Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1812162724
Path: packages/components/src/tabs/test/index.tsx
...
#### ciampo on 2024-10-23T08:21:59Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1812164478
Path: packages/components/src/tabs/test/index.tsx
...
#### ciampo on 2024-10-23T08:22:04Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1812164626
Path: packages/components/src/tabs/test/index.tsx
...
#### tyxla on 2024-10-28T15:20:01Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1819264133
Path: packages/components/src/tabs/tab.tsx

```diff
@@ -22,20 +27,35 @@ export const Tab = forwardRef<
 	HTMLButtonElement,
...
We might want to refactor those early returns in the future. Do we have an open issue for that?

#### ciampo on 2024-10-28T16:03:13Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1819337781
Path: packages/components/src/tabs/tab.tsx
...
Do you mean the "Subcomponent must be wrapped in the top level component" warnings?  Just double-checking before I go ahead and create the issue.

#### tyxla on 2024-10-28T16:08:31Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1819345798
Path: packages/components/src/tabs/tab.tsx
...
#### ciampo on 2024-10-28T16:19:55Z

URL: https://github.com/WordPress/gutenberg/pull/66097#discussion_r1819364045
Path: packages/components/src/tabs/tab.tsx
...
https://github.com/WordPress/gutenberg/issues/66530

## Changed files

- packages/block-editor/src/components/inserter/category-tabs/index.js (MODIFIED, +16/-1)
- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/tabs/index.tsx (MODIFIED, +42/-138)
- packages/components/src/tabs/tab.tsx (MODIFIED, +23/-3)
- packages/components/src/tabs/test/index.tsx (MODIFIED, +130/-117)
