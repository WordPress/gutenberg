...
type: pull_request
state: MERGED
merged_at: 2025-12-15T20:23:05Z
url: https://github.com/WordPress/gutenberg/pull/74004
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #74004: ToggleGroupControl: Deprecate bottom margin

- URL: https://github.com/WordPress/gutenberg/pull/74004
- Author: mirka
- Created: 2025-12-15T15:34:20Z
- Updated: 2025-12-15T20:23:41Z
- Comments: 3 of 3
- Review threads: 1 of 1
- Changed files: 47 of 47
- Diff: ../pr-diffs/74004.diff
...
### github-actions on 2025-12-15T15:36:02Z

URL: https://github.com/WordPress/gutenberg/pull/74004#issuecomment-3656299963
...
### github-actions on 2025-12-15T15:48:11Z

URL: https://github.com/WordPress/gutenberg/pull/74004#issuecomment-3656353856
...
| :--- | :---: | :---: |
| `build/scripts/block-editor/index.min.js` | 316 kB | -27 B (-0.01%) |
| `build/scripts/block-library/index.min.js` | 281 kB | -2 B (0%) |
| `build/scripts/components/index.min.js` | 272 kB | -10 B (0%) |
| `build/scripts/edit-site/index.min.js` | 240 kB | -10 B (0%) |
| `build/scripts/editor/index.min.js` | 284 kB | -12 B (0%) |
| `build/scripts/media-utils/index.min.js` | 69.5 kB | -11 B (-0.02%) |
...
### github-actions on 2025-12-15T16:05:55Z

URL: https://github.com/WordPress/gutenberg/pull/74004#issuecomment-3656437626

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 6ebe218fbe60432d4264efd759ffda7cfc510b9a.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/20237973439
📝  Reported issues:
...
#### ntsekouras on 2025-12-15T17:02:28Z

URL: https://github.com/WordPress/gutenberg/pull/74004#discussion_r2620181992
...
Nit: Maybe add the comment inline?

## Changed files

- .eslintrc.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/background-image-control/index.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/block-variation-transforms/index.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/child-layout-control/index.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/dimensions-tool/scale-tool.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/image-size-control/index.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/text-alignment-control/index.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/text-decoration-control/index.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/text-transform-control/index.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/writing-mode-control/index.js (MODIFIED, +0/-1)
- packages/block-editor/src/hooks/layout.js (MODIFIED, +0/-1)
- packages/block-editor/src/layouts/constrained.js (MODIFIED, +0/-1)
- packages/block-editor/src/layouts/flex.js (MODIFIED, +0/-2)
- packages/block-editor/src/layouts/grid.js (MODIFIED, +0/-1)
- packages/block-library/src/accordion/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/button/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/comments-pagination/comments-pagination-arrow-controls.js (MODIFIED, +0/-1)
- packages/block-library/src/latest-posts/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/navigation-overlay-close/edit.js (MODIFIED, +0/-1)
...
- packages/block-library/src/navigation/edit/overlay-visibility-control.js (MODIFIED, +0/-1)
...
- packages/block-library/src/query-pagination/query-pagination-arrow-controls.js (MODIFIED, +0/-1)
- packages/block-library/src/query/edit/inspector-controls/index.js (MODIFIED, +0/-2)
- packages/block-library/src/terms-query/edit/inspector-controls/inherit-control.js (MODIFIED, +0/-1)
- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/border-control/border-control-style-picker/component.tsx (MODIFIED, +0/-1)
- packages/components/src/date-time/time/time-input/index.tsx (MODIFIED, +0/-1)
- packages/components/src/font-size-picker/font-size-picker-toggle-group.tsx (MODIFIED, +0/-1)
- packages/components/src/toggle-group-control/stories/index.story.tsx (MODIFIED, +0/-1)
- packages/components/src/toggle-group-control/test/index.tsx (MODIFIED, +1/-7)
...
- packages/components/src/toggle-group-control/toggle-group-control-option/README.md (MODIFIED, +0/-1)
- packages/components/src/toggle-group-control/toggle-group-control-option/component.tsx (MODIFIED, +0/-1)
- packages/components/src/toggle-group-control/toggle-group-control/README.md (MODIFIED, +0/-8)
- packages/components/src/toggle-group-control/toggle-group-control/component.tsx (MODIFIED, +3/-8)
- packages/components/src/toggle-group-control/types.ts (MODIFIED, +8/-4)
- packages/components/src/tools-panel/stories/index.story.tsx (MODIFIED, +0/-3)
- packages/components/src/validated-form-controls/components/toggle-group-control.tsx (MODIFIED, +1/-2)
- packages/dataviews/src/components/dataviews-view-config/index.tsx (MODIFIED, +0/-2)
- packages/dataviews/src/dataform-controls/toggle-group.tsx (MODIFIED, +0/-1)
- packages/dataviews/src/dataviews-layouts/table/density-picker.tsx (MODIFIED, +0/-1)
- packages/global-styles-ui/src/screen-typography-element.tsx (MODIFIED, +0/-1)
- packages/global-styles-ui/src/shadows-edit-panel.tsx (MODIFIED, +0/-1)
