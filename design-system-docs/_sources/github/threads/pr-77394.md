...
type: pull_request
state: MERGED
merged_at: 2026-04-16T08:56:49Z
url: https://github.com/WordPress/gutenberg/pull/77394
matched_labels: ["[Package] UI","[Package] Theme"]
all_labels: ["[Type] Code Quality","[Package] Editor","[Package] DataViews","[Package] Theme","[Package] UI"]
---

# PR #77394: TypeScript: Share React CSS custom properties typing

- URL: https://github.com/WordPress/gutenberg/pull/77394
- Author: mirka
- Created: 2026-04-15T19:04:26Z
- Updated: 2026-04-16T08:57:27Z
- Comments: 4 of 4
- Review threads: 3 of 3
- Changed files: 14 of 14
- Diff: ../pr-diffs/77394.diff
...
### github-actions on 2026-04-15T19:04:52Z

URL: https://github.com/WordPress/gutenberg/pull/77394#issuecomment-4254706966
...
### aduth on 2026-04-15T19:13:11Z

URL: https://github.com/WordPress/gutenberg/pull/77394#issuecomment-4254761209

Ah, love how this is solving / simplifying a bunch of real-world usage ❤️

### github-actions on 2026-04-15T19:16:47Z

URL: https://github.com/WordPress/gutenberg/pull/77394#issuecomment-4254789138
...
### github-actions on 2026-04-15T20:03:11Z

URL: https://github.com/WordPress/gutenberg/pull/77394#issuecomment-4255089248

<!-- flaky-tests-report-comment -->
**Flaky tests detected in d5954705e4ea55dd6aac372d3fe6bee334ee5b1c.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/24472923969
📝  Reported issues:
...
#### mirka on 2026-04-15T19:21:23Z

URL: https://github.com/WordPress/gutenberg/pull/77394#discussion_r3088842051
Path: typings/react-css-custom-properties/index.d.ts
...
`export {};` is only here to keep this declaration file in module scope so `declare module "react"` is treated as a module augmentation. I originally used `import "react"`, but the repo lint rules reject direct `react` imports, so this is the no-op replacement.

### Review thread 2

#### mirka on 2026-04-15T19:21:23Z

URL: https://github.com/WordPress/gutenberg/pull/77394#discussion_r3088842055
...
The explicit `CSSProperties` annotation is here to avoid a TS2883 portability error once `theme` opts into the shared custom-properties typing. Without it, the exported hook ends up exposing a wider inferred type that TypeScript complains cannot be named portably because it pulls through `csstype` references.

### Review thread 3

#### mirka on 2026-04-15T19:23:24Z

URL: https://github.com/WordPress/gutenberg/pull/77394#discussion_r3088851281
Path: packages/connectors/src/connector-item.tsx
...
This CSS variable shouldn't be redefined here. But leaving it in for the scope of this PR.

## Changed files

- packages/connectors/src/connector-item.tsx (MODIFIED, +2/-2)
- packages/connectors/tsconfig.json (MODIFIED, +3/-0)
- packages/dataviews/src/dataviews/stories/layout-activity.tsx (MODIFIED, +5/-7)
...
- packages/editor/tsconfig.json (MODIFIED, +1/-1)
...
- packages/ui/tsconfig.json (MODIFIED, +6/-1)
