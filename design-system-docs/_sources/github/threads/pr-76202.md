...
type: pull_request
state: MERGED
merged_at: 2026-03-07T14:16:22Z
url: https://github.com/WordPress/gutenberg/pull/76202
matched_labels: ["Design System","[Package] UI"]
all_labels: ["[Type] Enhancement","Design System","[Package] UI"]
---

# PR #76202: UI Notice: let description and actions span icon column at narrow widths

- URL: https://github.com/WordPress/gutenberg/pull/76202
- Author: jameskoster
- Created: 2026-03-05T16:01:19Z
- Updated: 2026-03-07T14:17:11Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/76202.diff

## Body

## What

The `Notice` component in the `@wordpress/ui` package has a three-column CSS grid layout (`auto 1fr auto`) where the icon occupies the first column. At narrow widths, this icon column indents the description and actions, wasting valuable horizontal space. This PR adjusts the layout so the description and actions span the icon column reducing wasted space.

## Why

When the `Notice` is rendered in a narrow container, the description and action buttons are the content most likely to need the full available width. The icon carries important semantic meaning (communicating intent beyond color alone), so hiding it is not desirable. Instead, only the title (which should be relatively short) should remain indented next to the icon.

## How

- Added `container-type: inline-size` to `.notice` to enable container queries.
- Added a `@container (max-width: 320px)` rule that sets `grid-column: 1 / 3` on `.description` and `.actions`, allowing them to span across both the icon and content columns at narrow widths.
- The icon remains visible and aligned with the title. The close button is unaffected.
- A TODO comment notes that the `320px` threshold should be replaced with a `measure` token from the Theme package.

## Testing Instructions

1. npm run storybook
2. View a Notice story that includes an icon e.g. http://localhost:50240/?path=/story/design-system-components-notice--info
3. Resize the Notice in dev tools and note that at 320px the description and actions occupy the first two columns in the grid

| Before | After |
| --- | --- |
| <img width="344" height="204" alt="Screenshot 2026-03-05 at 15 43 21" src="https://github.com/user-attachments/assets/5255a076-449a-4976-92b7-49753f2d41d3" /> | <img width="340" height="198" alt="Screenshot 2026-03-05 at 15 43 46" src="https://github.com/user-attachments/assets/4e952ec6-5c0d-4f37-bdcd-1ee894b779f7" /> |

When the Notice omits a title the current layout is applied.

## Issue comments

### github-actions on 2026-03-05T16:02:41Z

URL: https://github.com/WordPress/gutenberg/pull/76202#issuecomment-4006117198
...
### github-actions on 2026-03-05T16:14:11Z

URL: https://github.com/WordPress/gutenberg/pull/76202#issuecomment-4006197266
...
### github-actions on 2026-03-07T13:59:54Z

URL: https://github.com/WordPress/gutenberg/pull/76202#issuecomment-4016569845

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 9f9e54afb9533e17fb6bfd32bcc96e02a3cf52f1.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/22800029210
📝  Reported issues:
- #48535 in `/test/e2e/specs/editor/various/autocomplete-and-mentions.spec.js`
- #47280 in `/test/e2e/specs/editor/various/autocomplete-and-mentions.spec.js`
...
- packages/ui/src/notice/style.module.css (MODIFIED, +9/-0)
