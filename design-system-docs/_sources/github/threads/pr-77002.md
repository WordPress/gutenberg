...
type: pull_request
state: MERGED
merged_at: 2026-04-03T10:31:37Z
url: https://github.com/WordPress/gutenberg/pull/77002
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Core data","[Package] Components","[Package] Editor","[Package] Rich text","[Package] Block editor","[Package] E2E Tests","[Package] Fields"]
---

# PR #77002: Fix pre-existing lint errors across the codebase

- URL: https://github.com/WordPress/gutenberg/pull/77002
- Author: manzoorwanijk
- Created: 2026-04-02T13:32:29Z
- Updated: 2026-04-03T10:32:20Z
- Comments: 4 of 4
- Review threads: 1 of 1
- Changed files: 29 of 29
- Diff: ../pr-diffs/77002.diff
...
### github-actions on 2026-04-02T13:32:39Z

URL: https://github.com/WordPress/gutenberg/pull/77002#issuecomment-4177901903
...
### github-actions on 2026-04-02T13:44:05Z

URL: https://github.com/WordPress/gutenberg/pull/77002#issuecomment-4177997820
...
| :--- | :---: | :---: |
| `build/scripts/block-editor/index.min.js` | 339 kB | +5 B (0%) |
...
| `build/scripts/core-data/index.min.js` | 30.4 kB |
...
### github-actions on 2026-04-02T15:02:37Z

URL: https://github.com/WordPress/gutenberg/pull/77002#issuecomment-4178528540

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 711064e73c146de829c3409580869895a801b164.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/23909686849
📝  Reported issues:
...
### manzoorwanijk on 2026-04-02T18:52:14Z

URL: https://github.com/WordPress/gutenberg/pull/77002#issuecomment-4179840859
...
#### Mamaduka on 2026-04-02T15:30:03Z

URL: https://github.com/WordPress/gutenberg/pull/77002#discussion_r3028783388
Path: packages/core-data/src/hooks/use-resource-permissions.ts
...
Maybe we should rename during re-export, or just use the same method for these types for hooks/components.

#### manzoorwanijk on 2026-04-02T15:33:23Z

URL: https://github.com/WordPress/gutenberg/pull/77002#discussion_r3028801487
Path: packages/core-data/src/hooks/use-resource-permissions.ts
...
That's exactly what's happening here — the function is renamed to `useDeprecatedResourcePermissions` (valid hook name so `rules-of-hooks` doesn't flag the hook calls inside it), and the original `__experimentalUseResourcePermissions` name is preserved via `export { useDeprecatedResourcePermissions as __experimentalUseResourcePermissions }`.

The same pattern is used consistently across all 5 hooks in this PR. The key constraint is that the internal function name must start with `use` for ESLint to recognize it as a hook.

#### Mamaduka on 2026-04-02T15:49:09Z

URL: https://github.com/WordPress/gutenberg/pull/77002#discussion_r3028880753
Path: packages/core-data/src/hooks/use-resource-permissions.ts
...
What I mean is to handle renaming in the barrel file, similar to https://github.com/WordPress/gutenberg/pull/77002/changes#diff-bec072c72a2f961596701aef67f67575b0a3b918135a6587229a0cd79bb3db44.

#### manzoorwanijk on 2026-04-02T15:58:15Z

URL: https://github.com/WordPress/gutenberg/pull/77002#discussion_r3028926523
Path: packages/core-data/src/hooks/use-resource-permissions.ts
...
#### manzoorwanijk on 2026-04-02T15:59:45Z

URL: https://github.com/WordPress/gutenberg/pull/77002#discussion_r3028934692
Path: packages/core-data/src/hooks/use-resource-permissions.ts
...
#### Mamaduka on 2026-04-02T16:02:27Z

URL: https://github.com/WordPress/gutenberg/pull/77002#discussion_r3028948458
Path: packages/core-data/src/hooks/use-resource-permissions.ts
...
- packages/block-editor/src/components/block-list/block-crash-warning.native.js (MODIFIED, +3/-1)
- packages/block-editor/src/components/rich-text/index.js (MODIFIED, +1/-1)
- packages/block-editor/src/components/rich-text/index.native.js (MODIFIED, +1/-1)
- packages/block-editor/src/components/rich-text/input-event.js (MODIFIED, +1/-1)
- packages/block-editor/src/components/rich-text/input-event.native.js (MODIFIED, +1/-1)
- packages/block-editor/src/components/rich-text/native/index.native.js (MODIFIED, +18/-17)
- packages/components/src/higher-order/with-focus-outside/index.native.js (MODIFIED, +21/-20)
- packages/components/src/toolbar/toolbar-button/toolbar-button-container.native.js (MODIFIED, +3/-1)
...
- packages/core-data/src/hooks/use-resource-permissions.ts (MODIFIED, +1/-1)
- packages/dependency-extraction-webpack-plugin/lib/types.d.ts (MODIFIED, +1/-1)
- packages/e2e-test-utils-playwright/src/test.ts (MODIFIED, +2/-0)
- packages/editor/src/components/collaborators-overlay/use-render-cursors.ts (MODIFIED, +4/-2)
- packages/fields/src/stories/index.story.tsx (MODIFIED, +2/-2)
- packages/media-fields/src/stories/index.story.tsx (MODIFIED, +2/-2)
- packages/report-flaky-tests/src/__tests__/markdown.test.ts (MODIFIED, +9/-9)
- packages/rich-text/src/hook/index.js (MODIFIED, +1/-1)
- packages/rich-text/src/index.ts (MODIFIED, +1/-1)
- test/e2e/specs/editor/blocks/avatar.spec.js (MODIFIED, +4/-2)
- test/e2e/specs/editor/various/copy-cut-paste.spec.js (MODIFIED, +2/-2)
- test/e2e/specs/editor/various/post-title.spec.js (MODIFIED, +1/-1)
- test/e2e/specs/editor/various/pref-modal.spec.js (MODIFIED, +2/-2)
- test/e2e/specs/editor/various/revisions.spec.js (MODIFIED, +4/-2)
- test/e2e/specs/interactivity/directive-context.spec.ts (MODIFIED, +1/-1)
- test/e2e/specs/interactivity/router-regions.spec.ts (MODIFIED, +1/-1)
- typings/gutenberg-test-env/index.d.ts (MODIFIED, +3/-3)
