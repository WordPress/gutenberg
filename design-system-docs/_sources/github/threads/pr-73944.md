...
type: pull_request
state: MERGED
merged_at: 2025-12-12T11:15:03Z
url: https://github.com/WordPress/gutenberg/pull/73944
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Breaking Change","[Package] Components"]
---

# PR #73944: DimensionControl: Hard deprecate component

- URL: https://github.com/WordPress/gutenberg/pull/73944
- Author: mirka
- Created: 2025-12-11T23:33:43Z
- Updated: 2025-12-12T11:15:41Z
- Comments: 2 of 2
- Review threads: 1 of 1
- Changed files: 11 of 11
- Diff: ../pr-diffs/73944.diff

## Body

## What?

Remove the deprecated `DimensionControl` component.

## Why?

The component was soft deprecated in WP 6.7 and scheduled for removal in WP 7.0. This removes the component entirely, completing the deprecation cycle.

## How?

- Remove the `DimensionControl` component, its types, stories, tests, and documentation.
- Update the package exports and manifest.

## Testing Instructions

Confirm there are no remaining usages of `DimensionControl` in the codebase.

## Issue comments

### github-actions on 2025-12-11T23:33:52Z

URL: https://github.com/WordPress/gutenberg/pull/73944#issuecomment-3644231780
...
### github-actions on 2025-12-11T23:47:54Z

URL: https://github.com/WordPress/gutenberg/pull/73944#issuecomment-3644266089
...
| :--- | :---: | :---: |
| `build/scripts/components/index.min.js` | 272 kB | -396 B (-0.15%) |
...
#### juanfra on 2025-12-12T08:11:41Z

URL: https://github.com/WordPress/gutenberg/pull/73944#discussion_r2613324247
...
- packages/components/src/dimension-control/README.md (DELETED, +0/-115)
- packages/components/src/dimension-control/index.tsx (DELETED, +0/-132)
- packages/components/src/dimension-control/sizes.ts (DELETED, +0/-51)
- packages/components/src/dimension-control/stories/index.story.tsx (DELETED, +0/-56)
- packages/components/src/dimension-control/test/__snapshots__/index.test.js.snap (DELETED, +0/-1183)
- packages/components/src/dimension-control/test/index.test.js (DELETED, +0/-137)
- packages/components/src/dimension-control/types.ts (DELETED, +0/-52)
