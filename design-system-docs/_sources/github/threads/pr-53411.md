...
type: pull_request
state: MERGED
merged_at: 2023-08-09T03:29:29Z
url: https://github.com/WordPress/gutenberg/pull/53411
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components","Needs Accessibility Feedback"]
---

# PR #53411: Button: add `:disabled` selector to reset hover color for disabled buttons

- URL: https://github.com/WordPress/gutenberg/pull/53411
- Author: ramonjd
- Created: 2023-08-08T06:24:55Z
- Updated: 2023-08-09T03:29:55Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/53411.diff
...
### alexstine on 2023-08-08T16:26:23Z

URL: https://github.com/WordPress/gutenberg/pull/53411#issuecomment-1669938805

Accessibility impact with adding `aria-disabled`? Styles should not be based off ARIA attributes unless the said attribute is used/needed. Without testing this, I'm a little unclear on why this is needed.

### ramonjd on 2023-08-08T21:29:48Z

URL: https://github.com/WordPress/gutenberg/pull/53411#issuecomment-1670333981

> Styles should not be based off ARIA attributes unless the said attribute is used/needed. Without testing this, I'm a little unclear on why this is needed.

Thanks for the feedback @alexstine 

The button component has a rule that resets the hover color using an `aria-disabled` selector. 
Do you think it would be more appropriate to change that rule in the button component to use the `:disabled` selector?

Actually, now I look at the button component CSS more closely, it might be more consistent. There's already a `&:focus:not(:disabled)` rule. See: https://github.com/WordPress/gutenberg/blob/fc6000ac74b3fb6dd93b142e447eb5cc189fdc35/packages/components/src/button/style.scss#L37C2-L37C24

It would have the same effect.

### github-actions on 2023-08-09T01:50:03Z

URL: https://github.com/WordPress/gutenberg/pull/53411#issuecomment-1670536901
...
| `build/components/index.min.js` | 244 kB |
...
### ramonjd on 2023-08-09T01:58:33Z

URL: https://github.com/WordPress/gutenberg/pull/53411#issuecomment-1670543623

The scope of this PR has widened slightly. Now the hover color will not show for any buttons with a `"disabled="true"` attribute.

I think it's a safe change and was probably left out initially?

I didn't change anything else to keep the scope of this PR smaller, since there are buttons that have either the `aria-disabled` OR `disabled` prop.
