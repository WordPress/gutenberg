...
type: pull_request
state: MERGED
merged_at: 2025-12-01T20:38:17Z
url: https://github.com/WordPress/gutenberg/pull/73530
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Experimental","[Package] UI"]
---

# PR #73530: UI: Add border support to Box component

- URL: https://github.com/WordPress/gutenberg/pull/73530
- Author: aduth
- Created: 2025-11-24T22:00:30Z
- Updated: 2025-12-01T20:38:55Z
- Comments: 3 of 3
- Review threads: 1 of 1
- Changed files: 13 of 13
- Diff: ../pr-diffs/73530.diff
...
2. Go to http://localhost:50240/?path=/story/design-system-components-box--default
3. Observe interactions with `borderColor`, `borderRadius`, and `borderWidth` props

## Screenshots or screencast <!-- if applicable -->

<img width="1293" height="1245" alt="image" src="https://github.com/user-attachments/assets/6b2d969d-f1b6-4cae-a8d0-92c3da24e3c0" />

## Issue comments

### github-actions on 2025-11-24T22:00:39Z

URL: https://github.com/WordPress/gutenberg/pull/73530#issuecomment-3572894681
...
### github-actions on 2025-11-24T22:12:15Z

URL: https://github.com/WordPress/gutenberg/pull/73530#issuecomment-3572933778
...
| :--- | :---: | :---: |
| `build/modules/boot/index.min.js` | 102 kB | +190 B (+0.19%) |
...
| `build/scripts/block-editor/index.min.js` | 323 kB |
...
| `build/scripts/media-utils/index.min.js` | 66.9 kB |
...
### github-actions on 2025-11-24T22:30:28Z

URL: https://github.com/WordPress/gutenberg/pull/73530#issuecomment-3572991439

<!-- flaky-tests-report-comment -->
**Flaky tests detected in a0c4aed61cc46e8ed78c4b9380a1a3722729f914.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/19831554510
📝  Reported issues:
...
#### aduth on 2025-11-25T21:27:08Z

URL: https://github.com/WordPress/gutenberg/pull/73530#discussion_r2561483910
Path: packages/ui/src/box/box.tsx

```diff
@@ -109,5 +112,18 @@ export const Box = forwardRef< HTMLDivElement, BoxProps >( function Box(
 		);
 	}
...
#### juanfra on 2025-11-26T16:01:19Z

URL: https://github.com/WordPress/gutenberg/pull/73530#discussion_r2565579759
Path: packages/ui/src/box/box.tsx
...
#### aduth on 2025-12-01T17:22:22Z

URL: https://github.com/WordPress/gutenberg/pull/73530#discussion_r2577969042
Path: packages/ui/src/box/box.tsx
...
- packages/theme/docs/ds-tokens.md (MODIFIED, +11/-7)
- packages/theme/src/prebuilt/css/design-tokens.css (MODIFIED, +10/-6)
- packages/theme/src/prebuilt/js/design-tokens.js (MODIFIED, +9/-5)
- packages/theme/src/prebuilt/json/figma.json (MODIFIED, +33/-9)
- packages/theme/tokens/border.json (MODIFIED, +43/-21)
- packages/ui/src/box/box.tsx (MODIFIED, +16/-0)
- packages/ui/src/box/stories/index.story.tsx (MODIFIED, +3/-0)
- packages/ui/src/box/types.ts (MODIFIED, +30/-0)
