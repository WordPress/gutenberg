...
type: pull_request
state: MERGED
merged_at: 2026-05-22T11:58:42Z
url: https://github.com/WordPress/gutenberg/pull/78529
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Type] Breaking Change","[Package] Components","[Package] Editor","Needs Dev Note"]
---

# PR #78529: Navigation: Hard deprecate component

- URL: https://github.com/WordPress/gutenberg/pull/78529
- Author: mirka
- Created: 2026-05-21T22:28:19Z
- Updated: 2026-05-25T07:45:00Z
- Comments: 2 of 2
- Review threads: 1 of 1
- Changed files: 36 of 36
- Diff: ../pr-diffs/78529.diff
...
Hard deprecates the deprecated `Navigation` component and subcomponents from `@wordpress/components`.

## Why?
`Navigation` has logged a deprecation warning since WordPress 6.8 and is scheduled for removal in WordPress 7.1. `Navigator` is the supported replacement.

I considered stubbing the export with some kind of courtesy no-op, but given [zero usage](https://veloria.dev/search/7d0b464a-7989-4628-86ec-67b3b69f6b78) in plugin directory it's probably safe enough not to.

## How?
Removes the `__experimentalNavigation*` exports, the Navigation implementation, docs, stories, tests, and docs manifest entry. This also removes stale editor sidebar CSS overrides that targeted the old `.components-navigation*` class names.

## Testing Instructions

Confirm all relevant files are gone.

## Issue comments

### github-actions on 2026-05-21T22:36:28Z

URL: https://github.com/WordPress/gutenberg/pull/78529#issuecomment-4513315576

**Size Change:** -3.63 kB (-0.05%) 
...
| :--- | :---: | :---: |
| `build/scripts/components/index.min.js` | 264 kB | -3.47 kB (-1.3%) |
| `build/styles/editor/style-rtl.css` | 29.4 kB | -42 B (-0.14%) |
| `build/styles/editor/style-rtl.min.css` | 24.8 kB | -38 B (-0.15%) |
| `build/styles/editor/style.css` | 29.4 kB | -41 B (-0.14%) |
| `build/styles/editor/style.min.css` | 24.8 kB | -39 B (-0.16%) |
...
### github-actions on 2026-05-21T22:57:14Z

URL: https://github.com/WordPress/gutenberg/pull/78529#issuecomment-4513425136
...
#### mirka on 2026-05-21T22:46:40Z

URL: https://github.com/WordPress/gutenberg/pull/78529#discussion_r3284792694
...
Note to self: After merge, ping docs team for removal from Block Editor handbook.

## Changed files

- docs/manifest.json (MODIFIED, +0/-6)
- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/index.ts (MODIFIED, +0/-5)
...
- packages/components/src/navigation/stories/utils/more-examples.tsx (DELETED, +0/-162)
...
- packages/editor/src/components/global-styles-sidebar/style.scss (MODIFIED, +0/-9)
