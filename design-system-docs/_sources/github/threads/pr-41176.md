...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/41176
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Feature] UI Components","[Package] Components","[Feature] Design Tools"]
---

# PR #41176: Box Control: Ensure Unlink tooltip position stays within the viewport

- URL: https://github.com/WordPress/gutenberg/pull/41176
- Author: andrewserong
- Created: 2022-05-20T00:17:37Z
- Updated: 2025-04-22T10:21:09Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 4 of 4
- Diff: ../pr-diffs/41176.diff
...
### github-actions on 2022-05-20T00:31:01Z

URL: https://github.com/WordPress/gutenberg/pull/41176#issuecomment-1132324859
...
| `build/components/index.min.js` | 227 kB | +16 B (0%) |
...
### andrewserong on 2022-05-24T00:13:28Z

URL: https://github.com/WordPress/gutenberg/pull/41176#issuecomment-1135262059

Thanks for testing @aaronrobertshaw! 

> Perhaps via a better default position on the Button component?

That's a great point, it does look like it'd be worth looking to a more generalised solution for this, so that (somehow) if the button is close to the edge of the viewport, we make sure that the tooltip doesn't go off the side. So maybe there's a fix we can look into for the Tooltip component itself, potentially, too, if the Button component doesn't wind up being the right place?

I'll do a bit more digging and 🤔 too!

### aaronrobertshaw on 2022-05-24T00:23:35Z

URL: https://github.com/WordPress/gutenberg/pull/41176#issuecomment-1135267342

> I'll do a bit more digging and 🤔 too!

My naive guess (without exploring the code yet) is that we are now [setting a default position on Tooltips](https://github.com/WordPress/gutenberg/pull/40740/files#diff-219c89ee33ab626f095cb53bf670c1405d827a7c8cc8fbbc1e1babc5335eb905R98) whereas it was automatic placement previously which might have ensured rendering within the current viewport.

### andrewserong on 2022-05-24T07:31:44Z

URL: https://github.com/WordPress/gutenberg/pull/41176#issuecomment-1135513520

I'll close out this PR now — I believe I've come up with a more thorough way to fix this directly in `ToolTip` over in #41268, which 🤞 should deal with the other cases, too. Thanks again for the feedback!
...
- packages/block-editor/src/components/border-radius-control/linked-button.js (MODIFIED, +1/-1)
...
- packages/components/src/box-control/linked-button.js (MODIFIED, +1/-1)
