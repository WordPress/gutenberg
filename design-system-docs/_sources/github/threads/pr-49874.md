...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/49874
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components","Needs Accessibility Feedback"]
---

# PR #49874: Try: create new `Tabs` component using `@radix-ui/react-tabs` & shim `TabPanel`

- URL: https://github.com/WordPress/gutenberg/pull/49874
- Author: flootr
- Created: 2023-04-17T18:35:56Z
- Updated: 2023-06-16T08:19:32Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 11 of 11
- Diff: ../pr-diffs/49874.diff
...
### github-actions on 2023-04-17T18:45:46Z

URL: https://github.com/WordPress/gutenberg/pull/49874#issuecomment-1511903305
...
| :--- | :---: | :---: | :---: |
| `build/block-editor/index.min.js` | 203 kB | +29 B (0%) |  |
...
| `build/components/index.min.js` | 212 kB | +4.01 kB (+2%) |  |
| `build/components/style-rtl.css` | 11.8 kB | +67 B (+1%) |  |
| `build/components/style.css` | 11.8 kB | +65 B (+1%) |  |
| `build/edit-post/style-rtl.css` | 7.61 kB | +20 B (0%) |  |
| `build/edit-post/style.css` | 7.6 kB | +20 B (0%) |  |
| `build/edit-site/index.min.js` | 64.4 kB | +126 B (0%) |  |
...
### alexstine on 2023-04-18T02:36:05Z

URL: https://github.com/WordPress/gutenberg/pull/49874#issuecomment-1512351036

👋 Just wanted to make sure this PR got tracked by me for accessibility review. Really important to not break UX for this component considering there is an effort to roll it out to replace the fake tab buttons. Please let me know when ready for review.

Thanks.

### flootr on 2023-06-16T08:19:20Z

URL: https://github.com/WordPress/gutenberg/pull/49874#issuecomment-1594300763

Closing in favor of #51551
...
- package-lock.json (MODIFIED, +117/-3)
- packages/components/package.json (MODIFIED, +1/-0)
- packages/components/src/style.scss (MODIFIED, +1/-0)
- packages/components/src/tab-panel/index.tsx (MODIFIED, +49/-62)
- packages/components/src/tab-panel/stories/index.tsx (MODIFIED, +1/-0)
- packages/components/src/tab-panel/style.scss (MODIFIED, +1/-1)
- packages/components/src/tab-panel/types.ts (MODIFIED, +2/-4)
- packages/components/src/tabs/index.tsx (ADDED, +73/-0)
- packages/components/src/tabs/stories/index.tsx (ADDED, +94/-0)
- packages/components/src/tabs/style.scss (ADDED, +83/-0)
- packages/components/src/tabs/types.ts (ADDED, +33/-0)
