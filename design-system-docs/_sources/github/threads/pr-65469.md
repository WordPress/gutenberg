...
type: pull_request
state: MERGED
merged_at: 2024-09-21T21:11:17Z
url: https://github.com/WordPress/gutenberg/pull/65469
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components","Needs Dev Note"]
---

# PR #65469: BoxControl: Promote to stable

- URL: https://github.com/WordPress/gutenberg/pull/65469
- Author: DaniGuardiola
- Created: 2024-09-18T20:46:10Z
- Updated: 2024-10-09T09:33:48Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 9 of 9
- Diff: ../pr-diffs/65469.diff
...
Promote `BoxControl` to a non-experimental component.
...
I also tweaked the docs slightly, and fixed some `@default` tags in jsdocs that were being wrongly wrapped in backticks.

If no one has any concerns, this one should be a straightforward merge.

## ✍️  Dev note

The `__experimentalBoxControl` component can now be imported as `BoxControl`.

The legacy `__experimentalBoxControl` is marked as deprecated.

## Issue comments

### github-actions on 2024-09-18T20:46:24Z

URL: https://github.com/WordPress/gutenberg/pull/65469#issuecomment-2359374241
...
### github-actions on 2024-09-18T20:58:51Z

URL: https://github.com/WordPress/gutenberg/pull/65469#issuecomment-2359393708
...
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 258 kB | -3 B (0%) |
| `build/components/index.min.js` | 225 kB | +8 B (0%) |
...
- packages/components/src/box-control/README.md (MODIFIED, +9/-12)
- packages/components/src/box-control/index.tsx (MODIFIED, +4/-4)
- packages/components/src/box-control/stories/index.story.tsx (MODIFIED, +1/-1)
- packages/components/src/box-control/types.ts (MODIFIED, +3/-3)
- packages/components/src/index.ts (MODIFIED, +2/-0)
- packages/components/src/tools-panel/tools-panel/README.md (MODIFIED, +10/-10)
