...
type: pull_request
state: MERGED
merged_at: 2023-11-24T15:05:21Z
url: https://github.com/WordPress/gutenberg/pull/55547
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Priority] High","[Focus] Accessibility (a11y)","[Package] Components","[Package] Edit Site"]
---

# PR #55547: Improve `Button` saving state accessibility.

- URL: https://github.com/WordPress/gutenberg/pull/55547
- Author: afercia
- Created: 2023-10-23T13:53:35Z
- Updated: 2023-11-24T15:05:43Z
- Comments: 5 of 5
- Review threads: 1 of 1
- Changed files: 3 of 3
- Diff: ../pr-diffs/55547.diff
...
### github-actions on 2023-10-23T14:07:33Z

URL: https://github.com/WordPress/gutenberg/pull/55547#issuecomment-1775287483
...
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 248 kB | +247 B (0%) |
| `build/block-editor/style-rtl.css` | 15.7 kB | +13 B (0%) |
| `build/block-editor/style.css` | 15.7 kB | +13 B (0%) |
| `build/block-library/blocks/cover/style-rtl.css` | 1.7 kB | +4 B (0%) |
| `build/block-library/blocks/cover/style.css` | 1.69 kB | +4 B (0%) |
| `build/block-library/index.min.js` | 212 kB | -31 B (0%) |
| `build/block-library/style-rtl.css` | 14.5 kB | +2 B (0%) |
| `build/block-library/style.css` | 14.5 kB | +2 B (0%) |
| `build/components/index.min.js` | 256 kB | +334 B (0%) |
| `build/components/style-rtl.css` | 12 kB | +36 B (0%) |
| `build/components/style.css` | 12 kB | +34 B (0%) |
| `build/core-data/index.min.js` | 72.5 kB | +115 B (0%) |
| `build/edit-post/index.min.js` | 35.7 kB | +9 B (0%) |
| `build/edit-site/index.min.js` | 208 kB | +54 B (0%) |
| `build/edit-site/style-rtl.css` | 14.4 kB | +107 B (+1%) |
| `build/edit-site/style.css` | 14.4 kB | +106 B (+1%) |
| `build/editor/index.min.js` | 47.1 kB | +266 B (+1%) |
| `build/patterns/index.min.js` | 4.84 kB | +27 B (+1%) |
...
### github-actions on 2023-10-23T14:33:11Z

URL: https://github.com/WordPress/gutenberg/pull/55547#issuecomment-1775341657

<!-- flaky-tests-report-comment -->
**Flaky tests detected in d79707fa0225d933f4a58f6f9eabcc5206910ed7.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/6945368659
📝  Reported issues:
- #53524 in `/test/e2e/specs/editor/various/multi-block-selection.spec.js`

### afercia on 2023-11-21T14:42:47Z

URL: https://github.com/WordPress/gutenberg/pull/55547#issuecomment-1821059198

Rebased on top of latest trunk.
I'd appreciate a quick review, when you have a chance please @ciampo pinging also @WordPress/gutenberg-design as this is mostly a CSS change.

### afercia on 2023-11-21T14:48:42Z

URL: https://github.com/WordPress/gutenberg/pull/55547#issuecomment-1821069736

The optional check `verify @wordpress/components CHANGELOG update` is now failing but this PR does add a changelog entry. Looks like the check fails to recognize a changelog entry after rebasing a PR.

### ciampo on 2023-11-21T17:38:25Z

URL: https://github.com/WordPress/gutenberg/pull/55547#issuecomment-1821370844
...
#### jasmussen on 2023-11-21T15:10:17Z

URL: https://github.com/WordPress/gutenberg/pull/55547#discussion_r1400746978
...
#### afercia on 2023-11-21T15:33:59Z

URL: https://github.com/WordPress/gutenberg/pull/55547#discussion_r1400783973
Path: packages/components/src/button/style.scss
...
#### jasmussen on 2023-11-21T15:35:44Z

URL: https://github.com/WordPress/gutenberg/pull/55547#discussion_r1400786225
Path: packages/components/src/button/style.scss
...
#### afercia on 2023-11-21T15:38:57Z

URL: https://github.com/WordPress/gutenberg/pull/55547#discussion_r1400790597
Path: packages/components/src/button/style.scss
...
Yes of course, but I'd recommend a separate PR. I did already open https://github.com/WordPress/gutenberg/issues/55566 in fact.

#### ciampo on 2023-11-22T15:00:44Z

URL: https://github.com/WordPress/gutenberg/pull/55547#discussion_r1402198677
Path: packages/components/src/button/style.scss
...
Sounds good to me. At most we could add an inline comment suggesting that we should refactor it to using `@include reduce-motion("animation");` as soon as https://github.com/WordPress/gutenberg/issues/55566 is closed

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/button/style.scss (MODIFIED, +5/-0)
- packages/edit-site/src/components/save-hub/style.scss (MODIFIED, +7/-0)
