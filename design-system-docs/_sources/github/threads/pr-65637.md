...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/65637
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #65637: WIP: Components :update `re-resizable` library

- URL: https://github.com/WordPress/gutenberg/pull/65637
- Author: t-hamano
- Created: 2024-09-25T07:59:53Z
- Updated: 2024-11-06T07:56:31Z
- Comments: 8 of 8
- Review threads: 0 of 0
- Changed files: 4 of 4
- Diff: ../pr-diffs/65637.diff
...
### github-actions on 2024-09-25T08:11:48Z

URL: https://github.com/WordPress/gutenberg/pull/65637#issuecomment-2373376171
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 225 kB | -47 B (-0.02%) |
...
### stokesman on 2024-09-26T15:09:14Z

URL: https://github.com/WordPress/gutenberg/pull/65637#issuecomment-2377248169

Seems like the "Why?" section could more generally mention enabling tab order fixes for all instances where `ResizableBox` is used with focusable handles. I see you did mention those intances in the testing instructions.

### t-hamano on 2024-09-27T06:32:54Z

URL: https://github.com/WordPress/gutenberg/pull/65637#issuecomment-2378502626

@stokesman Thanks for the feedback!

I've updated the Why section of the PR.

The current issues I'm facing are the following two behaviors that first appeared in re-resizable `6.9.1`, and I'm currently investigating ways to address these issues.

### The handle will be displayed unless we explicitly set the direction to `false` with the `enable` prop

This is the correct specification described in [the README](https://github.com/bokuweb/re-resizable?tab=readme-ov-file#enable-enable--false), but if the version of re-resizable was lower than `6.9.1`, it was not necessary to explicitly set it to `false`. However, due to a specification change that was probably made in `6.9.1`, this behavior has changed.

For example, in the Image block, handles are displayed in all directions that are not explicitly set to `false`:

| Expected (re-resizable 6.4.0) | Actual (re-resizable 6.9.1) |
|--------|--------|
| ![image](https://github.com/user-attachments/assets/a88b8747-bb0a-4d15-a236-c49bbc37f4e8)| ![image](https://github.com/user-attachments/assets/75f17114-8f56-465d-a6fe-8d9c72e5723c)| 
...
https://github.com/user-attachments/assets/ceddc167-77ba-40af-8bc0-7da6f11395e3

### afercia on 2024-09-27T08:29:11Z

URL: https://github.com/WordPress/gutenberg/pull/65637#issuecomment-2378738319

@t-hamano thank you for [your upstrem PR](https://github.com/bokuweb/re-resizable/pull/827). Would this update help solve also https://github.com/WordPress/gutenberg/issues/52602 ?

### t-hamano on 2024-09-27T08:51:02Z

URL: https://github.com/WordPress/gutenberg/pull/65637#issuecomment-2378780178

> Would this update help solve also https://github.com/WordPress/gutenberg/issues/52602 ?

Yes, some additional CSS may be required, but I believe it will also work correctly with RTL languages.

### Mamaduka on 2024-11-05T06:02:05Z

URL: https://github.com/WordPress/gutenberg/pull/65637#issuecomment-2456304929

@t-hamano, what's the blocker for this PR?

cc @WordPress/gutenberg-components

### t-hamano on 2024-11-06T07:48:23Z

URL: https://github.com/WordPress/gutenberg/pull/65637#issuecomment-2458919448

https://github.com/bokuweb/re-resizable/pull/827 to fix the tab order problem has unfortunately been [reverted](https://github.com/bokuweb/re-resizable/pull/836) because it caused a regression.

This means we can no longer move forward with this PR 😥 I've listed possible suggestions in [this comment](https://github.com/WordPress/gutenberg/issues/52602#issuecomment-2458914337).

### Mamaduka on 2024-11-06T07:56:30Z

URL: https://github.com/WordPress/gutenberg/pull/65637#issuecomment-2458931777
...
- package-lock.json (MODIFIED, +17/-32)
- packages/components/CHANGELOG.md (MODIFIED, +4/-0)
- packages/components/package.json (MODIFIED, +1/-1)
- packages/components/src/resizable-box/index.tsx (MODIFIED, +13/-0)
