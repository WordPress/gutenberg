...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/47476
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Focus] Accessibility (a11y)","[Package] Components"]
---

# PR #47476: ColorPalette: Show checkered background through semi-transparent colors

- URL: https://github.com/WordPress/gutenberg/pull/47476
- Author: brookewp
- Created: 2023-01-27T01:28:20Z
- Updated: 2025-02-10T16:45:42Z
- Comments: 5 of 5
- Review threads: 0 of 0
- Changed files: 4 of 4
- Diff: ../pr-diffs/47476.diff
...
### github-actions on 2023-01-27T01:37:35Z

URL: https://github.com/WordPress/gutenberg/pull/47476#issuecomment-1405905916
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 203 kB | +13 B (0%) |
...
### ciampo on 2023-02-01T17:46:30Z

URL: https://github.com/WordPress/gutenberg/pull/47476#issuecomment-1412467937

Thank you Brooke for working on this!

It definitely looks like an improvement over the current situation, although @mirka 's [comment](https://github.com/WordPress/gutenberg/pull/47373#issuecomment-1408654488) in a related PR makes me wonder — should we look at solving these UX / a11y issues at the design level (e.g by moving the text outside of the swatch) ?

### brookewp on 2023-02-10T07:01:21Z

URL: https://github.com/WordPress/gutenberg/pull/47476#issuecomment-1425280778

>should we look at solving these UX / a11y issues at the design level (e.g by moving the text outside of the swatch) ?

Ah, this makes sense! So outside of the swatch, like the below example? 

<img width="268" alt="Screenshot 2023-02-09 at 10 55 23 PM" src="https://user-images.githubusercontent.com/35543432/218024096-888826a3-126a-4861-b0ab-a288ba911692.png">

(But of course getting design involved to make the design on how it looks)

### ciampo on 2023-02-10T16:44:06Z

URL: https://github.com/WordPress/gutenberg/pull/47476#issuecomment-1426069226
...
- close this PR since we'll likely adopt a different approach
- open a new issue in which we explain the situation, and we propose the [solution highlighted by Lena](https://github.com/WordPress/gutenberg/pull/47373#issuecomment-1408654488). We could then ping design folks and discuss an approach!

What do you think about this plan?

### brookewp on 2023-02-14T03:53:56Z

URL: https://github.com/WordPress/gutenberg/pull/47476#issuecomment-1429073989

> Next steps could be:
>     close this PR since we'll likely adopt a different approach
>     open a new issue in which we explain the situation, and we propose the solution highlighted by Lena. We could then ping design folks and discuss an approach!
> What do you think about this plan?
...
- packages/components/src/color-palette/style.scss (MODIFIED, +11/-9)
