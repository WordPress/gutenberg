...
type: pull_request
state: MERGED
merged_at: 2023-01-09T17:51:33Z
url: https://github.com/WordPress/gutenberg/pull/46945
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #46945: ItemGroup: migrate Storybook to controls, refactor to TypeScript

- URL: https://github.com/WordPress/gutenberg/pull/46945
- Author: ciampo
- Created: 2023-01-06T15:39:48Z
- Updated: 2023-01-09T17:56:16Z
- Comments: 2 of 2
- Review threads: 3 of 3
- Changed files: 8 of 8
- Diff: ../pr-diffs/46945.diff
...
Migrate `ItemGroup`'s Storybook examples to controls instead of knobs, and rewrite in TypeScript
...
Open Storybook, make sure that the `ItemGroup` example works and feels good

## Issue comments

### github-actions on 2023-01-06T15:49:22Z

URL: https://github.com/WordPress/gutenberg/pull/46945#issuecomment-1373823020
...
### github-actions on 2023-01-06T15:56:14Z

URL: https://github.com/WordPress/gutenberg/pull/46945#issuecomment-1373829809

<!-- flaky-tests-report-comment -->
**Flaky tests detected in a947ad9b08e6113f8bb5b3c9ebbeee0c33208156.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/3876020347
📝  Reported issues:
...
#### ciampo on 2023-01-06T15:43:06Z

URL: https://github.com/WordPress/gutenberg/pull/46945#discussion_r1063546260
...
Previously, `ItemGroup`'s stories were much more complex, and involved many other components in an effort to showcase how the component could be used:
- in combination with `Dropdown`
...
#### mirka on 2023-01-06T19:37:21Z

URL: https://github.com/WordPress/gutenberg/pull/46945#discussion_r1063727618
Path: packages/components/src/item-group/stories/index.tsx
...
Though, I wasn't familiar with this component and my first impression when seeing the new default story was that I couldn't understand what the component was supposed to be used for. Would it be more straightforward if we just had a group of three clickable `Item`s? I'm assuming that is the main use case because I had a hard time finding an example in the Gutenberg app where there were unclickable items.
...
#### ciampo on 2023-01-09T16:21:21Z

URL: https://github.com/WordPress/gutenberg/pull/46945#discussion_r1064827087
Path: packages/components/src/item-group/stories/index.tsx
...
Pushed some changes in https://github.com/WordPress/gutenberg/pull/46945/commits/6623d9b114a251d9d32b76dd8be5e90081dd60b7 — let me know if they look good to you (if they're not, I can open a follow-up)

### Review thread 2

#### ciampo on 2023-01-06T15:43:54Z

URL: https://github.com/WordPress/gutenberg/pull/46945#discussion_r1063546866
Path: packages/components/src/item-group/stories/index.tsx
...
Also, note that I removed the hardcoded `max-width` from the component, since we can now leverage some custom Storybook tools to change the container's width

### Review thread 3

#### ciampo on 2023-01-06T15:44:54Z

URL: https://github.com/WordPress/gutenberg/pull/46945#discussion_r1063547618
...
This change was necessary to fix an issue with the separators overflowing the parent `ItemGroup` wrapper:

<img width="903" alt="Screenshot 2023-01-06 at 16 44 40" src="https://user-images.githubusercontent.com/1083581/211046575-72565fd3-51aa-4cbf-a9fe-33a65700cd6b.png">

#### mirka on 2023-01-06T19:17:45Z

URL: https://github.com/WordPress/gutenberg/pull/46945#discussion_r1063714433
Path: packages/components/src/item-group/styles.ts
...
- packages/components/src/item-group/item-group/component.tsx (MODIFIED, +25/-2)
- packages/components/src/item-group/item/component.tsx (MODIFIED, +26/-2)
- packages/components/src/item-group/stories/index.js (DELETED, +0/-270)
- packages/components/src/item-group/stories/index.tsx (ADDED, +103/-0)
...
- packages/edit-post/src/components/preferences-modal/test/__snapshots__/index.js.snap (MODIFIED, +1/-0)
