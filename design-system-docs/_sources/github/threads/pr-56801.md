...
type: pull_request
state: MERGED
merged_at: 2023-12-06T16:49:19Z
url: https://github.com/WordPress/gutenberg/pull/56801
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #56801: Use consistent styling for duotone panels

- URL: https://github.com/WordPress/gutenberg/pull/56801
- Author: richtabor
- Created: 2023-12-05T23:18:10Z
- Updated: 2023-12-06T16:49:39Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 6 of 6
- Diff: ../pr-diffs/56801.diff
...
### github-actions on 2023-12-05T23:25:03Z

URL: https://github.com/WordPress/gutenberg/pull/56801#issuecomment-1841788831
...
| :--- | :---: | :---: | :---: |
| `build/block-editor/index.min.js` | 248 kB | +8 B (0%) |  |
| `build/block-editor/style-rtl.css` | 15.6 kB | -33 B (0%) |  |
| `build/block-editor/style.css` | 15.6 kB | -35 B (0%) |  |
| `build/components/index.min.js` | 256 kB | -14 B (0%) |  |
| `build/edit-post/index.min.js` | 34.6 kB | -362 B (-1%) |  |
| `build/edit-post/style-rtl.css` | 7.42 kB | -136 B (-2%) |  |
| `build/edit-post/style.css` | 7.42 kB | -135 B (-2%) |  |
| `build/edit-site/index.min.js` | 209 kB | -553 B (0%) |  |
| `build/edit-site/style-rtl.css` | 14.3 kB | -334 B (-2%) |  |
| `build/edit-site/style.css` | 14.3 kB | -329 B (-2%) |  |
| `build/editor/index.min.js` | 49.7 kB | +1.11 kB (+2%) |  |
...
### github-actions on 2023-12-05T23:37:18Z

URL: https://github.com/WordPress/gutenberg/pull/56801#issuecomment-1841801527

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 0ac47b5114a2811eab866c45e5575bdd0af46c4c.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/7115833829
📝  Reported issues:
- #56776 in `/test/e2e/specs/site-editor/font-library.spec.js`

### jasmussen on 2023-12-06T09:49:59Z

URL: https://github.com/WordPress/gutenberg/pull/56801#issuecomment-1842538794

Sounds good. The main difference here is the padding, correct?

### richtabor on 2023-12-06T11:10:10Z

URL: https://github.com/WordPress/gutenberg/pull/56801#issuecomment-1842661025

Padding, the MenuGroup label, and the paragraph font size (removing the arbitrary value).
...
- packages/block-editor/src/components/colors-gradients/style.scss (MODIFIED, +0/-1)
- packages/block-editor/src/components/duotone-control/index.js (MODIFIED, +2/-5)
- packages/block-editor/src/components/duotone-control/style.scss (MODIFIED, +1/-6)
- packages/block-editor/src/components/global-styles/filters-panel.js (MODIFIED, +8/-4)
- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/palette-edit/style.scss (MODIFIED, +2/-2)
