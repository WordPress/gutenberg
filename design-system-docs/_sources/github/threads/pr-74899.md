...
type: pull_request
state: MERGED
merged_at: 2026-02-04T16:28:16Z
url: https://github.com/WordPress/gutenberg/pull/74899
matched_labels: ["[Package] Theme"]
all_labels: ["[Type] Code Quality","[Package] Block library","Storybook","[Package] Theme"]
---

# PR #74899: Storybook: Always load design tokens in Design System section

- URL: https://github.com/WordPress/gutenberg/pull/74899
- Author: mirka
- Created: 2026-01-23T16:13:11Z
- Updated: 2026-02-04T16:29:05Z
- Comments: 5 of 5
- Review threads: 2 of 2
- Changed files: 8 of 8
- Diff: ../pr-diffs/74899.diff
...
### github-actions on 2026-01-23T16:15:54Z

URL: https://github.com/WordPress/gutenberg/pull/74899#issuecomment-3791033995
...
### github-actions on 2026-01-23T16:23:47Z

URL: https://github.com/WordPress/gutenberg/pull/74899#issuecomment-3791074356
...
### github-actions on 2026-01-23T16:37:27Z

URL: https://github.com/WordPress/gutenberg/pull/74899#issuecomment-3791150703

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 480538fc7e68394b9857a43862f7bead47c07a19.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/21292832126
📝  Reported issues:
- #74883 in `/test/e2e/specs/editor/various/block-hiding.spec.js`

### ciampo on 2026-02-04T14:35:16Z

URL: https://github.com/WordPress/gutenberg/pull/74899#issuecomment-3847832422

Should we also add them to other folders related to the DS, such as dataviews?

### mirka on 2026-02-04T15:49:34Z

URL: https://github.com/WordPress/gutenberg/pull/74899#issuecomment-3848240333

> Should we also add them to other folders related to the DS, such as dataviews?

They were already added in #75182, so I just consolidated them [here](https://github.com/WordPress/gutenberg/pull/74899/changes#diff-b42081f75f881d642ecfeac0c12b368f7d076a5da71aa43ecfde8cd2a4ff8389).

## Review threads

### Review thread 1

#### mirka on 2026-01-23T16:13:55Z

URL: https://github.com/WordPress/gutenberg/pull/74899#discussion_r2721881000
Path: storybook/package-styles/config.js

```diff
@@ -17,7 +17,7 @@ import fieldsLtr from '../package-styles/fields-ltr.lazy.scss?inline';
...
#### aduth on 2026-01-26T16:57:28Z

URL: https://github.com/WordPress/gutenberg/pull/74899#discussion_r2728428852
Path: storybook/package-styles/config.js
...
I thought I recalled that we explicitly did not want the design tokens stylesheet to be loaded on theme package stories? Something about them interfering with color ramps, for example?

I thought this was discussed in #73938, but I couldn't find any references in skimming it.

#### mirka on 2026-02-03T17:27:35Z

URL: https://github.com/WordPress/gutenberg/pull/74899#discussion_r2760185302
Path: storybook/package-styles/config.js
...
Are you maybe thinking about disabling the **theme switcher** in the toolbar for non-component stories? The stylesheet is a dependency of the theme package so it should definitely not be a problem for `ThemeProvider` stories, and I'm not seeing any issues with the Color Scales stories (cc @ciampo to double check).

#### aduth on 2026-02-03T20:25:25Z

URL: https://github.com/WordPress/gutenberg/pull/74899#discussion_r2760848169
Path: storybook/package-styles/config.js
...
Yeah, now that you mention it, I'm likely getting this confused with the theme switcher. I wouldn't think having the base tokens loaded on theme stories should be a problem, since ThemeProvider is designed to be able to extend those default styles.

#### ciampo on 2026-02-04T14:34:49Z

URL: https://github.com/WordPress/gutenberg/pull/74899#discussion_r2764334046
Path: storybook/package-styles/config.js
...
- packages/block-library/src/tabs-menu-item/block.json (MODIFIED, +1/-3)
- packages/block-library/src/tabs-menu/block.json (MODIFIED, +2/-6)
- packages/theme/src/stories/index.story.tsx (MODIFIED, +0/-1)
- packages/ui/src/form/primitives/field/stories/index.story.tsx (MODIFIED, +0/-1)
- packages/ui/src/form/primitives/select/stories/index.story.tsx (MODIFIED, +0/-1)
- storybook/package-styles/config.js (MODIFIED, +6/-7)
- storybook/package-styles/design-tokens.lazy.scss (RENAMED, +0/-0)
- storybook/package-styles/ui.lazy.scss (DELETED, +0/-1)
