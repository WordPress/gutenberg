...
type: pull_request
state: MERGED
merged_at: 2021-09-14T16:04:10Z
url: https://github.com/WordPress/gutenberg/pull/31170
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components","Needs Accessibility Feedback"]
---

# PR #31170: Fix Dropdown/DropdownMenu toggle closing in all UAs

- URL: https://github.com/WordPress/gutenberg/pull/31170
- Author: stokesman
- Created: 2021-04-25T01:07:13Z
- Updated: 2021-09-14T16:04:35Z
- Comments: 6 of 6
- Review threads: 1 of 1
- Changed files: 4 of 4
- Diff: ../pr-diffs/31170.diff
...
### github-actions on 2021-04-25T01:19:56Z

URL: https://github.com/WordPress/gutenberg/pull/31170#issuecomment-826188963
...
| :--- | :---: | :---: |
| `build/block-library/index.min.js` | 153 kB | -7 B (0%) |
...
### aristath on 2021-05-10T06:25:35Z

URL: https://github.com/WordPress/gutenberg/pull/31170#issuecomment-836239262

Changing the tabindex affects a11y so this will PR needs a11y feedback. Added the related tag :+1:

### ellatrix on 2021-09-13T09:19:24Z

URL: https://github.com/WordPress/gutenberg/pull/31170#issuecomment-918000981

@stokesman I came to the same conclusion in #30392. Could you rebase this PR?

### mtias on 2021-09-13T10:09:31Z

URL: https://github.com/WordPress/gutenberg/pull/31170#issuecomment-918039369

@diegohaz can you take a brief look as well?

### stokesman on 2021-09-13T16:14:43Z

URL: https://github.com/WordPress/gutenberg/pull/31170#issuecomment-918353175

Thanks for reviewing @ellatrix! It's rebased with a comment like the suggested.

### stokesman on 2021-09-14T16:03:51Z

URL: https://github.com/WordPress/gutenberg/pull/31170#issuecomment-919293031

Thanks for reviewing @diegohaz 🙇 

> The ideal solution would be ignoring clicks on the toggle button when the popover is open

Tricky since a `click` comes after the popover has already closed via `blur`. So it might be simpler if we made the toggle button act on `pointerdown` instead of `click`. I think then its action would not need ignored when the popover is open, as it would beat `onFocusOutside`/`blur` to the punch.

## Review threads

### Review thread 1 (resolved)

#### ellatrix on 2021-09-13T09:20:31Z

URL: https://github.com/WordPress/gutenberg/pull/31170#discussion_r707155116
...
Could you leave a comment here? Maybe
...
- packages/block-library/src/template-part/edit/index.js (MODIFIED, +0/-3)
- packages/components/src/color-palette/test/__snapshots__/index.js.snap (MODIFIED, +2/-0)
- packages/components/src/dropdown/index.js (MODIFIED, +4/-0)
