...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/28394
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #28394: Modal: Fix sticky header when rendering Modal with overflow content

- URL: https://github.com/WordPress/gutenberg/pull/28394
- Author: ItsJonQ
- Created: 2021-01-21T13:38:15Z
- Updated: 2025-04-22T10:18:17Z
- Comments: 5 of 5
- Review threads: 0 of 0
- Changed files: 1 of 1
- Diff: ../pr-diffs/28394.diff
...
### github-actions on 2021-01-21T13:48:41Z

URL: https://github.com/WordPress/gutenberg/pull/28394#issuecomment-764654251
...
| :--- | :---: | :---: |
| `build/components/style.css` | 15.5 kB | +1 B (0%) |
...
| `build/components/index.js` | 274 kB | 0 B |
...
### jasmussen on 2021-01-22T07:53:33Z

URL: https://github.com/WordPress/gutenberg/pull/28394#issuecomment-765211367

Yep, this seems good to me. But I wonder, did you find any context in the file history for why it was height vs. min-height? I feel like in the back of my memory there was a reason for it. Was there an overflow property attached to the container? What happens if there's no height or min-height attached?

### ntsekouras on 2021-01-22T08:15:55Z

URL: https://github.com/WordPress/gutenberg/pull/28394#issuecomment-765224876

>What happens if there's no height or min-height attached?

While trying to make sticky `block manager` elements in: https://github.com/WordPress/gutenberg/pull/28329, before leaving it for a follow up, by having no height defined at all, makes `sticky` not to work. So it seems that there is the need for at least a `min-height:0` for something `sticky` to work.

That was my `fix` for resolving this, but I was overriding in the specific modal. Also by having this change, I couldn't make the sticky work well for inner elements.

I'm not css expert though... :)

### ItsJonQ on 2021-01-22T15:59:09Z

URL: https://github.com/WordPress/gutenberg/pull/28394#issuecomment-765507290

Are you folks 👍 on me merging this one? :D

### mirka on 2022-07-28T19:25:02Z

URL: https://github.com/WordPress/gutenberg/pull/28394#issuecomment-1198544449

Thanks for working on this! We've been cleaning up stale PRs, and it looks like this issue was already fixed. Closing out for now 🙏
