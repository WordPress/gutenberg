...
type: pull_request
state: MERGED
merged_at: 2022-11-04T16:22:27Z
url: https://github.com/WordPress/gutenberg/pull/45533
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Build Tooling","[Type] Code Quality","[Package] Components"]
---

# PR #45533: Include TS and JSX files to testing-library lint

- URL: https://github.com/WordPress/gutenberg/pull/45533
- Author: mirka
- Created: 2022-11-03T22:15:04Z
- Updated: 2022-11-04T16:22:56Z
- Comments: 4 of 4
- Review threads: 1 of 1
- Changed files: 12 of 12
- Diff: ../pr-diffs/45533.diff
...
### codesandbox on 2022-11-03T22:15:06Z

URL: https://github.com/WordPress/gutenberg/pull/45533#issuecomment-1302735618

<img alt="CodeSandbox logo" src="https://raw.githubusercontent.com/codesandbox/open-in-codesandbox/main/assets/csb.light.svg#gh-dark-mode-only" /><img alt="CodeSandbox logo" src="https://raw.githubusercontent.com/codesandbox/open-in-codesandbox/main/assets/csb.svg#gh-light-mode-only" />&nbsp; Open in CodeSandbox <a href="https://codesandbox.io/p/github/WordPress/gutenberg/testing-library-lint-tsx?workspace=%7B%22gitSidebarPanel%22:%22PR%22,%22sidebarPanel%22:%22GIT%22%7D">Web Editor</a> | <a href="https://codesandbox.io/p/vscode?owner=WordPress&repo=gutenberg&branch=testing-library-lint-tsx">VS Code</a> | <a href="https://codesandbox.io/p/vscode?owner=WordPress&repo=gutenberg&branch=testing-library-lint-tsx&insiders=true">VS Code Insiders</a>

<!-- open-in-codesandbox:complete -->

### github-actions on 2022-11-03T22:24:43Z

URL: https://github.com/WordPress/gutenberg/pull/45533#issuecomment-1302742328
...
| `build/block-library/editor-rtl.css` | 11.2 kB | +6 B (0%) |  |
| `build/block-library/editor.css` | 11.2 kB | +5 B (0%) |  |
| `build/block-library/style-rtl.css` | 12.3 kB | +13 B (0%) |  |
| `build/block-library/style.css` | 12.4 kB | +13 B (0%) |  |
...
### tyxla on 2022-11-04T12:06:36Z

URL: https://github.com/WordPress/gutenberg/pull/45533#issuecomment-1303353568

Thanks for starting this @mirka! I've pushed a few commits to fix some pre-existing violations and I believe this is ready for review now. @mirka let me know if you have any other thoughts or suggestions in the meantime.

### tyxla on 2022-11-04T16:19:40Z

URL: https://github.com/WordPress/gutenberg/pull/45533#issuecomment-1303829443
...
#### jsnajdr on 2022-11-04T13:01:26Z

URL: https://github.com/WordPress/gutenberg/pull/45533#discussion_r1013995694
Path: packages/components/src/flex/test/index.tsx
...
There are many other tests like this. For `Flex`, `Scrollable`, `Spacer`, `Surface`, ...

#### tyxla on 2022-11-04T13:06:40Z

URL: https://github.com/WordPress/gutenberg/pull/45533#discussion_r1014000266
Path: packages/components/src/flex/test/index.tsx
...
We want to because we intend to compare the snapshots of the two renders (see the `toMatchStyleDiffSnapshot ` call below). That applies to the rest of the tests, or at least most of them.

#### tyxla on 2022-11-04T13:07:48Z

URL: https://github.com/WordPress/gutenberg/pull/45533#discussion_r1014001240
Path: packages/components/src/flex/test/index.tsx
...
Alternatively, we could use [`asFragment()`](https://testing-library.com/docs/react-testing-library/api/#asfragment), but theoretically, it would do the same thing, just with different mechanics.

## Changed files

- .eslintrc.js (MODIFIED, +5/-5)
- packages/components/src/card/test/__snapshots__/index.tsx.snap (MODIFIED, +64/-368)
- packages/components/src/card/test/index.tsx (MODIFIED, +2/-2)
- packages/components/src/date-time/date/test/index.tsx (MODIFIED, +2/-2)
- packages/components/src/divider/test/index.tsx (MODIFIED, +4/-4)
- packages/components/src/flex/test/index.tsx (MODIFIED, +29/-3)
- packages/components/src/form-token-field/test/index.tsx (MODIFIED, +6/-6)
- packages/components/src/scrollable/test/index.tsx (MODIFIED, +7/-3)
- packages/components/src/spacer/test/index.tsx (MODIFIED, +33/-3)
- packages/components/src/surface/test/index.tsx (MODIFIED, +12/-12)
- packages/components/src/text/test/index.tsx (MODIFIED, +4/-4)
- packages/components/src/toggle-group-control/test/index.tsx (MODIFIED, +1/-1)
