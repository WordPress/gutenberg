...
type: pull_request
state: MERGED
merged_at: 2023-02-06T23:50:43Z
url: https://github.com/WordPress/gutenberg/pull/47788
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Developer Documentation","[Package] Components","[Type] New API"]
---

# PR #47788: Components: polish heading level component APIs

- URL: https://github.com/WordPress/gutenberg/pull/47788
- Author: ciampo
- Created: 2023-02-06T15:25:20Z
- Updated: 2023-02-06T23:51:08Z
- Comments: 2 of 2
- Review threads: 2 of 2
- Changed files: 12 of 12
- Diff: ../pr-diffs/47788.diff
...
Polish some APIs recently added in #43848 to components in  `@wordpress/components` 
...
- API design improvements (mark as optional, add default values, rename)
- add docs to README
...
- Make sure that changes introduced in #43848 still apply
- Make sure that docs (README and JSDocs) are in sync

## Issue comments

### github-actions on 2023-02-06T15:41:29Z

URL: https://github.com/WordPress/gutenberg/pull/47788#issuecomment-1419291498
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 204 kB | +11 B (0%) |
| `build/edit-site/index.min.js` | 64.2 kB | +8 B (0%) |
...
### github-actions on 2023-02-06T18:31:45Z

URL: https://github.com/WordPress/gutenberg/pull/47788#issuecomment-1419561245

<!-- flaky-tests-report-comment -->
**Flaky tests detected in db383755b6f25c973258e0d16c7463edbd749546.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/4106522478
📝  Reported issues:
...
#### mirka on 2023-02-06T20:05:11Z

URL: https://github.com/WordPress/gutenberg/pull/47788#discussion_r1097862736
...
Nit: What do you think about consolidating the "New Feature" headings into "Enhancements"? This has been a tiny pet peeve of mine because they are kind of the same thing, especially in terms of semver.

#### ciampo on 2023-02-06T23:21:36Z

URL: https://github.com/WordPress/gutenberg/pull/47788#discussion_r1098019444
Path: packages/components/CHANGELOG.md
...
#### mirka on 2023-02-06T20:11:50Z

URL: https://github.com/WordPress/gutenberg/pull/47788#discussion_r1097869933
Path: packages/components/CHANGELOG.md
...
#### ciampo on 2023-02-06T23:21:43Z

URL: https://github.com/WordPress/gutenberg/pull/47788#discussion_r1098019519
Path: packages/components/CHANGELOG.md
...
- packages/components/src/color-palette/types.ts (MODIFIED, +6/-6)
- packages/components/src/gradient-picker/README.md (MODIFIED, +8/-0)
- packages/components/src/palette-edit/index.js (MODIFIED, +2/-2)
- packages/components/src/tools-panel/tools-panel-header/README.md (MODIFIED, +7/-0)
- packages/components/src/tools-panel/tools-panel-header/hook.ts (MODIFIED, +6/-4)
- packages/components/src/tools-panel/tools-panel/README.md (MODIFIED, +7/-0)
- packages/components/src/tools-panel/tools-panel/hook.ts (MODIFIED, +2/-0)
- packages/components/src/tools-panel/types.ts (MODIFIED, +12/-8)
- packages/edit-site/src/components/global-styles/color-palette-panel.js (MODIFIED, +3/-3)
- packages/edit-site/src/components/global-styles/gradients-palette-panel.js (MODIFIED, +1/-1)
