...
type: pull_request
state: MERGED
merged_at: 2022-03-01T14:49:49Z
url: https://github.com/WordPress/gutenberg/pull/38969
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #38969: Components: Normalize font-family

- URL: https://github.com/WordPress/gutenberg/pull/38969
- Author: mirka
- Created: 2022-02-21T20:46:55Z
- Updated: 2022-03-15T23:06:37Z
- Comments: 1 of 1
- Review threads: 1 of 1
- Changed files: 11 of 11
- Diff: ../pr-diffs/38969.diff
...
### github-actions on 2022-02-21T20:54:55Z

URL: https://github.com/WordPress/gutenberg/pull/38969#issuecomment-1047222200
...
#### ciampo on 2022-02-23T20:42:28Z

URL: https://github.com/WordPress/gutenberg/pull/38969#discussion_r813300565
...
#### mirka on 2022-03-01T13:09:01Z

URL: https://github.com/WordPress/gutenberg/pull/38969#discussion_r816752751
Path: packages/components/src/date-time/style.scss
...
Good catch, I didn't even notice! I considered renaming it to "form", but looking at the code again, the "integer" in the internal component `<UpdateOnBlurAsIntegerField>` seems to be about handling integer validation concerns. So the fact that the Months dropdown is using it looks like an abstraction failure, rather than just inappropriate naming 😬 I think we should keep this as is for now, until it causes issues.
...
- packages/components/src/combobox-control/style.scss (MODIFIED, +1/-0)
- packages/components/src/date-time/style.scss (MODIFIED, +4/-0)
- packages/components/src/date-time/time.js (MODIFIED, +16/-5)
...
- packages/components/src/toggle-group-control/test/__snapshots__/index.js.snap (MODIFIED, +1/-0)
- packages/components/src/toggle-group-control/toggle-group-control-option/styles.ts (MODIFIED, +1/-0)
