...
type: pull_request
state: MERGED
merged_at: 2023-03-28T19:09:25Z
url: https://github.com/WordPress/gutenberg/pull/48609
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #48609: FormTokenField: Add prop to remove bottom margin

- URL: https://github.com/WordPress/gutenberg/pull/48609
- Author: brookewp
- Created: 2023-03-01T03:12:28Z
- Updated: 2023-03-28T19:09:53Z
- Comments: 6 of 6
- Review threads: 3 of 3
- Changed files: 6 of 6
- Diff: ../pr-diffs/48609.diff
...
### github-actions on 2023-03-01T03:23:12Z

URL: https://github.com/WordPress/gutenberg/pull/48609#issuecomment-1449276006
...
### brookewp on 2023-03-02T00:47:40Z

URL: https://github.com/WordPress/gutenberg/pull/48609#issuecomment-1451105319

>Thanks for this!
>I haven't done a full review yet, but let's get the FormTokenField itself in good shape first before I start looking at the consumer code. 

Thank you for the initial review and for catching those mistakes! 🙇‍♀️ I've resolved your initial findings!

### brookewp on 2023-03-03T12:57:11Z

URL: https://github.com/WordPress/gutenberg/pull/48609#issuecomment-1453494126

>Note that we still need to maintain the [margin](https://wordpress.github.io/gutenberg/?path=/story/components-formtokenfield--default&args=__experimentalShowHowTo:false&globals=marginChecker:show) when __experimentalShowHowTo = false && __nextHasNoMarginBottom = false.
...
### github-actions on 2023-03-18T00:41:29Z

URL: https://github.com/WordPress/gutenberg/pull/48609#issuecomment-1474547682

<!-- flaky-tests-report-comment -->
**Flaky tests detected in bcf1a9fccba95e1dbfe6bab9c29697dc41e2d035.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/4545977854
📝  Reported issues:
- #35176 in `specs/editor/various/autosave.test.js`

### mirka on 2023-03-21T11:45:40Z

URL: https://github.com/WordPress/gutenberg/pull/48609#issuecomment-1477694689
...
### brookewp on 2023-03-21T18:23:10Z

URL: https://github.com/WordPress/gutenberg/pull/48609#issuecomment-1478387741

>re we going to reduce the scope of this PR? That means to move out the consumer changes (LatestPosts, QueryControls, HierarchicalTermSelector) into a separate PR so they can be reviewed better 🙂 It's actually how we did the rest of the components (as outlined in https://github.com/WordPress/gutenberg/issues/38730 — Step 1: Implement the prop without adding a deprecation warning. Step 2: Migrate the usages in the codebase). I think it's especially worth it in this case because both concerns have some complexity involved.

Ahh, thanks for clarifying! I think this might be a mistake in how I created this branch, which was a branch off of this one: #47515

So initially, the consumer changes _were_ separated in the above PR. However, we need to deprecate the margin bottom from `FormTokenField` in order for `QueryControls` to look correct. So I thought that branching off would make sense, so there isn't any gap of time where it looks off. But I am not too familiar with merging child branches, so I might have done this incorrectly. 😅 

I'd love to hear your thoughts / if you have advice on how to proceed with the branches before I make further assumptions. 🙇‍♀️

## Review threads

### Review thread 1 (resolved)

#### mirka on 2023-03-01T19:53:05Z

URL: https://github.com/WordPress/gutenberg/pull/48609#discussion_r1122232795
...
#### mirka on 2023-03-01T19:53:46Z

URL: https://github.com/WordPress/gutenberg/pull/48609#discussion_r1122233505
Path: packages/components/src/form-token-field/index.tsx

```diff
@@ -67,8 +71,17 @@ export function FormTokenField( props: FormTokenFieldProps ) {
...
#### mirka on 2023-03-01T19:58:41Z

URL: https://github.com/WordPress/gutenberg/pull/48609#discussion_r1122240423
Path: packages/components/src/form-token-field/index.tsx

```diff
@@ -714,16 +727,17 @@ export function FormTokenField( props: FormTokenFieldProps ) {
 				) }
 			</div>
...
Could you help me understand what you were trying to achieve by adding this class? We generally do not want to reuse classnames across component boundaries because that breaks component encapsulation.

#### brookewp on 2023-03-02T00:23:37Z

URL: https://github.com/WordPress/gutenberg/pull/48609#discussion_r1122469875
Path: packages/components/src/form-token-field/index.tsx
...
This was definitely a tired mistake. 😅 I'll change that back.

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/form-token-field/README.md (MODIFIED, +1/-0)
- packages/components/src/form-token-field/index.tsx (MODIFIED, +10/-3)
- packages/components/src/form-token-field/style.scss (MODIFIED, +0/-7)
- packages/components/src/form-token-field/test/index.tsx (MODIFIED, +1/-0)
