...
type: pull_request
state: MERGED
merged_at: 2022-09-01T11:32:12Z
url: https://github.com/WordPress/gutenberg/pull/43719
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components"]
---

# PR #43719: Components: Retire `LIGHT_GRAY[ 200 ]` and `DARK_GRAY[ 150 ]`

- URL: https://github.com/WordPress/gutenberg/pull/43719
- Author: mirka
- Created: 2022-08-30T17:29:29Z
- Updated: 2022-09-01T11:32:38Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 4 of 4
- Diff: ../pr-diffs/43719.diff
...
### github-actions on 2022-08-30T17:43:56Z

URL: https://github.com/WordPress/gutenberg/pull/43719#issuecomment-1231973120
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 197 kB | -51 B (0%) |
...
### jasmussen on 2022-09-01T07:05:41Z

URL: https://github.com/WordPress/gutenberg/pull/43719#issuecomment-1233837280

This is a nice step forward. But all of these colors are still wrong:

<img width="826" alt="Screenshot 2022-09-01 at 09 03 09" src="https://user-images.githubusercontent.com/1204802/187852549-b60b9fe8-2b7b-4841-9420-ac5a9c7e2ebf.png">

They should be these:

<img width="259" alt="Screenshot 2022-09-01 at 09 03 19" src="https://user-images.githubusercontent.com/1204802/187852566-d9c389b6-d5ac-445f-aec5-f0ae8dd2182d.png">

All neutral grays. They look like old colors from before the G2 refresh.

That's not to say this PR cannot land: a retired color is a retired color.

### ciampo on 2022-09-01T07:22:07Z

URL: https://github.com/WordPress/gutenberg/pull/43719#issuecomment-1233855406
...
- swapping `#f3f4f5` with `#f0f0f0` (gray 100)
- swapping `#8d96a0` with `#949494` (gray 600)

I assume that the rest of the `LIGHT_GRAY` and `DARK_GRAY` colors are also going to removed and replaced with the neutral ones

### jasmussen on 2022-09-01T07:28:56Z

URL: https://github.com/WordPress/gutenberg/pull/43719#issuecomment-1233862559
...
- packages/components/src/utils/colors-values.js (MODIFIED, +4/-4)
