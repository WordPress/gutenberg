...
type: pull_request
state: MERGED
merged_at: 2021-12-14T13:53:32Z
url: https://github.com/WordPress/gutenberg/pull/37369
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #37369: Components: Remove unused `reakit-utils` from peer dependencies

- URL: https://github.com/WordPress/gutenberg/pull/37369
- Author: gziolo
- Created: 2021-12-14T13:26:35Z
- Updated: 2021-12-14T13:53:58Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/37369.diff
...
In #37264 warnings from yarn were listed about the not having satisfied the `reakit-utils` dependency, example:

```
@wordpress/block-library@npm:6.0.13 doesn't provide reakit-utils (p79b87), requested by @wordpress/components
```

I got confirmation that this peer dependency should be removed in https://github.com/WordPress/gutenberg/issues/37264#issuecomment-993509603:

> > @diegohaz or @ciampo, do you know why `reakit-utils` is listed as a peer dependency in `@wordpress/components`:
> > https://github.com/WordPress/gutenberg/blob/d6ec4d1781e2a2cc1a19c7807bd31d90dee26406/packages/components/package.json#L71-L73
> > 
...
### github-actions on 2021-12-14T13:33:40Z

URL: https://github.com/WordPress/gutenberg/pull/37369#issuecomment-993543233
...
- packages/components/package.json (MODIFIED, +0/-3)
