...
type: pull_request
state: MERGED
merged_at: 2021-07-19T19:43:41Z
url: https://github.com/WordPress/gutenberg/pull/33553
matched_labels: ["[Package] Components","[Feature] Component System"]
all_labels: ["[Package] Components","[Feature] Component System"]
---

# PR #33553: `ItemGroup`: fix padding, split types, rename boolean props

- URL: https://github.com/WordPress/gutenberg/pull/33553
- Author: ciampo
- Created: 2021-07-19T16:12:28Z
- Updated: 2021-07-19T19:44:04Z
- Comments: 1 of 1
- Review threads: 1 of 1
- Changed files: 7 of 7
- Diff: ../pr-diffs/33553.diff
...
This PR cherry-picks a few minor improvements to the `<ItemGroup />` component  that were part of #33070 and didn't get merged when the original PR got closed:

- refactor types to a separate file
- rename boolean props and add the `is*` prefix
- Fix padding styles not being applied by removing an extra comma
- Rename `[last|first]-child` CSS rules to `[last|first]-of-type` to avoid Storybook warnings
- Updated storybook stories to use knobs

This component is still experimental and doesn't have a README yet
...
- visit the `ItemGroup` story
- Make sure both the default and dropdown stories behave as expected:
  - when editing the values of the knobs
  - compared to [production](https://wordpress.github.io/gutenberg)

## Screenshots <!-- if applicable -->

![Screenshot 2021-07-19 at 18 06 04](https://user-images.githubusercontent.com/1083581/126191531-6afd31ac-debb-483f-b9af-98b6ba1a20b7.png)
...
### github-actions on 2021-07-19T16:19:35Z

URL: https://github.com/WordPress/gutenberg/pull/33553#issuecomment-882681119
...
#### sarayourfriend on 2021-07-19T18:01:57Z

URL: https://github.com/WordPress/gutenberg/pull/33553#discussion_r672515760
Path: packages/components/src/ui/item-group/types.ts
...
- packages/components/src/ui/item-group/context.ts (MODIFIED, +8/-4)
- packages/components/src/ui/item-group/item-group.tsx (MODIFIED, +9/-7)
- packages/components/src/ui/item-group/stories/index.js (MODIFIED, +50/-20)
- packages/components/src/ui/item-group/styles.ts (MODIFIED, +6/-6)
- packages/components/src/ui/item-group/types.ts (ADDED, +18/-0)
- packages/components/src/ui/item-group/use-item-group.ts (MODIFIED, +10/-16)
- packages/components/src/ui/item-group/use-item.ts (MODIFIED, +13/-9)
