...
type: pull_request
state: MERGED
merged_at: 2026-05-18T12:23:35Z
url: https://github.com/WordPress/gutenberg/pull/78362
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components","[Package] Base styles"]
---

# PR #78362: Modal: Inline header z-index

- URL: https://github.com/WordPress/gutenberg/pull/78362
- Author: mirka
- Created: 2026-05-15T17:39:37Z
- Updated: 2026-05-18T12:24:18Z
- Comments: 3 of 3
- Review threads: 2 of 2
- Changed files: 3 of 3
- Diff: ../pr-diffs/78362.diff
...
### github-actions on 2026-05-15T17:47:36Z

URL: https://github.com/WordPress/gutenberg/pull/78362#issuecomment-4461982722
...
### github-actions on 2026-05-15T17:58:40Z

URL: https://github.com/WordPress/gutenberg/pull/78362#issuecomment-4462050153
...
### github-actions on 2026-05-15T18:19:52Z

URL: https://github.com/WordPress/gutenberg/pull/78362#issuecomment-4462189581

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 6584046290b238773ee2747d9e28b9caeb5f72e2.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/25932707789
📝  Reported issues:
...
#### mirka on 2026-05-15T17:56:15Z

URL: https://github.com/WordPress/gutenberg/pull/78362#discussion_r3249983915
...
This value looks arbitrary and no specific reasoning is given in the original PR that introduced it. However, given how long this specific value has been around (seven years), and how consumers very often override modal styles using internal classes, there are definitely cases where changing the value could cause a regression.

Since we have a cleaner replacement in the pipeline (`Dialog`), I think it would be fine to keep this magic value for this legacy component.

### Review thread 2

#### mirka on 2026-05-15T17:57:55Z

URL: https://github.com/WordPress/gutenberg/pull/78362#discussion_r3249991279
...
This value looks high enough to seem like it's participating in some kind of global coordination, but its parent stacking context is within the `Modal` component (`.components-modal__frame`), so it's not a global concern.

## Changed files

- packages/base-styles/CHANGELOG.md (MODIFIED, +2/-1)
- packages/base-styles/_z-index.scss (MODIFIED, +0/-1)
- packages/components/src/modal/style.scss (MODIFIED, +2/-1)
