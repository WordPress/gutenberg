...
type: pull_request
state: MERGED
merged_at: 2022-11-10T00:04:55Z
url: https://github.com/WordPress/gutenberg/pull/45617
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #45617: MenuGroup: Convert component to TypeScript

- URL: https://github.com/WordPress/gutenberg/pull/45617
- Author: walbo
- Created: 2022-11-08T23:43:49Z
- Updated: 2022-11-10T00:05:15Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 5 of 5
- Diff: ../pr-diffs/45617.diff
...
## What?
Refactor the `MenuGroup` component to TypeScript.
...
2. Run  `npm run test:unit -- packages/components/src/menu-group` and make sure unit tests passes.
3. Test the editor and make sure the MenuGroup still works.

## Issue comments

### codesandbox on 2022-11-08T23:43:51Z

URL: https://github.com/WordPress/gutenberg/pull/45617#issuecomment-1307985589

<img alt="CodeSandbox logo" src="https://raw.githubusercontent.com/codesandbox/open-in-codesandbox/main/assets/csb.light.svg#gh-dark-mode-only" /><img alt="CodeSandbox logo" src="https://raw.githubusercontent.com/codesandbox/open-in-codesandbox/main/assets/csb.svg#gh-light-mode-only" />&nbsp; Open in CodeSandbox <a href="https://codesandbox.io/p/github/WordPress/gutenberg/refactor/menu-group-to-typescript?workspace=%7B%22gitSidebarPanel%22:%22PR%22,%22sidebarPanel%22:%22GIT%22%7D">Web Editor</a> | <a href="https://codesandbox.io/p/vscode?owner=WordPress&repo=gutenberg&branch=refactor/menu-group-to-typescript">VS Code</a> | <a href="https://codesandbox.io/p/vscode?owner=WordPress&repo=gutenberg&branch=refactor/menu-group-to-typescript&insiders=true">VS Code Insiders</a>

<!-- open-in-codesandbox:complete -->

### github-actions on 2022-11-08T23:54:15Z

URL: https://github.com/WordPress/gutenberg/pull/45617#issuecomment-1307994565
...
| :--- | :---: | :---: |
| `build/block-library/index.min.js` | 193 kB | +28 B (0%) |
...
| `build/block-library/blocks/navigation/style-rtl.css` | 2.2 kB |
| `build/block-library/blocks/navigation/style.css` | 2.19 kB |
...
- packages/components/src/menu-group/index.tsx (RENAMED, +22/-3)
- packages/components/src/menu-group/test/index.tsx (RENAMED, +0/-0)
- packages/components/src/menu-group/types.ts (ADDED, +23/-0)
- test/integration/fixtures/blocks/core__button__center__deprecated.json (MODIFIED, +0/-1)
