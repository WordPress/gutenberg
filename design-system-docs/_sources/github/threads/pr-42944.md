...
type: pull_request
state: MERGED
merged_at: 2022-08-04T05:52:25Z
url: https://github.com/WordPress/gutenberg/pull/42944
matched_labels: ["[Package] Components"]
all_labels: ["[Feature] UI Components","[Package] Components"]
---

# PR #42944: Popover: tidy up code 🧹 , add more comments

- URL: https://github.com/WordPress/gutenberg/pull/42944
- Author: ciampo
- Created: 2022-08-03T15:58:52Z
- Updated: 2022-08-04T05:52:54Z
- Comments: 1 of 1
- Review threads: 4 of 4
- Changed files: 2 of 2
- Diff: ../pr-diffs/42944.diff
...
Extracted from the exploration in #42531, this PR includes a few improvements to the `Popover`'s code that improve its readability without introducing virtually any runtime changes.

## Why?
<!-- Why is this PR necessary? What problem is it solving? Reference any existing previous issue(s) or PR(s), but please add a short summary here, too -->

These changes hopefully will help future developers to understand `Popover`'s code more easily.

## How?
<!-- How is your PR addressing the issue at hand? What are the implementation details? -->

- Renames variables
- Added lots of inline comments
...
Check that there's no runtime changes, smoke test Storybook and the various popovers across the editor to make sure everything behaves as on `trunk`

## Issue comments

### github-actions on 2022-08-03T16:31:17Z

URL: https://github.com/WordPress/gutenberg/pull/42944#issuecomment-1204199224
...
#### ntsekouras on 2022-08-03T16:13:45Z

URL: https://github.com/WordPress/gutenberg/pull/42944#discussion_r936863379
Path: packages/components/src/popover/index.js

```diff
@@ -279,28 +280,38 @@ const Popover = (
 	} );
...
#### ntsekouras on 2022-08-03T16:15:42Z

URL: https://github.com/WordPress/gutenberg/pull/42944#discussion_r936870327
Path: packages/components/src/popover/index.js
...
#### ntsekouras on 2022-08-03T16:17:02Z

URL: https://github.com/WordPress/gutenberg/pull/42944#discussion_r936875091
Path: packages/components/src/popover/index.js

```diff
@@ -313,17 +324,22 @@ const Popover = (
 				},
 			};
...
#### ntsekouras on 2022-08-03T16:19:13Z

URL: https://github.com/WordPress/gutenberg/pull/42944#discussion_r936882028
Path: packages/components/src/popover/index.js

```diff
@@ -364,7 +384,9 @@ const Popover = (
 		};
...
- packages/components/src/popover/index.js (MODIFIED, +61/-32)
