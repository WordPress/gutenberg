...
type: pull_request
state: MERGED
merged_at: 2026-04-28T12:31:20Z
url: https://github.com/WordPress/gutenberg/pull/77691
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Enhancement","[Package] UI"]
---

# PR #77691: ui: Unify hairline border across overlay popups

- URL: https://github.com/WordPress/gutenberg/pull/77691
- Author: ciampo
- Created: 2026-04-27T12:21:52Z
- Updated: 2026-04-28T12:32:01Z
- Comments: 10 of 10
- Review threads: 0 of 0
- Changed files: 6 of 6
- Diff: ../pr-diffs/77691.diff
...
### github-actions on 2026-04-27T12:34:30Z

URL: https://github.com/WordPress/gutenberg/pull/77691#issuecomment-4326993281
...
| `build/scripts/editor/index.min.js` | 423 kB |
...
### github-actions on 2026-04-27T12:52:01Z

URL: https://github.com/WordPress/gutenberg/pull/77691#issuecomment-4327104507

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 9bdc06d8cb56551722fa6064966207518e4f3144.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/25036769430
📝  Reported issues:
...
### github-actions on 2026-04-27T13:05:45Z

URL: https://github.com/WordPress/gutenberg/pull/77691#issuecomment-4327194800
...
### jameskoster on 2026-04-27T13:52:12Z

URL: https://github.com/WordPress/gutenberg/pull/77691#issuecomment-4327522409

It's difficult to approve the `Dialog` change from a design POV. The stroke color being lighter the overlay color (assuming a white page background) makes the appearance a bit uncanny to my eye. It might work a bit better if the overlay was white, or perhaps less opaque with some blur, but obviously that's a separate change.

## This PR
<img width="1142" height="558" alt="Screenshot 2026-04-27 at 14 47 28" src="https://github.com/user-attachments/assets/33dfd528-6a23-40c3-b27d-10f4e24ee0da" />

## Alternatives
<img width="1166" height="618" alt="Screenshot 2026-04-27 at 14 47 10" src="https://github.com/user-attachments/assets/f013fc18-876d-4505-8374-5847097ca2a7" />
<img width="1143" height="633" alt="Screenshot 2026-04-27 at 14 49 07" src="https://github.com/user-attachments/assets/a37519af-8aa0-47d8-9f53-27a062544e9a" />

### ciampo on 2026-04-27T14:13:30Z

URL: https://github.com/WordPress/gutenberg/pull/77691#issuecomment-4327677028

@jameskoster this PR is trying to achieve two things:

- design uniformity (in terms of border and box-shadow styles)
- accessibility (ie. always show overlay borders in forced colors / high contrast mode)

I'm happy to follow your lead on the designs (although I believe that, whatever we choose, we should try to be as consistent as possible), and I'll make sure that we'll always have a visible border in forced color mode.

Also, a reminder that both `Dialog`, `Popover` and `Drawer` can expose a `modal` prop. The backrdop only shows when `modal={true}`.

### jameskoster on 2026-04-27T14:38:23Z

URL: https://github.com/WordPress/gutenberg/pull/77691#issuecomment-4327862887

I understand, I'm just trying to ensure the final result remains visually compelling. Like I said, the addition of the border on `Dialog` is making the edge of the UI feel a little fuzzy compared to what we have on trunk, and I think it's because the overlay is just a little darker than the border. The border is the right color though, so it's a case of tuning the overlay to find something that works well. Then again maybe it's just me. Let's see what other folks in the Design group think.

### ciampo on 2026-04-27T19:25:18Z

URL: https://github.com/WordPress/gutenberg/pull/77691#issuecomment-4329822662

> I wonder if we can remove the border when there's a backdrop? Too much complexity?

Happy to try that.

> I would also say the border is still quite subtle in dark mode, especially in something like the popover arrow. It's not invisible but I can barely see it.

That is true. For sure we have to iterate more when it comes to borders and especially box shadows in "dark" themes.

### ciampo on 2026-04-28T06:04:57Z

URL: https://github.com/WordPress/gutenberg/pull/77691#issuecomment-4332742380

@mirka @jameskoster I've updated the PR as suggested:

- borders are only shown when there's no backdrop;
- borders are always shown in forced-colors mode.

### jameskoster on 2026-04-28T12:17:01Z

URL: https://github.com/WordPress/gutenberg/pull/77691#issuecomment-4335114827

That sounds good for now. To be clear; I'm not opposed to the border. In fact I think it would be more stylistically aligned with other container components (not only popovers, but `Card` and `Notice` as well) to include one. It just needs a backdrop tweak to accommodate. Maybe we can revisit separately?

### ciampo on 2026-04-28T12:31:04Z

URL: https://github.com/WordPress/gutenberg/pull/77691#issuecomment-4335230351

Agreed. We can definitely improve styles and consistency around border/box shadows/backdrops.

In the meantime, I'll merge this PR as-is, as it introduces an a11y fix.
...
- packages/ui/src/dialog/style.module.css (MODIFIED, +29/-0)
- packages/ui/src/drawer/style.module.css (MODIFIED, +29/-0)
- packages/ui/src/popover/style.module.css (MODIFIED, +30/-2)
