...
type: pull_request
state: MERGED
merged_at: 2022-07-25T19:14:59Z
url: https://github.com/WordPress/gutenberg/pull/42510
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","Internationalization (i18n)","[Package] Components"]
---

# PR #42510: ColorPalette: Fix background image in RTL mode

- URL: https://github.com/WordPress/gutenberg/pull/42510
- Author: walbo
- Created: 2022-07-18T15:43:36Z
- Updated: 2022-07-25T19:15:28Z
- Comments: 1 of 1
- Review threads: 1 of 1
- Changed files: 2 of 2
- Diff: ../pr-diffs/42510.diff
...
## What?
Fix background image in the `ColorPalette` component when no color is picked in RTL mode.

## Why?
Better RTL experience 

## How?
Don't change the `background-position` value in the RTL css file.

## Testing Instructions
1. Fire up the storybook.
2. Go to `ColorPalette`
3. Change to RTL and deselect the color. The background should show white and gray squares.

## Screenshots or screencast <!-- if applicable -->
| Before | After |
| - | - |
| ![color-palette-bug](https://user-images.githubusercontent.com/1415747/179546574-c197e4a8-c4b9-428b-977e-cb4b0af7f0e9.gif) | ![color-palette-fixed](https://user-images.githubusercontent.com/1415747/179546732-3fafa34b-aea4-4f72-a036-69384cf19909.gif) |

## Issue comments

### github-actions on 2022-07-18T15:53:01Z

URL: https://github.com/WordPress/gutenberg/pull/42510#issuecomment-1187670688
...
#### talldan on 2022-07-19T08:00:37Z

URL: https://github.com/WordPress/gutenberg/pull/42510#discussion_r924184340
...
It'd be great to add a comment to say why this is ignored. It would help incidental readers of this code understand what the gradient does.

#### walbo on 2022-07-19T12:23:08Z

URL: https://github.com/WordPress/gutenberg/pull/42510#discussion_r924429311
Path: packages/components/src/color-palette/style.scss
...
- packages/components/src/color-palette/style.scss (MODIFIED, +5/-0)
