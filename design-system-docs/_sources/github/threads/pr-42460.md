...
type: pull_request
state: MERGED
merged_at: 2022-07-19T16:26:07Z
url: https://github.com/WordPress/gutenberg/pull/42460
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components"]
---

# PR #42460: CustomSelectControl: Use styles from SelectControl

- URL: https://github.com/WordPress/gutenberg/pull/42460
- Author: mirka
- Created: 2022-07-15T08:56:58Z
- Updated: 2022-07-19T16:28:33Z
- Comments: 2 of 2
- Review threads: 1 of 1
- Changed files: 4 of 4
- Diff: ../pr-diffs/42460.diff
...
### github-actions on 2022-07-15T09:04:30Z

URL: https://github.com/WordPress/gutenberg/pull/42460#issuecomment-1185338404
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 230 kB | +97 B (0%) |
| `build/components/style-rtl.css` | 14 kB | -31 B (0%) |
| `build/components/style.css` | 14 kB | -32 B (0%) |
...
### mirka on 2022-07-19T13:04:46Z

URL: https://github.com/WordPress/gutenberg/pull/42460#issuecomment-1189028273
...
Right, I consider the font size to be a bug fix. It's a side effect of the `isSmall` Button like you say and I don't think it was ever an intentional choice.

## Review threads

### Review thread 1

#### mirka on 2022-07-15T09:08:06Z

URL: https://github.com/WordPress/gutenberg/pull/42460#discussion_r921971827
...
I'm going to remove this conditional for now — you might notice that the spacing after the `chevronDown` is slightly different from the one in trunk, when `__next36pxDefaultSize=true`. This responsive spacing will be added back in a cleaner way after #42378 lands.

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +4/-1)
- packages/components/src/custom-select-control/index.js (MODIFIED, +44/-26)
- packages/components/src/custom-select-control/stories/index.js (MODIFIED, +7/-2)
- packages/components/src/custom-select-control/style.scss (MODIFIED, +4/-29)
