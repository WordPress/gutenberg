...
type: pull_request
state: MERGED
merged_at: 2023-01-04T15:58:59Z
url: https://github.com/WordPress/gutenberg/pull/42377
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components","Storybook"]
---

# PR #42377: Use data URI for `FocalPointPicker` video story

- URL: https://github.com/WordPress/gutenberg/pull/42377
- Author: stokesman
- Created: 2022-07-12T18:35:47Z
- Updated: 2023-01-04T15:59:31Z
- Comments: 5 of 5
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/42377.diff
...
## What?
Updates the video story so it does not rely on an external link.

## Why?
The present link is 404.
https://github.com/WordPress/gutenberg/blob/233142b1aca24e8a51da7bf6029155b9f59c8777/packages/components/src/focal-point-picker/stories/index.js#L42-L43

## How?
Updates the utility function `isVideoType` to recognize data URIs and uses one to replace the story’s video url.

## Alternatives to consider
We can probably get a smaller data URI than the one here (~18kb) but I figured it'd be fun to try this one. Of course, if we'd prefer to to just find a new link for an external video that's fine by me.

## Testing Instructions
Try the story out and confirm the video works.

## Screenshots or screencast 
![nyan-in-story](https://user-images.githubusercontent.com/9000376/178567613-8029dfe5-eca9-4621-9b7a-16fc3903df65.png)

## Issue comments

### github-actions on 2022-07-12T18:43:34Z

URL: https://github.com/WordPress/gutenberg/pull/42377#issuecomment-1182243030
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 230 kB | +11 B (0%) |
...
### ciampo on 2023-01-03T13:08:05Z

URL: https://github.com/WordPress/gutenberg/pull/42377#issuecomment-1369747909

I force-pushed this PR to unblock CI tasks — but it still looks like @mirka 's request to make the video data smaller hasn't been addressed yet

### mirka on 2023-01-04T01:07:08Z

URL: https://github.com/WordPress/gutenberg/pull/42377#issuecomment-1370380368

Although, the "bundle bloat" problem is a non-issue now that our story files are chunked 😄 Still, one could say that a video URL would be a more realistic use case than a data URL. I'll suggest this video URL from wordpress.tv that will likely stay up for a while: https://videos.files.wordpress.com/NGYE1Hqy/video-206c645332.mp4

### stokesman on 2023-01-04T06:49:59Z

URL: https://github.com/WordPress/gutenberg/pull/42377#issuecomment-1370544251

Thanks Marco!

I still favor data URI for its resource conservation and network independence. Subjectively, nyan cat seems like more fun too. If no one can get up the courage to approve though I will acquiesce and make the suggested change.

Alternatively if anyone feels like making the change please do. You'll have my approval.

### ciampo on 2023-01-04T15:58:52Z

URL: https://github.com/WordPress/gutenberg/pull/42377#issuecomment-1371110090
...
- packages/components/src/focal-point-picker/stories/index.tsx (MODIFIED, +1/-1)
- packages/components/src/focal-point-picker/utils.ts (MODIFIED, +4/-1)
