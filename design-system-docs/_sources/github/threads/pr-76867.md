...
type: pull_request
state: MERGED
merged_at: 2026-04-01T10:26:04Z
url: https://github.com/WordPress/gutenberg/pull/76867
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Enhancement","[Package] DataViews","[Package] UI"]
---

# PR #76867: CollapsibleCard: Add HeaderDescription subcomponent

- URL: https://github.com/WordPress/gutenberg/pull/76867
- Author: ciampo
- Created: 2026-03-27T16:59:51Z
- Updated: 2026-04-01T10:26:49Z
- Comments: 4 of 4
- Review threads: 3 of 3
- Changed files: 10 of 10
- Diff: ../pr-diffs/76867.diff
...
### github-actions on 2026-03-27T17:00:01Z

URL: https://github.com/WordPress/gutenberg/pull/76867#issuecomment-4143996230
...
### github-actions on 2026-03-27T17:00:02Z

URL: https://github.com/WordPress/gutenberg/pull/76867#issuecomment-4143996263
...
- **Labels found**: [Package] DataViews, [Package] UI.
...
### github-actions on 2026-03-27T17:24:20Z

URL: https://github.com/WordPress/gutenberg/pull/76867#issuecomment-4144127177

**Size Change:** +402 B (+0.01%) 

**Total Size:** 7.73 MB

| Filename | Size | Change |
| :--- | :---: | :---: |
| `build/scripts/block-editor/index.min.js` | 339 kB | +165 B (+0.05%) |
| `build/scripts/edit-site/index.min.js` | 261 kB | +178 B (+0.07%) |
| `build/scripts/editor/index.min.js` | 410 kB | +59 B (+0.01%) |
...
### github-actions on 2026-03-27T17:41:28Z

URL: https://github.com/WordPress/gutenberg/pull/76867#issuecomment-4144221570

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 3c55c810225093370c926e73fd7b3793fb384319.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/23842549615
📝  Reported issues:
...
#### mirka on 2026-03-31T17:48:18Z

URL: https://github.com/WordPress/gutenberg/pull/76867#discussion_r3017400295
...
Not that it matters now because of the CSS modules, but could be better for future setups.

#### ciampo on 2026-04-01T09:40:42Z

URL: https://github.com/WordPress/gutenberg/pull/76867#discussion_r3020960965
Path: packages/ui/src/collapsible-card/test/index.test.tsx
...
#### mirka on 2026-03-31T17:51:19Z

URL: https://github.com/WordPress/gutenberg/pull/76867#discussion_r3017415932
...
#### mirka on 2026-03-31T17:57:19Z

URL: https://github.com/WordPress/gutenberg/pull/76867#discussion_r3017445832
Path: packages/ui/src/collapsible-card/stories/index.story.tsx

```diff
@@ -156,6 +157,49 @@ export const Stacked: Story = {
 	),
 };
...
Is this an actual pattern we're using (or will use) in the app? It does look good as a pattern, but if it's not official yet, it could be safer to stick with an existing pattern like the one in DataForm (horizontal stack) so it doesn't look like we're endorsing this specific vertical stack pattern. We might want agreement on the alignment of the caret icon too, in case of a vertical stack.

#### ciampo on 2026-04-01T09:48:26Z

URL: https://github.com/WordPress/gutenberg/pull/76867#discussion_r3021000829
Path: packages/ui/src/collapsible-card/stories/index.story.tsx
...
Interesting point. We'd actually want DataForm to support better layout flexibility for consumers (at the moment it forces a horizontal layout), both in terms of custom layours and responsiveness.

I applied your suggestion nonetheless, I agree that consistency with dataforms is better here.

## Changed files

- packages/dataviews/CHANGELOG.md (MODIFIED, +1/-0)
- packages/dataviews/src/components/dataform-layouts/card/index.tsx (MODIFIED, +3/-12)
- packages/ui/CHANGELOG.md (MODIFIED, +1/-0)
- packages/ui/src/collapsible-card/context.ts (ADDED, +7/-0)
- packages/ui/src/collapsible-card/header-description.tsx (ADDED, +43/-0)
- packages/ui/src/collapsible-card/header.tsx (MODIFIED, +43/-26)
- packages/ui/src/collapsible-card/index.ts (MODIFIED, +2/-1)
- packages/ui/src/collapsible-card/stories/index.story.tsx (MODIFIED, +47/-0)
- packages/ui/src/collapsible-card/test/index.test.tsx (MODIFIED, +93/-0)
- packages/ui/src/collapsible-card/types.ts (MODIFIED, +12/-0)
