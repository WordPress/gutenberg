...
type: pull_request
state: MERGED
merged_at: 2022-08-18T00:55:21Z
url: https://github.com/WordPress/gutenberg/pull/43304
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components","Global Styles","Needs User Documentation"]
---

# PR #43304: Improve appearance of controls in the Global Styles Typography panel

- URL: https://github.com/WordPress/gutenberg/pull/43304
- Author: noisysocks
- Created: 2022-08-17T07:05:51Z
- Updated: 2022-09-04T16:44:39Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 8 of 8
- Diff: ../pr-diffs/43304.diff
...
### github-actions on 2022-08-17T07:17:26Z

URL: https://github.com/WordPress/gutenberg/pull/43304#issuecomment-1217554524
...
| `build/block-editor/style-rtl.css` | 15.1 kB | -19 B (0%) |
| `build/block-editor/style.css` | 15.1 kB | -18 B (0%) |
| `build/components/index.min.js` | 198 kB | -5 B (0%) |
| `build/components/style-rtl.css` | 11.6 kB | +1 B (0%) |
| `build/components/style.css` | 11.6 kB | +1 B (0%) |
...
### ciampo on 2022-08-17T10:50:59Z

URL: https://github.com/WordPress/gutenberg/pull/43304#issuecomment-1217850247
...
### noisysocks on 2022-08-18T00:15:18Z

URL: https://github.com/WordPress/gutenberg/pull/43304#issuecomment-1218735630

> I'm a bit conflicted about this one, because although it does "look nicer" it now becomes absolutely indistinguishable from a normal `radio` 😂

Yeah it's not great. I like the suggestion in https://github.com/WordPress/gutenberg/issues/34345#issuecomment-1217786842 of designing a secondary variation for `TabPanel` and then using that. In the meantime though just want to clean this up a bit since the margins were all over the place.

> I wonder if we should instead hide the visual label completely?

Good idea! I think that definitely works a little better.

<img width="297" alt="Screen Shot 2022-08-18 at 10 06 16" src="https://user-images.githubusercontent.com/612155/185265229-598ea28e-c6a9-4974-848c-33a2fb003d4b.png">
...
- packages/block-editor/src/components/font-appearance-control/style.scss (MODIFIED, +0/-2)
- packages/block-editor/src/components/font-family/index.js (MODIFIED, +1/-1)
- packages/block-editor/src/hooks/typography.scss (MODIFIED, +0/-1)
- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/font-size-picker/index.js (MODIFIED, +26/-34)
- packages/components/src/font-size-picker/style.scss (MODIFIED, +4/-0)
- packages/edit-site/src/components/global-styles/style.scss (MODIFIED, +3/-2)
- packages/edit-site/src/components/global-styles/typography-panel.js (MODIFIED, +96/-93)
