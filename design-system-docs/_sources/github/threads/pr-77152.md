...
type: pull_request
state: MERGED
merged_at: 2026-04-09T15:24:41Z
url: https://github.com/WordPress/gutenberg/pull/77152
matched_labels: ["Design System"]
all_labels: ["[Type] Enhancement","Design System","[Package] Admin UI"]
---

# PR #77152: Admin UI: Increase page header vertical padding

- URL: https://github.com/WordPress/gutenberg/pull/77152
- Author: jameskoster
- Created: 2026-04-08T14:11:39Z
- Updated: 2026-04-09T15:25:21Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/77152.diff
...
### github-actions on 2026-04-08T14:11:52Z

URL: https://github.com/WordPress/gutenberg/pull/77152#issuecomment-4206888888
...
### github-actions on 2026-04-08T14:24:48Z

URL: https://github.com/WordPress/gutenberg/pull/77152#issuecomment-4206983443
...
| :--- | :---: | :---: |
| `build/modules/boot/index.min.js` | 16.9 kB | -5 B (-0.03%) |
| `build/styles/edit-post/style-rtl.css` | 4.01 kB | -7 B (-0.17%) |
| `build/styles/edit-post/style-rtl.min.css` | 2.7 kB | -5 B (-0.19%) |
| `build/styles/edit-post/style.css` | 4.02 kB | -6 B (-0.15%) |
| `build/styles/edit-post/style.min.css` | 2.7 kB | -5 B (-0.18%) |
| `build/styles/edit-site/style-rtl.css` | 20.9 kB | -6 B (-0.03%) |
| `build/styles/edit-site/style-rtl.min.css` | 17 kB | -6 B (-0.04%) |
| `build/styles/edit-site/style.css` | 20.9 kB | -6 B (-0.03%) |
| `build/styles/edit-site/style.min.css` | 17 kB | -6 B (-0.04%) |
| `build/styles/edit-widgets/style-rtl.css` | 5.34 kB | -6 B (-0.11%) |
| `build/styles/edit-widgets/style-rtl.min.css` | 4 kB | -6 B (-0.15%) |
| `build/styles/edit-widgets/style.css` | 5.34 kB | -5 B (-0.09%) |
| `build/styles/edit-widgets/style.min.css` | 4 kB | -6 B (-0.15%) |
| `build/styles/editor/style-rtl.css` | 26.6 kB | -5 B (-0.02%) |
| `build/styles/editor/style-rtl.min.css` | 22.5 kB | -5 B (-0.02%) |
| `build/styles/editor/style.css` | 26.7 kB | -6 B (-0.02%) |
...
### github-actions on 2026-04-08T14:43:15Z

URL: https://github.com/WordPress/gutenberg/pull/77152#issuecomment-4207106703

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 95690c71cb2b793a33d2002772022e97fedc07e1.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/24140034210
📝  Reported issues:
...
- packages/admin-ui/src/page/style.scss (MODIFIED, +1/-1)
