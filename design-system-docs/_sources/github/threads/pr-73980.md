...
type: pull_request
state: MERGED
merged_at: 2025-12-15T17:29:10Z
url: https://github.com/WordPress/gutenberg/pull/73980
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #73980: FocalPointPicker: Deprecate bottom margin

- URL: https://github.com/WordPress/gutenberg/pull/73980
- Author: mirka
- Created: 2025-12-12T19:22:26Z
- Updated: 2025-12-15T17:35:10Z
- Comments: 3 of 3
- Review threads: 1 of 1
- Changed files: 12 of 12
- Diff: ../pr-diffs/73980.diff
...
Remove the deprecated `__nextHasNoMarginBottom` prop from `FocalPointPicker`, making the margin-free styles the permanent default.
...
- Remove the `__nextHasNoMarginBottom` prop from `FocalPointPicker` and its types and docs.
...
### github-actions on 2025-12-12T19:23:24Z

URL: https://github.com/WordPress/gutenberg/pull/73980#issuecomment-3647841256
...
### github-actions on 2025-12-12T19:39:03Z

URL: https://github.com/WordPress/gutenberg/pull/73980#issuecomment-3647889843
...
| :--- | :---: | :---: |
| `build/scripts/block-editor/index.min.js` | 315 kB | -4 B (0%) |
| `build/scripts/block-library/index.min.js` | 281 kB | -7 B (0%) |
| `build/scripts/components/index.min.js` | 272 kB | -211 B (-0.08%) |
...
| `build/styles/block-editor/style-rtl.css` | 15.4 kB |
| `build/styles/block-editor/style.css` | 15.4 kB |
...
### github-actions on 2025-12-12T19:57:21Z

URL: https://github.com/WordPress/gutenberg/pull/73980#issuecomment-3647946036

<!-- flaky-tests-report-comment -->
**Flaky tests detected in e9e5d363958633891f4bd5ff759d1fa49d1e3d29.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/20239284765
📝  Reported issues:
...
#### juanfra on 2025-12-15T11:11:25Z

URL: https://github.com/WordPress/gutenberg/pull/73980#discussion_r2618979696
Path: packages/components/src/focal-point-picker/index.tsx

```diff
@@ -89,7 +87,6 @@ const GRID_OVERLAY_TIMEOUT = 600;
  * ```
  */
...
#### mirka on 2025-12-15T16:17:50Z

URL: https://github.com/WordPress/gutenberg/pull/73980#discussion_r2620040542
Path: packages/components/src/focal-point-picker/index.tsx
...
Nice catch, thank you! e9e5d363958633891f4bd5ff759d1fa49d1e3d29
...
- packages/components/src/focal-point-picker/README.md (MODIFIED, +0/-17)
- packages/components/src/focal-point-picker/controls.tsx (MODIFIED, +0/-2)
- packages/components/src/focal-point-picker/index.tsx (MODIFIED, +3/-15)
- packages/components/src/focal-point-picker/stories/index.story.tsx (MODIFIED, +1/-6)
- packages/components/src/focal-point-picker/styles/focal-point-picker-style.ts (MODIFIED, +0/-11)
- packages/components/src/focal-point-picker/test/index.tsx (MODIFIED, +1/-1)
- packages/components/src/focal-point-picker/types.ts (MODIFIED, +3/-1)
