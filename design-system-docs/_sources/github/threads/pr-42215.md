...
type: pull_request
state: MERGED
merged_at: 2022-07-07T10:01:14Z
url: https://github.com/WordPress/gutenberg/pull/42215
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Performance","[Type] Code Quality","[Package] Components","[Package] Blocks","[Package] Editor","[Package] Block library","[Package] Block editor","[Package] Edit Site"]
---

# PR #42215: Lodash: Refactor away from `_.identity()`

- URL: https://github.com/WordPress/gutenberg/pull/42215
- Author: tyxla
- Created: 2022-07-07T08:09:29Z
- Updated: 2022-07-07T10:01:44Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 10 of 10
- Diff: ../pr-diffs/42215.diff
...
### github-actions on 2022-07-07T08:18:09Z

URL: https://github.com/WordPress/gutenberg/pull/42215#issuecomment-1177237864
...
| `build/block-library/index.min.js` | 183 kB | -6 B (0%) |
| `build/blocks/index.min.js` | 47 kB | -3 B (0%) |
| `build/components/index.min.js` | 230 kB | -8 B (0%) |
| `build/edit-site/index.min.js` | 52 kB | -1 B (0%) |
| `build/editor/index.min.js` | 39.4 kB | +5 B (0%) |
...
- packages/block-editor/src/components/block-list/index.native.js (MODIFIED, +1/-1)
- packages/block-editor/src/hooks/utils.js (MODIFIED, +2/-1)
- packages/block-editor/src/store/reducer.js (MODIFIED, +2/-1)
- packages/block-library/src/utils/clean-empty-object.js (MODIFIED, +3/-1)
- packages/blocks/src/api/validation/index.js (MODIFIED, +3/-1)
- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/form-token-field/index.tsx (MODIFIED, +3/-1)
- packages/edit-site/src/components/global-styles/global-styles-provider.js (MODIFIED, +3/-8)
- packages/editor/src/components/post-taxonomies/index.js (MODIFIED, +3/-1)
