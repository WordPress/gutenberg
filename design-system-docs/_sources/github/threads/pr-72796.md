...
type: pull_request
state: MERGED
merged_at: 2025-10-31T13:13:30Z
url: https://github.com/WordPress/gutenberg/pull/72796
matched_labels: ["[Package] Theme"]
all_labels: ["[Type] Performance","[Package] Theme"]
---

# PR #72796: Theme: Add caching for theme color ramp builders

- URL: https://github.com/WordPress/gutenberg/pull/72796
- Author: aduth
- Created: 2025-10-29T17:08:22Z
- Updated: 2025-10-31T13:14:44Z
- Comments: 3 of 3
- Review threads: 1 of 1
- Changed files: 8 of 8
- Diff: ../pr-diffs/72796.diff
...
### github-actions on 2025-10-29T17:19:57Z

URL: https://github.com/WordPress/gutenberg/pull/72796#issuecomment-3462765408
...
| :--- | :---: | :---: |
| `build/scripts/theme/index.min.js` | 28.5 kB | +53 B (+0.19%) |
...
### github-actions on 2025-10-29T18:15:31Z

URL: https://github.com/WordPress/gutenberg/pull/72796#issuecomment-3462994923

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 904dd42e24a1e16354d406eecdb85f7b9edc0c5f.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/18916192587
📝  Reported issues:
...
- #57389 in `/test/e2e/specs/interactivity/router-navigate.spec.ts`

### github-actions on 2025-10-31T12:54:12Z

URL: https://github.com/WordPress/gutenberg/pull/72796#issuecomment-3472977735
...
#### jsnajdr on 2025-10-31T12:54:00Z

URL: https://github.com/WordPress/gutenberg/pull/72796#discussion_r2481323466
Path: packages/theme/src/color-ramps/lib/find-color-with-constraints.ts

```diff
@@ -80,15 +77,6 @@ export function findColorMeetingRequirements(
 		);
...
Did the memoization force you to remove the optional `debug` param and all the debug logging? 🙁

#### aduth on 2025-10-31T12:55:40Z

URL: https://github.com/WordPress/gutenberg/pull/72796#discussion_r2481327375
Path: packages/theme/src/color-ramps/lib/find-color-with-constraints.ts
...
I wouldn't say it _forced me_ to, but the changes did confront me with the choice of what to do with it 😅 We don't use it anywhere, and I don't like inflating the code and bundle size with logging statements.

If we want this kind of debugging, I think it should probably be based on something like `NODE_ENV` so we can make sure it's omitted from production bundles.

#### jsnajdr on 2025-10-31T13:03:30Z

URL: https://github.com/WordPress/gutenberg/pull/72796#discussion_r2481346424
Path: packages/theme/src/color-ramps/lib/find-color-with-constraints.ts
...
Sounds fair; when I'm debugging something, I'm adding my own `console.log` statements and logpoints anyway.

## Changed files

- package-lock.json (MODIFIED, +2/-1)
- packages/theme/bin/generate-primitive-tokens/index.ts (MODIFIED, +2/-5)
- packages/theme/package.json (MODIFIED, +2/-1)
- packages/theme/src/color-ramps/index.ts (MODIFIED, +10/-28)
- packages/theme/src/color-ramps/lib/find-color-with-constraints.ts (MODIFIED, +0/-19)
- packages/theme/src/color-ramps/lib/index.ts (MODIFIED, +0/-45)
- packages/theme/src/color-ramps/stories/index.story.tsx (MODIFIED, +8/-22)
- packages/theme/src/use-theme-provider-styles.ts (MODIFIED, +6/-5)
