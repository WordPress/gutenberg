...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/74206
...
# PR #74206: Manual version bump for npm packages

- URL: https://github.com/WordPress/gutenberg/pull/74206
- Author: priethor
- Created: 2025-12-24T16:13:26Z
- Updated: 2026-01-08T15:45:21Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 204 of 204
- Diff: ../pr-diffs/74206.diff

## Body

## What

Follow-up/alternative to #74202.

Backports the version bump from the 22.3 release to trunk.

## Why

The last npm publish workflow [failed](https://github.com/WordPress/gutenberg/actions/runs/20462309747/job/58797649853) to cherry-pick the version bump commit to trunk due to conflicts.

Without this fix, trunk is missing:
- `## X.Y.0 (2025-12-23)` version headers in all package CHANGELOGs
- `package.json` version bumps (still showing `-prerelease` suffixes)

## How

Cherry-picking commit `d096bed11d` from `wp/latest` and manually resolving the two CHANGELOG conflicts by preserving both the Unreleased content (from trunk) and the version headers (from the release).

## Testing Instructions

1. Verify that all package CHANGELOGs now have the `## X.Y.0 (2025-12-23)` version header after the `## Unreleased` section
2. Confirm `package.json` versions are updated to match

## Issue comments

### github-actions on 2025-12-24T16:13:37Z

URL: https://github.com/WordPress/gutenberg/pull/74206#issuecomment-3690177320
...
### github-actions on 2025-12-24T16:26:15Z

URL: https://github.com/WordPress/gutenberg/pull/74206#issuecomment-3690198012
...
### github-actions on 2025-12-24T17:07:59Z

URL: https://github.com/WordPress/gutenberg/pull/74206#issuecomment-3690259867

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 96247c9ef6b20c22f74445e7702faba02a8542fa.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/20490240724
📝  Reported issues:
- #73752 in `/test/e2e/specs/site-editor/template-id-format.spec.js`

### priethor on 2026-01-08T14:33:31Z

URL: https://github.com/WordPress/gutenberg/pull/74206#issuecomment-3724150459

Closing in favor of #74413
...
- package-lock.json (MODIFIED, +103/-103)
...
- packages/image-cropper/CHANGELOG.md (MODIFIED, +3/-1)
