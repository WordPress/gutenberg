...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/45999
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #45999: Components: Remove deprecated calendar help from `DateTimePicker`

- URL: https://github.com/WordPress/gutenberg/pull/45999
- Author: tyxla
- Created: 2022-11-23T11:26:32Z
- Updated: 2022-11-30T16:31:13Z
- Comments: 6 of 6
- Review threads: 1 of 1
- Changed files: 7 of 7
- Diff: ../pr-diffs/45999.diff
...
### codesandbox on 2022-11-23T11:26:33Z

URL: https://github.com/WordPress/gutenberg/pull/45999#issuecomment-1324908040

<img alt="CodeSandbox logo" src="https://raw.githubusercontent.com/codesandbox/open-in-codesandbox/main/assets/csb.light.svg#gh-dark-mode-only" /><img alt="CodeSandbox logo" src="https://raw.githubusercontent.com/codesandbox/open-in-codesandbox/main/assets/csb.svg#gh-light-mode-only" />&nbsp; Open in CodeSandbox <a href="https://codesandbox.io/p/github/WordPress/gutenberg/remove/date-picker-deprecated-help?workspace=%7B%22gitSidebarPanel%22:%22PR%22,%22sidebarPanel%22:%22GIT%22%7D">Web Editor</a> | <a href="https://codesandbox.io/p/vscode?owner=WordPress&repo=gutenberg&branch=remove/date-picker-deprecated-help">VS Code</a> | <a href="https://codesandbox.io/p/vscode?owner=WordPress&repo=gutenberg&branch=remove/date-picker-deprecated-help&insiders=true">VS Code Insiders</a>

<!-- open-in-codesandbox:complete -->

### github-actions on 2022-11-23T11:40:00Z

URL: https://github.com/WordPress/gutenberg/pull/45999#issuecomment-1324924172
...
| :--- | :---: | :---: |
| `build/block-editor/index.min.js` | 176 kB | -26 B (0%) |
| `build/components/index.min.js` | 202 kB | -699 B (0%) |
...
### Mamaduka on 2022-11-23T13:36:57Z

URL: https://github.com/WordPress/gutenberg/pull/45999#issuecomment-1325079934

@tyxla, our policy on removing deprecated APIs and props has changed recently, so I'm not entirely sure that we can remove these props.

Here's a recent example https://github.com/WordPress/gutenberg/pull/45195#issuecomment-1286678591 and you can find general conversations in this issue https://github.com/WordPress/gutenberg/issues/40316.

### tyxla on 2022-11-23T13:59:23Z

URL: https://github.com/WordPress/gutenberg/pull/45999#issuecomment-1325111583

Thanks for letting me know @Mamaduka! 

I wonder what alternatives we have? Punt the decision for 6 more months of releases by just bumping the `version`?

### ciampo on 2022-11-23T14:23:54Z

URL: https://github.com/WordPress/gutenberg/pull/45999#issuecomment-1325149730

@Mamaduka would that policy apply also for experimental props like the ones being discussed in this PR?

> I wonder what alternatives we have? 

Off the top of my mind:

- bumping the deprecation version as @tyxla suggested would be just a way to gain some time here (and fix broken CI tests on `trunk`)
- a more gradual approach could be:
  -  add `__nextRemoveHelpButton` and `__nextRemoveResetButton` props to all usages of `DateTimePicker` across the repo
  - change their default value from `false` to `true`, effectively removing help and reset buttons from the default version of the component (potentially breaking change)
  - finally, we could see if we can remove the props (and related code) completely, or if we had to leave them around to support backward compat

### tyxla on 2022-11-23T14:35:43Z

URL: https://github.com/WordPress/gutenberg/pull/45999#issuecomment-1325167948

Okay, I've filed #46006 to bump the removal version of the deprecated props. That gives us some time to think about it better while the checks in `trunk` are green. I suggest going with that until we can figure out a better way to deal with the growing number of deprecated features cluttering the code.

## Review threads

### Review thread 1

#### tyxla on 2022-11-23T12:57:38Z

URL: https://github.com/WordPress/gutenberg/pull/45999#discussion_r1030410599
...
@ciampo @mirka Are such changes supposed to be flagged as breaking changes in the CHANGELOG?
...
- packages/components/src/date-time/date-time/index.tsx (MODIFIED, +15/-155)
- packages/components/src/date-time/date-time/styles.ts (MODIFIED, +0/-4)
- packages/components/src/date-time/stories/date-time.tsx (MODIFIED, +1/-4)
