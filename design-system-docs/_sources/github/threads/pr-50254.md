...
type: pull_request
state: MERGED
merged_at: 2023-05-09T13:57:20Z
url: https://github.com/WordPress/gutenberg/pull/50254
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components","has dev note"]
---

# PR #50254: Button: Add opt-in prop for next 40px default size

- URL: https://github.com/WordPress/gutenberg/pull/50254
- Author: mirka
- Created: 2023-05-02T15:42:24Z
- Updated: 2023-10-12T20:04:52Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 5 of 5
- Diff: ../pr-diffs/50254.diff
...
Adds a `__next40pxDefaultSize` prop to opt into the new 40px default size for Button.

We're not quite ready to feature this prop in the documentation yet (like README and default code snippets), so I'll update those later when appropriate.
...
1. `npm run storybook:dev` and go to the Canvas view for the Button component.
2. Enable the Margin Checker tool in the toolbar for easier visualization.
3. For each of the Button stories, toggle the control for `__next40pxDefaultSize` and check that the size changes as expected.

https://user-images.githubusercontent.com/555336/235715283-39d96dbf-db8f-4f96-8081-5d3a77e7731f.mp4

## Issue comments

### github-actions on 2023-05-02T15:57:58Z

URL: https://github.com/WordPress/gutenberg/pull/50254#issuecomment-1531723369
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 210 kB | +30 B (0%) |
| `build/components/style-rtl.css` | 11.8 kB | +24 B (0%) |
| `build/components/style.css` | 11.8 kB | +24 B (0%) |
...
### github-actions on 2023-05-09T14:00:52Z

URL: https://github.com/WordPress/gutenberg/pull/50254#issuecomment-1540185666

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 5d6cdd54126d9aa9545b363254d8f3e010723f5c.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/4926245319
📝  Reported issues:
- #36939 in `/test/e2e/specs/editor/plugins/custom-post-types.spec.js`

### ciampo on 2023-10-12T20:04:51Z

URL: https://github.com/WordPress/gutenberg/pull/50254#issuecomment-1760294070

For the dev note, see https://github.com/WordPress/gutenberg/issues/46741

### github-actions on 2023-10-12T20:04:52Z

URL: https://github.com/WordPress/gutenberg/pull/50254#issuecomment-1760294087
...
- packages/components/src/button/style.scss (MODIFIED, +8/-0)
