...
type: pull_request
state: MERGED
merged_at: 2022-12-20T19:25:21Z
url: https://github.com/WordPress/gutenberg/pull/46427
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components"]
---

# PR #46427: Theme component: Remove public export

- URL: https://github.com/WordPress/gutenberg/pull/46427
- Author: mirka
- Created: 2022-12-09T11:26:06Z
- Updated: 2022-12-20T19:25:50Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 3 of 3
- Diff: ../pr-diffs/46427.diff
...
Removes the public export of the `Theme` component while we iterate on it internally to the wp-components package. Also removes the theming section from the Contributing guide.

## Why?

The Theme component is not in any way production-ready, compared to our other "experimental" components which are simply in beta. There is no reason for this to be used elsewhere in the Gutenberg app yet.


## Testing Instructions

✅ `npm run build` still builds without error.

## Issue comments

### github-actions on 2022-12-09T11:41:04Z

URL: https://github.com/WordPress/gutenberg/pull/46427#issuecomment-1344202237
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 203 kB | -800 B (0%) |
...
- packages/components/CONTRIBUTING.md (MODIFIED, +0/-21)
