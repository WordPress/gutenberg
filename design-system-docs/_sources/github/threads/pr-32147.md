...
type: pull_request
state: MERGED
merged_at: 2021-05-24T14:35:53Z
url: https://github.com/WordPress/gutenberg/pull/32147
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Developer Documentation","[Package] Components"]
---

# PR #32147: Components: Mark all experimental components in the handbook

- URL: https://github.com/WordPress/gutenberg/pull/32147
- Author: gziolo
- Created: 2021-05-24T10:39:39Z
- Updated: 2021-05-24T14:36:17Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 32 of 32
- Diff: ../pr-diffs/32147.diff
...
### github-actions on 2021-05-24T10:48:01Z

URL: https://github.com/WordPress/gutenberg/pull/32147#issuecomment-846957280
...
- packages/components/src/box-control/README.md (MODIFIED, +4/-0)
- packages/components/src/dimension-control/README.md (MODIFIED, +4/-0)
- packages/components/src/divider/README.md (MODIFIED, +4/-0)
- packages/components/src/elevation/README.md (MODIFIED, +5/-1)
...
- packages/components/src/flex/flex/README.md (MODIFIED, +3/-1)
- packages/components/src/grid/README.md (MODIFIED, +4/-2)
- packages/components/src/h-stack/README.md (MODIFIED, +4/-2)
- packages/components/src/heading/README.md (MODIFIED, +3/-1)
- packages/components/src/input-control/README.md (MODIFIED, +4/-0)
- packages/components/src/navigation/README.md (MODIFIED, +4/-0)
- packages/components/src/number-control/README.md (MODIFIED, +4/-0)
- packages/components/src/radio-group/README.md (MODIFIED, +4/-0)
- packages/components/src/spacer/README.md (MODIFIED, +5/-5)
- packages/components/src/text/README.md (MODIFIED, +3/-1)
- packages/components/src/tree-grid/README.md (MODIFIED, +4/-1)
- packages/components/src/truncate/README.md (MODIFIED, +3/-1)
- packages/components/src/ui/card/README.md (MODIFIED, +4/-0)
- packages/components/src/ui/control-group/README.md (MODIFIED, +4/-0)
- packages/components/src/ui/control-label/README.md (MODIFIED, +4/-0)
- packages/components/src/ui/form-group/README.md (MODIFIED, +4/-0)
- packages/components/src/ui/popover/README.md (MODIFIED, +4/-0)
- packages/components/src/ui/scrollable/README.md (MODIFIED, +4/-0)
- packages/components/src/ui/spinner/README.md (MODIFIED, +4/-0)
- packages/components/src/ui/surface/README.md (MODIFIED, +4/-0)
- packages/components/src/ui/tooltip/README.md (MODIFIED, +4/-0)
- packages/components/src/ui/visually-hidden/README.md (MODIFIED, +4/-0)
- packages/components/src/unit-control/README.md (MODIFIED, +4/-0)
- packages/components/src/v-stack/README.md (MODIFIED, +4/-2)
- packages/components/src/view/README.md (MODIFIED, +4/-2)
- packages/components/src/z-stack/README.md (MODIFIED, +3/-1)
