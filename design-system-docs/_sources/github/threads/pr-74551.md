...
type: pull_request
state: MERGED
merged_at: 2026-01-13T10:37:34Z
url: https://github.com/WordPress/gutenberg/pull/74551
matched_labels: ["[Package] Theme"]
all_labels: ["[Type] Developer Documentation","Storybook","[Package] Theme"]
---

# PR #74551: Theme/UI: Add intro docs to Storybook

- URL: https://github.com/WordPress/gutenberg/pull/74551
- Author: mirka
- Created: 2026-01-12T15:39:22Z
- Updated: 2026-01-13T10:38:16Z
- Comments: 2 of 2
- Review threads: 3 of 3
- Changed files: 11 of 11
- Diff: ../pr-diffs/74551.diff
...
Adds "Introduction" docs to the `@wordpress/theme` and `@wordpress/ui` package sections in Storybook.

Also some minor related fixes:

- Remove any "DS" abbreviations.
- Markdown formatting.

## Why?

These are new packages, and it's unclear what these are just by looking at the Storybook.

An import thing we want to highlight here is that the `@wordpress/ui` package itself is still experimental. This will allow us to remove the experimental tags on individual component pages.

## Testing Instructions

See Design System section in Storybook.

## Issue comments

### github-actions on 2026-01-12T15:50:18Z

URL: https://github.com/WordPress/gutenberg/pull/74551#issuecomment-3739248066
...
| `build/scripts/media-utils/index.min.js` | 71.7 kB |
...
### github-actions on 2026-01-12T16:00:45Z

URL: https://github.com/WordPress/gutenberg/pull/74551#issuecomment-3739296356
...
#### mirka on 2026-01-12T15:47:15Z

URL: https://github.com/WordPress/gutenberg/pull/74551#discussion_r2682850837
...
Ensures the "Introduction" doc is shown at the top of each section.

### Review thread 2

#### mirka on 2026-01-12T16:00:10Z

URL: https://github.com/WordPress/gutenberg/pull/74551#discussion_r2682904413
...
Using an absolute link here so it also works in Storybook.

### Review thread 3

#### ciampo on 2026-01-13T08:30:59Z

URL: https://github.com/WordPress/gutenberg/pull/74551#discussion_r2685386620
...
Should we mention the icons package?

I assume that if/when the online doc site will be ready, it will be added here too?

#### mirka on 2026-01-13T10:36:53Z

URL: https://github.com/WordPress/gutenberg/pull/74551#discussion_r2685817935
Path: storybook/stories/design-system/introduction.mdx
...
Good question… I think it is conceptually true that `@wordpress/icons` is part of the design system. What gives me pause is that the theme and ui packages are still quite incomplete and chaotic, so I don't want to pull the very stable `@wordpress/icons` into that chaos and make it seem like it's also experimental. Maybe we can officially categorize it as part of the DS packages when everything is a bit more stable?

## Changed files

- packages/theme/README.md (MODIFIED, +18/-18)
- packages/theme/bin/terrazzo-plugin-ds-tokens-docs/index.ts (MODIFIED, +1/-1)
- packages/theme/docs/tokens.md (RENAMED, +1/-1)
- packages/theme/src/color-ramps/stories/index.story.tsx (MODIFIED, +1/-1)
- packages/theme/src/stories/index.story.tsx (MODIFIED, +2/-2)
- packages/theme/src/stories/introduction.mdx (ADDED, +6/-0)
- packages/theme/terrazzo.config.ts (MODIFIED, +1/-1)
- packages/ui/src/stories/introduction.mdx (ADDED, +6/-0)
- storybook/main.js (MODIFIED, +2/-1)
- storybook/preview.jsx (MODIFIED, +2/-0)
- storybook/stories/design-system/introduction.mdx (ADDED, +45/-0)
