...
type: pull_request
state: MERGED
merged_at: 2023-03-30T11:23:01Z
url: https://github.com/WordPress/gutenberg/pull/49229
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #49229: Components: Ship TypeScript types

- URL: https://github.com/WordPress/gutenberg/pull/49229
- Author: mirka
- Created: 2023-03-21T12:50:00Z
- Updated: 2023-04-19T00:28:03Z
- Comments: 5 of 5
- Review threads: 1 of 1
- Changed files: 4 of 4
- Diff: ../pr-diffs/49229.diff
...
Properly ship first-party TypeScript declarations with the `@wordpress/components` package.

## Why?

We were relying on `@types`, which could be wrong or outdated.

**Follow-up: remove types from Definitely Typed**

## Testing Instructions

1. `npm run build`
2. In your IDE, go to component usages in packages other than wp-components. Check that IntelliSense and source mapping (e.g. "Go to Definition" in VS Code) works as expected.

## Issue comments

### github-actions on 2023-03-21T13:00:32Z

URL: https://github.com/WordPress/gutenberg/pull/49229#issuecomment-1477796923
...
### gziolo on 2023-03-21T22:26:12Z

URL: https://github.com/WordPress/gutenberg/pull/49229#issuecomment-1478676968

Wow, it’s so close 🎉🎉🎉 

That’s quite an achievement, congrats to everyone involved!

### ciampo on 2023-03-21T22:51:12Z

URL: https://github.com/WordPress/gutenberg/pull/49229#issuecomment-1478697208

I gave this PR a quick look, and types seems to work as expected, at least in VSCode.

It would be good to get more eyes on this, especially:
- from folks working on other parts of Gutenberg
- using other IDEs
- one important thing to check for is any incompatibility with existing Definitely Typed type defs

Pinging a few folks in that regard: @gziolo @aaronrobertshaw @andrewserong @noisysocks @sirreal

### github-actions on 2023-03-23T19:29:55Z

URL: https://github.com/WordPress/gutenberg/pull/49229#issuecomment-1481778012

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 98e379a28dee4f84a25fd4ef0bc6db5aed812799.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/4504205931
📝  Reported issues:
- #49016 in `/test/e2e/specs/site-editor/template-part.spec.js`
- #42245 in `/test/e2e/specs/site-editor/template-part.spec.js`

### noahtallen on 2023-04-19T00:28:03Z

URL: https://github.com/WordPress/gutenberg/pull/49229#issuecomment-1513950766

DT removal: https://github.com/DefinitelyTyped/DefinitelyTyped/pull/65213

## Review threads

### Review thread 1

#### ciampo on 2023-03-21T22:58:01Z

URL: https://github.com/WordPress/gutenberg/pull/49229#discussion_r1144068929
...
On top of excluding `index.js`, I wonder if there's any value in renaming it to `index.ts` ?

#### ciampo on 2023-03-23T18:58:31Z

URL: https://github.com/WordPress/gutenberg/pull/49229#discussion_r1146690340
Path: packages/components/tsconfig.json
...
- packages/components/src/index.ts (RENAMED, +0/-0)
- packages/components/src/private-apis.ts (RENAMED, +0/-0)
