...
type: pull_request
state: MERGED
merged_at: 2025-08-14T14:30:07Z
url: https://github.com/WordPress/gutenberg/pull/71186
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #71186: Components: Update gradient-parser from 1.0.2 to 1.1.1

- URL: https://github.com/WordPress/gutenberg/pull/71186
- Author: t-hamano
- Created: 2025-08-13T07:53:04Z
- Updated: 2025-08-14T14:53:04Z
- Comments: 6 of 6
- Review threads: 2 of 2
- Changed files: 7 of 7
- Diff: ../pr-diffs/71186.diff
...
This PR updates the version of the `gradient-parser` library to allow the `GradientPicker` component to handle more color formats and expressions.

Specifically, this PR adds new support for:

- HSL and HSLA color: https://github.com/rafaelcaricio/gradient-parser/commit/2d2029017ae7df4d939cac563622dcc2a7c7df46
- CSS variables: https://github.com/rafaelcaricio/gradient-parser/commit/c38a3fb1903c207a5e04fa985adf1c71f0985864
- calc() expressions: https://github.com/rafaelcaricio/gradient-parser/commit/f15c4bb91fbb75cf53ef13078dfb1154321633df

### Changes between 1.0.2 and 1.1.1

There is no changelog file for this library, but all changes are listed below:

https://github.com/rafaelcaricio/gradient-parser/compare/1.0.2...v1.1.1

### Type definition update

https://github.com/DefinitelyTyped/DefinitelyTyped/pull/73447
...
Note that `colord` converts HSLA color to RGBA color when rendering.

<img width="1227" height="286" alt="image" src="https://github.com/user-attachments/assets/8a13ecdb-553a-4680-818a-2680b0a36b53" />

### CSS variables

<img width="1233" height="334" alt="image" src="https://github.com/user-attachments/assets/47297bdf-9675-4edb-8ded-97292283d040" />

## Issue comments

### github-actions on 2025-08-13T08:14:20Z

URL: https://github.com/WordPress/gutenberg/pull/71186#issuecomment-3182688965

**Size Change:** +689 B (+0.04%) 

**Total Size:** 1.91 MB

| Filename | Size | Change |
| :--- | :---: | :---: |
| `build/components/index.min.js` | 250 kB | +689 B (+0.28%) |
...
### github-actions on 2025-08-13T08:24:33Z

URL: https://github.com/WordPress/gutenberg/pull/71186#issuecomment-3182722595
...
### github-actions on 2025-08-13T08:30:06Z

URL: https://github.com/WordPress/gutenberg/pull/71186#issuecomment-3182742542

<!-- flaky-tests-report-comment -->
**Flaky tests detected in ec3cb7deab3d84c707ac3d497b70908a4ef1a325.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/16953870801
📝  Reported issues:
...
### mirka on 2025-08-14T13:06:45Z

URL: https://github.com/WordPress/gutenberg/pull/71186#issuecomment-3188390647
...
### t-hamano on 2025-08-14T14:28:29Z

URL: https://github.com/WordPress/gutenberg/pull/71186#issuecomment-3188661757

I'd like to merge this PR, and I will also test whether the following issues are resolved:

> I haven't tested myself, but potentially closing:
> 
> - #46233
> - #43715
> - #28254

### t-hamano on 2025-08-14T14:53:04Z

URL: https://github.com/WordPress/gutenberg/pull/71186#issuecomment-3188751362
...
#### aduth on 2025-08-13T15:16:09Z

URL: https://github.com/WordPress/gutenberg/pull/71186#discussion_r2273795052
Path: packages/components/src/gradient-picker/stories/index.story.tsx

I'm trying to understand how `calc` support is intended to work. Should someone be able to pass a `value` including `calc`? I tried it in these stories and it wouldn't parse. 🤔 
...
index 16e460efc0..574a4bf8df 100644
...
@@ -69,3 +69,3 @@ const GRADIENTS = [
 		gradient:
-			'linear-gradient(135deg,hsl(200, 100%, 50%) 0%,hsl(280, 100%, 60%) 100%)',
+			'linear-gradient(135deg,hsl(calc(180 + 20), 100%, 50%) 0%,hsl(280, 100%, 60%) 100%)',
 		slug: 'hsl-blue-to-purple',
```

#### t-hamano on 2025-08-14T01:48:51Z

URL: https://github.com/WordPress/gutenberg/pull/71186#discussion_r2275076647
Path: packages/components/src/gradient-picker/stories/index.story.tsx

It may be that the calc expression is not available for hue values, or it may be a parser bug, but calc expressions should be valid in the format used in this test.

https://github.com/rafaelcaricio/gradient-parser/commit/f15c4bb91fbb75cf53ef13078dfb1154321633df#diff-df8b7db433e7e7a8ce7b0b7e035914f50743a8ab52655807aaa7563d4fcb4814R380

#### t-hamano on 2025-08-14T14:27:02Z

URL: https://github.com/WordPress/gutenberg/pull/71186#discussion_r2276798169
Path: packages/components/src/gradient-picker/stories/index.story.tsx

Perhaps the library only supports using calc expressions for positions, not colors. I verified this with the code below:

```javascript
const parser = require('gradient-parser');
const gradients = [
	'linear-gradient(to right, #000 100%)',
	'linear-gradient(to right, #000 calc(80% + 20%))',
	'linear-gradient(to right, rgb(0,0,0) 100%)',
	'linear-gradient(to right, hsl(100,10%,10%) 100%)',
	'linear-gradient(to right, rgb(calc(100 - 20),0,0) 100%)',
	'linear-gradient(to right, hsl(calc(100 - 20),10%,10%) 100%)',
];

for (const gradient of gradients) {
	try {
		parser.parse(gradient);
		console.log('✅ Successfully parsed:', gradient);
	} catch (e) {
		console.log('❌ Failed to parse:', gradient);
	}
}
```
...
```bash
$ node test.js
✅ Successfully parsed: linear-gradient(to right, #000 100%)
✅ Successfully parsed: linear-gradient(to right, #000 calc(80% + 20%))
✅ Successfully parsed: linear-gradient(to right, rgb(0,0,0) 100%)
✅ Successfully parsed: linear-gradient(to right, hsl(100,10%,10%) 100%)
❌ Failed to parse: linear-gradient(to right, rgb(calc(100 - 20),0,0) 100%)
❌ Failed to parse: linear-gradient(to right, hsl(calc(100 - 20),10%,10%) 100%)
```

### Review thread 2 (resolved)

#### aduth on 2025-08-13T15:16:27Z

URL: https://github.com/WordPress/gutenberg/pull/71186#discussion_r2273795799
...
Maybe we could expand this to highlight how the new color types are supported.

#### t-hamano on 2025-08-14T01:56:33Z

URL: https://github.com/WordPress/gutenberg/pull/71186#discussion_r2275100305
Path: packages/components/CHANGELOG.md
...
ec3cb7deab3d84c707ac3d497b70908a4ef1a325

## Changed files

- package-lock.json (MODIFIED, +11/-10)
- packages/components/CHANGELOG.md (MODIFIED, +4/-0)
- packages/components/package.json (MODIFIED, +2/-2)
- packages/components/src/custom-gradient-picker/serializer.ts (MODIFIED, +14/-0)
- packages/components/src/custom-gradient-picker/test/serializer.ts (MODIFIED, +25/-0)
- packages/components/src/custom-gradient-picker/utils.ts (MODIFIED, +10/-0)
- packages/components/src/gradient-picker/stories/index.story.tsx (MODIFIED, +48/-0)
