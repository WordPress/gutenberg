...
type: pull_request
state: MERGED
merged_at: 2022-10-05T15:36:11Z
url: https://github.com/WordPress/gutenberg/pull/44695
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #44695: Components: Refactor `withFocusOutside` to `@testing-library/react`

- URL: https://github.com/WordPress/gutenberg/pull/44695
- Author: tyxla
- Created: 2022-10-05T08:36:07Z
- Updated: 2022-10-05T15:36:31Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 1 of 1
- Diff: ../pr-diffs/44695.diff

## Body

## What?
This PR refactors the tests of `withFocusOutside` to use `@testing-library/react`'s render instead of `react-dom` render. This addresses one of the changes needed to upgrade to React 18, as touched in #32765.
...
Verify tests still pass: `npm run test:unit packages/components/src/higher-order/with-focus-outside/test/index.js`

## Issue comments

### github-actions on 2022-10-05T08:44:55Z

URL: https://github.com/WordPress/gutenberg/pull/44695#issuecomment-1268135263
...
- packages/components/src/higher-order/with-focus-outside/test/index.js (MODIFIED, +44/-45)
