...
type: pull_request
state: MERGED
merged_at: 2026-03-20T17:04:34Z
url: https://github.com/WordPress/gutenberg/pull/76653
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Enhancement","[Package] UI"]
---

# PR #76653: InputControl: Add to @wordpress/ui

- URL: https://github.com/WordPress/gutenberg/pull/76653
- Author: mirka
- Created: 2026-03-18T22:44:49Z
- Updated: 2026-03-20T17:05:35Z
- Comments: 3 of 3
- Review threads: 3 of 3
- Changed files: 15 of 15
- Diff: ../pr-diffs/76653.diff

## Body

## What?

Adds `InputControl` to `@wordpress/ui`. This is the first form "control" (a composition of form primitives) in the package.

## Why?

`InputControl` is a standard composition of `Field.Root`, `Field.Label`, `Input`, `Field.Description`, and `Field.Details` that would otherwise need to be assembled manually by every consumer. Providing it as a ready-made control encourages consistent labeling and accessible description patterns.

## Testing Instructions

Run `npm run storybook:dev` and navigate to Design System / Components / Form / InputControl.
...
### github-actions on 2026-03-18T22:57:56Z

URL: https://github.com/WordPress/gutenberg/pull/76653#issuecomment-4086113453
...
### github-actions on 2026-03-19T00:07:55Z

URL: https://github.com/WordPress/gutenberg/pull/76653#issuecomment-4086480226

<!-- flaky-tests-report-comment -->
**Flaky tests detected in e6d87283e84b6ab111d20abdf2a98655e922ad5d.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/23272278386
📝  Reported issues:
- #76524 in `/test/e2e/specs/editor/various/post-content-focus-mode.spec.js`

### github-actions on 2026-03-19T22:49:01Z

URL: https://github.com/WordPress/gutenberg/pull/76653#issuecomment-4093841292
...
#### mirka on 2026-03-18T22:54:50Z

URL: https://github.com/WordPress/gutenberg/pull/76653#discussion_r2956681743
Path: packages/ui/src/form/input-control/input-control.tsx
...
+ * Built on form primitives with design token styling.
+ */
...
My initial plan was to not have `hideLabelFromVision` props on the `Control` components, but I've seen enough misuses of this (e.g. the developer used a primitive and then completely forgot to label it). So I'm concluding that having this prop available on the higher-level components is better for overall accessibility adherence.

### Review thread 2

#### mirka on 2026-03-18T23:17:04Z

URL: https://github.com/WordPress/gutenberg/pull/76653#discussion_r2956775051
Path: packages/ui/src/form/input-control/input-control.tsx
...
We'll monitor actual usage, but since simultaneous usage of both `description` and `details` doesn't inherently cause accessibility issues, I'm leaning towards starting with no enforcement measures for "proper" use of one or the other.

### Review thread 3

#### mirka on 2026-03-18T23:26:30Z

URL: https://github.com/WordPress/gutenberg/pull/76653#discussion_r2956814495
Path: packages/ui/src/form/stories/shared.tsx
...
Extracted into a reusable chunk because this will be used across basically all the `*Control` component stories.

## Changed files

- packages/ui/CHANGELOG.md (MODIFIED, +4/-0)
- packages/ui/src/form/index.ts (ADDED, +3/-0)
- packages/ui/src/form/input-control/index.ts (ADDED, +1/-0)
- packages/ui/src/form/input-control/input-control.tsx (ADDED, +33/-0)
- packages/ui/src/form/input-control/stories/index.story.tsx (ADDED, +163/-0)
- packages/ui/src/form/input-control/test/index.test.tsx (ADDED, +53/-0)
- packages/ui/src/form/input-control/types.ts (ADDED, +5/-0)
- packages/ui/src/form/primitives/field/stories/index.story.tsx (MODIFIED, +2/-7)
- packages/ui/src/form/primitives/fieldset/stories/index.story.tsx (MODIFIED, +2/-7)
- packages/ui/src/form/primitives/input-layout/stories/index.story.tsx (MODIFIED, +22/-1)
- packages/ui/src/form/primitives/input/stories/index.story.tsx (MODIFIED, +7/-0)
- packages/ui/src/form/primitives/stories/overview.mdx (ADDED, +15/-0)
- packages/ui/src/form/stories/shared.tsx (ADDED, +19/-0)
- packages/ui/src/form/types.ts (ADDED, +34/-0)
