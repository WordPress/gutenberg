...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/77969
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #77969: CustomSelectControl: Portal dropdown popover into Popover.Slot by default

- URL: https://github.com/WordPress/gutenberg/pull/77969
- Author: ciampo
- Created: 2026-05-05T17:19:18Z
- Updated: 2026-05-06T08:56:19Z
- Comments: 3 of 3
- Review threads: 2 of 2
- Changed files: 7 of 7
- Diff: ../pr-diffs/77969.diff
...
### github-actions on 2026-05-05T17:36:20Z

URL: https://github.com/WordPress/gutenberg/pull/77969#issuecomment-4381593473
...
| :--- | :---: | :---: |
| `build/scripts/components/index.min.js` | 266 kB | +32 B (+0.01%) |
...
| `build/styles/editor/style-rtl.css` | 27.7 kB |
| `build/styles/editor/style-rtl.min.css` | 23.4 kB |
| `build/styles/editor/style.css` | 27.8 kB |
| `build/styles/editor/style.min.css` | 23.4 kB |
...
### github-actions on 2026-05-05T18:23:58Z

URL: https://github.com/WordPress/gutenberg/pull/77969#issuecomment-4381901260

<!-- flaky-tests-report-comment -->
**Flaky tests detected in e27ebdee91bbd9dd2f7fee770a5e49ed02902181.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/25424563015
📝  Reported issues:
...
### ciampo on 2026-05-06T08:38:28Z

URL: https://github.com/WordPress/gutenberg/pull/77969#issuecomment-4386353767
...
#### copilot-pull-request-reviewer on 2026-05-05T17:32:54Z

URL: https://github.com/WordPress/gutenberg/pull/77969#discussion_r3190371868
...
`flip` is now set to `undefined` for non-legacy selects (and for legacy selects when `portal` is true). Previously this component explicitly passed `flip={ true }` for non-legacy behavior, so the new code now implicitly relies on Ariakit’s default. To avoid an unintentional behavior change (or a future dependency regression if Ariakit defaults change), consider explicitly passing `true` when flip should be enabled (or preserving the prior `flip={ !isLegacy }` behavior except for the new legacy+portal case).

### Review thread 2 (resolved)

#### copilot-pull-request-reviewer on 2026-05-05T17:32:55Z

URL: https://github.com/WordPress/gutenberg/pull/77969#discussion_r3190371910
...
The new CHANGELOG entries don’t include the PR reference link, while surrounding entries consistently include a `([#NNNNN](...))` link. Please add the PR link for these bullets to keep the changelog format consistent and make the change traceable.

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +5/-0)
- packages/components/src/custom-select-control-v2/custom-select.tsx (MODIFIED, +5/-2)
- packages/components/src/custom-select-control-v2/types.ts (MODIFIED, +15/-0)
- packages/components/src/custom-select-control/index.tsx (MODIFIED, +15/-0)
- packages/components/src/custom-select-control/stories/index.story.tsx (MODIFIED, +17/-7)
- packages/components/src/custom-select-control/test/index.tsx (MODIFIED, +39/-0)
- packages/components/src/custom-select-control/types.ts (MODIFIED, +13/-0)
