...
type: pull_request
state: MERGED
merged_at: 2026-05-19T11:52:21Z
url: https://github.com/WordPress/gutenberg/pull/78407
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #78407: Components: Popover: don't close when focus moves into the `@wordpress/ui` compat overlay slot

- URL: https://github.com/WordPress/gutenberg/pull/78407
- Author: ciampo
- Created: 2026-05-18T15:22:58Z
- Updated: 2026-05-19T11:53:03Z
- Comments: 5 of 5
- Review threads: 1 of 1
- Changed files: 3 of 3
- Diff: ../pr-diffs/78407.diff
...
### github-actions on 2026-05-18T15:33:30Z

URL: https://github.com/WordPress/gutenberg/pull/78407#issuecomment-4479247484
...
| :--- | :---: | :---: |
| `build/scripts/components/index.min.js` | 267 kB | +67 B (+0.03%) |
...
### github-actions on 2026-05-18T16:01:17Z

URL: https://github.com/WordPress/gutenberg/pull/78407#issuecomment-4479475583
...
### github-actions on 2026-05-18T16:41:00Z

URL: https://github.com/WordPress/gutenberg/pull/78407#issuecomment-4479794687

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 2ffb94845f0e2b1db6842cec6fd9354f0be9498d.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/26093846324
📝  Reported issues:
- #64334 in `/test/e2e/specs/site-editor/dataviews-list-layout-keyboard.spec.js`
- #78421 in `/test/e2e/specs/preload/post-editor.spec.js`

### ciampo on 2026-05-18T18:10:17Z

URL: https://github.com/WordPress/gutenberg/pull/78407#issuecomment-4480520542
...
### ciampo on 2026-05-19T10:30:22Z

URL: https://github.com/WordPress/gutenberg/pull/78407#issuecomment-4486842653

@mirka it is a separate issue, and it only happens in `Popover` (ie. `Modal` is fine) — opened https://github.com/WordPress/gutenberg/issues/78432 to track it separately.

## Review threads

### Review thread 1 (resolved)

#### mirka on 2026-05-18T17:37:24Z

URL: https://github.com/WordPress/gutenberg/pull/78407#discussion_r3260848100
Path: packages/components/src/popover/test/index.tsx

```diff
@@ -663,4 +669,116 @@ describe( 'Popover', () => {
 			} );
 		} );
 	} );
+
...
#### ciampo on 2026-05-19T11:14:12Z

URL: https://github.com/WordPress/gutenberg/pull/78407#discussion_r3265816290
Path: packages/components/src/popover/test/index.tsx
...
Good catch, fixed in e069bb8 — the test now starts with focus inside the popover, then clicks the slot button (which is the move *out* that exercises the focus-outside path), then returns focus to the popover descendant.

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +4/-0)
- packages/components/src/popover/index.tsx (MODIFIED, +22/-0)
- packages/components/src/popover/test/index.tsx (MODIFIED, +119/-1)
