...
type: pull_request
state: MERGED
merged_at: 2021-03-04T16:36:36Z
url: https://github.com/WordPress/gutenberg/pull/29523
...
# PR #29523: Components: Add TooltipButton

- URL: https://github.com/WordPress/gutenberg/pull/29523
- Author: sarayourfriend
- Created: 2021-03-03T16:35:53Z
- Updated: 2021-03-04T16:37:18Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 14 of 14
- Diff: ../pr-diffs/29523.diff
...
### github-actions on 2021-03-03T17:34:47Z

URL: https://github.com/WordPress/gutenberg/pull/29523#issuecomment-789915934
...
| `build/block-library/index.js` | 148 kB | +165 B (0%) |  |
...
| `build/blocks/index.js` | 48.3 kB | -62 B (0%) |  |
| `build/components/index.js` | 283 kB | +6.67 kB (+2%) |  |
...
| `build/edit-post/index.js` | 306 kB | -75 B (0%) |  |
| `build/edit-site/index.js` | 27 kB | -64 B (0%) |  |
| `build/edit-widgets/index.js` | 20.1 kB | -23 B (0%) |  |
| `build/editor/index.js` | 42.1 kB | -36 B (0%) |  |
...
### ItsJonQ on 2021-03-04T16:24:42Z

URL: https://github.com/WordPress/gutenberg/pull/29523#issuecomment-790742556

Thanks for updating the tests @sarayourfriend !
I'm going to merge this up :)
...
- packages/components/src/button/index.js (MODIFIED, +2/-1)
- packages/components/src/button/next.js (ADDED, +79/-0)
- packages/components/src/ui/base-button/component.js (MODIFIED, +15/-2)
- packages/components/src/ui/base-button/hook.js (MODIFIED, +27/-2)
- packages/components/src/ui/base-button/types.ts (MODIFIED, +3/-0)
- packages/components/src/ui/button/component.js (MODIFIED, +25/-11)
- packages/components/src/ui/button/stories/index.js (MODIFIED, +3/-1)
- packages/components/src/ui/button/test/__snapshots__/index.js.snap (MODIFIED, +32/-6)
- packages/components/src/ui/button/test/index.js (MODIFIED, +12/-0)
- packages/components/src/ui/tooltip-button/README.md (ADDED, +24/-0)
- packages/components/src/ui/tooltip-button/component.tsx (ADDED, +95/-0)
- packages/components/src/ui/tooltip-button/index.js (ADDED, +2/-0)
- packages/components/src/ui/tooltip-button/stories/index.js (ADDED, +74/-0)
- packages/components/src/ui/tooltip-button/test/index.js (ADDED, +32/-0)
