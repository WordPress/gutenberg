...
type: pull_request
state: MERGED
merged_at: 2026-03-06T19:16:56Z
url: https://github.com/WordPress/gutenberg/pull/75963
matched_labels: ["Design System"]
all_labels: ["[Type] Enhancement","Backported to WP Core","Design System"]
---

# PR #75963: Refactor admin-ui Page component to use @wordpress/theme tokens and @wordpress/ui layout primitive

- URL: https://github.com/WordPress/gutenberg/pull/75963
- Author: jameskoster
- Created: 2026-02-26T14:35:51Z
- Updated: 2026-03-19T06:02:11Z
- Comments: 13 of 13
- Review threads: 3 of 3
- Changed files: 5 of 5
- Diff: ../pr-diffs/75963.diff
...
| Before | After |
| --- | --- |
| <img width="1090" height="1252" alt="Screenshot 2026-02-26 at 14 28 49" src="https://github.com/user-attachments/assets/fa20be19-8589-4737-bf9a-a2134d5144bc" /> | <img width="1092" height="836" alt="Screenshot 2026-02-26 at 14 23 11" src="https://github.com/user-attachments/assets/b43c8232-8cad-4dde-8a66-a6be877bcfa6" /> |

## Issue comments

### github-actions on 2026-02-26T14:47:31Z

URL: https://github.com/WordPress/gutenberg/pull/75963#issuecomment-3967099950

**Size Change:** +5.87 kB (+0.09%) 

**Total Size:** 6.88 MB

| Filename | Size | Change |  |
| :--- | :---: | :---: | :---: |
| `build/modules/boot/index.min.js` | 16.8 kB | +1.94 kB (+13.06%) | ⚠️ |
| `build/scripts/edit-post/index.min.js` | 16.3 kB | -17 B (-0.1%) |  |
| `build/scripts/edit-site/index.min.js` | 245 kB | +382 B (+0.16%) |  |
| `build/scripts/editor/index.min.js` | 350 kB | +426 B (+0.12%) |  |
| `build/styles/edit-post/style-rtl.css` | 4.1 kB | +172 B (+4.38%) |  |
| `build/styles/edit-post/style-rtl.min.css` | 2.77 kB | +203 B (+7.92%) | 🔍 |
| `build/styles/edit-post/style.css` | 4.1 kB | +171 B (+4.35%) |  |
| `build/styles/edit-post/style.min.css` | 2.77 kB | +203 B (+7.92%) | 🔍 |
| `build/styles/edit-site/style-rtl.css` | 20.7 kB | +207 B (+1.01%) |  |
| `build/styles/edit-site/style-rtl.min.css` | 16.8 kB | +213 B (+1.28%) |  |
| `build/styles/edit-site/style.css` | 20.8 kB | +207 B (+1.01%) |  |
| `build/styles/edit-site/style.min.css` | 16.8 kB | +213 B (+1.28%) |  |
| `build/styles/edit-widgets/style-rtl.css` | 5.35 kB | +190 B (+3.68%) |  |
| `build/styles/edit-widgets/style-rtl.min.css` | 3.99 kB | +209 B (+5.52%) | 🔍 |
| `build/styles/edit-widgets/style.css` | 5.35 kB | +193 B (+3.74%) |  |
| `build/styles/edit-widgets/style.min.css` | 4 kB | +208 B (+5.49%) | 🔍 |
| `build/styles/editor/style-rtl.css` | 23.5 kB | +158 B (+0.68%) |  |
| `build/styles/editor/style-rtl.min.css` | 20.1 kB | +216 B (+1.09%) |  |
| `build/styles/editor/style.css` | 23.5 kB | +159 B (+0.68%) |  |
| `build/styles/editor/style.min.css` | 20.1 kB | +221 B (+1.11%) |  |
...
| `build/scripts/core-data/index.min.js` | 28.8 kB |
...
### github-actions on 2026-02-26T16:15:01Z

URL: https://github.com/WordPress/gutenberg/pull/75963#issuecomment-3967638625
...
### youknowriad on 2026-02-26T18:52:26Z

URL: https://github.com/WordPress/gutenberg/pull/75963#issuecomment-3968552070

No blocker for me here. But for me with this change it's becoming urgent to add `ThemeProvider` to `edit-site` and adapt it to WordPress user profile.

### mirka on 2026-02-27T13:23:49Z

URL: https://github.com/WordPress/gutenberg/pull/75963#issuecomment-3972947170

> No blocker for me here. But for me with this change it's becoming urgent to add `ThemeProvider` to `edit-site` and adapt it to WordPress user profile.

One quick unblock is to remove the design token stylesheet, and also whatever is loading extra `wp-admin-theme` color declarations in Extensible Site Editor in a way that overwrites the correct declarations that already reflect the user theme. The normal Site Editor and Block Editor already reflect all the user accent colors correctly (at least rudimentarily) without a `ThemeProvider`, both in `@wordpress/components` and the design tokens.

### github-actions on 2026-02-27T13:51:54Z

URL: https://github.com/WordPress/gutenberg/pull/75963#issuecomment-3973071678

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 9e343bfaa8389994078a9d48c0c47321c25c21d9.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/22488022926
📝  Reported issues:
- #64584 in `/test/e2e/specs/editor/blocks/navigation-colors.spec.js`

### simison on 2026-03-13T12:25:49Z

URL: https://github.com/WordPress/gutenberg/pull/75963#issuecomment-4054738219

Noting that the Breadcrumbs component has some dependencies on `@wordpress/components` still.

### ciampo on 2026-03-16T15:07:10Z

URL: https://github.com/WordPress/gutenberg/pull/75963#issuecomment-4068362158

> Noting that the Breadcrumbs component has some dependencies on `@wordpress/components` still.

@jameskoster, would you have the capacity to migrate `Breadcrumbs`, too?

I was hoping we could remove `@wordpress/components` entirely as a dependency of `@wordpress/admin-ui`, but unfortunately it's still used to `createSlotFill` (cc @WordPress/gutenberg-components , a consideration for the long-term replacement of the package)

### jameskoster on 2026-03-16T17:07:34Z

URL: https://github.com/WordPress/gutenberg/pull/75963#issuecomment-4069227874

Added to my todo list 😆

### t-hamano on 2026-03-18T06:41:38Z

URL: https://github.com/WordPress/gutenberg/pull/75963#issuecomment-4080118154

Is it okay to backport this PR to `wp/7.0`? Because when I tried to backport the fixes related to the Connectors page to `wp/7.0`, a conflict occurred. While we can resolve the conflict manually, performing the backport in the order of #75963 and then #76456 avoids the conflict. See https://github.com/WordPress/gutenberg/pull/76580#discussion_r2946744652

### jameskoster on 2026-03-18T10:56:19Z

URL: https://github.com/WordPress/gutenberg/pull/75963#issuecomment-4081549766

@mirka will probably know best. I'm not sure if https://github.com/WordPress/gutenberg/issues/76135 is a blocker to backporting this PR for 7.0.

### mirka on 2026-03-18T13:23:55Z

URL: https://github.com/WordPress/gutenberg/pull/75963#issuecomment-4082546150

> I'm not sure if #76135 is a blocker to backporting this PR for 7.0.

Not a blocker 👍 The `Stack` component is safe, and the build-time injection of design tokens fallbacks was also backported.

### t-hamano on 2026-03-19T05:59:56Z

URL: https://github.com/WordPress/gutenberg/pull/75963#issuecomment-4088012685

Thank you! I'll backport this PR to 7.0.

### github-actions on 2026-03-19T06:02:11Z

URL: https://github.com/WordPress/gutenberg/pull/75963#issuecomment-4088021327

I just cherry-picked this PR to the wp/7.0 branch to get it included in the next release: 997e2290028cfa6efa36fd98d6b79caff3f0d692

## Review threads

### Review thread 1

#### jameskoster on 2026-02-26T16:14:48Z

URL: https://github.com/WordPress/gutenberg/pull/75963#discussion_r2859950544
Path: packages/admin-ui/src/page/header.tsx

```diff
@@ -28,34 +24,39 @@ export default function Header( {
...
It occurs to me that in the extensible site editor (need a shorter name for that haha) context this should arguably be a `h1`. WDYT?

#### mirka on 2026-02-27T13:12:35Z

URL: https://github.com/WordPress/gutenberg/pull/75963#discussion_r2864283250
Path: packages/admin-ui/src/page/header.tsx
...
There's a weird empty h1 in the sidebar 🥲

<img width="204" height="52" alt="Document outline" src="https://github.com/user-attachments/assets/136e9d5a-93ac-4dd2-97d0-a523138535b2" />

#### jameskoster on 2026-02-27T14:01:41Z

URL: https://github.com/WordPress/gutenberg/pull/75963#discussion_r2864483843
Path: packages/admin-ui/src/page/header.tsx
...
I guess we can tidy this up separately.

### Review thread 2

#### mirka on 2026-02-27T13:04:56Z

URL: https://github.com/WordPress/gutenberg/pull/75963#discussion_r2864253220
Path: packages/admin-ui/src/page/header.tsx
...
Also needs `align="center"` if we're going to match the `HStack` behavior? (They were center-aligned by default)

#### jameskoster on 2026-02-27T13:56:21Z

URL: https://github.com/WordPress/gutenberg/pull/75963#discussion_r2864460962
Path: packages/admin-ui/src/page/header.tsx
...
I think this one is okay. It ensures the primary action button always remains in the correct position regardless of whether the page title wraps:

<img width="1326" height="108" alt="Screenshot 2026-02-27 at 13 55 39" src="https://github.com/user-attachments/assets/1e51a239-12e5-4580-8326-41d186d86912" />

### Review thread 3 (resolved)

#### mirka on 2026-02-27T13:05:49Z

URL: https://github.com/WordPress/gutenberg/pull/75963#discussion_r2864256626
Path: packages/admin-ui/src/page/header.tsx
...
Also needs `align="center"` to match the `HStack` behavior?

#### jameskoster on 2026-02-27T14:00:06Z

URL: https://github.com/WordPress/gutenberg/pull/75963#discussion_r2864477442
Path: packages/admin-ui/src/page/header.tsx
...
Fixed in https://github.com/WordPress/gutenberg/pull/75963/commits/6d793534b98806a912c8bc36fbd75bcd305845a6.

## Changed files

- package-lock.json (MODIFIED, +1/-0)
- packages/admin-ui/package.json (MODIFIED, +1/-0)
- packages/admin-ui/src/page/header.tsx (MODIFIED, +18/-16)
- packages/admin-ui/src/page/style.scss (MODIFIED, +23/-17)
- packages/admin-ui/tsconfig.json (MODIFIED, +2/-1)
