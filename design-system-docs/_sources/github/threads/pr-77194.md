...
type: pull_request
state: MERGED
merged_at: 2026-04-21T10:52:53Z
url: https://github.com/WordPress/gutenberg/pull/77194
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Enhancement","[Package] UI"]
---

# PR #77194: UI Dialog: Add Description, modal context, and misc improvements

- URL: https://github.com/WordPress/gutenberg/pull/77194
- Author: ciampo
- Created: 2026-04-09T11:26:40Z
- Updated: 2026-04-21T10:55:15Z
- Comments: 3 of 3
- Review threads: 7 of 7
- Changed files: 12 of 12
- Diff: ../pr-diffs/77194.diff
...
### github-actions on 2026-04-09T12:38:30Z

URL: https://github.com/WordPress/gutenberg/pull/77194#issuecomment-4214256725
...
### github-actions on 2026-04-09T12:57:16Z

URL: https://github.com/WordPress/gutenberg/pull/77194#issuecomment-4214386596

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 5889c59ee2ca089b90c9c1aebf23142446c8fec6.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/24716531148
📝  Reported issues:
- #76524 in `/test/e2e/specs/editor/various/post-content-focus-mode.spec.js`

### github-actions on 2026-04-17T15:19:06Z

URL: https://github.com/WordPress/gutenberg/pull/77194#issuecomment-4269233469
...
#### ciampo on 2026-04-17T09:23:12Z

URL: https://github.com/WordPress/gutenberg/pull/77194#discussion_r3099159902
Path: packages/ui/src/dialog/stories/index.story.tsx

Is the `table` here necessary?

### Review thread 2 (resolved)

#### ciampo on 2026-04-17T09:55:55Z

URL: https://github.com/WordPress/gutenberg/pull/77194#discussion_r3099353044
Path: packages/ui/src/dialog/types.ts

we could also improve the container prop wordring, taking inspiration from https://github.com/WordPress/gutenberg/pull/76690

### Review thread 3 (resolved)

#### copilot-pull-request-reviewer on 2026-04-17T11:55:59Z

URL: https://github.com/WordPress/gutenberg/pull/77194#discussion_r3100049790
Path: packages/ui/src/dialog/popup.tsx

```diff
@@ -37,10 +37,13 @@ const Popup = forwardRef< HTMLDivElement, PopupProps >( function DialogPopup(
...
The new conditional backdrop behavior isn’t covered by unit tests. Since `modal` can be `true | false | 'trap-focus'`, please add assertions that the backdrop is rendered only when `modal === true` and is absent for `modal={false}` and `modal="trap-focus"` (to prevent regressions in non-modal / trap-focus modes).

### Review thread 4 (resolved)

#### copilot-pull-request-reviewer on 2026-04-17T12:33:08Z

URL: https://github.com/WordPress/gutenberg/pull/77194#discussion_r3100284769
Path: packages/ui/src/dialog/test/index.test.tsx

```diff
@@ -58,11 +62,167 @@ describe( 'Dialog', () => {
...
The assertion for the “disabled={ false } overrides loading” case is likely incorrect/brittle: elsewhere in this codebase (e.g. Button tests) the enabled state is asserted via `not.toHaveAttribute('aria-disabled', 'true')` rather than expecting `aria-disabled="false"`, because the attribute is typically omitted when not disabled. Consider changing this expectation to assert `aria-disabled` is not `'true'` (or assert the action is clickable) so the test matches the established behavior.
```suggestion
...
#### mirka on 2026-04-20T16:41:53Z

URL: https://github.com/WordPress/gutenberg/pull/77194#discussion_r3112252411
Path: packages/ui/src/dialog/description.tsx
...
Worth noting that there's a semantic association with `aria-describedby`?

### Review thread 6 (resolved)

#### mirka on 2026-04-20T16:45:35Z

URL: https://github.com/WordPress/gutenberg/pull/77194#discussion_r3112272574
Path: packages/ui/src/dialog/style.module.css

Preexisting, but shouldn't we be using `100dvh` here instead of `100vh`?

### Review thread 7 (resolved)

#### mirka on 2026-04-20T16:47:13Z

URL: https://github.com/WordPress/gutenberg/pull/77194#discussion_r3112280783
Path: packages/ui/src/dialog/test/index.test.tsx
...
May be less fragile to query with a `data-testid`.

## Changed files

- packages/ui/CHANGELOG.md (MODIFIED, +1/-0)
- packages/ui/src/dialog/context.tsx (MODIFIED, +31/-5)
- packages/ui/src/dialog/description.tsx (ADDED, +28/-0)
- packages/ui/src/dialog/index.ts (MODIFIED, +2/-0)
- packages/ui/src/dialog/popup.tsx (MODIFIED, +14/-3)
- packages/ui/src/dialog/root.tsx (MODIFIED, +22/-5)
- packages/ui/src/dialog/stories/index.story.tsx (MODIFIED, +3/-21)
- packages/ui/src/dialog/style.module.css (MODIFIED, +10/-3)
- packages/ui/src/dialog/test/index.test.tsx (MODIFIED, +182/-0)
- packages/ui/src/dialog/title.tsx (MODIFIED, +3/-2)
- packages/ui/src/dialog/types.ts (MODIFIED, +16/-2)
- packages/ui/src/popover/description.tsx (MODIFIED, +0/-1)
