...
type: pull_request
state: MERGED
merged_at: 2022-08-19T08:54:34Z
url: https://github.com/WordPress/gutenberg/pull/43377
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Feature] UI Components","[Package] Components"]
---

# PR #43377: Dropdown: anchor popover to the dropdown wrapper (instead of the toggle)

- URL: https://github.com/WordPress/gutenberg/pull/43377
- Author: ciampo
- Created: 2022-08-18T11:54:14Z
- Updated: 2022-08-19T08:55:10Z
- Comments: 4 of 4
- Review threads: 3 of 3
- Changed files: 5 of 5
- Diff: ../pr-diffs/43377.diff
...
### github-actions on 2022-08-18T12:05:47Z

URL: https://github.com/WordPress/gutenberg/pull/43377#issuecomment-1219410895
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 198 kB | -4 B (0%) |
| `build/components/style-rtl.css` | 11.7 kB | +10 B (0%) |
| `build/components/style.css` | 11.7 kB | +9 B (0%) |
...
### ciampo on 2022-08-18T15:48:38Z

URL: https://github.com/WordPress/gutenberg/pull/43377#issuecomment-1219655742

Since this change affects a lot of components in Gutenberg (every dropdown!), it'd be great if we could also get a second pair of eyes checking for any potential regressions.

Thank you!

### ciampo on 2022-08-19T07:39:49Z

URL: https://github.com/WordPress/gutenberg/pull/43377#issuecomment-1220354021
...
That is a known issue, which I reported first in https://github.com/WordPress/gutenberg/issues/41390 and recently in https://github.com/WordPress/gutenberg/issues/42994 (should be unrelated to the changes in this PR)

> I ran into an issue with testing the Image block buttons, but fortunately that's been fixed in https://github.com/WordPress/gutenberg/pull/43361 — looks like this PR will need a rebase just to make sure those still work. Once it's rebased, we'd then just want to double check that the aspect ratio dropdown in the toolbar is positioned correctly, then I think we'd be good to go.

Good idea — i've just rebased

### ciampo on 2022-08-19T07:47:00Z

URL: https://github.com/WordPress/gutenberg/pull/43377#issuecomment-1220359924

The aspect ratio dropdown looks good after the rebase

![Screenshot 2022-08-19 at 09 46 17](https://user-images.githubusercontent.com/1083581/185569970-6d225b6d-8338-4aab-9dac-cc71204526a3.png)

I'm going to wait for CI to pass ✅  and likely go ahead and merge

## Review threads

### Review thread 1

#### ciampo on 2022-08-18T11:57:37Z

URL: https://github.com/WordPress/gutenberg/pull/43377#discussion_r949039046
...
#### ciampo on 2022-08-18T11:58:30Z

URL: https://github.com/WordPress/gutenberg/pull/43377#discussion_r949039761
...
#### ntsekouras on 2022-08-18T14:34:25Z

URL: https://github.com/WordPress/gutenberg/pull/43377#discussion_r949222001
Path: packages/components/src/custom-gradient-picker/style.scss
...
```suggestion
		// Trim any internal white spacing that would be caused by inline positioned elements.
```

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/custom-gradient-bar/control-points.js (MODIFIED, +24/-14)
- packages/components/src/custom-gradient-picker/style.scss (MODIFIED, +21/-11)
- packages/components/src/dropdown-menu/stories/index.js (MODIFIED, +13/-2)
- packages/components/src/dropdown/index.js (MODIFIED, +3/-5)
