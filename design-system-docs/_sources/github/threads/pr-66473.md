...
type: pull_request
state: MERGED
merged_at: 2024-10-27T13:02:57Z
url: https://github.com/WordPress/gutenberg/pull/66473
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #66473: DrodownMenuV2: Rename folder to `menu`

- URL: https://github.com/WordPress/gutenberg/pull/66473
- Author: ciampo
- Created: 2024-10-25T12:45:26Z
- Updated: 2024-10-27T13:03:32Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 18 of 18
- Diff: ../pr-diffs/66473.diff
...
Rename internal folder in preparation for https://github.com/WordPress/gutenberg/pull/66289

## Why?
<!-- Why is this PR necessary? What problem is it solving? Reference any existing previous issue(s) or PR(s), but please add a short summary here, too -->

See https://github.com/WordPress/gutenberg/pull/66289


## How?
<!-- How is your PR addressing the issue at hand? What are the implementation details? -->

Rename folder, update imports
...
### github-actions on 2024-10-25T12:46:18Z

URL: https://github.com/WordPress/gutenberg/pull/66473#issuecomment-2437686108
...
### github-actions on 2024-10-25T12:55:46Z

URL: https://github.com/WordPress/gutenberg/pull/66473#issuecomment-2437706077
...
- docs/tool/manifest.js (MODIFIED, +1/-1)
- packages/components/src/menu/README.md (RENAMED, +0/-0)
- packages/components/src/menu/checkbox-item.tsx (RENAMED, +0/-0)
- packages/components/src/menu/context.tsx (RENAMED, +0/-0)
- packages/components/src/menu/group-label.tsx (RENAMED, +0/-0)
- packages/components/src/menu/group.tsx (RENAMED, +0/-0)
- packages/components/src/menu/index.tsx (RENAMED, +0/-0)
- packages/components/src/menu/item-help-text.tsx (RENAMED, +0/-0)
- packages/components/src/menu/item-label.tsx (RENAMED, +0/-0)
- packages/components/src/menu/item.tsx (RENAMED, +0/-0)
- packages/components/src/menu/radio-item.tsx (RENAMED, +0/-0)
- packages/components/src/menu/separator.tsx (RENAMED, +0/-0)
- packages/components/src/menu/stories/index.story.tsx (RENAMED, +0/-0)
- packages/components/src/menu/styles.ts (RENAMED, +0/-0)
- packages/components/src/menu/test/index.tsx (RENAMED, +0/-0)
- packages/components/src/menu/types.ts (RENAMED, +0/-0)
- packages/components/src/menu/use-temporary-focus-visible-fix.ts (RENAMED, +0/-0)
