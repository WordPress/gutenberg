...
type: pull_request
state: MERGED
merged_at: 2022-11-01T17:44:58Z
url: https://github.com/WordPress/gutenberg/pull/45389
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components"]
---

# PR #45389: RadioGroup: Mark as deprecated

- URL: https://github.com/WordPress/gutenberg/pull/45389
- Author: mirka
- Created: 2022-10-28T16:54:12Z
- Updated: 2022-11-01T17:45:30Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 9 of 9
- Diff: ../pr-diffs/45389.diff
...
Mark `RadioGroup` (and `Radio`) as deprecated, so we can encourage people to use the alternatives.

And some related cleanup:

- Opt out from TypeScript checks
- Remove separate story for `Radio` (wasn't really useful anyway)
- Move `radio/` and `radio-context/` to subfolders of `radio-group/` (just to decrease clutter)
...
<img width="280" alt="Heavily modded RadioGroup" src="https://user-images.githubusercontent.com/555336/198690403-2c5a2d14-8c90-4a8a-a4a6-66a572bf5e8f.png">
...
1. `npm run storybook:dev` and see the RadioGroup story. It should've moved to the Deprecated section.
2. `npm run dev`, go to `wp-admin/site-editor.php?postType=wp_template_part`, and click the "Add New" button. The RadioGroup in the modal should not have changed.

✅ Type checks (`npx tsc --build`) still pass

## Issue comments

### codesandbox on 2022-10-28T16:54:14Z

URL: https://github.com/WordPress/gutenberg/pull/45389#issuecomment-1295232704

<img alt="CodeSandbox logo" src="https://raw.githubusercontent.com/codesandbox/open-in-codesandbox/main/assets/csb.light.svg#gh-dark-mode-only" /><img alt="CodeSandbox logo" src="https://raw.githubusercontent.com/codesandbox/open-in-codesandbox/main/assets/csb.svg#gh-light-mode-only" />&nbsp; Open in CodeSandbox <a href="https://codesandbox.io/p/github/WordPress/gutenberg/deprecate-radio-group?workspace=%7B%22gitSidebarPanel%22:%22PR%22,%22sidebarPanel%22:%22GIT%22%7D">Web Editor</a> | <a href="https://codesandbox.io/p/vscode?owner=WordPress&repo=gutenberg&branch=deprecate-radio-group">VS Code</a> | <a href="https://codesandbox.io/p/vscode?owner=WordPress&repo=gutenberg&branch=deprecate-radio-group&insiders=true">VS Code Insiders</a>

<!-- open-in-codesandbox:complete -->

### github-actions on 2022-10-28T17:07:38Z

URL: https://github.com/WordPress/gutenberg/pull/45389#issuecomment-1295244469
...
- packages/components/src/radio-group/index.js (MODIFIED, +6/-1)
- packages/components/src/radio-group/radio-context/index.js (RENAMED, +0/-0)
- packages/components/src/radio-group/radio/index.js (RENAMED, +6/-1)
- packages/components/src/radio-group/stories/index.js (MODIFIED, +11/-2)
- packages/components/src/radio/stories/index.js (DELETED, +0/-20)
