...
type: pull_request
state: MERGED
merged_at: 2021-05-06T06:35:27Z
url: https://github.com/WordPress/gutenberg/pull/31300
matched_labels: ["[Package] Components","[Feature] Component System"]
all_labels: ["[Package] Components","[Feature] Component System"]
---

# PR #31300: components: Promote VStack and HStack

- URL: https://github.com/WordPress/gutenberg/pull/31300
- Author: sarayourfriend
- Created: 2021-04-28T20:16:12Z
- Updated: 2021-05-06T06:38:15Z
- Comments: 5 of 5
- Review threads: 5 of 5
- Changed files: 42 of 42
- Diff: ../pr-diffs/31300.diff
...
## Description
Promote the HStack and VStack components to experimental exports from `@wordpress/components`. These are brand new components.
...
### github-actions on 2021-04-28T20:27:29Z

URL: https://github.com/WordPress/gutenberg/pull/31300#issuecomment-828755388
...
| `build/components/index.js` | 186 kB | +484 B (0%) |
...
| `build/edit-site/index.js` | 25.7 kB | +363 B (+1%) |
| `build/edit-site/style-rtl.css` | 4.91 kB | +10 B (0%) |
| `build/edit-site/style.css` | 4.9 kB | +9 B (0%) |
| `build/edit-widgets/index.js` | 13.1 kB | -2 B (0%) |
| `build/editor/index.js` | 60.5 kB | +8 B (0%) |
...
### gziolo on 2021-04-30T11:48:03Z

URL: https://github.com/WordPress/gutenberg/pull/31300#issuecomment-830039109

There is no story for `VStack`.

A story for `HStack` looks this way:

<img width="1040" alt="Screen Shot 2021-04-30 at 13 47 48" src="https://user-images.githubusercontent.com/699132/116691126-ac05bb00-a9ba-11eb-9703-981e64635f6a.png">

### sarayourfriend on 2021-05-05T15:43:03Z

URL: https://github.com/WordPress/gutenberg/pull/31300#issuecomment-832797939

We can migrate Spacer as part of this PR? Or add it in a previous PR that this PR then is blocked by?

### sarayourfriend on 2021-05-05T16:02:02Z

URL: https://github.com/WordPress/gutenberg/pull/31300#issuecomment-832813842

I opened a Spacer PR here: https://github.com/WordPress/gutenberg/pull/31509 We can merge it first and then incorporate it into the stories for HStack and VStack.

### gziolo on 2021-05-06T06:36:25Z

URL: https://github.com/WordPress/gutenberg/pull/31300#issuecomment-833266975

> I opened a Spacer PR here: #31509 We can merge it first and then incorporate it into the stories for HStack and VStack.

There is no need to wait. I mostly raised it so we are aware that documentation contains `Spacer` component that doesn't exist yet and `View` component is inside the `/ui` subfolder.

## Review threads

### Review thread 1 (resolved)

#### gziolo on 2021-04-29T07:21:25Z

URL: https://github.com/WordPress/gutenberg/pull/31300#discussion_r622794026
...
Experimental features by design should not be documented. We should either ignore them here or expose as official APIs.

### Review thread 2

#### gziolo on 2021-04-30T11:13:14Z

URL: https://github.com/WordPress/gutenberg/pull/31300#discussion_r623799475
Path: packages/components/src/h-stack/README.md
...
I assume that `View` is going to be moved quite soon.

### Review thread 3

#### gziolo on 2021-04-30T11:13:47Z

URL: https://github.com/WordPress/gutenberg/pull/31300#discussion_r623799744
Path: packages/components/src/h-stack/README.md
...
There is no `Spacer` in `@wordpress/components` yet. Should we replace it with something else in this README file?

### Review thread 4 (resolved)

#### gziolo on 2021-04-30T11:14:17Z

URL: https://github.com/WordPress/gutenberg/pull/31300#discussion_r623799975
Path: packages/components/src/v-stack/README.md
...
Or we replace this component with something else. In fact, we might want to remove the whole section for now.

### Review thread 5 (resolved)

#### gziolo on 2021-04-30T11:14:26Z

URL: https://github.com/WordPress/gutenberg/pull/31300#discussion_r623800043
Path: packages/components/src/v-stack/README.md
...
- packages/components/src/h-stack/README.md (RENAMED, +19/-3)
- packages/components/src/h-stack/component.js (RENAMED, +6/-2)
- packages/components/src/h-stack/hook.js (RENAMED, +4/-4)
- packages/components/src/h-stack/index.js (RENAMED, +1/-1)
- packages/components/src/h-stack/stories/index.js (RENAMED, +2/-2)
- packages/components/src/h-stack/test/__snapshots__/index.js.snap (RENAMED, +0/-0)
- packages/components/src/h-stack/test/index.js (RENAMED, +1/-1)
- packages/components/src/h-stack/types.ts (RENAMED, +1/-1)
- packages/components/src/h-stack/utils.js (RENAMED, +1/-1)
- packages/components/src/index.js (MODIFIED, +3/-1)
...
- packages/components/src/ui/context/stories/ComponentsProvider.stories.js (MODIFIED, +2/-1)
...
- packages/components/src/v-stack/README.md (RENAMED, +21/-1)
- packages/components/src/v-stack/component.js (RENAMED, +6/-2)
- packages/components/src/v-stack/hook.js (RENAMED, +2/-2)
- packages/components/src/v-stack/index.js (RENAMED, +1/-2)
- packages/components/src/v-stack/test/__snapshots__/index.js.snap (RENAMED, +0/-0)
- packages/components/src/v-stack/test/index.js (RENAMED, +2/-2)
- packages/components/src/v-stack/types.ts (RENAMED, +0/-0)
- packages/components/src/visually-hidden/index.js (MODIFIED, +2/-2)
- packages/components/src/visually-hidden/test/index.js (MODIFIED, +1/-1)
