...
type: pull_request
state: MERGED
merged_at: 2025-10-27T15:08:51Z
url: https://github.com/WordPress/gutenberg/pull/72669
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #72669: Components: Stop using rems

- URL: https://github.com/WordPress/gutenberg/pull/72669
- Author: mirka
- Created: 2025-10-24T14:43:22Z
- Updated: 2025-10-27T15:09:31Z
- Comments: 5 of 5
- Review threads: 3 of 3
- Changed files: 4 of 4
- Diff: ../pr-diffs/72669.diff
...
### github-actions on 2025-10-24T15:07:30Z

URL: https://github.com/WordPress/gutenberg/pull/72669#issuecomment-3443649939
...
| :--- | :---: | :---: |
| `build/scripts/components/index.min.js` | 271 kB | -1 B (0%) |
| `build/styles/components/style-rtl.css` | 14 kB | -8 B (-0.06%) |
| `build/styles/components/style.css` | 14 kB | -8 B (-0.06%) |
...
| `build/scripts/core-commands/index.min.js` | 4.15 kB |
...
### github-actions on 2025-10-24T15:13:31Z

URL: https://github.com/WordPress/gutenberg/pull/72669#issuecomment-3443671300
...
### mirka on 2025-10-24T15:15:40Z

URL: https://github.com/WordPress/gutenberg/pull/72669#issuecomment-3443680390

FYI I tagged this as a bug, but given it only affects usage of the `@wordpress/components` package outside of WP, I don't think we need to backport this one.

### github-actions on 2025-10-24T15:27:24Z

URL: https://github.com/WordPress/gutenberg/pull/72669#issuecomment-3443721050

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 6336b70d1e807e6b65900c3afe2492d034a890b6.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/18783586782
📝  Reported issues:
- #51533 in `/test/e2e/specs/editor/various/list-view.spec.js`

### jasmussen on 2025-10-27T07:53:15Z

URL: https://github.com/WordPress/gutenberg/pull/72669#issuecomment-3449934170
...
#### mirka on 2025-10-24T14:59:51Z

URL: https://github.com/WordPress/gutenberg/pull/72669#discussion_r2460923249
...
I didn't find any intention to make this value change in relation to any relevant font sizes, so I've simply converted this to the equivalent pixel value.

No visual changes (if used in Gutenberg, at least).

<img width="748" height="226" alt="Tab list overflow fade" src="https://github.com/user-attachments/assets/aa980187-8507-4f4e-bd7c-5a50d06398ea" />

### Review thread 2

#### mirka on 2025-10-24T15:03:40Z

URL: https://github.com/WordPress/gutenberg/pull/72669#discussion_r2460938815
...
We could have made this the exact px equivalent (19.2px), but I've taken this opportunity to use a standard base-styles value (20px). Does this look ok @WordPress/gutenberg-design ?

| Before | After |
|--------|-------|
|<img width="1286" height="746" alt="Modal heading, before" src="https://github.com/user-attachments/assets/c6503753-b6a5-4802-b00e-67f310b0af16" />|<img width="1286" height="746" alt="Modal heading, after" src="https://github.com/user-attachments/assets/424e97cf-7e2d-4082-a46b-618b6de5a949" />|

### Review thread 3

#### mirka on 2025-10-24T15:08:42Z

URL: https://github.com/WordPress/gutenberg/pull/72669#discussion_r2460958105
...
<img width="311" height="100" alt="Error message in validated controls" src="https://github.com/user-attachments/assets/17e83632-decb-489e-b1a0-fb9751f90d1e" />
...
- packages/components/src/validated-form-controls/style.scss (MODIFIED, +1/-1)
