...
type: pull_request
state: MERGED
merged_at: 2022-02-08T13:17:16Z
url: https://github.com/WordPress/gutenberg/pull/38582
...
# PR #38582: `Navigator`: rename `push`/`pop` to `goTo`/`goBack`

- URL: https://github.com/WordPress/gutenberg/pull/38582
- Author: ciampo
- Created: 2022-02-07T14:17:01Z
- Updated: 2022-02-15T19:45:43Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 11 of 11
- Diff: ../pr-diffs/38582.diff
...
As proposed by @mirka and discussed in #38149, this PR renames the main 2 functions exposed by `useNavigator` hook:

- `push` renamed to `goTo`
- `pop` renamed to `goBack`
...
- preferences modal in post editor (on mobile viewport) still works as expected
- global styles sidebar still works as expected
...
### github-actions on 2022-02-07T14:24:56Z

URL: https://github.com/WordPress/gutenberg/pull/38582#issuecomment-1031524772
...
| `build/edit-post/index.min.js` | 29.7 kB | +2 B (0%) |
...
- packages/components/src/navigator/context.ts (MODIFIED, +2/-2)
- packages/components/src/navigator/navigator-provider/README.md (MODIFIED, +8/-8)
- packages/components/src/navigator/navigator-provider/component.tsx (MODIFIED, +9/-9)
- packages/components/src/navigator/navigator-screen/component.tsx (MODIFIED, +4/-4)
- packages/components/src/navigator/stories/index.js (MODIFIED, +6/-4)
- packages/components/src/navigator/test/index.js (MODIFIED, +21/-21)
- packages/components/src/navigator/types.ts (MODIFIED, +2/-2)
- packages/components/src/navigator/use-navigator.ts (MODIFIED, +3/-3)
- packages/edit-post/src/components/preferences-modal/index.js (MODIFIED, +4/-4)
- packages/edit-site/src/components/global-styles/navigation-button.js (MODIFIED, +4/-4)
