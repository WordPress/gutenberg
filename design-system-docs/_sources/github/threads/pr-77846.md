...
type: pull_request
state: OPEN
url: https://github.com/WordPress/gutenberg/pull/77846
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components","[Package] Block editor"]
---

# PR #77846: Block Toolbar: Add edge padding and stop disorienting flip jumps

- URL: https://github.com/WordPress/gutenberg/pull/77846
- Author: richtabor
- Created: 2026-04-30T14:23:23Z
- Updated: 2026-04-30T15:09:57Z
- Comments: 2 of 2
- Review threads: 4 of 4
- Changed files: 6 of 6
- Diff: ../pr-diffs/77846.diff
...
### github-actions on 2026-04-30T14:23:36Z

URL: https://github.com/WordPress/gutenberg/pull/77846#issuecomment-4353261595
...
### github-actions on 2026-04-30T14:35:48Z

URL: https://github.com/WordPress/gutenberg/pull/77846#issuecomment-4353363790
...
| :--- | :---: | :---: |
| `build/scripts/block-editor/index.min.js` | 341 kB | -359 B (-0.11%) |
| `build/scripts/components/index.min.js` | 266 kB | +14 B (+0.01%) |
| `build/styles/block-editor/style-rtl.css` | 18.6 kB | -5 B (-0.03%) |
| `build/styles/block-editor/style-rtl.min.css` | 15.8 kB | -7 B (-0.04%) |
| `build/styles/block-editor/style.css` | 18.6 kB | -5 B (-0.03%) |
| `build/styles/block-editor/style.min.css` | 15.8 kB | -8 B (-0.05%) |
...
#### copilot-pull-request-reviewer on 2026-04-30T14:28:32Z

URL: https://github.com/WordPress/gutenberg/pull/77846#discussion_r3168651535
Path: packages/block-editor/src/components/block-tools/use-block-toolbar-popover-props.js
...
+// First top-level block: there's no room above and scrolling can't rescue the
+// user, so place the toolbar below the block instead. Static placement avoids
+// the threshold-based flip jumps the previous implementation suffered from.
+const FIRST_BLOCK_PROPS = {
 	...COMMON_PROPS,
-	flip: true,
-	shift: false,
...
#### richtabor on 2026-04-30T14:39:44Z

URL: https://github.com/WordPress/gutenberg/pull/77846#discussion_r3168726997
Path: packages/block-editor/src/components/block-tools/use-block-toolbar-popover-props.js
...
Fixed, @copilot re-review

#### copilot-swe-agent on 2026-04-30T14:42:26Z

URL: https://github.com/WordPress/gutenberg/pull/77846#discussion_r3168744277
Path: packages/block-editor/src/components/block-tools/use-block-toolbar-popover-props.js
...
#### ciampo on 2026-04-30T14:51:50Z

URL: https://github.com/WordPress/gutenberg/pull/77846#discussion_r3168807717
...
#### mirka on 2026-04-30T15:09:57Z

URL: https://github.com/WordPress/gutenberg/pull/77846#discussion_r3168924323
Path: packages/components/src/popover/types.ts
...
#### ciampo on 2026-04-30T14:52:46Z

URL: https://github.com/WordPress/gutenberg/pull/77846#discussion_r3168813404
Path: packages/components/src/popover/types.ts
...
#### ciampo on 2026-04-30T14:54:16Z

URL: https://github.com/WordPress/gutenberg/pull/77846#discussion_r3168822619
Path: packages/block-editor/src/components/block-tools/use-block-toolbar-popover-props.js
...
- packages/block-editor/src/components/block-tools/block-toolbar-popover.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/block-tools/empty-block-inserter.js (MODIFIED, +1/-4)
- packages/block-editor/src/components/block-tools/style.scss (MODIFIED, +0/-2)
- packages/block-editor/src/components/block-tools/use-block-toolbar-popover-props.js (MODIFIED, +26/-171)
- packages/components/src/popover/index.tsx (MODIFIED, +6/-1)
- packages/components/src/popover/types.ts (MODIFIED, +5/-1)
