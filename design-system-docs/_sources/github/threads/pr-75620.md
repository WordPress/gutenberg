...
type: pull_request
state: MERGED
merged_at: 2026-02-18T08:34:26Z
url: https://github.com/WordPress/gutenberg/pull/75620
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components","[Package] Block editor","[Package] DataViews"]
---

# PR #75620: Update Ariakit packages

- URL: https://github.com/WordPress/gutenberg/pull/75620
- Author: jsnajdr
- Created: 2026-02-17T12:37:34Z
- Updated: 2026-02-18T08:35:54Z
- Comments: 7 of 7
- Review threads: 0 of 0
- Changed files: 10 of 10
- Diff: ../pr-diffs/75620.diff

## Body

I originally did this as part of the React 19 upgrade in #61521. I thought it was needed to make tests work, but it turned out it was not necessary. But I think it's still a worthwhile update we would do anyway sooner or later.

## Issue comments

### jsnajdr on 2026-02-17T12:46:29Z

URL: https://github.com/WordPress/gutenberg/pull/75620#issuecomment-3914519064

There is at least one type error:
```
packages/components/src/custom-select-control-v2/index.tsx(19,42):
  error TS2345: Argument of type 'SelectStoreValue' is not assignable to parameter of type 'string | string[]'.
```
That looks like an API change or a type fixup.

### github-actions on 2026-02-17T12:46:39Z

URL: https://github.com/WordPress/gutenberg/pull/75620#issuecomment-3914519887
...
### ntsekouras on 2026-02-17T12:49:30Z

URL: https://github.com/WordPress/gutenberg/pull/75620#issuecomment-3914532378

Have you checked any breaking changes between those versions? Sometimes something subtle like default focus change on some component or something like that could affect our current usage.

### jsnajdr on 2026-02-17T12:52:04Z

URL: https://github.com/WordPress/gutenberg/pull/75620#issuecomment-3914543947

> Have you checked any breaking changes between those versions?

I didn't check anything yet, opening this PR is meant to start the discussion and testing.

### github-actions on 2026-02-17T14:37:38Z

URL: https://github.com/WordPress/gutenberg/pull/75620#issuecomment-3915086045

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 7fdba767bbc7571cfea9fc1fc6031a69634208f4.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/22101915942
📝  Reported issues:
- #48569 in `/test/e2e/specs/editor/various/autocomplete-and-mentions.spec.js`

### github-actions on 2026-02-17T17:42:28Z

URL: https://github.com/WordPress/gutenberg/pull/75620#issuecomment-3916132550

**Size Change:** -2.76 kB (-0.04%) 

**Total Size:** 6.84 MB

| Filename | Size | Change |
| :--- | :---: | :---: |
| `build/scripts/components/index.min.js` | 265 kB | -1.43 kB (-0.54%) |
| `build/scripts/edit-site/index.min.js` | 243 kB | -619 B (-0.25%) |
| `build/scripts/media-utils/index.min.js` | 72.9 kB | -703 B (-0.95%) |
...
| `build/scripts/editor/index.min.js` | 347 kB |
...
| `build/styles/block-library/icon/style-rtl.css` | 205 B |
| `build/styles/block-library/icon/style-rtl.min.css` | 144 B |
| `build/styles/block-library/icon/style.css` | 205 B |
| `build/styles/block-library/icon/style.min.css` | 144 B |
...
### jsnajdr on 2026-02-17T19:08:07Z

URL: https://github.com/WordPress/gutenberg/pull/75620#issuecomment-3916600039

TypeScript errors are fixed and the CI checks are now green. All the type errors were caused by a new `readonly` attribute on `string[]` types. Mentioned in [0.4.19 changelog](https://github.com/ariakit/ariakit/blob/main/packages/ariakit-react/CHANGELOG.md#0419) as:
...
- package-lock.json (MODIFIED, +19/-19)
...
- packages/components/src/custom-select-control-v2/stories/index.story.tsx (MODIFIED, +3/-3)
- packages/components/src/custom-select-control-v2/test/index.tsx (MODIFIED, +3/-3)
- packages/components/src/custom-select-control-v2/types.ts (MODIFIED, +4/-4)
