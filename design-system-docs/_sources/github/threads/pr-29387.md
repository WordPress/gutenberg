...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/29387
matched_labels: ["[Package] Components","[Feature] Component System"]
all_labels: ["[Package] Components","[Feature] Component System"]
---

# PR #29387: Components: Convert `create-component` to TypeScript and simplify types

- URL: https://github.com/WordPress/gutenberg/pull/29387
- Author: sarayourfriend
- Created: 2021-02-26T20:29:04Z
- Updated: 2021-04-26T20:05:02Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 3 of 3
- Diff: ../pr-diffs/29387.diff
...
## Description
Simply convert `createComponent` to native TypeScript and simplify the types in the process.

None of the inner logic of the component is changed here, just the types.

This also has the added benefit of further documenting the parameters (🎉)

## How has this been tested?
Unit tests pass and storybook components continue to run.
...
### github-actions on 2021-02-26T20:40:28Z

URL: https://github.com/WordPress/gutenberg/pull/29387#issuecomment-786882572
...
- packages/components/src/ui/utils/create-component.tsx (ADDED, +57/-0)
