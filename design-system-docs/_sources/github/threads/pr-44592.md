...
type: pull_request
state: MERGED
merged_at: 2022-10-06T04:29:48Z
url: https://github.com/WordPress/gutenberg/pull/44592
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #44592: BorderBoxControl: Omit unit select when values are mixed

- URL: https://github.com/WordPress/gutenberg/pull/44592
- Author: aaronrobertshaw
- Created: 2022-09-30T03:25:42Z
- Updated: 2022-10-06T04:30:20Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 7 of 7
- Diff: ../pr-diffs/44592.diff
...
### jasmussen on 2022-09-30T07:28:41Z

URL: https://github.com/WordPress/gutenberg/pull/44592#issuecomment-1263210054
...
### aaronrobertshaw on 2022-10-04T08:02:28Z

URL: https://github.com/WordPress/gutenberg/pull/44592#issuecomment-1266554160
...
It's a minor change to make the disabling of the unit select depend only on the border width being mixed. I think this gives us the best of both worlds.

Here's a quick video of the component as of https://github.com/WordPress/gutenberg/pull/44592/commits/aeb352bc5e94a05c1d0bb6a40202964c243bd53f 


https://user-images.githubusercontent.com/60436221/193766478-ed458f2a-e49b-49b1-ba26-3ad3eb3d366f.mp4

### aaronrobertshaw on 2022-10-05T09:08:27Z

URL: https://github.com/WordPress/gutenberg/pull/44592#issuecomment-1268162347
...
### github-actions on 2022-10-06T01:14:26Z

URL: https://github.com/WordPress/gutenberg/pull/44592#issuecomment-1269177674
...
| :--- | :---: | :---: | :---: |
| `build/block-editor/index.min.js` | 166 kB | -236 B (0%) |  |
| `build/block-editor/style-rtl.css` | 15.4 kB | -44 B (0%) |  |
| `build/block-editor/style.css` | 15.3 kB | -45 B (0%) |  |
...
| `build/block-library/editor-rtl.css` | 11.2 kB | +15 B (0%) |  |
| `build/block-library/editor.css` | 11.2 kB | +15 B (0%) |  |
| `build/block-library/index.min.js` | 192 kB | +168 B (0%) |  |
| `build/block-library/style-rtl.css` | 12.3 kB | +15 B (0%) |  |
| `build/block-library/style.css` | 12.3 kB | +19 B (0%) |  |
| `build/components/index.min.js` | 202 kB | +2.51 kB (+1%) |  |
...
| `build/edit-site/index.min.js` | 57.9 kB | +79 B (0%) |  |
...
- packages/components/src/border-box-control/border-box-control/component.tsx (MODIFIED, +2/-0)
- packages/components/src/border-box-control/border-box-control/hook.ts (MODIFIED, +4/-0)
- packages/components/src/border-box-control/test/index.js (MODIFIED, +7/-2)
