...
type: pull_request
state: MERGED
merged_at: 2021-05-21T17:28:35Z
url: https://github.com/WordPress/gutenberg/pull/31614
matched_labels: ["[Package] Components","[Feature] Component System"]
all_labels: ["[Package] Components","[Feature] Component System"]
---

# PR #31614: components: Promote Elevation

- URL: https://github.com/WordPress/gutenberg/pull/31614
- Author: sarayourfriend
- Created: 2021-05-07T20:56:00Z
- Updated: 2021-05-21T17:29:03Z
- Comments: 2 of 2
- Review threads: 1 of 1
- Changed files: 14 of 14
- Diff: ../pr-diffs/31614.diff
...
## Description
Promotes the `Elevation` component to a full export.
...
### github-actions on 2021-05-07T21:05:24Z

URL: https://github.com/WordPress/gutenberg/pull/31614#issuecomment-834779313
...
### sarayourfriend on 2021-05-20T15:09:00Z

URL: https://github.com/WordPress/gutenberg/pull/31614#issuecomment-845205802
...
> I noticed that packages/components/tsconfig.json doesn't include all components — for example, should <Divider /> be listed there?
...
#### ciampo on 2021-05-21T07:13:22Z

URL: https://github.com/WordPress/gutenberg/pull/31614#discussion_r636689583
Path: packages/components/src/elevation/README.md
...
Nit: We should also change the `import` statement in the other example in this README (line 10) so that it imports `Elevation` by renaming `__experimentalElevation`

## Changed files

- docs/manifest.json (MODIFIED, +6/-0)
- packages/components/src/elevation/README.md (RENAMED, +17/-1)
- packages/components/src/elevation/component.js (RENAMED, +2/-2)
- packages/components/src/elevation/hook.js (RENAMED, +3/-3)
- packages/components/src/elevation/index.js (RENAMED, +0/-0)
- packages/components/src/elevation/stories/index.js (RENAMED, +6/-6)
- packages/components/src/elevation/styles.js (RENAMED, +0/-0)
- packages/components/src/elevation/test/__snapshots__/index.js.snap (RENAMED, +0/-0)
- packages/components/src/elevation/test/index.js (RENAMED, +0/-0)
- packages/components/src/elevation/types.ts (RENAMED, +0/-0)
