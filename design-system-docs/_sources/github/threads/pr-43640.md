...
type: pull_request
state: MERGED
merged_at: 2022-08-29T07:35:35Z
url: https://github.com/WordPress/gutenberg/pull/43640
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #43640: Components: remove unused normalizeArrowKey utility function

- URL: https://github.com/WordPress/gutenberg/pull/43640
- Author: ciampo
- Created: 2022-08-26T15:46:37Z
- Updated: 2022-08-29T07:36:05Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 3 of 3
- Diff: ../pr-diffs/43640.diff
...
The `normalizeArrowKey` is a utility function added in #33208 and needed by a component (`TextInput`) that was never added to the library, and is currently unused.

It is not used by any component, and is not exported from the package. And probably it won't be useful in the future, as we should be using `KeyboardEvent.code` instead of the deprecated `KeyboardEvent.keyCode`.

## Why?
<!-- Why is this PR necessary? What problem is it solving? Reference any existing previous issue(s) or PR(s), but please add a short summary here, too -->

I came across this piece of dead code while working on refactoring away from all `KeyboardEvent.keyCode` and `@wordpress/keycodes` calls in the `@wordpress/components` package/
...
### github-actions on 2022-08-26T16:00:11Z

URL: https://github.com/WordPress/gutenberg/pull/43640#issuecomment-1228670695
...
- packages/components/src/utils/keyboard.js (DELETED, +0/-28)
- packages/components/src/utils/test/keyboard.js (DELETED, +0/-34)
