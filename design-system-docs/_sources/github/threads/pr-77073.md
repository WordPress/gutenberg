...
type: pull_request
state: MERGED
merged_at: 2026-04-07T13:40:18Z
url: https://github.com/WordPress/gutenberg/pull/77073
matched_labels: ["[Package] UI"]
all_labels: ["[Focus] Accessibility (a11y)","[Type] Code Quality","[Package] Editor","[Package] UI"]
---

# PR #77073: ESLint plugin: Disable `jsx-a11y/heading-has-content`

- URL: https://github.com/WordPress/gutenberg/pull/77073
- Author: mirka
- Created: 2026-04-06T18:48:35Z
- Updated: 2026-04-07T13:54:32Z
- Comments: 6 of 6
- Review threads: 0 of 0
- Changed files: 9 of 9
- Diff: ../pr-diffs/77073.diff
...
### github-actions on 2026-04-06T18:56:34Z

URL: https://github.com/WordPress/gutenberg/pull/77073#issuecomment-4194346023
...
### github-actions on 2026-04-06T19:02:40Z

URL: https://github.com/WordPress/gutenberg/pull/77073#issuecomment-4194377206
...
### aduth on 2026-04-06T20:38:04Z

URL: https://github.com/WordPress/gutenberg/pull/77073#issuecomment-4194855799

Should we disable the `anchor-has-content` rule as well, since it seems like it'd be prone to the exact type of problems?

(Also mentioned at https://github.com/WordPress/gutenberg/issues/76501#issuecomment-4068250574, with at least one real-world [false positive in button tests](https://github.com/WordPress/gutenberg/blob/f755b5a3b99ac58d0c0c450e1296e6c9bba47ae2/packages/ui/src/button/test/button.test.tsx#L67-L72))

### mirka on 2026-04-07T12:04:30Z

URL: https://github.com/WordPress/gutenberg/pull/77073#issuecomment-4198809157

> Should we disable the `anchor-has-content` rule as well, since it seems like it'd be prone to the exact type of problems?

Hm, do we have a use case for this other than for `Button`? There is very clear guidance against this pattern from the Base UI team ([docs](https://base-ui.com/react/components/button#rendering-links-as-buttons), [potential dev warning](https://github.com/mui/base-ui/pull/3423)), so if anything we should remove that unit test, clarify it in our own docs, and perhaps have a separate component for link buttons.

### aduth on 2026-04-07T12:14:32Z

URL: https://github.com/WordPress/gutenberg/pull/77073#issuecomment-4198863747

> Hm, do we have a use case for this other than for `Button`? There is very clear guidance against this pattern from the Base UI team ([docs](https://base-ui.com/react/components/button#rendering-links-as-buttons), [potential dev warning](https://github.com/mui/base-ui/pull/3423)), so if anything we should remove that unit test, clarify it in our own docs, and perhaps have a separate component for link buttons.

That's a good point. I was looking at it more from a consistency of `*-has-content` rule treatment, though I can see your point about keeping it to indirectly discourage a pattern we want to prevent.

### mirka on 2026-04-07T13:54:32Z

URL: https://github.com/WordPress/gutenberg/pull/77073#issuecomment-4199489890
...
- packages/editor/src/components/post-title/index.js (MODIFIED, +2/-2)
- packages/eslint-plugin/CHANGELOG.md (MODIFIED, +4/-0)
- packages/eslint-plugin/configs/jsx-a11y.js (MODIFIED, +3/-0)
- packages/ui/src/card/stories/index.story.tsx (MODIFIED, +0/-1)
- packages/ui/src/card/test/index.test.tsx (MODIFIED, +0/-1)
- packages/ui/src/empty-state/title.tsx (MODIFIED, +0/-1)
- packages/ui/src/text/stories/index.story.tsx (MODIFIED, +0/-2)
- packages/ui/src/text/test/index.test.tsx (MODIFIED, +1/-4)
- storybook/stories/design-system/theme-example-application.story.tsx (MODIFIED, +0/-4)
