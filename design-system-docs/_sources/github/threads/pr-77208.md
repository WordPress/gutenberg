...
type: pull_request
state: MERGED
merged_at: 2026-04-10T08:41:14Z
url: https://github.com/WordPress/gutenberg/pull/77208
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #77208: FormToggle: Update disabled styles

- URL: https://github.com/WordPress/gutenberg/pull/77208
- Author: mirka
- Created: 2026-04-09T19:04:32Z
- Updated: 2026-04-10T08:43:33Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/77208.diff
...
Updates `FormToggle` disabled styles so the checked disabled state no longer relies on a blanket opacity reduction.

## Why?

The previous disabled treatment dimmed the entire control with `opacity: 0.3`, which is not themable, and keeping the accent color active in a disabled state is not the direction we're heading with the new design system.

This brings `FormToggle` closer to the newer disabled styling direction used for `CheckboxControl` in #77132, and thus closer to the new design system styles we want.

## How?

Replaces the disabled opacity rule with explicit disabled track and thumb colors.

Also adds `forced-colors` adjustments so the disabled checked track and thumb still render with the intended system colors in Windows High Contrast Mode.

## Testing Instructions

1. Run `npm run storybook:dev`.
2. Open `Components / FormToggle`.
3. Check the disabled unchecked state and confirm it uses disabled colors instead of reduced opacity.
4. Check the disabled checked state and confirm it no longer looks like a faded accent-colored toggle.
5. Enable `forced-colors` mode in dev tools and confirm the disabled checked track and thumb still render with the expected system colors.

## Screenshots or screencast

| Before | After |
|--------|-------|
|<img width="106" height="132" alt="Disabled toggles, before" src="https://github.com/user-attachments/assets/5bed2c41-d057-4450-921d-77bd3640cce2" />|<img width="104" height="132" alt="Disabled toggles, after" src="https://github.com/user-attachments/assets/b23edcf8-2d8b-4b95-8889-3076dc43882e" />|

### Forced colors mode

<img width="106" height="132" alt="Disabled toggles in forced colors mode" src="https://github.com/user-attachments/assets/f68a71cb-5b02-423c-8721-130047b669df" />
...
### github-actions on 2026-04-09T19:06:49Z

URL: https://github.com/WordPress/gutenberg/pull/77208#issuecomment-4216810572
...
### github-actions on 2026-04-09T19:18:27Z

URL: https://github.com/WordPress/gutenberg/pull/77208#issuecomment-4216912816

**Size Change:** +498 B (+0.01%) 
...
| :--- | :---: | :---: |
| `build/styles/components/style-rtl.css` | 17.3 kB | +96 B (+0.56%) |
| `build/styles/components/style-rtl.min.css` | 14.1 kB | +148 B (+1.06%) |
| `build/styles/components/style.css` | 17.3 kB | +97 B (+0.56%) |
| `build/styles/components/style.min.css` | 14.1 kB | +157 B (+1.12%) |
...
### github-actions on 2026-04-09T19:37:48Z

URL: https://github.com/WordPress/gutenberg/pull/77208#issuecomment-4217019748

<!-- flaky-tests-report-comment -->
**Flaky tests detected in c307e8d7b5a07cec0d3eee4dbad18075c7516c71.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/24232661595
📝  Reported issues:
...
- packages/components/src/form-toggle/style.scss (MODIFIED, +34/-1)
