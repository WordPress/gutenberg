...
type: pull_request
state: MERGED
merged_at: 2026-03-06T08:14:31Z
url: https://github.com/WordPress/gutenberg/pull/76041
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components","[Package] DataViews"]
---

# PR #76041: Menu: Fix `RadioItem` controlled checked state

- URL: https://github.com/WordPress/gutenberg/pull/76041
- Author: Aljullu
- Created: 2026-03-02T12:34:00Z
- Updated: 2026-03-06T08:16:07Z
- Comments: 4 of 4
- Review threads: 1 of 1
- Changed files: 5 of 5
- Diff: ../pr-diffs/76041.diff

## Body

## What?

In DataViews, the checked status of a menu option might be reset from a separate menu. Ie, sorting by Column A should reset the 'checked' status of sorting menu items from Column B. This is fixed in `@ariakit/react` 0.4.22, so this PR updates the package.

## Testing Instructions

1. Go to the storybook > DataViews > Layout Table.
2. Sort by Categories (asc or desc, doesn't matter).
3. Verify the option you just clicks shows the · icon as it's checked.
4. Now, sort by Title. Verify the option shows the · icon.
5. Open the Categories menu again.
6. Verify none of those options is checked.

Before | After
--- | ---
<img width="1702" height="375" alt="imatge" src="https://github.com/user-attachments/assets/42eabe6c-1078-4942-af37-f2f6c3d81ffd" /> | <img width="1702" height="375" alt="imatge" src="https://github.com/user-attachments/assets/a8f50442-47d0-4541-b118-414cf6a42007" />

Note: in the screenshot above, notice that the table is currently sorted by _Title_, so the sorting options in the _Categories_ columns should both look as not checked.

7. Optionally check Actions > Menus > With Radios to make sure there are no regressions in current menus.

## Issue comments

### github-actions on 2026-03-02T12:49:17Z

URL: https://github.com/WordPress/gutenberg/pull/76041#issuecomment-3984201832
...
| :--- | :---: | :---: |
| `build/scripts/components/index.min.js` | 265 kB | +5 B (0%) |
...
| `build/scripts/editor/index.min.js` | 350 kB |
...
| `build/styles/editor/style.css` | 23.3 kB |
| `build/styles/editor/style.min.css` | 19.8 kB |
...
### github-actions on 2026-03-02T13:35:20Z

URL: https://github.com/WordPress/gutenberg/pull/76041#issuecomment-3984442007
...
### Aljullu on 2026-03-05T10:18:17Z

URL: https://github.com/WordPress/gutenberg/pull/76041#issuecomment-4003973653

Thanks for taking a look, folks!

> Reported upstream at https://github.com/ariakit/ariakit/issues/5483

With the upstream fix, I believe my original fix is no longer necessary? So I converted this PR into simply updating `@ariakit/react`. I also added a unit test. I'm not 100% sure if it's needed, considering that this is now handled by Ariakit, but I don't have a strong opinion.

@tyxla @mirka given that this PR changed significantly, would you like to take another look?

### github-actions on 2026-03-05T10:31:44Z

URL: https://github.com/WordPress/gutenberg/pull/76041#issuecomment-4004057233

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 285725c8223f4a6e93e6cbb7bdcd4fb8d2273870.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/22752549953
📝  Reported issues:
...
#### mirka on 2026-03-05T17:21:19Z

URL: https://github.com/WordPress/gutenberg/pull/76041#discussion_r2891297062
...
Confirmed that the [changelog](https://ariakit.org/changelog#0422) is just our fix ✅

## Changed files

- package-lock.json (MODIFIED, +33/-1)
