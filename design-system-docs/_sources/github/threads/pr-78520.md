...
type: pull_request
state: MERGED
merged_at: 2026-05-25T14:50:15Z
url: https://github.com/WordPress/gutenberg/pull/78520
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Bug","[Package] UI"]
---

# PR #78520: UI: Update Autocomplete clear disabled state

- URL: https://github.com/WordPress/gutenberg/pull/78520
- Author: mirka
- Created: 2026-05-21T19:25:56Z
- Updated: 2026-05-25T17:03:21Z
- Comments: 2 of 2
- Review threads: 1 of 1
- Changed files: 3 of 3
- Diff: ../pr-diffs/78520.diff
...
### github-actions on 2026-05-21T19:37:40Z

URL: https://github.com/WordPress/gutenberg/pull/78520#issuecomment-4512142914
...
| :--- | :---: | :---: |
| `build/scripts/block-editor/index.min.js` | 378 kB | -130 B (-0.03%) |
| `build/scripts/editor/index.min.js` | 432 kB | +29 B (+0.01%) |
...
### github-actions on 2026-05-22T16:50:50Z

URL: https://github.com/WordPress/gutenberg/pull/78520#issuecomment-4520813082
...
#### ciampo on 2026-05-25T14:12:45Z

URL: https://github.com/WordPress/gutenberg/pull/78520#discussion_r3298608425
Path: packages/ui/src/form/primitives/autocomplete/clear.tsx
...
Out of curiosity, could we grab `disabled` from the props? Or do you prefer to grab it from the internal state since it's more "correct" ?

If `disabled` is in `...props` anyway, it will override the explicitly set `disabled` anyway?

#### mirka on 2026-05-25T14:49:56Z

URL: https://github.com/WordPress/gutenberg/pull/78520#discussion_r3298772889
Path: packages/ui/src/form/primitives/autocomplete/clear.tsx
...
I was wondering similar things before, and confirmed in source code that yes the internal state is "more correct", and internal state takes the `disabled` prop into consideration, so the current setup is correct.

#### ciampo on 2026-05-25T16:53:18Z

URL: https://github.com/WordPress/gutenberg/pull/78520#discussion_r3299215255
Path: packages/ui/src/form/primitives/autocomplete/clear.tsx
...
But should we assign the `disabled` prop on `IconButton` after the `{...props}` spread, or is that a non-issue?

#### mirka on 2026-05-25T17:03:21Z

URL: https://github.com/WordPress/gutenberg/pull/78520#discussion_r3299246840
Path: packages/ui/src/form/primitives/autocomplete/clear.tsx
...
Right, it's a non-issue because Base UI _strips_ the consumer-provided `disabled` to compute its own internal disabled state, and the raw consumer-provided `disabled` doesn't reach this render function directly.

## Changed files

- packages/ui/CHANGELOG.md (MODIFIED, +1/-0)
- packages/ui/src/form/primitives/autocomplete/clear.tsx (MODIFIED, +10/-4)
- packages/ui/src/form/primitives/autocomplete/test/index.test.tsx (MODIFIED, +31/-0)
