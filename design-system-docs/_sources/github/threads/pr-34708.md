...
type: pull_request
state: MERGED
merged_at: 2021-09-13T15:21:29Z
url: https://github.com/WordPress/gutenberg/pull/34708
matched_labels: ["[Package] Components","[Feature] Component System"]
all_labels: ["[Type] Enhancement","[Type] Developer Documentation","[Package] Components","Storybook","[Feature] Component System"]
---

# PR #34708: ItemGroup: add story showcasing more complex layouts

- URL: https://github.com/WordPress/gutenberg/pull/34708
- Author: ciampo
- Created: 2021-09-09T16:56:50Z
- Updated: 2021-09-20T14:57:24Z
- Comments: 4 of 4
- Review threads: 0 of 0
- Changed files: 1 of 1
- Diff: ../pr-diffs/34708.diff
...
Adds a new Storybook story for the `ItemGroup` component that helps showcasing how to use this component to create more complex UIs.

This example is also going to help to investigate the current limitations on `ItemGroup` when integrating it with other components.
...
- [ ] project builds
- [ ] storybook story behaves as expected

## Screenshots <!-- if applicable -->

<img width="265" alt="Screenshot 2021-09-09 at 18 56 35" src="https://user-images.githubusercontent.com/1083581/132729574-d646dc60-d616-4b33-ad61-1298dc67947e.png">
...
### github-actions on 2021-09-09T17:03:28Z

URL: https://github.com/WordPress/gutenberg/pull/34708#issuecomment-916277547
...
### pablohoneyhoney on 2021-09-10T13:24:36Z

URL: https://github.com/WordPress/gutenberg/pull/34708#issuecomment-916902253

Nice!

When possible, let's try the borders as 20% of 000000. 

<img width="98" alt="Screen Shot 2021-09-10 at 9 22 28 AM" src="https://user-images.githubusercontent.com/25516611/132859932-96f3d9e6-c5e4-4c42-b1b4-387061afdb16.png">

Here's the original reference:

<img width="841" alt="Screen Shot 2021-09-10 at 9 24 07 AM" src="https://user-images.githubusercontent.com/25516611/132860175-99eb9837-f75e-45e1-b878-d7a5de1f8561.png">

### ciampo on 2021-09-13T14:17:05Z

URL: https://github.com/WordPress/gutenberg/pull/34708#issuecomment-918239568

> When possible, let's try the borders as 20% of 000000.

Thank you for the feedback, @pablohoneyhoney. I've [updated](https://github.com/WordPress/gutenberg/pull/34708/commits/10d56360cf544815472fae29c75ec8751fbc3207) this specific Storybook example to be 20% of `000000`.

Out of curiosity, should this be the border color for all component's borders (e.g. the `ItemGroup` itself, `Card`, ...)? Currently, it is [set to be 10% of `#000000`](https://github.com/WordPress/gutenberg/blob/9af3ae765d5d6cd7e7688ff791e5170710386d79/packages/components/src/utils/config-values.js#L75)

### pablohoneyhoney on 2021-09-20T14:57:08Z

URL: https://github.com/WordPress/gutenberg/pull/34708#issuecomment-923004877

> Out of curiosity, should this be the border color for all component's borders (e.g. the ItemGroup itself, Card, ...)? Currently, it is set to be 10% of #000000

We'd need to see them in context to value if the difference matters, but let's try it. @ciampo
...
- packages/components/src/item-group/stories/index.js (MODIFIED, +90/-2)
