...
type: pull_request
state: MERGED
merged_at: 2025-07-28T17:41:54Z
url: https://github.com/WordPress/gutenberg/pull/70910
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #70910: TextControl: Improve theming support

- URL: https://github.com/WordPress/gutenberg/pull/70910
- Author: mirka
- Created: 2025-07-25T15:07:49Z
- Updated: 2025-07-28T17:42:28Z
- Comments: 2 of 2
- Review threads: 3 of 3
- Changed files: 4 of 4
- Diff: ../pr-diffs/70910.diff
...
### github-actions on 2025-07-25T15:10:55Z

URL: https://github.com/WordPress/gutenberg/pull/70910#issuecomment-3118456735
...
### github-actions on 2025-07-25T15:21:38Z

URL: https://github.com/WordPress/gutenberg/pull/70910#issuecomment-3118562757

**Size Change:** -200 B (-0.01%) 

**Total Size:** 1.89 MB

| Filename | Size | Change |
| :--- | :---: | :---: |
| `build/components/style-rtl.css` | 13.6 kB | -99 B (-0.72%) |
| `build/components/style.css` | 13.6 kB | -101 B (-0.74%) |
...
#### mirka on 2025-07-25T15:10:11Z

URL: https://github.com/WordPress/gutenberg/pull/70910#discussion_r2231376790
...
https://github.com/WordPress/gutenberg/blob/a2cb1b07ac94daa5e93902bc778b6717c25f013b/packages/components/src/utils/colors-values.js#L66-L68

### Review thread 2

#### jsnajdr on 2025-07-28T17:07:37Z

URL: https://github.com/WordPress/gutenberg/pull/70910#discussion_r2237307570
...
Border color is already defined in the `input-style__neutral` mixin included by `input-control`. Should the themed color be moved to that mixin? Then it would apply to multiple components, everything that uses `input-control`. Not sure how big issue that is.

#### mirka on 2025-07-28T17:18:20Z

URL: https://github.com/WordPress/gutenberg/pull/70910#discussion_r2237342849
Path: packages/components/src/text-control/style.scss
...
The themed variables are experimental and live at the `@wordpress/components` level, so we don't want to expose them at the `@wordpress/base-styles` level.

### Review thread 3

#### jsnajdr on 2025-07-28T17:13:19Z

URL: https://github.com/WordPress/gutenberg/pull/70910#discussion_r2237322921
Path: packages/components/src/text-control/style.scss
...
Is there an existing style that styles the `::placeholder`? I see some non-standard pseudo-selectors like `::-webkit-input-placeholder`, I wonder why we don't use the standard one yet.

#### mirka on 2025-07-28T17:21:30Z

URL: https://github.com/WordPress/gutenberg/pull/70910#discussion_r2237352827
Path: packages/components/src/text-control/style.scss
...
I believe it's just old code and can be replaced. I guess the repo doesn't have the [`property-no-vendor-prefix` lint](https://stylelint.io/user-guide/rules/property-no-vendor-prefix/)?

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +4/-0)
- packages/components/src/text-control/stories/index.story.tsx (MODIFIED, +1/-0)
- packages/components/src/text-control/style.scss (MODIFIED, +6/-1)
