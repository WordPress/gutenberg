...
type: pull_request
state: MERGED
merged_at: 2022-10-05T10:13:02Z
url: https://github.com/WordPress/gutenberg/pull/44698
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components"]
---

# PR #44698: Components: Refactor `useFocusOutside` to `@testing-library/react`

- URL: https://github.com/WordPress/gutenberg/pull/44698
- Author: tyxla
- Created: 2022-10-05T08:52:55Z
- Updated: 2022-10-05T10:13:36Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 1 of 1
- Diff: ../pr-diffs/44698.diff

## Body

## What?
This PR refactors the tests of `useFocusOutside` to use `@testing-library/react`'s render instead of `react-dom` render. This addresses one of the changes needed to upgrade to React 18, as touched in #32765.
...
Verify tests still pass: `npm run test:unit packages/compose/src/hooks/use-focus-outside/test/index.js`

## Issue comments

### github-actions on 2022-10-05T09:03:03Z

URL: https://github.com/WordPress/gutenberg/pull/44698#issuecomment-1268155855
...
- packages/compose/src/hooks/use-focus-outside/test/index.js (MODIFIED, +44/-45)
