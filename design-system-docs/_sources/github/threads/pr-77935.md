...
type: pull_request
state: MERGED
merged_at: 2026-05-05T13:50:49Z
url: https://github.com/WordPress/gutenberg/pull/77935
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #77935: ExternalLink: Fix focus outline under wp-admin

- URL: https://github.com/WordPress/gutenberg/pull/77935
- Author: t-hamano
- Created: 2026-05-05T07:10:47Z
- Updated: 2026-05-05T13:52:22Z
- Comments: 3 of 3
- Review threads: 1 of 1
- Changed files: 2 of 2
- Diff: ../pr-diffs/77935.diff

## Body

Related to #77910
See https://github.com/WordPress/gutenberg/pull/77790#issuecomment-4367920633

## What?

Fix the focus outline rendered around the `ExternalLink` component when used inside wp-admin.

## Why?

#77790 applied a new focus style to the `ExternalLink` component via the `outline` property, based on the new design system. However, w-admin applies `box-shadow` and `border-radius` to the `a` element, which prevents the focus ring from being formed correctly.

Additionally, the link icon has `display:inline-block`, which may cause the resulting inline block box to be taller than the surrounding text's baseline.

## How?

- Override `box-shadow` and `border-radius` in the focus state so only the design-system outline is shown.
- Add `line-height: 1` to `.components-external-link__icon` so the icon's inline box stays within the surrounding strut.

## Testing Instructions

1. Open the post editor.
2. Tab to any `ExternalLink` (for example, insert a block, open the Advanced panel, and focus the "Learn more about anchors" link).
3. Confirm the focus outline style.

## Screenshots or screencast

| Before | After |
| - | - |
| <img width="255" height="178" alt="image" src="https://github.com/user-attachments/assets/72076db4-bf06-49da-a4b5-e1c5bad08f8e" /> | <img width="260" height="177" alt="image" src="https://github.com/user-attachments/assets/1cbe9e31-5e50-4d89-b40f-6c67a21f3d7a" /> |
...
Used for: Diagnosing the wp-admin `common.css` overrides and drafting the CSS fix. Final change reviewed and validated by me.

## Issue comments

### github-actions on 2026-05-05T07:19:07Z

URL: https://github.com/WordPress/gutenberg/pull/77935#issuecomment-4377243630
...
| :--- | :---: | :---: |
| `build/styles/components/style-rtl.css` | 17.5 kB | +7 B (+0.04%) |
| `build/styles/components/style-rtl.min.css` | 14.3 kB | +5 B (+0.03%) |
| `build/styles/components/style.css` | 17.6 kB | +10 B (+0.06%) |
| `build/styles/components/style.min.css` | 14.3 kB | +5 B (+0.03%) |
...
| `build/modules/user-post-types/index.min.js` | 81.9 kB |
...
### github-actions on 2026-05-05T07:22:00Z

URL: https://github.com/WordPress/gutenberg/pull/77935#issuecomment-4377258409
...
### github-actions on 2026-05-05T13:29:02Z

URL: https://github.com/WordPress/gutenberg/pull/77935#issuecomment-4379708651

<!-- flaky-tests-report-comment -->
**Flaky tests detected in ae1165cdda984acf8cadb3f09566dd83bd395b81.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/25377503986
📝  Reported issues:
...
#### ciampo on 2026-05-05T09:18:47Z

URL: https://github.com/WordPress/gutenberg/pull/77935#discussion_r3187308901
...
Should we use the dedicated `--_gcd-a-box-shadow` and `--_gcd-a-border-radius` "common defense" variables instead?

#### t-hamano on 2026-05-05T10:11:54Z

URL: https://github.com/WordPress/gutenberg/pull/77935#discussion_r3187633661
Path: packages/components/src/external-link/style.scss
...
My understanding is that `ExternalLink` is from the components package, not the `ui` package, so it doesn't use CSS modules, and the defensive styles can't be applied here. Is that right?

#### ciampo on 2026-05-05T12:15:47Z

URL: https://github.com/WordPress/gutenberg/pull/77935#discussion_r3188308553
Path: packages/components/src/external-link/style.scss
...
🤦  You're correct. I must have gotten confused while context-switching between different PRs

## Changed files

- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/external-link/style.scss (MODIFIED, +4/-0)
