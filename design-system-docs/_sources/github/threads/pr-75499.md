...
type: pull_request
state: MERGED
merged_at: 2026-02-13T09:07:58Z
url: https://github.com/WordPress/gutenberg/pull/75499
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Element","[Package] Data","[Package] Server Side Render","[Package] Compose","[Package] Components","[Package] Editor","[Package] Block library","[Package] Format library","[Package] Block editor","[Package] Interface","[Package] Primitives","[Package] Edit Site","[Package] Commands","[Package] Patterns","[Package] Fields"]
---

# PR #75499: Types: consistently use the React namespace

- URL: https://github.com/WordPress/gutenberg/pull/75499
- Author: jsnajdr
- Created: 2026-02-13T07:50:48Z
- Updated: 2026-02-22T04:28:59Z
- Comments: 5 of 5
- Review threads: 6 of 6
- Changed files: 102 of 102
- Diff: ../pr-diffs/75499.diff
...
### github-actions on 2026-02-13T07:55:47Z

URL: https://github.com/WordPress/gutenberg/pull/75499#issuecomment-3895461605
...
### github-actions on 2026-02-13T08:03:22Z

URL: https://github.com/WordPress/gutenberg/pull/75499#issuecomment-3895486498
...
| :--- | :---: | :---: |
| `build/scripts/block-editor/index.min.js` | 326 kB | -1 B (0%) |
...
### github-actions on 2026-02-13T08:42:06Z

URL: https://github.com/WordPress/gutenberg/pull/75499#issuecomment-3895636602

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 0ce9dcc2681e1b368811ab9b6de7db76b9980cf6.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/21979732250
📝  Reported issues:
- #57525 in `/test/e2e/specs/widgets/editing-widgets.spec.js`
- #74483 in `/test/e2e/specs/site-editor/pages.spec.js`

### jsnajdr on 2026-02-13T09:07:06Z

URL: https://github.com/WordPress/gutenberg/pull/75499#issuecomment-3895797459

> Some checks are failing and need adjustents, but besides that changes look good to me

Yes, I was fixing all of them as you were writing this, and at this moment everything is green 🚀

### tyxla on 2026-02-22T04:28:59Z

URL: https://github.com/WordPress/gutenberg/pull/75499#issuecomment-3940121581

So glad we figured this out and kept the docs pretty!

## Review threads

### Review thread 1

#### jsnajdr on 2026-02-13T07:52:02Z

URL: https://github.com/WordPress/gutenberg/pull/75499#discussion_r2802794959
Path: packages/components/src/text/utils.ts
...
Using the `AllHTMLAttributes` type is too convoluted. Let's just use `CSSProperties`. That's the type of the `style` attribute and we use it explicitly at many other places, too

### Review thread 2

#### jsnajdr on 2026-02-13T07:52:53Z

URL: https://github.com/WordPress/gutenberg/pull/75499#discussion_r2802797421
Path: packages/components/src/utils/use-responsive-value.ts
...
Removing the `eslint-disable` here. As the source file is `.ts`, it doesn't need jsdoc type annotations at all.

### Review thread 3

#### jsnajdr on 2026-02-13T07:53:29Z

URL: https://github.com/WordPress/gutenberg/pull/75499#discussion_r2802799924
Path: packages/format-library/src/link/utils.js

```diff
@@ -133,18 +133,17 @@ export function createLinkFormat( {
 	return format;
 }
...
Removing another `eslint-disable`. Let's import the `RichTextValue` type properly to fix it.

### Review thread 4

#### jsnajdr on 2026-02-13T07:54:25Z

URL: https://github.com/WordPress/gutenberg/pull/75499#discussion_r2802803372
...
Here the `Mousetrap` module is already imported, let's use it.

### Review thread 5

#### jsnajdr on 2026-02-13T07:55:30Z

URL: https://github.com/WordPress/gutenberg/pull/75499#discussion_r2802806730
Path: packages/components/src/text/utils.ts
...
The `FindAllArgs` type is already imported, let's use the imported name.

### Review thread 6

#### jsnajdr on 2026-02-13T08:04:03Z

URL: https://github.com/WordPress/gutenberg/pull/75499#discussion_r2802834007
Path: packages/eslint-plugin/configs/jsdoc.js
...
This is a tiny but important change. It tells ESLint to report unqualified usage of `JSX` as error, and respect the global `React` namespace. That makes ESLint check the types the same way as TypeScript would do.

## Changed files

- packages/block-editor/README.md (MODIFIED, +3/-3)
- packages/block-editor/src/components/autocomplete/index.js (MODIFIED, +1/-1)
...
- packages/block-editor/src/components/block-draggable/dropping-insertion-point.native.js (MODIFIED, +1/-1)
- packages/block-editor/src/components/block-draggable/index.native.js (MODIFIED, +9/-9)
- packages/block-editor/src/components/block-heading-level-dropdown/heading-level-icon.js (MODIFIED, +1/-1)
- packages/block-editor/src/components/block-heading-level-dropdown/index.js (MODIFIED, +1/-1)
- packages/block-editor/src/components/block-heading-level-dropdown/index.native.js (MODIFIED, +1/-1)
...
- packages/block-editor/src/components/block-toolbar/pattern-overrides-dropdown.js (MODIFIED, +7/-7)
- packages/block-editor/src/components/block-visibility/modal.js (MODIFIED, +1/-1)
...
- packages/block-editor/src/components/iframe/index.js (MODIFIED, +1/-1)
- packages/block-editor/src/components/iframe/use-scale-canvas.js (MODIFIED, +2/-2)
...
- packages/block-editor/src/components/list-view/index.js (MODIFIED, +2/-2)
...
- packages/block-editor/src/components/use-on-block-drop/index.js (MODIFIED, +1/-1)
- packages/block-editor/src/hooks/block-style-variation.js (MODIFIED, +2/-2)
- packages/block-editor/src/hooks/fit-text.js (MODIFIED, +8/-8)
...
- packages/block-library/src/navigation/edit/index.js (MODIFIED, +1/-1)
...
- packages/block-library/src/navigation/edit/overlay-panel.js (MODIFIED, +1/-1)
- packages/block-library/src/navigation/edit/overlay-preview.js (MODIFIED, +1/-1)
- packages/block-library/src/navigation/edit/overlay-template-part-selector.js (MODIFIED, +1/-1)
...
- packages/block-library/src/tab/add-tab-toolbar-control.js (MODIFIED, +1/-1)
- packages/block-library/src/tab/remove-tab-toolbar-control.js (MODIFIED, +1/-1)
...
- packages/compose/README.md (MODIFIED, +8/-8)
- packages/compose/src/hooks/use-constrained-tabbing/index.js (MODIFIED, +1/-1)
- packages/compose/src/hooks/use-copy-on-click/index.js (MODIFIED, +5/-5)
- packages/compose/src/hooks/use-copy-to-clipboard/index.js (MODIFIED, +2/-2)
...
- packages/compose/src/hooks/use-focus-on-mount/index.js (MODIFIED, +2/-2)
- packages/compose/src/hooks/use-focus-outside/index.native.js (MODIFIED, +3/-3)
...
- packages/compose/src/hooks/use-merge-refs/index.js (MODIFIED, +7/-8)
- packages/data/src/components/with-dispatch/index.js (MODIFIED, +1/-1)
- packages/data/src/components/with-select/index.js (MODIFIED, +1/-1)
- packages/edit-site/src/components/page-templates/hooks.js (MODIFIED, +7/-7)
- packages/editor/README.md (MODIFIED, +1/-1)
- packages/editor/src/components/autocompleters/user.js (MODIFIED, +1/-1)
- packages/editor/src/components/editor-history/redo.js (MODIFIED, +1/-1)
- packages/editor/src/components/editor-history/undo.js (MODIFIED, +1/-1)
- packages/editor/src/components/global-styles/menu.js (MODIFIED, +1/-1)
- packages/editor/src/components/header/header-skeleton.js (MODIFIED, +6/-6)
- packages/editor/src/components/post-revisions-preview/diff-markers.js (MODIFIED, +1/-1)
- packages/editor/src/components/post-revisions-preview/revisions-canvas.js (MODIFIED, +1/-1)
- packages/editor/src/components/post-revisions-preview/revisions-header.js (MODIFIED, +1/-1)
- packages/editor/src/components/post-revisions-preview/revisions-slider.js (MODIFIED, +1/-1)
- packages/editor/src/components/post-saved-state/index.js (MODIFIED, +1/-1)
- packages/editor/src/components/styles-canvas/index.js (MODIFIED, +1/-1)
- packages/editor/src/components/styles-canvas/revisions.js (MODIFIED, +4/-4)
- packages/editor/src/components/styles-canvas/style-book.js (MODIFIED, +5/-5)
- packages/editor/src/components/visual-editor/edit-template-blocks-notification.js (MODIFIED, +3/-3)
- packages/editor/src/hooks/navigation-link-view-button.js (MODIFIED, +1/-1)
- packages/editor/src/hooks/template-part-navigation-edit-button.js (MODIFIED, +1/-1)
- packages/element/README.md (MODIFIED, +2/-2)
- packages/element/src/react-platform.ts (MODIFIED, +4/-4)
- packages/element/src/serialize.ts (MODIFIED, +1/-1)
- packages/eslint-plugin/configs/jsdoc.js (MODIFIED, +1/-1)
- packages/fields/README.md (MODIFIED, +1/-1)
- packages/fields/src/components/media-edit/index.tsx (MODIFIED, +1/-1)
- packages/format-library/src/link/utils.js (MODIFIED, +2/-3)
- packages/interface/src/components/complementary-area-toggle/index.js (MODIFIED, +1/-1)
- packages/patterns/src/components/pattern-convert-button.js (MODIFIED, +1/-1)
- packages/primitives/src/svg/index.js (MODIFIED, +25/-25)
- packages/reusable-blocks/src/components/reusable-blocks-menu-items/reusable-block-convert-button.js (MODIFIED, +1/-1)
- packages/server-side-render/README.md (MODIFIED, +1/-1)
- packages/server-side-render/src/server-side-render.js (MODIFIED, +1/-1)
- packages/workflow/src/components/workflow-menu.js (MODIFIED, +1/-1)
- test/native/integration-test-helpers/initialize-editor.js (MODIFIED, +5/-5)
