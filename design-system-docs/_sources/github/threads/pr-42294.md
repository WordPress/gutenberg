...
type: pull_request
state: CLOSED
url: https://github.com/WordPress/gutenberg/pull/42294
matched_labels: ["[Package] Components"]
all_labels: ["[Package] Components"]
---

# PR #42294: Placeholder: Add a box-sizing border-box to input fields

- URL: https://github.com/WordPress/gutenberg/pull/42294
- Author: t-hamano
- Created: 2022-07-10T13:02:24Z
- Updated: 2023-11-26T10:28:38Z
- Comments: 5 of 5
- Review threads: 0 of 0
- Changed files: 1 of 1
- Diff: ../pr-diffs/42294.diff
...
### github-actions on 2022-07-10T13:09:45Z

URL: https://github.com/WordPress/gutenberg/pull/42294#issuecomment-1179726229
...
| :--- | :---: | :---: |
| `build/components/style-rtl.css` | 14.1 kB | +22 B (0%) |
| `build/components/style.css` | 14.1 kB | +22 B (0%) |
...
### t-hamano on 2022-07-14T11:46:33Z

URL: https://github.com/WordPress/gutenberg/pull/42294#issuecomment-1184349620

> I think a good place to start with this PR is to @include the reset mixin at the top level of .components-placeholder. What do you think?


I agree with you.
If we can apply `box-sizing:border-box` to the entire `Placeholder` component, we can cover not only the input element in this case but other elements as well.

But `@include reset` is used only in broader areas such as [edit-post](https://github.com/WordPress/gutenberg/blob/d48b6bb7f2324db82ac6d3bc87b9a71e542d107f/packages/edit-post/src/style.scss#L62-L71) and [edit-site](https://github.com/WordPress/gutenberg/blob/d48b6bb7f2324db82ac6d3bc87b9a71e542d107f/packages/edit-site/src/style.scss#L34-L38), and there is no component that has this mixin.
So I am concerned about whether it is safe to casually introduce this mix-in into the component.

It might be better to discuss how to handle `box-sizing` in components a bit more in #42415 before handling this PR. 🤔

### mirka on 2022-08-02T10:20:13Z

URL: https://github.com/WordPress/gutenberg/pull/42294#issuecomment-1202297342

## ⭐ Update

- We added a global CSS switcher to the Storybook (#42747) which should help us catch these `forms.css` issues more easily in development.
- I am proposing a batch fix on all BaseControl-based components, which should also fix the TextControl/TextareaControl problem (not just in Placeholder or Site Editor but everywhere) 👉 #42889

### t-hamano on 2022-08-02T11:10:15Z

URL: https://github.com/WordPress/gutenberg/pull/42294#issuecomment-1202343040

@mirka
Thanks for the great update !
I think #42889 will fundamentally solve the problems mentioned in this PR.

I will close this PR after #42889 is done, and hope to address the other `Placeholder` issues mentioned in #41961.

### t-hamano on 2022-08-03T05:48:06Z

URL: https://github.com/WordPress/gutenberg/pull/42294#issuecomment-1203511559
...
- packages/components/src/placeholder/style.scss (MODIFIED, +5/-0)
