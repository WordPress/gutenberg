...
type: pull_request
state: MERGED
merged_at: 2022-06-22T19:42:16Z
url: https://github.com/WordPress/gutenberg/pull/41850
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Enhancement","[Feature] UI Components","[Type] Code Quality","[Package] Components"]
---

# PR #41850: VStack: Convert component to TypeScript

- URL: https://github.com/WordPress/gutenberg/pull/41850
- Author: walbo
- Created: 2022-06-21T21:59:46Z
- Updated: 2022-06-22T19:42:41Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 9 of 9
- Diff: ../pr-diffs/41850.diff
...
## What?
Converts the `VStack` component to TypeScript.

## Why?
Part of the @wordpress/components's TypeScript migration (https://github.com/WordPress/gutenberg/issues/35744).

## How?
- Refactors the current `VStack` to TypeScript.

## Testing Instructions
1. Run npm run dev and ensure no typing errors
3. Test the various v-stack within the block/site editors in Gutenberg still work

## Issue comments

### github-actions on 2022-06-21T22:08:14Z

URL: https://github.com/WordPress/gutenberg/pull/41850#issuecomment-1162413649
...
| `build/block-editor/index.min.js` | 152 kB | +579 B (0%) |  |
...
### walbo on 2022-06-22T19:15:06Z

URL: https://github.com/WordPress/gutenberg/pull/41850#issuecomment-1163508175
...
- packages/components/src/v-stack/README.md (MODIFIED, +6/-18)
- packages/components/src/v-stack/component.tsx (RENAMED, +15/-10)
- packages/components/src/v-stack/hook.ts (RENAMED, +5/-6)
- packages/components/src/v-stack/index.ts (RENAMED, +0/-0)
- packages/components/src/v-stack/stories/index.tsx (ADDED, +41/-0)
- packages/components/src/v-stack/test/__snapshots__/index.tsx.snap (RENAMED, +0/-0)
- packages/components/src/v-stack/test/index.tsx (RENAMED, +0/-0)
- packages/components/src/v-stack/types.ts (MODIFIED, +21/-1)
