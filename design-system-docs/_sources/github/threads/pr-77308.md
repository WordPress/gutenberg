...
type: pull_request
state: MERGED
merged_at: 2026-04-14T12:58:28Z
url: https://github.com/WordPress/gutenberg/pull/77308
matched_labels: ["[Package] UI"]
all_labels: ["[Type] Enhancement","[Package] UI"]
---

# PR #77308: UI: Update `@base-ui/react` from `1.3.0` to `1.4.0`

- URL: https://github.com/WordPress/gutenberg/pull/77308
- Author: ciampo
- Created: 2026-04-14T09:36:45Z
- Updated: 2026-04-14T13:01:04Z
- Comments: 3 of 3
- Review threads: 3 of 3
- Changed files: 7 of 7
- Diff: ../pr-diffs/77308.diff
...
### github-actions on 2026-04-14T09:36:58Z

URL: https://github.com/WordPress/gutenberg/pull/77308#issuecomment-4242870746
...
### github-actions on 2026-04-14T10:46:54Z

URL: https://github.com/WordPress/gutenberg/pull/77308#issuecomment-4243279627

**Size Change:** +527 B (+0.01%) 
...
| :--- | :---: | :---: |
| `build/modules/boot/index.min.js` | 17 kB | +94 B (+0.55%) |
| `build/scripts/block-editor/index.min.js` | 340 kB | +118 B (+0.03%) |
| `build/scripts/edit-site/index.min.js` | 262 kB | +94 B (+0.04%) |
| `build/scripts/editor/index.min.js` | 412 kB | +144 B (+0.03%) |
| `build/scripts/media-utils/index.min.js` | 77.6 kB | +77 B (+0.1%) |
...
### github-actions on 2026-04-14T11:42:56Z

URL: https://github.com/WordPress/gutenberg/pull/77308#issuecomment-4243594884

<!-- flaky-tests-report-comment -->
**Flaky tests detected in ecff64cb92bd9af30fe081050da7dc61d8382668.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/24397544491
📝  Reported issues:
...
#### ciampo on 2026-04-14T10:25:46Z

URL: https://github.com/WordPress/gutenberg/pull/77308#discussion_r3078776774
Path: packages/ui/src/utils/types.ts
...
#### ciampo on 2026-04-14T10:37:43Z

URL: https://github.com/WordPress/gutenberg/pull/77308#discussion_r3078835521
Path: packages/ui/src/form/primitives/select/types.ts

Changes here are related to the same `style` type change from the previous commit.

Not sure if we should refactor to use `ComponentProps` instead?

#### mirka on 2026-04-14T11:47:13Z

URL: https://github.com/WordPress/gutenberg/pull/77308#discussion_r3079183455
Path: packages/ui/src/form/primitives/select/types.ts

Agree, let's refactor to `ComponentProps`.

### Review thread 3 (resolved)

#### mirka on 2026-04-14T11:46:32Z

URL: https://github.com/WordPress/gutenberg/pull/77308#discussion_r3079180002
Path: packages/ui/src/utils/types.ts
...
I'm noticing that maybe this should read "to the **element**" rather than "to the component". (Same with the `className` description)

## Changed files

- package-lock.json (MODIFIED, +15/-14)
...
- packages/ui/src/form/primitives/select/types.ts (MODIFIED, +9/-4)
