...
type: pull_request
state: MERGED
merged_at: 2022-03-11T06:59:23Z
url: https://github.com/WordPress/gutenberg/pull/39345
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #39345: [Components - ToggleGroupControlOption]: Calculate width from button content and remove `LabelPlaceholderView`

- URL: https://github.com/WordPress/gutenberg/pull/39345
- Author: ntsekouras
- Created: 2022-03-10T11:14:14Z
- Updated: 2022-03-11T08:31:08Z
- Comments: 3 of 3
- Review threads: 0 of 0
- Changed files: 5 of 5
- Diff: ../pr-diffs/39345.diff
...
### github-actions on 2022-03-10T11:47:14Z

URL: https://github.com/WordPress/gutenberg/pull/39345#issuecomment-1063970701
...
| :--- | :---: | :---: |
| `build/components/index.min.js` | 217 kB | -53 B (0%) |
...
### ntsekouras on 2022-03-11T06:59:11Z

URL: https://github.com/WordPress/gutenberg/pull/39345#issuecomment-1064829849
...
I think this was just code written quite a long time ago, as part of the initial creation of g2 components and was ported this way. Similar case would be the aspectRatio component that it turned out [we didn't need at all](https://github.com/WordPress/gutenberg/pull/33603#issuecomment-885785158) right now.

>This is probably caused by the fact that the placeholder view (which was deleted in this PR) had font-weight: bold; among its styles, which consequently made its text take more horizontal space — although I don't see it as an issue.

Right! If we want to tweak some styles there we should do it in the visible label and actually I think we discuss this in the `icons` PR I'm going to make, because we also have some padding right now.

>I had also concluded the same and removed it in a stale [draft PR](https://github.com/WordPress/gutenberg/pull/34945)

💯

### gziolo on 2022-03-11T08:31:03Z

URL: https://github.com/WordPress/gutenberg/pull/39345#issuecomment-1064887764
...
- packages/components/src/font-size-picker/test/index.js (MODIFIED, +0/-2)
- packages/components/src/toggle-group-control/test/__snapshots__/index.js.snap (MODIFIED, +0/-27)
- packages/components/src/toggle-group-control/toggle-group-control-option/component.tsx (MODIFIED, +1/-4)
- packages/components/src/toggle-group-control/toggle-group-control-option/styles.ts (MODIFIED, +0/-12)
