...
type: pull_request
state: MERGED
merged_at: 2021-10-28T14:35:03Z
url: https://github.com/WordPress/gutenberg/pull/36017
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Bug","[Package] Components"]
---

# PR #36017: Fix color list picker spacing to accomodate the new color picker

- URL: https://github.com/WordPress/gutenberg/pull/36017
- Author: ajlende
- Created: 2021-10-28T01:39:48Z
- Updated: 2021-10-28T14:35:30Z
- Comments: 1 of 1
- Review threads: 0 of 0
- Changed files: 2 of 2
- Diff: ../pr-diffs/36017.diff
...
Adjusts the spacing for the ColorListPicker component due to the addition of the custom color selector in #35583
...
Include the changes from #36016 if it hasn't been merged yet.

The ColorListPicker is only used in the duotone toolbar.

## Screenshots <!-- if applicable -->

#### Before

![old-color-list-spacing](https://user-images.githubusercontent.com/5129775/139171434-c4d6b9f9-21a2-446a-a283-8f3421544a1e.png)

#### After

![new-color-list-spacing](https://user-images.githubusercontent.com/5129775/139171429-b4de57ae-adb3-4b18-b8be-5ae3d7806c19.png)
...
### github-actions on 2021-10-28T01:46:50Z

URL: https://github.com/WordPress/gutenberg/pull/36017#issuecomment-953434047
...
- packages/components/src/color-list-picker/index.js (MODIFIED, +1/-0)
- packages/components/src/color-list-picker/style.scss (MODIFIED, +4/-0)
