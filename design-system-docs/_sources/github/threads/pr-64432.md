...
type: pull_request
state: MERGED
merged_at: 2024-08-12T15:03:13Z
url: https://github.com/WordPress/gutenberg/pull/64432
matched_labels: ["Design System","[Package] Components"]
all_labels: ["[Type] Enhancement","[Package] Components","Design System"]
---

# PR #64432: Update DropdownMenuV2 elevation, remove unused config value

- URL: https://github.com/WordPress/gutenberg/pull/64432
- Author: jameskoster
- Created: 2024-08-12T09:02:17Z
- Updated: 2024-09-24T19:41:59Z
- Comments: 2 of 2
- Review threads: 0 of 0
- Changed files: 3 of 3
- Diff: ../pr-diffs/64432.diff
...
## What?
Updates `DropdownMenuV2` to use the new elevation scale. Removes subsequently unused and un-exported `popoverShadow` config value.

## Why?
Consistency moving forwards. Code tidiness.

## Testing Instructions
1. Open a menu like the layout switcher in data views
2. Notice there are no visual changes between this PR and trunk

### Note
Technically menus should use the new `elevationMedium`. This will be handled in a separate PR that seeks to update all components together.

## Issue comments

### github-actions on 2024-08-12T09:02:37Z

URL: https://github.com/WordPress/gutenberg/pull/64432#issuecomment-2283445393
...
### github-actions on 2024-08-12T09:13:18Z

URL: https://github.com/WordPress/gutenberg/pull/64432#issuecomment-2283466388
