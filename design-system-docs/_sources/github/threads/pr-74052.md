...
type: pull_request
state: MERGED
merged_at: 2025-12-17T09:39:45Z
url: https://github.com/WordPress/gutenberg/pull/74052
matched_labels: ["[Package] Components"]
all_labels: ["[Type] Code Quality","[Package] Components"]
---

# PR #74052: SelectControl: Deprecate bottom margin

- URL: https://github.com/WordPress/gutenberg/pull/74052
- Author: mirka
- Created: 2025-12-16T18:14:18Z
- Updated: 2025-12-17T09:40:31Z
- Comments: 3 of 3
- Review threads: 1 of 1
- Changed files: 60 of 60
- Diff: ../pr-diffs/74052.diff
...
### github-actions on 2025-12-16T18:14:30Z

URL: https://github.com/WordPress/gutenberg/pull/74052#issuecomment-3661810563
...
### github-actions on 2025-12-16T18:28:14Z

URL: https://github.com/WordPress/gutenberg/pull/74052#issuecomment-3661859732

**Size Change:** -369 B (-0.01%) 

**Total Size:** 2.58 MB

| Filename | Size | Change |
| :--- | :---: | :---: |
| `build/scripts/block-editor/index.min.js` | 317 kB | -14 B (0%) |
| `build/scripts/block-library/index.min.js` | 282 kB | -221 B (-0.08%) |
| `build/scripts/components/index.min.js` | 272 kB | -48 B (-0.02%) |
| `build/scripts/edit-site/index.min.js` | 240 kB | -26 B (-0.01%) |
| `build/scripts/editor/index.min.js` | 284 kB | -11 B (0%) |
| `build/scripts/format-library/index.min.js` | 10.8 kB | -16 B (-0.15%) |
| `build/scripts/media-utils/index.min.js` | 69.4 kB | -16 B (-0.02%) |
| `build/scripts/widgets/index.min.js` | 7.8 kB | -17 B (-0.22%) |
...
### github-actions on 2025-12-16T18:45:38Z

URL: https://github.com/WordPress/gutenberg/pull/74052#issuecomment-3661915202

<!-- flaky-tests-report-comment -->
**Flaky tests detected in 3f6fe88e96de7186f1089e15c4da77c04ba34b5e.**
...
🔍  Workflow run URL: https://github.com/WordPress/gutenberg/actions/runs/20278199704
📝  Reported issues:
...
#### mirka on 2025-12-16T18:18:52Z

URL: https://github.com/WordPress/gutenberg/pull/74052#discussion_r2624281720
...
The `@deprecated` type will now be included in `SelectControlSingleSelectionProps`.

## Changed files

- .eslintrc.js (MODIFIED, +1/-1)
- packages/block-editor/src/components/dimensions-tool/aspect-ratio-tool.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/html-element-control/index.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/image-size-control/index.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/inspector-controls/README.md (MODIFIED, +0/-1)
- packages/block-editor/src/components/resolution-tool/index.js (MODIFIED, +0/-1)
- packages/block-editor/src/components/responsive-block-control/test/index.js (MODIFIED, +0/-1)
- packages/block-library/src/archives/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/audio/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/categories/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/file/inspector.js (MODIFIED, +0/-1)
- packages/block-library/src/form/edit.js (MODIFIED, +0/-2)
- packages/block-library/src/gallery/edit.js (MODIFIED, +0/-5)
...
- packages/block-library/src/navigation/edit/overlay-template-part-selector.js (MODIFIED, +0/-1)
- packages/block-library/src/post-author/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/post-featured-image/dimension-controls.js (MODIFIED, +0/-1)
- packages/block-library/src/post-navigation-link/edit.js (MODIFIED, +0/-1)
- packages/block-library/src/query/edit/inspector-controls/index.js (MODIFIED, +0/-1)
- packages/block-library/src/query/edit/inspector-controls/order-control.js (MODIFIED, +0/-1)
- packages/block-library/src/query/edit/inspector-controls/sticky-control.js (MODIFIED, +0/-1)
- packages/block-library/src/search/edit.js (MODIFIED, +0/-2)
- packages/block-library/src/separator/edit.js (MODIFIED, +0/-1)
...
- packages/block-library/src/template-part/edit/import-controls.js (MODIFIED, +0/-1)
- packages/block-library/src/terms-query/edit/inspector-controls/order-control.js (MODIFIED, +0/-1)
- packages/block-library/src/terms-query/edit/inspector-controls/taxonomy-control.js (MODIFIED, +0/-1)
- packages/block-library/src/video/edit-common-settings.js (MODIFIED, +0/-1)
- packages/block-library/src/video/tracks-editor.js (MODIFIED, +0/-1)
- packages/components/CHANGELOG.md (MODIFIED, +1/-0)
- packages/components/src/color-picker/component.tsx (MODIFIED, +0/-1)
- packages/components/src/custom-gradient-picker/index.tsx (MODIFIED, +0/-1)
- packages/components/src/date-time/time/index.tsx (MODIFIED, +0/-1)
...
- packages/components/src/select-control/README.md (MODIFIED, +0/-11)
- packages/components/src/select-control/index.tsx (MODIFIED, +2/-4)
- packages/components/src/select-control/stories/index.story.tsx (MODIFIED, +0/-2)
- packages/components/src/select-control/test/select-control.tsx (MODIFIED, +1/-7)
- packages/components/src/select-control/types.ts (MODIFIED, +8/-1)
- packages/components/src/tree-select/index.tsx (MODIFIED, +0/-1)
- packages/components/src/tree-select/types.ts (MODIFIED, +1/-8)
- packages/components/src/validated-form-controls/components/select-control.tsx (MODIFIED, +1/-6)
- packages/dataviews/src/components/dataviews-filters/filter.tsx (MODIFIED, +0/-1)
- packages/dataviews/src/components/dataviews-pagination/index.tsx (MODIFIED, +0/-1)
- packages/dataviews/src/components/dataviews-view-config/index.tsx (MODIFIED, +0/-1)
- packages/dataviews/src/dataform-controls/select.tsx (MODIFIED, +0/-1)
- packages/dataviews/src/dataform-controls/utils/relative-date-control.tsx (MODIFIED, +0/-1)
- packages/editor/src/components/post-author/select.js (MODIFIED, +0/-1)
- packages/editor/src/components/post-template/classic-theme.js (MODIFIED, +0/-1)
- packages/format-library/src/language/index.js (MODIFIED, +0/-1)
- packages/global-styles-ui/src/font-library/font-collection.tsx (MODIFIED, +0/-2)
- packages/image-cropper/src/stories/index.story.tsx (MODIFIED, +0/-1)
- packages/widgets/src/blocks/legacy-widget/edit/widget-type-selector.js (MODIFIED, +0/-1)
