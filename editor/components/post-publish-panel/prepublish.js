...
function PostPublishPanelPrepublish( {
	...
	return (
		<div className="editor-post-publish-panel__prepublish">
			...
			<p>{ hasPublishAction ? __( 'Here, you can do a last-minute check up of your settings below, before you publish.' ) : __( 'Here, you can do a last-minute check up of your settings below, before you submit for review.' ) }</p>
			{ hasPublishAction && (
				<Fragment>
