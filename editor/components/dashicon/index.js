	...
	render() {
		...
		switch ( icon ) {
			...
			case 'editor-distractionfree':
				title = 'Editor Distractionfree';
				path = 'M7 8h6v4H7zM2 13v4h4l-1.2-1.2L7 12l-3.8 2.2M14 17h4v-4l-1.2 1.2L13 12l2.2 3.8M14 3l1.3 1.3L13 8l3.8-2.2L18 7V3M6 3H2v4l1.2-1.2L7 8 4.7 4.3"/></g></g></g></g></g><';
				break;
			case 'editor-help':
				title = 'Editor Help';
			...
			case 'insert':
				title = 'Insert';
				path = '"Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><title>Insert</title><g><style>.st0{fill:#565D66;}</style><path class="st0" d="M10 1c-5 0-9 4-9 9s4 9 9 9 9-4 9-9-4-9-9-9zm0 16c-3.9 0-7-3.1-7-7s3.1-7 7-7 7 3.1 7 7-3.1 7-7 7zm1-11H9v3H6v2h3v3h2v-3h3V9h-3V6z';
				break;
			case 'laptop':
				title = 'Laptop';
