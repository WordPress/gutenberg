...
import BlockConverterFromHTMLButton from './block-converter-from-html';
import BlockConverterFromUnknownButton from './block-converter-from-unknown';
				...
				<Dropdown
					...
					renderContent={ ( { onClose } ) => (
						...
						<NavigableMenu className="editor-block-settings-menu__content">
							...
							{ count === 1 && <BlockConverterFromUnknownButton uid={ firstBlockUID } role="menuitem" /> }
							{ count === 1 && <BlockConverterFromHTMLButton uid={ firstBlockUID } role="menuitem" /> }
