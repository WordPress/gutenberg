...
describe( 'msListConverter', () => {
	it( 'should convert unordered list', () => {
		...
		equal( deepFilter( input, [ msListConverter ] ), output );
	} );
	...
	it( 'should convert indented list', () => {
		...
		equal( deepFilter( input1 + input2 + input3, [ msListConverter ] ), output );
	} );
	...
	it( 'should convert deep indented list', () => {
		...
		equal( deepFilter( input1 + input2 + input3 + input4, [ msListConverter ] ), output );
	} );
} );
