...
class Tests_Blocks_Render_Playlist extends WP_UnitTestCase {
	 ...
	 * @covers ::render_block_core_playlist
	 */
	public function test_waveform_style_attribute_takes_precedence_over_style_class() {
		$markup = $this->build_playlist_markup(
			array(
				'className'     => 'waveform-style--mirror',
				'waveformStyle' => 'line',
			),
			array(
				array(
		...
		$context = json_decode( $p->get_attribute( 'data-wp-context' ), true );
		$this->assertSame( 'line', $context['waveformStyle'] );
	}

	/**
	 * @covers ::render_block_core_playlist
	 */
	public function test_waveform_style_falls_back_to_style_class() {
		$markup = $this->build_playlist_markup(
			array(
				'className' => 'custom-class waveform-style--mirror',
			),
			array(
				array(
					'id'    => 1,
	 ...
	 * @covers ::render_block_core_playlist
	 */
	public function test_waveform_style_ignores_unknown_style_class() {
		$markup = $this->build_playlist_markup(
			array(
				'className' => 'waveform-style--thin-line',
			),
			array(
				array(
					'id'    => 1,
