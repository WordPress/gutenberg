...
class Test_Render_Block_Core_Countdown extends WP_UnitTestCase {
	...
	/**
	 * Get attributes for the countdown block.
	 *
	 ...
	 *
	 * @param array  $attribute_overrides The attribute overrides.
	...
	/**
	 * Test that the countdown wrapper is rendered when not expired.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that the countdown defaults to one hour from now when the end time is empty.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that the show flags control which boxes are rendered.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that the appearance colors are applied to the boxes.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that the hide action renders nothing once expired.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that the hide action still renders before expiry.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that the none action keeps the timer visible at zero.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that the show message is hidden before expiry and visible after.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that the show message falls back to default text when empty.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that the show message escapes HTML in the action value.
	 *
	 * @covers ::render_block_core_countdown
	 */
	public function test_show_message_escapes_html_in_action_value() {
		...
		$output = $this->render(
			array(
				'endTime'     => $past,
				'actionOnEnd' => 'showMessage',
				'actionValue' => '<script>alert(1)</script>',
			)
		);
	...
	/**
	 * Test that the redirect is skipped in the admin context.
	 *
	 * @covers ::render_block_core_countdown
	 */
	public function test_redirect_is_skipped_in_admin_context() {
		...
		$output = $this->render(
			array(
				...
				'actionValue' => 'https://example.com/sale-over',
			)
		);
	...
	/**
	 * Test that the redirect is skipped for an invalid URL.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that the expired action fires only when expired.
	 *
	 * @covers ::render_block_core_countdown
	 */
	public function test_expired_action_fires_only_when_expired() {
		...
		$this->render(
			array(
				'endTime'     => gmdate( 'Y-m-d\TH:i:s', time() - MINUTE_IN_SECONDS ),
				'actionOnEnd' => 'showMessage',
			)
		);
	...
	/**
	 * Test that the expired action does not fire when hide short circuits.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that the expired action receives attributes and block instance.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that the end time is interpreted in the site timezone.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that the function uses real UTC now, not a shifted current time.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that the years box appears for long durations.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that the years box is absent for short durations.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that evergreen mode is never marked as expired on the server side.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that evergreen data attributes are present and consistent.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that the evergreen timer ID differs for different attributes.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that inner blocks render when revealOnEnd is true and the countdown is expired.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that inner blocks are absent when revealOnEnd is true and the countdown is not expired.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that inner blocks render when hideOnEnd is true and the countdown is not expired.
	 *
	 * @covers ::render_block_core_countdown
	 */
	public function test_inner_blocks_render_when_hide_on_end_and_not_expired() {
		...
		$output = $this->render(
			...
			'<p>Early bird content</p>'
		);
		$this->assertStringContainsString( 'Early bird content', $output );
	}

	/**
	 * Test that inner blocks are absent when hideOnEnd is true and the countdown is expired.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that no inner blocks markup is emitted when there is no content.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that evergreen mode strips inner blocks for security.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that data attributes are individually quoted.
	 *
	 * @covers ::render_block_core_countdown
	 */
	public function test_data_attributes_are_individually_quoted() {
		$output = $this->render(
			array(
				'actionOnEnd' => 'redirect',
				'actionValue' => 'https://example.com/?a=1&b=2',
			)
		);
	...
	/**
	 * Test that show flags are serialized as string booleans.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that the is_expired filter can force an expired state.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that the is_expired filter can force a not-expired state.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that the is_expired filter receives attributes and block.
	 *
	 * @covers ::render_block_core_countdown
	 */
	public function test_is_expired_filter_receives_attributes_and_block() {
		$received_attrs = null;
		$cb             = function ( $is_expired, $attributes ) use ( &$received_attrs ) {
	...
	/**
	 * Test that the end_time_ts filter overrides the displayed digits.
	 *
	 * @covers ::render_block_core_countdown
	 */
	public function test_end_time_ts_filter_overrides_displayed_digits() {
		add_filter(
			'core_countdown_end_time_ts',
			function () {
				return time() + 3665;
			}
		);
	...
	/**
	 * Test that the end_time_ts filter receives attributes and block.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that the is_expired filter forces a consistent data-end-time.
	 *
	 * @covers ::render_block_core_countdown
	 */
	...
	/**
	 * Test that the is_expired filter forces a consistent data-end-time even when naturally not expired.
	 *
	 * @covers ::render_block_core_countdown
	 */
