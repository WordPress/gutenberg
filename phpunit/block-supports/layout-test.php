	...
	public function data_gutenberg_get_layout_style() {
		return array(
			...
			'constrained layout with block gap support'    => array(
				...
				'expected_output' => '.wp-layout > *{margin-block-start:0;margin-block-end:0;}.wp-layout.wp-layout > * + *,.wp-layout.wp-layout .wp-block-group__inner-container > * + *{margin-block-start:2.5rem;margin-block-end:0;}',
			),
			...
			'constrained layout with block gap support and spacing preset' => array(
				...
				'expected_output' => '.wp-layout > *{margin-block-start:0;margin-block-end:0;}.wp-layout.wp-layout > * + *,.wp-layout.wp-layout .wp-block-group__inner-container > * + *{margin-block-start:var(--wp--preset--spacing--50);margin-block-end:0;}',
			),
