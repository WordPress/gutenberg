...
/**
 * Test WP_REST_Font_Families_Controller::get_item().
 *
 * @package WordPress
 * @subpackage Fonts
 *
 ...
 */
class WP_Test_REST_Font_Families_Controller_GetItem extends WP_Test_REST_Font_Families_Controller_UnitTestCase {

	/**
	 * Install fonts to test get item.
	 */
	...
	public function test_get_item() {
		$get_items_request = new WP_REST_Request( 'GET', '/wp/v2/font-families/piazzolla' );
