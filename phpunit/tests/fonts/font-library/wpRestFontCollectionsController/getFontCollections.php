<?php
/**
 * Test WP_REST_Font_Collections_Controller::get_font_collections().
 *
 * @package WordPress
 ...
 * @group font-library
 *
 * @covers WP_REST_Font_Collections_Controller::get_font_collections
 */

class Tests_Fonts_WPRESTFontCollectionsController_GetFontCollections extends WP_REST_Font_Collections_Controller_UnitTestCase {
