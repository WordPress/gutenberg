...
class Tests_Collaboration_EditorSettingsAutosaveDetails extends WP_UnitTestCase {
	 ...
	 */
	private function create_draft_with_autosave(): array {
	...
	public function test_adds_autosave_author_and_modified_time() {
		...
		$this->assertSame( self::$author_id, $settings['autosave']['authorId'] );
		$this->assertSame(
			(int) mysql2date( 'U', $autosave->post_modified_gmt, false ),
