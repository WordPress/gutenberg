...
class WP_Theme_JSON_Gutenberg_Test extends WP_UnitTestCase {
	...
	public function data_get_styles_for_block_with_style_variations() {
		$plain = array(
			...
			'styles'   => '.is-style-plain.wp-block-quote{background-color: hotpink;}',
		);

		$custom = array(
			'metadata' => array(
				'path'     => array( 'styles', 'blocks', 'core/quote', 'variations', 'custom' ),
				'selector' => '.is-style-custom.wp-block-quote',
			),
			'styles'   => '.is-style-custom.wp-block-quote{background-color: magenta;}',
		);
	...
	public function test_block_style_variations_from_block_styles_registry() {
