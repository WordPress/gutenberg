...
class WP_Theme_JSON_Gutenberg_Test extends WP_UnitTestCase {
	...
	public function test_get_stylesheet_handles_whitelisted_element_pseudo_selectors() {
		...
		$element_styles = 'a:where(:not(.wp-element-button)){background-color: red;color: green;}:root :where(a:where(:not(.wp-element-button)):hover){background-color: green;color: red;font-size: 10em;text-transform: uppercase;}:root :where(a:where(:not(.wp-element-button)):focus){background-color: black;color: yellow;}';
	...
	public function test_get_stylesheet_ignores_non_whitelisted_pseudo_selectors() {
		...
		$element_styles = 'a:where(:not(.wp-element-button)){background-color: red;color: green;}:root :where(a:where(:not(.wp-element-button)):hover){background-color: green;color: red;}';
	...
	public function test_get_stylesheet_handles_whitelisted_block_level_element_pseudo_selectors() {
		...
		$element_styles = 'a:where(:not(.wp-element-button)){background-color: red;color: green;}:root :where(a:where(:not(.wp-element-button)):hover){background-color: green;color: red;}:root :where(.wp-block-group a:where(:not(.wp-element-button)):hover){background-color: black;color: yellow;}';
	...
	public function test_get_property_value_valid() {
		...
		$color_styles = 'body{background-color: #ffffff;color: #000000;}:root :where(.wp-element-button, .wp-block-button__link){background-color: #000000;color: #ffffff;}';
	...
	public function test_get_property_value_loop() {
		...
		$color_styles = 'body{background-color: #ffffff;}:root :where(.wp-element-button, .wp-block-button__link){color: #ffffff;}';
		$expected     = static::$base_styles . $color_styles;
		$this->assertSame( $expected, $theme_json->get_stylesheet() );
	}
	...
	public function test_get_property_value_recursion() {
		...
		$color_styles = 'body{background-color: #ffffff;color: #ffffff;}:root :where(.wp-element-button, .wp-block-button__link){color: #ffffff;}';
		$expected     = static::$base_styles . $color_styles;
		$this->assertSame( $expected, $theme_json->get_stylesheet() );
	}
