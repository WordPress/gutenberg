...
class WP_Theme_JSON_Gutenberg_Test extends WP_UnitTestCase {
	...
	public function test_get_stylesheet_generates_fallback_gap_layout_styles( $layout_definitions ) {
		...
		// Results also include root site blocks styles.
		$this->assertEquals(
			'body {margin: 0;}.wp-site-blocks > .alignleft {float: left; margin-right: 2em;}.wp-site-blocks > .alignright {float: right; margin-left: 2em;}.wp-site-blocks > .aligncenter {justify-content: center; margin-left: auto; margin-right: auto;}body .is-layout-flex {gap: 0.5em; display: flex;flex-wrap: wrap; align-items: center;}body .is-layout-flow > .alignleft {float: left; margin-inline-start: 0; margin-inline-end: 2em;}body .is-layout-flow > .alignright {float: right; margin-inline-start: 2em; margin-inline-end: 0;}body .is-layout-flow > .aligncenter {margin-left: auto !important; margin-right: auto !important;}',
			$stylesheet
		);
	}
	...
	public function test_get_stylesheet_generates_base_fallback_gap_layout_styles( $layout_definitions ) {
		...
		$this->assertEquals(
			'body .is-layout-flex {gap: 0.5em; display: flex;flex-wrap: wrap; align-items: center;}body .is-layout-flow > .alignleft {float: left; margin-inline-start: 0; margin-inline-end: 2em;}body .is-layout-flow > .alignright {float: right; margin-inline-start: 2em; margin-inline-end: 0;}body .is-layout-flow > .aligncenter {margin-left: auto !important; margin-right: auto !important;}.wp-block-columns.is-layout-flex {gap: 2em;}',
			$stylesheet
		);
	}
	...
	function test_get_stylesheet_with_block_support_feature_level_selectors() {
		...
		$base_styles   = 'body {--wp--preset--color--green: green;margin: 0;}.wp-site-blocks > .alignleft {float: left; margin-right: 2em;}.wp-site-blocks > .alignright {float: right; margin-left: 2em;}.wp-site-blocks > .aligncenter {justify-content: center; margin-left: auto; margin-right: auto;}';
	...
	function test_get_styles_for_block_without_padding_aware_alignments() {
		...
		$expected = 'body {margin: 0; padding-top: 10px; padding-right: 12px; padding-bottom: 10px; padding-left: 12px;}.wp-site-blocks > .alignleft {float: left; margin-right: 2em;}.wp-site-blocks > .alignright {float: right; margin-left: 2em;}.wp-site-blocks > .aligncenter {justify-content: center; margin-left: auto; margin-right: auto;}';
		$this->assertEquals( $expected, $theme_json->get_styles_for_block( $metadata ) );
	}
}
