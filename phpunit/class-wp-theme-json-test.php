...
class WP_Theme_JSON_Gutenberg_Test extends WP_UnitTestCase {
	...
	public function test_get_stylesheet_allows_current_item() {

		$expected_background_value = 'blue';
		$expected_text_value       = 'yellow';
		...
		// Replace the $base_styles with an empty string to make the assertion easier.
		$actual = str_replace( $base_styles, '', $generated );
