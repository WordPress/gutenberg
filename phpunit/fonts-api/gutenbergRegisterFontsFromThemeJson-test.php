...
/**
 * Test WP_Fonts_Theme_Json_Handler::register_fonts_from_theme_json().
 *
 * @package WordPress
...
class Tests_Fonts_RegisterFontsFromThemeJson extends WP_Fonts_TestCase {
	...
	public function test_should_bails_out_when_no_fonts_defined() {
		...
		WP_Fonts_Theme_Json_Handler::register_fonts_from_theme_json();
		$wp_fonts = wp_fonts();
	...
	/**
	 * Tests that WP_Fonts_Theme_Json_Handler::register_fonts_from_theme_json() skips fonts that are already registered
	 ...
	 * it checks if the WP_Fonts_Theme_Json_Handler::register_fonts_from_theme_json() enqueued the font. If no, then
	...
	public function test_should_skip_registered_fonts() {
		...
		$this->assertEmpty( wp_fonts()->get_enqueued(), 'No fonts should be enqueued before running WP_Fonts_Theme_Json_Handler::register_fonts_from_theme_json()' );
	...
	public function test_should_skip_when_font_face_not_defined() {
		 ...
		 * This callback is invoked at the start of WP_Fonts_Theme_Json_Handler::register_fonts_from_theme_json() before processing
