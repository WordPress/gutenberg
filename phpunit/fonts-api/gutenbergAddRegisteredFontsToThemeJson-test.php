...
/**
 * Test WP_Fonts_Theme_Json_Handler::add_registered_fonts_to_theme_json().
 *
 * @package WordPress
...
class Tests_Fonts_GutenbergAddRegisteredFontsToThemeJson extends WP_Fonts_TestCase {
	...
	public function test_should_return_instance( $theme ) {
		...
		$actual = WP_Fonts_Theme_Json_Handler::add_registered_fonts_to_theme_json( $data );
	...
	public function test_should_add_non_theme_json_fonts( $theme, $fonts, $expected ) {
		...
		$this->assertContains(
			...
			'Fonts should be added after running WP_Fonts_Theme_Json_Handler::add_registered_fonts_to_theme_json()'
		);
	}
