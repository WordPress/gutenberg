 ...
 */
class Tests_Fonts_WpWebfonts_RegisterWebfont extends WP_Fonts_TestCase {
	...
	public function test_should_register_webfont( array $input, $expected ) {
		$this->assertSame( $expected['register_webfont'], wp_fonts()->register_webfont( ...$input ), 'Font-family handle should be returned' );
	...
	public function data_should_register_webfont() {
		return array(
			...
			'No font family handle but has variation handles' => array(
				'input'    => array(
					array(
						'font-family' => 'Merriweather',
						'font-style'  => 'italic',
