...
class Tests_Webfonts_WpWebfonts_AddVariation extends WP_Webfonts_TestCase {
	 ...
	 * @param string      $variation_handle   Optional. The variation's handle.
	 */
	public function test_add_variation_when_already_registered( $expected, $font_family_handle, array $variation, $variation_handle = '' ) {
		$wp_webfonts = new WP_Webfonts();
		$wp_webfonts->add( $font_family_handle, false );
	 ...
	 * @param string      $variation_handle   Optional. The variation's handle.
	 */
	public function test_add_variation_registers_font_family( $expected, $font_family_handle, array $variation, $variation_handle = '' ) {
		$wp_webfonts = new WP_Webfonts();
	 ...
	 * @param array  $variation          An array of variation properties to add.
	 */
	public function test_add_variation_should_not_register_font_family_or_variant( $font_family_handle, array $variation ) {
		$this->expectNotice();
	 ...
	 */
	public function test_add_variation_should_not_register_variation_when_font_family_not_defined( $font_family_handle, array $variation, $expected_message ) {
		$this->expectNotice();
	 ...
	 * @param array  $variation          An array of variation properties to add.
	 */
	public function test_add_variation_should_register_font_family_when_variant_fails_to_register( $font_family_handle, array $variation ) {
		$this->expectNotice();
