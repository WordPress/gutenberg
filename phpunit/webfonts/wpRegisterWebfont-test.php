...
class Tests_Webfonts_WpRegisterWebfont extends WP_Webfonts_TestCase {
	 ...
	 * @param array  $expected           Expected results.
	 */
	public function test_register( $font_family_handle, array $variation, $expected ) {
	 ...
	 * @param array $expected  Expected results.
	 */
	public function test_registers_font_family( array $variation, $expected ) {
	 ...
	 * @param array $expected  Expected results.
	 */
	public function test_registers_font_family_with_deprecated_structure(
		array $variation, $expected
	) {
		$font_family_handle = $expected[0];
	 ...
	 * @return array
	 */
	public function data_register_with_deprecated_structure() {
		return array(
	 ...
	 * @param string $font_family_handle Font family for this variation.
	 * @param array  $variation          Web font to test.
	 * @param string $expected_meessage  Expected notice message.
	 */
	public function test_font_family_registration_fails( $font_family_handle, array $variation, $expected_meessage ) {
		$this->expectNotice();
		$this->expectNoticeMessage( $expected_meessage );
