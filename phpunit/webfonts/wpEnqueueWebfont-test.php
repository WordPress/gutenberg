...
class Tests_Webfonts_WpEnqueueWebfont extends WP_Webfonts_TestCase {
	 ...
	 */
	public function test_enqueue_after_registration( $font_family, array $expected ) {
	 ...
	 */
	public function test_enqueue_before_registration( $font_family, array $not_used, array $expected ) {
		wp_enqueue_webfont( $font_family );
