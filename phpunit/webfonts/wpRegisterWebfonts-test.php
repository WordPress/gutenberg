...
class Tests_Webfonts_WpRegisterWebfonts extends WP_Webfonts_TestCase {
	 ...
	 */
	public function test_register( array $webfonts, array $expected ) {
	 ...
	 * @param array $expected Expected results.
	 */
	public function test_register_with_deprecated_structure( array $webfonts, array $expected ) {
		$this->expectNotice();
	 ...
	 * @param array $webfonts Array of webfonts to test.
	 */
	public function test_web_fonts_do_not_enqueue_on_registration( array $webfonts ) {
