 ...
 * wp_insert_post_data for wp_user_post_type records.
 * See lib/experimental/content-types/post-types.php.
 *
 ...
 * @package gutenberg
 *
 * @covers ::gutenberg_filter_user_post_type_post_content
 */
class User_Post_Type_Content_Filter_Test extends WP_UnitTestCase {
	...
	/**
	 * Inserting a wp_user_post_type record via wp_insert_post strips HTML from
	 ...
	 */
	public function test_strips_html_in_post_type_post() {
	...
	/**
	 * Non-JSON post_content on a wp_user_post_type record is normalized to
	...
	public function test_normalizes_non_json_payload_to_marker_only() {
		...
		$this->assertSame(
			array( GUTENBERG_USER_POST_TYPE_CONFIG_MARKER => true ),
