...
class Gutenberg_Content_Guidelines_Revisions_Controller_Test extends WP_UnitTestCase {
	 ...
	 * boots the REST server early. In that window the `wp_knowledge`
	 ...
	 *
	 * The handler in lib/experimental/knowledge/index.php must defend
	...
	public function test_rest_api_init_does_not_fatal_when_post_type_not_yet_registered() {
		unregister_post_type( Gutenberg_Knowledge_Post_Type::POST_TYPE );
		$this->assertFalse(
			post_type_exists( Gutenberg_Knowledge_Post_Type::POST_TYPE ),
