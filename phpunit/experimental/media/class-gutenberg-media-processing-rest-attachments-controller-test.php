...
/**
 * @coversDefaultClass \Gutenberg_Media_Processing_REST_Attachments_Controller
 */
class Gutenberg_Media_Processing_REST_Attachments_Controller_Test extends WP_Test_REST_Post_Type_Controller_Testcase {
	/**
