...
class Gutenberg_Icons_Registry_7_1_Test extends WP_UnitTestCase {
	...
	public function data_sanitize_icon_content() {
		return array(
			// Correctly extracts the SVG element.
			...
			'strips foreignObject and html inside' => array(
				'<svg xmlns="http://www.w3.org/2000/svg"><foreignObject><p>paragraph content</p></foreignObject><path d="M0 0h24v24H0z" /></svg>',
			...
			// Valid SVG elements and attributes are preserved.
