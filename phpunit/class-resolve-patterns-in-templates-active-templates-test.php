<?php
/**
 * Tests for pattern block resolution in templates via REST API when active_templates experiment is enabled.
 *
 * @package gutenberg
 *
 * @group rest-api
 ...
 */
class Tests_Resolve_Patterns_In_Templates_Active_Templates extends WP_Test_REST_Controller_Testcase {
	...
	public function set_up() {
		...
		// Enable the active_templates experiment.
	...
	public function tear_down() {
		// Disable the active_templates experiment.
	...
	/**
	 * Test that pattern blocks are resolved when fetching a single template via REST API with active_templates enabled.
	 */
	...
	/**
	 * Test that pattern blocks are resolved when fetching multiple templates via REST API with active_templates enabled.
	 */
	...
	/**
	 * Test that pattern blocks are resolved when fetching a single template part via REST API with active_templates enabled.
	 */
	...
	/**
	 * Test that pattern blocks are resolved when fetching multiple template parts via REST API with active_templates enabled.
	 */
