	...
	public function data_sanitize_inline_svg() {
		...
		return array(
			...
			'preserves fill and clip rules on svg'         => array(
				'<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" fill-rule="evenodd" clip-rule="evenodd"><path d="M0 0" /></svg>',
				'<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" fill-rule="evenodd" clip-rule="evenodd"><path d="M0 0" /></svg>',
			),
			'preserves stroke attributes and style on svg' => array(
				'<svg xmlns="http://www.w3.org/2000/svg" style="fill: none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" vector-effect="non-scaling-stroke"><path d="M0 0" /></svg>',
				'<svg xmlns="http://www.w3.org/2000/svg" style="fill: none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" vector-effect="non-scaling-stroke"><path d="M0 0" /></svg>',
			),
			'preserves clip rule, opacity and stroke on path' => array(
				'<svg xmlns="http://www.w3.org/2000/svg"><path d="M0 0" fill-rule="evenodd" clip-rule="evenodd" opacity="0.4" style="fill: none" stroke="currentColor" vector-effect="non-scaling-stroke" /></svg>',
				'<svg xmlns="http://www.w3.org/2000/svg"><path d="M0 0" fill-rule="evenodd" clip-rule="evenodd" opacity="0.4" style="fill: none" stroke="currentColor" vector-effect="non-scaling-stroke" /></svg>',
			),
			'preserves clip rule and stroke on polygon'    => array(
				'<svg xmlns="http://www.w3.org/2000/svg"><polygon points="0,0 1,1" clip-rule="evenodd" stroke="currentColor" vector-effect="non-scaling-stroke" /></svg>',
				'<svg xmlns="http://www.w3.org/2000/svg"><polygon points="0,0 1,1" clip-rule="evenodd" stroke="currentColor" vector-effect="non-scaling-stroke" /></svg>',
			),
			'preserves presentation attributes on rect'    => array(
				'<svg xmlns="http://www.w3.org/2000/svg"><rect x="4" y="5" width="16" height="14" rx="2" ry="2" fill="currentColor" stroke="currentColor" transform="rotate(45)" vector-effect="non-scaling-stroke" /></svg>',
				'<svg xmlns="http://www.w3.org/2000/svg"><rect x="4" y="5" width="16" height="14" rx="2" ry="2" fill="currentColor" stroke="currentColor" transform="rotate(45)" vector-effect="non-scaling-stroke" /></svg>',
			),
			'preserves presentation attributes on circle'  => array(
				'<svg xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="3" fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" transform="rotate(45)" vector-effect="non-scaling-stroke" /></svg>',
				'<svg xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="3" fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" transform="rotate(45)" vector-effect="non-scaling-stroke" /></svg>',
			),
