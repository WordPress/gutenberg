...
export default dedupePlugins( [
	// Global ignores (replaces .eslintignore).
	{
		ignores: [
			...
			// Standalone dev script for regenerating the JXL e2e fixtures. It
			// is not in the test/e2e TypeScript project that the typed e2e
			// lint rules parse against.
			'test/e2e/assets/.gen-jxl-fidelity-fixtures.mjs',
			'**/vendor/**',
