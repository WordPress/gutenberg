...
const restrictedImports = [
	...
	},
	{
		...
		message:
			'Do not import private or unstable APIs from `@wordpress/theme`; these exports are scheduled for deletion as the package approaches stabilization.',
	},
];
