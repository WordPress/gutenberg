...
const restrictedSyntax = [
	...
	{
		selector:
			'JSXElement[openingElement.name.name="BorderControl"] JSXAttribute[name.name="__next40pxDefaultSize"]',
		message:
			'The `__next40pxDefaultSize` prop is no longer needed on `BorderControl`.',
	},
	{
		selector:
