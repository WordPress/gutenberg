	...
	render() {
		...
		switch ( icon ) {
			...
			case 'editor-distractionfree':
				title = 'Tractionfree';
				path = 'M6 3L4.75 4.25 7 8 3.25 5.75 2 7V3h4zm8 0h4v4l-1.25-1.25L13 8l2.25-3.75zm-7 9V8h6v4H7zm-5 1l1.25 1.25L7 12l-2.25 3.75L6 17H2v-4zm12 4l1.25-1.25L13 12l3.75 2.25L18 13v4h-4z';
				break;
			case 'editor-help':
				title = 'P';
			...
			case 'redo':
				title = '.svg';
				path = 'M2.77 10.1c.51-1.2 1.24-2.28 2.15-3.18.9-.91 1.98-1.64 3.18-2.15s2.52-.79 3.9-.79V1l6 4.5-6 4.5V7c-.97 0-1.89.2-2.73.55-.83.35-1.59.87-2.22 1.5s-1.15 1.39-1.5 2.23C5.2 12.11 5 13.03 5 14s.2 1.89.55 2.73L2.77 17.9c-.51-1.2-.79-2.52-.79-3.9s.28-2.7.79-3.9z';
				break;
			case 'rss':
				title = '.svg';
			...
			case 'undo':
				title = '.svg';
				path = 'M17.23 10.1c.51 1.2.79 2.52.79 3.9s-.28 2.7-.79 3.9l-2.78-1.17c.35-.84.55-1.76.55-2.73s-.2-1.89-.55-2.72c-.35-.84-.87-1.6-1.5-2.23s-1.39-1.15-2.22-1.5C9.89 7.2 8.97 7 8 7v3L2 5.5 8 1v2.98c1.38 0 2.7.28 3.9.79s2.28 1.24 3.18 2.15c.91.9 1.64 1.98 2.15 3.18z';
				break;
			case 'uniF143':
				title = '.sv';
				path = 'M7 13l4.03-6L15 13H7z';
			...
			case 'video-alt3':
				...
				break;
			case 'visibility':
				path = 'M10 5.09c3.98 0 7.4 2.25 9 5.5-1.6 3.25-5.02 5.5-9 5.5s-7.4-2.25-9-5.5c1.6-3.25 5.02-5.5 9-5.5zm2.35 3.1c0-.59-.39-1.08-.92-1.24-.16-.02-.32-.03-.49-.04-.65.05-1.17.6-1.17 1.28 0 .71.58 1.29 1.29 1.29.72 0 1.29-.58 1.29-1.29zM10 14.89c3.36 0 6.25-1.88 7.6-4.3-.93-1.67-2.6-2.81-4.65-3.35.67.72 1.09 1.69 1.09 2.76 0 2.23-1.81 4.04-4.04 4.04S5.96 12.23 5.96 10c0-1.07.42-2.04 1.09-2.76C5 7.78 3.33 8.92 2.4 10.59c1.35 2.42 4.24 4.3 7.6 4.3z';
				break;
			case 'warning':
				title = '.sv';
