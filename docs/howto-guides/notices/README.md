...
Check out the [_Loading JavaScript_](/docs/howto-guides/javascript/loading-javascript.md) tutorial for a primer on how to load your custom JavaScript into the block editor.
