...
* [Store Post Meta with a Block](/docs/howto-guides/metabox/meta-block-1-intro.md)

## Sidebar Plugin

If you are interested in working with the post meta outside the editor, check out the [Sidebar Tutorial](/docs/howto-guides/sidebar-tutorial/plugin-sidebar-0.md/).
