...
See [theme.json reference docs](/docs/reference-guides/theme-json-reference/README.md), the [how to guide](/docs/how-to-guides/themes/global-settings-and-styles.md), and an introduction to [styles in the block editor](/docs/explanations/architecture/styles.md).
