...
1. **[Styling blocks](https://developer.wordpress.org/block-editor/getting-started/fundamentals/styling-blocks):** How the CSS a block ships and the styles WordPress generates from block supports, block styles, and `theme.json` fit together.
