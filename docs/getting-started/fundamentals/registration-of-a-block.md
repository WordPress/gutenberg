...
The `blocks-manifest.php` file is automatically generated by the [`wp-scripts build-blocks-manifest`](https://developer.wordpress.org/block-editor/reference-guides/packages/packages-scripts/#build-blocks-manifest) command (or by passing the `--blocks-manifest` flag to the `build` and `start` commands). It compiles metadata from all `block.json` files in your project into a single PHP file.
...
<div class="callout callout-info">
	<code>wp_register_block_types_from_metadata_collection()</code> requires WordPress 6.8 or later. See the <a href="https://make.wordpress.org/core/2025/03/13/more-efficient-block-type-registration-in-6-8/">WordPress 6.8 dev note</a> for more details.
</div>
...
<div class="callout callout-info">
	<code>wp_register_block_metadata_collection()</code> requires WordPress 6.7 or later. See the <a href="https://make.wordpress.org/core/2024/10/17/new-block-type-registration-apis-to-improve-performance-in-wordpress-6-7/">WordPress 6.7 dev note</a> for more details.
</div>
...
- [`wp_register_block_types_from_metadata_collection` PHP function](https://developer.wordpress.org/reference/functions/wp_register_block_types_from_metadata_collection/) (WordPress 6.8+)
- [`wp_register_block_metadata_collection` PHP function](https://developer.wordpress.org/reference/functions/wp_register_block_metadata_collection/) (WordPress 6.7+)
...
- [More efficient block type registration in 6.8](https://make.wordpress.org/core/2025/03/13/more-efficient-block-type-registration-in-6-8/) | WordPress Core dev note
- [New block type registration APIs in 6.7](https://make.wordpress.org/core/2024/10/17/new-block-type-registration-apis-to-improve-performance-in-wordpress-6-7/) | WordPress Core dev note
