...
<!-- START TOKEN(Autogenerated selectors|../../../packages/block-editor/src/store/selectors.ts) -->
...
-   _state_ `State`: Global application state.
...
-   _rootClientId_ `string | undefined`: Optional root client ID of block list.
...
-   _state_ `State`: Editor state.
-   _nameOrType_ `string`: Block name or type object.
...
-   _state_ `State`: Editor state.
-   _clientId_ `string | null`: The block client Id.
...
-   _modifier_ Directionality multiplier (1 next, -1 previous).
...
-   _rootClientId_ Optional root client ID of block list.
...
-   `Block | null`: Parsed block object.
...
-   _state_ `State`: Global application state.
-   _clientId_ The block client ID, or `''` for the root container.
...
-   _state_ `State`: Editor state.
-   _clientId_ `string | undefined | null`: Block client ID.
...
-   _state_ Editor state.
-   _clientId_ Block from which to find root client ID.
...
-   _state_ Global application state.
...
-   First block client ID in the multi-selection set, or null if there is no multi-selection.
...
-   _state_ Global application state.
-   _blockName_ Optional block name, if specified only blocks of that type will be counted.
...
-   Last block client ID in the multi-selection set, or null if there is no multi-selection.
...
-   Client ID of block ending multi-selection, or null if there is no multi-selection.
...
-   Client ID of block beginning multi-selection, or null if there is no multi-selection.
...
-   _rootClientId_ `string | null`: Optional target root client ID.
...
-   `string[]`: Multi-selected block client IDs.
...
-   _state_ `State`: Block editor state.
...
-   `TemplateState | null`: Block Template.
...
-   `unknown`: Items that appear in inserter.
...
-   `boolean | undefined`: True if the block matches the last block inserted from the specified source.


<!-- END TOKEN(Autogenerated selectors|../../../packages/block-editor/src/store/selectors.ts) -->

## Actions

<!-- START TOKEN(Autogenerated actions|../../../packages/block-editor/src/store/actions.ts) -->
...
<!-- END TOKEN(Autogenerated actions|../../../packages/block-editor/src/store/actions.ts) -->
