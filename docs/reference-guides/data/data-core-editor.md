...
Returns true if the current distributed editing session can export local updates.
...
-   `boolean`: Whether local updates can be exported.
...
-   `string`: Distributed editing disposition.
...
-   `?string`: Distributed editing reason code.
...
-   `Object`: Distributed editing session state.
...
-   `boolean`: Whether local pending changes exist.

### hasRemoteDistributedEditingChanges

Returns true if remote edits have been observed in the distributed editing session.
...
-   `boolean`: Whether remote changes exist.
...
Returns true if the distributed editing session is awaiting server confirmation.
...
-   `boolean`: Whether server confirmation is pending.
...
Returns true if the editor must offer a local-copy/export path before replacing the post with server state.
...
-   `boolean`: Whether a local copy must be offered.

### requiresDistributedEditingServerStateAcceptance

Returns true if the current distributed editing session must accept server state before continuing.
...
-   `boolean`: Whether the session should warn before leaving.
...
Returns an action object used in signalling that the distributed editing session state should be reset for the current editor.
...
Returns an action object used in signalling that the distributed editing session state should be replaced.

_Parameters_

-   _sessionState_ `Object`: Distributed editing session state.
...
Returns an action object used in signalling that the distributed editing session state should be partially updated.

_Parameters_

-   _sessionState_ `Object`: Partial distributed editing session state.
