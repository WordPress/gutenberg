...
Returns whether the panel should be shown or skipped when the user clicks the "publish" button.
...
Returns whether the post-publish panel should be shown or skipped

_Returns_

-   `boolean`: Whether the post-publish panel should be shown or not.

### showPrePublishPanel

Returns whether the pre-publish panel should be shown or skipped
