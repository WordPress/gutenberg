...
<!-- START TOKEN(Autogenerated selectors|../../../packages/preferences/src/store/selectors.ts) -->
...
<!-- END TOKEN(Autogenerated selectors|../../../packages/preferences/src/store/selectors.ts) -->

## Actions

<!-- START TOKEN(Autogenerated actions|../../../packages/preferences/src/store/actions.ts) -->
...
<!-- END TOKEN(Autogenerated actions|../../../packages/preferences/src/store/actions.ts) -->
