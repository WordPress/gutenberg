...
-   [PluginPostRevisionHeader](/docs/reference-guides/slotfills/plugin-post-revision-header.md)
-   [PluginPostRevisionInfo](/docs/reference-guides/slotfills/plugin-post-revision-info.md)
