...
For information on creating and managing packages in Gutenberg, see the [packages README](https://github.com/WordPress/gutenberg/blob/HEAD/packages/README.md). For details on the build system and package configuration, see the [@wordpress/build README](/packages/wp-build/README.md).
...
For complete guidelines, see the [package guidelines](https://github.com/WordPress/gutenberg/blob/HEAD/packages/README.md#package-guidelines) in the packages README.
