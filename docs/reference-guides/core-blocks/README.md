...
-	**Attributes:** arrowIcon, displayMode, indicatorStyle, loop, navigationBackgroundColor, navigationColor, navigationJustification, navigationPosition, showIndicators, slidesToShow
