...
-	**Supports:** anchor, background (backgroundImage, backgroundSize, gradient), color (background, text), layout, shadow, spacing (blockGap, padding), typography (fontSize, lineHeight), ~~html~~, ~~visibility~~
-	**Attributes:** label
