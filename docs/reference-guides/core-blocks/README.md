...
-	**Attributes:** caption, order, showArtists, showImages, showNumbers, showPlayButtonArtwork, showPlaybackControls, showTrackLength, showTracklist, type, waveformBackgroundColor, waveformBackgroundGradient, waveformColor, waveformGradient, waveformStyle
