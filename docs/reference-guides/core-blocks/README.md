...
-	**Supports:** __unstablePasteTextInline, align (full, wide), anchor, color (background, gradients, link, text), interactivity (clientNavigation), layout (~~allowJustification~~), listView, spacing (blockGap, margin, padding), typography (fontSize, lineHeight), ~~html~~
