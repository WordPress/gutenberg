...
-	**Supports:** align, anchor, color (background, gradients, link, text), interactivity, spacing (margin, padding)
-	**Attributes:** caption, customWaveformBackgroundColor, customWaveformColor, order, showArtists, showImages, showNumbers, showTrackLength, showTracklist, type, waveformBackgroundColor, waveformBackgroundColorValue, waveformColor, waveformColorValue, waveformStyle
