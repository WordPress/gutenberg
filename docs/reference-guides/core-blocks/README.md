...
-	**Category:** [media](https://developer.wordpress.org/block-editor/reference-guides/core-blocks/core-blocks-media/)
-	**Supports:** align, anchor, color (background, gradients, link, ~~text~~), interactivity, layout (default, ~~allowInheriting~~, ~~allowOrientation~~, ~~allowSwitching~~, ~~allowVerticalAlignment~~, ~~allowWrap~~), spacing (blockGap, margin, padding)
