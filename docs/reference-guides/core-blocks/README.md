...
-	**Attributes:** align, focalPoint, href, imageFill, isStackedOnMobile, lightbox, linkClass, linkDestination, linkTarget, mediaAlt, mediaId, mediaLink, mediaPosition, mediaSizeSlug, mediaType, mediaUrl, mediaWidth, rel, useFeaturedImage, verticalAlignment
