...
- [Figure](https://developer.wordpress.org/block-editor/reference-guides/core-blocks/core-blocks-media/core-block-figure/) — `core/figure`: A semantic container for self-contained content such as images, code, quotes, and more with an optional caption.
