...
-	**Category:** theme
-	**Supports:** align, anchor, color (background, gradients, link, text), spacing (margin, padding), typography (fontSize, lineHeight), ~~html~~, ~~reusable~~
...
-	**Category:** theme
-	**Supports:** anchor, color (background, gradients, ~~text~~), spacing (margin, padding), typography (fontSize, lineHeight), ~~html~~, ~~reusable~~
-	**Attributes:** label
