...
-   [Testing Published Packages Across WordPress Versions](/docs/contributors/code/package-runtime-compatibility.md) explains how to test package bundles that load dependencies from WordPress.
...
-   [Agents and Skills](/docs/contributors/code/agents-and-skills.md) explains how instructions for AI coding agents (`AGENTS.md` files and `.agents/skills/`) are organized, and what to consider before adding more.
-   [Gutenberg Building Guidance](/docs/contributors/code/building-guidance.md) collects recurring implementation and review guidance for Gutenberg changes.
    -   Focused guides cover [cross-cutting method](/docs/contributors/code/cross-cutting-method.md), [UI and accessibility](/docs/contributors/code/ui-accessibility.md), [React and data lifecycle](/docs/contributors/code/react-data-lifecycle.md), [packages and compatibility](/docs/contributors/code/packages-apis-compatibility.md), [PHP and REST](/docs/contributors/code/php-rest-schema.md), [tooling and release safety](/docs/contributors/code/tooling-ci-release.md), and [tests and delivery evidence](/docs/contributors/code/testing-docs-delivery.md).
