...
In addition to that, you can also compare the metrics across branches (or tags or commits) by running the following command `./tools/release/cli.js perf [branches]`, example:

```
./tools/release/cli.js perf trunk v8.1.0 v8.0.0
```
...
```
./tools/release/cli.js perf trunk v8.1.0 v8.0.0 --tests-branch add/perf-tests-coverage
```
