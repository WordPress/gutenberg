...
The API for creating blocks is a crucial aspect of the project. We are working on improved documentation and tutorials. Check out the [Creating Block Types](../blocks.md) section to get started.
...
*See:* [Theme Support](../extensibility/theme-support.md)
...
Yes, primarily in [design principles](./design-principles.md)
...
We suggest you look at the [language of Gutenberg](../language.md) to learn more about how this aspect of the project works.
