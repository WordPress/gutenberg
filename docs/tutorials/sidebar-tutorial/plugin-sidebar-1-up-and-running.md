...
The first step in the journey is to tell the editor that there is a new plugin that will have its own sidebar. You can do so by using the [registerPlugin](/packages/plugins/README.md#registerPlugin), [PluginSidebar](/packages/edit-post/README.md#PluginSidebar), and [createElement](/packages/element/README.md#createElement) utilities provided by WordPress, to be found in the `@wordpress/plugins`, `@wordpress/edit-post`, and `@wordpress/element` [packages](/docs/packages/README.md), respectively.
