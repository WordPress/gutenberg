...
<a name="keepCaretInsideBlock" href="#keepCaretInsideBlock">#</a> **keepCaretInsideBlock**
...
-   `boolean`: Whether to keep caret inside block.
...
<a name="setKeepCaretInsideBlock" href="#setKeepCaretInsideBlock">#</a> **setKeepCaretInsideBlock**

Returns an action object that changes caret navigation in edit mode.

_Parameters_

-   _keepCaretInsideBlock_ `boolean`: 
