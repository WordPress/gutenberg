...
In this tutorial you're going to create a custom sidebar for a plugin. This sidebar will have a text control for the user to update a value that is stored in the `post_meta` table.
