...
Let's look at using the [Block Style example](/docs/reference-guides/filters/block-filters.md#block-stylea) to extend the editor. This example allows you to add your own custom CSS class name to any core block type.
