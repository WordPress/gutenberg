...
A tool to compare performance across multiple branches/tags/commits is provided. You can run it locally like so: `./tools/release/cli.js perf [branches]`, example:
