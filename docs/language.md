...
Similarities with the Gutenberg printing press remain. The movable type press constructed the content from individual blocks of metal, put together to form a page, and then print it. The final printed form has no knowledge that it was done through individual pieces, because there's no need for that to bear any weight when someone is reading. In order to make further edits you had to go back to assemble the letters. Gutenberg leaves invisible marks on the printed paper so that the printing press can reassemble all the individual letters again and be ready to manipulate.
