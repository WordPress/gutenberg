...
class LinkInput extends Component {
	...
	render() {
		...
		return (
			<div className="blocks-format-toolbar__link-input">
				<input
					autoFocus
					type="url"
					aria-label={ __( 'URL' ) }
				...
				{ showSuggestions && !! posts.length &&
					<div
						className="blocks-format-toolbar__link-input-suggestions"
					...
					>
						{ posts.map( ( post, index ) => (
							<button
								...
								className={ classnames( 'blocks-format-toolbar__link-input-suggestion', {
