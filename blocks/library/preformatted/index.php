...
function register_core_preformatted_block() {
	wp_register_script( 'core-preformatted-block', gutenberg_url( '/build/blocks/library/preformatted.js' ) );

	wp_register_style(
		'core-preformatted-block-editor',
		gutenberg_url( '/build/blocks/library/preformatted_editor.css' ),
		array(),
		filemtime( gutenberg_dir_path() . 'build/blocks/library/preformatted_editor.css' )
	);
