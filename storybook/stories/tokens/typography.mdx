...
<table>
	...
	<tbody>
		<tr>
			...
			<td>`$font-family-headings`, `font-weight-semibold`, `font-size-2x-large`, `line-height-2x-large`</td>
		</tr>
		<tr>
			<td>heading-x-large</td>
			<td>`$font-family-headings`, `font-weight-semibold`, `font-size-x-large`, `line-height-medium`</td>
		</tr>
		<tr>
			<td>heading-large</td>
			<td>`$font-family-headings`, `font-weight-semibold`, `font-size-large`, `line-height-small`</td>
		</tr>
		<tr>
			<td>heading-medium</td>
			<td>`$font-family-headings`, `font-weight-semibold`, `font-size-medium`, `line-height-small`</td>
		</tr>
		<tr>
			<td>heading-small</td>
			<td>`$font-family-headings`, `font-weight-semibold`, `font-size-x-small`, `line-height-x-small`</td>
		</tr>
	</tbody>
</table>
