...
<Meta id="foundations-design-language-radius" title="Design System/Foundations/Design Language/Radius" name="page" />
...
These steps are defined as SCSS tokens. The values are listed in the [`@wordpress/base-styles` README](https://github.com/WordPress/gutenberg/blob/trunk/packages/base-styles/README.md#radius-tokens). New UI should use the [design system tokens](?path=/docs/design-system-tokens-introduction--docs) instead.
