...
<Meta id="foundations-design-language-elevation" title="Design System/Foundations/Design Language/Elevation" name="page" />
...
Use tokens to apply elevation in your work. The SCSS values are listed in the [`@wordpress/base-styles` README](https://github.com/WordPress/gutenberg/blob/trunk/packages/base-styles/README.md#elevation-tokens).
