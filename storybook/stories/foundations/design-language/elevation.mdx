...
<table>
	...
	<tbody>
		<tr>
			<td>Extra small</td>
			<td>
				For large sections and containers that group related content and
				controls, and may shift and overlap on top of other content.
			</td>
		...
		<tr>
			<td>Small</td>
			<td>
				For components that provide contextual feedback without being
				overly intrusive. Generally non-interruptive.
			</td>
		...
		<tr>
			<td>Large</td>
			<td>
				For components that confirm or provide decisions or other
				interruption necessary tasks.
			</td>
			<td>Modals</td>
		</tr>
	</tbody>
