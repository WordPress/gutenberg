...
<Meta title="Design System/Patterns/Save & submit UX" />
...
- Keep labels short; use the description under the toggle or in the card title to provide more context. Keep that short too and link to a guide (that opens in the help center) if you need to say more. Make sure not to duplicate descriptions in the page and card titles.
