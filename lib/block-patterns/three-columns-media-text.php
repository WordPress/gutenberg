...
return array(
	...
	<h6 class="has-text-color" style="color:#000000">' . esc_html__( 'NATURE', 'default' ) . '</h6>
	<!-- /wp:heading -->

	<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.1","fontSize":"5vw"},"color":{"text":"#000000"}}} -->
	<p class="has-text-color" style="color:#000000;font-size:5vw;line-height:1.1"><strong>' . esc_html__( 'Flora and fauna.', 'default' ) . '</strong></p>
