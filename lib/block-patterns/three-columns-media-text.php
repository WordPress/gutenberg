...
return array(
	...
	<figure class="wp-block-image size-large"><img src="https://blockpatterndesigns.mystagingwebsite.com/wp-content/uploads/2021/02/StockSnap_ZD6WAL4LGT-edited.jpg" alt="" class="wp-image-345"/></figure>
	<!-- /wp:image --></div>
	<!-- /wp:column -->
	
	<!-- wp:column {"width":"33.62%"} -->
	<div class="wp-block-column" style="flex-basis:33.62%"><!-- wp:image {"id":347,"sizeSlug":"large","linkDestination":"none"} -->
	<figure class="wp-block-image size-large"><img src="https://blockpatterndesigns.mystagingwebsite.com/wp-content/uploads/2021/02/StockSnap_56RKHNDUQ2-edited-scaled.jpg" alt="" class="wp-image-347"/></figure>
	<!-- /wp:image --></div>
	<!-- /wp:column --></div>
	<!-- /wp:columns -->
	...
	<div class="wp-block-image"><figure class="alignright size-large"><img src="https://blockpatterndesigns.mystagingwebsite.com/wp-content/uploads/2021/02/StockSnap_H17J2YTARL-1024x683.jpg" alt="" class="wp-image-348"/></figure></div>
	<!-- /wp:image --></div>
	<!-- /wp:column -->
