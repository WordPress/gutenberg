...
return array(
	...
	<h3 style="font-size:24px;line-height:1.3"><strong><a href="http://wordpress.org" data-type="URL" data-id="wordpress.org">' . esc_html__( 'Virtual Tour ↗', 'default' ) . '</a></strong></h3>
	<!-- /wp:heading -->
