...
function gutenberg_reregister_core_block_types() {
	...
	$blocks_dirs = array(
		__DIR__ . '/../build/block-library/blocks/' => array(
			...
			'block_names'   => array(
				...
				'cover'                        => 'core/cover',
				'comment-author-avatar'        => 'core/comment-author-avatar',
				'comment-author-name'          => 'core/comment-author-name',
				'comment-content'              => 'core/comment-content',
				'comment-date'                 => 'core/comment-date',
				'comment-edit-link'            => 'core/comment-edit-link',
				'comment-reply-link'           => 'core/comment-reply-link',
				'comment-template'             => 'core/comment-template',
				'comments-pagination'          => 'core/comments-pagination',
				'comments-pagination-next'     => 'core/comments-pagination-next',
				'comments-pagination-numbers'  => 'core/comments-pagination-numbers',
				'comments-pagination-previous' => 'core/comments-pagination-previous',
				'comments-title'               => 'core/comments-title',
				'comments'                     => 'core/comments',
				'footnotes'                    => 'core/footnotes',
				'file'                         => 'core/file',
				'form'                         => 'core/form',
				'form-input'                   => 'core/form-input',
				...
				'post-author-biography'        => 'core/post-author-biography',
				'post-comment'                 => 'core/post-comment',
				'post-comments-count'          => 'core/post-comments-count',
				'post-comments-form'           => 'core/post-comments-form',
				'post-comments-link'           => 'core/post-comments-link',
				...
				'post-navigation-link'         => 'core/post-navigation-link',
				'post-terms'                   => 'core/post-terms',
				'post-time-to-read'            => 'core/post-time-to-read',
				'post-title'                   => 'core/post-title',
				'query'                        => 'core/query',
				'post-template'                => 'core/post-template',
				'query-no-results'             => 'core/query-no-results',
				'query-pagination'             => 'core/query-pagination',
				'query-pagination-next'        => 'core/query-pagination-next',
				'query-pagination-numbers'     => 'core/query-pagination-numbers',
				'query-pagination-previous'    => 'core/query-pagination-previous',
	...
	foreach ( $blocks_dirs as $blocks_dir => $details ) {
		...
		foreach ( $block_names as $file => $sub_block_names ) {
			if ( ! file_exists( $blocks_dir . $file . '/index.php' ) ) {
				continue;
			}
			...
			require_once $blocks_dir . $file . '/index.php';
		}
	}
}
