...
return array(
	...
	'description'   => _x( 'Two horizontal buttons, the left button has a solid background color, and the right button is outlined.', 'Block pattern description', 'gutenberg' ),
