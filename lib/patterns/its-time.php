<?php
/**
 * It's time block pattern.
 *
 * @package gutenberg
 */

return array(
	'title'       => __( 'It\'s time', 'gutenberg' ),
	'categories'  => array( 'text', 'columns' ),
	'description' => _x( 'Two columns with text, followed by a centered paragraph with a large font size', 'Block pattern description', 'gutenberg' ),
