...
export default function HeaderIllustration() {
	const instanceId = useInstanceId( HeaderIllustration );
	const flaskGradientId = `flask-gradient-${ instanceId }`;
	const liquidGradientId = `liquid-gradient-${ instanceId }`;
