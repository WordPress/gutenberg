 ...
 *
 * This endpoint exists to override the core WP_REST_Icon_Controller endpoint
 * and utilize the WP_Icons_Registry_Gutenberg registry.
 *
 *
 * @package gutenberg
 * @since 6.9.0
...
class WP_REST_Icon_Controller_Gutenberg extends WP_REST_Controller {
	/**
	...
	public function get_items( $request ) {
		$response = array();
		$icons    = WP_Icons_Registry_Gutenberg::get_instance()->get_all_registered();
