 ...
 * (image_sizes, image_size_threshold, image_output_formats, etc.) on the root
 * endpoint that are not included in WordPress Core's default preload paths.
 * This filter ensures the preloaded URL matches exactly what the JavaScript requests.
 *
 * @since 20.1.0
 *
 * @param array $paths REST API paths to preload.
