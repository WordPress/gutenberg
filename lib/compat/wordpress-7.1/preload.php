...
function gutenberg_block_editor_preload_paths_7_1( $paths, $context ) {
	...
	$root_fields = 'description,gmt_offset,home,image_max_bit_depth,image_sizes,image_size_threshold,image_strip_meta,name,site_icon,site_icon_url,site_logo,timezone_string,url,video_keep_original,page_for_posts,page_on_front,show_on_front';
