 ...
 */
class Gutenberg_HTML_Tag_Processor_6_7 {
	/**
	...
	public function set_bookmark( $name ): bool {
		...
		$this->bookmarks[ $name ] = new Gutenberg_HTML_Span_6_7( $this->token_starts_at, $this->token_length );
	...
	private function parse_next_attribute(): bool {
		...
		if ( ! isset( $this->attributes[ $comparable_name ] ) ) {
			$this->attributes[ $comparable_name ] = new Gutenberg_HTML_Attribute_Token_6_7(
				$attribute_name,
				$value_start,
				$value_length,
				$attribute_start,
		 ...
		 */
		$duplicate_span = new Gutenberg_HTML_Span_6_7( $attribute_start, $attribute_end - $attribute_start );
	 ...
	 */
	private static function sort_start_ascending( Gutenberg_HTML_Text_Replacement_6_7 $a, Gutenberg_HTML_Text_Replacement_6_7 $b ): int {
	...
	private function get_enqueued_attribute_value( string $comparable_name ) {
		...
		return Gutenberg_HTML_Decoder_6_7::decode_attribute( $enqueued_value );
	}
	...
	public function get_attribute( $name ) {
		...
		return Gutenberg_HTML_Decoder_6_7::decode_attribute( $raw_value );
	}
	...
	public function get_modifiable_text(): string {
		...
		$decoded = Gutenberg_HTML_Decoder_6_7::decode_text_node( $text );
	...
	public function set_attribute( $name, $value ): bool {
		...
		if ( isset( $this->attributes[ $comparable_name ] ) ) {
			...
			$this->lexical_updates[ $comparable_name ] = new Gutenberg_HTML_Text_Replacement_6_7(
	...
	public function remove_attribute( $name ): bool {
		 ...
		 *    Result: <div />
		 */
		$this->lexical_updates[ $name ] = new Gutenberg_HTML_Text_Replacement_6_7(
		...
		foreach ( $this->duplicate_attributes[ $name ] ?? array() as $attribute_token ) {
			$this->lexical_updates[] = new Gutenberg_HTML_Text_Replacement_6_7(
