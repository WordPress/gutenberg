...
class WP_Theme_JSON_5_9 {
	...
	public function get_svg_filters( $origins ) {
		...
		/*
		 * Filters generated by blocks include their own stylesheet instead of
		 * having a class name, so we can skip generating the theme filters in
		 * classic themes which only support per-block filters.
		 */
