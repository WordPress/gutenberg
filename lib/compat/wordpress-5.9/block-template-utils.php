...
/**
 * Retrieves a single unified template object using its id. If no template object is found with that ID,
 * continues looking for a fallback using the template hierarchy resolution algorithm.
 *
 * @param string $id Template unique identifier (example: theme_slug//template_slug).
 * @param array  $template_type wp_template or wp_template_part.
 *
