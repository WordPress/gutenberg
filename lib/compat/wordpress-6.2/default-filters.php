...
add_action( 'save_post_wp_global_styles', array( 'WP_Theme_JSON_Resolver', 'clean_cached_data' ) );
...
add_action( 'upgrader_process_complete', '_gutenberg_get_global_stylesheet_clean_cache_upon_upgrading' );
