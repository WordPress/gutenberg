...
class Gutenberg_REST_Template_Parts_Controller_7_2 extends Gutenberg_REST_Templates_Controller_7_2 {
	...
	public function update_item( $request ) {
		...
		$result = gutenberg_save_template_part_customization( $theme, $slug, $fields );
	...
	/**
	 * Creates a template part: a customization named after the part, which
	 * registers it as a pattern of its area.
	 *
	 * @param WP_REST_Request $request Full details about the request.
	 * @return WP_REST_Response|WP_Error Response object on success, or WP_Error object on failure.
	 */
	 ...
	 * @return array|WP_Error Fields for `gutenberg_save_template_part_customization()`, or an error.
	 */
