<?php
/**
 * Loads the MathML polyfill stylesheet of `@wordpress/latex-to-mathml` for
 * the Math block and the inline math format.
 *
 * @package gutenberg
 */

/**
 * Enqueues the MathML polyfill when a rendered block contains a `math` element.
 *
...
/**
 * Enqueues the MathML polyfill in the editor, where it is copied into the
