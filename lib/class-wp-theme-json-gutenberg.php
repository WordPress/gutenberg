...
class WP_Theme_JSON_Gutenberg {
	 ...
	 * @since 7.2.0 Added the `--wp--style--block-background-padding` property.
	 *
	 * @var array
	 */
	const PROPERTIES_METADATA = array(
		...
		'--wp--style--block-background-padding' => array( 'spacing', 'blockBackgroundPadding' ),
	 ...
	 * @since 7.0.0 Added `dimensions.width`, `dimensions.height`, and
	 *              `typography.textIndent` properties.
	 * @since 7.2.0 Added `spacing.blockBackgroundPadding`.
	 * @var array
	 */
