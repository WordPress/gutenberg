		...
		array(
			...
			'items' => array(
				...
				array(
					...
					'description' => __( 'Lets PHP-only blocks use a block pattern as their content: only bound fields are editable per instance, and pattern updates reach existing posts.', 'gutenberg' ),
				),
			),
		),
	);
