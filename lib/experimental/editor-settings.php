...
function gutenberg_enable_experiments() {
	...
	if ( gutenberg_is_experiment_enabled( 'gutenberg-rtc-polling-provider' ) ) {
		wp_add_inline_script( 'wp-block-editor', 'window.__experimentalRtcPollingProvider = true', 'before' );
	}
}
