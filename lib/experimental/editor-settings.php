...
function gutenberg_enable_experiments() {
	...
	if ( gutenberg_is_experiment_enabled( 'gutenberg-optimize-existing-media' ) ) {
		wp_add_inline_script( 'wp-editor', 'window.__experimentalOptimizeExistingMedia = true', 'before' );
	}
