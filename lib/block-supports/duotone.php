...
function gutenberg_render_duotone_support( $block_content, $block ) {
	 ...
	 */
	function rgb_to_rgb( $rgb_color ) {
		return array(
	        'r' => bound01( $rgb_color['r'], 255 ) * 255,
	        'g' => bound01( $rgb_color['g'], 255 ) * 255,
	        'b' => bound01( $rgb_color['b'], 255 ) * 255
	    );
	}
	 ...
	 * @return array            Rounded and converted RGB object.
	 */
	function hsl_to_rgb( $hsl_color ) {
	    $h = bound01( $hsl_color['h'], 360 );
	    $s = bound01( $hsl_color['s'], 100 );
	    $l = bound01( $hsl_color['l'], 100 );
