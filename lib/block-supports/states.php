...
/**
 * Adds fallback dimension declarations for aspect-ratio and height declarations.
 *
 * @param array $declarations CSS declarations generated by the style engine.
...
function gutenberg_get_state_declarations_with_fallback_dimension_styles( $declarations ) {
	...
	if ( isset( $declarations['aspect-ratio'] ) && '' !== $declarations['aspect-ratio'] ) {
		$declarations['min-height'] = 'unset';
		$declarations['height']     = 'unset';
	} elseif (
		( isset( $declarations['min-height'] ) && '' !== $declarations['min-height'] ) ||
		( isset( $declarations['height'] ) && '' !== $declarations['height'] )
	) {
		$declarations['aspect-ratio'] = 'unset';
	}
...
function gutenberg_render_block_states_support( $block_content, $block ) {
	...
	foreach ( $css_rules as $rule ) {
		$declarations = gutenberg_get_state_declarations_with_fallback_dimension_styles( $rule['declarations'] );
