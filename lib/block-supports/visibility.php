 ...
 */
function gutenberg_render_visibility_support( $block_content, $block ) {
...
if ( function_exists( 'wp_render_visibility_support' ) ) {
	remove_filter( 'render_block', 'wp_render_visibility_support' );
}
add_filter( 'render_block', 'gutenberg_render_visibility_support', 10, 2 );
