...
function gutenberg_register_typography_support( $block_type ) {
	...
	$has_word_break_support      = $typography_supports['__experimentalWordBreak'] ?? false;
...
function gutenberg_apply_typography_support( $block_type, $block_attributes ) {
	...
	if ( $has_word_break_support && ! $should_skip_word_break && isset( $block_attributes['style']['typography']['wordBreak'] ) ) {
		$typography_block_styles['wordBreak'] =
			gutenberg_typography_get_preset_inline_style_value( $block_attributes['style']['typography']['wordBreak'], 'word-break' );
	}
