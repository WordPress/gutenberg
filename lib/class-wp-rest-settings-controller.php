...
// This is a copy/paste from core :(
 ...
 */
class WP_REST_Settings_Controller2 extends WP_REST_Controller {
	...
	public function get_item( $request ) {
		...
		foreach ( $options as $name => $args ) {
			 ...
			 */
			$response[ $name ] = $this->prepare_value_for_response( $response[ $name ], $request, $args );
		}
