...
function gutenberg_register_packages_styles( $styles ) {
	...
	gutenberg_override_style(
		$styles,
		'wp-widgets-customize',
		gutenberg_url( 'build/widgets-customize/style.css' ),
		array( 'wp-components', 'wp-block-editor', 'wp-edit-blocks' ),
		filemtime( gutenberg_dir_path() . 'build/widgets-customize/style.css' )
	);
	$styles->add_data( 'wp-widgets-customize', 'rtl', 'replace' );
}
