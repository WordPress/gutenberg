...
function gutenberg_register_packages_styles( $styles ) {
	...
	gutenberg_override_style(
		...
		array( 'wp-components', 'wp-block-editor', 'wp-edit-patterns', 'wp-reusable-blocks' ),
		$version
	);
	...
	gutenberg_override_style(
		...
		array( 'wp-components', 'wp-block-editor', 'wp-editor', 'wp-edit-blocks', 'wp-edit-patterns', 'wp-reusable-blocks', 'wp-widgets' ),
		$version
	);
	...
	gutenberg_override_style(
		$styles,
		'wp-edit-patterns',
		gutenberg_url( 'build/edit-patterns/style.css' ),
		array( 'wp-components' ),
		$version
	);
	$styles->add_data( 'wp-edit-patterns', 'rtl', 'replace' );
