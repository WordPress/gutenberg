...
class CG_Post_Type {
	...
	public static function register() {
		$args = array(
			'labels'                          => array(
				'name'          => __( 'Guidelines', 'content-guidelines' ),
				'singular_name' => __( 'Guidelines', 'content-guidelines' ),
			),
			'public'                          => false,
			...
			'rest_controller_class'           => 'CG_REST_Controller',
			'revisions_rest_controller_class' => 'CG_Revisions_Controller',
	...
	public static function get_guideline_categories_from_meta( $post_id ) {
		$category_labels = array(
			'copy'       => __( 'Copy Guidelines', 'content-guidelines' ),
			'images'     => __( 'Image Guidelines', 'content-guidelines' ),
			'site'       => __( 'Site Context', 'content-guidelines' ),
			'additional' => __( 'Additional Guidelines', 'content-guidelines' ),
		);
